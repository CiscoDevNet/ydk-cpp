...
{
    if(name == "config" || name == "state" || name == "mpls-interface-attributes")
        return true;
    return false;
}
...
{
    if(name == "name" || name == "mpls-enabled")
        return true;
    return false;
}
...
{
    return (srlg !=  nullptr && srlg->has_data())
...
{
    if(name == "srlg" || name == "igp-flooding-bandwidth" || name == "mpls-admin-groups" || name == "te-lsp-timers")
        return true;
    return false;
}
...
{
    if(name == "config" || name == "state" || name == "igp-flooding-bandwidth" || name == "name")
        return true;
    return false;
}
...
{
    if(name == "name" || name == "te-metric" || name == "srlg-membership" || name == "admin-group")
        return true;
    return false;
}
...
{
    if(name == "rsvp-te" || name == "segment-routing" || name == "ldp")
        return true;
    return false;
}
...
{
    if(name == "source-port" || name == "destination-port" || name == "source-address" || name == "destination-address" || name == "status" || name == "type" || name == "tunnel-id" || name == "label-in" || name == "label-out" || name == "associated-lsps")
        return true;
    return false;
}
...
{
    if(name == "config" || name == "state" || name == "hellos" || name == "authentication" || name == "subscription" || name == "protection" || name == "interface-name")
        return true;
    return false;
}
...
bool Mpls::SignalingProtocols::RsvpTe::InterfaceAttributes::Interface::State::has_data() const
{
    ...
    return highwater_mark.is_set
	|| active_reservation_count.is_set
...
{
    if(name == "bandwidth" || name == "counters" || name == "highwater-mark" || name == "active-reservation-count")
        return true;
    return false;
}
...
{
    if(name == "lower-bound" || name == "upper-bound" || name == "size" || name == "free" || name == "used")
        return true;
    return false;
}
...
{
    if(name == "config" || name == "state" || name == "adjacency-sid" || name == "interface")
        return true;
    return false;
}
...
{
    if(name == "config" || name == "state" || name == "bandwidth" || name == "p2p-tunnel-attributes" || name == "name" || name == "type")
        return true;
    return false;
}
...
{
    if(name == "name" || name == "type" || name == "signaling-protocol" || name == "local-id" || name == "description" || name == "admin-status" || name == "preference" || name == "metric" || name == "protection-style-requested" || name == "reoptimize-timer" || name == "source" || name == "soft-preemption" || name == "setup-priority" || name == "hold-priority")
        return true;
    return false;
}
...
{
    if(name == "counters" || name == "name" || name == "type" || name == "signaling-protocol" || name == "local-id" || name == "description" || name == "admin-status" || name == "preference" || name == "metric" || name == "protection-style-requested" || name == "reoptimize-timer" || name == "source" || name == "soft-preemption" || name == "setup-priority" || name == "hold-priority" || name == "oper-status" || name == "role")
        return true;
    return false;
}
...
{
    if(name == "config" || name == "state" || name == "p2p-primary-paths" || name == "p2p-secondary-paths")
        return true;
    return false;
}
...
{
    if(name == "p2p-lsp" || name == "p2mp-lsp" || name == "mp2mp-lsp" || name == "tunnel-type" || name == "ldp-type")
        return true;
    return false;
}
...
{
    if(name == "config" || name == "state" || name == "prefix-sid" || name == "fec-address")
        return true;
    return false;
}
...
{
    if(name == "type" || name == "node-flag" || name == "last-hop-behavior")
        return true;
    return false;
}
...
{
    if(name == "ingress" || name == "transit" || name == "egress" || name == "name")
        return true;
    return false;
}
