...
{
    if(name == "aggregation" || name == "config" || name == "ethernet" || name == "hold-time" || name == "routed-vlan" || name == "sonet" || name == "state" || name == "subinterfaces" || name == "name")
        return true;
    return false;
}
...
{
    if(name == "description" || name == "enabled" || name == "mtu" || name == "name" || name == "type")
        return true;
    return false;
}
...
{
    if(name == "aggregate-id" || name == "auto-negotiate" || name == "duplex-mode" || name == "enable-flow-control" || name == "mac-address" || name == "port-speed")
        return true;
    return false;
}
