...
Entity* Interfaces::Interface::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & Interfaces::Interface::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::State::Counters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::State::Counters::get_children()
{
    return children;
}
...
Interfaces::Interface::State::State()
    :
	 ...
	 description{YType::str, "description"},
	 enabled{YType::boolean, "enabled"},
	 hardware_port{YType::str, "hardware-port"},
...
Entity* Interfaces::Interface::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::State::get_children()
{
...
Entity* Interfaces::Interface::HoldTime::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::HoldTime::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::HoldTime::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::HoldTime::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::HoldTime::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::HoldTime::get_children()
{
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::State::Counters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::State::Counters::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::State::get_children()
{
    if(children.find("counters") == children.end())
    {
        if(counters != nullptr)
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Vlan::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Vlan::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Vlan::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Vlan::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Vlan::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Vlan::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Vrrp::VrrpGroup::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Vrrp::VrrpGroup::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Vrrp::VrrpGroup::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Vrrp::VrrpGroup::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Vrrp::VrrpGroup::InterfaceTracking::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Vrrp::VrrpGroup::InterfaceTracking::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Vrrp::VrrpGroup::InterfaceTracking::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Vrrp::VrrpGroup::InterfaceTracking::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Vrrp::VrrpGroup::InterfaceTracking::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Vrrp::VrrpGroup::InterfaceTracking::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
	...
	,state(std::make_unique<Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Vrrp::VrrpGroup::State>())
{
    ...
    children["interface-tracking"] = interface_tracking.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "vrrp-group" <<"[virtual-router-id='" <<virtual_router_id.get() <<"']";
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Vrrp::VrrpGroup::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Vrrp::VrrpGroup::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Vrrp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "vrrp-group")
    {
        ...
        auto c = std::make_unique<Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Vrrp::VrrpGroup>();
        c->parent = this;
        vrrp_group.push_back(std::move(c));
        children[segment_path] = vrrp_group.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::Vrrp::get_children()
{
    for (auto const & c : vrrp_group)
    {
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Neighbor::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Neighbor::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Neighbor::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Neighbor::State::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "neighbor" <<"[ip='" <<ip.get() <<"']";
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Neighbor::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Neighbor::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "address")
    {
        ...
        auto c = std::make_unique<Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Address>();
        c->parent = this;
    ...
    if(child_yang_name == "neighbor")
    {
        ...
        auto c = std::make_unique<Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::Neighbor>();
        c->parent = this;
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv4::get_children()
{
    for (auto const & c : address)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Vrrp::VrrpGroup::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Vrrp::VrrpGroup::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Vrrp::VrrpGroup::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Vrrp::VrrpGroup::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Vrrp::VrrpGroup::InterfaceTracking::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Vrrp::VrrpGroup::InterfaceTracking::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Vrrp::VrrpGroup::InterfaceTracking::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Vrrp::VrrpGroup::InterfaceTracking::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Vrrp::VrrpGroup::InterfaceTracking::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Vrrp::VrrpGroup::InterfaceTracking::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Vrrp::VrrpGroup::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Vrrp::VrrpGroup::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Vrrp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "vrrp-group")
    {
        ...
        auto c = std::make_unique<Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Vrrp::VrrpGroup>();
        c->parent = this;
        vrrp_group.push_back(std::move(c));
        children[segment_path] = vrrp_group.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::Vrrp::get_children()
{
    for (auto const & c : vrrp_group)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Neighbor::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Neighbor::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Neighbor::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Neighbor::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Neighbor::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Neighbor::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Autoconf::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Autoconf::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Autoconf::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Autoconf::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Autoconf::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Autoconf::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
	...
	,state(std::make_unique<Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::State>())
{
    ...
    children["autoconf"] = autoconf.get();
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "address")
    {
        ...
        auto c = std::make_unique<Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Address>();
        c->parent = this;
        address.push_back(std::move(c));
        children[segment_path] = address.back().get();
        return children.at(segment_path);
    ...
    if(child_yang_name == "neighbor")
    {
        ...
        auto c = std::make_unique<Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::Neighbor>();
        c->parent = this;
        neighbor.push_back(std::move(c));
        children[segment_path] = neighbor.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::Ipv6::get_children()
{
    for (auto const & c : address)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
{
    std::ostringstream path_buffer;
    path_buffer << "subinterface" <<"[index='" <<index_.get() <<"']";
...
Entity* Interfaces::Interface::Subinterfaces::Subinterface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::Subinterface::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::Subinterfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "subinterface")
    {
        ...
        auto c = std::make_unique<Interfaces::Interface::Subinterfaces::Subinterface>();
        c->parent = this;
        subinterface.push_back(std::move(c));
        children[segment_path] = subinterface.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Interfaces::Interface::Subinterfaces::get_children()
{
    for (auto const & c : subinterface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Interfaces::Interface::Ethernet::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Ethernet::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Ethernet::State::Counters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Ethernet::State::Counters::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Ethernet::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Ethernet::State::get_children()
{
    if(children.find("counters") == children.end())
    {
        if(counters != nullptr)
...
Entity* Interfaces::Interface::Ethernet::Vlan::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Ethernet::Vlan::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Ethernet::Vlan::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Ethernet::Vlan::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Ethernet::Vlan::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Ethernet::Vlan::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::Ethernet::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Ethernet::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::Aggregation::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Aggregation::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Aggregation::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Aggregation::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Aggregation::Lacp::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Aggregation::Lacp::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Aggregation::Lacp::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Aggregation::Lacp::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Aggregation::Lacp::Members::Member::State::Counters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Aggregation::Lacp::Members::Member::State::Counters::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Aggregation::Lacp::Members::Member::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Aggregation::Lacp::Members::Member::State::get_children()
{
    if(children.find("counters") == children.end())
    {
        if(counters != nullptr)
...
{
    std::ostringstream path_buffer;
    path_buffer << "member" <<"[interface='" <<interface.get() <<"']";
...
Entity* Interfaces::Interface::Aggregation::Lacp::Members::Member::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Aggregation::Lacp::Members::Member::get_children()
{
    if(children.find("state") == children.end())
    {
        if(state != nullptr)
...
Entity* Interfaces::Interface::Aggregation::Lacp::Members::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "member")
    {
        ...
        auto c = std::make_unique<Interfaces::Interface::Aggregation::Lacp::Members::Member>();
        c->parent = this;
...
std::map<std::string, Entity*> & Interfaces::Interface::Aggregation::Lacp::Members::get_children()
{
    for (auto const & c : member)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Interfaces::Interface::Aggregation::Lacp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Aggregation::Lacp::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::Aggregation::Vlan::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Aggregation::Vlan::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Aggregation::Vlan::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Aggregation::Vlan::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::Aggregation::Vlan::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Aggregation::Vlan::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::Aggregation::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::Aggregation::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::RoutedVlan::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv4::Address::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv4::Address::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv4::Address::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv4::Address::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv4::Address::Vrrp::VrrpGroup::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv4::Address::Vrrp::VrrpGroup::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv4::Address::Vrrp::VrrpGroup::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv4::Address::Vrrp::VrrpGroup::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv4::Address::Vrrp::VrrpGroup::InterfaceTracking::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv4::Address::Vrrp::VrrpGroup::InterfaceTracking::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv4::Address::Vrrp::VrrpGroup::InterfaceTracking::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv4::Address::Vrrp::VrrpGroup::InterfaceTracking::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv4::Address::Vrrp::VrrpGroup::InterfaceTracking::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv4::Address::Vrrp::VrrpGroup::InterfaceTracking::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::RoutedVlan::Ipv4::Address::Vrrp::VrrpGroup::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv4::Address::Vrrp::VrrpGroup::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::RoutedVlan::Ipv4::Address::Vrrp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "vrrp-group")
    {
        ...
        auto c = std::make_unique<Interfaces::Interface::RoutedVlan::Ipv4::Address::Vrrp::VrrpGroup>();
        c->parent = this;
        vrrp_group.push_back(std::move(c));
        children[segment_path] = vrrp_group.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv4::Address::Vrrp::get_children()
{
    for (auto const & c : vrrp_group)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Interfaces::Interface::RoutedVlan::Ipv4::Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv4::Address::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::RoutedVlan::Ipv4::Neighbor::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv4::Neighbor::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv4::Neighbor::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv4::Neighbor::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv4::Neighbor::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv4::Neighbor::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::RoutedVlan::Ipv4::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv4::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv4::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv4::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv4::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "address")
    {
        ...
        auto c = std::make_unique<Interfaces::Interface::RoutedVlan::Ipv4::Address>();
        c->parent = this;
        address.push_back(std::move(c));
        children[segment_path] = address.back().get();
        return children.at(segment_path);
    ...
    if(child_yang_name == "neighbor")
    {
        ...
        auto c = std::make_unique<Interfaces::Interface::RoutedVlan::Ipv4::Neighbor>();
        c->parent = this;
        neighbor.push_back(std::move(c));
        children[segment_path] = neighbor.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv4::get_children()
{
    for (auto const & c : address)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Address::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Address::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Address::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Address::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Address::Vrrp::VrrpGroup::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Address::Vrrp::VrrpGroup::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Address::Vrrp::VrrpGroup::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Address::Vrrp::VrrpGroup::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Address::Vrrp::VrrpGroup::InterfaceTracking::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Address::Vrrp::VrrpGroup::InterfaceTracking::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Address::Vrrp::VrrpGroup::InterfaceTracking::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Address::Vrrp::VrrpGroup::InterfaceTracking::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Address::Vrrp::VrrpGroup::InterfaceTracking::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Address::Vrrp::VrrpGroup::InterfaceTracking::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Address::Vrrp::VrrpGroup::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Address::Vrrp::VrrpGroup::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Address::Vrrp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "vrrp-group")
    {
        ...
        auto c = std::make_unique<Interfaces::Interface::RoutedVlan::Ipv6::Address::Vrrp::VrrpGroup>();
        c->parent = this;
        vrrp_group.push_back(std::move(c));
        children[segment_path] = vrrp_group.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Address::Vrrp::get_children()
{
    for (auto const & c : vrrp_group)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Address::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Neighbor::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Neighbor::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Neighbor::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Neighbor::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Neighbor::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Neighbor::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Autoconf::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Autoconf::Config::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Autoconf::State::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Autoconf::State::get_children()
{
    return children;
}
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::Autoconf::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::Autoconf::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
...
Entity* Interfaces::Interface::RoutedVlan::Ipv6::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "address")
    {
        ...
        auto c = std::make_unique<Interfaces::Interface::RoutedVlan::Ipv6::Address>();
        c->parent = this;
        address.push_back(std::move(c));
        children[segment_path] = address.back().get();
        return children.at(segment_path);
    ...
    if(child_yang_name == "neighbor")
    {
        ...
        auto c = std::make_unique<Interfaces::Interface::RoutedVlan::Ipv6::Neighbor>();
        c->parent = this;
        neighbor.push_back(std::move(c));
        children[segment_path] = neighbor.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::Ipv6::get_children()
{
    for (auto const & c : address)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Interfaces::Interface::RoutedVlan::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::RoutedVlan::get_children()
{
    if(children.find("config") == children.end())
    {
        if(config != nullptr)
	...
	,subinterfaces(std::make_unique<Interfaces::Interface::Subinterfaces>())
{
    ...
    children["hold-time"] = hold_time.get();

    routed_vlan->parent = this;
    children["routed-vlan"] = routed_vlan.get();

    state->parent = this;
    children["state"] = state.get();

    subinterfaces->parent = this;
    children["subinterfaces"] = subinterfaces.get();
...
Entity* Interfaces::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Interfaces::Interface::get_children()
{
...
Entity* Interfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "interface")
    {
        ...
        auto c = std::make_unique<Interfaces::Interface>();
        c->parent = this;
