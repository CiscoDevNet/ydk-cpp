...
{
    if(name == "reseq-items" || name == "seq-items" || name == "name" || name == "perACEStatistics")
        return true;
    return false;
}
...
{
    if(name == "protocol" || name == "cos" || name == "redirect" || name == "timeRange" || name == "vlan" || name == "erspanDscp" || name == "erspanGre" || name == "action" || name == "srcPrefix" || name == "srcPrefixMask" || name == "dstPrefix" || name == "dstPrefixMask" || name == "packets")
        return true;
    return false;
}
...
{
    if(name == "seqNum" || name == "prefix" || name == "prefixMask" || name == "prefixLength" || name == "configStatus")
        return true;
    return false;
}
