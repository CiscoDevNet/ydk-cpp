...
{
    if(name == "id" || name == "fltType" || name == "operSt" || name == "dir")
        return true;
    return false;
}
...
{
    if(name == "id" || name == "ctxEncap" || name == "operSt" || name == "fltType" || name == "dir")
        return true;
    return false;
}
