...
System::VtpItems::VtpItems()
    ...
    , intf_items(std::make_shared<System::VtpItems::IntfItems>())
{
...
{
    if(name == "inst-items" || name == "intf-items" || name == "adminSt" || name == "operSt" || name == "operErr")
        return true;
    return false;
}
...
{
    if(name == "domain" || name == "version" || name == "password" || name == "filePath" || name == "adminSt" || name == "operErr")
        return true;
    return false;
}

System::VtpItems::IntfItems::IntfItems()
    :
    intf_list(this, {"intf"})
{

    yang_name = "intf-items"; yang_parent_name = "vtp-items"; is_top_level_class = false; has_list_ancestor = false; 
}
...
bool System::VtpItems::IntfItems::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<intf_list.len(); index++)
    {
        if(intf_list[index]->has_data())
            return true;
    }
    return false;
}

bool System::VtpItems::IntfItems::has_operation() const
{
    for (std::size_t index=0; index<intf_list.len(); index++)
    {
        if(intf_list[index]->has_operation())
            return true;
    }
    return is_set(yfilter);
}

std::string System::VtpItems::IntfItems::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-NX-OS-device:System/vtp-items/" << get_segment_path();
    return path_buffer.str();
...
std::string System::VtpItems::IntfItems::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > System::VtpItems::IntfItems::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> System::VtpItems::IntfItems::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "Intf-list")
    {
        auto ent_ = std::make_shared<System::VtpItems::IntfItems::IntfList>();
        ent_->parent = this;
        intf_list.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> System::VtpItems::IntfItems::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : intf_list.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
void System::VtpItems::IntfItems::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void System::VtpItems::IntfItems::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool System::VtpItems::IntfItems::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "Intf-list")
        return true;
    return false;
...
System::VtpItems::IntfItems::IntfList::IntfList()
    :
    intf{YType::str, "intf"}
{

    yang_name = "Intf-list"; yang_parent_name = "intf-items"; is_top_level_class = false; has_list_ancestor = false; 
}
...
bool System::VtpItems::IntfItems::IntfList::has_data() const
{
    if (is_presence_container) return true;
    return intf.is_set;
}

bool System::VtpItems::IntfItems::IntfList::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(intf.yfilter);
}

std::string System::VtpItems::IntfItems::IntfList::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-NX-OS-device:System/vtp-items/intf-items/" << get_segment_path();
    return path_buffer.str();
}

std::string System::VtpItems::IntfItems::IntfList::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Intf-list";
    ADD_KEY_TOKEN(intf, "intf");
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > System::VtpItems::IntfItems::IntfList::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> System::VtpItems::IntfItems::IntfList::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> System::VtpItems::IntfItems::IntfList::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void System::VtpItems::IntfItems::IntfList::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "intf")
    {
        intf = value;
...
void System::VtpItems::IntfItems::IntfList::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "intf")
    {
...
bool System::VtpItems::IntfItems::IntfList::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "intf")
        return true;
    return false;
...
System::WedgeItems::WedgeItems()
    :
    ipenabled{YType::enumeration, "ipEnabled"},
    ipaddr{YType::str, "ipAddr"}
{

    yang_name = "wedge-items"; yang_parent_name = "System"; is_top_level_class = false; has_list_ancestor = false; 
}
...
bool System::WedgeItems::has_data() const
{
    if (is_presence_container) return true;
    return ipenabled.is_set
	|| ipaddr.is_set;
}

bool System::WedgeItems::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(ipenabled.yfilter)
	|| ydk::is_set(ipaddr.yfilter);
}

std::string System::WedgeItems::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-NX-OS-device:System/" << get_segment_path();
    return path_buffer.str();
...
std::string System::WedgeItems::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "wedge-items";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > System::WedgeItems::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};

    if (ipenabled.is_set || is_set(ipenabled.yfilter)) leaf_name_data.push_back(ipenabled.get_name_leafdata());
...
std::shared_ptr<ydk::Entity> System::WedgeItems::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> System::WedgeItems::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void System::WedgeItems::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ipEnabled")
    {
        ipenabled = value;
        ipenabled.value_namespace = name_space;
        ipenabled.value_namespace_prefix = name_space_prefix;
    }
...
void System::WedgeItems::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ipEnabled")
    {
        ipenabled.yfilter = yfilter;
    }
    if(value_path == "ipAddr")
    {
...
bool System::WedgeItems::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ipEnabled" || name == "ipAddr")
        return true;
    return false;
}
...
System::NbmItems::ConfItems::GlobalItems::DomItems::GlobalConfDomList::GlobalItems_::GlobalItems_()
    ...
    immediatebwrecovery{YType::enumeration, "immediateBwRecovery"}
{
...
bool System::NbmItems::ConfItems::GlobalItems::DomItems::GlobalConfDomList::GlobalItems_::has_operation() const
{
	...
	|| ydk::is_set(immediatebwrecovery.yfilter);
}
...
std::vector<std::pair<std::string, LeafData> > System::NbmItems::ConfItems::GlobalItems::DomItems::GlobalConfDomList::GlobalItems_::get_name_leaf_data() const
{
    ...
    if (immediatebwrecovery.is_set || is_set(immediatebwrecovery.yfilter)) leaf_name_data.push_back(immediatebwrecovery.get_name_leafdata());
...
void System::NbmItems::ConfItems::GlobalItems::DomItems::GlobalConfDomList::GlobalItems_::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    ...
    if(value_path == "immediateBwRecovery")
    {
        immediatebwrecovery = value;
        immediatebwrecovery.value_namespace = name_space;
        immediatebwrecovery.value_namespace_prefix = name_space_prefix;
    }
}
...
void System::NbmItems::ConfItems::GlobalItems::DomItems::GlobalConfDomList::GlobalItems_::set_filter(const std::string & value_path, YFilter yfilter)
{
    ...
    if(value_path == "immediateBwRecovery")
    {
        immediatebwrecovery.yfilter = yfilter;
    }
}
...
{
    if(name == "operMode" || name == "defaultSenderHostPolicy" || name == "defaultReceiverHostPolicy" || name == "defaultPimHostPolicy" || name == "defaultflowBw" || name == "defaultflowBwUnit" || name == "defaultDscp" || name == "unicastBwPercent" || name == "beaconAck" || name == "subscriptionId" || name == "defaultFlowPolicer" || name == "immediateBwRecovery")
        return true;
    return false;
}
...
System::BootItems::BootItems()
    ...
    order{YType::enumeration, "order"},
    mode{YType::enumeration, "mode"},
    dhcp{YType::uint32, "dhcp"},
    aci{YType::str, "aci"},
    autocopy{YType::enumeration, "autoCopy"}
        ,
    image_items(std::make_shared<System::BootItems::ImageItems>())
    , modbootorder_items(std::make_shared<System::BootItems::ModbootorderItems>())
{
    image_items->parent = this;
    modbootorder_items->parent = this;
...
bool System::BootItems::has_data() const
{
	...
	|| (modbootorder_items !=  nullptr && modbootorder_items->has_data());
}
...
bool System::BootItems::has_operation() const
{
	...
	|| ydk::is_set(aci.yfilter)
	|| ydk::is_set(autocopy.yfilter)
	|| (image_items !=  nullptr && image_items->has_operation())
	|| (modbootorder_items !=  nullptr && modbootorder_items->has_operation());
}
...
std::vector<std::pair<std::string, LeafData> > System::BootItems::get_name_leaf_data() const
{
    ...
    if (aci.is_set || is_set(aci.yfilter)) leaf_name_data.push_back(aci.get_name_leafdata());
    if (autocopy.is_set || is_set(autocopy.yfilter)) leaf_name_data.push_back(autocopy.get_name_leafdata());
...
std::shared_ptr<ydk::Entity> System::BootItems::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "modbootorder-items")
    {
        if(modbootorder_items == nullptr)
        {
            modbootorder_items = std::make_shared<System::BootItems::ModbootorderItems>();
        }
        return modbootorder_items;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> System::BootItems::get_children() const
{
    ...
    if(modbootorder_items != nullptr)
    {
        _children["modbootorder-items"] = modbootorder_items;
    }
...
void System::BootItems::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    ...
    {
        aci = value;
        aci.value_namespace = name_space;
        aci.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "autoCopy")
    {
        autocopy = value;
        autocopy.value_namespace = name_space;
        autocopy.value_namespace_prefix = name_space_prefix;
    }
}
...
void System::BootItems::set_filter(const std::string & value_path, YFilter yfilter)
{
    ...
    if(value_path == "autoCopy")
    {
        autocopy.yfilter = yfilter;
    }
}

bool System::BootItems::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "image-items" || name == "modbootorder-items" || name == "poap" || name == "order" || name == "mode" || name == "dhcp" || name == "aci" || name == "autoCopy")
        return true;
    return false;
}
...
System::BootItems::ModbootorderItems::ModbootorderItems()
    :
    bootorderreverse{YType::enumeration, "bootOrderReverse"}
{

    yang_name = "modbootorder-items"; yang_parent_name = "boot-items"; is_top_level_class = false; has_list_ancestor = false; 
}
...
bool System::BootItems::ModbootorderItems::has_data() const
{
    if (is_presence_container) return true;
    return bootorderreverse.is_set;
}

bool System::BootItems::ModbootorderItems::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(bootorderreverse.yfilter);
}

std::string System::BootItems::ModbootorderItems::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-NX-OS-device:System/boot-items/" << get_segment_path();
    return path_buffer.str();
...
std::string System::BootItems::ModbootorderItems::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "modbootorder-items";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > System::BootItems::ModbootorderItems::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};

    if (bootorderreverse.is_set || is_set(bootorderreverse.yfilter)) leaf_name_data.push_back(bootorderreverse.get_name_leafdata());

    return leaf_name_data;

}

std::shared_ptr<ydk::Entity> System::BootItems::ModbootorderItems::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> System::BootItems::ModbootorderItems::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void System::BootItems::ModbootorderItems::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "bootOrderReverse")
    {
        bootorderreverse = value;
        bootorderreverse.value_namespace = name_space;
        bootorderreverse.value_namespace_prefix = name_space_prefix;
    }
}

void System::BootItems::ModbootorderItems::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "bootOrderReverse")
    {
        bootorderreverse.yfilter = yfilter;
    }
}

bool System::BootItems::ModbootorderItems::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "bootOrderReverse")
        return true;
    return false;
}
...
{
    if(name == "ejpol-items" || name == "locled-items" || name == "supslot-items" || name == "lcslot-items" || name == "fcslot-items" || name == "scslot-items" || name == "psuslot-items" || name == "ftslot-items" || name == "spbp-items" || name == "bslot-items" || name == "nslot-items" || name == "p-items" || name == "role" || name == "operSt" || name == "operStQual" || name == "vdrId" || name == "vendor" || name == "model" || name == "rev" || name == "ser" || name == "mfgTm" || name == "id" || name == "descr")
        return true;
    return false;
}
...
std::shared_ptr<ydk::Entity> System::ChItems::LocledItems::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "LocLed-list")
    {
        auto ent_ = std::make_shared<System::ChItems::LocledItems::LocLedList>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> System::ChItems::LocledItems::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> System::ChItems::LocledItems::LocLedList::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> System::ChItems::LocledItems::LocLedList::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
{
    if(name == "sup-items" || name == "rstrec-items" || name == "rtoosSlot-items" || name == "id" || name == "poweroff" || name == "descr" || name == "physId" || name == "type" || name == "operSt" || name == "loc")
        return true;
    return false;
}
...
std::shared_ptr<ydk::Entity> System::ChItems::SupslotItems::SupCSlotList::SupItems::LocledItems::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "LocLed-list")
    {
        auto ent_ = std::make_shared<System::ChItems::SupslotItems::SupCSlotList::SupItems::LocledItems::LocLedList>();
        ent_->parent = this;
        locled_list.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> System::ChItems::SupslotItems::SupCSlotList::SupItems::LocledItems::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> System::ChItems::SupslotItems::SupCSlotList::SupItems::LocledItems::LocLedList::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> System::ChItems::SupslotItems::SupCSlotList::SupItems::LocledItems::LocLedList::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
{
    if(name == "locled-items" || name == "id" || name == "descr" || name == "type")
        return true;
    return false;
}
...
std::shared_ptr<ydk::Entity> System::ChItems::SupslotItems::SupCSlotList::SupItems::MgmtItems::MgmtPList::LocledItems::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "LocLed-list")
    {
        auto ent_ = std::make_shared<System::ChItems::SupslotItems::SupCSlotList::SupItems::MgmtItems::MgmtPList::LocledItems::LocLedList>();
        ent_->parent = this;
        locled_list.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> System::ChItems::SupslotItems::SupCSlotList::SupItems::MgmtItems::MgmtPList::LocledItems::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> System::ChItems::SupslotItems::SupCSlotList::SupItems::MgmtItems::MgmtPList::LocledItems::LocLedList::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> System::ChItems::SupslotItems::SupCSlotList::SupItems::MgmtItems::MgmtPList::LocledItems::LocLedList::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
