...
System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::PmapItems()
    :
    name{YType::str, "name"},
    stats{YType::boolean, "stats"},
    configstatus{YType::uint32, "configStatus"}
        ,
    rspolicyinsttopmap_items(std::make_shared<System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::RspolicyInstToPMapItems>())
{
...
bool System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::has_data() const
{
...
bool System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::has_operation() const
{
...
std::string System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::get_absolute_path() const
{
...
std::string System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::get_name_leaf_data() const
{
...
void System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "name")
    {
...
bool System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::has_leaf_or_child_of_name(const std::string & name) const
{
...
System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::RspolicyInstToPMapItems::RspolicyInstToPMapItems()
    :
    tdn{YType::str, "tDn"}
{
...
bool System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::RspolicyInstToPMapItems::has_data() const
{
    if (is_presence_container) return true;
    return tdn.is_set;
}

bool System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::RspolicyInstToPMapItems::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(tdn.yfilter);
}

std::string System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::RspolicyInstToPMapItems::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-NX-OS-device:System/ipqos-items/dflt-items/policy-items/in-items/pmap-items/" << get_segment_path();
    return path_buffer.str();
}

std::string System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::RspolicyInstToPMapItems::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::RspolicyInstToPMapItems::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
void System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::RspolicyInstToPMapItems::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "tDn")
    {
        tdn.yfilter = yfilter;
...
bool System::IpqosItems::DfltItems::PolicyItems::InItems::PmapItems::RspolicyInstToPMapItems::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "tDn")
        return true;
    return false;
...
System::IpqosItems::DfltItems::PolicyItems::OutItems::OutItems()
    ...
    , pmap_items(std::make_shared<System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems>())
{
...
System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::PmapItems()
    :
    name{YType::str, "name"},
    stats{YType::boolean, "stats"},
    configstatus{YType::uint32, "configStatus"}
        ,
    rspolicyinsttopmap_items(std::make_shared<System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::RspolicyInstToPMapItems>())
{
    rspolicyinsttopmap_items->parent = this;
...
bool System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::has_data() const
{
    if (is_presence_container) return true;
    return name.is_set
	|| stats.is_set
...
bool System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(name.yfilter)
	|| ydk::is_set(stats.yfilter)
...
std::string System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-NX-OS-device:System/ipqos-items/dflt-items/policy-items/out-items/" << get_segment_path();
    return path_buffer.str();
...
std::string System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "pmap-items";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
void System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "name")
    {
        name.yfilter = yfilter;
...
bool System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "rspolicyInstToPMap-items" || name == "name" || name == "stats" || name == "configStatus")
        return true;
    return false;
...
System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::RspolicyInstToPMapItems::RspolicyInstToPMapItems()
    :
    tdn{YType::str, "tDn"}
{
...
bool System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::RspolicyInstToPMapItems::has_data() const
{
    if (is_presence_container) return true;
    return tdn.is_set;
}

bool System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::RspolicyInstToPMapItems::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(tdn.yfilter);
}

std::string System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::RspolicyInstToPMapItems::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-NX-OS-device:System/ipqos-items/dflt-items/policy-items/out-items/pmap-items/" << get_segment_path();
    return path_buffer.str();
}

std::string System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::RspolicyInstToPMapItems::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "rspolicyInstToPMap-items";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::RspolicyInstToPMapItems::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
void System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::RspolicyInstToPMapItems::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "tDn")
    {
        tdn.yfilter = yfilter;
...
bool System::IpqosItems::DfltItems::PolicyItems::OutItems::PmapItems::RspolicyInstToPMapItems::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "tDn")
        return true;
    return false;
...
System::IpqosItems::GlobalpriorflowctrlItems::GlobalpriorflowctrlItems()
    :
    overrideinterface{YType::enumeration, "overrideInterface"}
{

    yang_name = "globalpriorflowctrl-items"; yang_parent_name = "ipqos-items"; is_top_level_class = false; has_list_ancestor = false; 
}
...
bool System::IpqosItems::GlobalpriorflowctrlItems::has_data() const
{
    if (is_presence_container) return true;
    return overrideinterface.is_set;
}

bool System::IpqosItems::GlobalpriorflowctrlItems::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(overrideinterface.yfilter);
}

std::string System::IpqosItems::GlobalpriorflowctrlItems::get_absolute_path() const
{
    std::ostringstream path_buffer;
...
std::string System::IpqosItems::GlobalpriorflowctrlItems::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > System::IpqosItems::GlobalpriorflowctrlItems::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> System::IpqosItems::GlobalpriorflowctrlItems::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> System::IpqosItems::GlobalpriorflowctrlItems::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void System::IpqosItems::GlobalpriorflowctrlItems::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void System::IpqosItems::GlobalpriorflowctrlItems::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "overrideInterface")
    {
...
bool System::IpqosItems::GlobalpriorflowctrlItems::has_leaf_or_child_of_name(const std::string & name) const
{
...
System::NxapiItems::NxapiItems()
    ...
    encrkeypassphrase{YType::str, "encrKeyPassphrase"},
...
bool System::NxapiItems::has_operation() const
{
	...
	|| ydk::is_set(encrkeypassphrase.yfilter)
...
std::vector<std::pair<std::string, LeafData> > System::NxapiItems::get_name_leaf_data() const
{
    ...
    if (encrkeypassphrase.is_set || is_set(encrkeypassphrase.yfilter)) leaf_name_data.push_back(encrkeypassphrase.get_name_leafdata());
...
void System::NxapiItems::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    ...
    if(value_path == "encrKeyPassphrase")
    {
        encrkeypassphrase = value;
        encrkeypassphrase.value_namespace = name_space;
        encrkeypassphrase.value_namespace_prefix = name_space_prefix;
    }
...
void System::NxapiItems::set_filter(const std::string & value_path, YFilter yfilter)
{
    ...
    if(value_path == "encrKeyPassphrase")
    {
        encrkeypassphrase.yfilter = yfilter;
    }
    if(value_path == "certEnable")
    {
...
{
    if(name == "httpPort" || name == "httpsPort" || name == "useVrf" || name == "certFile" || name == "keyFile" || name == "encrKeyPassphrase" || name == "certEnable" || name == "sslCiphersWeak" || name == "sslProtocols")
        return true;
    return false;
}
...
System::PoeItems::PoeItems()
    ...
    , modloglevel_items(std::make_shared<System::PoeItems::ModloglevelItems>())
{
...
{
    if(name == "inst-items" || name == "physif-items" || name == "modloglevel-items" || name == "name" || name == "adminSt" || name == "operSt")
        return true;
    return false;
}
...
System::PoeItems::ModloglevelItems::ModloglevelItems()
    :
    logginglevel{YType::uint16, "loggingLevel"},
    loggingtype{YType::enumeration, "loggingType"}
{

    yang_name = "modloglevel-items"; yang_parent_name = "poe-items"; is_top_level_class = false; has_list_ancestor = false; 
}
...
bool System::PoeItems::ModloglevelItems::has_data() const
{
    if (is_presence_container) return true;
...
bool System::PoeItems::ModloglevelItems::has_operation() const
{
    return is_set(yfilter)
...
std::string System::PoeItems::ModloglevelItems::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-NX-OS-device:System/poe-items/" << get_segment_path();
    return path_buffer.str();
...
std::string System::PoeItems::ModloglevelItems::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > System::PoeItems::ModloglevelItems::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> System::PoeItems::ModloglevelItems::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> System::PoeItems::ModloglevelItems::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void System::PoeItems::ModloglevelItems::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void System::PoeItems::ModloglevelItems::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "loggingLevel")
    {
...
bool System::PoeItems::ModloglevelItems::has_leaf_or_child_of_name(const std::string & name) const
{
