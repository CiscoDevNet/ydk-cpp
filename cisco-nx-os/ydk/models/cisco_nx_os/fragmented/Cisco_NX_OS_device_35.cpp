...
System::Ipv4Items::InstItems::DomItems::DomList::MulticastrtItems::MulticastRouteList::NhItems::MulticastNexthopList::MulticastNexthopList()
    :
    nhif{YType::str, "nhIf"},
    ...
    pref{YType::uint8, "pref"}
{
    ...
    yang_name = "MulticastNexthop-list"; yang_parent_name = "nh-items"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool System::Ipv4Items::InstItems::DomItems::DomList::MulticastrtItems::MulticastRouteList::NhItems::MulticastNexthopList::has_data() const
{
...
bool System::Ipv4Items::InstItems::DomItems::DomList::MulticastrtItems::MulticastRouteList::NhItems::MulticastNexthopList::has_operation() const
{
...
std::string System::Ipv4Items::InstItems::DomItems::DomList::MulticastrtItems::MulticastRouteList::NhItems::MulticastNexthopList::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "MulticastNexthop-list";
...
std::vector<std::pair<std::string, LeafData> > System::Ipv4Items::InstItems::DomItems::DomList::MulticastrtItems::MulticastRouteList::NhItems::MulticastNexthopList::get_name_leaf_data() const
{
...
std::shared_ptr<ydk::Entity> System::Ipv4Items::InstItems::DomItems::DomList::MulticastrtItems::MulticastRouteList::NhItems::MulticastNexthopList::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> System::Ipv4Items::InstItems::DomItems::DomList::MulticastrtItems::MulticastRouteList::NhItems::MulticastNexthopList::get_children() const
{
...
void System::Ipv4Items::InstItems::DomItems::DomList::MulticastrtItems::MulticastRouteList::NhItems::MulticastNexthopList::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "nhIf")
    {
        nhif = value;
...
void System::Ipv4Items::InstItems::DomItems::DomList::MulticastrtItems::MulticastRouteList::NhItems::MulticastNexthopList::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "nhIf")
    {
...
bool System::Ipv4Items::InstItems::DomItems::DomList::MulticastrtItems::MulticastRouteList::NhItems::MulticastNexthopList::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "nhIf" || name == "nhAddr" || name == "nhVrf" || name == "pref")
        return true;
    return false;
}
...
System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::IfbriefstatsItems()
    :
    vrfifbriefstats_list(this, {"interfaceid"})
{

    yang_name = "ifbriefstats-items"; yang_parent_name = "Dom-list"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<vrfifbriefstats_list.len(); index++)
    {
        if(vrfifbriefstats_list[index]->has_data())
            return true;
    }
    return false;
}

bool System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::has_operation() const
{
    for (std::size_t index=0; index<vrfifbriefstats_list.len(); index++)
    {
        if(vrfifbriefstats_list[index]->has_operation())
            return true;
    }
    return is_set(yfilter);
}

std::string System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "ifbriefstats-items";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "VrfIfBriefStats-list")
    {
        auto ent_ = std::make_shared<System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::VrfIfBriefStatsList>();
        ent_->parent = this;
        vrfifbriefstats_list.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : vrfifbriefstats_list.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
void System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "VrfIfBriefStats-list")
        return true;
    return false;
}

System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::VrfIfBriefStatsList::VrfIfBriefStatsList()
    :
    interfaceid{YType::str, "interfaceId"},
    addr{YType::str, "addr"},
    adminst{YType::enumeration, "adminSt"},
    protst{YType::enumeration, "protSt"},
    linkst{YType::enumeration, "linkSt"},
    secaddrlist{YType::str, "secAddrList"}
{

    yang_name = "VrfIfBriefStats-list"; yang_parent_name = "ifbriefstats-items"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::VrfIfBriefStatsList::has_data() const
{
    if (is_presence_container) return true;
    return interfaceid.is_set
	|| addr.is_set
	|| adminst.is_set
	|| protst.is_set
	|| linkst.is_set
...
bool System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::VrfIfBriefStatsList::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(interfaceid.yfilter)
	|| ydk::is_set(addr.yfilter)
	|| ydk::is_set(adminst.yfilter)
	|| ydk::is_set(protst.yfilter)
	|| ydk::is_set(linkst.yfilter)
	|| ydk::is_set(secaddrlist.yfilter);
}

std::string System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::VrfIfBriefStatsList::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "VrfIfBriefStats-list";
    ADD_KEY_TOKEN(interfaceid, "interfaceId");
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::VrfIfBriefStatsList::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};

    if (interfaceid.is_set || is_set(interfaceid.yfilter)) leaf_name_data.push_back(interfaceid.get_name_leafdata());
    if (addr.is_set || is_set(addr.yfilter)) leaf_name_data.push_back(addr.get_name_leafdata());
    if (adminst.is_set || is_set(adminst.yfilter)) leaf_name_data.push_back(adminst.get_name_leafdata());
    if (protst.is_set || is_set(protst.yfilter)) leaf_name_data.push_back(protst.get_name_leafdata());
    if (linkst.is_set || is_set(linkst.yfilter)) leaf_name_data.push_back(linkst.get_name_leafdata());
    if (secaddrlist.is_set || is_set(secaddrlist.yfilter)) leaf_name_data.push_back(secaddrlist.get_name_leafdata());

    return leaf_name_data;

}

std::shared_ptr<ydk::Entity> System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::VrfIfBriefStatsList::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::VrfIfBriefStatsList::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::VrfIfBriefStatsList::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "interfaceId")
    {
        interfaceid = value;
        interfaceid.value_namespace = name_space;
        interfaceid.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "addr")
    {
        addr = value;
    ...
    if(value_path == "protSt")
    {
        protst = value;
        protst.value_namespace = name_space;
        protst.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "linkSt")
    {
        linkst = value;
        linkst.value_namespace = name_space;
        linkst.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "secAddrList")
    {
        secaddrlist = value;
        secaddrlist.value_namespace = name_space;
        secaddrlist.value_namespace_prefix = name_space_prefix;
    }
}

void System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::VrfIfBriefStatsList::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "interfaceId")
    {
        interfaceid.yfilter = yfilter;
    }
    if(value_path == "addr")
    {
    ...
    if(value_path == "protSt")
    {
        protst.yfilter = yfilter;
    }
    if(value_path == "linkSt")
    {
        linkst.yfilter = yfilter;
    }
    if(value_path == "secAddrList")
    {
        secaddrlist.yfilter = yfilter;
    }
}

bool System::Ipv4Items::InstItems::DomItems::DomList::IfbriefstatsItems::VrfIfBriefStatsList::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "interfaceId" || name == "addr" || name == "adminSt" || name == "protSt" || name == "linkSt" || name == "secAddrList")
        return true;
    return false;
}
...
{
    if(name == "addr-items" || name == "lladdr-items" || name == "nghbr-items" || name == "ifstats-items" || name == "nbrstats-items" || name == "rpol-items" || name == "rtvrfMbr-items" || name == "rtnwPathToIf-items" || name == "id" || name == "useLinkLocalAddr" || name == "urpf" || name == "forward" || name == "autoconfig" || name == "defaultRoute" || name == "llAddr" || name == "configError" || name == "operSt" || name == "operStQual")
        return true;
    return false;
}
...
System::Ipv6Items::InstItems::DomItems::DomList::IfItems::IfList::AddrItems::AddrList::AddrList()
    :
    addr{YType::str, "addr"},
    aggregateprefixlength{YType::uint16, "aggregatePrefixLength"},
...
bool System::Ipv6Items::InstItems::DomItems::DomList::IfItems::IfList::AddrItems::AddrList::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(addr.yfilter)
	|| ydk::is_set(aggregateprefixlength.yfilter)
...
std::vector<std::pair<std::string, LeafData> > System::Ipv6Items::InstItems::DomItems::DomList::IfItems::IfList::AddrItems::AddrList::get_name_leaf_data() const
{
    ...
    if (addr.is_set || is_set(addr.yfilter)) leaf_name_data.push_back(addr.get_name_leafdata());
    if (aggregateprefixlength.is_set || is_set(aggregateprefixlength.yfilter)) leaf_name_data.push_back(aggregateprefixlength.get_name_leafdata());
...
void System::Ipv6Items::InstItems::DomItems::DomList::IfItems::IfList::AddrItems::AddrList::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    ...
    if(value_path == "aggregatePrefixLength")
    {
        aggregateprefixlength = value;
        aggregateprefixlength.value_namespace = name_space;
        aggregateprefixlength.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "type")
    {
        type = value;
...
void System::Ipv6Items::InstItems::DomItems::DomList::IfItems::IfList::AddrItems::AddrList::set_filter(const std::string & value_path, YFilter yfilter)
{
    ...
    if(value_path == "aggregatePrefixLength")
    {
        aggregateprefixlength.yfilter = yfilter;
    }
    if(value_path == "type")
    {
...
{
    if(name == "addr" || name == "aggregatePrefixLength" || name == "type" || name == "ctrl" || name == "vpcPeer" || name == "pref" || name == "tag" || name == "operSt" || name == "operStQual")
        return true;
    return false;
}
...
System::EthpmItems::InstItems::InstItems()
    ...
    systemifadminstate{YType::enumeration, "systemIfAdminState"},
...
bool System::EthpmItems::InstItems::has_operation() const
{
	...
	|| ydk::is_set(systemifadminstate.yfilter)
...
std::vector<std::pair<std::string, LeafData> > System::EthpmItems::InstItems::get_name_leaf_data() const
{
    ...
    if (systemifadminstate.is_set || is_set(systemifadminstate.yfilter)) leaf_name_data.push_back(systemifadminstate.get_name_leafdata());
...
void System::EthpmItems::InstItems::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    ...
    if(value_path == "systemIfAdminState")
    {
        systemifadminstate = value;
        systemifadminstate.value_namespace = name_space;
        systemifadminstate.value_namespace_prefix = name_space_prefix;
    }
...
void System::EthpmItems::InstItems::set_filter(const std::string & value_path, YFilter yfilter)
{
    ...
    if(value_path == "systemIfAdminState")
    {
        systemifadminstate.yfilter = yfilter;
    }
    if(value_path == "logEvent")
    {
...
{
    if(name == "runtime-items" || name == "errdisrecover-items" || name == "vlan-items" || name == "module-items" || name == "vlanTagNative" || name == "systemDefaultLayer" || name == "systemDefaultAdminSt" || name == "systemJumboMtu" || name == "systemIfAdminState" || name == "logEvent" || name == "logLevel" || name == "allowUnsupportedSfp" || name == "ifSyslogInfo" || name == "adminLinkUpSyslogLevel" || name == "adminLinkDownSyslogLevel" || name == "name" || name == "adminSt" || name == "ctrl")
        return true;
    return false;
}
...
System::L2fmItems::L2fmItems()
    ...
    maclearn{YType::enumeration, "macLearn"}
        ,
    macmovetrap_items(std::make_shared<System::L2fmItems::MacmovetrapItems>())
{
    macmovetrap_items->parent = this;
...
bool System::L2fmItems::has_data() const
{
	...
	|| (macmovetrap_items !=  nullptr && macmovetrap_items->has_data());
}
...
bool System::L2fmItems::has_operation() const
{
	...
	|| (macmovetrap_items !=  nullptr && macmovetrap_items->has_operation());
}
...
{
    if(child_yang_name == "macmovetrap-items")
    {
        if(macmovetrap_items == nullptr)
        {
            macmovetrap_items = std::make_shared<System::L2fmItems::MacmovetrapItems>();
        }
        return macmovetrap_items;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> System::L2fmItems::get_children() const
{
    ...
    if(macmovetrap_items != nullptr)
    {
        _children["macmovetrap-items"] = macmovetrap_items;
    }
...
{
    if(name == "macmovetrap-items" || name == "macLearn")
        return true;
    return false;
}

System::L2fmItems::MacmovetrapItems::MacmovetrapItems()
    :
    macmoveaddress{YType::str, "macMoveAddress"},
    macmovevlannumber{YType::uint32, "macMoveVlanNumber"},
    macmovefromportid{YType::uint32, "macMoveFromPortID"},
    macmovetoportid{YType::uint32, "macMoveToPortID"},
    macmovetime{YType::str, "macMoveTime"}
{

    yang_name = "macmovetrap-items"; yang_parent_name = "l2fm-items"; is_top_level_class = false; has_list_ancestor = false; 
}
...
bool System::L2fmItems::MacmovetrapItems::has_data() const
{
    if (is_presence_container) return true;
    return macmoveaddress.is_set
	|| macmovevlannumber.is_set
	|| macmovefromportid.is_set
	|| macmovetoportid.is_set
	|| macmovetime.is_set;
}

bool System::L2fmItems::MacmovetrapItems::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(macmoveaddress.yfilter)
	|| ydk::is_set(macmovevlannumber.yfilter)
	|| ydk::is_set(macmovefromportid.yfilter)
	|| ydk::is_set(macmovetoportid.yfilter)
	|| ydk::is_set(macmovetime.yfilter);
}

std::string System::L2fmItems::MacmovetrapItems::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-NX-OS-device:System/l2fm-items/" << get_segment_path();
    return path_buffer.str();
}

std::string System::L2fmItems::MacmovetrapItems::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "macmovetrap-items";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > System::L2fmItems::MacmovetrapItems::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};

    if (macmoveaddress.is_set || is_set(macmoveaddress.yfilter)) leaf_name_data.push_back(macmoveaddress.get_name_leafdata());
    if (macmovevlannumber.is_set || is_set(macmovevlannumber.yfilter)) leaf_name_data.push_back(macmovevlannumber.get_name_leafdata());
    if (macmovefromportid.is_set || is_set(macmovefromportid.yfilter)) leaf_name_data.push_back(macmovefromportid.get_name_leafdata());
    if (macmovetoportid.is_set || is_set(macmovetoportid.yfilter)) leaf_name_data.push_back(macmovetoportid.get_name_leafdata());
    if (macmovetime.is_set || is_set(macmovetime.yfilter)) leaf_name_data.push_back(macmovetime.get_name_leafdata());

    return leaf_name_data;

}

std::shared_ptr<ydk::Entity> System::L2fmItems::MacmovetrapItems::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> System::L2fmItems::MacmovetrapItems::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void System::L2fmItems::MacmovetrapItems::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "macMoveAddress")
    {
        macmoveaddress = value;
        macmoveaddress.value_namespace = name_space;
        macmoveaddress.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "macMoveVlanNumber")
    {
        macmovevlannumber = value;
        macmovevlannumber.value_namespace = name_space;
        macmovevlannumber.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "macMoveFromPortID")
    {
        macmovefromportid = value;
        macmovefromportid.value_namespace = name_space;
        macmovefromportid.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "macMoveToPortID")
    {
        macmovetoportid = value;
        macmovetoportid.value_namespace = name_space;
        macmovetoportid.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "macMoveTime")
    {
        macmovetime = value;
        macmovetime.value_namespace = name_space;
        macmovetime.value_namespace_prefix = name_space_prefix;
    }
}

void System::L2fmItems::MacmovetrapItems::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "macMoveAddress")
    {
        macmoveaddress.yfilter = yfilter;
    }
    if(value_path == "macMoveVlanNumber")
    {
        macmovevlannumber.yfilter = yfilter;
    }
    if(value_path == "macMoveFromPortID")
    {
        macmovefromportid.yfilter = yfilter;
    }
    if(value_path == "macMoveToPortID")
    {
        macmovetoportid.yfilter = yfilter;
    }
    if(value_path == "macMoveTime")
    {
        macmovetime.yfilter = yfilter;
    }
}

bool System::L2fmItems::MacmovetrapItems::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "macMoveAddress" || name == "macMoveVlanNumber" || name == "macMoveFromPortID" || name == "macMoveToPortID" || name == "macMoveTime")
        return true;
    return false;
}
...
System::EpsItems::EpsItems()
    :
    oper_peer_items(std::make_shared<System::EpsItems::OperPeerItems>())
...
{
    if (is_presence_container) return true;
    return (oper_peer_items !=  nullptr && oper_peer_items->has_data())
	|| (evpnmulticast_items !=  nullptr && evpnmulticast_items->has_data())
...
{
    return is_set(yfilter)
	|| (oper_peer_items !=  nullptr && oper_peer_items->has_operation())
...
{
    if(child_yang_name == "oper_peer-items")
    {
        if(oper_peer_items == nullptr)
        {
            oper_peer_items = std::make_shared<System::EpsItems::OperPeerItems>();
        }
        return oper_peer_items;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> System::EpsItems::get_children() const
{
    ...
    if(oper_peer_items != nullptr)
    {
        _children["oper_peer-items"] = oper_peer_items;
    }
...
{
    if(name == "oper_peer-items" || name == "evpnmulticast-items" || name == "multisite-items" || name == "epId-items")
        return true;
    return false;
}

System::EpsItems::OperPeerItems::OperPeerItems()
    :
    operpeer_list(this, {"ip"})
{

    yang_name = "oper_peer-items"; yang_parent_name = "eps-items"; is_top_level_class = false; has_list_ancestor = false; 
}
...
bool System::EpsItems::OperPeerItems::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<operpeer_list.len(); index++)
    {
        if(operpeer_list[index]->has_data())
            return true;
    }
    return false;
}

bool System::EpsItems::OperPeerItems::has_operation() const
{
    for (std::size_t index=0; index<operpeer_list.len(); index++)
    {
        if(operpeer_list[index]->has_operation())
            return true;
    }
    return is_set(yfilter);
}

std::string System::EpsItems::OperPeerItems::get_absolute_path() const
{
    std::ostringstream path_buffer;
...
std::string System::EpsItems::OperPeerItems::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "oper_peer-items";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > System::EpsItems::OperPeerItems::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> System::EpsItems::OperPeerItems::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "OperPeer-list")
    {
        auto ent_ = std::make_shared<System::EpsItems::OperPeerItems::OperPeerList>();
        ent_->parent = this;
        operpeer_list.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> System::EpsItems::OperPeerItems::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : operpeer_list.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
void System::EpsItems::OperPeerItems::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void System::EpsItems::OperPeerItems::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool System::EpsItems::OperPeerItems::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "OperPeer-list")
        return true;
    return false;
}

System::EpsItems::OperPeerItems::OperPeerList::OperPeerList()
    :
    ip{YType::str, "ip"},
    ...
    operst{YType::enumeration, "operSt"}
        ,
    peer_adj_items(std::make_shared<System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems>())
{
    peer_adj_items->parent = this;

    yang_name = "OperPeer-list"; yang_parent_name = "oper_peer-items"; is_top_level_class = false; has_list_ancestor = false; 
}
...
bool System::EpsItems::OperPeerItems::OperPeerList::has_data() const
{
    if (is_presence_container) return true;
    return ip.is_set
	|| uptime.is_set
	|| createts.is_set
	|| operst.is_set
	|| (peer_adj_items !=  nullptr && peer_adj_items->has_data());
}

bool System::EpsItems::OperPeerItems::OperPeerList::has_operation() const
{
    return is_set(yfilter)
	...
	|| ydk::is_set(operst.yfilter)
	|| (peer_adj_items !=  nullptr && peer_adj_items->has_operation());
}

std::string System::EpsItems::OperPeerItems::OperPeerList::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-NX-OS-device:System/eps-items/oper_peer-items/" << get_segment_path();
    return path_buffer.str();
}

std::string System::EpsItems::OperPeerItems::OperPeerList::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "OperPeer-list";
    ADD_KEY_TOKEN(ip, "ip");
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > System::EpsItems::OperPeerItems::OperPeerList::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> System::EpsItems::OperPeerItems::OperPeerList::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "peer_adj-items")
    {
        if(peer_adj_items == nullptr)
        {
            peer_adj_items = std::make_shared<System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems>();
        }
        return peer_adj_items;
    }

    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> System::EpsItems::OperPeerItems::OperPeerList::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(peer_adj_items != nullptr)
    {
        _children["peer_adj-items"] = peer_adj_items;
    }

    return _children;
}

void System::EpsItems::OperPeerItems::OperPeerList::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ip")
    {
        ip = value;
...
void System::EpsItems::OperPeerItems::OperPeerList::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ip")
    {
        ip.yfilter = yfilter;
...
bool System::EpsItems::OperPeerItems::OperPeerList::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "peer_adj-items" || name == "ip" || name == "upTime" || name == "createTs" || name == "operSt")
        return true;
    return false;
}

System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::PeerAdjItems()
    :
    peeradjacency_list(this, {"eviid"})
{

    yang_name = "peer_adj-items"; yang_parent_name = "OperPeer-list"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<peeradjacency_list.len(); index++)
    {
        if(peeradjacency_list[index]->has_data())
            return true;
    }
    return false;
}

bool System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::has_operation() const
{
    for (std::size_t index=0; index<peeradjacency_list.len(); index++)
    {
        if(peeradjacency_list[index]->has_operation())
            return true;
    }
    return is_set(yfilter);
}

std::string System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "peer_adj-items";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "PeerAdjacency-list")
    {
        auto ent_ = std::make_shared<System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::PeerAdjacencyList>();
        ent_->parent = this;
        peeradjacency_list.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : peeradjacency_list.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
void System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "PeerAdjacency-list")
        return true;
    return false;
}

System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::PeerAdjacencyList::PeerAdjacencyList()
    :
    eviid{YType::uint32, "eviId"},
    egresslbl{YType::uint32, "egressLbl"},
    ownership{YType::str, "ownership"},
    operst{YType::enumeration, "operSt"}
{

    yang_name = "PeerAdjacency-list"; yang_parent_name = "peer_adj-items"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::PeerAdjacencyList::has_data() const
{
    if (is_presence_container) return true;
    return eviid.is_set
	|| egresslbl.is_set
...
bool System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::PeerAdjacencyList::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(eviid.yfilter)
	|| ydk::is_set(egresslbl.yfilter)
	|| ydk::is_set(ownership.yfilter)
	|| ydk::is_set(operst.yfilter);
}

std::string System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::PeerAdjacencyList::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "PeerAdjacency-list";
    ADD_KEY_TOKEN(eviid, "eviId");
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::PeerAdjacencyList::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};

    if (eviid.is_set || is_set(eviid.yfilter)) leaf_name_data.push_back(eviid.get_name_leafdata());
    if (egresslbl.is_set || is_set(egresslbl.yfilter)) leaf_name_data.push_back(egresslbl.get_name_leafdata());
    if (ownership.is_set || is_set(ownership.yfilter)) leaf_name_data.push_back(ownership.get_name_leafdata());
    if (operst.is_set || is_set(operst.yfilter)) leaf_name_data.push_back(operst.get_name_leafdata());
...
std::shared_ptr<ydk::Entity> System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::PeerAdjacencyList::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::PeerAdjacencyList::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::PeerAdjacencyList::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "eviId")
    {
        eviid = value;
    ...
    if(value_path == "egressLbl")
    {
        egresslbl = value;
        egresslbl.value_namespace = name_space;
        egresslbl.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "ownership")
    {
        ownership = value;
        ownership.value_namespace = name_space;
        ownership.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "operSt")
    {
        operst = value;
...
void System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::PeerAdjacencyList::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "eviId")
    {
    ...
    if(value_path == "egressLbl")
    {
        egresslbl.yfilter = yfilter;
    }
    if(value_path == "ownership")
    {
        ownership.yfilter = yfilter;
    }
    if(value_path == "operSt")
    {
        operst.yfilter = yfilter;
...
bool System::EpsItems::OperPeerItems::OperPeerList::PeerAdjItems::PeerAdjacencyList::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "eviId" || name == "egressLbl" || name == "ownership" || name == "operSt")
        return true;
    return false;
}
...
System::EpsItems::EpIdItems::EpList::EpList()
    ...
    anycastintf{YType::str, "anycastIntf"},
    ...
    operstanycastsrcintf{YType::enumeration, "operStAnycastSrcIntf"},
    ...
    primaryipv6{YType::str, "primaryIpv6"},
    secondaryipv6{YType::str, "secondaryIpv6"},
...
bool System::EpsItems::EpIdItems::EpList::has_operation() const
{
	...
	|| ydk::is_set(anycastintf.yfilter)
	...
	|| ydk::is_set(operstanycastsrcintf.yfilter)
	...
	|| ydk::is_set(primaryipv6.yfilter)
	|| ydk::is_set(secondaryipv6.yfilter)
...
std::vector<std::pair<std::string, LeafData> > System::EpsItems::EpIdItems::EpList::get_name_leaf_data() const
{
    ...
    if (anycastintf.is_set || is_set(anycastintf.yfilter)) leaf_name_data.push_back(anycastintf.get_name_leafdata());
    ...
    if (operstanycastsrcintf.is_set || is_set(operstanycastsrcintf.yfilter)) leaf_name_data.push_back(operstanycastsrcintf.get_name_leafdata());
    ...
    if (primaryipv6.is_set || is_set(primaryipv6.yfilter)) leaf_name_data.push_back(primaryipv6.get_name_leafdata());
    if (secondaryipv6.is_set || is_set(secondaryipv6.yfilter)) leaf_name_data.push_back(secondaryipv6.get_name_leafdata());
...
void System::EpsItems::EpIdItems::EpList::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    ...
    if(value_path == "anycastIntf")
    {
        anycastintf = value;
        anycastintf.value_namespace = name_space;
        anycastintf.value_namespace_prefix = name_space_prefix;
    }
    ...
    if(value_path == "operStAnycastSrcIntf")
    {
        operstanycastsrcintf = value;
        operstanycastsrcintf.value_namespace = name_space;
        operstanycastsrcintf.value_namespace_prefix = name_space_prefix;
    }
    ...
    if(value_path == "primaryIpv6")
    {
        primaryipv6 = value;
        primaryipv6.value_namespace = name_space;
        primaryipv6.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "secondaryIpv6")
    {
        secondaryipv6 = value;
        secondaryipv6.value_namespace = name_space;
        secondaryipv6.value_namespace_prefix = name_space_prefix;
    }
...
void System::EpsItems::EpIdItems::EpList::set_filter(const std::string & value_path, YFilter yfilter)
{
    ...
    if(value_path == "operStAnycastSrcIntf")
    {
        operstanycastsrcintf.yfilter = yfilter;
    }
    if(value_path == "operStMultisiteBrdrGwLoopbackIntf")
    {
    ...
    if(value_path == "primaryIpv6")
    {
        primaryipv6.yfilter = yfilter;
    }
    if(value_path == "secondaryIpv6")
    {
        secondaryipv6.yfilter = yfilter;
    }
    if(value_path == "multisiteBrdrGwIntfIp")
    {
...
{
    if(name == "peers-items" || name == "nws-items" || name == "cntrs-items" || name == "rsoperSourceInterface-items" || name == "epId" || name == "adminSt" || name == "descr" || name == "sourceInterface" || name == "anycastIntf" || name == "multisiteBordergwInterface" || name == "holdDownTime" || name == "hostReach" || name == "suppressARP" || name == "mcastGroupL2" || name == "mcastGroupL3" || name == "ingressReplProtoBGP" || name == "advertiseVmac" || name == "virtualMac" || name == "controllerId" || name == "cfgSrc" || name == "encapType" || name == "autoRemapReplicationServers" || name == "operState" || name == "operStSrcLoopbackIntf" || name == "operStAnycastSrcIntf" || name == "operStMultisiteBrdrGwLoopbackIntf" || name == "adminStMultisiteBrdrGwLoopackIntf" || name == "operEncapType" || name == "mac" || name == "virtualRtrMac" || name == "virtualRtrMacReorig" || name == "learningMode" || name == "holdUpTime" || name == "holdDownTimerExpiryTime" || name == "holdUpTimerExpiryTime" || name == "delayRestoreMsBrdrGwExpiryTime" || name == "vpcVIPNotified" || name == "primaryIp" || name == "secondaryIp" || name == "primaryIpv6" || name == "secondaryIpv6" || name == "multisiteBrdrGwIntfIp")
        return true;
    return false;
}
