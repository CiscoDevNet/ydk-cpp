...
Entity* AtmVcm::Nodes::Node::Vcs::Vc::CellPackingData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::Vcs::Vc::CellPackingData::get_children()
{
    return children;
}
...
AtmVcm::Nodes::Node::Vcs::Vc::Vc()
    :
	 ...
	 vpi_xr{YType::uint16, "vpi-xr"}
    	,
    cell_packing_data(std::make_unique<AtmVcm::Nodes::Node::Vcs::Vc::CellPackingData>())
{
    cell_packing_data->parent = this;
    children["cell-packing-data"] = cell_packing_data.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "vc" <<"[interface-name='" <<interface_name.get() <<"']";
...
Entity* AtmVcm::Nodes::Node::Vcs::Vc::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::Vcs::Vc::get_children()
{
...
Entity* AtmVcm::Nodes::Node::Vcs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "vc")
    {
        ...
        auto c = std::make_unique<AtmVcm::Nodes::Node::Vcs::Vc>();
        c->parent = this;
        vc.push_back(std::move(c));
        children[segment_path] = vc.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::Vcs::get_children()
{
    for (auto const & c : vc)
    {
...
Entity* AtmVcm::Nodes::Node::CellPacks::CellPack::CellPacking::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::CellPacks::CellPack::CellPacking::get_children()
{
    return children;
}
...
AtmVcm::Nodes::Node::CellPacks::CellPack::CellPack()
    :
	 ...
	 vpi{YType::uint32, "vpi"}
    	,
    cell_packing(std::make_unique<AtmVcm::Nodes::Node::CellPacks::CellPack::CellPacking>())
{
...
Entity* AtmVcm::Nodes::Node::CellPacks::CellPack::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::CellPacks::CellPack::get_children()
{
...
Entity* AtmVcm::Nodes::Node::CellPacks::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "cell-pack")
    {
        ...
        auto c = std::make_unique<AtmVcm::Nodes::Node::CellPacks::CellPack>();
        c->parent = this;
        cell_pack.push_back(std::move(c));
        children[segment_path] = cell_pack.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::CellPacks::get_children()
{
    for (auto const & c : cell_pack)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* AtmVcm::Nodes::Node::Pvps::Pvp::CellPackingData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::Pvps::Pvp::CellPackingData::get_children()
{
    return children;
}
...
AtmVcm::Nodes::Node::Pvps::Pvp::Pvp()
    :
	 ...
	 vpi_xr{YType::uint16, "vpi-xr"}
    	,
    cell_packing_data(std::make_unique<AtmVcm::Nodes::Node::Pvps::Pvp::CellPackingData>())
{
    cell_packing_data->parent = this;
    children["cell-packing-data"] = cell_packing_data.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "pvp" <<"[interface-name='" <<interface_name.get() <<"']";
...
Entity* AtmVcm::Nodes::Node::Pvps::Pvp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::Pvps::Pvp::get_children()
{
    if(children.find("cell-packing-data") == children.end())
    {
        if(cell_packing_data != nullptr)
...
Entity* AtmVcm::Nodes::Node::Pvps::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "pvp")
    {
        ...
        auto c = std::make_unique<AtmVcm::Nodes::Node::Pvps::Pvp>();
        c->parent = this;
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::Pvps::get_children()
{
    for (auto const & c : pvp)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* AtmVcm::Nodes::Node::ClassLinks::ClassLink::VcClassNotSupported::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::ClassLinks::ClassLink::VcClassNotSupported::get_children()
{
    return children;
}
...
Entity* AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::ClassLinkShaping::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::ClassLinkShaping::get_children()
{
    return children;
}
...
Entity* AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::ClassLinkEncapsulation::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::ClassLinkEncapsulation::get_children()
{
    return children;
}
...
Entity* AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::OamPvc::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::OamPvc::get_children()
{
    return children;
}
...
Entity* AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::OamRetry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::OamRetry::get_children()
{
    return children;
}
...
Entity* AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::AisRdi::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::AisRdi::get_children()
{
    return children;
}
...
AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::OamConfig()
    :
    ais_rdi(std::make_unique<AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::AisRdi>())
	,class_link_encapsulation(std::make_unique<AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::ClassLinkEncapsulation>())
	,class_link_shaping(std::make_unique<AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::ClassLinkShaping>())
	,oam_pvc(std::make_unique<AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::OamPvc>())
	,oam_retry(std::make_unique<AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::OamRetry>())
{
    ais_rdi->parent = this;
    children["ais-rdi"] = ais_rdi.get();

    class_link_encapsulation->parent = this;
    children["class-link-encapsulation"] = class_link_encapsulation.get();

    class_link_shaping->parent = this;
    children["class-link-shaping"] = class_link_shaping.get();

    oam_pvc->parent = this;
    children["oam-pvc"] = oam_pvc.get();

    oam_retry->parent = this;
    children["oam-retry"] = oam_retry.get();
...
Entity* AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::get_children()
{
...
AtmVcm::Nodes::Node::ClassLinks::ClassLink::ClassLink()
    :
	 ...
	 vci{YType::int32, "vci"}
    	,
    oam_config(std::make_unique<AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig>())
	,vc_class_not_supported(std::make_unique<AtmVcm::Nodes::Node::ClassLinks::ClassLink::VcClassNotSupported>())
{
    oam_config->parent = this;
    children["oam-config"] = oam_config.get();

    vc_class_not_supported->parent = this;
    children["vc-class-not-supported"] = vc_class_not_supported.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "class-link" <<"[vpi='" <<vpi.get() <<"']";
...
Entity* AtmVcm::Nodes::Node::ClassLinks::ClassLink::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::ClassLinks::ClassLink::get_children()
{
...
Entity* AtmVcm::Nodes::Node::ClassLinks::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "class-link")
    {
        ...
        auto c = std::make_unique<AtmVcm::Nodes::Node::ClassLinks::ClassLink>();
        c->parent = this;
        class_link.push_back(std::move(c));
        children[segment_path] = class_link.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::ClassLinks::get_children()
{
    for (auto const & c : class_link)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* AtmVcm::Nodes::Node::Interfaces::Interface::CellPackingData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::Interfaces::Interface::CellPackingData::get_children()
{
    return children;
}
...
AtmVcm::Nodes::Node::Interfaces::Interface::Interface()
    :
	 ...
	 pvc_notification_interval{YType::uint32, "pvc-notification-interval"}
    	,
    cell_packing_data(std::make_unique<AtmVcm::Nodes::Node::Interfaces::Interface::CellPackingData>())
{
    cell_packing_data->parent = this;
    children["cell-packing-data"] = cell_packing_data.get();
...
Entity* AtmVcm::Nodes::Node::Interfaces::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::Interfaces::Interface::get_children()
{
    if(children.find("cell-packing-data") == children.end())
    {
        if(cell_packing_data != nullptr)
...
Entity* AtmVcm::Nodes::Node::Interfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "interface")
    {
        ...
        auto c = std::make_unique<AtmVcm::Nodes::Node::Interfaces::Interface>();
        c->parent = this;
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::Interfaces::get_children()
{
    for (auto const & c : interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
{
    std::ostringstream path_buffer;
    path_buffer << "vp-tunnel" <<"[interface-name='" <<interface_name.get() <<"']";
...
Entity* AtmVcm::Nodes::Node::VpTunnels::VpTunnel::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::VpTunnels::VpTunnel::get_children()
{
    return children;
}
...
Entity* AtmVcm::Nodes::Node::VpTunnels::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "vp-tunnel")
    {
        ...
        auto c = std::make_unique<AtmVcm::Nodes::Node::VpTunnels::VpTunnel>();
        c->parent = this;
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::VpTunnels::get_children()
{
    for (auto const & c : vp_tunnel)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
AtmVcm::Nodes::Node::Node()
    :
    	...
    	,
    cell_packs(std::make_unique<AtmVcm::Nodes::Node::CellPacks>())
	,class_links(std::make_unique<AtmVcm::Nodes::Node::ClassLinks>())
	,interfaces(std::make_unique<AtmVcm::Nodes::Node::Interfaces>())
	,pvps(std::make_unique<AtmVcm::Nodes::Node::Pvps>())
	,vcs(std::make_unique<AtmVcm::Nodes::Node::Vcs>())
	,vp_tunnels(std::make_unique<AtmVcm::Nodes::Node::VpTunnels>())
{
    cell_packs->parent = this;
    children["cell-packs"] = cell_packs.get();

    class_links->parent = this;
    children["class-links"] = class_links.get();
...
Entity* AtmVcm::Nodes::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::Nodes::Node::get_children()
{
...
Entity* AtmVcm::Nodes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "node")
    {
        ...
        auto c = std::make_unique<AtmVcm::Nodes::Node>();
        c->parent = this;
...
std::map<std::string, Entity*> & AtmVcm::Nodes::get_children()
{
    for (auto const & c : node)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
AtmVcm::AtmVcm()
    :
    nodes(std::make_unique<AtmVcm::Nodes>())
{
    nodes->parent = this;
...
Entity* AtmVcm::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & AtmVcm::get_children()
{
...
std::unique_ptr<Entity> AtmVcm::clone_ptr()
{
