...
std::string Mfwd::DefaultContext::Ipv6::StaticRpfRules::StaticRpfRule::get_segment_path() const
{
    ...
    path_buffer << "static-rpf-rule" <<"[address='" <<address.get() <<"']" <<"[prefix-mask='" <<prefix_mask.get() <<"']";
...
Entity* Mfwd::DefaultContext::Ipv6::StaticRpfRules::StaticRpfRule::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & Mfwd::DefaultContext::Ipv6::StaticRpfRules::StaticRpfRule::get_children()
{
    return children;
}
...
Entity* Mfwd::DefaultContext::Ipv6::StaticRpfRules::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "static-rpf-rule")
    {
        ...
        auto c = std::make_unique<Mfwd::DefaultContext::Ipv6::StaticRpfRules::StaticRpfRule>();
        c->parent = this;
        static_rpf_rule.push_back(std::move(c));
        children[segment_path] = static_rpf_rule.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Mfwd::DefaultContext::Ipv6::StaticRpfRules::get_children()
{
    for (auto const & c : static_rpf_rule)
    {
...
Entity* Mfwd::DefaultContext::Ipv6::Interfaces::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Mfwd::DefaultContext::Ipv6::Interfaces::Interface::get_children()
{
    return children;
}
...
Entity* Mfwd::DefaultContext::Ipv6::Interfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "interface")
    {
        ...
        auto c = std::make_unique<Mfwd::DefaultContext::Ipv6::Interfaces::Interface>();
        c->parent = this;
...
std::map<std::string, Entity*> & Mfwd::DefaultContext::Ipv6::Interfaces::get_children()
{
    for (auto const & c : interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Mfwd::DefaultContext::Ipv6::Ipv6()
    :
	 ...
	 rate_per_route{YType::empty, "rate-per-route"}
    	,
    interfaces(std::make_unique<Mfwd::DefaultContext::Ipv6::Interfaces>())
	,static_rpf_rules(std::make_unique<Mfwd::DefaultContext::Ipv6::StaticRpfRules>())
{
    interfaces->parent = this;
    children["interfaces"] = interfaces.get();

    static_rpf_rules->parent = this;
    children["static-rpf-rules"] = static_rpf_rules.get();
...
Entity* Mfwd::DefaultContext::Ipv6::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Mfwd::DefaultContext::Ipv6::get_children()
{
...
Entity* Mfwd::DefaultContext::Ipv4::StaticRpfRules::StaticRpfRule::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Mfwd::DefaultContext::Ipv4::StaticRpfRules::StaticRpfRule::get_children()
{
    return children;
}
...
Entity* Mfwd::DefaultContext::Ipv4::StaticRpfRules::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "static-rpf-rule")
    {
        ...
        auto c = std::make_unique<Mfwd::DefaultContext::Ipv4::StaticRpfRules::StaticRpfRule>();
        c->parent = this;
        static_rpf_rule.push_back(std::move(c));
        children[segment_path] = static_rpf_rule.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Mfwd::DefaultContext::Ipv4::StaticRpfRules::get_children()
{
    for (auto const & c : static_rpf_rule)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Mfwd::DefaultContext::Ipv4::Interfaces::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Mfwd::DefaultContext::Ipv4::Interfaces::Interface::get_children()
{
    return children;
}
...
Entity* Mfwd::DefaultContext::Ipv4::Interfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "interface")
    {
        ...
        auto c = std::make_unique<Mfwd::DefaultContext::Ipv4::Interfaces::Interface>();
        c->parent = this;
        interface.push_back(std::move(c));
        children[segment_path] = interface.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Mfwd::DefaultContext::Ipv4::Interfaces::get_children()
{
    for (auto const & c : interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Mfwd::DefaultContext::Ipv4::Ipv4()
    :
	 ...
	 rate_per_route{YType::empty, "rate-per-route"}
    	,
    interfaces(std::make_unique<Mfwd::DefaultContext::Ipv4::Interfaces>())
	,static_rpf_rules(std::make_unique<Mfwd::DefaultContext::Ipv4::StaticRpfRules>())
{
    interfaces->parent = this;
    children["interfaces"] = interfaces.get();
...
Entity* Mfwd::DefaultContext::Ipv4::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Mfwd::DefaultContext::Ipv4::get_children()
{
    if(children.find("interfaces") == children.end())
    {
        if(interfaces != nullptr)
...
Mfwd::DefaultContext::DefaultContext()
    :
    ipv4(std::make_unique<Mfwd::DefaultContext::Ipv4>())
	,ipv6(std::make_unique<Mfwd::DefaultContext::Ipv6>())
{
    ipv4->parent = this;
...
Entity* Mfwd::DefaultContext::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Mfwd::DefaultContext::get_children()
{
...
Entity* Mfwd::Vrfs::Vrf::Ipv6::StaticRpfRules::StaticRpfRule::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Mfwd::Vrfs::Vrf::Ipv6::StaticRpfRules::StaticRpfRule::get_children()
{
    return children;
}
...
Entity* Mfwd::Vrfs::Vrf::Ipv6::StaticRpfRules::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "static-rpf-rule")
    {
        ...
        auto c = std::make_unique<Mfwd::Vrfs::Vrf::Ipv6::StaticRpfRules::StaticRpfRule>();
        c->parent = this;
        static_rpf_rule.push_back(std::move(c));
        children[segment_path] = static_rpf_rule.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Mfwd::Vrfs::Vrf::Ipv6::StaticRpfRules::get_children()
{
    for (auto const & c : static_rpf_rule)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Mfwd::Vrfs::Vrf::Ipv6::Interfaces::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Mfwd::Vrfs::Vrf::Ipv6::Interfaces::Interface::get_children()
{
    return children;
}
...
Entity* Mfwd::Vrfs::Vrf::Ipv6::Interfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "interface")
    {
        ...
        auto c = std::make_unique<Mfwd::Vrfs::Vrf::Ipv6::Interfaces::Interface>();
        c->parent = this;
        interface.push_back(std::move(c));
        children[segment_path] = interface.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Mfwd::Vrfs::Vrf::Ipv6::Interfaces::get_children()
{
    for (auto const & c : interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Mfwd::Vrfs::Vrf::Ipv6::Ipv6()
    :
	 ...
	 rate_per_route{YType::empty, "rate-per-route"}
    	,
    interfaces(std::make_unique<Mfwd::Vrfs::Vrf::Ipv6::Interfaces>())
	,static_rpf_rules(std::make_unique<Mfwd::Vrfs::Vrf::Ipv6::StaticRpfRules>())
{
    interfaces->parent = this;
    children["interfaces"] = interfaces.get();
...
Entity* Mfwd::Vrfs::Vrf::Ipv6::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Mfwd::Vrfs::Vrf::Ipv6::get_children()
{
    if(children.find("interfaces") == children.end())
    {
        if(interfaces != nullptr)
...
Entity* Mfwd::Vrfs::Vrf::Ipv4::StaticRpfRules::StaticRpfRule::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Mfwd::Vrfs::Vrf::Ipv4::StaticRpfRules::StaticRpfRule::get_children()
{
    return children;
}
...
Entity* Mfwd::Vrfs::Vrf::Ipv4::StaticRpfRules::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "static-rpf-rule")
    {
        ...
        auto c = std::make_unique<Mfwd::Vrfs::Vrf::Ipv4::StaticRpfRules::StaticRpfRule>();
        c->parent = this;
        static_rpf_rule.push_back(std::move(c));
        children[segment_path] = static_rpf_rule.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Mfwd::Vrfs::Vrf::Ipv4::StaticRpfRules::get_children()
{
    for (auto const & c : static_rpf_rule)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Mfwd::Vrfs::Vrf::Ipv4::Interfaces::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Mfwd::Vrfs::Vrf::Ipv4::Interfaces::Interface::get_children()
{
    return children;
}
...
Entity* Mfwd::Vrfs::Vrf::Ipv4::Interfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "interface")
    {
        ...
        auto c = std::make_unique<Mfwd::Vrfs::Vrf::Ipv4::Interfaces::Interface>();
        c->parent = this;
        interface.push_back(std::move(c));
        children[segment_path] = interface.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Mfwd::Vrfs::Vrf::Ipv4::Interfaces::get_children()
{
    for (auto const & c : interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Mfwd::Vrfs::Vrf::Ipv4::Ipv4()
    :
	 ...
	 rate_per_route{YType::empty, "rate-per-route"}
    	,
    interfaces(std::make_unique<Mfwd::Vrfs::Vrf::Ipv4::Interfaces>())
	,static_rpf_rules(std::make_unique<Mfwd::Vrfs::Vrf::Ipv4::StaticRpfRules>())
{
    interfaces->parent = this;
    children["interfaces"] = interfaces.get();
...
Entity* Mfwd::Vrfs::Vrf::Ipv4::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Mfwd::Vrfs::Vrf::Ipv4::get_children()
{
    if(children.find("interfaces") == children.end())
    {
        if(interfaces != nullptr)
...
Mfwd::Vrfs::Vrf::Vrf()
    :
    	...
    	,
    ipv4(std::make_unique<Mfwd::Vrfs::Vrf::Ipv4>())
	,ipv6(std::make_unique<Mfwd::Vrfs::Vrf::Ipv6>())
{
    ipv4->parent = this;
    children["ipv4"] = ipv4.get();
...
Entity* Mfwd::Vrfs::Vrf::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Mfwd::Vrfs::Vrf::get_children()
{
    if(children.find("ipv4") == children.end())
    {
        if(ipv4 != nullptr)
...
Entity* Mfwd::Vrfs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "vrf")
    {
        ...
        auto c = std::make_unique<Mfwd::Vrfs::Vrf>();
        c->parent = this;
...
std::map<std::string, Entity*> & Mfwd::Vrfs::get_children()
{
    for (auto const & c : vrf)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Mfwd::Mfwd()
	...
	,vrfs(std::make_unique<Mfwd::Vrfs>())
{
    vrfs->parent = this;
...
Entity* Mfwd::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "default-context")
    {
        ...
        {
            default_context = std::make_unique<Mfwd::DefaultContext>();
...
std::map<std::string, Entity*> & Mfwd::get_children()
{
...
std::unique_ptr<Entity> Mfwd::clone_ptr()
{
