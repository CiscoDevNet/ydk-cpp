...
std::string Ntp::PeerVrfs::PeerVrf::PeerIpv4S::PeerIpv4::PeerTypeIpv4::get_segment_path() const
{
    ...
    path_buffer << "peer-type-ipv4" <<"[peer-type='" <<peer_type.get() <<"']";
...
Entity* Ntp::PeerVrfs::PeerVrf::PeerIpv4S::PeerIpv4::PeerTypeIpv4::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & Ntp::PeerVrfs::PeerVrf::PeerIpv4S::PeerIpv4::PeerTypeIpv4::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "peer-ipv4" <<"[address-ipv4='" <<address_ipv4.get() <<"']";
...
Entity* Ntp::PeerVrfs::PeerVrf::PeerIpv4S::PeerIpv4::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "peer-type-ipv4")
    {
        ...
        auto c = std::make_unique<Ntp::PeerVrfs::PeerVrf::PeerIpv4S::PeerIpv4::PeerTypeIpv4>();
        c->parent = this;
        peer_type_ipv4.push_back(std::move(c));
        children[segment_path] = peer_type_ipv4.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Ntp::PeerVrfs::PeerVrf::PeerIpv4S::PeerIpv4::get_children()
{
    for (auto const & c : peer_type_ipv4)
    {
...
Entity* Ntp::PeerVrfs::PeerVrf::PeerIpv4S::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "peer-ipv4")
    {
        ...
        auto c = std::make_unique<Ntp::PeerVrfs::PeerVrf::PeerIpv4S::PeerIpv4>();
        c->parent = this;
        peer_ipv4.push_back(std::move(c));
        children[segment_path] = peer_ipv4.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Ntp::PeerVrfs::PeerVrf::PeerIpv4S::get_children()
{
    for (auto const & c : peer_ipv4)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
{
    std::ostringstream path_buffer;
    path_buffer << "peer-type-ipv6" <<"[peer-type='" <<peer_type.get() <<"']";
...
Entity* Ntp::PeerVrfs::PeerVrf::PeerIpv6S::PeerIpv6::PeerTypeIpv6::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ntp::PeerVrfs::PeerVrf::PeerIpv6S::PeerIpv6::PeerTypeIpv6::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "peer-ipv6" <<"[address-ipv6='" <<address_ipv6.get() <<"']";
...
Entity* Ntp::PeerVrfs::PeerVrf::PeerIpv6S::PeerIpv6::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "peer-type-ipv6")
    {
        ...
        auto c = std::make_unique<Ntp::PeerVrfs::PeerVrf::PeerIpv6S::PeerIpv6::PeerTypeIpv6>();
        c->parent = this;
        peer_type_ipv6.push_back(std::move(c));
        children[segment_path] = peer_type_ipv6.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Ntp::PeerVrfs::PeerVrf::PeerIpv6S::PeerIpv6::get_children()
{
    for (auto const & c : peer_type_ipv6)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Ntp::PeerVrfs::PeerVrf::PeerIpv6S::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "peer-ipv6")
    {
        ...
        auto c = std::make_unique<Ntp::PeerVrfs::PeerVrf::PeerIpv6S::PeerIpv6>();
        c->parent = this;
        peer_ipv6.push_back(std::move(c));
        children[segment_path] = peer_ipv6.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Ntp::PeerVrfs::PeerVrf::PeerIpv6S::get_children()
{
    for (auto const & c : peer_ipv6)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Ntp::PeerVrfs::PeerVrf::PeerVrf()
    :
    	...
    	,
    peer_ipv4s(std::make_unique<Ntp::PeerVrfs::PeerVrf::PeerIpv4S>())
	,peer_ipv6s(std::make_unique<Ntp::PeerVrfs::PeerVrf::PeerIpv6S>())
{
    peer_ipv4s->parent = this;
    children["peer-ipv4s"] = peer_ipv4s.get();

    peer_ipv6s->parent = this;
    children["peer-ipv6s"] = peer_ipv6s.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "peer-vrf" <<"[vrf-name='" <<vrf_name.get() <<"']";
...
Entity* Ntp::PeerVrfs::PeerVrf::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ntp::PeerVrfs::PeerVrf::get_children()
{
...
Entity* Ntp::PeerVrfs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "peer-vrf")
    {
        ...
        auto c = std::make_unique<Ntp::PeerVrfs::PeerVrf>();
        c->parent = this;
        peer_vrf.push_back(std::move(c));
        children[segment_path] = peer_vrf.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Ntp::PeerVrfs::get_children()
{
    for (auto const & c : peer_vrf)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Ntp::DscpIpv4::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ntp::DscpIpv4::get_children()
{
    return children;
}
...
Entity* Ntp::DscpIpv6::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ntp::DscpIpv6::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "source" <<"[vrf-name='" <<vrf_name.get() <<"']";
...
Entity* Ntp::Sources::Source::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ntp::Sources::Source::get_children()
{
    return children;
}
...
Entity* Ntp::Sources::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "source")
    {
        ...
        auto c = std::make_unique<Ntp::Sources::Source>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ntp::Sources::get_children()
{
    for (auto const & c : source)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
{
    std::ostringstream path_buffer;
    path_buffer << "key" <<"[key-number='" <<key_number.get() <<"']";
...
Entity* Ntp::Authentication::Keies::Key::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ntp::Authentication::Keies::Key::get_children()
{
    return children;
}
...
Entity* Ntp::Authentication::Keies::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "key")
    {
        ...
        auto c = std::make_unique<Ntp::Authentication::Keies::Key>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ntp::Authentication::Keies::get_children()
{
    for (auto const & c : key)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
{
    std::ostringstream path_buffer;
    path_buffer << "trusted-key" <<"[key-number='" <<key_number.get() <<"']";
...
Entity* Ntp::Authentication::TrustedKeies::TrustedKey::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ntp::Authentication::TrustedKeies::TrustedKey::get_children()
{
    return children;
}
...
Entity* Ntp::Authentication::TrustedKeies::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "trusted-key")
    {
        ...
        auto c = std::make_unique<Ntp::Authentication::TrustedKeies::TrustedKey>();
        c->parent = this;
        trusted_key.push_back(std::move(c));
        children[segment_path] = trusted_key.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Ntp::Authentication::TrustedKeies::get_children()
{
    for (auto const & c : trusted_key)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Ntp::Authentication::Authentication()
    :
    	...
    	,
    keies(std::make_unique<Ntp::Authentication::Keies>())
	,trusted_keies(std::make_unique<Ntp::Authentication::TrustedKeies>())
{
    keies->parent = this;
    children["keies"] = keies.get();

    trusted_keies->parent = this;
    children["trusted-keies"] = trusted_keies.get();
...
Entity* Ntp::Authentication::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ntp::Authentication::get_children()
{
...
Entity* Ntp::Passive::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ntp::Passive::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "multicast-client" <<"[ip-address='" <<ip_address.get() <<"']";
...
Entity* Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceMulticast::MulticastClients::MulticastClient::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceMulticast::MulticastClients::MulticastClient::get_children()
{
    return children;
}
...
Entity* Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceMulticast::MulticastClients::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "multicast-client")
    {
        ...
        auto c = std::make_unique<Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceMulticast::MulticastClients::MulticastClient>();
        c->parent = this;
        multicast_client.push_back(std::move(c));
        children[segment_path] = multicast_client.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceMulticast::MulticastClients::get_children()
{
    for (auto const & c : multicast_client)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
{
    std::ostringstream path_buffer;
    path_buffer << "multicast-server" <<"[ip-address='" <<ip_address.get() <<"']";
...
Entity* Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceMulticast::MulticastServers::MulticastServer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceMulticast::MulticastServers::MulticastServer::get_children()
{
    return children;
}
...
Entity* Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceMulticast::MulticastServers::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "multicast-server")
    {
        ...
        auto c = std::make_unique<Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceMulticast::MulticastServers::MulticastServer>();
        c->parent = this;
        multicast_server.push_back(std::move(c));
        children[segment_path] = multicast_server.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceMulticast::MulticastServers::get_children()
{
    for (auto const & c : multicast_server)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceMulticast::InterfaceMulticast()
    :
    multicast_clients(std::make_unique<Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceMulticast::MulticastClients>())
	,multicast_servers(std::make_unique<Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceMulticast::MulticastServers>())
{
    multicast_clients->parent = this;
    children["multicast-clients"] = multicast_clients.get();

    multicast_servers->parent = this;
    children["multicast-servers"] = multicast_servers.get();
...
Entity* Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceMulticast::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceMulticast::get_children()
{
...
Entity* Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceBroadcast::Broadcast::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceBroadcast::Broadcast::get_children()
{
    return children;
}
...
Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceBroadcast::InterfaceBroadcast()
    :
    	...
    	,
    broadcast(std::make_unique<Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceBroadcast::Broadcast>())
{
    broadcast->parent = this;
    children["broadcast"] = broadcast.get();
...
Entity* Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceBroadcast::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceBroadcast::get_children()
{
...
Ntp::InterfaceTables::InterfaceTable::Interface::Interface()
    :
	 ...
	 disable{YType::empty, "disable"}
    	,
    interface_broadcast(std::make_unique<Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceBroadcast>())
	,interface_multicast(std::make_unique<Ntp::InterfaceTables::InterfaceTable::Interface::InterfaceMulticast>())
{
    interface_broadcast->parent = this;
    children["interface-broadcast"] = interface_broadcast.get();

    interface_multicast->parent = this;
    children["interface-multicast"] = interface_multicast.get();
...
Entity* Ntp::InterfaceTables::InterfaceTable::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ntp::InterfaceTables::InterfaceTable::Interface::get_children()
{
...
{
    std::ostringstream path_buffer;
    path_buffer << "interface-table" <<"[vrf-name='" <<vrf_name.get() <<"']";
...
Entity* Ntp::InterfaceTables::InterfaceTable::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "interface")
    {
        ...
        auto c = std::make_unique<Ntp::InterfaceTables::InterfaceTable::Interface>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ntp::InterfaceTables::InterfaceTable::get_children()
{
    for (auto const & c : interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Ntp::InterfaceTables::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "interface-table")
    {
        ...
        auto c = std::make_unique<Ntp::InterfaceTables::InterfaceTable>();
        c->parent = this;
        interface_table.push_back(std::move(c));
        children[segment_path] = interface_table.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Ntp::InterfaceTables::get_children()
{
    for (auto const & c : interface_table)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
{
    std::ostringstream path_buffer;
    path_buffer << "access-group" <<"[access-group-type='" <<access_group_type.get() <<"']";
...
Entity* Ntp::AccessGroupTables::AccessGroupTable::AccessGroupAfTable::AccessGroup::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ntp::AccessGroupTables::AccessGroupTable::AccessGroupAfTable::AccessGroup::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "access-group-af-table" <<"[af='" <<af.get() <<"']";
...
Entity* Ntp::AccessGroupTables::AccessGroupTable::AccessGroupAfTable::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "access-group")
    {
        ...
        auto c = std::make_unique<Ntp::AccessGroupTables::AccessGroupTable::AccessGroupAfTable::AccessGroup>();
        c->parent = this;
        access_group.push_back(std::move(c));
        children[segment_path] = access_group.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Ntp::AccessGroupTables::AccessGroupTable::AccessGroupAfTable::get_children()
{
    for (auto const & c : access_group)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
{
    std::ostringstream path_buffer;
    path_buffer << "access-group-table" <<"[vrf-name='" <<vrf_name.get() <<"']";
...
Entity* Ntp::AccessGroupTables::AccessGroupTable::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "access-group-af-table")
    {
        ...
        auto c = std::make_unique<Ntp::AccessGroupTables::AccessGroupTable::AccessGroupAfTable>();
        c->parent = this;
        access_group_af_table.push_back(std::move(c));
        children[segment_path] = access_group_af_table.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Ntp::AccessGroupTables::AccessGroupTable::get_children()
{
    for (auto const & c : access_group_af_table)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Ntp::AccessGroupTables::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "access-group-table")
    {
        ...
        auto c = std::make_unique<Ntp::AccessGroupTables::AccessGroupTable>();
        c->parent = this;
        access_group_table.push_back(std::move(c));
        children[segment_path] = access_group_table.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Ntp::AccessGroupTables::get_children()
{
    for (auto const & c : access_group_table)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Ntp::Ntp()
    :
	 ...
	 update_calendar{YType::empty, "update-calendar"}
    	,
    access_group_tables(std::make_unique<Ntp::AccessGroupTables>())
	,authentication(std::make_unique<Ntp::Authentication>())
	,dscp_ipv4(nullptr) // presence node
	,dscp_ipv6(nullptr) // presence node
	,interface_tables(std::make_unique<Ntp::InterfaceTables>())
	,passive(std::make_unique<Ntp::Passive>())
	,peer_vrfs(std::make_unique<Ntp::PeerVrfs>())
	,sources(std::make_unique<Ntp::Sources>())
{
    access_group_tables->parent = this;
    children["access-group-tables"] = access_group_tables.get();

    authentication->parent = this;
    children["authentication"] = authentication.get();

    interface_tables->parent = this;
    children["interface-tables"] = interface_tables.get();

    passive->parent = this;
    children["passive"] = passive.get();

    peer_vrfs->parent = this;
    children["peer-vrfs"] = peer_vrfs.get();
...
Entity* Ntp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "dscp-ipv4")
    {
        ...
        {
            children["dscp-ipv4"] = dscp_ipv4.get();
        }
        else
        {
            dscp_ipv4 = std::make_unique<Ntp::DscpIpv4>();
    ...
    if(child_yang_name == "dscp-ipv6")
    {
        ...
        {
            children["dscp-ipv6"] = dscp_ipv6.get();
        }
        else
        {
            dscp_ipv6 = std::make_unique<Ntp::DscpIpv6>();
