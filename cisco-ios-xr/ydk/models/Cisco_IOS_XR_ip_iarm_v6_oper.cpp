...
Entity* Ipv6Arm::Addresses::Vrfs::Vrf::Networks::Network::AddressXr::Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & Ipv6Arm::Addresses::Vrfs::Vrf::Networks::Network::AddressXr::Address::get_children()
{
    return children;
}
...
Ipv6Arm::Addresses::Vrfs::Vrf::Networks::Network::AddressXr::AddressXr()
    :
	 ...
	 route_tag{YType::uint32, "route-tag"}
    	,
    address(std::make_unique<Ipv6Arm::Addresses::Vrfs::Vrf::Networks::Network::AddressXr::Address>())
{
    address->parent = this;
...
Entity* Ipv6Arm::Addresses::Vrfs::Vrf::Networks::Network::AddressXr::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6Arm::Addresses::Vrfs::Vrf::Networks::Network::AddressXr::get_children()
{
...
Ipv6Arm::Addresses::Vrfs::Vrf::Networks::Network::Network()
    :
	 ...
	 vrf_name{YType::str, "vrf-name"}
    	,
    address_xr(std::make_unique<Ipv6Arm::Addresses::Vrfs::Vrf::Networks::Network::AddressXr>())
{
...
Entity* Ipv6Arm::Addresses::Vrfs::Vrf::Networks::Network::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6Arm::Addresses::Vrfs::Vrf::Networks::Network::get_children()
{
...
Entity* Ipv6Arm::Addresses::Vrfs::Vrf::Networks::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "network")
    {
        ...
        auto c = std::make_unique<Ipv6Arm::Addresses::Vrfs::Vrf::Networks::Network>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ipv6Arm::Addresses::Vrfs::Vrf::Networks::get_children()
{
    for (auto const & c : network)
    {
...
Entity* Ipv6Arm::Addresses::Vrfs::Vrf::Interfaces::Interface::Address::Address_::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6Arm::Addresses::Vrfs::Vrf::Interfaces::Interface::Address::Address_::get_children()
{
    return children;
}
...
Ipv6Arm::Addresses::Vrfs::Vrf::Interfaces::Interface::Address::Address()
    :
	 ...
	 route_tag{YType::uint32, "route-tag"}
    	,
    address(std::make_unique<Ipv6Arm::Addresses::Vrfs::Vrf::Interfaces::Interface::Address::Address_>())
{
    address->parent = this;
    children["address"] = address.get();
...
Entity* Ipv6Arm::Addresses::Vrfs::Vrf::Interfaces::Interface::Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6Arm::Addresses::Vrfs::Vrf::Interfaces::Interface::Address::get_children()
{
    if(children.find("address") == children.end())
    {
        if(address != nullptr)
...
Entity* Ipv6Arm::Addresses::Vrfs::Vrf::Interfaces::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "address")
    {
        ...
        auto c = std::make_unique<Ipv6Arm::Addresses::Vrfs::Vrf::Interfaces::Interface::Address>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ipv6Arm::Addresses::Vrfs::Vrf::Interfaces::Interface::get_children()
{
    for (auto const & c : address)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Ipv6Arm::Addresses::Vrfs::Vrf::Interfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "interface")
    {
        ...
        auto c = std::make_unique<Ipv6Arm::Addresses::Vrfs::Vrf::Interfaces::Interface>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ipv6Arm::Addresses::Vrfs::Vrf::Interfaces::get_children()
{
    for (auto const & c : interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Ipv6Arm::Addresses::Vrfs::Vrf::Vrf()
    :
    	vrf_name{YType::str, "vrf-name"}
    	,
    interfaces(std::make_unique<Ipv6Arm::Addresses::Vrfs::Vrf::Interfaces>())
	,networks(std::make_unique<Ipv6Arm::Addresses::Vrfs::Vrf::Networks>())
{
...
Entity* Ipv6Arm::Addresses::Vrfs::Vrf::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6Arm::Addresses::Vrfs::Vrf::get_children()
{
...
Entity* Ipv6Arm::Addresses::Vrfs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "vrf")
    {
        ...
        auto c = std::make_unique<Ipv6Arm::Addresses::Vrfs::Vrf>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ipv6Arm::Addresses::Vrfs::get_children()
{
    for (auto const & c : vrf)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Ipv6Arm::Addresses::Addresses()
    :
    vrfs(std::make_unique<Ipv6Arm::Addresses::Vrfs>())
{
    vrfs->parent = this;
...
Entity* Ipv6Arm::Addresses::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6Arm::Addresses::get_children()
{
...
Entity* Ipv6Arm::Summary::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6Arm::Summary::get_children()
{
    return children;
}
...
Entity* Ipv6Arm::VrfSummaries::VrfSummary::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6Arm::VrfSummaries::VrfSummary::get_children()
{
    return children;
}
...
Entity* Ipv6Arm::VrfSummaries::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "vrf-summary")
    {
        ...
        auto c = std::make_unique<Ipv6Arm::VrfSummaries::VrfSummary>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ipv6Arm::VrfSummaries::get_children()
{
    for (auto const & c : vrf_summary)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Ipv6Arm::Ipv6Arm()
    :
    	...
    	,
    addresses(std::make_unique<Ipv6Arm::Addresses>())
	,summary(std::make_unique<Ipv6Arm::Summary>())
	,vrf_summaries(std::make_unique<Ipv6Arm::VrfSummaries>())
{
...
Entity* Ipv6Arm::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6Arm::get_children()
{
...
std::unique_ptr<Entity> Ipv6Arm::clone_ptr()
{
    return std::make_unique<Ipv6Arm>();
}
