...
Entity* EsAcl::Accesses::Access::AccessListEntries::AccessListEntry::SourceNetwork::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & EsAcl::Accesses::Access::AccessListEntries::AccessListEntry::SourceNetwork::get_children()
{
    return children;
}
...
Entity* EsAcl::Accesses::Access::AccessListEntries::AccessListEntry::DestinationNetwork::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & EsAcl::Accesses::Access::AccessListEntries::AccessListEntry::DestinationNetwork::get_children()
{
    return children;
}
...
EsAcl::Accesses::Access::AccessListEntries::AccessListEntry::AccessListEntry()
    :
	 ...
	 vlan2{YType::uint16, "vlan2"}
    	,
    destination_network(std::make_unique<EsAcl::Accesses::Access::AccessListEntries::AccessListEntry::DestinationNetwork>())
	,source_network(std::make_unique<EsAcl::Accesses::Access::AccessListEntries::AccessListEntry::SourceNetwork>())
{
...
Entity* EsAcl::Accesses::Access::AccessListEntries::AccessListEntry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & EsAcl::Accesses::Access::AccessListEntries::AccessListEntry::get_children()
{
...
Entity* EsAcl::Accesses::Access::AccessListEntries::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "access-list-entry")
    {
        ...
        auto c = std::make_unique<EsAcl::Accesses::Access::AccessListEntries::AccessListEntry>();
        c->parent = this;
...
std::map<std::string, Entity*> & EsAcl::Accesses::Access::AccessListEntries::get_children()
{
    for (auto const & c : access_list_entry)
    {
...
EsAcl::Accesses::Access::Access()
    :
    	name{YType::str, "name"}
    	,
    access_list_entries(std::make_unique<EsAcl::Accesses::Access::AccessListEntries>())
{
...
Entity* EsAcl::Accesses::Access::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & EsAcl::Accesses::Access::get_children()
{
...
Entity* EsAcl::Accesses::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "access")
    {
        ...
        auto c = std::make_unique<EsAcl::Accesses::Access>();
        c->parent = this;
...
std::map<std::string, Entity*> & EsAcl::Accesses::get_children()
{
    for (auto const & c : access)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EsAcl::EsAcl()
    :
    accesses(std::make_unique<EsAcl::Accesses>())
{
