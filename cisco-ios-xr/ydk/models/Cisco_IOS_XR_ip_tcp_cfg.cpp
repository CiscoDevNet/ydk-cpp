...
Entity* IpTcp::Directory::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & IpTcp::Directory::get_children()
{
    return children;
}
...
Entity* IpTcp::Throttle::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & IpTcp::Throttle::get_children()
{
    return children;
}
...
Entity* IpTcp::NumThread::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & IpTcp::NumThread::get_children()
{
    return children;
}
...
Entity* IpTcp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "directory")
    {
        ...
        {
            directory = std::make_unique<IpTcp::Directory>();
    ...
    if(child_yang_name == "num-thread")
    {
        ...
        {
            num_thread = std::make_unique<IpTcp::NumThread>();
    ...
    if(child_yang_name == "throttle")
    {
        ...
        {
            throttle = std::make_unique<IpTcp::Throttle>();
...
std::map<std::string, Entity*> & IpTcp::get_children()
{
...
std::unique_ptr<Entity> IpTcp::clone_ptr()
{
    return std::make_unique<IpTcp>();
}
...
Entity* Ip::Cinetd::Services::Ipv4::SmallServers::TcpSmallServers::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Ipv4::SmallServers::TcpSmallServers::get_children()
{
    return children;
}
...
Entity* Ip::Cinetd::Services::Ipv4::SmallServers::UdpSmallServers::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Ipv4::SmallServers::UdpSmallServers::get_children()
{
    return children;
}
...
Entity* Ip::Cinetd::Services::Ipv4::SmallServers::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "tcp-small-servers")
    {
        ...
        {
            children["tcp-small-servers"] = tcp_small_servers.get();
        }
        else
        {
            tcp_small_servers = std::make_unique<Ip::Cinetd::Services::Ipv4::SmallServers::TcpSmallServers>();
    ...
    if(child_yang_name == "udp-small-servers")
    {
        ...
        {
            children["udp-small-servers"] = udp_small_servers.get();
        }
        else
        {
            udp_small_servers = std::make_unique<Ip::Cinetd::Services::Ipv4::SmallServers::UdpSmallServers>();
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Ipv4::SmallServers::get_children()
{
...
Ip::Cinetd::Services::Ipv4::Ipv4()
    :
    small_servers(std::make_unique<Ip::Cinetd::Services::Ipv4::SmallServers>())
{
    small_servers->parent = this;
    children["small-servers"] = small_servers.get();
...
Entity* Ip::Cinetd::Services::Ipv4::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Ipv4::get_children()
{
...
Entity* Ip::Cinetd::Services::Vrfs::Vrf::Ipv6::Telnet::Tcp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Vrfs::Vrf::Ipv6::Telnet::Tcp::get_children()
{
    return children;
}
...
Entity* Ip::Cinetd::Services::Vrfs::Vrf::Ipv6::Telnet::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "tcp")
    {
        ...
        {
            tcp = std::make_unique<Ip::Cinetd::Services::Vrfs::Vrf::Ipv6::Telnet::Tcp>();
            tcp->parent = this;
            children["tcp"] = tcp.get();
        }
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Vrfs::Vrf::Ipv6::Telnet::get_children()
{
...
Entity* Ip::Cinetd::Services::Vrfs::Vrf::Ipv6::Tftp::Udp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Vrfs::Vrf::Ipv6::Tftp::Udp::get_children()
{
    return children;
}
...
Entity* Ip::Cinetd::Services::Vrfs::Vrf::Ipv6::Tftp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "udp")
    {
        ...
        {
            udp = std::make_unique<Ip::Cinetd::Services::Vrfs::Vrf::Ipv6::Tftp::Udp>();
            udp->parent = this;
            children["udp"] = udp.get();
        }
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Vrfs::Vrf::Ipv6::Tftp::get_children()
{
...
Ip::Cinetd::Services::Vrfs::Vrf::Ipv6::Ipv6()
    :
    telnet(std::make_unique<Ip::Cinetd::Services::Vrfs::Vrf::Ipv6::Telnet>())
	,tftp(std::make_unique<Ip::Cinetd::Services::Vrfs::Vrf::Ipv6::Tftp>())
{
    telnet->parent = this;
    children["telnet"] = telnet.get();

    tftp->parent = this;
    children["tftp"] = tftp.get();
...
Entity* Ip::Cinetd::Services::Vrfs::Vrf::Ipv6::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Vrfs::Vrf::Ipv6::get_children()
{
...
Entity* Ip::Cinetd::Services::Vrfs::Vrf::Ipv4::Telnet::Tcp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Vrfs::Vrf::Ipv4::Telnet::Tcp::get_children()
{
    return children;
}
...
Entity* Ip::Cinetd::Services::Vrfs::Vrf::Ipv4::Telnet::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "tcp")
    {
        ...
        {
            tcp = std::make_unique<Ip::Cinetd::Services::Vrfs::Vrf::Ipv4::Telnet::Tcp>();
            tcp->parent = this;
            children["tcp"] = tcp.get();
        }
        return children.at("tcp");
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Vrfs::Vrf::Ipv4::Telnet::get_children()
{
    if(children.find("tcp") == children.end())
    {
        if(tcp != nullptr)
...
Entity* Ip::Cinetd::Services::Vrfs::Vrf::Ipv4::Tftp::Udp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Vrfs::Vrf::Ipv4::Tftp::Udp::get_children()
{
    return children;
}
...
Entity* Ip::Cinetd::Services::Vrfs::Vrf::Ipv4::Tftp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "udp")
    {
        ...
        {
            udp = std::make_unique<Ip::Cinetd::Services::Vrfs::Vrf::Ipv4::Tftp::Udp>();
            udp->parent = this;
            children["udp"] = udp.get();
        }
        return children.at("udp");
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Vrfs::Vrf::Ipv4::Tftp::get_children()
{
    if(children.find("udp") == children.end())
    {
        if(udp != nullptr)
...
Ip::Cinetd::Services::Vrfs::Vrf::Ipv4::Ipv4()
    :
    telnet(std::make_unique<Ip::Cinetd::Services::Vrfs::Vrf::Ipv4::Telnet>())
	,tftp(std::make_unique<Ip::Cinetd::Services::Vrfs::Vrf::Ipv4::Tftp>())
{
    telnet->parent = this;
    children["telnet"] = telnet.get();
...
Entity* Ip::Cinetd::Services::Vrfs::Vrf::Ipv4::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Vrfs::Vrf::Ipv4::get_children()
{
    if(children.find("telnet") == children.end())
    {
        if(telnet != nullptr)
...
Ip::Cinetd::Services::Vrfs::Vrf::Vrf()
    :
    	...
    	,
    ipv4(std::make_unique<Ip::Cinetd::Services::Vrfs::Vrf::Ipv4>())
	,ipv6(std::make_unique<Ip::Cinetd::Services::Vrfs::Vrf::Ipv6>())
{
    ipv4->parent = this;
...
Entity* Ip::Cinetd::Services::Vrfs::Vrf::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Vrfs::Vrf::get_children()
{
...
Entity* Ip::Cinetd::Services::Vrfs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "vrf")
    {
        ...
        auto c = std::make_unique<Ip::Cinetd::Services::Vrfs::Vrf>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Vrfs::get_children()
{
    for (auto const & c : vrf)
    {
...
Entity* Ip::Cinetd::Services::Ipv6::SmallServers::TcpSmallServers::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Ipv6::SmallServers::TcpSmallServers::get_children()
{
    return children;
}
...
Entity* Ip::Cinetd::Services::Ipv6::SmallServers::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "tcp-small-servers")
    {
        ...
        {
            tcp_small_servers = std::make_unique<Ip::Cinetd::Services::Ipv6::SmallServers::TcpSmallServers>();
            tcp_small_servers->parent = this;
            children["tcp-small-servers"] = tcp_small_servers.get();
        }
        return children.at("tcp-small-servers");
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Ipv6::SmallServers::get_children()
{
    if(children.find("tcp-small-servers") == children.end())
    {
        if(tcp_small_servers != nullptr)
...
Ip::Cinetd::Services::Ipv6::Ipv6()
    :
    small_servers(std::make_unique<Ip::Cinetd::Services::Ipv6::SmallServers>())
{
    small_servers->parent = this;
    children["small-servers"] = small_servers.get();
...
Entity* Ip::Cinetd::Services::Ipv6::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::Ipv6::get_children()
{
    if(children.find("small-servers") == children.end())
    {
        if(small_servers != nullptr)
...
Ip::Cinetd::Services::Services()
    :
    ipv4(std::make_unique<Ip::Cinetd::Services::Ipv4>())
	,ipv6(std::make_unique<Ip::Cinetd::Services::Ipv6>())
	,vrfs(std::make_unique<Ip::Cinetd::Services::Vrfs>())
{
    ipv4->parent = this;
    children["ipv4"] = ipv4.get();
...
Entity* Ip::Cinetd::Services::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::Cinetd::Services::get_children()
{
    if(children.find("ipv4") == children.end())
    {
        if(ipv4 != nullptr)
...
Ip::Cinetd::Cinetd()
    :
    services(std::make_unique<Ip::Cinetd::Services>())
{
...
Entity* Ip::Cinetd::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::Cinetd::get_children()
{
...
{
    std::ostringstream path_buffer;
    path_buffer << "port" <<"[port-id='" <<port_id.get() <<"']";
...
Entity* Ip::ForwardProtocol::Udp::Ports::Port::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::ForwardProtocol::Udp::Ports::Port::get_children()
{
    return children;
}
...
Entity* Ip::ForwardProtocol::Udp::Ports::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "port")
    {
        ...
        auto c = std::make_unique<Ip::ForwardProtocol::Udp::Ports::Port>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ip::ForwardProtocol::Udp::Ports::get_children()
{
    for (auto const & c : port)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Ip::ForwardProtocol::Udp::Udp()
    :
    	...
    	,
    ports(std::make_unique<Ip::ForwardProtocol::Udp::Ports>())
{
    ports->parent = this;
...
Entity* Ip::ForwardProtocol::Udp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::ForwardProtocol::Udp::get_children()
{
...
Ip::ForwardProtocol::ForwardProtocol()
    :
    udp(std::make_unique<Ip::ForwardProtocol::Udp>())
{
    udp->parent = this;
    children["udp"] = udp.get();
...
Entity* Ip::ForwardProtocol::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::ForwardProtocol::get_children()
{
    if(children.find("udp") == children.end())
    {
        if(udp != nullptr)
...
Ip::Ip()
    :
    cinetd(std::make_unique<Ip::Cinetd>())
	,forward_protocol(std::make_unique<Ip::ForwardProtocol>())
{
    cinetd->parent = this;
    children["cinetd"] = cinetd.get();

    forward_protocol->parent = this;
    children["forward-protocol"] = forward_protocol.get();
...
Entity* Ip::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ip::get_children()
{
...
std::unique_ptr<Entity> Ip::clone_ptr()
{
