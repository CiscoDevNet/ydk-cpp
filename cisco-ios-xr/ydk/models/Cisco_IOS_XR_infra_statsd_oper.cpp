...
EntityPath InfraStatistics::Interfaces::Interface::Cache::Protocols::Protocol::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Cache::Protocols::Protocol::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Cache::Protocols::Protocol::get_children()
{
    return children;
}
...
EntityPath InfraStatistics::Interfaces::Interface::Cache::Protocols::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Cache::Protocols::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "protocol")
    {
        ...
        auto c = std::make_unique<InfraStatistics::Interfaces::Interface::Cache::Protocols::Protocol>();
        c->parent = this;
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Cache::Protocols::get_children()
{
    for (auto const & c : protocol)
    {
...
EntityPath InfraStatistics::Interfaces::Interface::Cache::InterfacesMibCounters::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Cache::InterfacesMibCounters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Cache::InterfacesMibCounters::get_children()
{
    return children;
}
...
EntityPath InfraStatistics::Interfaces::Interface::Cache::DataRate::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Cache::DataRate::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Cache::DataRate::get_children()
{
    return children;
}
...
EntityPath InfraStatistics::Interfaces::Interface::Cache::GenericCounters::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Cache::GenericCounters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Cache::GenericCounters::get_children()
{
    return children;
}
...
InfraStatistics::Interfaces::Interface::Cache::Cache()
    :
    data_rate(std::make_unique<InfraStatistics::Interfaces::Interface::Cache::DataRate>())
	,generic_counters(std::make_unique<InfraStatistics::Interfaces::Interface::Cache::GenericCounters>())
	,interfaces_mib_counters(std::make_unique<InfraStatistics::Interfaces::Interface::Cache::InterfacesMibCounters>())
	,protocols(std::make_unique<InfraStatistics::Interfaces::Interface::Cache::Protocols>())
{
    data_rate->parent = this;
    children["data-rate"] = data_rate.get();

    generic_counters->parent = this;
    children["generic-counters"] = generic_counters.get();

    interfaces_mib_counters->parent = this;
    children["interfaces-mib-counters"] = interfaces_mib_counters.get();
...
EntityPath InfraStatistics::Interfaces::Interface::Cache::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Cache::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "interfaces-mib-counters")
    {
        ...
        return children.at("interfaces-mib-counters");
    }
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Cache::get_children()
{
    if(children.find("data-rate") == children.end())
    {
        if(data_rate != nullptr)
        {
            children["data-rate"] = data_rate.get();
    ...
    if(children.find("interfaces-mib-counters") == children.end())
    {
        if(interfaces_mib_counters != nullptr)
        {
            children["interfaces-mib-counters"] = interfaces_mib_counters.get();
...
EntityPath InfraStatistics::Interfaces::Interface::Latest::Protocols::Protocol::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Latest::Protocols::Protocol::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Latest::Protocols::Protocol::get_children()
{
    return children;
}
...
EntityPath InfraStatistics::Interfaces::Interface::Latest::Protocols::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Latest::Protocols::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "protocol")
    {
        ...
        auto c = std::make_unique<InfraStatistics::Interfaces::Interface::Latest::Protocols::Protocol>();
        c->parent = this;
        protocol.push_back(std::move(c));
        children[segment_path] = protocol.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Latest::Protocols::get_children()
{
    for (auto const & c : protocol)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath InfraStatistics::Interfaces::Interface::Latest::InterfacesMibCounters::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Latest::InterfacesMibCounters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Latest::InterfacesMibCounters::get_children()
{
    return children;
}
...
EntityPath InfraStatistics::Interfaces::Interface::Latest::DataRate::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Latest::DataRate::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Latest::DataRate::get_children()
{
    return children;
}
...
EntityPath InfraStatistics::Interfaces::Interface::Latest::GenericCounters::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Latest::GenericCounters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Latest::GenericCounters::get_children()
{
    return children;
}
...
InfraStatistics::Interfaces::Interface::Latest::Latest()
    :
    data_rate(std::make_unique<InfraStatistics::Interfaces::Interface::Latest::DataRate>())
	,generic_counters(std::make_unique<InfraStatistics::Interfaces::Interface::Latest::GenericCounters>())
	,interfaces_mib_counters(std::make_unique<InfraStatistics::Interfaces::Interface::Latest::InterfacesMibCounters>())
	,protocols(std::make_unique<InfraStatistics::Interfaces::Interface::Latest::Protocols>())
{
    data_rate->parent = this;
    children["data-rate"] = data_rate.get();
...
EntityPath InfraStatistics::Interfaces::Interface::Latest::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Latest::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Latest::get_children()
{
    if(children.find("data-rate") == children.end())
    {
        if(data_rate != nullptr)
...
EntityPath InfraStatistics::Interfaces::Interface::Total::Protocols::Protocol::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Total::Protocols::Protocol::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Total::Protocols::Protocol::get_children()
{
    return children;
}
...
EntityPath InfraStatistics::Interfaces::Interface::Total::Protocols::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Total::Protocols::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "protocol")
    {
        ...
        auto c = std::make_unique<InfraStatistics::Interfaces::Interface::Total::Protocols::Protocol>();
        c->parent = this;
        protocol.push_back(std::move(c));
        children[segment_path] = protocol.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Total::Protocols::get_children()
{
    for (auto const & c : protocol)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath InfraStatistics::Interfaces::Interface::Total::InterfacesMibCounters::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Total::InterfacesMibCounters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Total::InterfacesMibCounters::get_children()
{
    return children;
}
...
EntityPath InfraStatistics::Interfaces::Interface::Total::DataRate::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Total::DataRate::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Total::DataRate::get_children()
{
    return children;
}
...
EntityPath InfraStatistics::Interfaces::Interface::Total::GenericCounters::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Total::GenericCounters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Total::GenericCounters::get_children()
{
    return children;
}
...
InfraStatistics::Interfaces::Interface::Total::Total()
    :
    data_rate(std::make_unique<InfraStatistics::Interfaces::Interface::Total::DataRate>())
	,generic_counters(std::make_unique<InfraStatistics::Interfaces::Interface::Total::GenericCounters>())
	,interfaces_mib_counters(std::make_unique<InfraStatistics::Interfaces::Interface::Total::InterfacesMibCounters>())
	,protocols(std::make_unique<InfraStatistics::Interfaces::Interface::Total::Protocols>())
{
    data_rate->parent = this;
    children["data-rate"] = data_rate.get();
...
EntityPath InfraStatistics::Interfaces::Interface::Total::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Total::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Total::get_children()
{
    if(children.find("data-rate") == children.end())
    {
        if(data_rate != nullptr)
...
EntityPath InfraStatistics::Interfaces::Interface::Protocols::Protocol::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Protocols::Protocol::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Protocols::Protocol::get_children()
{
    return children;
}
...
EntityPath InfraStatistics::Interfaces::Interface::Protocols::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::Protocols::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "protocol")
    {
        ...
        auto c = std::make_unique<InfraStatistics::Interfaces::Interface::Protocols::Protocol>();
        c->parent = this;
        protocol.push_back(std::move(c));
        children[segment_path] = protocol.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::Protocols::get_children()
{
    for (auto const & c : protocol)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath InfraStatistics::Interfaces::Interface::InterfacesMibCounters::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::InterfacesMibCounters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::InterfacesMibCounters::get_children()
{
    return children;
}
...
EntityPath InfraStatistics::Interfaces::Interface::DataRate::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::DataRate::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::DataRate::get_children()
{
    return children;
}
...
EntityPath InfraStatistics::Interfaces::Interface::GenericCounters::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::GenericCounters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::GenericCounters::get_children()
{
    return children;
}
...
InfraStatistics::Interfaces::Interface::Interface()
    :
    	...
    	,
    cache(std::make_unique<InfraStatistics::Interfaces::Interface::Cache>())
	,data_rate(std::make_unique<InfraStatistics::Interfaces::Interface::DataRate>())
	,generic_counters(std::make_unique<InfraStatistics::Interfaces::Interface::GenericCounters>())
	,interfaces_mib_counters(std::make_unique<InfraStatistics::Interfaces::Interface::InterfacesMibCounters>())
	,latest(std::make_unique<InfraStatistics::Interfaces::Interface::Latest>())
	,protocols(std::make_unique<InfraStatistics::Interfaces::Interface::Protocols>())
	,total(std::make_unique<InfraStatistics::Interfaces::Interface::Total>())
{
    cache->parent = this;
...
EntityPath InfraStatistics::Interfaces::Interface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::Interface::get_children()
{
    ...
    if(children.find("latest") == children.end())
    {
        if(latest != nullptr)
        {
            children["latest"] = latest.get();
...
EntityPath InfraStatistics::Interfaces::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* InfraStatistics::Interfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "interface")
    {
        ...
        auto c = std::make_unique<InfraStatistics::Interfaces::Interface>();
        c->parent = this;
...
std::map<std::string, Entity*> & InfraStatistics::Interfaces::get_children()
{
    for (auto const & c : interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
InfraStatistics::InfraStatistics()
    :
    interfaces(std::make_unique<InfraStatistics::Interfaces>())
{
...
EntityPath InfraStatistics::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor != nullptr)
    {
...
Entity* InfraStatistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & InfraStatistics::get_children()
{
...
std::unique_ptr<Entity> InfraStatistics::clone_ptr()
{
    return std::make_unique<InfraStatistics>();
}
