...
Entity* TrafficCollector::Summary::DatabaseStatisticsExternalInterface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::Summary::DatabaseStatisticsExternalInterface::get_children()
{
    return children;
}
...
Entity* TrafficCollector::Summary::VrfStatistic::DatabaseStatisticsIpv4::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::Summary::VrfStatistic::DatabaseStatisticsIpv4::get_children()
{
    return children;
}
...
Entity* TrafficCollector::Summary::VrfStatistic::DatabaseStatisticsTunnel::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::Summary::VrfStatistic::DatabaseStatisticsTunnel::get_children()
{
    return children;
}
...
TrafficCollector::Summary::VrfStatistic::VrfStatistic()
    :
    	...
    	,
    database_statistics_ipv4(std::make_unique<TrafficCollector::Summary::VrfStatistic::DatabaseStatisticsIpv4>())
	,database_statistics_tunnel(std::make_unique<TrafficCollector::Summary::VrfStatistic::DatabaseStatisticsTunnel>())
{
    database_statistics_ipv4->parent = this;
    children["database-statistics-ipv4"] = database_statistics_ipv4.get();

    database_statistics_tunnel->parent = this;
    children["database-statistics-tunnel"] = database_statistics_tunnel.get();
...
Entity* TrafficCollector::Summary::VrfStatistic::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::Summary::VrfStatistic::get_children()
{
...
Entity* TrafficCollector::Summary::CollectionMessageStatistic::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::Summary::CollectionMessageStatistic::get_children()
{
    return children;
}
...
Entity* TrafficCollector::Summary::CheckpointMessageStatistic::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::Summary::CheckpointMessageStatistic::get_children()
{
    return children;
}
...
TrafficCollector::Summary::Summary()
    :
	 ...
	 timeout_timer_is_running{YType::boolean, "timeout-timer-is-running"}
    	,
    database_statistics_external_interface(std::make_unique<TrafficCollector::Summary::DatabaseStatisticsExternalInterface>())
{
    database_statistics_external_interface->parent = this;
    children["database-statistics-external-interface"] = database_statistics_external_interface.get();
...
Entity* TrafficCollector::Summary::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "checkpoint-message-statistic")
    {
        ...
        auto c = std::make_unique<TrafficCollector::Summary::CheckpointMessageStatistic>();
        c->parent = this;
        checkpoint_message_statistic.push_back(std::move(c));
        children[segment_path] = checkpoint_message_statistic.back().get();
        return children.at(segment_path);
    }
    ...
    if(child_yang_name == "collection-message-statistic")
    {
        ...
        auto c = std::make_unique<TrafficCollector::Summary::CollectionMessageStatistic>();
        c->parent = this;
        collection_message_statistic.push_back(std::move(c));
        children[segment_path] = collection_message_statistic.back().get();
        return children.at(segment_path);
    }
    ...
    if(child_yang_name == "vrf-statistic")
    {
        ...
        auto c = std::make_unique<TrafficCollector::Summary::VrfStatistic>();
        c->parent = this;
        vrf_statistic.push_back(std::move(c));
        children[segment_path] = vrf_statistic.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & TrafficCollector::Summary::get_children()
{
    for (auto const & c : checkpoint_message_statistic)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::Prefix::BaseCounterStatistics::CountHistory::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::Prefix::BaseCounterStatistics::CountHistory::get_children()
{
    return children;
}
...
Entity* TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::Prefix::BaseCounterStatistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "count-history")
    {
        ...
        auto c = std::make_unique<TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::Prefix::BaseCounterStatistics::CountHistory>();
        c->parent = this;
        count_history.push_back(std::move(c));
        children[segment_path] = count_history.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::Prefix::BaseCounterStatistics::get_children()
{
    for (auto const & c : count_history)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::Prefix::TrafficMatrixCounterStatistics::CountHistory::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::Prefix::TrafficMatrixCounterStatistics::CountHistory::get_children()
{
    return children;
}
...
Entity* TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::Prefix::TrafficMatrixCounterStatistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "count-history")
    {
        ...
        auto c = std::make_unique<TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::Prefix::TrafficMatrixCounterStatistics::CountHistory>();
        c->parent = this;
        count_history.push_back(std::move(c));
        children[segment_path] = count_history.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::Prefix::TrafficMatrixCounterStatistics::get_children()
{
    for (auto const & c : count_history)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::Prefix::Prefix()
    :
	 ...
	 prefix{YType::str, "prefix"}
    	,
    base_counter_statistics(std::make_unique<TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::Prefix::BaseCounterStatistics>())
	,traffic_matrix_counter_statistics(std::make_unique<TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::Prefix::TrafficMatrixCounterStatistics>())
{
    base_counter_statistics->parent = this;
    children["base-counter-statistics"] = base_counter_statistics.get();

    traffic_matrix_counter_statistics->parent = this;
    children["traffic-matrix-counter-statistics"] = traffic_matrix_counter_statistics.get();
...
Entity* TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::Prefix::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::Prefix::get_children()
{
...
Entity* TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "prefix")
    {
        ...
        auto c = std::make_unique<TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::Prefix>();
        c->parent = this;
...
std::map<std::string, Entity*> & TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes::get_children()
{
    for (auto const & c : prefix)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Tunnels::Tunnel::BaseCounterStatistics::CountHistory::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Tunnels::Tunnel::BaseCounterStatistics::CountHistory::get_children()
{
    return children;
}
...
Entity* TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Tunnels::Tunnel::BaseCounterStatistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "count-history")
    {
        ...
        auto c = std::make_unique<TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Tunnels::Tunnel::BaseCounterStatistics::CountHistory>();
        c->parent = this;
        count_history.push_back(std::move(c));
        children[segment_path] = count_history.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Tunnels::Tunnel::BaseCounterStatistics::get_children()
{
    for (auto const & c : count_history)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Tunnels::Tunnel::Tunnel()
    :
	 ...
	 vrfid{YType::uint32, "vrfid"}
    	,
    base_counter_statistics(std::make_unique<TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Tunnels::Tunnel::BaseCounterStatistics>())
{
    base_counter_statistics->parent = this;
    children["base-counter-statistics"] = base_counter_statistics.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "tunnel" <<"[interface-name='" <<interface_name.get() <<"']";
...
Entity* TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Tunnels::Tunnel::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Tunnels::Tunnel::get_children()
{
    if(children.find("base-counter-statistics") == children.end())
    {
        if(base_counter_statistics != nullptr)
...
Entity* TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Tunnels::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "tunnel")
    {
        ...
        auto c = std::make_unique<TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Tunnels::Tunnel>();
        c->parent = this;
...
std::map<std::string, Entity*> & TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Tunnels::get_children()
{
    for (auto const & c : tunnel)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Counters()
    :
    prefixes(std::make_unique<TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Prefixes>())
	,tunnels(std::make_unique<TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::Tunnels>())
{
...
Entity* TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters::get_children()
{
...
TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Af()
    :
    	...
    	,
    counters(std::make_unique<TrafficCollector::VrfTable::DefaultVrf::Afs::Af::Counters>())
{
...
Entity* TrafficCollector::VrfTable::DefaultVrf::Afs::Af::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::VrfTable::DefaultVrf::Afs::Af::get_children()
{
...
Entity* TrafficCollector::VrfTable::DefaultVrf::Afs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "af")
    {
        ...
        auto c = std::make_unique<TrafficCollector::VrfTable::DefaultVrf::Afs::Af>();
        c->parent = this;
...
std::map<std::string, Entity*> & TrafficCollector::VrfTable::DefaultVrf::Afs::get_children()
{
    for (auto const & c : af)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
TrafficCollector::VrfTable::DefaultVrf::DefaultVrf()
    :
    afs(std::make_unique<TrafficCollector::VrfTable::DefaultVrf::Afs>())
{
    afs->parent = this;
...
Entity* TrafficCollector::VrfTable::DefaultVrf::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::VrfTable::DefaultVrf::get_children()
{
...
TrafficCollector::VrfTable::VrfTable()
    :
    default_vrf(std::make_unique<TrafficCollector::VrfTable::DefaultVrf>())
{
...
Entity* TrafficCollector::VrfTable::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::VrfTable::get_children()
{
...
Entity* TrafficCollector::Afs::Af::Counters::Prefixes::Prefix::BaseCounterStatistics::CountHistory::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::Afs::Af::Counters::Prefixes::Prefix::BaseCounterStatistics::CountHistory::get_children()
{
    return children;
}
...
Entity* TrafficCollector::Afs::Af::Counters::Prefixes::Prefix::BaseCounterStatistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "count-history")
    {
        ...
        auto c = std::make_unique<TrafficCollector::Afs::Af::Counters::Prefixes::Prefix::BaseCounterStatistics::CountHistory>();
        c->parent = this;
        count_history.push_back(std::move(c));
        children[segment_path] = count_history.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & TrafficCollector::Afs::Af::Counters::Prefixes::Prefix::BaseCounterStatistics::get_children()
{
    for (auto const & c : count_history)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* TrafficCollector::Afs::Af::Counters::Prefixes::Prefix::TrafficMatrixCounterStatistics::CountHistory::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::Afs::Af::Counters::Prefixes::Prefix::TrafficMatrixCounterStatistics::CountHistory::get_children()
{
    return children;
}
...
Entity* TrafficCollector::Afs::Af::Counters::Prefixes::Prefix::TrafficMatrixCounterStatistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "count-history")
    {
        ...
        auto c = std::make_unique<TrafficCollector::Afs::Af::Counters::Prefixes::Prefix::TrafficMatrixCounterStatistics::CountHistory>();
        c->parent = this;
        count_history.push_back(std::move(c));
        children[segment_path] = count_history.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & TrafficCollector::Afs::Af::Counters::Prefixes::Prefix::TrafficMatrixCounterStatistics::get_children()
{
    for (auto const & c : count_history)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
TrafficCollector::Afs::Af::Counters::Prefixes::Prefix::Prefix()
    :
	 ...
	 prefix{YType::str, "prefix"}
    	,
    base_counter_statistics(std::make_unique<TrafficCollector::Afs::Af::Counters::Prefixes::Prefix::BaseCounterStatistics>())
	,traffic_matrix_counter_statistics(std::make_unique<TrafficCollector::Afs::Af::Counters::Prefixes::Prefix::TrafficMatrixCounterStatistics>())
{
    base_counter_statistics->parent = this;
    children["base-counter-statistics"] = base_counter_statistics.get();
...
Entity* TrafficCollector::Afs::Af::Counters::Prefixes::Prefix::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::Afs::Af::Counters::Prefixes::Prefix::get_children()
{
    if(children.find("base-counter-statistics") == children.end())
    {
        if(base_counter_statistics != nullptr)
...
Entity* TrafficCollector::Afs::Af::Counters::Prefixes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "prefix")
    {
        ...
        auto c = std::make_unique<TrafficCollector::Afs::Af::Counters::Prefixes::Prefix>();
        c->parent = this;
        prefix.push_back(std::move(c));
        children[segment_path] = prefix.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & TrafficCollector::Afs::Af::Counters::Prefixes::get_children()
{
    for (auto const & c : prefix)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* TrafficCollector::Afs::Af::Counters::Tunnels::Tunnel::BaseCounterStatistics::CountHistory::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::Afs::Af::Counters::Tunnels::Tunnel::BaseCounterStatistics::CountHistory::get_children()
{
    return children;
}
...
Entity* TrafficCollector::Afs::Af::Counters::Tunnels::Tunnel::BaseCounterStatistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "count-history")
    {
        ...
        auto c = std::make_unique<TrafficCollector::Afs::Af::Counters::Tunnels::Tunnel::BaseCounterStatistics::CountHistory>();
        c->parent = this;
        count_history.push_back(std::move(c));
        children[segment_path] = count_history.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & TrafficCollector::Afs::Af::Counters::Tunnels::Tunnel::BaseCounterStatistics::get_children()
{
    for (auto const & c : count_history)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
TrafficCollector::Afs::Af::Counters::Tunnels::Tunnel::Tunnel()
    :
	 ...
	 vrfid{YType::uint32, "vrfid"}
    	,
    base_counter_statistics(std::make_unique<TrafficCollector::Afs::Af::Counters::Tunnels::Tunnel::BaseCounterStatistics>())
{
    base_counter_statistics->parent = this;
    children["base-counter-statistics"] = base_counter_statistics.get();
...
Entity* TrafficCollector::Afs::Af::Counters::Tunnels::Tunnel::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::Afs::Af::Counters::Tunnels::Tunnel::get_children()
{
    if(children.find("base-counter-statistics") == children.end())
    {
        if(base_counter_statistics != nullptr)
...
Entity* TrafficCollector::Afs::Af::Counters::Tunnels::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "tunnel")
    {
        ...
        auto c = std::make_unique<TrafficCollector::Afs::Af::Counters::Tunnels::Tunnel>();
        c->parent = this;
        tunnel.push_back(std::move(c));
        children[segment_path] = tunnel.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & TrafficCollector::Afs::Af::Counters::Tunnels::get_children()
{
    for (auto const & c : tunnel)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
TrafficCollector::Afs::Af::Counters::Counters()
    :
    prefixes(std::make_unique<TrafficCollector::Afs::Af::Counters::Prefixes>())
	,tunnels(std::make_unique<TrafficCollector::Afs::Af::Counters::Tunnels>())
{
    prefixes->parent = this;
    children["prefixes"] = prefixes.get();
...
Entity* TrafficCollector::Afs::Af::Counters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::Afs::Af::Counters::get_children()
{
    if(children.find("prefixes") == children.end())
    {
        if(prefixes != nullptr)
...
TrafficCollector::Afs::Af::Af()
    :
    	af_name{YType::enumeration, "af-name"}
    	,
    counters(std::make_unique<TrafficCollector::Afs::Af::Counters>())
{
    counters->parent = this;
    children["counters"] = counters.get();
...
Entity* TrafficCollector::Afs::Af::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & TrafficCollector::Afs::Af::get_children()
{
    if(children.find("counters") == children.end())
    {
        if(counters != nullptr)
...
Entity* TrafficCollector::Afs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "af")
    {
        ...
        auto c = std::make_unique<TrafficCollector::Afs::Af>();
        c->parent = this;
        af.push_back(std::move(c));
        children[segment_path] = af.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & TrafficCollector::Afs::get_children()
{
    for (auto const & c : af)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
TrafficCollector::TrafficCollector()
    :
    afs(std::make_unique<TrafficCollector::Afs>())
	,external_interfaces(std::make_unique<TrafficCollector::ExternalInterfaces>())
	,summary(std::make_unique<TrafficCollector::Summary>())
	,vrf_table(std::make_unique<TrafficCollector::VrfTable>())
{
    afs->parent = this;
    children["afs"] = afs.get();
