...
{
    if(name == "npu-tblr" || name == "resource" || name == "table-id" || name == "name" || name == "is-global" || name == "num-npus" || name == "table-specific-list")
        return true;
    return false;
}
...
{
    if(name == "npu-id" || name == "num-objs" || name == "create-req" || name == "create-ok" || name == "delete-req" || name == "delete-ok" || name == "update-req" || name == "update-ok" || name == "eod-req" || name == "eod-ok" || name == "err-hw-fail" || name == "err-ref-resolve" || name == "err-db-notfound" || name == "err-db-exists" || name == "err-db-nomem")
        return true;
    return false;
}
