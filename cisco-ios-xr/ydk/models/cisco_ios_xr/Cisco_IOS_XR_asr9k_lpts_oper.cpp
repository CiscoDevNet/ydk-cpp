...
std::shared_ptr<ydk::Entity> PlatformLptspIfibStatic::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfibStatic::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(node_statics != nullptr)
    {
        _children["node-statics"] = node_statics;
    }
...
std::shared_ptr<ydk::Entity> PlatformLptspIfibStatic::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> PlatformLptspIfibStatic::NodeStatics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "node-static")
    {
        auto ent_ = std::make_shared<PlatformLptspIfibStatic::NodeStatics::NodeStatic>();
        ent_->parent = this;
        node_static.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfibStatic::NodeStatics::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : node_static.entities())
    {
...
std::shared_ptr<ydk::Entity> PlatformLptspIfibStatic::NodeStatics::NodeStatic::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfibStatic::NodeStatics::NodeStatic::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(police != nullptr)
...
std::shared_ptr<ydk::Entity> PlatformLptspIfibStatic::NodeStatics::NodeStatic::Police::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "static-info")
    {
        auto ent_ = std::make_shared<PlatformLptspIfibStatic::NodeStatics::NodeStatic::Police::StaticInfo>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfibStatic::NodeStatics::NodeStatic::Police::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformLptspIfibStatic::NodeStatics::NodeStatic::Police::StaticInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfibStatic::NodeStatics::NodeStatic::Police::StaticInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> PlatformLptspIfibStatic::NodeStatics::NodeStatic::Stats::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfibStatic::NodeStatics::NodeStatic::Stats::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> PlatformLptspIfib::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfib::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(nodes != nullptr)
...
std::shared_ptr<ydk::Entity> PlatformLptspIfib::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> PlatformLptspIfib::Nodes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "node")
    {
        auto ent_ = std::make_shared<PlatformLptspIfib::Nodes::Node>();
        ent_->parent = this;
        node.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfib::Nodes::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformLptspIfib::Nodes::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "police")
    {
        if(police == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfib::Nodes::Node::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(police != nullptr)
...
std::shared_ptr<ydk::Entity> PlatformLptspIfib::Nodes::Node::Police::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "police-info")
    {
        auto ent_ = std::make_shared<PlatformLptspIfib::Nodes::Node::Police::PoliceInfo>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfib::Nodes::Node::Police::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformLptspIfib::Nodes::Node::Police::PoliceInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfib::Nodes::Node::Police::PoliceInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> PlatformLptspIfib::Nodes::Node::Stats::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfib::Nodes::Node::Stats::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> PlatformLptspIfibNpStats::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfibNpStats::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(node_np_stats != nullptr)
    {
        _children["node-np-stats"] = node_np_stats;
    }
...
std::shared_ptr<ydk::Entity> PlatformLptspIfibNpStats::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> PlatformLptspIfibNpStats::NodeNpStats::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "node-np-stat")
    {
        auto ent_ = std::make_shared<PlatformLptspIfibNpStats::NodeNpStats::NodeNpStat>();
        ent_->parent = this;
        node_np_stat.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfibNpStats::NodeNpStats::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : node_np_stat.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> PlatformLptspIfibNpStats::NodeNpStats::NodeNpStat::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfibNpStats::NodeNpStats::NodeNpStat::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(nps != nullptr)
...
std::shared_ptr<ydk::Entity> PlatformLptspIfibNpStats::NodeNpStats::NodeNpStat::Nps::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "np")
    {
        auto ent_ = std::make_shared<PlatformLptspIfibNpStats::NodeNpStats::NodeNpStat::Nps::Np>();
        ent_->parent = this;
        np.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfibNpStats::NodeNpStats::NodeNpStat::Nps::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformLptspIfibNpStats::NodeNpStats::NodeNpStat::Nps::Np::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfibNpStats::NodeNpStats::NodeNpStat::Nps::Np::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(np_police != nullptr)
    {
        _children["np-police"] = np_police;
    }
...
std::shared_ptr<ydk::Entity> PlatformLptspIfibNpStats::NodeNpStats::NodeNpStat::Nps::Np::NpPolice::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "police-info")
    {
        auto ent_ = std::make_shared<PlatformLptspIfibNpStats::NodeNpStats::NodeNpStat::Nps::Np::NpPolice::PoliceInfo>();
        ent_->parent = this;
        police_info.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfibNpStats::NodeNpStats::NodeNpStat::Nps::Np::NpPolice::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformLptspIfibNpStats::NodeNpStats::NodeNpStat::Nps::Np::NpPolice::PoliceInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformLptspIfibNpStats::NodeNpStats::NodeNpStat::Nps::Np::NpPolice::PoliceInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
