...
const Enum::YLeaf Mode::mode_invalid {0, "mode-invalid"};
const Enum::YLeaf Mode::mode_source {1, "mode-source"};
const Enum::YLeaf Mode::mode_sink {2, "mode-sink"};
const Enum::YLeaf Mode::mode_source_sink {3, "mode-source-sink"};
