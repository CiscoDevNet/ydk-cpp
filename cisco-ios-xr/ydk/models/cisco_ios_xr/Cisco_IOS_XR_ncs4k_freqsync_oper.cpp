...
{
    return (clock_interface_selection_back_traces !=  nullptr && clock_interface_selection_back_traces->has_data())
...
{
    if(name == "clock-interface-selection-back-traces" || name == "clock-interface-selection-forward-traces" || name == "clocks" || name == "global-interfaces" || name == "global-nodes" || name == "interfaces" || name == "nodes" || name == "summary")
        return true;
    return false;
}
...
{
    if(name == "ntp-selection-forward-trace" || name == "ptp-selection-forward-trace" || name == "time-of-day-back-trace" || name == "node")
        return true;
    return false;
}
...
{
    if(name == "configuration-errors" || name == "ntp" || name == "ptp" || name == "selection-point-inputs" || name == "selection-points" || name == "ssm-summary" || name == "node")
        return true;
    return false;
}
