...
std::shared_ptr<Entity> FrequencySynchronization::Clocks::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    {
        auto c = std::make_shared<FrequencySynchronization::Clocks::Clock>();
        c->parent = this;
        clock_.push_back(c);
        return c;
    }
...
FrequencySynchronization::Clocks::Clock::Clock()
    :
    clock_name{YType::str, "clock-name"},
    state{YType::enumeration, "state"},
    ...
    node_selection_points_description{YType::str, "node-selection-points-description"}
    	,
    source(std::make_shared<FrequencySynchronization::Clocks::Clock::Source>())
	,selected_source(std::make_shared<FrequencySynchronization::Clocks::Clock::SelectedSource>())
	,quality_level_received(std::make_shared<FrequencySynchronization::Clocks::Clock::QualityLevelReceived>())
	,quality_level_damped(std::make_shared<FrequencySynchronization::Clocks::Clock::QualityLevelDamped>())
	,quality_level_effective_input(std::make_shared<FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveInput>())
	,quality_level_effective_output(std::make_shared<FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveOutput>())
	,quality_level_selected_source(std::make_shared<FrequencySynchronization::Clocks::Clock::QualityLevelSelectedSource>())
{
    source->parent = this;
    selected_source->parent = this;
    quality_level_received->parent = this;
...
bool FrequencySynchronization::Clocks::Clock::has_data() const
{
    for (auto const & leaf : spa_selection_point.getYLeafs())
    {
        if(leaf.is_set)
...
bool FrequencySynchronization::Clocks::Clock::has_operation() const
{
    for (auto const & leaf : spa_selection_point.getYLeafs())
    {
        if(is_set(leaf.yfilter))
...
std::string FrequencySynchronization::Clocks::Clock::get_absolute_path() const
{
    std::ostringstream path_buffer;
...
std::string FrequencySynchronization::Clocks::Clock::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > FrequencySynchronization::Clocks::Clock::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> FrequencySynchronization::Clocks::Clock::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "source")
    {
        if(source == nullptr)
...
std::map<std::string, std::shared_ptr<Entity>> FrequencySynchronization::Clocks::Clock::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(source != nullptr)
...
void FrequencySynchronization::Clocks::Clock::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "clock-name")
    {
        clock_name = value;
...
void FrequencySynchronization::Clocks::Clock::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "clock-name")
    {
        clock_name.yfilter = yfilter;
...
bool FrequencySynchronization::Clocks::Clock::has_leaf_or_child_of_name(const std::string & name) const
{
...
FrequencySynchronization::Clocks::Clock::Source::Source()
    :
    source_class{YType::enumeration, "source-class"},
    ethernet_interface{YType::str, "ethernet-interface"},
    sonet_interface{YType::str, "sonet-interface"},
    ...
    ntp_node{YType::str, "ntp-node"}
    	,
    clock_id(std::make_shared<FrequencySynchronization::Clocks::Clock::Source::ClockId>())
{
    clock_id->parent = this;
...
bool FrequencySynchronization::Clocks::Clock::Source::has_data() const
{
    return source_class.is_set
	|| ethernet_interface.is_set
	|| sonet_interface.is_set
...
bool FrequencySynchronization::Clocks::Clock::Source::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(source_class.yfilter)
	|| ydk::is_set(ethernet_interface.yfilter)
...
std::string FrequencySynchronization::Clocks::Clock::Source::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "source";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > FrequencySynchronization::Clocks::Clock::Source::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> FrequencySynchronization::Clocks::Clock::Source::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "clock-id")
    {
        if(clock_id == nullptr)
...
std::map<std::string, std::shared_ptr<Entity>> FrequencySynchronization::Clocks::Clock::Source::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(clock_id != nullptr)
...
void FrequencySynchronization::Clocks::Clock::Source::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "source-class")
    {
        source_class = value;
...
void FrequencySynchronization::Clocks::Clock::Source::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "source-class")
    {
        source_class.yfilter = yfilter;
...
bool FrequencySynchronization::Clocks::Clock::Source::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "clock-id" || name == "source-class" || name == "ethernet-interface" || name == "sonet-interface" || name == "node" || name == "ptp-node" || name == "satellite-access-interface" || name == "ntp-node")
        return true;
    return false;
...
FrequencySynchronization::Clocks::Clock::Source::ClockId::ClockId()
    :
    node{YType::str, "node"},
    port{YType::uint32, "port"}
{
...
bool FrequencySynchronization::Clocks::Clock::Source::ClockId::has_data() const
{
    return node.is_set
	|| port.is_set;
}

bool FrequencySynchronization::Clocks::Clock::Source::ClockId::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(node.yfilter)
	|| ydk::is_set(port.yfilter);
...
std::string FrequencySynchronization::Clocks::Clock::Source::ClockId::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "clock-id";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > FrequencySynchronization::Clocks::Clock::Source::ClockId::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> FrequencySynchronization::Clocks::Clock::Source::ClockId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> FrequencySynchronization::Clocks::Clock::Source::ClockId::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void FrequencySynchronization::Clocks::Clock::Source::ClockId::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "node")
    {
        node = value;
...
void FrequencySynchronization::Clocks::Clock::Source::ClockId::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "node")
    {
        node.yfilter = yfilter;
...
bool FrequencySynchronization::Clocks::Clock::Source::ClockId::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "node" || name == "port")
        return true;
    return false;
...
FrequencySynchronization::Clocks::Clock::SelectedSource::SelectedSource()
    :
    source_class{YType::enumeration, "source-class"},
    ethernet_interface{YType::str, "ethernet-interface"},
    sonet_interface{YType::str, "sonet-interface"},
    ...
    ntp_node{YType::str, "ntp-node"}
    	,
    clock_id(std::make_shared<FrequencySynchronization::Clocks::Clock::SelectedSource::ClockId>())
{
    clock_id->parent = this;
...
bool FrequencySynchronization::Clocks::Clock::SelectedSource::has_data() const
{
    return source_class.is_set
	|| ethernet_interface.is_set
	|| sonet_interface.is_set
...
bool FrequencySynchronization::Clocks::Clock::SelectedSource::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(source_class.yfilter)
	|| ydk::is_set(ethernet_interface.yfilter)
...
std::string FrequencySynchronization::Clocks::Clock::SelectedSource::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "selected-source";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > FrequencySynchronization::Clocks::Clock::SelectedSource::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> FrequencySynchronization::Clocks::Clock::SelectedSource::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "clock-id")
    {
        if(clock_id == nullptr)
...
std::map<std::string, std::shared_ptr<Entity>> FrequencySynchronization::Clocks::Clock::SelectedSource::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(clock_id != nullptr)
...
void FrequencySynchronization::Clocks::Clock::SelectedSource::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "source-class")
    {
        source_class = value;
...
void FrequencySynchronization::Clocks::Clock::SelectedSource::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "source-class")
    {
        source_class.yfilter = yfilter;
...
bool FrequencySynchronization::Clocks::Clock::SelectedSource::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "clock-id" || name == "source-class" || name == "ethernet-interface" || name == "sonet-interface" || name == "node" || name == "ptp-node" || name == "satellite-access-interface" || name == "ntp-node")
        return true;
    return false;
...
FrequencySynchronization::Clocks::Clock::SelectedSource::ClockId::ClockId()
    :
    node{YType::str, "node"},
    port{YType::uint32, "port"}
{
...
bool FrequencySynchronization::Clocks::Clock::SelectedSource::ClockId::has_data() const
{
    return node.is_set
	|| port.is_set;
}

bool FrequencySynchronization::Clocks::Clock::SelectedSource::ClockId::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(node.yfilter)
	|| ydk::is_set(port.yfilter);
...
std::string FrequencySynchronization::Clocks::Clock::SelectedSource::ClockId::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "clock-id";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > FrequencySynchronization::Clocks::Clock::SelectedSource::ClockId::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> FrequencySynchronization::Clocks::Clock::SelectedSource::ClockId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> FrequencySynchronization::Clocks::Clock::SelectedSource::ClockId::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void FrequencySynchronization::Clocks::Clock::SelectedSource::ClockId::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "node")
    {
        node = value;
...
void FrequencySynchronization::Clocks::Clock::SelectedSource::ClockId::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "node")
    {
        node.yfilter = yfilter;
...
bool FrequencySynchronization::Clocks::Clock::SelectedSource::ClockId::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "node" || name == "port")
        return true;
    return false;
...
FrequencySynchronization::Clocks::Clock::QualityLevelReceived::QualityLevelReceived()
    :
    quality_level_option{YType::enumeration, "quality-level-option"},
    option1_value{YType::enumeration, "option1-value"},
    option2_generation1_value{YType::enumeration, "option2-generation1-value"},
...
bool FrequencySynchronization::Clocks::Clock::QualityLevelReceived::has_data() const
{
    return quality_level_option.is_set
	|| option1_value.is_set
	|| option2_generation1_value.is_set
...
bool FrequencySynchronization::Clocks::Clock::QualityLevelReceived::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(quality_level_option.yfilter)
	|| ydk::is_set(option1_value.yfilter)
...
std::string FrequencySynchronization::Clocks::Clock::QualityLevelReceived::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "quality-level-received";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > FrequencySynchronization::Clocks::Clock::QualityLevelReceived::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> FrequencySynchronization::Clocks::Clock::QualityLevelReceived::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> FrequencySynchronization::Clocks::Clock::QualityLevelReceived::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void FrequencySynchronization::Clocks::Clock::QualityLevelReceived::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "quality-level-option")
    {
        quality_level_option = value;
...
void FrequencySynchronization::Clocks::Clock::QualityLevelReceived::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "quality-level-option")
    {
        quality_level_option.yfilter = yfilter;
...
bool FrequencySynchronization::Clocks::Clock::QualityLevelReceived::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "quality-level-option" || name == "option1-value" || name == "option2-generation1-value" || name == "option2-generation2-value")
        return true;
    return false;
...
FrequencySynchronization::Clocks::Clock::QualityLevelDamped::QualityLevelDamped()
    :
    quality_level_option{YType::enumeration, "quality-level-option"},
    option1_value{YType::enumeration, "option1-value"},
    option2_generation1_value{YType::enumeration, "option2-generation1-value"},
...
bool FrequencySynchronization::Clocks::Clock::QualityLevelDamped::has_data() const
{
    return quality_level_option.is_set
	|| option1_value.is_set
	|| option2_generation1_value.is_set
...
bool FrequencySynchronization::Clocks::Clock::QualityLevelDamped::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(quality_level_option.yfilter)
	|| ydk::is_set(option1_value.yfilter)
...
std::string FrequencySynchronization::Clocks::Clock::QualityLevelDamped::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "quality-level-damped";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > FrequencySynchronization::Clocks::Clock::QualityLevelDamped::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> FrequencySynchronization::Clocks::Clock::QualityLevelDamped::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> FrequencySynchronization::Clocks::Clock::QualityLevelDamped::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void FrequencySynchronization::Clocks::Clock::QualityLevelDamped::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "quality-level-option")
    {
        quality_level_option = value;
...
void FrequencySynchronization::Clocks::Clock::QualityLevelDamped::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "quality-level-option")
    {
        quality_level_option.yfilter = yfilter;
...
bool FrequencySynchronization::Clocks::Clock::QualityLevelDamped::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "quality-level-option" || name == "option1-value" || name == "option2-generation1-value" || name == "option2-generation2-value")
        return true;
    return false;
...
FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveInput::QualityLevelEffectiveInput()
    :
    quality_level_option{YType::enumeration, "quality-level-option"},
    option1_value{YType::enumeration, "option1-value"},
    option2_generation1_value{YType::enumeration, "option2-generation1-value"},
...
bool FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveInput::has_data() const
{
    return quality_level_option.is_set
	|| option1_value.is_set
	|| option2_generation1_value.is_set
...
bool FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveInput::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(quality_level_option.yfilter)
	|| ydk::is_set(option1_value.yfilter)
...
std::string FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveInput::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "quality-level-effective-input";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveInput::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveInput::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveInput::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveInput::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "quality-level-option")
    {
        quality_level_option = value;
...
void FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveInput::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "quality-level-option")
    {
        quality_level_option.yfilter = yfilter;
...
bool FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveInput::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "quality-level-option" || name == "option1-value" || name == "option2-generation1-value" || name == "option2-generation2-value")
        return true;
    return false;
...
FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveOutput::QualityLevelEffectiveOutput()
    :
    quality_level_option{YType::enumeration, "quality-level-option"},
    option1_value{YType::enumeration, "option1-value"},
    option2_generation1_value{YType::enumeration, "option2-generation1-value"},
...
bool FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveOutput::has_data() const
{
    return quality_level_option.is_set
	|| option1_value.is_set
	|| option2_generation1_value.is_set
...
bool FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveOutput::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(quality_level_option.yfilter)
	|| ydk::is_set(option1_value.yfilter)
...
std::string FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveOutput::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "quality-level-effective-output";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveOutput::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveOutput::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveOutput::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveOutput::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "quality-level-option")
    {
        quality_level_option = value;
...
void FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveOutput::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "quality-level-option")
    {
        quality_level_option.yfilter = yfilter;
...
bool FrequencySynchronization::Clocks::Clock::QualityLevelEffectiveOutput::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "quality-level-option" || name == "option1-value" || name == "option2-generation1-value" || name == "option2-generation2-value")
        return true;
    return false;
...
FrequencySynchronization::Clocks::Clock::QualityLevelSelectedSource::QualityLevelSelectedSource()
    :
    quality_level_option{YType::enumeration, "quality-level-option"},
    option1_value{YType::enumeration, "option1-value"},
    option2_generation1_value{YType::enumeration, "option2-generation1-value"},
...
bool FrequencySynchronization::Clocks::Clock::QualityLevelSelectedSource::has_data() const
{
    return quality_level_option.is_set
	|| option1_value.is_set
	|| option2_generation1_value.is_set
...
bool FrequencySynchronization::Clocks::Clock::QualityLevelSelectedSource::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(quality_level_option.yfilter)
	|| ydk::is_set(option1_value.yfilter)
...
std::string FrequencySynchronization::Clocks::Clock::QualityLevelSelectedSource::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "quality-level-selected-source";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > FrequencySynchronization::Clocks::Clock::QualityLevelSelectedSource::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> FrequencySynchronization::Clocks::Clock::QualityLevelSelectedSource::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> FrequencySynchronization::Clocks::Clock::QualityLevelSelectedSource::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void FrequencySynchronization::Clocks::Clock::QualityLevelSelectedSource::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "quality-level-option")
    {
        quality_level_option = value;
...
void FrequencySynchronization::Clocks::Clock::QualityLevelSelectedSource::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "quality-level-option")
    {
        quality_level_option.yfilter = yfilter;
...
bool FrequencySynchronization::Clocks::Clock::QualityLevelSelectedSource::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "quality-level-option" || name == "option1-value" || name == "option2-generation1-value" || name == "option2-generation2-value")
        return true;
    return false;
