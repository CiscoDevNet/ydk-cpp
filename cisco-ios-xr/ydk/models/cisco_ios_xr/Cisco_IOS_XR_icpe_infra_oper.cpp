...
{
    if(name == "icpe-dpms" || name == "install" || name == "install-op-progresses" || name == "install-op-statuses" || name == "install-reference-info" || name == "install-shows" || name == "reload-op-statuses" || name == "reload-statuses" || name == "satellite-priorities" || name == "satellite-properties" || name == "satellite-statuses" || name == "satellite-topologies" || name == "satellite-versions" || name == "sdacp-controls" || name == "sdacp-discovery2s" || name == "sdacp-redundancies")
        return true;
    return false;
}
...
{
    if(name == "reference-name" || name == "reference-file" || name == "reference-name-xr")
        return true;
    return false;
}
