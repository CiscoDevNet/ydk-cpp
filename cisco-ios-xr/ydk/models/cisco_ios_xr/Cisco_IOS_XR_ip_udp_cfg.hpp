...
class IpUdp : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_ip_udp_cfg::IpUdp::NumThread> num_thread; // presence node
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_ip_udp_cfg::IpUdp::Directory> directory; // presence node
