...
class Ipv4 : public Cisco_IOS_XR_ip_domain_oper::HostAddressBase, virtual ydk::Identity
{
    public:
        Ipv4();
        ~Ipv4();
...
class Ipv6 : public Cisco_IOS_XR_ip_domain_oper::HostAddressBase, virtual ydk::Identity
{
    public:
        Ipv6();
        ~Ipv6();
