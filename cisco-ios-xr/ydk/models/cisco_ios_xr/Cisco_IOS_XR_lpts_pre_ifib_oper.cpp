...
{
    if(name == "dynamic-flows-stats" || name == "hardware" || name == "type-values" || name == "node-name")
        return true;
    return false;
}
...
{
    if(name == "flow" || name == "dynamic-flows-enabled" || name == "platform-configured-max" || name == "platform-supported-max" || name == "platform-total-configured" || name == "total-hw-entries" || name == "total-sw-entries")
        return true;
    return false;
}
...
{
    if(name == "active-max" || name == "configurable" || name == "configured" || name == "configured-max" || name == "default-max" || name == "flow-name" || name == "hardware-count" || name == "pending-software-entries" || name == "software-count")
        return true;
    return false;
}
