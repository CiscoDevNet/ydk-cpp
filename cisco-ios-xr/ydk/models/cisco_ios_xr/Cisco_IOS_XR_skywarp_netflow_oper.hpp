...
class NetFlow::Statistics : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_skywarp_netflow_oper::NetFlow::Statistics::Statistic> > statistic;
...
class NetFlow::Statistics::Statistic::Server::FlowExporters : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_skywarp_netflow_oper::NetFlow::Statistics::Statistic::Server::FlowExporters::FlowExporter> > flow_exporter;
...
class NetFlow::Statistics::Statistic::Server::FlowExporters::FlowExporter::Exporter : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_skywarp_netflow_oper::NetFlow::Statistics::Statistic::Server::FlowExporters::FlowExporter::Exporter::Statistic_> > statistic;
...
class NetFlow::Statistics::Statistic::Server::FlowExporters::FlowExporter::Exporter::Statistic_ : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_skywarp_netflow_oper::NetFlow::Statistics::Statistic::Server::FlowExporters::FlowExporter::Exporter::Statistic_::Collector> > collector;
