...
class FileSystem : public ydk::Entity
{
    public:
        FileSystem();
        ~FileSystem();
...
class FileSystem::Node : public ydk::Entity
{
    public:
        Node();
        ~Node();
...
class FileSystem::Node::FileSystem_ : public ydk::Entity
{
    public:
        FileSystem_();
        ~FileSystem_();
        ...
        ydk::YLeaf free; //type: string
        ydk::YLeaf type; //type: string
        ydk::YLeaf flags; //type: string
        ydk::YLeaf prefixes; //type: string
