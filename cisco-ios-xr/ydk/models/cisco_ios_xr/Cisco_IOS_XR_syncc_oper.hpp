...
class TimingController::Nodes : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_syncc_oper::TimingController::Nodes::Node> > node;
...
class TimingController::Nodes::Node::TimingSource : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_syncc_oper::TimingController::Nodes::Node::TimingSource::SynccInstance> > syncc_instance;
