...
std::shared_ptr<ydk::Entity> LptsIfib::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> LptsIfib::get_children() const
{
...
std::shared_ptr<ydk::Entity> LptsIfib::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> LptsIfib::Nodes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "node")
    {
        auto ent_ = std::make_shared<LptsIfib::Nodes::Node>();
        ent_->parent = this;
        node.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> LptsIfib::Nodes::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> LptsIfib::Nodes::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> LptsIfib::Nodes::Node::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(slice_ids != nullptr)
...
std::shared_ptr<ydk::Entity> LptsIfib::Nodes::Node::SliceIds::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "slice-id")
    {
        auto ent_ = std::make_shared<LptsIfib::Nodes::Node::SliceIds::SliceId>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> LptsIfib::Nodes::Node::SliceIds::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> LptsIfib::Nodes::Node::SliceIds::SliceId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "entry")
    {
        auto ent_ = std::make_shared<LptsIfib::Nodes::Node::SliceIds::SliceId::Entry>();
        ent_->parent = this;
        entry.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> LptsIfib::Nodes::Node::SliceIds::SliceId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> LptsIfib::Nodes::Node::SliceIds::SliceId::Entry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> LptsIfib::Nodes::Node::SliceIds::SliceId::Entry::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
