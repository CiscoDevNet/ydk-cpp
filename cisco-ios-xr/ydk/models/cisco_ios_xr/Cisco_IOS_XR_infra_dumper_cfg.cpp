...
std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::get_children() const
{
    ...
    if(choice1 != nullptr)
    {
        _children["choice1"] = choice1;
    }

    if(choice3 != nullptr)
    {
        _children["choice3"] = choice3;
    }

    if(process_names != nullptr)
    {
        _children["process-names"] = process_names;
    }

    if(choice2 != nullptr)
    {
        _children["choice2"] = choice2;
    }
...
std::shared_ptr<ydk::Entity> Exception::Choice1::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::Choice1::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Exception::Choice3::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::Choice3::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Exception::ProcessNames::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "process-name")
    {
        auto ent_ = std::make_shared<Exception::ProcessNames::ProcessName>();
        ent_->parent = this;
        process_name.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::ProcessNames::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : process_name.entities())
    {
...
std::shared_ptr<ydk::Entity> Exception::ProcessNames::ProcessName::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::ProcessNames::ProcessName::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(core_option != nullptr)
    {
        _children["core-option"] = core_option;
    }
...
std::shared_ptr<ydk::Entity> Exception::ProcessNames::ProcessName::CoreOption::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::ProcessNames::ProcessName::CoreOption::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Exception::Choice2::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::Choice2::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
