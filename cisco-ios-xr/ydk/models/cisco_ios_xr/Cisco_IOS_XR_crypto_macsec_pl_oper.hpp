...
class MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext : public ydk::Entity
{
    public:
        ...
        ydk::YLeaf type; //type: MacsecPhyVendor
...
class MacsecPhyVendor : public ydk::Enum
{
    public:
        static const ydk::Enum::YLeaf msfpga;
        static const ydk::Enum::YLeaf xlmsfpga;
        static const ydk::Enum::YLeaf apm_es200;
        static const ydk::Enum::YLeaf apm_x120;
        static const ydk::Enum::YLeaf mv88ec808;
        static const ydk::Enum::YLeaf max_card_type;
