#ifndef _CISCO_IOS_XR_SYSADMIN_LED_MGR_UI_
#define _CISCO_IOS_XR_SYSADMIN_LED_MGR_UI_
...
class Led::Location : public ydk::Entity
{
    public:
        Location();
        ~Location();
...
class Led::Location::LedAttributes : public ydk::Entity
{
    public:
        LedAttributes();
        ~LedAttributes();
...
class Led::Trace : public ydk::Entity
{
    public:
        Trace();
        ~Trace();
...
class Led::Trace::Location : public ydk::Entity
{
    public:
        Location();
        ~Location();
...
class Led::Trace::Location::AllOptions : public ydk::Entity
{
    public:
        AllOptions();
        ~AllOptions();
...
class Led::Trace::Location::AllOptions::TraceBlocks : public ydk::Entity
{
    public:
        TraceBlocks();
        ~TraceBlocks();
...
#endif /* _CISCO_IOS_XR_SYSADMIN_LED_MGR_UI_ */
