...
std::shared_ptr<ydk::Entity> PlatformFaultManager::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::get_children() const
{
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(fault_type1s != nullptr)
    {
        _children["fault-type1s"] = fault_type1s;
    }
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "fault-type1")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Exclude::FaultType1s::FaultType1>();
        ent_->parent = this;
        fault_type1.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : fault_type1.entities())
    {
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(fault_type2s != nullptr)
    {
        _children["fault-type2s"] = fault_type2s;
    }
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "fault-type2")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2>();
        ent_->parent = this;
        fault_type2.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : fault_type2.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(fault_type3s != nullptr)
    {
        _children["fault-type3s"] = fault_type3s;
    }
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "fault-type3")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3>();
        ent_->parent = this;
        fault_type3.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : fault_type3.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "racks")
    {
        if(racks == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(racks != nullptr)
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "rack")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack>();
        ent_->parent = this;
        rack.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(slots != nullptr)
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::Slots::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "slot")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::Slots::Slot>();
        ent_->parent = this;
        slot.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::Slots::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::Slots::Slot::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::Slots::Slot::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(fault_summary != nullptr)
    {
        _children["fault-summary"] = fault_summary;
    }

    if(hardware_fault_devices != nullptr)
    {
        _children["hardware-fault-devices"] = hardware_fault_devices;
    }
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::Slots::Slot::FaultSummary::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::Slots::Slot::FaultSummary::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::Slots::Slot::HardwareFaultDevices::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "hardware-fault-device")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice>();
        ent_->parent = this;
        hardware_fault_device.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::Slots::Slot::HardwareFaultDevices::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : hardware_fault_device.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "hardware-fault-type")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::HardwareFaultType>();
        ent_->parent = this;
        hardware_fault_type.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : hardware_fault_type.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::HardwareFaultType::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::FaultType3s::FaultType3::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::HardwareFaultType::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "rack")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack>();
        ent_->parent = this;
        rack.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "slots")
    {
        if(slots == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(slots != nullptr)
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::Slots::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "slot")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::Slots::Slot>();
        ent_->parent = this;
        slot.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::Slots::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::Slots::Slot::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "fault-summary")
    {
        if(fault_summary == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::Slots::Slot::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(fault_summary != nullptr)
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::Slots::Slot::FaultSummary::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::Slots::Slot::FaultSummary::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::Slots::Slot::HardwareFaultDevices::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "hardware-fault-device")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice>();
        ent_->parent = this;
        hardware_fault_device.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::Slots::Slot::HardwareFaultDevices::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "hardware-fault-type")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::HardwareFaultType>();
        ent_->parent = this;
        hardware_fault_type.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::HardwareFaultType::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::FaultType2s::FaultType2::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::HardwareFaultType::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "rack")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack>();
        ent_->parent = this;
        rack.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "slots")
    {
        if(slots == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(slots != nullptr)
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::Slots::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "slot")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::Slots::Slot>();
        ent_->parent = this;
        slot.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::Slots::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::Slots::Slot::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "fault-summary")
    {
        if(fault_summary == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::Slots::Slot::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(fault_summary != nullptr)
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::Slots::Slot::FaultSummary::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::Slots::Slot::FaultSummary::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::Slots::Slot::HardwareFaultDevices::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "hardware-fault-device")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice>();
        ent_->parent = this;
        hardware_fault_device.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::Slots::Slot::HardwareFaultDevices::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "hardware-fault-type")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::HardwareFaultType>();
        ent_->parent = this;
        hardware_fault_type.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::HardwareFaultType::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Exclude::FaultType1s::FaultType1::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::HardwareFaultType::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Racks::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "rack")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Racks::Rack>();
        ent_->parent = this;
        rack.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Racks::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Racks::Rack::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "slots")
    {
        if(slots == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Racks::Rack::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(slots != nullptr)
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Racks::Rack::Slots::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "slot")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Racks::Rack::Slots::Slot>();
        ent_->parent = this;
        slot.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Racks::Rack::Slots::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Racks::Rack::Slots::Slot::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "fault-summary")
    {
        if(fault_summary == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Racks::Rack::Slots::Slot::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(fault_summary != nullptr)
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Racks::Rack::Slots::Slot::FaultSummary::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Racks::Rack::Slots::Slot::FaultSummary::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Racks::Rack::Slots::Slot::HardwareFaultDevices::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "hardware-fault-device")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice>();
        ent_->parent = this;
        hardware_fault_device.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Racks::Rack::Slots::Slot::HardwareFaultDevices::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "hardware-fault-type")
    {
        auto ent_ = std::make_shared<PlatformFaultManager::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::HardwareFaultType>();
        ent_->parent = this;
        hardware_fault_type.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> PlatformFaultManager::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::HardwareFaultType::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformFaultManager::Racks::Rack::Slots::Slot::HardwareFaultDevices::HardwareFaultDevice::HardwareFaultType::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
