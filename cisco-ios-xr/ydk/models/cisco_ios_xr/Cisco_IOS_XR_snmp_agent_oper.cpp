...
{
    if(name == "incoming-q" || name == "pending-q" || name == "in-avg" || name == "in-max" || name == "in-min" || name == "pend-avg" || name == "pend-max" || name == "pend-min" || name == "qlen")
        return true;
    return false;
}
...
{
    if(name == "trap-q" || name == "trap-avg" || name == "trap-max" || name == "trap-min")
        return true;
    return false;
}
