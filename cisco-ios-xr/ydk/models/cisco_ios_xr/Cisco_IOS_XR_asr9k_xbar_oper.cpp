...
{
    if(name == "asic-id" || name == "diagnostic-packet-count-high" || name == "diagnostic-packet-count-low" || name == "egress-channel-utilization-count-high" || name == "egress-channel-utilization-count-low" || name == "egress-packet-count-since-last-read-high" || name == "egress-packet-count-since-last-read-low" || name == "fpoedb-correctable-ecc-error-count-high" || name == "fpoedb-correctable-ecc-error-count-low" || name == "fpoedb-uncorrectable-ecc-error-count-high" || name == "fpoedb-uncorrectable-ecc-error-count-low" || name == "header-crc-error-count-high" || name == "header-crc-error-count-low" || name == "holdrop-count-high" || name == "holdrop-count-low" || name == "ingress-channel-utilization-count-high" || name == "ingress-channel-utilization-count-low" || name == "ingress-packet-count-since-last-read-high" || name == "ingress-packet-count-since-last-read-low" || name == "input-buffer-back-pressure-count-high" || name == "input-buffer-back-pressure-count-low" || name == "input-buffer-correctable-ecc-error-count-high" || name == "input-buffer-correctable-ecc-error-count-low" || name == "input-buffer-queued-packet-count-high" || name == "input-buffer-queued-packet-count-low" || name == "input-buffer-uncorrectable-ecc-error-count-high" || name == "input-buffer-uncorrectable-ecc-error-count-low" || name == "internal-error-count" || name == "null-fpoe-drop-count-high" || name == "null-fpoe-drop-count-low" || name == "output-buffer-back-pressure-count-high" || name == "output-buffer-back-pressure-count-low" || name == "output-buffer-correctable-ecc-error-count-high" || name == "output-buffer-correctable-ecc-error-count-low" || name == "output-buffer-queued-packet-count-high" || name == "output-buffer-queued-packet-count-low" || name == "output-buffer-uncorrectable-ecc-error-count-high" || name == "output-buffer-uncorrectable-ecc-error-count-low" || name == "packet-crc-error-count-high" || name == "packet-crc-error-count-low" || name == "port" || name == "short-input-header-error-count-high" || name == "short-input-header-error-count-low" || name == "short-packet-error-count-high" || name == "short-packet-error-count-low" || name == "xbar-timeout-drop-count-high" || name == "xbar-timeout-drop-count-low")
        return true;
    return false;
}
...
{
    if(name == "ca-stats" || name == "ma-stats" || name == "pe-cc-stats" || name == "pe-mc-stats" || name == "pe-stats" || name == "pe-uc-stats" || name == "pi-cc-stats" || name == "pi-mc-stats" || name == "pi-stats" || name == "pi-uc-stats" || name == "ua0-stats" || name == "ua1-stats" || name == "ua2-stats" || name == "asic-id" || name == "internal-err-cnt" || name == "port")
        return true;
    return false;
}
...
{
    if(name == "dest-drop-pkt-cnt" || name == "dest-src-pkt-cnt" || name == "rcv-pkt-cnt" || name == "rx-drop-pkt-cnt" || name == "rx-fabric-to-cnt" || name == "rx-hol-to-cnt" || name == "rx-re-transmit-cnt" || name == "src-dest-pkt-cnt" || name == "tx-pkt-cnt")
        return true;
    return false;
}
...
{
    if(name == "mc2uc-preempt-cnt" || name == "total-calc-rate" || name == "total-rate1-cnt" || name == "total-rate2-cnt" || name == "total-rate3-cnt")
        return true;
    return false;
}
...
{
    if(name == "calc-rate" || name == "cpp-head-drop-pkt-cnt" || name == "crc-stomp-pkt-cnt" || name == "diag-pkt-cnt" || name == "fpoe-mem-ecc-1bit-err-cnt" || name == "fpoe-mem-ecc-2bit-err-cnt" || name == "in-coming-pkt-err-cnt" || name == "line-err-drp-pkt" || name == "line-s-written-in-mem0" || name == "line-s-written-in-mem1" || name == "line-s-written-in-mem2" || name == "max-pkt-len-err-cnt" || name == "min-pkt-len-err-cnt" || name == "pkt-cfh-crc-err-cnt" || name == "pkt-crc-err-cnt" || name == "pkt-fpoe-addr-rng-hit-cnt" || name == "pkt-null-poe-sent-ua0-cnt" || name == "pkt-null-poe-sent-ua1-cnt" || name == "pkt-null-poe-sent-ua2-cnt" || name == "pkt-rcv-cnt" || name == "pkt-sent-to-disabled-port-cnt" || name == "pkt-seq-err-cnt" || name == "pkts-sent-to-ux0-cnt" || name == "pkts-sent-to-ux1-cnt" || name == "pkts-sent-to-ux2-cnt" || name == "rate-cnt" || name == "stop-thrsh-hit-cnt" || name == "tail-drp-pkt-cnt" || name == "tr-head-drop-pkt-cnt" || name == "tr-pkt-sent-to-ux" || name == "uc0-data-mem-ecc-1bit-err-cnt" || name == "uc0-data-mem-ecc-2bit-err-cnt" || name == "uc1-data-mem-ecc-1bit-err-cnt" || name == "uc1-data-mem-ecc-2bit-err-cnt" || name == "uc2-data-mem-ecc-1bit-err-cnt" || name == "uc2-data-mem-ecc-2bit-err-cnt")
        return true;
    return false;
}
