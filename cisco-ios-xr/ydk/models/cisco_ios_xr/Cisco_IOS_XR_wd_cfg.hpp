...
class Watchdog : public ydk::Entity
{
    public:
        ...
        ydk::YLeaf threshold_memory_switchover; //type: uint32
        ydk::YLeaf restart_deadlock_disable; //type: empty
        ydk::YLeaf monitor_qnet_timeout; //type: uint32
        ydk::YLeaf monitor_cpuhog_timeout; //type: uint32
        ydk::YLeaf monitor_procnto_timeout; //type: uint32
        ydk::YLeaf overload_notification; //type: empty
        ydk::YLeaf restart_cpuhog_disable; //type: empty
