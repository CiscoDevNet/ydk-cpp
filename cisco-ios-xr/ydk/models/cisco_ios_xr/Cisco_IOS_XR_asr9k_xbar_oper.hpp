...
class CrossBarStats::Nodes::Node::CrossBarTable::SkbStats::SkbStat::EgStats::ObuStats : public ydk::Entity
{
    public:
        ...
        class DataQueque; //type: CrossBarStats::Nodes::Node::CrossBarTable::SkbStats::SkbStat::EgStats::ObuStats::DataQueque

        ydk::YList data_queque;
        
}; // CrossBarStats::Nodes::Node::CrossBarTable::SkbStats::SkbStat::EgStats::ObuStats


class CrossBarStats::Nodes::Node::CrossBarTable::SkbStats::SkbStat::EgStats::ObuStats::DataQueque : public ydk::Entity
{
    public:
        DataQueque();
        ~DataQueque();
...
}; // CrossBarStats::Nodes::Node::CrossBarTable::SkbStats::SkbStat::EgStats::ObuStats::DataQueque
