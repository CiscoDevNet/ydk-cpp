...
class Ppp : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_ppp_ma_syslog_cfg::Ppp::Syslog> syslog;
        
}; // Ppp


class Ppp::Syslog : public ydk::Entity
{
    public:
        Syslog();
        ~Syslog();
        ...
        ydk::YLeaf enable_session_status; //type: empty
