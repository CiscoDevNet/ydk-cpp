...
class Logmsg : public ydk::Entity
{
    public:
        Logmsg();
        ~Logmsg();
        ...
        class Input; //type: Logmsg::Input

        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_syslog_act::Logmsg::Input> input;
        
}; // Logmsg


class Logmsg::Input : public ydk::Entity
{
    public:
        Input();
        ~Input();
