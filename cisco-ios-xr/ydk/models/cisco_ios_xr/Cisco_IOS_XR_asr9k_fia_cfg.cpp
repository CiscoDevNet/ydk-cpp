...
std::shared_ptr<ydk::Entity> FabricFiaConfig::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> FabricFiaConfig::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(fia_intf_policer != nullptr)
    {
        _children["fia-intf-policer"] = fia_intf_policer;
    }
...
std::shared_ptr<ydk::Entity> FabricFiaConfig::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> FabricFiaConfig::FiaIntfPolicer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> FabricFiaConfig::FiaIntfPolicer::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
