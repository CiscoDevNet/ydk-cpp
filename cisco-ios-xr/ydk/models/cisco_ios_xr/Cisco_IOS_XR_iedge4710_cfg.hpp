...
class SubscriberManager : public ydk::Entity
{
    public:
        SubscriberManager();
        ~SubscriberManager();
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_iedge4710_cfg::SubscriberManager::Accounting> accounting;
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_iedge4710_cfg::SubscriberManager::Srg> srg;
        
}; // SubscriberManager


class SubscriberManager::Accounting : public ydk::Entity
{
    public:
        Accounting();
        ~Accounting();
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_iedge4710_cfg::SubscriberManager::Accounting::SendStop> send_stop;
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_iedge4710_cfg::SubscriberManager::Accounting::Interim> interim;
        
}; // SubscriberManager::Accounting


class SubscriberManager::Accounting::SendStop : public ydk::Entity
{
    public:
        SendStop();
        ~SendStop();
        ...
        class SetupFailure; //type: SubscriberManager::Accounting::SendStop::SetupFailure

        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_iedge4710_cfg::SubscriberManager::Accounting::SendStop::SetupFailure> setup_failure;
        
}; // SubscriberManager::Accounting::SendStop


class SubscriberManager::Accounting::SendStop::SetupFailure : public ydk::Entity
{
    public:
        SetupFailure();
        ~SetupFailure();
...
class SubscriberManager::Accounting::Interim : public ydk::Entity
{
    public:
        Interim();
        ~Interim();
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_iedge4710_cfg::SubscriberManager::Accounting::Interim::Variation> variation;
        
}; // SubscriberManager::Accounting::Interim


class SubscriberManager::Accounting::Interim::Variation : public ydk::Entity
{
    public:
        Variation();
        ~Variation();
        ...
        ydk::YLeaf maximum_percentage_variation; //type: uint32

}; // SubscriberManager::Accounting::Interim::Variation


class SubscriberManager::Srg : public ydk::Entity
{
    public:
        Srg();
        ~Srg();
        ...
        ydk::YLeaf sync_account_session_id; //type: empty

}; // SubscriberManager::Srg

class SubscriberFeaturette : public ydk::Entity
{
    public:
...
class SubManager::Location : public ydk::Entity
{
    public:
        Location();
        ~Location();
        ...
        ydk::YLeaf location1; //type: string
        ydk::YLeaf history; //type: empty
        class Trace; //type: SubManager::Location::Trace

        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_iedge4710_cfg::SubManager::Location::Trace> trace;
        
}; // SubManager::Location


class SubManager::Location::Trace : public ydk::Entity
{
    public:
        Trace();
        ~Trace();
