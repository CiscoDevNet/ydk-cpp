...
std::shared_ptr<Entity> SysmgrProcessRestart::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::shared_ptr<Entity> SysmgrProcessRestart::clone_ptr() const
{
...
std::shared_ptr<Entity> SysmgrProcessRestart::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}
