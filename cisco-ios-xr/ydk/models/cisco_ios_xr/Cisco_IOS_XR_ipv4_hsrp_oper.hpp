...
class Hsrp : public Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XR_ipv4_hsrp_oper::Hsrp::BfdSessions> bfd_sessions;
        std::shared_ptr<Cisco_IOS_XR_ipv4_hsrp_oper::Hsrp::Ipv4> ipv4;
...
class Hsrp::Ipv4::Groups : public Entity
{
    public:
        Groups();
        ~Groups();
...
class Hsrp::Ipv4::Groups::Group : public Entity
{
    public:
        Group();
        ~Group();
        ...
        std::shared_ptr<Cisco_IOS_XR_ipv4_hsrp_oper::Hsrp::Ipv4::Groups::Group::CoupReceivedTime> coup_received_time;
        std::shared_ptr<Cisco_IOS_XR_ipv4_hsrp_oper::Hsrp::Ipv4::Groups::Group::CoupSentTime> coup_sent_time;
        std::vector<std::shared_ptr<Cisco_IOS_XR_ipv4_hsrp_oper::Hsrp::Ipv4::Groups::Group::GlobalAddress> > global_address;
        std::shared_ptr<Cisco_IOS_XR_ipv4_hsrp_oper::Hsrp::Ipv4::Groups::Group::ResignReceivedTime> resign_received_time;
...
class Hsrp::Ipv4::Groups::Group::ResignSentTime : public Entity
{
    public:
        ResignSentTime();
        ~ResignSentTime();
...
class Hsrp::Ipv4::Groups::Group::ResignReceivedTime : public Entity
{
    public:
        ResignReceivedTime();
        ~ResignReceivedTime();
...
class Hsrp::Ipv4::Groups::Group::CoupSentTime : public Entity
{
    public:
        CoupSentTime();
        ~CoupSentTime();
...
class Hsrp::Ipv4::Groups::Group::CoupReceivedTime : public Entity
{
    public:
        CoupReceivedTime();
        ~CoupReceivedTime();
...
class Hsrp::Ipv4::Groups::Group::Statistics : public Entity
{
    public:
        Statistics();
        ~Statistics();
...
class Hsrp::Ipv4::Groups::Group::GlobalAddress : public Entity
{
    public:
        GlobalAddress();
        ~GlobalAddress();
...
class Hsrp::Ipv4::Groups::Group::StateChangeHistory : public Entity
{
    public:
        StateChangeHistory();
        ~StateChangeHistory();
...
class Hsrp::Ipv4::Groups::Group::StateChangeHistory::Time : public Entity
{
    public:
        Time();
        ~Time();
...
class Hsrp::Ipv4::TrackedInterfaces : public Entity
{
    public:
        TrackedInterfaces();
        ~TrackedInterfaces();
...
class Hsrp::Ipv4::TrackedInterfaces::TrackedInterface : public Entity
{
    public:
        TrackedInterface();
        ~TrackedInterface();
...
class Hsrp::Ipv4::Interfaces : public Entity
{
    public:
        Interfaces();
        ~Interfaces();
...
class Hsrp::Ipv4::Interfaces::Interface : public Entity
{
    public:
        Interface();
        ~Interface();
...
class Hsrp::Ipv4::Interfaces::Interface::Statistics : public Entity
{
    public:
        Statistics();
        ~Statistics();
...
class Hsrp::MgoSessions : public Entity
{
    public:
        MgoSessions();
        ~MgoSessions();
...
class Hsrp::MgoSessions::MgoSession : public Entity
{
    public:
        MgoSession();
        ~MgoSession();
...
class Hsrp::MgoSessions::MgoSession::Slave : public Entity
{
    public:
        Slave();
        ~Slave();
...
class Hsrp::Ipv6::TrackedInterfaces : public Entity
{
    public:
        TrackedInterfaces();
        ~TrackedInterfaces();
...
class Hsrp::Ipv6::TrackedInterfaces::TrackedInterface : public Entity
{
    public:
        TrackedInterface();
        ~TrackedInterface();
...
class Hsrp::Ipv6::Groups : public Entity
{
    public:
        Groups();
        ~Groups();
...
class Hsrp::Ipv6::Groups::Group : public Entity
{
    public:
        Group();
        ~Group();
        ...
        std::shared_ptr<Cisco_IOS_XR_ipv4_hsrp_oper::Hsrp::Ipv6::Groups::Group::CoupReceivedTime> coup_received_time;
        std::shared_ptr<Cisco_IOS_XR_ipv4_hsrp_oper::Hsrp::Ipv6::Groups::Group::CoupSentTime> coup_sent_time;
        std::vector<std::shared_ptr<Cisco_IOS_XR_ipv4_hsrp_oper::Hsrp::Ipv6::Groups::Group::GlobalAddress> > global_address;
        std::shared_ptr<Cisco_IOS_XR_ipv4_hsrp_oper::Hsrp::Ipv6::Groups::Group::ResignReceivedTime> resign_received_time;
...
class Hsrp::Ipv6::Groups::Group::ResignSentTime : public Entity
{
    public:
        ResignSentTime();
        ~ResignSentTime();
...
class Hsrp::Ipv6::Groups::Group::ResignReceivedTime : public Entity
{
    public:
        ResignReceivedTime();
        ~ResignReceivedTime();
...
class Hsrp::Ipv6::Groups::Group::CoupSentTime : public Entity
{
    public:
        CoupSentTime();
        ~CoupSentTime();
...
class Hsrp::Ipv6::Groups::Group::CoupReceivedTime : public Entity
{
    public:
        CoupReceivedTime();
        ~CoupReceivedTime();
...
class Hsrp::Ipv6::Groups::Group::Statistics : public Entity
{
    public:
        Statistics();
        ~Statistics();
...
class Hsrp::Ipv6::Groups::Group::GlobalAddress : public Entity
{
    public:
        GlobalAddress();
        ~GlobalAddress();
...
class Hsrp::Ipv6::Groups::Group::StateChangeHistory : public Entity
{
    public:
        StateChangeHistory();
        ~StateChangeHistory();
...
class Hsrp::Ipv6::Groups::Group::StateChangeHistory::Time : public Entity
{
    public:
        Time();
        ~Time();
...
class Hsrp::Ipv6::Interfaces : public Entity
{
    public:
        Interfaces();
        ~Interfaces();
...
class Hsrp::Ipv6::Interfaces::Interface : public Entity
{
    public:
        Interface();
        ~Interface();
...
class Hsrp::Ipv6::Interfaces::Interface::Statistics : public Entity
{
    public:
        Statistics();
        ~Statistics();
...
class Hsrp::BfdSessions : public Entity
{
    public:
        BfdSessions();
        ~BfdSessions();
...
class Hsrp::BfdSessions::BfdSession : public Entity
{
    public:
        BfdSession();
        ~BfdSession();
...
class Hsrp::BfdSessions::BfdSession::Group : public Entity
{
    public:
        Group();
        ~Group();
...
class Hsrp::Summary : public Entity
{
    public:
        Summary();
        ~Summary();
