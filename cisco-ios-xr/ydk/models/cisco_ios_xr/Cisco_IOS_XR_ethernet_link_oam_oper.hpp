...
class EtherLinkOam::DiscoveryInfoInterfaces : public Entity
{
    public:
...
class EtherLinkOam::DiscoveryInfoInterfaces::DiscoveryInfoInterface : public Entity
{
    public:
...
class EtherLinkOam::InterfaceStateInterfaces : public Entity
{
    public:
...
class EtherLinkOam::InterfaceStateInterfaces::InterfaceStateInterface : public Entity
{
    public:
...
class EtherLinkOam::InterfaceStateInterfaces::InterfaceStateInterface::Errors : public Entity
{
    public:
        Errors();
        ~Errors();
...
class EtherLinkOam::InterfaceStateInterfaces::InterfaceStateInterface::EfdTriggers : public Entity
{
    public:
        EfdTriggers();
        ~EfdTriggers();
...
class EtherLinkOam::RunningConfigInterfaces : public Entity
{
    public:
...
class EtherLinkOam::RunningConfigInterfaces::RunningConfigInterface : public Entity
{
    public:
        ...
        YLeaf symbol_period_window_units; //type: uint8
        YLeaf symbol_period_window_multiplier; //type: uint8
        YLeaf symbol_period_threshold_low; //type: uint64
        YLeaf symbol_period_threshold_high; //type: uint64
        YLeaf symbol_period_threshold_units; //type: uint8
        YLeaf symbol_period_threshold_low_multiplier; //type: uint8
        YLeaf symbol_period_threshold_high_multiplier; //type: uint8
        YLeaf frame_window; //type: uint32
        YLeaf frame_threshold_low; //type: uint64
        YLeaf frame_threshold_high; //type: uint64
        YLeaf frame_threshold_low_multiplier; //type: uint8
        YLeaf frame_threshold_high_multiplier; //type: uint8
        YLeaf frame_period_window; //type: uint32
        YLeaf frame_period_window_units; //type: uint8
        YLeaf frame_period_window_multiplier; //type: uint8
        YLeaf frame_period_threshold_low; //type: uint64
        YLeaf frame_period_threshold_high; //type: uint64
        YLeaf frame_period_threshold_units; //type: uint8
        YLeaf frame_period_threshold_low_multiplier; //type: uint8
        YLeaf frame_period_threshold_high_multiplier; //type: uint8
        YLeaf frame_seconds_window; //type: uint32
        YLeaf frame_seconds_threshold_low; //type: uint64
        YLeaf frame_seconds_threshold_high; //type: uint64
...
class EtherLinkOam::Nodes : public Entity
{
    public:
        Nodes();
        ~Nodes();
...
class EtherLinkOam::Nodes::Node : public Entity
{
    public:
        Node();
        ~Node();
...
class EtherLinkOam::Nodes::Node::Summary : public Entity
{
    public:
        Summary();
        ~Summary();
...
class EtherLinkOam::EventLogEntryInterfaces : public Entity
{
    public:
...
class EtherLinkOam::EventLogEntryInterfaces::EventLogEntryInterface : public Entity
{
    public:
...
class EtherLinkOam::EventLogEntryInterfaces::EventLogEntryInterface::EventLogEntryIndexes : public Entity
{
    public:
...
class EtherLinkOam::EventLogEntryInterfaces::EventLogEntryInterface::EventLogEntryIndexes::EventLogEntryIndex : public Entity
{
    public:
        EventLogEntryIndex();
        ~EventLogEntryIndex();
        ...
        YLeaf window_units; //type: uint8
        YLeaf threshold_config_units; //type: uint64
        YLeaf threshold_units; //type: uint8
...
class EtherLinkOam::StatsInterfaces : public Entity
{
    public:
        StatsInterfaces();
        ~StatsInterfaces();
...
class EtherLinkOam::StatsInterfaces::StatsInterface : public Entity
{
    public:
        StatsInterface();
        ~StatsInterface();
