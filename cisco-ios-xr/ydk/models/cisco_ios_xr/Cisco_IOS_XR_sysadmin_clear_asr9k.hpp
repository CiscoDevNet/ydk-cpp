#ifndef _CISCO_IOS_XR_SYSADMIN_CLEAR_ASR9K_
#define _CISCO_IOS_XR_SYSADMIN_CLEAR_ASR9K_
...
class Clear : public ydk::Entity
{
    public:
        ...
        class Plugin; //type: Clear::Plugin

        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_sysadmin_clear_asr9k::Clear::Controller> controller;
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_sysadmin_clear_asr9k::Clear::Plugin> plugin;
...
class Clear::Controller : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_sysadmin_clear_asr9k::Clear::Controller::Switch> switch_;
...
class Clear::Controller::Switch : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_sysadmin_clear_asr9k::Clear::Controller::Switch::Oper> oper;
...
class Clear::Controller::Switch::Oper : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_sysadmin_clear_asr9k::Clear::Controller::Switch::Oper::Fdb> fdb;
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_sysadmin_clear_asr9k::Clear::Controller::Switch::Oper::Statistics> statistics;
...
class Clear::Plugin : public ydk::Entity
{
    public:
        Plugin();
        ~Plugin();
        ...
        class Slot; //type: Clear::Plugin::Slot

        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_sysadmin_clear_asr9k::Clear::Plugin::Slot> slot;
        
}; // Clear::Plugin


class Clear::Plugin::Slot : public ydk::Entity
{
    public:
        Slot();
        ~Slot();
...
class Clear::Plugin::Slot::Location : public ydk::Entity
{
    public:
        Location();
        ~Location();
...
#endif /* _CISCO_IOS_XR_SYSADMIN_CLEAR_ASR9K_ */
