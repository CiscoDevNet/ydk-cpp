...
#include "Cisco_IOS_XR_prm_hwmod_loadbalance_cfg.hpp"

using namespace ydk;

namespace cisco_ios_xr {
namespace Cisco_IOS_XR_prm_hwmod_loadbalance_cfg {
...
std::string HardwareModule::get_segment_path() const
{
    ...
    path_buffer << "Cisco-IOS-XR-prm-hwmod-loadbalance-cfg:hardware-module";
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-prm-hwmod-loadbalance-cfg:hardware-module/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-prm-hwmod-loadbalance-cfg:hardware-module/loadbalancing/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-prm-hwmod-loadbalance-cfg:hardware-module/loadbalancing/bgp3107/" << get_segment_path();
    return path_buffer.str();
}
