...
std::shared_ptr<Entity> MlanDisableCmp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> MlanDisableCmp::get_children() const
{
...
std::shared_ptr<Entity> MlanDisableCmp::clone_ptr() const
{
...
std::shared_ptr<Entity> MlanDisableCmp::Nodes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> MlanDisableCmp::Nodes::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    for (auto const & c : node)
    {
...
std::shared_ptr<Entity> MlanDisableCmp::Nodes::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> MlanDisableCmp::Nodes::Node::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}
