...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::get_children()
{
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::get_children()
{
    for (auto const & c : node)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::get_children()
{
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::get_children()
{
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::get_children()
{
    for (auto const & c : vrf)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::get_children()
{
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Briefs::get_children()
{
    for (auto const & c : brief)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Briefs::Brief::get_children()
{
    for (auto const & c : address)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Briefs::Brief::LinkLocalAddress::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Briefs::Brief::Address::get_children()
{
    return children;
}
...
std::shared_ptr<Entity> Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "global-detail")
    {
        ...
        children[segment_path] = global_detail.back();
        return children.at(segment_path);
    }
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::get_children()
{
    for (auto const & c : global_detail)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
std::shared_ptr<Entity> Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "client-multicast-group")
    {
        ...
        children[segment_path] = client_multicast_group.back();
        return children.at(segment_path);
    }
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::get_children()
{
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::LinkLocalAddress::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::AccessControlList::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::MultiAccessControlList::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::Rpf::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::BgpPa::get_children()
{
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::BgpPa::Input::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::BgpPa::Output::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::Utime::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::IdbUtime::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::CapsUtime::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::FwdEnUtime::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::FwdDisUtime::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::MulticastGroup::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::Address::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalDetails::GlobalDetail::ClientMulticastGroup::get_children()
{
    return children;
}
...
std::shared_ptr<Entity> Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalBriefs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "global-brief")
    {
        ...
        children[segment_path] = global_brief.back();
        return children.at(segment_path);
    }
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalBriefs::get_children()
{
    for (auto const & c : global_brief)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalBriefs::GlobalBrief::get_children()
{
    for (auto const & c : address)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalBriefs::GlobalBrief::LinkLocalAddress::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::GlobalBriefs::GlobalBrief::Address::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::get_children()
{
    for (auto const & c : detail)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::Detail::get_children()
{
    if(children.find("access-control-list") == children.end())
    {
        if(access_control_list != nullptr)
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::Detail::LinkLocalAddress::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::Detail::AccessControlList::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::Detail::MultiAccessControlList::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::Detail::Rpf::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::Detail::BgpPa::get_children()
{
    if(children.find("input") == children.end())
    {
        if(input != nullptr)
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::Detail::BgpPa::Input::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::Detail::BgpPa::Output::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::Detail::Utime::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::Detail::IdbUtime::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::Detail::CapsUtime::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::Detail::FwdEnUtime::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::Detail::FwdDisUtime::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::Detail::MulticastGroup::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::Detail::Address::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Vrfs::Vrf::Details::Detail::ClientMulticastGroup::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Summary::get_children()
{
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Summary::IfUpUp::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Summary::IfUpDown::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Summary::IfDownDown::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Network::Nodes::Node::InterfaceData::Summary::IfShutdownDown::get_children()
{
    return children;
}
