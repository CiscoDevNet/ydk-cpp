...
{
    if(name == "nested-groups" || name == "operators" || name == "port-ranges" || name == "object-name" || name == "description")
        return true;
    return false;
}
...
{
    if(name == "address-ranges" || name == "addresses" || name == "hosts" || name == "nested-groups" || name == "object-name" || name == "description")
        return true;
    return false;
}
