...
std::shared_ptr<Entity> HwModuleSubslot::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> HwModuleSubslot::get_children() const
{
...
std::shared_ptr<Entity> HwModuleSubslot::clone_ptr() const
{
...
std::shared_ptr<Entity> HwModuleSubslot::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> HwModuleSubslot::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
