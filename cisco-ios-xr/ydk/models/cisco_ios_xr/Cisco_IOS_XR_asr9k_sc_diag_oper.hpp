#ifndef _CISCO_IOS_XR_ASR9K_SC_DIAG_OPER_
#define _CISCO_IOS_XR_ASR9K_SC_DIAG_OPER_
...
namespace Cisco_IOS_XR_asr9k_sc_diag_oper {
...
class Diag : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_asr9k_sc_diag_oper::Diag::Racks> racks;
...
class Diag::Racks::Rack : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_asr9k_sc_diag_oper::Diag::Racks::Rack::Slots> slots;
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_asr9k_sc_diag_oper::Diag::Racks::Rack::Summary> summary;
...
class Diag::Racks::Rack::Slots::Slot : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_asr9k_sc_diag_oper::Diag::Racks::Rack::Slots::Slot::Detail> detail;
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_asr9k_sc_diag_oper::Diag::Racks::Rack::Slots::Slot::Instances> instances;
...
class Diag::Racks::Rack::Slots::Slot::Instances::Instance : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_asr9k_sc_diag_oper::Diag::Racks::Rack::Slots::Slot::Instances::Instance::Detail> detail;
...
class Diag::Racks::Rack::Slots::Slot::Instances::Instance::Detail : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_asr9k_sc_diag_oper::Diag::Racks::Rack::Slots::Slot::Instances::Instance::Detail::Node> node;
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_asr9k_sc_diag_oper::Diag::Racks::Rack::Slots::Slot::Instances::Instance::Detail::Spa> spa;
...
#endif /* _CISCO_IOS_XR_ASR9K_SC_DIAG_OPER_ */
