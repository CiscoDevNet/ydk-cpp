...
class HardwareModule::Node::Slice : public ydk::Entity
{
    public:
        ...
        class ClientAins; //type: HardwareModule::Node::Slice::ClientAins

        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_ncs1k_mxp_cfg::HardwareModule::Node::Slice::Values> values;
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_ncs1k_mxp_cfg::HardwareModule::Node::Slice::ClientAins> client_ains;
...
class HardwareModule::Node::Slice::ClientAins : public ydk::Entity
{
    public:
        ClientAins();
        ~ClientAins();
...
}; // HardwareModule::Node::Slice::ClientAins
