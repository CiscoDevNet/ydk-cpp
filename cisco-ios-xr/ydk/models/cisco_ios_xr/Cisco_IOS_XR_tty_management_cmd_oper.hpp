...
class ShowUsers : public ydk::Entity
{
    public:
        ShowUsers();
        ~ShowUsers();
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_tty_management_cmd_oper::ShowUsers::Sessions> sessions;
        
}; // ShowUsers


class ShowUsers::Sessions : public ydk::Entity
{
    public:
        Sessions();
        ~Sessions();
...
class ShowUsers::Sessions::Session : public ydk::Entity
{
    public:
        Session();
        ~Session();
        ...
        ydk::YLeaf conns; //type: string
        ydk::YLeaf idle_string; //type: string
