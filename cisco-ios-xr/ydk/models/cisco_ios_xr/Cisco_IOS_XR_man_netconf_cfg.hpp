...
class NetconfYang::Agent : public ydk::Entity
{
    public:
        ...
        class Models; //type: NetconfYang::Agent::Models
        class Ssh; //type: NetconfYang::Agent::Ssh
        class Session; //type: NetconfYang::Agent::Session

        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_man_netconf_cfg::NetconfYang::Agent::Models> models;
...
class NetconfYang::Agent::Models : public ydk::Entity
{
    public:
        Models();
        ~Models();
        ...
        class Openconfig; //type: NetconfYang::Agent::Models::Openconfig

        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_man_netconf_cfg::NetconfYang::Agent::Models::Openconfig> openconfig;
        
}; // NetconfYang::Agent::Models


class NetconfYang::Agent::Models::Openconfig : public ydk::Entity
{
    public:
        Openconfig();
        ~Openconfig();
