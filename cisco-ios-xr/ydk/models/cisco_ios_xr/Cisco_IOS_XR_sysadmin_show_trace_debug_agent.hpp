#ifndef _CISCO_IOS_XR_SYSADMIN_SHOW_TRACE_DEBUG_AGENT_
#define _CISCO_IOS_XR_SYSADMIN_SHOW_TRACE_DEBUG_AGENT_
...
class DebugAgent : public ydk::Entity
{
    public:
        DebugAgent();
        ~DebugAgent();
...
class DebugAgent::Trace : public ydk::Entity
{
    public:
        Trace();
        ~Trace();
...
class DebugAgent::Trace::Location : public ydk::Entity
{
    public:
        Location();
        ~Location();
...
class DebugAgent::Trace::Location::AllOptions : public ydk::Entity
{
    public:
        AllOptions();
        ~AllOptions();
...
class DebugAgent::Trace::Location::AllOptions::TraceBlocks : public ydk::Entity
{
    public:
        TraceBlocks();
        ~TraceBlocks();
...
#endif /* _CISCO_IOS_XR_SYSADMIN_SHOW_TRACE_DEBUG_AGENT_ */
