...
class HardwareModule : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<Cisco_IOS_XR_ncs1001_ots_cfg::HardwareModule::Node> > node;
...
class HardwareModule::Node : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<Cisco_IOS_XR_ncs1001_ots_cfg::HardwareModule::Node::Slot> > slot;
...
class HardwareModule::Node::Slot : public ydk::Entity
{
    public:
        ...
        ydk::YLeaf slot_id; //type: string
        class Amplifier; //type: HardwareModule::Node::Slot::Amplifier
        class Psm; //type: HardwareModule::Node::Slot::Psm

        std::shared_ptr<Cisco_IOS_XR_ncs1001_ots_cfg::HardwareModule::Node::Slot::Amplifier> amplifier;
        std::shared_ptr<Cisco_IOS_XR_ncs1001_ots_cfg::HardwareModule::Node::Slot::Psm> psm;
