...
class Exception : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_spirit_corehelper_cfg::Exception::File> file;
        
}; // Exception


class Exception::File : public ydk::Entity
{
    public:
        File();
        ~File();
        ...
        ydk::YLeaf choice2; //type: string
        ydk::YLeaf choice1; //type: string
        ydk::YLeaf choice3; //type: string
