...
class Dpa::Stats::Nodes::Node : public Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XR_fretta_bcm_dpa_npu_stats_oper::Dpa::Stats::Nodes::Node::ClearVoqDataForNpuNumbers> clear_voq_data_for_npu_numbers;
        std::shared_ptr<Cisco_IOS_XR_fretta_bcm_dpa_npu_stats_oper::Dpa::Stats::Nodes::Node::NpuNumberForTrapDataClears> npu_number_for_trap_data_clears;
        std::shared_ptr<Cisco_IOS_XR_fretta_bcm_dpa_npu_stats_oper::Dpa::Stats::Nodes::Node::NpuNumberForTrapDatas> npu_number_for_trap_datas;
