...
std::map<std::string, std::shared_ptr<Entity>> & Clock::get_children()
{
...
std::map<std::string, std::shared_ptr<Entity>> & Clock::SummerTime::get_children()
{
    return children;
}
...
std::map<std::string, std::shared_ptr<Entity>> & Clock::TimeZone::get_children()
{
    return children;
}
