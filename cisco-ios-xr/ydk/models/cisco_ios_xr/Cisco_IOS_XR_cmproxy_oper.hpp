...
class SdrInventoryVm : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_cmproxy_oper::SdrInventoryVm::Nodes> nodes;
...
class SdrInventoryVm::Nodes::Node : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_cmproxy_oper::SdrInventoryVm::Nodes::Node::NodeEntries> node_entries;
