...
class Dhcpv4AuthUsername : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            if (name == "auth-username-mac") return 1;
            if (name == "auth-username-giaddr") return 2;
            return -1;
        }
};
...
class Policy : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            ...
            if (name == "unicastalways") return 2;
            return -1;
        }
};
...
class Matchoption : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            if (name == "circuitid") return 1;
            if (name == "remoteid") return 2;
            if (name == "60") return 60;
            if (name == "77") return 77;
            if (name == "124") return 124;
            if (name == "125") return 125;
            return -1;
        }
};
...
class Dhcpv4LimitLease1 : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            ...
            if (name == "circuit-id-remote-id") return 4;
            return -1;
        }
};
...
class Ipv4dhcpdLayer : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            if (name == "layer2") return 2;
            if (name == "layer3") return 3;
            return -1;
        }
};
...
class Ipv4dhcpdGiaddrPolicy : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            if (name == "giaddr-policy-keep") return 0;
            return -1;
        }
};
...
class Ipv4dhcpdMode : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            ...
            if (name == "relay") return 1;
            if (name == "snoop") return 2;
            if (name == "server") return 3;
            if (name == "proxy") return 4;
            if (name == "base2") return 5;
            return -1;
        }
};
...
class Ipv4dhcpdFmtSpecifier : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            if (name == "physical-chassis") return 1;
            if (name == "physical-slot") return 2;
            if (name == "physical-sub-slot") return 3;
            if (name == "physical-port") return 4;
            if (name == "physical-sub-port") return 5;
            if (name == "inner-vlan-id") return 6;
            if (name == "outer-vlan-id") return 7;
            if (name == "l2-interface") return 8;
            if (name == "l3-interface") return 9;
            if (name == "host-name") return 10;
            return -1;
        }
};
...
class Ipv4dhcpdFmt : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            if (name == "no-format") return 0;
            if (name == "hex") return 1;
            if (name == "ascii") return 2;
            if (name == "extended") return 3;
            return -1;
        }
};
...
class LeaseLimitValue : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            if (name == "per-interface") return 1;
            if (name == "per-circuit-id") return 2;
            if (name == "per-remote-id") return 3;
            return -1;
        }
};
...
class Dhcpv4MatchOption : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            if (name == "60/60") return 60;
            if (name == "77/77") return 77;
            if (name == "124/124") return 124;
            if (name == "125/125") return 125;
            return -1;
        }
};
