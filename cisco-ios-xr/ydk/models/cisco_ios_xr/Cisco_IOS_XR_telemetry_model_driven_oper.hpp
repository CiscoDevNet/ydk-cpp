...
class TelemetryModelDriven::Subscriptions::Subscription::Subscription_ : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XR_telemetry_model_driven_oper::TelemetryModelDriven::Subscriptions::Subscription::Subscription_::SourceInterface> source_interface;
