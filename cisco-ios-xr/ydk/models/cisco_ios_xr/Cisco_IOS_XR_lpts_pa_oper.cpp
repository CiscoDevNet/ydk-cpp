...
bool LptsPa::has_data() const
{
	...
	|| (entry_xr !=  nullptr && entry_xr->has_data());
}
...
{
    if(name == "entry" || name == "client-id" || name == "flags" || name == "location" || name == "open-flags" || name == "times")
        return true;
    return false;
}
...
{
    if(name == "ctime" || name == "utime" || name == "entry" || name == "client-flags" || name == "client-id" || name == "cookie" || name == "ifs" || name == "l3protocol" || name == "l4protocol" || name == "lazy-bindq-delay" || name == "local-ip" || name == "local-len" || name == "local-port" || name == "location" || name == "min-ttl" || name == "packet-misc" || name == "ptq-delay" || name == "ptype" || name == "remote-ip" || name == "remote-len" || name == "remote-port" || name == "scope" || name == "smask" || name == "vid")
        return true;
    return false;
}
