...
{
    if(name == "berts" || name == "interfaces" || name == "statistics")
        return true;
    return false;
}
...
{
    if(name == "interface-name" || name == "aborted-packet-drops" || name == "buffer-underrun-packet-drops" || name == "dropped-ether-stats-fragments" || name == "dropped-ether-stats-undersize-pkts" || name == "dropped-giant-packets-greaterthan-mru" || name == "dropped-jabbers-packets-greaterthan-mru" || name == "dropped-miscellaneous-error-packets" || name == "dropped-packets-with-crc-align-errors" || name == "ether-stats-collisions" || name == "invalid-dest-mac-drop-packets" || name == "invalid-encap-drop-packets" || name == "miscellaneous-output-errors" || name == "number-of-aborted-packets-dropped" || name == "number-of-buffer-overrun-packets-dropped" || name == "number-of-miscellaneous-packets-dropped" || name == "numberof-invalid-vlan-id-packets-dropped" || name == "received8021q-frames" || name == "received-broadcast-frames" || name == "received-good-bytes" || name == "received-good-frames" || name == "received-multicast-frames" || name == "received-pause-frames" || name == "received-total64-octet-frames" || name == "received-total-bytes" || name == "received-total-frames" || name == "received-total-octet-frames-from1024-to1518" || name == "received-total-octet-frames-from128-to255" || name == "received-total-octet-frames-from1519-to-max" || name == "received-total-octet-frames-from256-to511" || name == "received-total-octet-frames-from512-to1023" || name == "received-total-octet-frames-from65-to127" || name == "received-unicast-frames" || name == "received-unknown-opcodes" || name == "rfc2819-ether-stats-crc-align-errors" || name == "rfc2819-ether-stats-jabbers" || name == "rfc2819-ether-stats-oversized-pkts" || name == "rfc3635dot3-stats-alignment-errors" || name == "symbol-errors" || name == "total-bytes-transmitted" || name == "total-frames-transmitted" || name == "total-good-bytes-transmitted" || name == "transmitted8021q-frames" || name == "transmitted-broadcast-frames" || name == "transmitted-good-frames" || name == "transmitted-multicast-frames" || name == "transmitted-total64-octet-frames" || name == "transmitted-total-octet-frames-from1024-to1518" || name == "transmitted-total-octet-frames-from128-to255" || name == "transmitted-total-octet-frames-from1518-to-max" || name == "transmitted-total-octet-frames-from256-to511" || name == "transmitted-total-octet-frames-from512-to1023" || name == "transmitted-total-octet-frames-from65-to127" || name == "transmitted-total-pause-frames" || name == "transmitted-unicast-frames" || name == "uncounted-dropped-frames")
        return true;
    return false;
}
