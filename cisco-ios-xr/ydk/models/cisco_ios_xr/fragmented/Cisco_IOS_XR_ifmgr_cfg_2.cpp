...
InterfaceConfigurations::InterfaceConfiguration::TunnelTeAttributes::PathOptionProtects::PathOptionProtect::PathOptions::PathOption::PathOption()
    ...
    sticky{YType::enumeration, "sticky"}
{
...
{
    if(name == "preference-level" || name == "path-type" || name == "path-id" || name == "path-name" || name == "path-property" || name == "interface" || name == "output-label" || name == "destination" || name == "lockdown" || name == "verbatim" || name == "pce" || name == "pce-address" || name == "igp-type" || name == "igp-instance" || name == "igp-area" || name == "igp-area-ip-address-id" || name == "path-option-attribute-set-name" || name == "protected-by-preference-level" || name == "segment-routing" || name == "sticky")
        return true;
    return false;
}
...
InterfaceConfigurations::InterfaceConfiguration::Pbr::Pbr()
    ...
    service_policy_in{YType::str, "service-policy-in"}
        ,
    service_policies(std::make_shared<InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies>())
{
...
InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::ServicePolicies()
    :
...
bool InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::has_data() const
{
    if (is_presence_container) return true;
...
bool InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::has_operation() const
{
    for (std::size_t index=0; index<service_policy.len(); index++)
    {
...
std::string InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "service-policy")
    {
        auto ent_ = std::make_shared<InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::ServicePolicy>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::has_leaf_or_child_of_name(const std::string & name) const
{
...
InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::ServicePolicy::ServicePolicy()
    :
...
bool InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::ServicePolicy::has_data() const
{
    if (is_presence_container) return true;
    return service_policy.is_set;
}

bool InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::ServicePolicy::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(service_policy.yfilter);
}

std::string InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::ServicePolicy::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::ServicePolicy::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::ServicePolicy::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::ServicePolicy::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::ServicePolicy::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::ServicePolicy::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "service-policy")
    {
...
bool InterfaceConfigurations::InterfaceConfiguration::Pbr::ServicePolicies::ServicePolicy::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "service-policy")
        return true;
    return false;
