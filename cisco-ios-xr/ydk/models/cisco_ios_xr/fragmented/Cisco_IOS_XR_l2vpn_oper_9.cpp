...
L2Vpnv2::Active::Pwr::Summary::RdAuto::RdAuto()
    ...
    rd{YType::enumeration, "rd"}
    	,
    auto_(std::make_shared<L2Vpnv2::Active::Pwr::Summary::RdAuto::Auto_>())
...
L2Vpnv2::Active::Pwr::Summary::RdAuto::Auto_::Auto_()
    :
...
bool L2Vpnv2::Active::Pwr::Summary::RdAuto::Auto_::has_data() const
{
    return auto_index.is_set
	|| router_id.is_set;
}

bool L2Vpnv2::Active::Pwr::Summary::RdAuto::Auto_::has_operation() const
{
    return is_set(yfilter)
...
std::string L2Vpnv2::Active::Pwr::Summary::RdAuto::Auto_::get_absolute_path() const
{
    std::ostringstream path_buffer;
...
std::string L2Vpnv2::Active::Pwr::Summary::RdAuto::Auto_::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "auto";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > L2Vpnv2::Active::Pwr::Summary::RdAuto::Auto_::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> L2Vpnv2::Active::Pwr::Summary::RdAuto::Auto_::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> L2Vpnv2::Active::Pwr::Summary::RdAuto::Auto_::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void L2Vpnv2::Active::Pwr::Summary::RdAuto::Auto_::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void L2Vpnv2::Active::Pwr::Summary::RdAuto::Auto_::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "auto-index")
    {
...
bool L2Vpnv2::Active::Pwr::Summary::RdAuto::Auto_::has_leaf_or_child_of_name(const std::string & name) const
{
...
std::shared_ptr<Entity> L2Vpnv2::Active::XconnectBrief::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "encapsulation-report-matrix")
    {
        ...
        auto c = std::make_shared<L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix>();
        c->parent = this;
    ...
    if(child_yang_name == "encapsulation-total")
    {
        ...
        auto c = std::make_shared<L2Vpnv2::Active::XconnectBrief::EncapsulationTotal>();
        c->parent = this;
...
std::map<std::string, std::shared_ptr<Entity>> L2Vpnv2::Active::XconnectBrief::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    for (auto const & c : encapsulation_report_matrix)
    {
...
std::shared_ptr<Entity> L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "ac1")
    {
        ...
        auto c = std::make_shared<L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::Ac1>();
        c->parent = this;
        ac1.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    for (auto const & c : ac1)
    {
...
std::shared_ptr<Entity> L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::Ac1::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "ac2")
    {
        ...
        auto c = std::make_shared<L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::Ac1::Ac2>();
        c->parent = this;
        ac2.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::Ac1::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    for (auto const & c : ac2)
    {
...
std::shared_ptr<Entity> L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::Ac1::Ac2::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "down-count")
    {
        ...
        auto c = std::make_shared<L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::Ac1::Ac2::DownCount>();
        c->parent = this;
    ...
    if(child_yang_name == "unresolved-count")
    {
        ...
        auto c = std::make_shared<L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::Ac1::Ac2::UnresolvedCount>();
        c->parent = this;
    ...
    if(child_yang_name == "up-count")
    {
        ...
        auto c = std::make_shared<L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::Ac1::Ac2::UpCount>();
        c->parent = this;
...
std::map<std::string, std::shared_ptr<Entity>> L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::Ac1::Ac2::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    for (auto const & c : down_count)
    {
...
std::shared_ptr<Entity> L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::Ac1::Ac2::DownCount::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::Ac1::Ac2::DownCount::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}
...
std::shared_ptr<Entity> L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::Ac1::Ac2::UnresolvedCount::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::Ac1::Ac2::UnresolvedCount::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}
...
std::shared_ptr<Entity> L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::Ac1::Ac2::UpCount::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> L2Vpnv2::Active::XconnectBrief::EncapsulationReportMatrix::Ac1::Ac2::UpCount::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}
