	...
	,rewrite_tes(std::make_shared<MplsLsd::Rewrite::RewriteTes>())
{
    ...
    yang_name = "rewrite"; yang_parent_name = "mpls-lsd";
}
...
EntityPath MplsLsd::Rewrite::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "rewrite-ipv4s")
    {
        ...
        return children.at("rewrite-ipv4s");
    }
    ...
    if(child_yang_name == "rewrite-labels")
    {
        ...
        return children.at("rewrite-labels");
    }
    ...
    if(child_yang_name == "rewrite-pws")
    {
        ...
        return children.at("rewrite-pws");
    }
    ...
    if(child_yang_name == "rewrite-tes")
    {
        ...
        return children.at("rewrite-tes");
    }

    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::get_children()
{
    if(children.find("rewrite-ipv4s") == children.end())
    {
        if(rewrite_ipv4s != nullptr)
        {
            children["rewrite-ipv4s"] = rewrite_ipv4s;
    ...
    if(children.find("rewrite-labels") == children.end())
    {
        if(rewrite_labels != nullptr)
        {
            children["rewrite-labels"] = rewrite_labels;
    ...
    if(children.find("rewrite-pws") == children.end())
    {
        if(rewrite_pws != nullptr)
        {
            children["rewrite-pws"] = rewrite_pws;
    ...
    if(children.find("rewrite-tes") == children.end())
    {
        if(rewrite_tes != nullptr)
        {
            children["rewrite-tes"] = rewrite_tes;
...
void MplsLsd::Rewrite::set_value(const std::string & value_path, std::string value)
{
}

MplsLsd::Rewrite::RewritePws::RewritePws()
{
...
bool MplsLsd::Rewrite::RewritePws::has_data() const
{
...
bool MplsLsd::Rewrite::RewritePws::has_operation() const
{
    for (std::size_t index=0; index<rewrite_pw.size(); index++)
    {
...
std::string MplsLsd::Rewrite::RewritePws::get_segment_path() const
{
    std::ostringstream path_buffer;
...
EntityPath MplsLsd::Rewrite::RewritePws::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "rewrite-pw")
    {
        ...
        auto c = std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw>();
        c->parent = this;
        rewrite_pw.push_back(std::move(c));
        children[segment_path] = rewrite_pw.back();
        return children.at(segment_path);
    }
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::get_children()
{
    for (auto const & c : rewrite_pw)
    {
...
void MplsLsd::Rewrite::RewritePws::set_value(const std::string & value_path, std::string value)
{
}

MplsLsd::Rewrite::RewritePws::RewritePw::RewritePw()
    :
    ...
    rw_updated{YType::int32, "rw-updated"}
    	,
    fpi_key(std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey>())
	,rewrite_id(std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId>())
{
    fpi_key->parent = this;
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::has_data() const
{
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::has_operation() const
{
    for (std::size_t index=0; index<associated_fpi.size(); index++)
    {
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        path_buffer << "Cisco-IOS-XR-mpls-lsd-oper:mpls-lsd/rewrite/rewrite-pws/" << get_segment_path();
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "associated-fpi")
    {
        ...
        auto c = std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi>();
        c->parent = this;
        associated_fpi.push_back(std::move(c));
        children[segment_path] = associated_fpi.back();
        return children.at(segment_path);
    }
    ...
    if(child_yang_name == "mois")
    {
        ...
        auto c = std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::Mois>();
        c->parent = this;
        mois.push_back(std::move(c));
        children[segment_path] = mois.back();
        return children.at(segment_path);
    }
    ...
    if(child_yang_name == "v4-rpf")
    {
        ...
        auto c = std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::V4Rpf>();
        c->parent = this;
        v4_rpf.push_back(std::move(c));
        children[segment_path] = v4_rpf.back();
        return children.at(segment_path);
    }
    ...
    if(child_yang_name == "v6-rpf")
    {
        ...
        auto c = std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::V6Rpf>();
        c->parent = this;
        v6_rpf.push_back(std::move(c));
        children[segment_path] = v6_rpf.back();
        return children.at(segment_path);
    }
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::get_children()
{
    for (auto const & c : associated_fpi)
    {
        if(children.find(c->get_segment_path()) == children.end())
    ...
    if(children.find("fpi-key") == children.end())
    {
        if(fpi_key != nullptr)
        {
            children["fpi-key"] = fpi_key;
...
void MplsLsd::Rewrite::RewritePws::RewritePw::set_value(const std::string & value_path, std::string value)
{
...
MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::FpiKey()
    :
    fpi(std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi>())
{
    fpi->parent = this;
    children["fpi"] = fpi;
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::has_data() const
{
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::has_operation() const
{
    for (std::size_t index=0; index<application_owner.size(); index++)
    {
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "application-owner")
    {
        ...
        auto c = std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::ApplicationOwner>();
        c->parent = this;
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::get_children()
{
    for (auto const & c : application_owner)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
void MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::set_value(const std::string & value_path, std::string value)
{
}

MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Fpi()
    :
    fpi_type{YType::enumeration, "fpi-type"}
    	,
    dmtc_ext_intf_data(std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::DmtcExtIntfData>())
	,ipv4_data(std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv4Data>())
	,ipv6_data(std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv6Data>())
	,label_data(std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::LabelData>())
	,pw_list_data(std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::PwListData>())
	,te_data(std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::TeData>())
{
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::has_data() const
{
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::has_operation() const
{
    return is_set(operation)
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::get_children()
{
...
void MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::set_value(const std::string & value_path, std::string value)
{
...
MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::LabelData::LabelData()
    :
    elc{YType::int32, "elc"},
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::LabelData::has_data() const
{
    return elc.is_set
	|| label.is_set
	|| security_id.is_set;
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::LabelData::has_operation() const
{
    return is_set(operation)
...
std::string MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::LabelData::get_segment_path() const
{
    std::ostringstream path_buffer;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::LabelData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::LabelData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::LabelData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::LabelData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "elc")
    {
        elc = value;
...
MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::TeData::TeData()
    :
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::TeData::has_data() const
{
    return local_label.is_set
	|| tunnel_interface.is_set;
}

bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::TeData::has_operation() const
{
    return is_set(operation)
...
std::string MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::TeData::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "te-data";
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::TeData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::TeData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::TeData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::TeData::set_value(const std::string & value_path, std::string value)
{
...
MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv4Data::Ipv4Data()
    :
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv4Data::has_data() const
{
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv4Data::has_operation() const
{
    return is_set(operation)
...
std::string MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv4Data::get_segment_path() const
{
    std::ostringstream path_buffer;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv4Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv4Data::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv4Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv4Data::set_value(const std::string & value_path, std::string value)
{
...
MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv6Data::Ipv6Data()
    :
    prefix{YType::str, "prefix"},
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv6Data::has_data() const
{
    return prefix.is_set
	|| prefix_len.is_set
	|| router_flags.is_set
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv6Data::has_operation() const
{
    return is_set(operation)
	|| is_set(prefix.operation)
...
std::string MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv6Data::get_segment_path() const
{
    std::ostringstream path_buffer;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv6Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv6Data::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv6Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::Ipv6Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::PwListData::PwListData()
    :
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::PwListData::has_data() const
{
    return pwhe_list_id.is_set;
}

bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::PwListData::has_operation() const
{
    return is_set(operation)
	|| is_set(pwhe_list_id.operation);
}

std::string MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::PwListData::get_segment_path() const
{
    std::ostringstream path_buffer;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::PwListData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::PwListData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::PwListData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::PwListData::set_value(const std::string & value_path, std::string value)
{
...
MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::DmtcExtIntfData::DmtcExtIntfData()
    :
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::DmtcExtIntfData::has_data() const
{
    return dmtc_ext_ifh.is_set;
}

bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::DmtcExtIntfData::has_operation() const
{
    return is_set(operation)
	|| is_set(dmtc_ext_ifh.operation);
}

std::string MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::DmtcExtIntfData::get_segment_path() const
{
    std::ostringstream path_buffer;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::DmtcExtIntfData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::DmtcExtIntfData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::DmtcExtIntfData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::Fpi::DmtcExtIntfData::set_value(const std::string & value_path, std::string value)
{
...
MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::ApplicationOwner::ApplicationOwner()
    :
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::ApplicationOwner::has_data() const
{
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::ApplicationOwner::has_operation() const
{
    return is_set(operation)
...
std::string MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::ApplicationOwner::get_segment_path() const
{
    std::ostringstream path_buffer;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::ApplicationOwner::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::ApplicationOwner::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::ApplicationOwner::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::FpiKey::ApplicationOwner::set_value(const std::string & value_path, std::string value)
{
...
MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId()
    :
    rewrite_id(std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_>())
{
    rewrite_id->parent = this;
    children["rewrite-id"] = rewrite_id;
...
bool MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::has_data() const
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::get_children()
{
    if(children.find("rewrite-id") == children.end())
    {
        if(rewrite_id != nullptr)
...
void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::get_children()
{
...
void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::get_children()
{
...
void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv4Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv4Data::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv4Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv4Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv6Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv6Data::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv6Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv6Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Tev4Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Tev4Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Tev4Data::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv4L3VpnData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv4L3VpnData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv4L3VpnData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv4L3VpnData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv6L3VpnData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv6L3VpnData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv6L3VpnData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv6L3VpnData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::VrfL3VpnData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::VrfL3VpnData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::VrfL3VpnData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "security-id")
    {
        security_id = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Cev4L3VpnData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Cev4L3VpnData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Cev4L3VpnData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Cev4L3VpnData::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Cev6L3VpnData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Cev6L3VpnData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Cev6L3VpnData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Cev6L3VpnData::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::PseudowireData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::PseudowireData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::PseudowireData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::PseudowireData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::LabelBlockData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::LabelBlockData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::LabelBlockData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::LabelBlockData::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::IpSubData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::IpSubData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::IpSubData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::IpSubData::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Tev4P2MpData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Tev4P2MpData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Tev4P2MpData::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::MldPv4Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::MldPv4Data::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::MldPv4Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::MldPv4Data::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::PseudowireHeadEndData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::PseudowireHeadEndData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::PseudowireHeadEndData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::PseudowireHeadEndData::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::TpData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::TpData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::TpData::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::GenericRoutingEncapsulation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::GenericRoutingEncapsulation::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::GenericRoutingEncapsulation::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::GenericRoutingEncapsulation::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv6GenericRoutingEncapsulation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv6GenericRoutingEncapsulation::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv6GenericRoutingEncapsulation::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv6GenericRoutingEncapsulation::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::EvpnData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::EvpnData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::EvpnData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::EvpnData::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv4BlbData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv4BlbData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv4BlbData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv4BlbData::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv6BlbData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv6BlbData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv6BlbData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::Ipv6BlbData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "blb-intf")
    {
        blb_intf = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::PiMiPmsiData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::PiMiPmsiData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::PiMiPmsiData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::PiMiPmsiData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "head")
    {
        head = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::PiMsPmsiData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::PiMsPmsiData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::PiMsPmsiData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::PiMsPmsiData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "head")
    {
        head = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::NextHopSetL3Vpn::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::NextHopSetL3Vpn::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::NextHopSetL3Vpn::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::NextHopSetL3Vpn::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::SrPrefixSegment::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::SrPrefixSegment::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::SrPrefixSegment::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::SrAdjSegmentIpv4::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::SrAdjSegmentIpv4::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::SrAdjSegmentIpv4::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::SrAdjSegmentIpv4::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "addr")
    {
        addr = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::SrAdjSegmentIpv6::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::SrAdjSegmentIpv6::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::SrAdjSegmentIpv6::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::SrAdjSegmentIpv6::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "addr")
    {
        addr = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::LabelBlockSrgbData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::LabelBlockSrgbData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::LabelBlockSrgbData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::LabelBlockSrgbData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "offset")
    {
        offset = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::TeBinding::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::TeBinding::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LabelContext::TeBinding::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LocalLabelRewrite::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LocalLabelRewrite::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::RewriteId::RewriteId_::LocalLabelRewrite::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "application-owner")
    {
        ...
        auto c = std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::ApplicationOwner>();
        c->parent = this;
        application_owner.push_back(std::move(c));
        children[segment_path] = application_owner.back();
        return children.at(segment_path);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::get_children()
{
    for (auto const & c : application_owner)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
void MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::get_children()
{
    if(children.find("dmtc-ext-intf-data") == children.end())
    {
        if(dmtc_ext_intf_data != nullptr)
...
void MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "fpi-type")
    {
        fpi_type = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::LabelData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::LabelData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::LabelData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::LabelData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "elc")
    {
        elc = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::TeData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::TeData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::TeData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::TeData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "local-label")
    {
        local_label = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::Ipv4Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::Ipv4Data::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::Ipv4Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::Ipv4Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::Ipv6Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::Ipv6Data::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::Ipv6Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::Ipv6Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::PwListData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::PwListData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::PwListData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::PwListData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "pwhe-list-id")
    {
        pwhe_list_id = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::DmtcExtIntfData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::DmtcExtIntfData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::DmtcExtIntfData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::Fpi::DmtcExtIntfData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "dmtc-ext-ifh")
    {
        dmtc_ext_ifh = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::ApplicationOwner::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::ApplicationOwner::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::ApplicationOwner::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::AssociatedFpi::ApplicationOwner::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "application-instance")
    {
        application_instance = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::V4Rpf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::V4Rpf::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::V4Rpf::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "table-id")
    {
        table_id = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::V6Rpf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::V6Rpf::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::V6Rpf::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "table-id")
    {
        table_id = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "moi-array")
    {
        ...
        auto c = std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray>();
        c->parent = this;
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::get_children()
{
...
void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::ApplicationResource::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::ApplicationResource::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::ApplicationResource::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::ApplicationResource::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "application-instance")
    {
        application_instance = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::get_children()
{
...
void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::get_children()
{
...
void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PopAndLookupIpv4::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PopAndLookupIpv4::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PopAndLookupIpv4::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PopAndLookupIpv4::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PopAndLookupTp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PopAndLookupTp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PopAndLookupTp::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PopAndLookupTp::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PopAndLookupIpv6::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PopAndLookupIpv6::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PopAndLookupIpv6::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PopAndLookupIpv6::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "path-flags-decode")
    {
        path_flags_decode = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Ipv4Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Ipv4Data::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Ipv4Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Ipv4Data::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Ipv6Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Ipv6Data::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Ipv6Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Ipv6Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "backup-path-id")
    {
        backup_path_id = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Tev4Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Tev4Data::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Tev4Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Tev4Data::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PseudowireData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PseudowireData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PseudowireData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PseudowireData::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::IpSubData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::IpSubData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::IpSubData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::IpSubData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "out-interface")
    {
        out_interface = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PseudowireHeadEndData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PseudowireHeadEndData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PseudowireHeadEndData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PseudowireHeadEndData::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PwListData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PwListData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PwListData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::PwListData::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::get_children()
{
...
void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::Nexthop::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::Nexthop::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::Nexthop::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::Nexthop::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "backup-path-id")
    {
        backup_path_id = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::InnerStack::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::InnerStack::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "label")
    {
        ...
        auto c = std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::InnerStack::Label>();
        c->parent = this;
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::InnerStack::get_children()
{
    for (auto const & c : label)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::InnerStack::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::InnerStack::Label::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::InnerStack::Label::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::InnerStack::Label::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv4Data::InnerStack::Label::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::get_children()
{
    if(children.find("inner-stack") == children.end())
    {
        if(inner_stack != nullptr)
...
void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::Nexthop::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::Nexthop::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::Nexthop::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::Nexthop::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "backup-path-id")
    {
        backup_path_id = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::InnerStack::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::InnerStack::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "label")
    {
        ...
        auto c = std::make_shared<MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::InnerStack::Label>();
        c->parent = this;
        label.push_back(std::move(c));
        children[segment_path] = label.back();
        return children.at(segment_path);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::InnerStack::get_children()
{
    for (auto const & c : label)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::InnerStack::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "nexthop")
    {
        nexthop.append(value);
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::InnerStack::Label::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::InnerStack::Label::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::InnerStack::Label::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::Stackv6Data::InnerStack::Label::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "outgoing-label")
    {
        outgoing_label = value;
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::TeHeadData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::TeHeadData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::TeHeadData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::TeHeadData::set_value(const std::string & value_path, std::string value)
{
...
EntityPath MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::DmtcData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::DmtcData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::DmtcData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewritePws::RewritePw::Mois::MoiArray::Moi::DmtcData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "dmtc-ext-ifh")
    {
        dmtc_ext_ifh = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewriteIpv4S::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "rewrite-ipv4")
    {
        ...
        c->parent = this;
        rewrite_ipv4.push_back(std::move(c));
        children[segment_path] = rewrite_ipv4.back();
        return children.at(segment_path);
    }
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::get_children()
{
    for (auto const & c : rewrite_ipv4)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
void MplsLsd::Rewrite::RewriteIpv4S::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::get_children()
{
    for (auto const & c : associated_fpi)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "bcdl-priority")
    {
        bcdl_priority = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::get_children()
{
    for (auto const & c : application_owner)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::get_children()
{
    if(children.find("dmtc-ext-intf-data") == children.end())
    {
        if(dmtc_ext_intf_data != nullptr)
...
void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "fpi-type")
    {
        fpi_type = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::LabelData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::LabelData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::LabelData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "elc")
    {
        elc = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::TeData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::TeData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::TeData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "local-label")
    {
        local_label = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::Ipv4Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::Ipv4Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::Ipv4Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::Ipv6Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::Ipv6Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::Ipv6Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::PwListData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::PwListData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::PwListData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "pwhe-list-id")
    {
        pwhe_list_id = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::DmtcExtIntfData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::DmtcExtIntfData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::Fpi::DmtcExtIntfData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "dmtc-ext-ifh")
    {
        dmtc_ext_ifh = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::ApplicationOwner::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::ApplicationOwner::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::FpiKey::ApplicationOwner::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "application-instance")
    {
        application_instance = value;
    ...
    rewrite_id(std::make_shared<MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_>())
{
    ...
    yang_name = "rewrite-id"; yang_parent_name = "rewrite-ipv4";
}
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::get_children()
{
    if(children.find("rewrite-id") == children.end())
    {
        if(rewrite_id != nullptr)
...
void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::get_children()
{
    if(children.find("label-context") == children.end())
    {
        if(label_context != nullptr)
...
void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "rewrite-id-type")
    {
        rewrite_id_type = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::get_children()
{
    if(children.find("cev4l3vpn-data") == children.end())
    {
        if(cev4l3vpn_data != nullptr)
...
void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "label-context-type")
    {
        label_context_type = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv4Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv4Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv4Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv6Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv6Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv6Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Tev4Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Tev4Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Tev4Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "is-srte")
    {
        is_srte = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv4L3VpnData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv4L3VpnData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv4L3VpnData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv6L3VpnData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv6L3VpnData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv6L3VpnData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::VrfL3VpnData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::VrfL3VpnData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::VrfL3VpnData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "security-id")
    {
        security_id = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Cev4L3VpnData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Cev4L3VpnData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Cev4L3VpnData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "ipv4-next-hop")
    {
        ipv4_next_hop = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Cev6L3VpnData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Cev6L3VpnData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Cev6L3VpnData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "ipv6-next-hop")
    {
        ipv6_next_hop = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::PseudowireData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::PseudowireData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::PseudowireData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::LabelBlockData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::LabelBlockData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::LabelBlockData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "edge-id")
    {
        edge_id = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::IpSubData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::IpSubData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::IpSubData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "parent-interface")
    {
        parent_interface = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Tev4P2MpData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Tev4P2MpData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Tev4P2MpData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "p2mp-id")
    {
        p2mp_id = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::MldPv4Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::MldPv4Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::MldPv4Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "lsm-id")
    {
        lsm_id = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::PseudowireHeadEndData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::PseudowireHeadEndData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::PseudowireHeadEndData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "pwhe-intf")
    {
        pwhe_intf = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::TpData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::TpData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::TpData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "dest-global-id")
    {
        dest_global_id = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::GenericRoutingEncapsulation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::GenericRoutingEncapsulation::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::GenericRoutingEncapsulation::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "gre-interface")
    {
        gre_interface = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv6GenericRoutingEncapsulation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv6GenericRoutingEncapsulation::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv6GenericRoutingEncapsulation::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "greipv6-interface")
    {
        greipv6_interface = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::EvpnData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::EvpnData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::EvpnData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "ethernet-segment")
    {
        ethernet_segment = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv4BlbData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv4BlbData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv4BlbData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "blb-intf")
    {
        blb_intf = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv6BlbData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv6BlbData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::Ipv6BlbData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "blb-intf")
    {
        blb_intf = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::PiMiPmsiData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::PiMiPmsiData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::PiMiPmsiData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "head")
    {
        head = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::PiMsPmsiData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::PiMsPmsiData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::PiMsPmsiData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "head")
    {
        head = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::NextHopSetL3Vpn::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::NextHopSetL3Vpn::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::NextHopSetL3Vpn::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "next-hop-set-id")
    {
        next_hop_set_id = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::SrPrefixSegment::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::SrPrefixSegment::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::SrPrefixSegment::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "segment-id")
    {
        segment_id = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::SrAdjSegmentIpv4::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::SrAdjSegmentIpv4::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::SrAdjSegmentIpv4::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "addr")
    {
        addr = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::SrAdjSegmentIpv6::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::SrAdjSegmentIpv6::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::SrAdjSegmentIpv6::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "addr")
    {
        addr = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::LabelBlockSrgbData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::LabelBlockSrgbData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::LabelBlockSrgbData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "offset")
    {
        offset = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::TeBinding::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::TeBinding::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LabelContext::TeBinding::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "te-identifier")
    {
        te_identifier = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LocalLabelRewrite::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LocalLabelRewrite::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::RewriteId::RewriteId_::LocalLabelRewrite::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "label-data")
    {
        label_data.append(value);
    ...
    fpi(std::make_shared<MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi>())
{
    ...
    yang_name = "associated-fpi"; yang_parent_name = "rewrite-ipv4";
}
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::get_children()
{
    for (auto const & c : application_owner)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::get_children()
{
    if(children.find("dmtc-ext-intf-data") == children.end())
    {
        if(dmtc_ext_intf_data != nullptr)
...
void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "fpi-type")
    {
        fpi_type = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::LabelData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::LabelData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::LabelData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "elc")
    {
        elc = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::TeData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::TeData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::TeData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "local-label")
    {
        local_label = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::Ipv4Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::Ipv4Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::Ipv4Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::Ipv6Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::Ipv6Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::Ipv6Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "prefix")
    {
        prefix = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::PwListData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::PwListData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::PwListData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "pwhe-list-id")
    {
        pwhe_list_id = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::DmtcExtIntfData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::DmtcExtIntfData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::Fpi::DmtcExtIntfData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "dmtc-ext-ifh")
    {
        dmtc_ext_ifh = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::ApplicationOwner::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::ApplicationOwner::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::AssociatedFpi::ApplicationOwner::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "application-instance")
    {
        application_instance = value;
...
MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::V4Rpf::V4Rpf()
    ...
    v4_rpf_neighbor{YType::str, "v4-rpf-neighbor"}
{
    yang_name = "v4-rpf"; yang_parent_name = "rewrite-ipv4";
}
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::V4Rpf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::V4Rpf::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::V4Rpf::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "table-id")
    {
        table_id = value;
...
MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::V6Rpf::V6Rpf()
    ...
    v6_rpf_neighbor{YType::str, "v6-rpf-neighbor"}
{
    yang_name = "v6-rpf"; yang_parent_name = "rewrite-ipv4";
}
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::V6Rpf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::V6Rpf::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::V6Rpf::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::V6Rpf::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "table-id")
    {
        table_id = value;
    ...
    application_resource(std::make_shared<MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::ApplicationResource>())
{
    ...
    yang_name = "mois"; yang_parent_name = "rewrite-ipv4";
}
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::get_children()
{
    if(children.find("application-resource") == children.end())
    {
        if(application_resource != nullptr)
...
void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::ApplicationResource::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::ApplicationResource::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::ApplicationResource::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "application-instance")
    {
        application_instance = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::get_children()
{
    if(children.find("moi") == children.end())
    {
        if(moi != nullptr)
...
void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::get_children()
{
    if(children.find("dmtc-data") == children.end())
    {
        if(dmtc_data != nullptr)
...
void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "moi-type")
    {
        moi_type = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PopAndLookupIpv4::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PopAndLookupIpv4::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PopAndLookupIpv4::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "path-flags-decode")
    {
        path_flags_decode = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PopAndLookupTp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PopAndLookupTp::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PopAndLookupTp::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "out-label")
    {
        out_label = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PopAndLookupIpv6::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PopAndLookupIpv6::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PopAndLookupIpv6::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "path-flags-decode")
    {
        path_flags_decode = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Ipv4Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Ipv4Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Ipv4Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "backup-path-id")
    {
        backup_path_id = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Ipv6Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Ipv6Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Ipv6Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "backup-path-id")
    {
        backup_path_id = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Tev4Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Tev4Data::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Tev4Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "backup-interface")
    {
        backup_interface = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PseudowireData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PseudowireData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PseudowireData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "bridge-id")
    {
        bridge_id = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::IpSubData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::IpSubData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::IpSubData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "out-interface")
    {
        out_interface = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PseudowireHeadEndData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PseudowireHeadEndData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PseudowireHeadEndData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "control-word")
    {
        control_word = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PwListData::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PwListData::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::PwListData::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "l2-interface")
    {
        l2_interface = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Stackv4Data::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Stackv4Data::get_children()
{
    if(children.find("inner-stack") == children.end())
    {
        if(inner_stack != nullptr)
...
void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Stackv4Data::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "owner-application-type")
    {
        owner_application_type = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Stackv4Data::Nexthop::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Stackv4Data::Nexthop::get_children()
{
    return children;
}

void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Stackv4Data::Nexthop::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "backup-path-id")
    {
        backup_path_id = value;
...
EntityPath MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Stackv4Data::InnerStack::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Stackv4Data::InnerStack::get_children()
{
    for (auto const & c : label)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
void MplsLsd::Rewrite::RewriteIpv4S::RewriteIpv4::Mois::MoiArray::Moi::Stackv4Data::InnerStack::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "nexthop")
    {
        nexthop.append(value);
