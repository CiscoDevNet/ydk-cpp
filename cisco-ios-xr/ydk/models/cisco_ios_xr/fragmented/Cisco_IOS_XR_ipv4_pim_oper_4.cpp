...
EntityPath Pim::Active::Vrfs::Vrf::IfrsInterfaces::IfrsInterface::InterfaceAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::IfrsInterfaces::IfrsInterface::InterfaceAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Safs::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Safs::get_children()
{
    for (auto const & c : saf)
    {
...
EntityPath Pim::Active::Vrfs::Vrf::Safs::Saf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Safs::Saf::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::Safs::Saf::RpfHashSourceGroups::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Safs::Saf::RpfHashSourceGroups::get_children()
{
    for (auto const & c : rpf_hash_source_group)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::Safs::Saf::RpfHashSourceGroups::RpfHashSourceGroup::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Safs::Saf::RpfHashSourceGroups::RpfHashSourceGroup::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::Safs::Saf::RpfHashSourceGroups::RpfHashSourceGroup::NextHopAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Safs::Saf::RpfHashSourceGroups::RpfHashSourceGroup::NextHopAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Safs::Saf::RpfHashSourceGroups::RpfHashSourceGroup::SecondaryNextHopAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Safs::Saf::RpfHashSourceGroups::RpfHashSourceGroup::SecondaryNextHopAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Safs::Saf::RpfHashSources::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Safs::Saf::RpfHashSources::get_children()
{
    for (auto const & c : rpf_hash_source)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::Safs::Saf::RpfHashSources::RpfHashSource::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Safs::Saf::RpfHashSources::RpfHashSource::get_children()
{
    if(children.find("next-hop-address") == children.end())
    {
        if(next_hop_address != nullptr)
...
EntityPath Pim::Active::Vrfs::Vrf::Safs::Saf::RpfHashSources::RpfHashSource::NextHopAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Safs::Saf::RpfHashSources::RpfHashSource::NextHopAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Safs::Saf::RpfHashSources::RpfHashSource::SecondaryNextHopAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Safs::Saf::RpfHashSources::RpfHashSource::SecondaryNextHopAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Safs::Saf::Rpfs::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Safs::Saf::Rpfs::get_children()
{
    for (auto const & c : rpf)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::RegisteredAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::RegisteredAddressXr::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::RpfPath::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::RpfPath::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::RpfPath::RpfNeighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::RpfPath::RpfNeighbor::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::RpfPath::RpfNexthop::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::RpfPath::RpfNexthop::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::InterfaceStatistics::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::InterfaceStatistics::get_children()
{
    for (auto const & c : interface_statistic)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::InterfaceStatistics::InterfaceStatistic::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::InterfaceStatistics::InterfaceStatistic::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::TopologyRouteCount::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::TopologyRouteCount::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::TopologyRouteCount::GroupAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::TopologyRouteCount::GroupAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::JpStatistics::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::JpStatistics::get_children()
{
    for (auto const & c : jp_statistic)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::JpStatistics::JpStatistic::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::JpStatistics::JpStatistic::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::MibDatabases::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::MibDatabases::get_children()
{
    for (auto const & c : mib_database)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::MibDatabases::MibDatabase::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::MibDatabases::MibDatabase::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::MibDatabases::MibDatabase::SourceAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::MibDatabases::MibDatabase::SourceAddressXr::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::MibDatabases::MibDatabase::GroupAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::MibDatabases::MibDatabase::GroupAddressXr::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::MibDatabases::MibDatabase::RpfNeighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::MibDatabases::MibDatabase::RpfNeighbor::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::MibDatabases::MibDatabase::RpfRoot::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::MibDatabases::MibDatabase::RpfRoot::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapMatchRpfs::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapMatchRpfs::get_children()
{
    for (auto const & c : group_map_match_rpf)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::RpfNeighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::RpfNeighbor::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::Prefix::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::Prefix::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::RpAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::RpAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::NeighborOldFormats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::NeighborOldFormats::get_children()
{
    for (auto const & c : neighbor_old_format)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::NeighborOldFormats::NeighborOldFormat::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::NeighborOldFormats::NeighborOldFormat::get_children()
{
    for (auto const & c : neighbor_address_xr)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::NeighborOldFormats::NeighborOldFormat::NeighborAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::NeighborOldFormats::NeighborOldFormat::NeighborAddressXr::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::IfrsSummary::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::IfrsSummary::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Ranges::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Ranges::get_children()
{
    for (auto const & c : range)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::Ranges::Range::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Ranges::Range::get_children()
{
    for (auto const & c : group_range)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::Ranges::Range::RpAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Ranges::Range::RpAddressXr::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Ranges::Range::SourceOfInformation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Ranges::Range::SourceOfInformation::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Ranges::Range::GroupRange::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Ranges::Range::GroupRange::get_children()
{
    if(children.find("prefix") == children.end())
    {
        if(prefix != nullptr)
...
EntityPath Pim::Active::Vrfs::Vrf::Ranges::Range::GroupRange::Prefix::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Ranges::Range::GroupRange::Prefix::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Ranges::Range::GroupRange::SourceOfInformation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Ranges::Range::GroupRange::SourceOfInformation::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::InterfaceOldFormats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::InterfaceOldFormats::get_children()
{
    for (auto const & c : interface_old_format)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::InterfaceOldFormats::InterfaceOldFormat::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::InterfaceOldFormats::InterfaceOldFormat::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::InterfaceOldFormats::InterfaceOldFormat::DrAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::InterfaceOldFormats::InterfaceOldFormat::DrAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::InterfaceOldFormats::InterfaceOldFormat::InterfaceAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::InterfaceOldFormats::InterfaceOldFormat::InterfaceAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Bsr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Bsr::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::Bsr::RpCaches::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Bsr::RpCaches::get_children()
{
    for (auto const & c : rp_cache)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::Bsr::RpCaches::RpCache::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Bsr::RpCaches::RpCache::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::Bsr::RpCaches::RpCache::GroupPrefixXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Bsr::RpCaches::RpCache::GroupPrefixXr::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Bsr::RpCaches::RpCache::CandidateRpList::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Bsr::RpCaches::RpCache::CandidateRpList::get_children()
{
    for (auto const & c : pim_bsr_crp_bag)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::Bsr::RpCaches::RpCache::CandidateRpList::PimBsrCrpBag::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Bsr::RpCaches::RpCache::CandidateRpList::PimBsrCrpBag::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::Bsr::RpCaches::RpCache::CandidateRpList::PimBsrCrpBag::CandidateRpAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Bsr::RpCaches::RpCache::CandidateRpList::PimBsrCrpBag::CandidateRpAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Bsr::CandidateRps::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Bsr::CandidateRps::get_children()
{
    for (auto const & c : candidate_rp)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::Bsr::CandidateRps::CandidateRp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Bsr::CandidateRps::CandidateRp::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::Bsr::CandidateRps::CandidateRp::CandidateRp_::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Bsr::CandidateRps::CandidateRp::CandidateRp_::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Bsr::CandidateRps::CandidateRp::CrpAccess::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Bsr::CandidateRps::CandidateRp::CrpAccess::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Bsr::BsrElections::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Bsr::BsrElections::get_children()
{
    for (auto const & c : bsr_election)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::Bsr::BsrElections::BsrElection::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Bsr::BsrElections::BsrElection::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::Bsr::BsrElections::BsrElection::BsrAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Bsr::BsrElections::BsrElection::BsrAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Bsr::BsrElections::BsrElection::CandidateBsrAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Bsr::BsrElections::BsrElection::CandidateBsrAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::RoutePolicy::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::RoutePolicy::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::RoutePolicy::RoutePolicyStatistics::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::RoutePolicy::RoutePolicyStatistics::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::RoutePolicy::RoutePolicyTests::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::RoutePolicy::RoutePolicyTests::get_children()
{
    for (auto const & c : route_policy_test)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::RoutePolicy::RoutePolicyTests::RoutePolicyTest::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::RoutePolicy::RoutePolicyTests::RoutePolicyTest::get_children()
{
    if(children.find("group-address-xr") == children.end())
    {
        if(group_address_xr != nullptr)
...
EntityPath Pim::Active::Vrfs::Vrf::RoutePolicy::RoutePolicyTests::RoutePolicyTest::SourceAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::RoutePolicy::RoutePolicyTests::RoutePolicyTest::SourceAddressXr::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::RoutePolicy::RoutePolicyTests::RoutePolicyTest::GroupAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::RoutePolicy::RoutePolicyTests::RoutePolicyTest::GroupAddressXr::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::RpfSummary::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::RpfSummary::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Interfaces::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Interfaces::get_children()
{
    for (auto const & c : interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::Interfaces::Interface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Interfaces::Interface::get_children()
{
    if(children.find("dr-address") == children.end())
    {
        if(dr_address != nullptr)
...
EntityPath Pim::Active::Vrfs::Vrf::Interfaces::Interface::DrAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Interfaces::Interface::DrAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Interfaces::Interface::InterfaceAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Interfaces::Interface::InterfaceAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::NetIoTunnels::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::NetIoTunnels::get_children()
{
    for (auto const & c : net_io_tunnel)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::SourceAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::SourceAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::RpAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::RpAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::SourceAddressNetio::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::SourceAddressNetio::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::GroupAddressNetio::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::GroupAddressNetio::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::BidirDfStates::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::BidirDfStates::get_children()
{
    for (auto const & c : bidir_df_state)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::BidirDfStates::BidirDfState::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::BidirDfStates::BidirDfState::get_children()
{
    if(children.find("rp-address-xr") == children.end())
    {
        if(rp_address_xr != nullptr)
...
EntityPath Pim::Active::Vrfs::Vrf::BidirDfStates::BidirDfState::RpAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::BidirDfStates::BidirDfState::RpAddressXr::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Topologies::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Topologies::get_children()
{
    for (auto const & c : topology)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::Topologies::Topology::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Topologies::Topology::get_children()
{
    if(children.find("group-address-xr") == children.end())
    {
        if(group_address_xr != nullptr)
...
EntityPath Pim::Active::Vrfs::Vrf::Topologies::Topology::GroupAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Topologies::Topology::GroupAddressXr::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Topologies::Topology::SourceAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Topologies::Topology::SourceAddressXr::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Topologies::Topology::RpAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Topologies::Topology::RpAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Topologies::Topology::RpfNeighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Topologies::Topology::RpfNeighbor::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Topologies::Topology::SecondaryRpfNeighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Topologies::Topology::SecondaryRpfNeighbor::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Topologies::Topology::RpfRoot::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Topologies::Topology::RpfRoot::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Topologies::Topology::ProxyAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Topologies::Topology::ProxyAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Topologies::Topology::OrigSrcAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Topologies::Topology::OrigSrcAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Topologies::Topology::OutgoingInterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Topologies::Topology::OutgoingInterface::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::Topologies::Topology::OutgoingInterface::AssertWinner::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Topologies::Topology::OutgoingInterface::AssertWinner::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::BgpAfs::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::BgpAfs::get_children()
{
    for (auto const & c : bgp_af)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::BgpAfs::BgpAf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::BgpAfs::BgpAf::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::BgpAfs::BgpAf::Source::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::BgpAfs::BgpAf::Source::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::BgpAfs::BgpAf::Group::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::BgpAfs::BgpAf::Group::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::BgpAfs::BgpAf::NextHop::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::BgpAfs::BgpAf::NextHop::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::AutoRp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::AutoRp::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::TopologyInterfaceFlagRouteCounts::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::TopologyInterfaceFlagRouteCounts::get_children()
{
    for (auto const & c : topology_interface_flag_route_count)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::TopologyInterfaceFlagRouteCounts::TopologyInterfaceFlagRouteCount::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::TopologyInterfaceFlagRouteCounts::TopologyInterfaceFlagRouteCount::get_children()
{
    if(children.find("group-address") == children.end())
    {
        if(group_address != nullptr)
...
EntityPath Pim::Active::Vrfs::Vrf::TopologyInterfaceFlagRouteCounts::TopologyInterfaceFlagRouteCount::GroupAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::TopologyInterfaceFlagRouteCounts::TopologyInterfaceFlagRouteCount::GroupAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapSources::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapSources::get_children()
{
    for (auto const & c : group_map_source)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapSources::GroupMapSource::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapSources::GroupMapSource::get_children()
{
    if(children.find("group-map-information") == children.end())
    {
        if(group_map_information != nullptr)
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapSources::GroupMapSource::SourceOfInformation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapSources::GroupMapSource::SourceOfInformation::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapSources::GroupMapSource::GroupMapInformation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapSources::GroupMapSource::GroupMapInformation::get_children()
{
    if(children.find("prefix") == children.end())
    {
        if(prefix != nullptr)
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapSources::GroupMapSource::GroupMapInformation::Prefix::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapSources::GroupMapSource::GroupMapInformation::Prefix::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapSources::GroupMapSource::GroupMapInformation::RpAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapSources::GroupMapSource::GroupMapInformation::RpAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::TrafficCounters::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::TrafficCounters::get_children()
{
    for (auto const & c : packet_queue)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::TrafficCounters::PacketQueue::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::TrafficCounters::PacketQueue::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::TrafficCounters::PacketQueue::PacketQueueState::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::TrafficCounters::PacketQueue::PacketQueueState::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::TrafficCounters::PacketQueue::PacketQueueStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::TrafficCounters::PacketQueue::PacketQueueStats::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapRpfs::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapRpfs::get_children()
{
    for (auto const & c : group_map_rpf)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapRpfs::GroupMapRpf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapRpfs::GroupMapRpf::get_children()
{
    if(children.find("group-map-information") == children.end())
    {
        if(group_map_information != nullptr)
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapRpfs::GroupMapRpf::RpfNeighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapRpfs::GroupMapRpf::RpfNeighbor::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapRpfs::GroupMapRpf::GroupMapInformation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapRpfs::GroupMapRpf::GroupMapInformation::get_children()
{
    if(children.find("prefix") == children.end())
    {
        if(prefix != nullptr)
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapRpfs::GroupMapRpf::GroupMapInformation::Prefix::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapRpfs::GroupMapRpf::GroupMapInformation::Prefix::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::GroupMapRpfs::GroupMapRpf::GroupMapInformation::RpAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::GroupMapRpfs::GroupMapRpf::GroupMapInformation::RpAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Summary::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Summary::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Gre::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Gre::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::Gre::GreHashes::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Gre::GreHashes::get_children()
{
    for (auto const & c : gre_hash)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::Gre::GreHashes::GreHash::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Gre::GreHashes::GreHash::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Gre::GreNextHops::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Gre::GreNextHops::get_children()
{
    for (auto const & c : gre_next_hop)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::Gre::GreNextHops::GreNextHop::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Gre::GreNextHops::GreNextHop::get_children()
{
    for (auto const & c : gre_path)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::Gre::GreNextHops::GreNextHop::RegisteredAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Gre::GreNextHops::GreNextHop::RegisteredAddress::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Gre::GreNextHops::GreNextHop::GrePath::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Gre::GreNextHops::GreNextHop::GrePath::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::Gre::GreNextHops::GreNextHop::GrePath::GreNeighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Gre::GreNextHops::GreNextHop::GrePath::GreNeighbor::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Gre::GreNextHops::GreNextHop::GrePath::GreNextHop_::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Gre::GreNextHops::GreNextHop::GrePath::GreNextHop_::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::BidirDfWinners::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::BidirDfWinners::get_children()
{
    for (auto const & c : bidir_df_winner)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::BidirDfWinners::BidirDfWinner::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::BidirDfWinners::BidirDfWinner::get_children()
{
...
EntityPath Pim::Active::Vrfs::Vrf::BidirDfWinners::BidirDfWinner::RpAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::BidirDfWinners::BidirDfWinner::RpAddressXr::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::BidirDfWinners::BidirDfWinner::DfWinner::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::BidirDfWinners::BidirDfWinner::DfWinner::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::TableContexts::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::TableContexts::get_children()
{
    for (auto const & c : table_context)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::TableContexts::TableContext::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::TableContexts::TableContext::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::NeighborSummaries::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::NeighborSummaries::get_children()
{
    for (auto const & c : neighbor_summary)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::NeighborSummaries::NeighborSummary::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::NeighborSummaries::NeighborSummary::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Context::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Context::get_children()
{
    for (auto const & c : anycast_rp_range)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::Context::RemoteDefaultGroup::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Context::RemoteDefaultGroup::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Context::RpfDefaultTable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Context::RpfDefaultTable::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Context::ExportRouteTarget::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Context::ExportRouteTarget::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Context::ImportRouteTarget::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Context::ImportRouteTarget::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::Context::AnycastRpRange::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Context::AnycastRpRange::get_children()
{
    if(children.find("prefix") == children.end())
    {
        if(prefix != nullptr)
...
EntityPath Pim::Active::Vrfs::Vrf::Context::AnycastRpRange::Prefix::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::Context::AnycastRpRange::Prefix::get_children()
{
    return children;
}
...
EntityPath Pim::Active::Vrfs::Vrf::TopologyEntryFlagRouteCounts::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::TopologyEntryFlagRouteCounts::get_children()
{
    for (auto const & c : topology_entry_flag_route_count)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Pim::Active::Vrfs::Vrf::TopologyEntryFlagRouteCounts::TopologyEntryFlagRouteCount::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::TopologyEntryFlagRouteCounts::TopologyEntryFlagRouteCount::get_children()
{
    if(children.find("group-address") == children.end())
    {
        if(group_address != nullptr)
...
EntityPath Pim::Active::Vrfs::Vrf::TopologyEntryFlagRouteCounts::TopologyEntryFlagRouteCount::GroupAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Pim::Active::Vrfs::Vrf::TopologyEntryFlagRouteCounts::TopologyEntryFlagRouteCount::GroupAddress::get_children()
{
    return children;
}
