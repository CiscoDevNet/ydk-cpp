...
EntityPath Ipv6Pim::Standby::DefaultContext::TrafficCounters::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::TrafficCounters::get_children()
{
    for (auto const & c : packet_queue)
    {
...
EntityPath Ipv6Pim::Standby::DefaultContext::TrafficCounters::PacketQueue::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::TrafficCounters::PacketQueue::get_children()
{
...
EntityPath Ipv6Pim::Standby::DefaultContext::TrafficCounters::PacketQueue::PacketQueueState::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::TrafficCounters::PacketQueue::PacketQueueState::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::TrafficCounters::PacketQueue::PacketQueueStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::TrafficCounters::PacketQueue::PacketQueueStats::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::GroupMapRpfs::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::GroupMapRpfs::get_children()
{
    for (auto const & c : group_map_rpf)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::DefaultContext::GroupMapRpfs::GroupMapRpf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::GroupMapRpfs::GroupMapRpf::get_children()
{
...
EntityPath Ipv6Pim::Standby::DefaultContext::GroupMapRpfs::GroupMapRpf::RpfNeighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::GroupMapRpfs::GroupMapRpf::RpfNeighbor::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::GroupMapRpfs::GroupMapRpf::GroupMapInformation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::GroupMapRpfs::GroupMapRpf::GroupMapInformation::get_children()
{
...
EntityPath Ipv6Pim::Standby::DefaultContext::GroupMapRpfs::GroupMapRpf::GroupMapInformation::Prefix::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::GroupMapRpfs::GroupMapRpf::GroupMapInformation::Prefix::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::GroupMapRpfs::GroupMapRpf::GroupMapInformation::RpAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::GroupMapRpfs::GroupMapRpf::GroupMapInformation::RpAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::Summary::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Summary::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::Gre::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Gre::get_children()
{
...
EntityPath Ipv6Pim::Standby::DefaultContext::Gre::GreHashes::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Gre::GreHashes::get_children()
{
    for (auto const & c : gre_hash)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::DefaultContext::Gre::GreHashes::GreHash::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Gre::GreHashes::GreHash::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::Gre::GreNextHops::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Gre::GreNextHops::get_children()
{
    for (auto const & c : gre_next_hop)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::DefaultContext::Gre::GreNextHops::GreNextHop::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Gre::GreNextHops::GreNextHop::get_children()
{
    for (auto const & c : gre_path)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::DefaultContext::Gre::GreNextHops::GreNextHop::RegisteredAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Gre::GreNextHops::GreNextHop::RegisteredAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::Gre::GreNextHops::GreNextHop::GrePath::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Gre::GreNextHops::GreNextHop::GrePath::get_children()
{
...
EntityPath Ipv6Pim::Standby::DefaultContext::Gre::GreNextHops::GreNextHop::GrePath::GreNeighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Gre::GreNextHops::GreNextHop::GrePath::GreNeighbor::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::Gre::GreNextHops::GreNextHop::GrePath::GreNextHop_::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Gre::GreNextHops::GreNextHop::GrePath::GreNextHop_::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::BidirDfWinners::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::BidirDfWinners::get_children()
{
    for (auto const & c : bidir_df_winner)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::DefaultContext::BidirDfWinners::BidirDfWinner::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::BidirDfWinners::BidirDfWinner::get_children()
{
...
EntityPath Ipv6Pim::Standby::DefaultContext::BidirDfWinners::BidirDfWinner::RpAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::BidirDfWinners::BidirDfWinner::RpAddressXr::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::BidirDfWinners::BidirDfWinner::DfWinner::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::BidirDfWinners::BidirDfWinner::DfWinner::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::TableContexts::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::TableContexts::get_children()
{
    for (auto const & c : table_context)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::DefaultContext::TableContexts::TableContext::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::TableContexts::TableContext::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::NeighborSummaries::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::NeighborSummaries::get_children()
{
    for (auto const & c : neighbor_summary)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::DefaultContext::NeighborSummaries::NeighborSummary::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::NeighborSummaries::NeighborSummary::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::Context::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Context::get_children()
{
    for (auto const & c : anycast_rp_range)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::DefaultContext::Context::RemoteDefaultGroup::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Context::RemoteDefaultGroup::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::Context::RpfDefaultTable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Context::RpfDefaultTable::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::Context::ExportRouteTarget::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Context::ExportRouteTarget::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::Context::ImportRouteTarget::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Context::ImportRouteTarget::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::Context::AnycastRpRange::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Context::AnycastRpRange::get_children()
{
    if(children.find("prefix") == children.end())
    {
        if(prefix != nullptr)
...
EntityPath Ipv6Pim::Standby::DefaultContext::Context::AnycastRpRange::Prefix::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Context::AnycastRpRange::Prefix::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::TopologyEntryFlagRouteCounts::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::TopologyEntryFlagRouteCounts::get_children()
{
    for (auto const & c : topology_entry_flag_route_count)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::DefaultContext::TopologyEntryFlagRouteCounts::TopologyEntryFlagRouteCount::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::TopologyEntryFlagRouteCounts::TopologyEntryFlagRouteCount::get_children()
{
...
EntityPath Ipv6Pim::Standby::DefaultContext::TopologyEntryFlagRouteCounts::TopologyEntryFlagRouteCount::GroupAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::TopologyEntryFlagRouteCounts::TopologyEntryFlagRouteCount::GroupAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::RpfRedirect::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::RpfRedirect::get_children()
{
...
EntityPath Ipv6Pim::Standby::DefaultContext::RpfRedirect::RedirectRouteDatabases::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::RpfRedirect::RedirectRouteDatabases::get_children()
{
    for (auto const & c : redirect_route_database)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::DefaultContext::RpfRedirect::RedirectRouteDatabases::RedirectRouteDatabase::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::RpfRedirect::RedirectRouteDatabases::RedirectRouteDatabase::get_children()
{
...
EntityPath Ipv6Pim::Standby::DefaultContext::RpfRedirect::RedirectRouteDatabases::RedirectRouteDatabase::GroupAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::RpfRedirect::RedirectRouteDatabases::RedirectRouteDatabase::GroupAddressXr::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::RpfRedirect::RedirectRouteDatabases::RedirectRouteDatabase::SourceAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::RpfRedirect::RedirectRouteDatabases::RedirectRouteDatabase::SourceAddressXr::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::RpfRedirect::RedirectRouteDatabases::RedirectRouteDatabase::Interface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::RpfRedirect::RedirectRouteDatabases::RedirectRouteDatabase::Interface::get_children()
{
...
EntityPath Ipv6Pim::Standby::DefaultContext::RpfRedirect::RedirectRouteDatabases::RedirectRouteDatabase::Interface::RpfAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::RpfRedirect::RedirectRouteDatabases::RedirectRouteDatabase::Interface::RpfAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::RpfRedirect::BundleInterfaces::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::RpfRedirect::BundleInterfaces::get_children()
{
    for (auto const & c : bundle_interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::DefaultContext::RpfRedirect::BundleInterfaces::BundleInterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::RpfRedirect::BundleInterfaces::BundleInterface::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::Tunnels::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Tunnels::get_children()
{
    for (auto const & c : tunnel)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::DefaultContext::Tunnels::Tunnel::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Tunnels::Tunnel::get_children()
{
...
EntityPath Ipv6Pim::Standby::DefaultContext::Tunnels::Tunnel::SourceAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Tunnels::Tunnel::SourceAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::Tunnels::Tunnel::RpAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Tunnels::Tunnel::RpAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::Tunnels::Tunnel::SourceAddressNetio::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Tunnels::Tunnel::SourceAddressNetio::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::Tunnels::Tunnel::GroupAddressNetio::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Tunnels::Tunnel::GroupAddressNetio::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::MulticastStaticRoutes::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::MulticastStaticRoutes::get_children()
{
    for (auto const & c : multicast_static_route)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::DefaultContext::MulticastStaticRoutes::MulticastStaticRoute::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::MulticastStaticRoutes::MulticastStaticRoute::get_children()
{
...
EntityPath Ipv6Pim::Standby::DefaultContext::MulticastStaticRoutes::MulticastStaticRoute::Prefix::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::MulticastStaticRoutes::MulticastStaticRoute::Prefix::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::MulticastStaticRoutes::MulticastStaticRoute::Nexthop::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::MulticastStaticRoutes::MulticastStaticRoute::Nexthop::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::GroupMapMatchSources::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::GroupMapMatchSources::get_children()
{
    for (auto const & c : group_map_match_source)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::DefaultContext::GroupMapMatchSources::GroupMapMatchSource::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::GroupMapMatchSources::GroupMapMatchSource::get_children()
{
    if(children.find("group-map-information") == children.end())
    {
        if(group_map_information != nullptr)
...
EntityPath Ipv6Pim::Standby::DefaultContext::GroupMapMatchSources::GroupMapMatchSource::SourceOfInformation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::GroupMapMatchSources::GroupMapMatchSource::SourceOfInformation::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::GroupMapMatchSources::GroupMapMatchSource::GroupMapInformation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::GroupMapMatchSources::GroupMapMatchSource::GroupMapInformation::get_children()
{
    if(children.find("prefix") == children.end())
    {
        if(prefix != nullptr)
...
EntityPath Ipv6Pim::Standby::DefaultContext::GroupMapMatchSources::GroupMapMatchSource::GroupMapInformation::Prefix::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::GroupMapMatchSources::GroupMapMatchSource::GroupMapInformation::Prefix::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::GroupMapMatchSources::GroupMapMatchSource::GroupMapInformation::RpAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::GroupMapMatchSources::GroupMapMatchSource::GroupMapInformation::RpAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::DefaultContext::Neighbors::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Neighbors::get_children()
{
    for (auto const & c : neighbor)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::DefaultContext::Neighbors::Neighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Neighbors::Neighbor::get_children()
{
    for (auto const & c : neighbor_address_xr)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::DefaultContext::Neighbors::Neighbor::NeighborAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::DefaultContext::Neighbors::Neighbor::NeighborAddressXr::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Process::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Process::get_children()
{
...
EntityPath Ipv6Pim::Standby::Process::CheckpointStatistics::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Process::CheckpointStatistics::get_children()
{
    for (auto const & c : checkpoint_table)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Process::CheckpointStatistics::CheckpointTable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Process::CheckpointStatistics::CheckpointTable::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Process::Nsr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Process::Nsr::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Process::Summary::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Process::Summary::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Process::Nsf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Process::Nsf::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Process::Issu::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Process::Issu::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::get_children()
{
    for (auto const & c : vrf)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::get_children()
{
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::IfrsInterfaces::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::IfrsInterfaces::get_children()
{
    for (auto const & c : ifrs_interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::IfrsInterfaces::IfrsInterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::IfrsInterfaces::IfrsInterface::get_children()
{
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::IfrsInterfaces::IfrsInterface::DrAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::IfrsInterfaces::IfrsInterface::DrAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::IfrsInterfaces::IfrsInterface::InterfaceAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::IfrsInterfaces::IfrsInterface::InterfaceAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Safs::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Safs::get_children()
{
    for (auto const & c : saf)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::get_children()
{
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::RpfHashSourceGroups::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::RpfHashSourceGroups::get_children()
{
    for (auto const & c : rpf_hash_source_group)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::RpfHashSourceGroups::RpfHashSourceGroup::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::RpfHashSourceGroups::RpfHashSourceGroup::get_children()
{
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::RpfHashSourceGroups::RpfHashSourceGroup::NextHopAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::RpfHashSourceGroups::RpfHashSourceGroup::NextHopAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::RpfHashSourceGroups::RpfHashSourceGroup::SecondaryNextHopAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::RpfHashSourceGroups::RpfHashSourceGroup::SecondaryNextHopAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::RpfHashSources::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::RpfHashSources::get_children()
{
    for (auto const & c : rpf_hash_source)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::RpfHashSources::RpfHashSource::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::RpfHashSources::RpfHashSource::get_children()
{
    if(children.find("next-hop-address") == children.end())
    {
        if(next_hop_address != nullptr)
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::RpfHashSources::RpfHashSource::NextHopAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::RpfHashSources::RpfHashSource::NextHopAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::RpfHashSources::RpfHashSource::SecondaryNextHopAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::RpfHashSources::RpfHashSource::SecondaryNextHopAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::Rpfs::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::Rpfs::get_children()
{
    for (auto const & c : rpf)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::get_children()
{
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::RegisteredAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::RegisteredAddressXr::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::RpfPath::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::RpfPath::get_children()
{
    if(children.find("rpf-neighbor") == children.end())
    {
        if(rpf_neighbor != nullptr)
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::RpfPath::RpfNeighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::RpfPath::RpfNeighbor::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::RpfPath::RpfNexthop::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Safs::Saf::Rpfs::Rpf::RpfPath::RpfNexthop::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::InterfaceStatistics::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::InterfaceStatistics::get_children()
{
    for (auto const & c : interface_statistic)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::InterfaceStatistics::InterfaceStatistic::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::InterfaceStatistics::InterfaceStatistic::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::TopologyRouteCount::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::TopologyRouteCount::get_children()
{
    if(children.find("group-address") == children.end())
    {
        if(group_address != nullptr)
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::TopologyRouteCount::GroupAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::TopologyRouteCount::GroupAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::JpStatistics::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::JpStatistics::get_children()
{
    for (auto const & c : jp_statistic)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::JpStatistics::JpStatistic::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::JpStatistics::JpStatistic::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::MibDatabases::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::MibDatabases::get_children()
{
    for (auto const & c : mib_database)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::MibDatabases::MibDatabase::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::MibDatabases::MibDatabase::get_children()
{
    if(children.find("group-address-xr") == children.end())
    {
        if(group_address_xr != nullptr)
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::MibDatabases::MibDatabase::SourceAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::MibDatabases::MibDatabase::SourceAddressXr::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::MibDatabases::MibDatabase::GroupAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::MibDatabases::MibDatabase::GroupAddressXr::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::MibDatabases::MibDatabase::RpfNeighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::MibDatabases::MibDatabase::RpfNeighbor::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::MibDatabases::MibDatabase::RpfRoot::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::MibDatabases::MibDatabase::RpfRoot::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::GroupMapMatchRpfs::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::GroupMapMatchRpfs::get_children()
{
    for (auto const & c : group_map_match_rpf)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::get_children()
{
    if(children.find("group-map-information") == children.end())
    {
        if(group_map_information != nullptr)
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::RpfNeighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::RpfNeighbor::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::get_children()
{
    if(children.find("prefix") == children.end())
    {
        if(prefix != nullptr)
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::Prefix::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::Prefix::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::RpAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::RpAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::NeighborOldFormats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::NeighborOldFormats::get_children()
{
    for (auto const & c : neighbor_old_format)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::NeighborOldFormats::NeighborOldFormat::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::NeighborOldFormats::NeighborOldFormat::get_children()
{
    for (auto const & c : neighbor_address_xr)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::NeighborOldFormats::NeighborOldFormat::NeighborAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::NeighborOldFormats::NeighborOldFormat::NeighborAddressXr::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::IfrsSummary::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::IfrsSummary::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Ranges::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Ranges::get_children()
{
    for (auto const & c : range)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Ranges::Range::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Ranges::Range::get_children()
{
    for (auto const & c : group_range)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Ranges::Range::RpAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Ranges::Range::RpAddressXr::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Ranges::Range::SourceOfInformation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Ranges::Range::SourceOfInformation::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Ranges::Range::GroupRange::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Ranges::Range::GroupRange::get_children()
{
    if(children.find("prefix") == children.end())
    {
        if(prefix != nullptr)
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Ranges::Range::GroupRange::Prefix::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Ranges::Range::GroupRange::Prefix::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Ranges::Range::GroupRange::SourceOfInformation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Ranges::Range::GroupRange::SourceOfInformation::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::InterfaceOldFormats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::InterfaceOldFormats::get_children()
{
    for (auto const & c : interface_old_format)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::InterfaceOldFormats::InterfaceOldFormat::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::InterfaceOldFormats::InterfaceOldFormat::get_children()
{
    if(children.find("dr-address") == children.end())
    {
        if(dr_address != nullptr)
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::InterfaceOldFormats::InterfaceOldFormat::DrAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::InterfaceOldFormats::InterfaceOldFormat::DrAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::InterfaceOldFormats::InterfaceOldFormat::InterfaceAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::InterfaceOldFormats::InterfaceOldFormat::InterfaceAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Bsr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Bsr::get_children()
{
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Bsr::RpCaches::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Bsr::RpCaches::get_children()
{
    for (auto const & c : rp_cache)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Bsr::RpCaches::RpCache::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Bsr::RpCaches::RpCache::get_children()
{
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Bsr::RpCaches::RpCache::GroupPrefixXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Bsr::RpCaches::RpCache::GroupPrefixXr::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Bsr::RpCaches::RpCache::CandidateRpList::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Bsr::RpCaches::RpCache::CandidateRpList::get_children()
{
    for (auto const & c : pim_bsr_crp_bag)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Bsr::RpCaches::RpCache::CandidateRpList::PimBsrCrpBag::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Bsr::RpCaches::RpCache::CandidateRpList::PimBsrCrpBag::get_children()
{
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Bsr::RpCaches::RpCache::CandidateRpList::PimBsrCrpBag::CandidateRpAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Bsr::RpCaches::RpCache::CandidateRpList::PimBsrCrpBag::CandidateRpAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Bsr::CandidateRps::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Bsr::CandidateRps::get_children()
{
    for (auto const & c : candidate_rp)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Bsr::CandidateRps::CandidateRp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Bsr::CandidateRps::CandidateRp::get_children()
{
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Bsr::CandidateRps::CandidateRp::CandidateRp_::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Bsr::CandidateRps::CandidateRp::CandidateRp_::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Bsr::CandidateRps::CandidateRp::CrpAccess::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Bsr::CandidateRps::CandidateRp::CrpAccess::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Bsr::BsrElections::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Bsr::BsrElections::get_children()
{
    for (auto const & c : bsr_election)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Bsr::BsrElections::BsrElection::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Bsr::BsrElections::BsrElection::get_children()
{
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Bsr::BsrElections::BsrElection::BsrAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Bsr::BsrElections::BsrElection::BsrAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::Bsr::BsrElections::BsrElection::CandidateBsrAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::Bsr::BsrElections::BsrElection::CandidateBsrAddress::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::RoutePolicy::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::RoutePolicy::get_children()
{
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::RoutePolicy::RoutePolicyStatistics::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::RoutePolicy::RoutePolicyStatistics::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::RoutePolicy::RoutePolicyTests::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::RoutePolicy::RoutePolicyTests::get_children()
{
    for (auto const & c : route_policy_test)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::RoutePolicy::RoutePolicyTests::RoutePolicyTest::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::RoutePolicy::RoutePolicyTests::RoutePolicyTest::get_children()
{
    if(children.find("group-address-xr") == children.end())
    {
        if(group_address_xr != nullptr)
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::RoutePolicy::RoutePolicyTests::RoutePolicyTest::SourceAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::RoutePolicy::RoutePolicyTests::RoutePolicyTest::SourceAddressXr::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::RoutePolicy::RoutePolicyTests::RoutePolicyTest::GroupAddressXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::RoutePolicy::RoutePolicyTests::RoutePolicyTest::GroupAddressXr::get_children()
{
    return children;
}
...
EntityPath Ipv6Pim::Standby::Vrfs::Vrf::RpfSummary::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Ipv6Pim::Standby::Vrfs::Vrf::RpfSummary::get_children()
{
    return children;
}
