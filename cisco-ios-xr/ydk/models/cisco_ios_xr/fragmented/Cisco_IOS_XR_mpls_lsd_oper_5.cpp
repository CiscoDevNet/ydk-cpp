...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewriteTes::RewriteTe::Mois::MoiArray::Moi::NnhStackv4Data::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    {
        auto c = std::make_shared<MplsLsd::Rewrite::RewriteTes::RewriteTe::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop>();
        c->parent = this;
...
MplsLsd::Rewrite::RewriteTes::RewriteTe::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::NextNextHop()
    :
...
bool MplsLsd::Rewrite::RewriteTes::RewriteTe::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::has_data() const
{
    if (is_presence_container) return true;
...
bool MplsLsd::Rewrite::RewriteTes::RewriteTe::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::has_operation() const
{
    return is_set(yfilter)
...
std::string MplsLsd::Rewrite::RewriteTes::RewriteTe::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > MplsLsd::Rewrite::RewriteTes::RewriteTe::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewriteTes::RewriteTe::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> MplsLsd::Rewrite::RewriteTes::RewriteTe::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void MplsLsd::Rewrite::RewriteTes::RewriteTe::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void MplsLsd::Rewrite::RewriteTes::RewriteTe::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "nnh-type")
    {
...
bool MplsLsd::Rewrite::RewriteTes::RewriteTe::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::has_leaf_or_child_of_name(const std::string & name) const
{
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewriteLabels::RewriteLabel::Mois::MoiArray::Moi::NnhStackv4Data::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "next-next-hop")
    {
        auto c = std::make_shared<MplsLsd::Rewrite::RewriteLabels::RewriteLabel::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop>();
        c->parent = this;
        next_next_hop.append(c);
        return c;
    }
...
MplsLsd::Rewrite::RewriteLabels::RewriteLabel::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::NextNextHop()
    :
    nnh_type{YType::enumeration, "nnh-type"},
    address{YType::str, "address"},
    interface_name{YType::str, "interface-name"}
...
bool MplsLsd::Rewrite::RewriteLabels::RewriteLabel::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::has_data() const
{
    if (is_presence_container) return true;
    return nnh_type.is_set
	|| address.is_set
...
bool MplsLsd::Rewrite::RewriteLabels::RewriteLabel::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(nnh_type.yfilter)
	|| ydk::is_set(address.yfilter)
...
std::string MplsLsd::Rewrite::RewriteLabels::RewriteLabel::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "next-next-hop";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > MplsLsd::Rewrite::RewriteLabels::RewriteLabel::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsLsd::Rewrite::RewriteLabels::RewriteLabel::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> MplsLsd::Rewrite::RewriteLabels::RewriteLabel::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void MplsLsd::Rewrite::RewriteLabels::RewriteLabel::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "nnh-type")
    {
        nnh_type = value;
...
void MplsLsd::Rewrite::RewriteLabels::RewriteLabel::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "nnh-type")
    {
        nnh_type.yfilter = yfilter;
...
bool MplsLsd::Rewrite::RewriteLabels::RewriteLabel::Mois::MoiArray::Moi::NnhStackv4Data::NextNextHop::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "nnh-type" || name == "address" || name == "interface-name")
        return true;
    return false;
