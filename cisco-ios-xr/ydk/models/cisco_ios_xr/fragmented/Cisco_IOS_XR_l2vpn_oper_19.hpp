...
class L2Vpnv2::Active::BridgeDomains::BridgeDomain::BridgeDomainInfo::Rd : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_l2vpn_oper::L2Vpnv2::Active::BridgeDomains::BridgeDomain::BridgeDomainInfo::Rd::Auto_> auto_;
...
class L2Vpnv2::Active::BridgeDomains::BridgeDomain::BridgeDomainInfo::Rd::Auto_ : public ydk::Entity
{
    public:
        Auto_();
        ~Auto_();
