...
Aaa::Usernames::Username::Username()
    ...
    shell_type{YType::str, "shell-type"}
        ,
...
std::vector<std::pair<std::string, LeafData> > Aaa::Usernames::Username::get_name_leaf_data() const
{
    ...
    if (shell_type.is_set || is_set(shell_type.yfilter)) leaf_name_data.push_back(shell_type.get_name_leafdata());
...
void Aaa::Usernames::Username::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    ...
    if(value_path == "shell-type")
    {
        shell_type = value;
        shell_type.value_namespace = name_space;
        shell_type.value_namespace_prefix = name_space_prefix;
    }
}
...
void Aaa::Usernames::Username::set_filter(const std::string & value_path, YFilter yfilter)
{
    ...
    if(value_path == "shell-type")
    {
        shell_type.yfilter = yfilter;
    }
}

bool Aaa::Usernames::Username::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "password-policy" || name == "usergroup-under-usernames" || name == "ordering-index" || name == "name" || name == "secret" || name == "password" || name == "directory" || name == "shell-type")
        return true;
    return false;
}
...
Aaa::Diameter::Gy::Gy()
    ...
    service_context_id{YType::str, "service-context-id"}
{
...
bool Aaa::Diameter::Gy::has_operation() const
{
	...
	|| ydk::is_set(service_context_id.yfilter);
}
...
std::vector<std::pair<std::string, LeafData> > Aaa::Diameter::Gy::get_name_leaf_data() const
{
    ...
    if (service_context_id.is_set || is_set(service_context_id.yfilter)) leaf_name_data.push_back(service_context_id.get_name_leafdata());
...
void Aaa::Diameter::Gy::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    ...
    if(value_path == "service-context-id")
    {
        service_context_id = value;
        service_context_id.value_namespace = name_space;
        service_context_id.value_namespace_prefix = name_space_prefix;
    }
}
...
void Aaa::Diameter::Gy::set_filter(const std::string & value_path, YFilter yfilter)
{
    ...
    if(value_path == "service-context-id")
    {
        service_context_id.yfilter = yfilter;
    }
}

bool Aaa::Diameter::Gy::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "retransmit" || name == "enable" || name == "dest-host" || name == "tx-timer" || name == "service-context-id")
        return true;
    return false;
}
...
{
    if(name == "retransmit" || name == "enable" || name == "dest-host" || name == "tx-timer")
        return true;
    return false;
}
