...
InterfaceConfigurations::InterfaceConfiguration::InterfaceConfiguration()
    ...
    user_network_interface{YType::str, "Cisco-IOS-XR-l2-eth-infra-cfg:user-network-interface"},
    ...
    , ipv4_dhcp_client_config(nullptr) // presence node
    ...
    , flow_protocols(std::make_shared<InterfaceConfigurations::InterfaceConfiguration::FlowProtocols>())
...
bool InterfaceConfigurations::InterfaceConfiguration::has_data() const
{
	...
	|| (ipv4_dhcp_client_config !=  nullptr && ipv4_dhcp_client_config->has_data())
	...
	|| (flow_protocols !=  nullptr && flow_protocols->has_data())
...
bool InterfaceConfigurations::InterfaceConfiguration::has_operation() const
{
	...
	|| ydk::is_set(user_network_interface.yfilter)
	...
	|| (ipv4_dhcp_client_config !=  nullptr && ipv4_dhcp_client_config->has_operation())
	...
	|| (flow_protocols !=  nullptr && flow_protocols->has_operation())
...
std::vector<std::pair<std::string, LeafData> > InterfaceConfigurations::InterfaceConfiguration::get_name_leaf_data() const
{
    ...
    if (user_network_interface.is_set || is_set(user_network_interface.yfilter)) leaf_name_data.push_back(user_network_interface.get_name_leafdata());
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "Cisco-IOS-XR-ipv4-dc-cfg:ipv4-dhcp-client-config")
    {
        if(ipv4_dhcp_client_config == nullptr)
        {
            ipv4_dhcp_client_config = std::make_shared<InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig>();
        }
        return ipv4_dhcp_client_config;
    }
    ...
    if(child_yang_name == "Cisco-IOS-XR-traffmon-netflow-cfg:flow-protocols")
    {
        if(flow_protocols == nullptr)
        {
            flow_protocols = std::make_shared<InterfaceConfigurations::InterfaceConfiguration::FlowProtocols>();
        }
        return flow_protocols;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::get_children() const
{
    ...
    if(ethernet_control != nullptr)
    {
        _children["Cisco-IOS-XR-asr9k-lc-ethctrl-cfg:ethernet-control"] = ethernet_control;
    }
    ...
    if(atm != nullptr)
    {
        _children["Cisco-IOS-XR-atm-vcm-cfg:atm"] = atm;
    }
    ...
    if(ipv4_dhcp_client_config != nullptr)
    {
        _children["Cisco-IOS-XR-ipv4-dc-cfg:ipv4-dhcp-client-config"] = ipv4_dhcp_client_config;
    }
    ...
    if(cisco_ios_xr_ppp_ma_cfg_ppp != nullptr)
    {
        _children["Cisco-IOS-XR-ppp-ma-cfg:ppp"] = cisco_ios_xr_ppp_ma_cfg_ppp;
    }
    ...
    if(cisco_ios_xr_ppp_ma_ipcp_cfg_ppp != nullptr)
    {
        _children["Cisco-IOS-XR-ppp-ma-ipcp-cfg:ppp"] = cisco_ios_xr_ppp_ma_ipcp_cfg_ppp;
    }
    ...
    if(cisco_ios_xr_ppp_ma_lcp_cfg_ppp != nullptr)
    {
        _children["Cisco-IOS-XR-ppp-ma-lcp-cfg:ppp"] = cisco_ios_xr_ppp_ma_lcp_cfg_ppp;
    }
    ...
    if(flow_protocols != nullptr)
    {
        _children["Cisco-IOS-XR-traffmon-netflow-cfg:flow-protocols"] = flow_protocols;
    }
...
void InterfaceConfigurations::InterfaceConfiguration::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    ...
    if(value_path == "Cisco-IOS-XR-l2-eth-infra-cfg:user-network-interface")
    {
        user_network_interface = value;
        user_network_interface.value_namespace = name_space;
        user_network_interface.value_namespace_prefix = name_space_prefix;
    }
...
void InterfaceConfigurations::InterfaceConfiguration::set_filter(const std::string & value_path, YFilter yfilter)
{
    ...
    if(value_path == "user-network-interface")
    {
        user_network_interface.yfilter = yfilter;
    }
    if(value_path == "vrf")
    {
        vrf.yfilter = yfilter;
...
{
    if(name == "dampening" || name == "mtus" || name == "encapsulation" || name == "aaa-table" || name == "ethernet-control" || name == "ptp" || name == "pseudowire-ether" || name == "pseudowire-iw" || name == "bvi" || name == "l2-transport" || name == "atm" || name == "bfd" || name == "bundle" || name == "lacp" || name == "bundle-member" || name == "mlacp" || name == "cdp" || name == "optics" || name == "otu" || name == "macsec" || name == "dot1x-interface" || name == "loopbacks" || name == "ethernet" || name == "dwdm" || name == "vlan-sub-configuration" || name == "ethernet-service" || name == "ethernet-bng" || name == "mac-accounting" || name == "ethernet-features" || name == "carrier-delay" || name == "vlan-trunk-configuration" || name == "nv-satellite-access" || name == "nv-satellite-fabric-link" || name == "nv-satellite-fabric-network" || name == "lldp" || name == "span-monitor-sessions" || name == "ipv4-flow-spec" || name == "ipv6-flow-spec" || name == "frequency-synchronization" || name == "service-policies" || name == "afs" || name == "statistics" || name == "ipv6-packet-filter" || name == "es-packet-filter" || name == "ipv4-packet-filter" || name == "dagrs" || name == "ipv4arp" || name == "ipv4-dhcp-client-config" || name == "ipv4-network" || name == "ipv4-network-forwarding" || name == "ipv6-network" || name == "ipv6-neighbor" || name == "mpls" || name == "tunnel-te-attributes" || name == "transport-profile-tunnel" || name == "mte-tunnel-attributes" || name == "pbr" || name == "performance-management" || name == "ppp" || name == "ppp" || name == "ppp" || name == "ppp" || name == "ppp" || name == "ssrp-session" || name == "qos" || name == "subscriber" || name == "pppoe" || name == "flow-protocols" || name == "tunnel-ip" || name == "nve" || name == "wanphy" || name == "active" || name == "interface-name" || name == "shutdown" || name == "interface-virtual" || name == "secondary-admin-state" || name == "interface-mode-non-physical" || name == "bandwidth" || name == "link-status" || name == "description" || name == "laser-squelch" || name == "holdoff-time" || name == "perf-mon-disable" || name == "maintenance-embargo" || name == "user-network-interface" || name == "vrf" || name == "track-name" || name == "fast-shutdown" || name == "mac-addr")
        return true;
    return false;
}
...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::L2Transport::get_children() const
{
    ...
    if(atm_port_mode_parameters != nullptr)
    {
        _children["Cisco-IOS-XR-atm-vcm-cfg:atm-port-mode-parameters"] = atm_port_mode_parameters;
    }
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::L2Transport::AtmPortModeParameters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::L2Transport::AtmPortModeParameters::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(cell_packing != nullptr)
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::L2Transport::AtmPortModeParameters::CellPacking::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::L2Transport::AtmPortModeParameters::CellPacking::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
InterfaceConfigurations::InterfaceConfiguration::Optics::Optics()
    ...
    optics_ots_rx_enable{YType::boolean, "optics-ots-rx-enable"},
    ...
    optics_ots_rx_low_threshold_delta{YType::uint32, "optics-ots-rx-low-threshold-delta"},
    ...
    optics_ots_tx_enable{YType::boolean, "optics-ots-tx-enable"},
...
bool InterfaceConfigurations::InterfaceConfiguration::Optics::has_data() const
{
	...
	|| optics_ots_rx_low_threshold_delta.is_set
...
bool InterfaceConfigurations::InterfaceConfiguration::Optics::has_operation() const
{
	...
	|| ydk::is_set(optics_ots_rx_enable.yfilter)
	...
	|| ydk::is_set(optics_ots_rx_low_threshold_delta.yfilter)
	...
	|| ydk::is_set(optics_ots_tx_enable.yfilter)
...
std::vector<std::pair<std::string, LeafData> > InterfaceConfigurations::InterfaceConfiguration::Optics::get_name_leaf_data() const
{
    ...
    if (optics_ots_rx_enable.is_set || is_set(optics_ots_rx_enable.yfilter)) leaf_name_data.push_back(optics_ots_rx_enable.get_name_leafdata());
    ...
    if (optics_ots_rx_low_threshold_delta.is_set || is_set(optics_ots_rx_low_threshold_delta.yfilter)) leaf_name_data.push_back(optics_ots_rx_low_threshold_delta.get_name_leafdata());
    ...
    if (optics_ots_tx_enable.is_set || is_set(optics_ots_tx_enable.yfilter)) leaf_name_data.push_back(optics_ots_tx_enable.get_name_leafdata());
...
void InterfaceConfigurations::InterfaceConfiguration::Optics::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    ...
    if(value_path == "optics-ots-rx-enable")
    {
        optics_ots_rx_enable = value;
        optics_ots_rx_enable.value_namespace = name_space;
        optics_ots_rx_enable.value_namespace_prefix = name_space_prefix;
    }
    ...
    if(value_path == "optics-ots-rx-low-threshold-delta")
    {
        optics_ots_rx_low_threshold_delta = value;
        optics_ots_rx_low_threshold_delta.value_namespace = name_space;
        optics_ots_rx_low_threshold_delta.value_namespace_prefix = name_space_prefix;
    }
    ...
    if(value_path == "optics-ots-tx-enable")
    {
        optics_ots_tx_enable = value;
        optics_ots_tx_enable.value_namespace = name_space;
        optics_ots_tx_enable.value_namespace_prefix = name_space_prefix;
    }
...
void InterfaceConfigurations::InterfaceConfiguration::Optics::set_filter(const std::string & value_path, YFilter yfilter)
{
    ...
    if(value_path == "optics-ots-rx-enable")
    {
        optics_ots_rx_enable.yfilter = yfilter;
    }
    if(value_path == "optics-ots-channel-power-max-delta")
    {
    ...
    if(value_path == "optics-ots-rx-low-threshold-delta")
    {
        optics_ots_rx_low_threshold_delta.yfilter = yfilter;
    }
    if(value_path == "optics-ots-amplifier-gain")
    {
    ...
    if(value_path == "optics-ots-tx-enable")
    {
        optics_ots_tx_enable.yfilter = yfilter;
    }
    if(value_path == "optics-ots-amplifier-tilt")
    {
...
{
    if(name == "rx-thresholds" || name == "optics-network-srlgs" || name == "optics-dwdm-carrier" || name == "optics-lanes" || name == "tx-thresholds" || name == "optics-transmit-power" || name == "optics-ots-rx-enable" || name == "optics-ots-channel-power-max-delta" || name == "optics-loopback" || name == "optics-ots-osri" || name == "optics-ots-amplifier-gain-degrade-high-threshold" || name == "optics-ots-rx-voa-attenuation" || name == "optics-fec" || name == "optics-dgd-high-threshold" || name == "optics-ots-amplifier-channel-power" || name == "optics-ots-amplifier-control-mode" || name == "optics-ots-rx-low-threshold-delta" || name == "optics-ots-amplifier-gain" || name == "optics-ots-amplifier-gain-range" || name == "optics-ots-safety-control-mode" || name == "optics-cd-min" || name == "optics-ots-tx-voa-attenuation" || name == "optics-ots-tx-enable" || name == "optics-ots-amplifier-tilt" || name == "optics-transmit-shutdown" || name == "optics-baud-rate" || name == "optics-performance-monitoring" || name == "optics-cd-max" || name == "optics-bits-per-symbol" || name == "optics-lbc-high-threshold" || name == "optics-cd-high-threshold" || name == "optics-osnr-low-threshold" || name == "optics-ots-amplifier-gain-degrade-low-threshold" || name == "optics-cd-low-threshold" || name == "breakout")
        return true;
    return false;
}
...
InterfaceConfigurations::InterfaceConfiguration::Dot1xInterface::Dot1xInterface()
    :
    eapol_dest_addr{YType::str, "eapol-dest-addr"},
...
{
    return is_set(yfilter)
	|| ydk::is_set(eapol_dest_addr.yfilter)
...
std::vector<std::pair<std::string, LeafData> > InterfaceConfigurations::InterfaceConfiguration::Dot1xInterface::get_name_leaf_data() const
{
    ...
    if (eapol_dest_addr.is_set || is_set(eapol_dest_addr.yfilter)) leaf_name_data.push_back(eapol_dest_addr.get_name_leafdata());
...
{
    if(value_path == "eapol-dest-addr")
    {
        eapol_dest_addr = value;
        eapol_dest_addr.value_namespace = name_space;
        eapol_dest_addr.value_namespace_prefix = name_space_prefix;
    }
...
void InterfaceConfigurations::InterfaceConfiguration::Dot1xInterface::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "eapol-dest-addr")
    {
        eapol_dest_addr.yfilter = yfilter;
    }
    if(value_path == "dot1x-profile")
    {
...
{
    if(name == "eapol-dest-addr" || name == "dot1x-profile")
        return true;
    return false;
}
