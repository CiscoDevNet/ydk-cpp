...
{
    if(name == "span-monitor-sessions" || name == "l2-protocols" || name == "l2-ethernet-features" || name == "pac" || name == "cac" || name == "atm-port-mode-parameters" || name == "enabled" || name == "propagate-remote-status")
        return true;
    return false;
}
