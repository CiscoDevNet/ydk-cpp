...
void Pim::Standby::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Pim::Standby::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "tunnel-name")
    {
...
bool Pim::Standby::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::has_leaf_or_child_of_name(const std::string & name) const
{
...
void Pim::Standby::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::SourceAddress::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Pim::Standby::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::SourceAddress::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "af-name")
    {
...
bool Pim::Standby::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::SourceAddress::has_leaf_or_child_of_name(const std::string & name) const
{
...
void Pim::Standby::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::RpAddress::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "af-name")
    {
        af_name = value;
...
void Pim::Standby::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::RpAddress::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "af-name")
    {
        af_name.yfilter = yfilter;
...
bool Pim::Standby::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::RpAddress::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "af-name" || name == "ipv4-address" || name == "ipv6-address")
        return true;
    return false;
...
void Pim::Standby::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::SourceAddressNetio::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "af-name")
    {
        af_name = value;
...
void Pim::Standby::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::SourceAddressNetio::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "af-name")
    {
        af_name.yfilter = yfilter;
...
bool Pim::Standby::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::SourceAddressNetio::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "af-name" || name == "ipv4-address" || name == "ipv6-address")
        return true;
    return false;
...
void Pim::Standby::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::GroupAddressNetio::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "af-name")
    {
        af_name = value;
...
void Pim::Standby::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::GroupAddressNetio::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "af-name")
    {
        af_name.yfilter = yfilter;
...
bool Pim::Standby::Vrfs::Vrf::NetIoTunnels::NetIoTunnel::GroupAddressNetio::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "af-name" || name == "ipv4-address" || name == "ipv6-address")
        return true;
    return false;
...
void Pim::Standby::Vrfs::Vrf::BidirDfStates::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Pim::Standby::Vrfs::Vrf::BidirDfStates::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Pim::Standby::Vrfs::Vrf::BidirDfStates::has_leaf_or_child_of_name(const std::string & name) const
{
...
void Pim::Standby::Vrfs::Vrf::BidirDfStates::BidirDfState::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Pim::Standby::Vrfs::Vrf::BidirDfStates::BidirDfState::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "election-state")
    {
...
bool Pim::Standby::Vrfs::Vrf::BidirDfStates::BidirDfState::has_leaf_or_child_of_name(const std::string & name) const
{
...
void Pim::Standby::Vrfs::Vrf::BidirDfStates::BidirDfState::RpAddressXr::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "af-name")
    {
        af_name = value;
...
void Pim::Standby::Vrfs::Vrf::BidirDfStates::BidirDfState::RpAddressXr::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "af-name")
    {
        af_name.yfilter = yfilter;
...
bool Pim::Standby::Vrfs::Vrf::BidirDfStates::BidirDfState::RpAddressXr::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "af-name" || name == "ipv4-address" || name == "ipv6-address")
        return true;
    return false;
...
void Pim::Standby::Vrfs::Vrf::BgpAfs::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Pim::Standby::Vrfs::Vrf::BgpAfs::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Pim::Standby::Vrfs::Vrf::BgpAfs::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "bgp-af")
        return true;
    return false;
...
void Pim::Standby::Vrfs::Vrf::BgpAfs::BgpAf::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Pim::Standby::Vrfs::Vrf::BgpAfs::BgpAf::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "extranet-path-count")
    {
...
void Pim::Standby::Vrfs::Vrf::TopologyInterfaceFlagRouteCounts::TopologyInterfaceFlagRouteCount::GroupAddress::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "af-name")
    {
        af_name = value;
...
void Pim::Standby::Vrfs::Vrf::TopologyInterfaceFlagRouteCounts::TopologyInterfaceFlagRouteCount::GroupAddress::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "af-name")
    {
        af_name.yfilter = yfilter;
...
bool Pim::Standby::Vrfs::Vrf::TopologyInterfaceFlagRouteCounts::TopologyInterfaceFlagRouteCount::GroupAddress::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "af-name" || name == "ipv4-address" || name == "ipv6-address")
        return true;
    return false;
...
bool Pim::Standby::Vrfs::Vrf::TrafficCounters::has_operation() const
{
	...
	|| ydk::is_set(packet_dequeued.yfilter)
	|| ydk::is_set(packet_enqueued.yfilter)
	|| ydk::is_set(packet_packman_error.yfilter)
	|| ydk::is_set(packet_queue_last_clear.yfilter)
	|| ydk::is_set(packet_queue_length.yfilter)
	|| ydk::is_set(packet_queue_size.yfilter)
	|| ydk::is_set(packet_read_socket_error.yfilter)
	|| ydk::is_set(packet_tail_drop.yfilter)
...
void Pim::Standby::Vrfs::Vrf::TrafficCounters::set_filter(const std::string & value_path, YFilter yfilter)
{
    ...
    if(value_path == "packet-dequeued")
    {
        packet_dequeued.yfilter = yfilter;
    }
    if(value_path == "packet-enqueued")
    {
        packet_enqueued.yfilter = yfilter;
    }
    if(value_path == "packet-packman-error")
    {
    ...
    if(value_path == "packet-queue-length")
    {
        packet_queue_length.yfilter = yfilter;
    }
    if(value_path == "packet-queue-size")
    {
        packet_queue_size.yfilter = yfilter;
    }
    if(value_path == "packet-read-socket-error")
    {
    ...
    if(value_path == "packet-tail-drop")
    {
        packet_tail_drop.yfilter = yfilter;
    }
    if(value_path == "packets-standby")
    {
...
void Pim::Standby::Vrfs::Vrf::TopologyEntryFlagRouteCounts::TopologyEntryFlagRouteCount::GroupAddress::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "af-name")
    {
        af_name = value;
...
void Pim::Standby::Vrfs::Vrf::TopologyEntryFlagRouteCounts::TopologyEntryFlagRouteCount::GroupAddress::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "af-name")
    {
        af_name.yfilter = yfilter;
...
bool Pim::Standby::Vrfs::Vrf::TopologyEntryFlagRouteCounts::TopologyEntryFlagRouteCount::GroupAddress::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "af-name" || name == "ipv4-address" || name == "ipv6-address")
        return true;
    return false;
...
void Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::has_leaf_or_child_of_name(const std::string & name) const
{
...
void Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::GroupMapMatchSource::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "group-address")
    {
        group_address = value;
...
void Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::GroupMapMatchSource::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "group-address")
    {
        group_address.yfilter = yfilter;
...
bool Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::GroupMapMatchSource::has_leaf_or_child_of_name(const std::string & name) const
{
...
void Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::GroupMapMatchSource::SourceOfInformation::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "af-name")
    {
        af_name = value;
...
void Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::GroupMapMatchSource::SourceOfInformation::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "af-name")
    {
        af_name.yfilter = yfilter;
...
bool Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::GroupMapMatchSource::SourceOfInformation::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "af-name" || name == "ipv4-address" || name == "ipv6-address")
        return true;
    return false;
...
void Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::GroupMapMatchSource::GroupMapInformation::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "client")
    {
        client = value;
...
void Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::GroupMapMatchSource::GroupMapInformation::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "client")
    {
        client.yfilter = yfilter;
...
bool Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::GroupMapMatchSource::GroupMapInformation::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "prefix" || name == "rp-address" || name == "client" || name == "group-count" || name == "is-override" || name == "is-used" || name == "mrib-active" || name == "prefix-length" || name == "priority" || name == "protocol")
        return true;
    return false;
...
void Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::GroupMapMatchSource::GroupMapInformation::Prefix::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "af-name")
    {
        af_name = value;
...
void Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::GroupMapMatchSource::GroupMapInformation::Prefix::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "af-name")
    {
        af_name.yfilter = yfilter;
...
bool Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::GroupMapMatchSource::GroupMapInformation::Prefix::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "af-name" || name == "ipv4-address" || name == "ipv6-address")
        return true;
    return false;
...
void Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::GroupMapMatchSource::GroupMapInformation::RpAddress::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "af-name")
    {
        af_name = value;
...
void Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::GroupMapMatchSource::GroupMapInformation::RpAddress::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "af-name")
    {
        af_name.yfilter = yfilter;
...
bool Pim::Standby::Vrfs::Vrf::GroupMapMatchSources::GroupMapMatchSource::GroupMapInformation::RpAddress::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "af-name" || name == "ipv4-address" || name == "ipv6-address")
        return true;
    return false;
...
void Pim::Active::DefaultContext::TopologyRouteCount::GroupAddress::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "af-name")
    {
        af_name = value;
...
void Pim::Active::DefaultContext::TopologyRouteCount::GroupAddress::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "af-name")
    {
        af_name.yfilter = yfilter;
...
bool Pim::Active::DefaultContext::TopologyRouteCount::GroupAddress::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "af-name" || name == "ipv4-address" || name == "ipv6-address")
        return true;
    return false;
...
void Pim::Active::DefaultContext::GroupMapMatchRpfs::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Pim::Active::DefaultContext::GroupMapMatchRpfs::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Pim::Active::DefaultContext::GroupMapMatchRpfs::has_leaf_or_child_of_name(const std::string & name) const
{
...
void Pim::Active::DefaultContext::GroupMapMatchRpfs::GroupMapMatchRpf::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "group-address")
    {
        group_address = value;
...
void Pim::Active::DefaultContext::GroupMapMatchRpfs::GroupMapMatchRpf::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "group-address")
    {
        group_address.yfilter = yfilter;
...
bool Pim::Active::DefaultContext::GroupMapMatchRpfs::GroupMapMatchRpf::has_leaf_or_child_of_name(const std::string & name) const
{
...
void Pim::Active::DefaultContext::GroupMapMatchRpfs::GroupMapMatchRpf::RpfNeighbor::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "af-name")
    {
        af_name = value;
...
void Pim::Active::DefaultContext::GroupMapMatchRpfs::GroupMapMatchRpf::RpfNeighbor::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "af-name")
    {
        af_name.yfilter = yfilter;
...
bool Pim::Active::DefaultContext::GroupMapMatchRpfs::GroupMapMatchRpf::RpfNeighbor::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "af-name" || name == "ipv4-address" || name == "ipv6-address")
        return true;
    return false;
...
void Pim::Active::DefaultContext::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "client")
    {
        client = value;
...
void Pim::Active::DefaultContext::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "client")
    {
        client.yfilter = yfilter;
...
bool Pim::Active::DefaultContext::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "prefix" || name == "rp-address" || name == "client" || name == "group-count" || name == "is-override" || name == "is-used" || name == "mrib-active" || name == "prefix-length" || name == "priority" || name == "protocol")
        return true;
    return false;
...
void Pim::Active::DefaultContext::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::Prefix::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "af-name")
    {
        af_name = value;
...
void Pim::Active::DefaultContext::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::Prefix::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "af-name")
    {
        af_name.yfilter = yfilter;
...
bool Pim::Active::DefaultContext::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::Prefix::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "af-name" || name == "ipv4-address" || name == "ipv6-address")
        return true;
    return false;
...
void Pim::Active::DefaultContext::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::RpAddress::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "af-name")
    {
        af_name = value;
...
void Pim::Active::DefaultContext::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::RpAddress::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "af-name")
    {
        af_name.yfilter = yfilter;
...
bool Pim::Active::DefaultContext::GroupMapMatchRpfs::GroupMapMatchRpf::GroupMapInformation::RpAddress::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "af-name" || name == "ipv4-address" || name == "ipv6-address")
        return true;
    return false;
