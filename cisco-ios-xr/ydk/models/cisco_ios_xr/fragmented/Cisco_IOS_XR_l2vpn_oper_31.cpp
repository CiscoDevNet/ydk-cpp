...
L2vpnv2::Nodes::Node::Xconnects::Xconnect::Backup::PseudoWire::PreferredPath::PreferredPath()
    ...
    , te_named_tunnel(std::make_shared<L2vpnv2::Nodes::Node::Xconnects::Xconnect::Backup::PseudoWire::PreferredPath::TeNamedTunnel>())
{
...
L2vpnv2::Nodes::Node::Xconnects::Xconnect::Backup::PseudoWire::PreferredPath::TeNamedTunnel::TeNamedTunnel()
    :
...
bool L2vpnv2::Nodes::Node::Xconnects::Xconnect::Backup::PseudoWire::PreferredPath::TeNamedTunnel::has_data() const
{
    if (is_presence_container) return true;
    return te_named_tunnel.is_set;
}

bool L2vpnv2::Nodes::Node::Xconnects::Xconnect::Backup::PseudoWire::PreferredPath::TeNamedTunnel::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(te_named_tunnel.yfilter);
}

std::string L2vpnv2::Nodes::Node::Xconnects::Xconnect::Backup::PseudoWire::PreferredPath::TeNamedTunnel::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > L2vpnv2::Nodes::Node::Xconnects::Xconnect::Backup::PseudoWire::PreferredPath::TeNamedTunnel::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> L2vpnv2::Nodes::Node::Xconnects::Xconnect::Backup::PseudoWire::PreferredPath::TeNamedTunnel::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> L2vpnv2::Nodes::Node::Xconnects::Xconnect::Backup::PseudoWire::PreferredPath::TeNamedTunnel::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void L2vpnv2::Nodes::Node::Xconnects::Xconnect::Backup::PseudoWire::PreferredPath::TeNamedTunnel::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void L2vpnv2::Nodes::Node::Xconnects::Xconnect::Backup::PseudoWire::PreferredPath::TeNamedTunnel::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "te-named-tunnel")
    {
...
bool L2vpnv2::Nodes::Node::Xconnects::Xconnect::Backup::PseudoWire::PreferredPath::TeNamedTunnel::has_leaf_or_child_of_name(const std::string & name) const
{
