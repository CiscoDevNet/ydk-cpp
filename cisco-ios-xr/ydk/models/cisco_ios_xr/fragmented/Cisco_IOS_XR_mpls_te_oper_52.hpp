...
class MplsTeStandby::P2PP2MpTunnel::TunnelHeads : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_mpls_te_oper::MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead> > tunnel_head;
...
class MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_mpls_te_oper::MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Destination> > destination;
