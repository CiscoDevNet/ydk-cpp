...
{
    if(name == "snmp" || name == "distribute" || name == "vrfs" || name == "trace-bufs" || name == "graceful-shutdown-timers" || name == "default-vrf" || name == "process-name" || name == "start" || name == "nsr" || name == "protocol-shutdown" || name == "running")
        return true;
    return false;
}
