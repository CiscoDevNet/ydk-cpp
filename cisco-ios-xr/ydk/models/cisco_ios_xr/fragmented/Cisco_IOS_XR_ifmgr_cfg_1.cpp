...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteAccess::get_children() const
{
    ...
    if(qos != nullptr)
    {
        _children["Cisco-IOS-XR-qos-ma-sat-cfg:qos"] = qos;
    }
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteAccess::Qos::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteAccess::Qos::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(output != nullptr)
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteAccess::Qos::Output::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "service-policy")
    {
        auto ent_ = std::make_shared<InterfaceConfigurations::InterfaceConfiguration::NvSatelliteAccess::Qos::Output::ServicePolicy>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteAccess::Qos::Output::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteAccess::Qos::Output::ServicePolicy::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteAccess::Qos::Output::ServicePolicy::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteAccess::Qos::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "service-policy")
    {
        auto ent_ = std::make_shared<InterfaceConfigurations::InterfaceConfiguration::NvSatelliteAccess::Qos::Input::ServicePolicy>();
        ent_->parent = this;
        service_policy.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteAccess::Qos::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteAccess::Qos::Input::ServicePolicy::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteAccess::Qos::Input::ServicePolicy::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricLink::get_children() const
{
    ...
    if(frequency_synchronization != nullptr)
    {
        _children["Cisco-IOS-XR-freqsync-sat-cfg:frequency-synchronization"] = frequency_synchronization;
    }
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricLink::FrequencySynchronization::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricLink::FrequencySynchronization::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricLink::Qos::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "output")
    {
        if(output == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricLink::Qos::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(output != nullptr)
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricLink::Qos::Output::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "service-policy")
    {
        auto ent_ = std::make_shared<InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricLink::Qos::Output::ServicePolicy>();
        ent_->parent = this;
        service_policy.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricLink::Qos::Output::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricLink::Qos::Output::ServicePolicy::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricLink::Qos::Output::ServicePolicy::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricLink::Qos::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "service-policy")
    {
        auto ent_ = std::make_shared<InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricLink::Qos::Input::ServicePolicy>();
        ent_->parent = this;
        service_policy.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricLink::Qos::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricLink::Qos::Input::ServicePolicy::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricLink::Qos::Input::ServicePolicy::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricNetwork::Satellites::Qos::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "output")
    {
        if(output == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricNetwork::Satellites::Qos::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(output != nullptr)
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricNetwork::Satellites::Qos::Output::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "service-policy")
    {
        auto ent_ = std::make_shared<InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricNetwork::Satellites::Qos::Output::ServicePolicy>();
        ent_->parent = this;
        service_policy.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricNetwork::Satellites::Qos::Output::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricNetwork::Satellites::Qos::Output::ServicePolicy::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricNetwork::Satellites::Qos::Output::ServicePolicy::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricNetwork::Satellites::Qos::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "service-policy")
    {
        auto ent_ = std::make_shared<InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricNetwork::Satellites::Qos::Input::ServicePolicy>();
        ent_->parent = this;
        service_policy.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricNetwork::Satellites::Qos::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricNetwork::Satellites::Qos::Input::ServicePolicy::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::NvSatelliteFabricNetwork::Satellites::Qos::Input::ServicePolicy::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
InterfaceConfigurations::InterfaceConfiguration::Ipv4arp::Ipv4arp()
    ...
    drop_adj_timeout{YType::uint32, "drop-adj-timeout"},
...
bool InterfaceConfigurations::InterfaceConfiguration::Ipv4arp::has_operation() const
{
	...
	|| ydk::is_set(drop_adj_timeout.yfilter)
...
std::vector<std::pair<std::string, LeafData> > InterfaceConfigurations::InterfaceConfiguration::Ipv4arp::get_name_leaf_data() const
{
    ...
    if (drop_adj_timeout.is_set || is_set(drop_adj_timeout.yfilter)) leaf_name_data.push_back(drop_adj_timeout.get_name_leafdata());
...
void InterfaceConfigurations::InterfaceConfiguration::Ipv4arp::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    ...
    if(value_path == "drop-adj-timeout")
    {
        drop_adj_timeout = value;
        drop_adj_timeout.value_namespace = name_space;
        drop_adj_timeout.value_namespace_prefix = name_space_prefix;
    }
...
void InterfaceConfigurations::InterfaceConfiguration::Ipv4arp::set_filter(const std::string & value_path, YFilter yfilter)
{
    ...
    if(value_path == "drop-adj-timeout")
    {
        drop_adj_timeout.yfilter = yfilter;
    }
    if(value_path == "learning-solicited")
    {
...
{
    if(name == "learning-local" || name == "drop-adj-timeout" || name == "learning-solicited" || name == "gratuitous-ignore" || name == "proxy-arp" || name == "purge-delay" || name == "learning-disable" || name == "local-proxy-arp" || name == "timeout")
        return true;
    return false;
}

InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Ipv4DhcpClientConfig()
    :
    ipv4_dhcp_client{YType::empty, "ipv4-dhcp-client"}
        ,
    option61_config(nullptr) // presence node
    , option60_config(nullptr) // presence node
    , option77_config(nullptr) // presence node
{

    yang_name = "ipv4-dhcp-client-config"; yang_parent_name = "interface-configuration"; is_top_level_class = false; has_list_ancestor = true; is_presence_container = true;
}
...
bool InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::has_data() const
{
    if (is_presence_container) return true;
    return ipv4_dhcp_client.is_set
	|| (option61_config !=  nullptr && option61_config->has_data())
	|| (option60_config !=  nullptr && option60_config->has_data())
	|| (option77_config !=  nullptr && option77_config->has_data());
}

bool InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(ipv4_dhcp_client.yfilter)
	|| (option61_config !=  nullptr && option61_config->has_operation())
	|| (option60_config !=  nullptr && option60_config->has_operation())
	|| (option77_config !=  nullptr && option77_config->has_operation());
}

std::string InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-ipv4-dc-cfg:ipv4-dhcp-client-config";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};

    if (ipv4_dhcp_client.is_set || is_set(ipv4_dhcp_client.yfilter)) leaf_name_data.push_back(ipv4_dhcp_client.get_name_leafdata());

    return leaf_name_data;

}

std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "option61-config")
    {
        if(option61_config == nullptr)
        {
            option61_config = std::make_shared<InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option61Config>();
        }
        return option61_config;
    }

    if(child_yang_name == "option60-config")
    {
        if(option60_config == nullptr)
        {
            option60_config = std::make_shared<InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option60Config>();
        }
        return option60_config;
    }

    if(child_yang_name == "option77-config")
    {
        if(option77_config == nullptr)
        {
            option77_config = std::make_shared<InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option77Config>();
        }
        return option77_config;
    }

    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(option61_config != nullptr)
    {
        _children["option61-config"] = option61_config;
    }

    if(option60_config != nullptr)
    {
        _children["option60-config"] = option60_config;
    }

    if(option77_config != nullptr)
    {
        _children["option77-config"] = option77_config;
    }

    return _children;
}

void InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ipv4-dhcp-client")
    {
        ipv4_dhcp_client = value;
        ipv4_dhcp_client.value_namespace = name_space;
        ipv4_dhcp_client.value_namespace_prefix = name_space_prefix;
    }
}

void InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ipv4-dhcp-client")
    {
        ipv4_dhcp_client.yfilter = yfilter;
    }
}

bool InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "option61-config" || name == "option60-config" || name == "option77-config" || name == "ipv4-dhcp-client")
        return true;
    return false;
}

InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option61Config::Option61Config()
    :
    opt61{YType::enumeration, "opt61"},
    subtype{YType::enumeration, "subtype"},
    ascii_string{YType::str, "ascii-string"}
{

    yang_name = "option61-config"; yang_parent_name = "ipv4-dhcp-client-config"; is_top_level_class = false; has_list_ancestor = true; is_presence_container = true;
}
...
bool InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option61Config::has_data() const
{
    if (is_presence_container) return true;
    return opt61.is_set
	|| subtype.is_set
...
bool InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option61Config::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(opt61.yfilter)
	|| ydk::is_set(subtype.yfilter)
	|| ydk::is_set(ascii_string.yfilter);
}

std::string InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option61Config::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "option61-config";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option61Config::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};

    if (opt61.is_set || is_set(opt61.yfilter)) leaf_name_data.push_back(opt61.get_name_leafdata());
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option61Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option61Config::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option61Config::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "opt61")
    {
        opt61 = value;
        opt61.value_namespace = name_space;
        opt61.value_namespace_prefix = name_space_prefix;
    }
...
void InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option61Config::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "opt61")
    {
        opt61.yfilter = yfilter;
    }
    if(value_path == "subtype")
    {
...
bool InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option61Config::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "opt61" || name == "subtype" || name == "ascii-string")
        return true;
    return false;
}

InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option60Config::Option60Config()
    :
    opt60{YType::enumeration, "opt60"},
    enable{YType::empty, "enable"},
    ascii_string{YType::str, "ascii-string"}
{

    yang_name = "option60-config"; yang_parent_name = "ipv4-dhcp-client-config"; is_top_level_class = false; has_list_ancestor = true; is_presence_container = true;
}
...
bool InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option60Config::has_data() const
{
    if (is_presence_container) return true;
    return opt60.is_set
	|| enable.is_set
...
bool InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option60Config::has_operation() const
{
    return is_set(yfilter)
...
std::string InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option60Config::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "option60-config";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option60Config::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option60Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option60Config::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option60Config::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "opt60")
    {
        opt60 = value;
...
void InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option60Config::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "opt60")
    {
...
bool InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option60Config::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "opt60" || name == "enable" || name == "ascii-string")
        return true;
    return false;
}

InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option77Config::Option77Config()
    :
    opt77{YType::enumeration, "opt77"},
    enable{YType::empty, "enable"},
    ascii_string{YType::str, "ascii-string"}
{

    yang_name = "option77-config"; yang_parent_name = "ipv4-dhcp-client-config"; is_top_level_class = false; has_list_ancestor = true; is_presence_container = true;
}
...
bool InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option77Config::has_data() const
{
    if (is_presence_container) return true;
    return opt77.is_set
	|| enable.is_set
...
bool InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option77Config::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(opt77.yfilter)
	|| ydk::is_set(enable.yfilter)
	|| ydk::is_set(ascii_string.yfilter);
}

std::string InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option77Config::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "option77-config";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option77Config::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};

    if (opt77.is_set || is_set(opt77.yfilter)) leaf_name_data.push_back(opt77.get_name_leafdata());
    if (enable.is_set || is_set(enable.yfilter)) leaf_name_data.push_back(enable.get_name_leafdata());
    if (ascii_string.is_set || is_set(ascii_string.yfilter)) leaf_name_data.push_back(ascii_string.get_name_leafdata());
...
std::shared_ptr<ydk::Entity> InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option77Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option77Config::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option77Config::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "opt77")
    {
        opt77 = value;
        opt77.value_namespace = name_space;
        opt77.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "enable")
    {
        enable = value;
...
void InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option77Config::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "opt77")
    {
        opt77.yfilter = yfilter;
    }
    if(value_path == "enable")
    {
        enable.yfilter = yfilter;
...
bool InterfaceConfigurations::InterfaceConfiguration::Ipv4DhcpClientConfig::Option77Config::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "opt77" || name == "enable" || name == "ascii-string")
        return true;
    return false;
}
