...
class Inventory::Racks::Rack::Fantray::Slot::Attributes::InvEepromInfo::Eeprom : public ydk::Entity
{
    public:
        Eeprom();
        ~Eeprom();
...
class Inventory::Racks::Rack::Fantray::Slot::Attributes::InvEepromInfo::Eeprom::Rma : public ydk::Entity
{
    public:
        Rma();
        ~Rma();
