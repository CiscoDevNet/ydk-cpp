...
EntityPath Inventory::Racks::Rack::Fantray::Slot::Attributes::InvBasicBag::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Fantray::Slot::Attributes::InvBasicBag::get_children()
{
    return children;
}

void Inventory::Racks::Rack::Fantray::Slot::Attributes::InvBasicBag::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "alias")
    {
        alias = value;
...
EntityPath Inventory::Racks::Rack::Fantray::Slot::Attributes::InvEepromInfo::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Inventory::Racks::Rack::Fantray::Slot::Attributes::InvEepromInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Fantray::Slot::Attributes::InvEepromInfo::get_children()
{
...
void Inventory::Racks::Rack::Fantray::Slot::Attributes::InvEepromInfo::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "description")
    {
        description = value;
...
EntityPath Inventory::Racks::Rack::Fantray::Slot::Attributes::InvEepromInfo::Eeprom::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Inventory::Racks::Rack::Fantray::Slot::Attributes::InvEepromInfo::Eeprom::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Fantray::Slot::Attributes::InvEepromInfo::Eeprom::get_children()
{
...
void Inventory::Racks::Rack::Fantray::Slot::Attributes::InvEepromInfo::Eeprom::set_value(const std::string & value_path, std::string value)
{
...
EntityPath Inventory::Racks::Rack::Fantray::Slot::Attributes::InvEepromInfo::Eeprom::Rma::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Inventory::Racks::Rack::Fantray::Slot::Attributes::InvEepromInfo::Eeprom::Rma::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Fantray::Slot::Attributes::InvEepromInfo::Eeprom::Rma::get_children()
{
    return children;
}

void Inventory::Racks::Rack::Fantray::Slot::Attributes::InvEepromInfo::Eeprom::Rma::set_value(const std::string & value_path, std::string value)
{
...
EntityPath Inventory::Racks::Rack::Attributes::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::get_children()
{
...
void Inventory::Racks::Rack::Attributes::set_value(const std::string & value_path, std::string value)
{
...
EntityPath Inventory::Racks::Rack::Attributes::EnvSensorInfo::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::EnvSensorInfo::get_children()
{
    return children;
}

void Inventory::Racks::Rack::Attributes::EnvSensorInfo::set_value(const std::string & value_path, std::string value)
{
...
EntityPath Inventory::Racks::Rack::Attributes::PwgInfo::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::PwgInfo::get_children()
{
    return children;
}

void Inventory::Racks::Rack::Attributes::PwgInfo::set_value(const std::string & value_path, std::string value)
{
...
EntityPath Inventory::Racks::Rack::Attributes::EnvSensorInfoXml::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::EnvSensorInfoXml::get_children()
{
    if(children.find("threshold") == children.end())
    {
        if(threshold != nullptr)
...
void Inventory::Racks::Rack::Attributes::EnvSensorInfoXml::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "data-type")
    {
        data_type = value;
...
EntityPath Inventory::Racks::Rack::Attributes::EnvSensorInfoXml::Threshold::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::EnvSensorInfoXml::Threshold::get_children()
{
    for (auto const & c : threshold_array)
    {
...
void Inventory::Racks::Rack::Attributes::EnvSensorInfoXml::Threshold::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath Inventory::Racks::Rack::Attributes::EnvSensorInfoXml::Threshold::ThresholdArray::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::EnvSensorInfoXml::Threshold::ThresholdArray::get_children()
{
    return children;
}

void Inventory::Racks::Rack::Attributes::EnvSensorInfoXml::Threshold::ThresholdArray::set_value(const std::string & value_path, std::string value)
{
...
EntityPath Inventory::Racks::Rack::Attributes::InvAssetBag::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::InvAssetBag::get_children()
{
    return children;
}

void Inventory::Racks::Rack::Attributes::InvAssetBag::set_value(const std::string & value_path, std::string value)
{
...
EntityPath Inventory::Racks::Rack::Attributes::Threshold::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::Threshold::get_children()
{
...
void Inventory::Racks::Rack::Attributes::Threshold::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath Inventory::Racks::Rack::Attributes::Threshold::MajorLo::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::Threshold::MajorLo::get_children()
{
...
void Inventory::Racks::Rack::Attributes::Threshold::MajorLo::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath Inventory::Racks::Rack::Attributes::Threshold::MajorLo::ThreshBag::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::Threshold::MajorLo::ThreshBag::get_children()
{
    return children;
}

void Inventory::Racks::Rack::Attributes::Threshold::MajorLo::ThreshBag::set_value(const std::string & value_path, std::string value)
{
...
EntityPath Inventory::Racks::Rack::Attributes::Threshold::CriticalHi::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::Threshold::CriticalHi::get_children()
{
    if(children.find("thresh-bag") == children.end())
    {
        if(thresh_bag != nullptr)
...
void Inventory::Racks::Rack::Attributes::Threshold::CriticalHi::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath Inventory::Racks::Rack::Attributes::Threshold::CriticalHi::ThreshBag::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::Threshold::CriticalHi::ThreshBag::get_children()
{
    return children;
}

void Inventory::Racks::Rack::Attributes::Threshold::CriticalHi::ThreshBag::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "threshold-evaluation")
    {
        threshold_evaluation = value;
...
EntityPath Inventory::Racks::Rack::Attributes::Threshold::MinorHi::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::Threshold::MinorHi::get_children()
{
    if(children.find("thresh-bag") == children.end())
    {
        if(thresh_bag != nullptr)
...
void Inventory::Racks::Rack::Attributes::Threshold::MinorHi::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath Inventory::Racks::Rack::Attributes::Threshold::MinorHi::ThreshBag::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::Threshold::MinorHi::ThreshBag::get_children()
{
    return children;
}

void Inventory::Racks::Rack::Attributes::Threshold::MinorHi::ThreshBag::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "threshold-evaluation")
    {
        threshold_evaluation = value;
...
EntityPath Inventory::Racks::Rack::Attributes::Threshold::MajorHi::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::Threshold::MajorHi::get_children()
{
    if(children.find("thresh-bag") == children.end())
    {
        if(thresh_bag != nullptr)
...
void Inventory::Racks::Rack::Attributes::Threshold::MajorHi::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath Inventory::Racks::Rack::Attributes::Threshold::MajorHi::ThreshBag::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::Threshold::MajorHi::ThreshBag::get_children()
{
    return children;
}

void Inventory::Racks::Rack::Attributes::Threshold::MajorHi::ThreshBag::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "threshold-evaluation")
    {
        threshold_evaluation = value;
...
EntityPath Inventory::Racks::Rack::Attributes::Threshold::CriticalLo::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::Threshold::CriticalLo::get_children()
{
    if(children.find("thresh-bag") == children.end())
    {
        if(thresh_bag != nullptr)
...
void Inventory::Racks::Rack::Attributes::Threshold::CriticalLo::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath Inventory::Racks::Rack::Attributes::Threshold::CriticalLo::ThreshBag::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::Threshold::CriticalLo::ThreshBag::get_children()
{
    return children;
}

void Inventory::Racks::Rack::Attributes::Threshold::CriticalLo::ThreshBag::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "threshold-evaluation")
    {
        threshold_evaluation = value;
...
EntityPath Inventory::Racks::Rack::Attributes::Threshold::MinorLo::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::Threshold::MinorLo::get_children()
{
    if(children.find("thresh-bag") == children.end())
    {
        if(thresh_bag != nullptr)
...
void Inventory::Racks::Rack::Attributes::Threshold::MinorLo::set_value(const std::string & value_path, std::string value)
{
}
...
EntityPath Inventory::Racks::Rack::Attributes::Threshold::MinorLo::ThreshBag::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::Threshold::MinorLo::ThreshBag::get_children()
{
    return children;
}

void Inventory::Racks::Rack::Attributes::Threshold::MinorLo::ThreshBag::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "threshold-evaluation")
    {
        threshold_evaluation = value;
...
EntityPath Inventory::Racks::Rack::Attributes::FruInfo::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::FruInfo::get_children()
{
...
void Inventory::Racks::Rack::Attributes::FruInfo::set_value(const std::string & value_path, std::string value)
{
...
EntityPath Inventory::Racks::Rack::Attributes::FruInfo::LastOperationalStateChange::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::FruInfo::LastOperationalStateChange::get_children()
{
    return children;
}

void Inventory::Racks::Rack::Attributes::FruInfo::LastOperationalStateChange::set_value(const std::string & value_path, std::string value)
{
...
EntityPath Inventory::Racks::Rack::Attributes::FruInfo::CardUpTime::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::FruInfo::CardUpTime::get_children()
{
    return children;
}

void Inventory::Racks::Rack::Attributes::FruInfo::CardUpTime::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "time-in-nano-seconds")
    {
        time_in_nano_seconds = value;
...
EntityPath Inventory::Racks::Rack::Attributes::InvBasicBag::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::InvBasicBag::get_children()
{
    return children;
}

void Inventory::Racks::Rack::Attributes::InvBasicBag::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "alias")
    {
        alias = value;
...
EntityPath Inventory::Racks::Rack::Attributes::InvEepromInfo::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::InvEepromInfo::get_children()
{
    if(children.find("eeprom") == children.end())
    {
        if(eeprom != nullptr)
...
void Inventory::Racks::Rack::Attributes::InvEepromInfo::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "description")
    {
        description = value;
...
EntityPath Inventory::Racks::Rack::Attributes::InvEepromInfo::Eeprom::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::InvEepromInfo::Eeprom::get_children()
{
    if(children.find("rma") == children.end())
    {
        if(rma != nullptr)
...
void Inventory::Racks::Rack::Attributes::InvEepromInfo::Eeprom::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "asset-alias")
    {
        asset_alias = value;
...
EntityPath Inventory::Racks::Rack::Attributes::InvEepromInfo::Eeprom::Rma::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::map<std::string, std::shared_ptr<Entity>> & Inventory::Racks::Rack::Attributes::InvEepromInfo::Eeprom::Rma::get_children()
{
    return children;
}

void Inventory::Racks::Rack::Attributes::InvEepromInfo::Eeprom::Rma::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "rma-history")
    {
        rma_history = value;
