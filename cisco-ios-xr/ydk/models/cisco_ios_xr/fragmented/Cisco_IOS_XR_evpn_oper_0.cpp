...
std::shared_ptr<ydk::Entity> Evpn::Nodes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "node")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node>();
        ent_->parent = this;
        node.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
Evpn::Nodes::Node::Node()
    ...
    node_id{YType::str, "node-id"}
        ,
    evpn_groups(std::make_shared<Evpn::Nodes::Node::EvpnGroups>())
    , remote_shgs(std::make_shared<Evpn::Nodes::Node::RemoteShgs>())
    , client(std::make_shared<Evpn::Nodes::Node::Client>())
    , igmps(std::make_shared<Evpn::Nodes::Node::Igmps>())
    ...
    , teps(std::make_shared<Evpn::Nodes::Node::Teps>())
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(evpn_groups != nullptr)
...
{
    if(name == "evpn-groups" || name == "remote-shgs" || name == "client" || name == "igmps" || name == "evis" || name == "summary" || name == "evi-detail" || name == "teps" || name == "internal-labels" || name == "ethernet-segments" || name == "ac-ids" || name == "node-id")
        return true;
    return false;
}

Evpn::Nodes::Node::EvpnGroups::EvpnGroups()
    :
    evpn_group(this, {"group_number"})
{

    yang_name = "evpn-groups"; yang_parent_name = "node"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::EvpnGroups::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::EvpnGroups::has_operation() const
{
    for (std::size_t index=0; index<evpn_group.len(); index++)
    {
...
std::string Evpn::Nodes::Node::EvpnGroups::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::EvpnGroups::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EvpnGroups::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "evpn-group")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EvpnGroups::EvpnGroup>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EvpnGroups::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Nodes::Node::EvpnGroups::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Evpn::Nodes::Node::EvpnGroups::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Evpn::Nodes::Node::EvpnGroups::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "evpn-group")
        return true;
    return false;
...
Evpn::Nodes::Node::EvpnGroups::EvpnGroup::EvpnGroup()
    :
    ...
    , access_interface(this, {})
{
    ...
    yang_name = "evpn-group"; yang_parent_name = "evpn-groups"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::EvpnGroups::EvpnGroup::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::EvpnGroups::EvpnGroup::has_operation() const
{
    for (std::size_t index=0; index<core_interface.len(); index++)
    {
...
std::string Evpn::Nodes::Node::EvpnGroups::EvpnGroup::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::EvpnGroups::EvpnGroup::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EvpnGroups::EvpnGroup::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "core-interface")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EvpnGroups::EvpnGroup::CoreInterface>();
        ent_->parent = this;
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EvpnGroups::EvpnGroup::AccessInterface>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EvpnGroups::EvpnGroup::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Nodes::Node::EvpnGroups::EvpnGroup::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Evpn::Nodes::Node::EvpnGroups::EvpnGroup::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "group-number")
    {
...
bool Evpn::Nodes::Node::EvpnGroups::EvpnGroup::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::EvpnGroups::EvpnGroup::CoreInterface::CoreInterface()
    :
...
bool Evpn::Nodes::Node::EvpnGroups::EvpnGroup::CoreInterface::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::EvpnGroups::EvpnGroup::CoreInterface::has_operation() const
{
    return is_set(yfilter)
...
std::string Evpn::Nodes::Node::EvpnGroups::EvpnGroup::CoreInterface::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::EvpnGroups::EvpnGroup::CoreInterface::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EvpnGroups::EvpnGroup::CoreInterface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EvpnGroups::EvpnGroup::CoreInterface::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::EvpnGroups::EvpnGroup::CoreInterface::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Evpn::Nodes::Node::EvpnGroups::EvpnGroup::CoreInterface::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "interface-name")
    {
...
bool Evpn::Nodes::Node::EvpnGroups::EvpnGroup::CoreInterface::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::EvpnGroups::EvpnGroup::AccessInterface::AccessInterface()
    :
    interface_name{YType::str, "interface-name"},
    state{YType::enumeration, "state"}
{
...
bool Evpn::Nodes::Node::EvpnGroups::EvpnGroup::AccessInterface::has_data() const
{
    if (is_presence_container) return true;
    return interface_name.is_set
	|| state.is_set;
...
bool Evpn::Nodes::Node::EvpnGroups::EvpnGroup::AccessInterface::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(interface_name.yfilter)
	|| ydk::is_set(state.yfilter);
...
std::string Evpn::Nodes::Node::EvpnGroups::EvpnGroup::AccessInterface::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::EvpnGroups::EvpnGroup::AccessInterface::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EvpnGroups::EvpnGroup::AccessInterface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EvpnGroups::EvpnGroup::AccessInterface::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::EvpnGroups::EvpnGroup::AccessInterface::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "interface-name")
    {
        interface_name = value;
...
void Evpn::Nodes::Node::EvpnGroups::EvpnGroup::AccessInterface::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "interface-name")
    {
        interface_name.yfilter = yfilter;
...
bool Evpn::Nodes::Node::EvpnGroups::EvpnGroup::AccessInterface::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "interface-name" || name == "state")
        return true;
    return false;
...
Evpn::Nodes::Node::RemoteShgs::RemoteShgs()
    :
    remote_shg(this, {})
{

    yang_name = "remote-shgs"; yang_parent_name = "node"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::RemoteShgs::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::RemoteShgs::has_operation() const
{
    for (std::size_t index=0; index<remote_shg.len(); index++)
    {
...
std::string Evpn::Nodes::Node::RemoteShgs::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::RemoteShgs::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::RemoteShgs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "remote-shg")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::RemoteShgs::RemoteShg>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::RemoteShgs::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Nodes::Node::RemoteShgs::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Evpn::Nodes::Node::RemoteShgs::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Evpn::Nodes::Node::RemoteShgs::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "remote-shg")
        return true;
    return false;
...
Evpn::Nodes::Node::RemoteShgs::RemoteShg::RemoteShg()
    :
    esi1{YType::str, "esi1"},
    esi2{YType::str, "esi2"},
    esi3{YType::str, "esi3"},
    ...
    , remote_split_horizon_group_label(this, {})
{
    ...
    yang_name = "remote-shg"; yang_parent_name = "remote-shgs"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::RemoteShgs::RemoteShg::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::RemoteShgs::RemoteShg::has_operation() const
{
    for (std::size_t index=0; index<ethernet_segment_identifier.len(); index++)
    {
...
std::string Evpn::Nodes::Node::RemoteShgs::RemoteShg::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::RemoteShgs::RemoteShg::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::RemoteShgs::RemoteShg::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "ethernet-segment-identifier")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::RemoteShgs::RemoteShg::EthernetSegmentIdentifier>();
        ent_->parent = this;
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::RemoteShgs::RemoteShg::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Nodes::Node::RemoteShgs::RemoteShg::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "esi1")
    {
        esi1 = value;
...
void Evpn::Nodes::Node::RemoteShgs::RemoteShg::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "esi1")
    {
...
bool Evpn::Nodes::Node::RemoteShgs::RemoteShg::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::EthernetSegmentIdentifier()
    :
    entry{YType::uint8, "entry"}
{

    yang_name = "ethernet-segment-identifier"; yang_parent_name = "remote-shg"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::has_data() const
{
    if (is_presence_container) return true;
    return entry.is_set;
}

bool Evpn::Nodes::Node::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(entry.yfilter);
}

std::string Evpn::Nodes::Node::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "entry")
    {
        entry = value;
...
void Evpn::Nodes::Node::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "entry")
    {
...
bool Evpn::Nodes::Node::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "entry")
        return true;
    return false;
...
Evpn::Nodes::Node::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::RemoteSplitHorizonGroupLabel()
    :
    next_hop{YType::str, "next-hop"},
    label{YType::uint32, "label"}
{

    yang_name = "remote-split-horizon-group-label"; yang_parent_name = "remote-shg"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::has_operation() const
{
    return is_set(yfilter)
...
std::string Evpn::Nodes::Node::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Evpn::Nodes::Node::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "next-hop")
    {
...
bool Evpn::Nodes::Node::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::has_leaf_or_child_of_name(const std::string & name) const
{
...
bool Evpn::Nodes::Node::Client::has_data() const
{
    if (is_presence_container) return true;
    return false;
}

bool Evpn::Nodes::Node::Client::has_operation() const
{
    return is_set(yfilter);
}

std::string Evpn::Nodes::Node::Client::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "client";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Client::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Client::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Client::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::Client::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Evpn::Nodes::Node::Client::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Evpn::Nodes::Node::Client::has_leaf_or_child_of_name(const std::string & name) const
{
    return false;
}

Evpn::Nodes::Node::Igmps::Igmps()
    :
    igmp(this, {})
{

    yang_name = "igmps"; yang_parent_name = "node"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::Igmps::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::Igmps::has_operation() const
{
    for (std::size_t index=0; index<igmp.len(); index++)
    {
...
std::string Evpn::Nodes::Node::Igmps::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "igmps";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "igmp")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::Igmps::Igmp>();
        ent_->parent = this;
        igmp.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Nodes::Node::Igmps::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Evpn::Nodes::Node::Igmps::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Evpn::Nodes::Node::Igmps::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "igmp")
        return true;
    return false;
...
Evpn::Nodes::Node::Igmps::Igmp::Igmp()
    :
    ...
    resolved{YType::boolean, "resolved"}
        ,
    source_info(std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo>())
    , ethernet_segment_identifier(this, {})
    , next_hop(this, {})
{
    source_info->parent = this;

    yang_name = "igmp"; yang_parent_name = "igmps"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::Igmps::Igmp::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<ethernet_segment_identifier.len(); index++)
    {
...
bool Evpn::Nodes::Node::Igmps::Igmp::has_operation() const
{
    for (std::size_t index=0; index<ethernet_segment_identifier.len(); index++)
    {
        if(ethernet_segment_identifier[index]->has_operation())
...
std::string Evpn::Nodes::Node::Igmps::Igmp::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "igmp";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "ethernet-segment-identifier")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::EthernetSegmentIdentifier>();
        ent_->parent = this;
        ethernet_segment_identifier.append(ent_);
        return ent_;
    }
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::NextHop>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(source_info != nullptr)
...
void Evpn::Nodes::Node::Igmps::Igmp::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Evpn::Nodes::Node::Igmps::Igmp::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "is-leave")
    {
...
bool Evpn::Nodes::Node::Igmps::Igmp::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::SourceInfo()
    :
    type{YType::enumeration, "type"},
    remote_info{YType::str, "remote-info"}
        ,
    local_info(std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo>())
{
    local_info->parent = this;

    yang_name = "source-info"; yang_parent_name = "igmp"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::has_data() const
{
    if (is_presence_container) return true;
    return type.is_set
	|| remote_info.is_set
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::has_operation() const
{
    return is_set(yfilter)
...
std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(local_info != nullptr)
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "type")
    {
        type = value;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "type")
    {
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::LocalInfo()
    :
    name{YType::str, "name"},
    mtu{YType::uint32, "mtu"},
    payload_bytes{YType::uint16, "payload-bytes"}
        ,
    parameters(std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters>())
{
    parameters->parent = this;

    yang_name = "local-info"; yang_parent_name = "source-info"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::has_data() const
{
    if (is_presence_container) return true;
    return name.is_set
	|| mtu.is_set
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::has_operation() const
{
    return is_set(yfilter)
...
std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(parameters != nullptr)
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "name")
    {
        name = value;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "name")
    {
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Parameters()
    :
    type{YType::enumeration, "type"}
        ,
    ethernet(std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet>())
    , vlan(std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan>())
    , tdm(std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm>())
    , atm(std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm>())
    , fr(std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr>())
    , pseudowire_ether(std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther>())
    , pseudowire_iw(std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw>())
{
    ...
    yang_name = "parameters"; yang_parent_name = "local-info"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::has_data() const
{
    if (is_presence_container) return true;
    return type.is_set
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(type.yfilter)
...
std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(ethernet != nullptr)
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "type")
    {
        type = value;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "type")
    {
        type.yfilter = yfilter;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::Ethernet()
    :
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::has_data() const
{
    if (is_presence_container) return true;
    return xconnect_tags.is_set;
}

bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(xconnect_tags.yfilter);
}

std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "xconnect-tags")
    {
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::Vlan()
    :
    xconnect_tags{YType::uint8, "xconnect-tags"},
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::has_operation() const
{
    for (std::size_t index=0; index<rewrite_tag.len(); index++)
    {
...
std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "vlan";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "rewrite-tag")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag>();
        ent_->parent = this;
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "xconnect-tags")
    {
        xconnect_tags = value;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "xconnect-tags")
    {
        xconnect_tags.yfilter = yfilter;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::RewriteTag()
    :
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::has_data() const
{
    if (is_presence_container) return true;
    return entry.is_set;
}

bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(entry.yfilter);
}

std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "entry")
    {
        entry = value;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "entry")
    {
        entry.yfilter = yfilter;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "entry")
        return true;
    return false;
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::VlanRange()
    :
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::has_data() const
{
    if (is_presence_container) return true;
    return lower.is_set
	|| upper.is_set;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::has_operation() const
{
    return is_set(yfilter)
...
std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "lower")
    {
        lower = value;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "lower")
    {
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::Tdm()
    :
    timeslot_group{YType::str, "timeslot-group"},
    timeslot_rate{YType::uint8, "timeslot-rate"},
    tdm_mode{YType::enumeration, "tdm-mode"}
        ,
    tdm_options(std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions>())
{
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::has_operation() const
{
    return is_set(yfilter)
...
std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "tdm";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(tdm_options != nullptr)
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "timeslot-group")
    {
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::TdmOptions()
    :
    payload_bytes{YType::uint16, "payload-bytes"},
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(payload_bytes.yfilter)
...
std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "payload-bytes")
    {
        payload_bytes = value;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "payload-bytes")
    {
        payload_bytes.yfilter = yfilter;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::Atm()
    :
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::has_operation() const
{
    return is_set(yfilter)
...
std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "atm";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "maximum-number-cells-packed")
    {
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::Fr()
    :
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::has_operation() const
{
    return is_set(yfilter)
...
std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "fr";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "fr-mode")
    {
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::PseudowireEther()
    :
    is_valid{YType::boolean, "is-valid"},
    internal_label{YType::uint32, "internal-label"}
        ,
    interface_list(std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList>())
{
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::has_operation() const
{
    return is_set(yfilter)
...
std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(interface_list != nullptr)
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "is-valid")
    {
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::InterfaceList()
    :
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::has_operation() const
{
    for (std::size_t index=0; index<interface.len(); index++)
    {
...
std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "interface")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "interface-list-name")
    {
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::Interface()
    :
    interface_name{YType::str, "interface-name"},
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::has_data() const
{
    if (is_presence_container) return true;
    return interface_name.is_set
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(interface_name.yfilter)
...
std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "interface-name")
    {
        interface_name = value;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "interface-name")
    {
        interface_name.yfilter = yfilter;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::PseudowireIw()
    :
    is_valid{YType::boolean, "is-valid"},
    internal_label{YType::uint32, "internal-label"}
        ,
    interface_list(std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList>())
{
    interface_list->parent = this;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::has_data() const
{
    if (is_presence_container) return true;
    return is_valid.is_set
	|| internal_label.is_set
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(is_valid.yfilter)
	|| ydk::is_set(internal_label.yfilter)
...
std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "interface-list")
    {
        if(interface_list == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(interface_list != nullptr)
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "is-valid")
    {
        is_valid = value;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "is-valid")
    {
        is_valid.yfilter = yfilter;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "interface-list" || name == "is-valid" || name == "internal-label")
        return true;
    return false;
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::InterfaceList()
    :
    interface_list_name{YType::str, "interface-list-name"},
    interface_list_id{YType::uint32, "interface-list-id"}
        ,
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<interface.len(); index++)
    {
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::has_operation() const
{
    for (std::size_t index=0; index<interface.len(); index++)
    {
        if(interface[index]->has_operation())
...
std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "interface-list";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "interface")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface>();
        ent_->parent = this;
        interface.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "interface-list-name")
    {
        interface_list_name = value;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "interface-list-name")
    {
        interface_list_name.yfilter = yfilter;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "interface" || name == "interface-list-name" || name == "interface-list-id")
        return true;
    return false;
...
Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::Interface()
    :
    interface_name{YType::str, "interface-name"},
    replicate_status{YType::enumeration, "replicate-status"}
{
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::has_data() const
{
    if (is_presence_container) return true;
    return interface_name.is_set
	|| replicate_status.is_set;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(interface_name.yfilter)
	|| ydk::is_set(replicate_status.yfilter);
...
std::string Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "interface";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "interface-name")
    {
        interface_name = value;
...
void Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "interface-name")
    {
        interface_name.yfilter = yfilter;
...
bool Evpn::Nodes::Node::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "interface-name" || name == "replicate-status")
        return true;
    return false;
...
Evpn::Nodes::Node::Igmps::Igmp::EthernetSegmentIdentifier::EthernetSegmentIdentifier()
    :
    entry{YType::uint8, "entry"}
{

    yang_name = "ethernet-segment-identifier"; yang_parent_name = "igmp"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::Igmps::Igmp::EthernetSegmentIdentifier::has_data() const
{
    if (is_presence_container) return true;
    return entry.is_set;
}

bool Evpn::Nodes::Node::Igmps::Igmp::EthernetSegmentIdentifier::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(entry.yfilter);
}

std::string Evpn::Nodes::Node::Igmps::Igmp::EthernetSegmentIdentifier::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "ethernet-segment-identifier";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::EthernetSegmentIdentifier::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::EthernetSegmentIdentifier::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::EthernetSegmentIdentifier::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::Igmps::Igmp::EthernetSegmentIdentifier::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "entry")
    {
        entry = value;
...
void Evpn::Nodes::Node::Igmps::Igmp::EthernetSegmentIdentifier::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "entry")
    {
        entry.yfilter = yfilter;
...
bool Evpn::Nodes::Node::Igmps::Igmp::EthernetSegmentIdentifier::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "entry")
        return true;
    return false;
...
Evpn::Nodes::Node::Igmps::Igmp::NextHop::NextHop()
    :
    next_hop{YType::str, "next-hop"},
    ...
    df_pref{YType::uint16, "df-pref"}
{
    ...
    yang_name = "next-hop"; yang_parent_name = "igmp"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::Igmps::Igmp::NextHop::has_data() const
{
    if (is_presence_container) return true;
    return next_hop.is_set
...
bool Evpn::Nodes::Node::Igmps::Igmp::NextHop::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(next_hop.yfilter)
...
std::string Evpn::Nodes::Node::Igmps::Igmp::NextHop::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Igmps::Igmp::NextHop::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Igmps::Igmp::NextHop::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Igmps::Igmp::NextHop::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::Igmps::Igmp::NextHop::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "next-hop")
    {
        next_hop = value;
...
void Evpn::Nodes::Node::Igmps::Igmp::NextHop::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "next-hop")
    {
        next_hop.yfilter = yfilter;
...
bool Evpn::Nodes::Node::Igmps::Igmp::NextHop::has_leaf_or_child_of_name(const std::string & name) const
{
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Evis::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "evi")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::Evis::Evi>();
        ent_->parent = this;
        evi.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Evis::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Evis::Evi::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Evis::Evi::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Summary::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Summary::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(elements != nullptr)
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "element")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EviDetail::Elements::Element>();
        ent_->parent = this;
        element.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
Evpn::Nodes::Node::EviDetail::Elements::Element::Element()
    ...
    multicast_source_connected{YType::boolean, "multicast-source-connected"}
        ,
    evpn_instance(std::make_shared<Evpn::Nodes::Node::EviDetail::Elements::Element::EvpnInstance>())
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(evpn_instance != nullptr)
...
Evpn::Nodes::Node::EviDetail::Elements::Element::EvpnInstance::EvpnInstance()
    :
    ethernet_vpn_id{YType::uint32, "ethernet-vpn-id"},
    encapsulation_xr{YType::uint8, "encapsulation-xr"},
    bd_name{YType::str, "bd-name"},
    type{YType::enumeration, "type"}
{
    ...
    yang_name = "evpn-instance"; yang_parent_name = "element"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::EviDetail::Elements::Element::EvpnInstance::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::EviDetail::Elements::Element::EvpnInstance::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(ethernet_vpn_id.yfilter)
	|| ydk::is_set(encapsulation_xr.yfilter)
...
std::string Evpn::Nodes::Node::EviDetail::Elements::Element::EvpnInstance::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::EviDetail::Elements::Element::EvpnInstance::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::EvpnInstance::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::EvpnInstance::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::EviDetail::Elements::Element::EvpnInstance::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id = value;
...
void Evpn::Nodes::Node::EviDetail::Elements::Element::EvpnInstance::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id.yfilter = yfilter;
...
bool Evpn::Nodes::Node::EviDetail::Elements::Element::EvpnInstance::has_leaf_or_child_of_name(const std::string & name) const
{
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::FlowLabel::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::FlowLabel::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::RdAuto::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::RdAuto::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(auto_ != nullptr)
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::RdAuto::Auto::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::RdAuto::Auto::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::RdAuto::TwoByteAs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::RdAuto::TwoByteAs::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::RdAuto::FourByteAs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::RdAuto::FourByteAs::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::RdAuto::V4Addr::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::RdAuto::V4Addr::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::RdConfigured::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "auto")
    {
        if(auto_ == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::RdConfigured::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(auto_ != nullptr)
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::RdConfigured::Auto::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::RdConfigured::Auto::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::RdConfigured::TwoByteAs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::RdConfigured::TwoByteAs::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::RdConfigured::FourByteAs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::RdConfigured::FourByteAs::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::RdConfigured::V4Addr::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::RdConfigured::V4Addr::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::RtAuto::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "two-byte-as")
    {
        if(two_byte_as == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::RtAuto::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(two_byte_as != nullptr)
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::RtAuto::TwoByteAs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::RtAuto::TwoByteAs::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::RtAuto::FourByteAs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::RtAuto::FourByteAs::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::RtAuto::V4Addr::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::RtAuto::V4Addr::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::Elements::Element::RtAuto::EsImport::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::Elements::Element::RtAuto::EsImport::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(neighbors != nullptr)
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "neighbor")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::Neighbor>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::Neighbor::Neighbor()
    ...
    neighbor{YType::str, "neighbor"}
        ,
    evpn_instance(std::make_shared<Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::Neighbor::EvpnInstance>())
{
    evpn_instance->parent = this;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::Neighbor::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "evpn-instance")
    {
        if(evpn_instance == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::Neighbor::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(evpn_instance != nullptr)
...
Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::Neighbor::EvpnInstance::EvpnInstance()
    :
    ethernet_vpn_id{YType::uint32, "ethernet-vpn-id"},
    encapsulation_xr{YType::uint8, "encapsulation-xr"},
    bd_name{YType::str, "bd-name"},
    type{YType::enumeration, "type"}
{
    ...
    yang_name = "evpn-instance"; yang_parent_name = "neighbor"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::Neighbor::EvpnInstance::has_data() const
{
    if (is_presence_container) return true;
    return ethernet_vpn_id.is_set
	|| encapsulation_xr.is_set
...
bool Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::Neighbor::EvpnInstance::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(ethernet_vpn_id.yfilter)
	|| ydk::is_set(encapsulation_xr.yfilter)
...
std::string Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::Neighbor::EvpnInstance::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "evpn-instance";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::Neighbor::EvpnInstance::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::Neighbor::EvpnInstance::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::Neighbor::EvpnInstance::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::Neighbor::EvpnInstance::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id = value;
...
void Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::Neighbor::EvpnInstance::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id.yfilter = yfilter;
...
bool Evpn::Nodes::Node::EviDetail::EviChildren::Neighbors::Neighbor::EvpnInstance::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ethernet-vpn-id" || name == "encapsulation-xr" || name == "bd-name" || name == "type")
        return true;
    return false;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "ethernet-auto-discovery")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::EthernetAutoDiscovery()
    ...
    num_paths{YType::uint32, "num-paths"}
        ,
    evpn_instance(std::make_shared<Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::EvpnInstance>())
    , ethernet_segment_identifier(this, {})
    , path_buffer(this, {})
{
    evpn_instance->parent = this;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "evpn-instance")
    {
        if(evpn_instance == nullptr)
    ...
    if(child_yang_name == "ethernet-segment-identifier")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::EthernetSegmentIdentifier>();
        ent_->parent = this;
        ethernet_segment_identifier.append(ent_);
        return ent_;
    }
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::PathBuffer>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(evpn_instance != nullptr)
...
Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::EvpnInstance::EvpnInstance()
    :
    ethernet_vpn_id{YType::uint32, "ethernet-vpn-id"},
    encapsulation_xr{YType::uint8, "encapsulation-xr"},
    bd_name{YType::str, "bd-name"},
    type{YType::enumeration, "type"}
{
    ...
    yang_name = "evpn-instance"; yang_parent_name = "ethernet-auto-discovery"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::EvpnInstance::has_data() const
{
    if (is_presence_container) return true;
    return ethernet_vpn_id.is_set
	|| encapsulation_xr.is_set
...
bool Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::EvpnInstance::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(ethernet_vpn_id.yfilter)
	|| ydk::is_set(encapsulation_xr.yfilter)
...
std::string Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::EvpnInstance::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "evpn-instance";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::EvpnInstance::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::EvpnInstance::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::EvpnInstance::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::EvpnInstance::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id = value;
...
void Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::EvpnInstance::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id.yfilter = yfilter;
...
bool Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::EvpnInstance::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ethernet-vpn-id" || name == "encapsulation-xr" || name == "bd-name" || name == "type")
        return true;
    return false;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::EthernetSegmentIdentifier::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::EthernetSegmentIdentifier::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::PathBuffer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::EthernetAutoDiscoveries::EthernetAutoDiscovery::PathBuffer::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "inclusive-multicast")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::InclusiveMulticast>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::InclusiveMulticast::InclusiveMulticast()
    ...
    srte_policy{YType::str, "srte-policy"}
        ,
    evpn_instance(std::make_shared<Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::InclusiveMulticast::EvpnInstance>())
{
    evpn_instance->parent = this;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::InclusiveMulticast::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "evpn-instance")
    {
        if(evpn_instance == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::InclusiveMulticast::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(evpn_instance != nullptr)
...
Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::InclusiveMulticast::EvpnInstance::EvpnInstance()
    :
    ethernet_vpn_id{YType::uint32, "ethernet-vpn-id"},
    encapsulation_xr{YType::uint8, "encapsulation-xr"},
    bd_name{YType::str, "bd-name"},
    type{YType::enumeration, "type"}
{
    ...
    yang_name = "evpn-instance"; yang_parent_name = "inclusive-multicast"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::InclusiveMulticast::EvpnInstance::has_data() const
{
    if (is_presence_container) return true;
    return ethernet_vpn_id.is_set
	|| encapsulation_xr.is_set
...
bool Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::InclusiveMulticast::EvpnInstance::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(ethernet_vpn_id.yfilter)
	|| ydk::is_set(encapsulation_xr.yfilter)
...
std::string Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::InclusiveMulticast::EvpnInstance::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "evpn-instance";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::InclusiveMulticast::EvpnInstance::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::InclusiveMulticast::EvpnInstance::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::InclusiveMulticast::EvpnInstance::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::InclusiveMulticast::EvpnInstance::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id = value;
...
void Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::InclusiveMulticast::EvpnInstance::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id.yfilter = yfilter;
...
bool Evpn::Nodes::Node::EviDetail::EviChildren::InclusiveMulticasts::InclusiveMulticast::EvpnInstance::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ethernet-vpn-id" || name == "encapsulation-xr" || name == "bd-name" || name == "type")
        return true;
    return false;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "route-target")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::RouteTarget()
    ...
    route_target_stitching{YType::boolean, "route-target-stitching"}
        ,
    evpn_instance(std::make_shared<Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::EvpnInstance>())
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "evpn-instance")
    {
        if(evpn_instance == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(evpn_instance != nullptr)
...
Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::EvpnInstance::EvpnInstance()
    :
    ethernet_vpn_id{YType::uint32, "ethernet-vpn-id"},
    encapsulation_xr{YType::uint8, "encapsulation-xr"},
    bd_name{YType::str, "bd-name"},
    type{YType::enumeration, "type"}
{
    ...
    yang_name = "evpn-instance"; yang_parent_name = "route-target"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::EvpnInstance::has_data() const
{
    if (is_presence_container) return true;
    return ethernet_vpn_id.is_set
	|| encapsulation_xr.is_set
...
bool Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::EvpnInstance::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(ethernet_vpn_id.yfilter)
	|| ydk::is_set(encapsulation_xr.yfilter)
...
std::string Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::EvpnInstance::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "evpn-instance";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::EvpnInstance::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::EvpnInstance::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::EvpnInstance::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::EvpnInstance::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id = value;
...
void Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::EvpnInstance::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id.yfilter = yfilter;
...
bool Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::EvpnInstance::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ethernet-vpn-id" || name == "encapsulation-xr" || name == "bd-name" || name == "type")
        return true;
    return false;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::RouteTarget_::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "two-byte-as")
    {
        if(two_byte_as == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::RouteTarget_::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(two_byte_as != nullptr)
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::RouteTarget_::TwoByteAs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::RouteTarget_::TwoByteAs::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::RouteTarget_::FourByteAs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::RouteTarget_::FourByteAs::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::RouteTarget_::V4Addr::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::RouteTarget_::V4Addr::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::RouteTarget_::EsImport::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::RouteTargets::RouteTarget::RouteTarget_::EsImport::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::Macs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "mac")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac>();
        ent_->parent = this;
        mac.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::Macs::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::Mac()
    ...
    remote_is_static{YType::boolean, "remote-is-static"}
        ,
    evpn_instance(std::make_shared<Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::EvpnInstance>())
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "evpn-instance")
    {
        if(evpn_instance == nullptr)
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::LocalEthernetSegmentIdentifier>();
        ent_->parent = this;
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::RemoteEthernetSegmentIdentifier>();
        ent_->parent = this;
    ...
    if(child_yang_name == "path-buffer")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::PathBuffer>();
        ent_->parent = this;
        path_buffer.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(evpn_instance != nullptr)
...
Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::EvpnInstance::EvpnInstance()
    :
    ethernet_vpn_id{YType::uint32, "ethernet-vpn-id"},
    encapsulation_xr{YType::uint8, "encapsulation-xr"},
    bd_name{YType::str, "bd-name"},
    type{YType::enumeration, "type"}
{
    ...
    yang_name = "evpn-instance"; yang_parent_name = "mac"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::EvpnInstance::has_data() const
{
    if (is_presence_container) return true;
    return ethernet_vpn_id.is_set
	|| encapsulation_xr.is_set
...
bool Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::EvpnInstance::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(ethernet_vpn_id.yfilter)
	|| ydk::is_set(encapsulation_xr.yfilter)
...
std::string Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::EvpnInstance::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "evpn-instance";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::EvpnInstance::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::EvpnInstance::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::EvpnInstance::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::EvpnInstance::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id = value;
...
void Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::EvpnInstance::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id.yfilter = yfilter;
...
bool Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::EvpnInstance::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ethernet-vpn-id" || name == "encapsulation-xr" || name == "bd-name" || name == "type")
        return true;
    return false;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::LocalEthernetSegmentIdentifier::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::LocalEthernetSegmentIdentifier::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::RemoteEthernetSegmentIdentifier::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::RemoteEthernetSegmentIdentifier::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::PathBuffer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EviDetail::EviChildren::Macs::Mac::PathBuffer::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
Evpn::Nodes::Node::Teps::Teps()
    :
    tep(this, {"tep_id"})
{

    yang_name = "teps"; yang_parent_name = "node"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::Teps::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::Teps::has_operation() const
{
    for (std::size_t index=0; index<tep.len(); index++)
    {
...
std::string Evpn::Nodes::Node::Teps::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "teps";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Teps::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Teps::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "tep")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::Teps::Tep>();
        ent_->parent = this;
        tep.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Teps::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Nodes::Node::Teps::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Evpn::Nodes::Node::Teps::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Evpn::Nodes::Node::Teps::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "tep")
        return true;
    return false;
...
Evpn::Nodes::Node::Teps::Tep::Tep()
    ...
    udp_port{YType::uint16, "udp-port"}
        ,
    local_info(std::make_shared<Evpn::Nodes::Node::Teps::Tep::LocalInfo>())
    , remote_info(std::make_shared<Evpn::Nodes::Node::Teps::Tep::RemoteInfo>())
{
    local_info->parent = this;
    remote_info->parent = this;

    yang_name = "tep"; yang_parent_name = "teps"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::Teps::Tep::has_data() const
{
    if (is_presence_container) return true;
...
bool Evpn::Nodes::Node::Teps::Tep::has_operation() const
{
    return is_set(yfilter)
...
std::string Evpn::Nodes::Node::Teps::Tep::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "tep";
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Teps::Tep::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Teps::Tep::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "local-info")
    {
        if(local_info == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Teps::Tep::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(local_info != nullptr)
...
void Evpn::Nodes::Node::Teps::Tep::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Evpn::Nodes::Node::Teps::Tep::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "tep-id")
    {
...
bool Evpn::Nodes::Node::Teps::Tep::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::Teps::Tep::LocalInfo::LocalInfo()
    :
    ethernet_vpn_id{YType::uint32, "ethernet-vpn-id"},
...
bool Evpn::Nodes::Node::Teps::Tep::LocalInfo::has_data() const
{
    if (is_presence_container) return true;
    return ethernet_vpn_id.is_set
	|| encapsulation.is_set
...
bool Evpn::Nodes::Node::Teps::Tep::LocalInfo::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(ethernet_vpn_id.yfilter)
	|| ydk::is_set(encapsulation.yfilter)
...
std::string Evpn::Nodes::Node::Teps::Tep::LocalInfo::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "local-info";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Teps::Tep::LocalInfo::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Teps::Tep::LocalInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Teps::Tep::LocalInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::Teps::Tep::LocalInfo::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id = value;
...
void Evpn::Nodes::Node::Teps::Tep::LocalInfo::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id.yfilter = yfilter;
...
bool Evpn::Nodes::Node::Teps::Tep::LocalInfo::has_leaf_or_child_of_name(const std::string & name) const
{
...
Evpn::Nodes::Node::Teps::Tep::RemoteInfo::RemoteInfo()
    :
    ethernet_vpn_id{YType::uint32, "ethernet-vpn-id"},
    encapsulation{YType::uint8, "encapsulation"},
    ip{YType::str, "ip"}
...
bool Evpn::Nodes::Node::Teps::Tep::RemoteInfo::has_data() const
{
    if (is_presence_container) return true;
    return ethernet_vpn_id.is_set
	|| encapsulation.is_set
...
bool Evpn::Nodes::Node::Teps::Tep::RemoteInfo::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(ethernet_vpn_id.yfilter)
	|| ydk::is_set(encapsulation.yfilter)
...
std::string Evpn::Nodes::Node::Teps::Tep::RemoteInfo::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::Teps::Tep::RemoteInfo::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::Teps::Tep::RemoteInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::Teps::Tep::RemoteInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::Teps::Tep::RemoteInfo::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id = value;
...
void Evpn::Nodes::Node::Teps::Tep::RemoteInfo::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id.yfilter = yfilter;
...
bool Evpn::Nodes::Node::Teps::Tep::RemoteInfo::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ethernet-vpn-id" || name == "encapsulation" || name == "ip")
        return true;
    return false;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::InternalLabels::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "internal-label")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::InternalLabels::InternalLabel>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::InternalLabels::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
Evpn::Nodes::Node::InternalLabels::InternalLabel::InternalLabel()
    ...
    redundancy_single_flow_active{YType::boolean, "redundancy-single-flow-active"}
        ,
    evpn_instance(std::make_shared<Evpn::Nodes::Node::InternalLabels::InternalLabel::EvpnInstance>())
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::InternalLabels::InternalLabel::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "evpn-instance")
    {
        if(evpn_instance == nullptr)
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::InternalLabels::InternalLabel::MacPathBuffer>();
        ent_->parent = this;
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::InternalLabels::InternalLabel::EadPathBuffer>();
        ent_->parent = this;
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::InternalLabels::InternalLabel::EviPathBuffer>();
        ent_->parent = this;
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::InternalLabels::InternalLabel::SummaryPathBuffer>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::InternalLabels::InternalLabel::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(evpn_instance != nullptr)
...
Evpn::Nodes::Node::InternalLabels::InternalLabel::EvpnInstance::EvpnInstance()
    :
    ethernet_vpn_id{YType::uint32, "ethernet-vpn-id"},
    encapsulation_xr{YType::uint8, "encapsulation-xr"},
    bd_name{YType::str, "bd-name"},
    type{YType::enumeration, "type"}
{
    ...
    yang_name = "evpn-instance"; yang_parent_name = "internal-label"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::InternalLabels::InternalLabel::EvpnInstance::has_data() const
{
    if (is_presence_container) return true;
    return ethernet_vpn_id.is_set
	|| encapsulation_xr.is_set
...
bool Evpn::Nodes::Node::InternalLabels::InternalLabel::EvpnInstance::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(ethernet_vpn_id.yfilter)
	|| ydk::is_set(encapsulation_xr.yfilter)
...
std::string Evpn::Nodes::Node::InternalLabels::InternalLabel::EvpnInstance::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "evpn-instance";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::InternalLabels::InternalLabel::EvpnInstance::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::InternalLabels::InternalLabel::EvpnInstance::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::InternalLabels::InternalLabel::EvpnInstance::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::InternalLabels::InternalLabel::EvpnInstance::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id = value;
...
void Evpn::Nodes::Node::InternalLabels::InternalLabel::EvpnInstance::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id.yfilter = yfilter;
...
bool Evpn::Nodes::Node::InternalLabels::InternalLabel::EvpnInstance::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ethernet-vpn-id" || name == "encapsulation-xr" || name == "bd-name" || name == "type")
        return true;
    return false;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::InternalLabels::InternalLabel::MacPathBuffer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::InternalLabels::InternalLabel::MacPathBuffer::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::InternalLabels::InternalLabel::EadPathBuffer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::InternalLabels::InternalLabel::EadPathBuffer::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::InternalLabels::InternalLabel::EviPathBuffer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::InternalLabels::InternalLabel::EviPathBuffer::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::InternalLabels::InternalLabel::SummaryPathBuffer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::InternalLabels::InternalLabel::SummaryPathBuffer::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EthernetSegments::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "ethernet-segment")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EthernetSegments::EthernetSegment>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EthernetSegments::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "ethernet-segment-identifier")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EthernetSegments::EthernetSegment::EthernetSegmentIdentifier>();
        ent_->parent = this;
        ethernet_segment_identifier.append(ent_);
        return ent_;
    }
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EthernetSegments::EthernetSegment::PrimaryService>();
        ent_->parent = this;
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EthernetSegments::EthernetSegment::SecondaryService>();
        ent_->parent = this;
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingISidelectedResult>();
        ent_->parent = this;
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingIsidNotElectedResult>();
        ent_->parent = this;
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingEviElectedResult>();
        ent_->parent = this;
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingEviNotElectedResult>();
        ent_->parent = this;
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniElectedResult>();
        ent_->parent = this;
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniNotElectedResult>();
        ent_->parent = this;
    ...
    if(child_yang_name == "next-hop")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EthernetSegments::EthernetSegment::NextHop>();
        ent_->parent = this;
        next_hop.append(ent_);
        return ent_;
    }
    ...
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVpwsPermanentResult>();
        ent_->parent = this;
    ...
    if(child_yang_name == "remote-split-horizon-group-label")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::EthernetSegments::EthernetSegment::RemoteSplitHorizonGroupLabel>();
        ent_->parent = this;
        remote_split_horizon_group_label.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::EthernetSegmentIdentifier::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::EthernetSegmentIdentifier::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::PrimaryService::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::PrimaryService::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::SecondaryService::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::SecondaryService::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingISidelectedResult::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingISidelectedResult::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingIsidNotElectedResult::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingIsidNotElectedResult::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingEviElectedResult::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingEviElectedResult::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingEviNotElectedResult::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingEviNotElectedResult::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniElectedResult::ServiceCarvingVniElectedResult()
    :
    entry{YType::uint32, "entry"}
{

    yang_name = "service-carving-vni-elected-result"; yang_parent_name = "ethernet-segment"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniElectedResult::has_data() const
{
    if (is_presence_container) return true;
    return entry.is_set;
}

bool Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniElectedResult::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(entry.yfilter);
}

std::string Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniElectedResult::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniElectedResult::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniElectedResult::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniElectedResult::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniElectedResult::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "entry")
    {
        entry = value;
...
void Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniElectedResult::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "entry")
    {
        entry.yfilter = yfilter;
...
bool Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniElectedResult::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "entry")
        return true;
    return false;
...
Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniNotElectedResult::ServiceCarvingVniNotElectedResult()
    :
    entry{YType::uint32, "entry"}
{

    yang_name = "service-carving-vni-not-elected-result"; yang_parent_name = "ethernet-segment"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniNotElectedResult::has_data() const
{
    if (is_presence_container) return true;
    return entry.is_set;
}

bool Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniNotElectedResult::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(entry.yfilter);
}

std::string Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniNotElectedResult::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniNotElectedResult::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniNotElectedResult::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniNotElectedResult::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniNotElectedResult::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "entry")
    {
        entry = value;
...
void Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniNotElectedResult::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "entry")
    {
        entry.yfilter = yfilter;
...
bool Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVniNotElectedResult::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "entry")
        return true;
    return false;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::NextHop::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::NextHop::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVpwsPermanentResult::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::ServiceCarvingVpwsPermanentResult::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::RemoteSplitHorizonGroupLabel::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::EthernetSegments::EthernetSegment::RemoteSplitHorizonGroupLabel::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::AcIds::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "ac-id")
    {
        auto ent_ = std::make_shared<Evpn::Nodes::Node::AcIds::AcId>();
        ent_->parent = this;
        ac_id.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::AcIds::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
Evpn::Nodes::Node::AcIds::AcId::AcId()
    ...
    neighbor{YType::str, "neighbor"}
        ,
    evpn_instance(std::make_shared<Evpn::Nodes::Node::AcIds::AcId::EvpnInstance>())
{
    evpn_instance->parent = this;
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::AcIds::AcId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "evpn-instance")
    {
        if(evpn_instance == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::AcIds::AcId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(evpn_instance != nullptr)
...
Evpn::Nodes::Node::AcIds::AcId::EvpnInstance::EvpnInstance()
    :
    ethernet_vpn_id{YType::uint32, "ethernet-vpn-id"},
    encapsulation_xr{YType::uint8, "encapsulation-xr"},
    bd_name{YType::str, "bd-name"},
    type{YType::enumeration, "type"}
{
    ...
    yang_name = "evpn-instance"; yang_parent_name = "ac-id"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Evpn::Nodes::Node::AcIds::AcId::EvpnInstance::has_data() const
{
    if (is_presence_container) return true;
    return ethernet_vpn_id.is_set
	|| encapsulation_xr.is_set
...
bool Evpn::Nodes::Node::AcIds::AcId::EvpnInstance::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(ethernet_vpn_id.yfilter)
	|| ydk::is_set(encapsulation_xr.yfilter)
...
std::string Evpn::Nodes::Node::AcIds::AcId::EvpnInstance::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "evpn-instance";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Nodes::Node::AcIds::AcId::EvpnInstance::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Nodes::Node::AcIds::AcId::EvpnInstance::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Nodes::Node::AcIds::AcId::EvpnInstance::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Nodes::Node::AcIds::AcId::EvpnInstance::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id = value;
...
void Evpn::Nodes::Node::AcIds::AcId::EvpnInstance::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id.yfilter = yfilter;
...
bool Evpn::Nodes::Node::AcIds::AcId::EvpnInstance::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ethernet-vpn-id" || name == "encapsulation-xr" || name == "bd-name" || name == "type")
        return true;
    return false;
...
Evpn::Active::Active()
    :
    evpn_groups(std::make_shared<Evpn::Active::EvpnGroups>())
    , remote_shgs(std::make_shared<Evpn::Active::RemoteShgs>())
    , client(std::make_shared<Evpn::Active::Client>())
    , igmps(std::make_shared<Evpn::Active::Igmps>())
    ...
    , teps(std::make_shared<Evpn::Active::Teps>())
...
std::shared_ptr<ydk::Entity> Evpn::Active::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "evpn-groups")
    {
        if(evpn_groups == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(evpn_groups != nullptr)
...
Evpn::Active::EvpnGroups::EvpnGroups()
    :
    evpn_group(this, {"group_number"})
{

    yang_name = "evpn-groups"; yang_parent_name = "active"; is_top_level_class = false; has_list_ancestor = false; 
}
...
bool Evpn::Active::EvpnGroups::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<evpn_group.len(); index++)
    {
...
bool Evpn::Active::EvpnGroups::has_operation() const
{
    for (std::size_t index=0; index<evpn_group.len(); index++)
    {
        if(evpn_group[index]->has_operation())
...
std::string Evpn::Active::EvpnGroups::get_absolute_path() const
{
    std::ostringstream path_buffer;
...
std::string Evpn::Active::EvpnGroups::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "evpn-groups";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::EvpnGroups::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::EvpnGroups::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "evpn-group")
    {
        auto ent_ = std::make_shared<Evpn::Active::EvpnGroups::EvpnGroup>();
        ent_->parent = this;
        evpn_group.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::EvpnGroups::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Active::EvpnGroups::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Evpn::Active::EvpnGroups::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Evpn::Active::EvpnGroups::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "evpn-group")
        return true;
    return false;
...
Evpn::Active::EvpnGroups::EvpnGroup::EvpnGroup()
    :
    group_number{YType::uint32, "group-number"},
    group_id{YType::uint32, "group-id"},
    state{YType::enumeration, "state"}
...
bool Evpn::Active::EvpnGroups::EvpnGroup::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<core_interface.len(); index++)
    {
...
bool Evpn::Active::EvpnGroups::EvpnGroup::has_operation() const
{
    for (std::size_t index=0; index<core_interface.len(); index++)
    {
        if(core_interface[index]->has_operation())
...
std::string Evpn::Active::EvpnGroups::EvpnGroup::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/evpn-groups/" << get_segment_path();
    return path_buffer.str();
}

std::string Evpn::Active::EvpnGroups::EvpnGroup::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "evpn-group";
    ADD_KEY_TOKEN(group_number, "group-number");
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::EvpnGroups::EvpnGroup::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::EvpnGroups::EvpnGroup::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "core-interface")
    {
        auto ent_ = std::make_shared<Evpn::Active::EvpnGroups::EvpnGroup::CoreInterface>();
        ent_->parent = this;
        core_interface.append(ent_);
        return ent_;
    }
    ...
    if(child_yang_name == "access-interface")
    {
        auto ent_ = std::make_shared<Evpn::Active::EvpnGroups::EvpnGroup::AccessInterface>();
        ent_->parent = this;
        access_interface.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::EvpnGroups::EvpnGroup::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Active::EvpnGroups::EvpnGroup::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "group-number")
    {
        group_number = value;
...
void Evpn::Active::EvpnGroups::EvpnGroup::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "group-number")
    {
        group_number.yfilter = yfilter;
...
bool Evpn::Active::EvpnGroups::EvpnGroup::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "core-interface" || name == "access-interface" || name == "group-number" || name == "group-id" || name == "state")
        return true;
    return false;
...
Evpn::Active::EvpnGroups::EvpnGroup::CoreInterface::CoreInterface()
    :
    interface_name{YType::str, "interface-name"},
    state{YType::enumeration, "state"}
{
...
bool Evpn::Active::EvpnGroups::EvpnGroup::CoreInterface::has_data() const
{
    if (is_presence_container) return true;
    return interface_name.is_set
	|| state.is_set;
...
bool Evpn::Active::EvpnGroups::EvpnGroup::CoreInterface::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(interface_name.yfilter)
	|| ydk::is_set(state.yfilter);
...
std::string Evpn::Active::EvpnGroups::EvpnGroup::CoreInterface::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "core-interface";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::EvpnGroups::EvpnGroup::CoreInterface::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::EvpnGroups::EvpnGroup::CoreInterface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::EvpnGroups::EvpnGroup::CoreInterface::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Active::EvpnGroups::EvpnGroup::CoreInterface::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "interface-name")
    {
        interface_name = value;
...
void Evpn::Active::EvpnGroups::EvpnGroup::CoreInterface::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "interface-name")
    {
        interface_name.yfilter = yfilter;
...
bool Evpn::Active::EvpnGroups::EvpnGroup::CoreInterface::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "interface-name" || name == "state")
        return true;
    return false;
...
Evpn::Active::EvpnGroups::EvpnGroup::AccessInterface::AccessInterface()
    :
    interface_name{YType::str, "interface-name"},
    state{YType::enumeration, "state"}
{
...
bool Evpn::Active::EvpnGroups::EvpnGroup::AccessInterface::has_data() const
{
    if (is_presence_container) return true;
    return interface_name.is_set
	|| state.is_set;
...
bool Evpn::Active::EvpnGroups::EvpnGroup::AccessInterface::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(interface_name.yfilter)
	|| ydk::is_set(state.yfilter);
...
std::string Evpn::Active::EvpnGroups::EvpnGroup::AccessInterface::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "access-interface";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::EvpnGroups::EvpnGroup::AccessInterface::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::EvpnGroups::EvpnGroup::AccessInterface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::EvpnGroups::EvpnGroup::AccessInterface::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Active::EvpnGroups::EvpnGroup::AccessInterface::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "interface-name")
    {
        interface_name = value;
...
void Evpn::Active::EvpnGroups::EvpnGroup::AccessInterface::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "interface-name")
    {
        interface_name.yfilter = yfilter;
...
bool Evpn::Active::EvpnGroups::EvpnGroup::AccessInterface::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "interface-name" || name == "state")
        return true;
    return false;
...
Evpn::Active::RemoteShgs::RemoteShgs()
    :
    remote_shg(this, {})
{

    yang_name = "remote-shgs"; yang_parent_name = "active"; is_top_level_class = false; has_list_ancestor = false; 
}
...
bool Evpn::Active::RemoteShgs::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<remote_shg.len(); index++)
    {
...
bool Evpn::Active::RemoteShgs::has_operation() const
{
    for (std::size_t index=0; index<remote_shg.len(); index++)
    {
        if(remote_shg[index]->has_operation())
...
std::string Evpn::Active::RemoteShgs::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/" << get_segment_path();
    return path_buffer.str();
...
std::string Evpn::Active::RemoteShgs::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "remote-shgs";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::RemoteShgs::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::RemoteShgs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "remote-shg")
    {
        auto ent_ = std::make_shared<Evpn::Active::RemoteShgs::RemoteShg>();
        ent_->parent = this;
        remote_shg.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::RemoteShgs::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Active::RemoteShgs::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Evpn::Active::RemoteShgs::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Evpn::Active::RemoteShgs::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "remote-shg")
        return true;
    return false;
...
Evpn::Active::RemoteShgs::RemoteShg::RemoteShg()
    :
    esi1{YType::str, "esi1"},
    esi2{YType::str, "esi2"},
    esi3{YType::str, "esi3"},
...
bool Evpn::Active::RemoteShgs::RemoteShg::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<ethernet_segment_identifier.len(); index++)
    {
...
bool Evpn::Active::RemoteShgs::RemoteShg::has_operation() const
{
    for (std::size_t index=0; index<ethernet_segment_identifier.len(); index++)
    {
        if(ethernet_segment_identifier[index]->has_operation())
...
std::string Evpn::Active::RemoteShgs::RemoteShg::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/remote-shgs/" << get_segment_path();
    return path_buffer.str();
}

std::string Evpn::Active::RemoteShgs::RemoteShg::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "remote-shg";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::RemoteShgs::RemoteShg::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::RemoteShgs::RemoteShg::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "ethernet-segment-identifier")
    {
        auto ent_ = std::make_shared<Evpn::Active::RemoteShgs::RemoteShg::EthernetSegmentIdentifier>();
        ent_->parent = this;
        ethernet_segment_identifier.append(ent_);
        return ent_;
    }
    ...
    if(child_yang_name == "remote-split-horizon-group-label")
    {
        auto ent_ = std::make_shared<Evpn::Active::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel>();
        ent_->parent = this;
        remote_split_horizon_group_label.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::RemoteShgs::RemoteShg::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Active::RemoteShgs::RemoteShg::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "esi1")
    {
        esi1 = value;
...
void Evpn::Active::RemoteShgs::RemoteShg::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "esi1")
    {
        esi1.yfilter = yfilter;
...
bool Evpn::Active::RemoteShgs::RemoteShg::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ethernet-segment-identifier" || name == "remote-split-horizon-group-label" || name == "esi1" || name == "esi2" || name == "esi3" || name == "esi4" || name == "esi5")
        return true;
    return false;
...
Evpn::Active::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::EthernetSegmentIdentifier()
    :
    entry{YType::uint8, "entry"}
{
...
bool Evpn::Active::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::has_data() const
{
    if (is_presence_container) return true;
    return entry.is_set;
}

bool Evpn::Active::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(entry.yfilter);
}

std::string Evpn::Active::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/remote-shgs/remote-shg/" << get_segment_path();
    return path_buffer.str();
}

std::string Evpn::Active::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "ethernet-segment-identifier";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Active::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "entry")
    {
        entry = value;
...
void Evpn::Active::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "entry")
    {
        entry.yfilter = yfilter;
...
bool Evpn::Active::RemoteShgs::RemoteShg::EthernetSegmentIdentifier::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "entry")
        return true;
    return false;
...
Evpn::Active::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::RemoteSplitHorizonGroupLabel()
    :
    next_hop{YType::str, "next-hop"},
    label{YType::uint32, "label"}
{
...
bool Evpn::Active::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::has_data() const
{
    if (is_presence_container) return true;
    return next_hop.is_set
	|| label.is_set;
...
bool Evpn::Active::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(next_hop.yfilter)
	|| ydk::is_set(label.yfilter);
...
std::string Evpn::Active::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/remote-shgs/remote-shg/" << get_segment_path();
    return path_buffer.str();
...
std::string Evpn::Active::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "remote-split-horizon-group-label";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Active::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "next-hop")
    {
        next_hop = value;
...
void Evpn::Active::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "next-hop")
    {
        next_hop.yfilter = yfilter;
...
bool Evpn::Active::RemoteShgs::RemoteShg::RemoteSplitHorizonGroupLabel::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "next-hop" || name == "label")
        return true;
    return false;
...
Evpn::Active::Client::Client()
{

    yang_name = "client"; yang_parent_name = "active"; is_top_level_class = false; has_list_ancestor = false; 
}
...
bool Evpn::Active::Client::has_data() const
{
    if (is_presence_container) return true;
    return false;
}

bool Evpn::Active::Client::has_operation() const
{
    return is_set(yfilter);
}

std::string Evpn::Active::Client::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/" << get_segment_path();
    return path_buffer.str();
...
std::string Evpn::Active::Client::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "client";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Client::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Client::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Client::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Active::Client::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Evpn::Active::Client::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Evpn::Active::Client::has_leaf_or_child_of_name(const std::string & name) const
{
    return false;
}

Evpn::Active::Igmps::Igmps()
    :
    igmp(this, {})
{

    yang_name = "igmps"; yang_parent_name = "active"; is_top_level_class = false; has_list_ancestor = false; 
}
...
bool Evpn::Active::Igmps::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<igmp.len(); index++)
    {
...
bool Evpn::Active::Igmps::has_operation() const
{
    for (std::size_t index=0; index<igmp.len(); index++)
    {
        if(igmp[index]->has_operation())
...
std::string Evpn::Active::Igmps::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/" << get_segment_path();
    return path_buffer.str();
...
std::string Evpn::Active::Igmps::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "igmps";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "igmp")
    {
        auto ent_ = std::make_shared<Evpn::Active::Igmps::Igmp>();
        ent_->parent = this;
        igmp.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Active::Igmps::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Evpn::Active::Igmps::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Evpn::Active::Igmps::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "igmp")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::Igmp()
    ...
    resolved{YType::boolean, "resolved"}
        ,
    source_info(std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo>())
    , ethernet_segment_identifier(this, {})
    , next_hop(this, {})
{
    source_info->parent = this;
...
bool Evpn::Active::Igmps::Igmp::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<ethernet_segment_identifier.len(); index++)
    {
...
bool Evpn::Active::Igmps::Igmp::has_operation() const
{
    for (std::size_t index=0; index<ethernet_segment_identifier.len(); index++)
    {
        if(ethernet_segment_identifier[index]->has_operation())
...
std::string Evpn::Active::Igmps::Igmp::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/" << get_segment_path();
    return path_buffer.str();
}

std::string Evpn::Active::Igmps::Igmp::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "igmp";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "source-info")
    {
        if(source_info == nullptr)
    ...
    if(child_yang_name == "ethernet-segment-identifier")
    {
        auto ent_ = std::make_shared<Evpn::Active::Igmps::Igmp::EthernetSegmentIdentifier>();
        ent_->parent = this;
        ethernet_segment_identifier.append(ent_);
        return ent_;
    }
    ...
    if(child_yang_name == "next-hop")
    {
        auto ent_ = std::make_shared<Evpn::Active::Igmps::Igmp::NextHop>();
        ent_->parent = this;
        next_hop.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(source_info != nullptr)
...
void Evpn::Active::Igmps::Igmp::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "is-leave")
    {
        is_leave = value;
...
void Evpn::Active::Igmps::Igmp::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "is-leave")
    {
        is_leave.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "source-info" || name == "ethernet-segment-identifier" || name == "next-hop" || name == "is-leave" || name == "bpxcid" || name == "evibd" || name == "src-ip" || name == "grp-ip" || name == "esi1" || name == "esi2" || name == "esi3" || name == "esi4" || name == "esi5" || name == "ethernet-segment-name" || name == "evi" || name == "bd-id" || name == "route-type" || name == "source-addr" || name == "group-addr" || name == "ethernet-tag-id" || name == "igmp-version" || name == "igmp-group-type" || name == "ma-x-response-time" || name == "resolved")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::SourceInfo()
    :
    type{YType::enumeration, "type"},
    remote_info{YType::str, "remote-info"}
        ,
    local_info(std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo>())
{
    local_info->parent = this;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::has_data() const
{
    if (is_presence_container) return true;
    return type.is_set
	|| remote_info.is_set
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(type.yfilter)
	|| ydk::is_set(remote_info.yfilter)
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/" << get_segment_path();
    return path_buffer.str();
}

std::string Evpn::Active::Igmps::Igmp::SourceInfo::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "source-info";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "local-info")
    {
        if(local_info == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(local_info != nullptr)
...
void Evpn::Active::Igmps::Igmp::SourceInfo::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "type")
    {
        type = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "type")
    {
        type.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "local-info" || name == "type" || name == "remote-info")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::LocalInfo()
    :
    name{YType::str, "name"},
    mtu{YType::uint32, "mtu"},
    payload_bytes{YType::uint16, "payload-bytes"}
        ,
    parameters(std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters>())
{
    parameters->parent = this;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::has_data() const
{
    if (is_presence_container) return true;
    return name.is_set
	|| mtu.is_set
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(name.yfilter)
	|| ydk::is_set(mtu.yfilter)
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/source-info/" << get_segment_path();
    return path_buffer.str();
}

std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "local-info";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "parameters")
    {
        if(parameters == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(parameters != nullptr)
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "name")
    {
        name = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "name")
    {
        name.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "parameters" || name == "name" || name == "mtu" || name == "payload-bytes")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Parameters()
    :
    type{YType::enumeration, "type"}
        ,
    ethernet(std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet>())
    , vlan(std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan>())
    , tdm(std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm>())
    , atm(std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm>())
    , fr(std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr>())
    , pseudowire_ether(std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther>())
    , pseudowire_iw(std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw>())
{
    ethernet->parent = this;
    vlan->parent = this;
    tdm->parent = this;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::has_data() const
{
    if (is_presence_container) return true;
    return type.is_set
	|| (ethernet !=  nullptr && ethernet->has_data())
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(type.yfilter)
	|| (ethernet !=  nullptr && ethernet->has_operation())
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/source-info/local-info/" << get_segment_path();
    return path_buffer.str();
}

std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "parameters";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "ethernet")
    {
        if(ethernet == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(ethernet != nullptr)
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "type")
    {
        type = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "type")
    {
        type.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ethernet" || name == "vlan" || name == "tdm" || name == "atm" || name == "fr" || name == "pseudowire-ether" || name == "pseudowire-iw" || name == "type")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::Ethernet()
    :
    xconnect_tags{YType::uint8, "xconnect-tags"}
{
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::has_data() const
{
    if (is_presence_container) return true;
    return xconnect_tags.is_set;
}

bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(xconnect_tags.yfilter);
}

std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/source-info/local-info/parameters/" << get_segment_path();
    return path_buffer.str();
}

std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "ethernet";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "xconnect-tags")
    {
        xconnect_tags = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "xconnect-tags")
    {
        xconnect_tags.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Ethernet::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "xconnect-tags")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::Vlan()
    :
    xconnect_tags{YType::uint8, "xconnect-tags"},
    vlan_rewrite_tag{YType::uint16, "vlan-rewrite-tag"},
    simple_efp{YType::uint8, "simple-efp"},
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<rewrite_tag.len(); index++)
    {
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::has_operation() const
{
    for (std::size_t index=0; index<rewrite_tag.len(); index++)
    {
        if(rewrite_tag[index]->has_operation())
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/source-info/local-info/parameters/" << get_segment_path();
    return path_buffer.str();
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "vlan";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "rewrite-tag")
    {
        auto ent_ = std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag>();
        ent_->parent = this;
        rewrite_tag.append(ent_);
        return ent_;
    }
    ...
    if(child_yang_name == "vlan-range")
    {
        auto ent_ = std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange>();
        ent_->parent = this;
        vlan_range.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "xconnect-tags")
    {
        xconnect_tags = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "xconnect-tags")
    {
        xconnect_tags.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "rewrite-tag" || name == "vlan-range" || name == "xconnect-tags" || name == "vlan-rewrite-tag" || name == "simple-efp" || name == "encapsulation-type" || name == "outer-tag")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::RewriteTag()
    :
    entry{YType::uint16, "entry"}
{
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::has_data() const
{
    if (is_presence_container) return true;
    return entry.is_set;
}

bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(entry.yfilter);
}

std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/source-info/local-info/parameters/vlan/" << get_segment_path();
    return path_buffer.str();
}

std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "rewrite-tag";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "entry")
    {
        entry = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "entry")
    {
        entry.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::RewriteTag::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "entry")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::VlanRange()
    :
    lower{YType::uint16, "lower"},
    upper{YType::uint16, "upper"}
{
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::has_data() const
{
    if (is_presence_container) return true;
    return lower.is_set
	|| upper.is_set;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(lower.yfilter)
	|| ydk::is_set(upper.yfilter);
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/source-info/local-info/parameters/vlan/" << get_segment_path();
    return path_buffer.str();
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "vlan-range";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "lower")
    {
        lower = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "lower")
    {
        lower.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Vlan::VlanRange::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "lower" || name == "upper")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::Tdm()
    :
    timeslot_group{YType::str, "timeslot-group"},
    timeslot_rate{YType::uint8, "timeslot-rate"},
    tdm_mode{YType::enumeration, "tdm-mode"}
        ,
    tdm_options(std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions>())
{
    tdm_options->parent = this;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::has_data() const
{
    if (is_presence_container) return true;
    return timeslot_group.is_set
	|| timeslot_rate.is_set
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(timeslot_group.yfilter)
	|| ydk::is_set(timeslot_rate.yfilter)
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/source-info/local-info/parameters/" << get_segment_path();
    return path_buffer.str();
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "tdm";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "tdm-options")
    {
        if(tdm_options == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(tdm_options != nullptr)
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "timeslot-group")
    {
        timeslot_group = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "timeslot-group")
    {
        timeslot_group.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "tdm-options" || name == "timeslot-group" || name == "timeslot-rate" || name == "tdm-mode")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::TdmOptions()
    :
    payload_bytes{YType::uint16, "payload-bytes"},
    bit_rate{YType::uint32, "bit-rate"},
    rtp{YType::enumeration, "rtp"},
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::has_data() const
{
    if (is_presence_container) return true;
    return payload_bytes.is_set
	|| bit_rate.is_set
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(payload_bytes.yfilter)
	|| ydk::is_set(bit_rate.yfilter)
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/source-info/local-info/parameters/tdm/" << get_segment_path();
    return path_buffer.str();
}

std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "tdm-options";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "payload-bytes")
    {
        payload_bytes = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "payload-bytes")
    {
        payload_bytes.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Tdm::TdmOptions::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "payload-bytes" || name == "bit-rate" || name == "rtp" || name == "timestamp-mode" || name == "signalling-packets" || name == "cas" || name == "rtp-header-payload-type" || name == "timestamp-clock-freq" || name == "ssrc")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::Atm()
    :
    maximum_number_cells_packed{YType::uint16, "maximum-number-cells-packed"},
    maximum_number_cells_un_packed{YType::uint16, "maximum-number-cells-un-packed"},
    atm_mode{YType::enumeration, "atm-mode"},
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::has_data() const
{
    if (is_presence_container) return true;
    return maximum_number_cells_packed.is_set
	|| maximum_number_cells_un_packed.is_set
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(maximum_number_cells_packed.yfilter)
	|| ydk::is_set(maximum_number_cells_un_packed.yfilter)
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/source-info/local-info/parameters/" << get_segment_path();
    return path_buffer.str();
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "atm";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "maximum-number-cells-packed")
    {
        maximum_number_cells_packed = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "maximum-number-cells-packed")
    {
        maximum_number_cells_packed.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Atm::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "maximum-number-cells-packed" || name == "maximum-number-cells-un-packed" || name == "atm-mode" || name == "vpi" || name == "vci")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::Fr()
    :
    fr_mode{YType::enumeration, "fr-mode"},
    dlci{YType::uint32, "dlci"}
{
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::has_data() const
{
    if (is_presence_container) return true;
    return fr_mode.is_set
	|| dlci.is_set;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(fr_mode.yfilter)
	|| ydk::is_set(dlci.yfilter);
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/source-info/local-info/parameters/" << get_segment_path();
    return path_buffer.str();
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "fr";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "fr-mode")
    {
        fr_mode = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "fr-mode")
    {
        fr_mode.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::Fr::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "fr-mode" || name == "dlci")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::PseudowireEther()
    :
    is_valid{YType::boolean, "is-valid"},
    internal_label{YType::uint32, "internal-label"}
        ,
    interface_list(std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList>())
{
    interface_list->parent = this;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::has_data() const
{
    if (is_presence_container) return true;
    return is_valid.is_set
	|| internal_label.is_set
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(is_valid.yfilter)
	|| ydk::is_set(internal_label.yfilter)
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/source-info/local-info/parameters/" << get_segment_path();
    return path_buffer.str();
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "pseudowire-ether";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "interface-list")
    {
        if(interface_list == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(interface_list != nullptr)
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "is-valid")
    {
        is_valid = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "is-valid")
    {
        is_valid.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "interface-list" || name == "is-valid" || name == "internal-label")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::InterfaceList()
    :
    interface_list_name{YType::str, "interface-list-name"},
    interface_list_id{YType::uint32, "interface-list-id"}
        ,
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<interface.len(); index++)
    {
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::has_operation() const
{
    for (std::size_t index=0; index<interface.len(); index++)
    {
        if(interface[index]->has_operation())
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/source-info/local-info/parameters/pseudowire-ether/" << get_segment_path();
    return path_buffer.str();
}

std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "interface-list";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "interface")
    {
        auto ent_ = std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface>();
        ent_->parent = this;
        interface.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "interface-list-name")
    {
        interface_list_name = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "interface-list-name")
    {
        interface_list_name.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "interface" || name == "interface-list-name" || name == "interface-list-id")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::Interface()
    :
    interface_name{YType::str, "interface-name"},
    replicate_status{YType::enumeration, "replicate-status"}
{
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::has_data() const
{
    if (is_presence_container) return true;
    return interface_name.is_set
	|| replicate_status.is_set;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(interface_name.yfilter)
	|| ydk::is_set(replicate_status.yfilter);
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/source-info/local-info/parameters/pseudowire-ether/interface-list/" << get_segment_path();
    return path_buffer.str();
}

std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "interface";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "interface-name")
    {
        interface_name = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "interface-name")
    {
        interface_name.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireEther::InterfaceList::Interface::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "interface-name" || name == "replicate-status")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::PseudowireIw()
    :
    is_valid{YType::boolean, "is-valid"},
    internal_label{YType::uint32, "internal-label"}
        ,
    interface_list(std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList>())
{
    interface_list->parent = this;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::has_data() const
{
    if (is_presence_container) return true;
    return is_valid.is_set
	|| internal_label.is_set
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(is_valid.yfilter)
	|| ydk::is_set(internal_label.yfilter)
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/source-info/local-info/parameters/" << get_segment_path();
    return path_buffer.str();
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "pseudowire-iw";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "interface-list")
    {
        if(interface_list == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(interface_list != nullptr)
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "is-valid")
    {
        is_valid = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "is-valid")
    {
        is_valid.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "interface-list" || name == "is-valid" || name == "internal-label")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::InterfaceList()
    :
    interface_list_name{YType::str, "interface-list-name"},
    interface_list_id{YType::uint32, "interface-list-id"}
        ,
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<interface.len(); index++)
    {
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::has_operation() const
{
    for (std::size_t index=0; index<interface.len(); index++)
    {
        if(interface[index]->has_operation())
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/source-info/local-info/parameters/pseudowire-iw/" << get_segment_path();
    return path_buffer.str();
}

std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "interface-list";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "interface")
    {
        auto ent_ = std::make_shared<Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface>();
        ent_->parent = this;
        interface.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "interface-list-name")
    {
        interface_list_name = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "interface-list-name")
    {
        interface_list_name.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "interface" || name == "interface-list-name" || name == "interface-list-id")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::Interface()
    :
    interface_name{YType::str, "interface-name"},
    replicate_status{YType::enumeration, "replicate-status"}
{
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::has_data() const
{
    if (is_presence_container) return true;
    return interface_name.is_set
	|| replicate_status.is_set;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(interface_name.yfilter)
	|| ydk::is_set(replicate_status.yfilter);
...
std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/source-info/local-info/parameters/pseudowire-iw/interface-list/" << get_segment_path();
    return path_buffer.str();
}

std::string Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "interface";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "interface-name")
    {
        interface_name = value;
...
void Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "interface-name")
    {
        interface_name.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::SourceInfo::LocalInfo::Parameters::PseudowireIw::InterfaceList::Interface::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "interface-name" || name == "replicate-status")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::EthernetSegmentIdentifier::EthernetSegmentIdentifier()
    :
    entry{YType::uint8, "entry"}
{
...
bool Evpn::Active::Igmps::Igmp::EthernetSegmentIdentifier::has_data() const
{
    if (is_presence_container) return true;
    return entry.is_set;
}

bool Evpn::Active::Igmps::Igmp::EthernetSegmentIdentifier::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(entry.yfilter);
}

std::string Evpn::Active::Igmps::Igmp::EthernetSegmentIdentifier::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/" << get_segment_path();
    return path_buffer.str();
...
std::string Evpn::Active::Igmps::Igmp::EthernetSegmentIdentifier::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "ethernet-segment-identifier";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::EthernetSegmentIdentifier::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::EthernetSegmentIdentifier::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::EthernetSegmentIdentifier::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Active::Igmps::Igmp::EthernetSegmentIdentifier::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "entry")
    {
        entry = value;
...
void Evpn::Active::Igmps::Igmp::EthernetSegmentIdentifier::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "entry")
    {
        entry.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::EthernetSegmentIdentifier::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "entry")
        return true;
    return false;
...
Evpn::Active::Igmps::Igmp::NextHop::NextHop()
    :
    next_hop{YType::str, "next-hop"},
    df_dont_prempt{YType::boolean, "df-dont-prempt"},
    df_type{YType::uint8, "df-type"},
...
bool Evpn::Active::Igmps::Igmp::NextHop::has_data() const
{
    if (is_presence_container) return true;
    return next_hop.is_set
	|| df_dont_prempt.is_set
...
bool Evpn::Active::Igmps::Igmp::NextHop::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(next_hop.yfilter)
	|| ydk::is_set(df_dont_prempt.yfilter)
...
std::string Evpn::Active::Igmps::Igmp::NextHop::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/igmps/igmp/" << get_segment_path();
    return path_buffer.str();
...
std::string Evpn::Active::Igmps::Igmp::NextHop::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "next-hop";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::Igmps::Igmp::NextHop::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::Igmps::Igmp::NextHop::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Igmps::Igmp::NextHop::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Active::Igmps::Igmp::NextHop::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "next-hop")
    {
        next_hop = value;
...
void Evpn::Active::Igmps::Igmp::NextHop::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "next-hop")
    {
        next_hop.yfilter = yfilter;
...
bool Evpn::Active::Igmps::Igmp::NextHop::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "next-hop" || name == "df-dont-prempt" || name == "df-type" || name == "df-pref")
        return true;
    return false;
...
std::shared_ptr<ydk::Entity> Evpn::Active::Evis::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "evi")
    {
        auto ent_ = std::make_shared<Evpn::Active::Evis::Evi>();
        ent_->parent = this;
        evi.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Evis::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Evpn::Active::Evis::Evi::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Evis::Evi::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Active::Summary::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::Summary::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Evpn::Active::EviDetail::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "elements")
    {
        if(elements == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::EviDetail::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(elements != nullptr)
...
std::shared_ptr<ydk::Entity> Evpn::Active::EviDetail::Elements::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "element")
    {
        auto ent_ = std::make_shared<Evpn::Active::EviDetail::Elements::Element>();
        ent_->parent = this;
        element.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::EviDetail::Elements::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
Evpn::Active::EviDetail::Elements::Element::Element()
    ...
    multicast_source_connected{YType::boolean, "multicast-source-connected"}
        ,
    evpn_instance(std::make_shared<Evpn::Active::EviDetail::Elements::Element::EvpnInstance>())
...
std::shared_ptr<ydk::Entity> Evpn::Active::EviDetail::Elements::Element::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "evpn-instance")
    {
        if(evpn_instance == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::EviDetail::Elements::Element::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(evpn_instance != nullptr)
...
Evpn::Active::EviDetail::Elements::Element::EvpnInstance::EvpnInstance()
    :
    ethernet_vpn_id{YType::uint32, "ethernet-vpn-id"},
    encapsulation_xr{YType::uint8, "encapsulation-xr"},
    bd_name{YType::str, "bd-name"},
...
bool Evpn::Active::EviDetail::Elements::Element::EvpnInstance::has_data() const
{
    if (is_presence_container) return true;
    return ethernet_vpn_id.is_set
	|| encapsulation_xr.is_set
...
bool Evpn::Active::EviDetail::Elements::Element::EvpnInstance::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(ethernet_vpn_id.yfilter)
	|| ydk::is_set(encapsulation_xr.yfilter)
...
std::string Evpn::Active::EviDetail::Elements::Element::EvpnInstance::get_absolute_path() const
{
    std::ostringstream path_buffer;
...
std::string Evpn::Active::EviDetail::Elements::Element::EvpnInstance::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "evpn-instance";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Evpn::Active::EviDetail::Elements::Element::EvpnInstance::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Evpn::Active::EviDetail::Elements::Element::EvpnInstance::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::EviDetail::Elements::Element::EvpnInstance::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Evpn::Active::EviDetail::Elements::Element::EvpnInstance::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id = value;
...
void Evpn::Active::EviDetail::Elements::Element::EvpnInstance::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ethernet-vpn-id")
    {
        ethernet_vpn_id.yfilter = yfilter;
...
bool Evpn::Active::EviDetail::Elements::Element::EvpnInstance::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ethernet-vpn-id" || name == "encapsulation-xr" || name == "bd-name" || name == "type")
        return true;
    return false;
...
std::string Evpn::Active::EviDetail::Elements::Element::FlowLabel::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/evi-detail/elements/element/" << get_segment_path();
    return path_buffer.str();
...
std::shared_ptr<ydk::Entity> Evpn::Active::EviDetail::Elements::Element::FlowLabel::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::EviDetail::Elements::Element::FlowLabel::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::string Evpn::Active::EviDetail::Elements::Element::RdAuto::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-evpn-oper:evpn/active/evi-detail/elements/element/" << get_segment_path();
    return path_buffer.str();
...
std::shared_ptr<ydk::Entity> Evpn::Active::EviDetail::Elements::Element::RdAuto::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "auto")
    {
        if(auto_ == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Evpn::Active::EviDetail::Elements::Element::RdAuto::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(auto_ != nullptr)
...
const Enum::YLeaf L2vpnEvpnScMode::manual_list {3, "manual-list"};
const Enum::YLeaf L2vpnEvpnScMode::hrw {4, "hrw"};
const Enum::YLeaf L2vpnEvpnScMode::pref {5, "pref"};
...
const Enum::YLeaf EvpnIgmpSource::local {0, "local"};
const Enum::YLeaf EvpnIgmpSource::remote {1, "remote"};
...
const Enum::YLeaf EvpnIgmpGrp::include {0, "include"};
const Enum::YLeaf EvpnIgmpGrp::exclude {1, "exclude"};

const Enum::YLeaf EvpnIgmpMsg::join {0, "join"};
const Enum::YLeaf EvpnIgmpMsg::leave {1, "leave"};
...
const Enum::YLeaf EvpnGrp::deisolating {0, "deisolating"};
const Enum::YLeaf EvpnGrp::isolated {1, "isolated"};
const Enum::YLeaf EvpnGrp::ready {2, "ready"};
const Enum::YLeaf EvpnGrp::incomplete {3, "incomplete"};
...
const Enum::YLeaf EvpnIgmpVersion::version1 {0, "version1"};
const Enum::YLeaf EvpnIgmpVersion::version2 {1, "version2"};
const Enum::YLeaf EvpnIgmpVersion::version3 {2, "version3"};
