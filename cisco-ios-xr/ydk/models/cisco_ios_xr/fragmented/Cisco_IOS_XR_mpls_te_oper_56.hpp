...
class MplsTeStandby::P2pP2mpTunnel::TunnelHeads::TunnelHead::TunnelStandbyLsp::S2l : public ydk::Entity
{
    public:
        ...
        class AccumulatedPathMetrics; //type: MplsTeStandby::P2pP2mpTunnel::TunnelHeads::TunnelHead::TunnelStandbyLsp::S2l::AccumulatedPathMetrics
        class AccumulatedReversePathMetrics; //type: MplsTeStandby::P2pP2mpTunnel::TunnelHeads::TunnelHead::TunnelStandbyLsp::S2l::AccumulatedReversePathMetrics
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_mpls_te_oper::MplsTeStandby::P2pP2mpTunnel::TunnelHeads::TunnelHead::TunnelStandbyLsp::S2l::AccumulatedPathMetrics> accumulated_path_metrics;
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_mpls_te_oper::MplsTeStandby::P2pP2mpTunnel::TunnelHeads::TunnelHead::TunnelStandbyLsp::S2l::AccumulatedReversePathMetrics> accumulated_reverse_path_metrics;
