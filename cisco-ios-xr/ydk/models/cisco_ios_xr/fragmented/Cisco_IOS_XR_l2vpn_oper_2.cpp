...
{
    if(name == "segment1" || name == "segment2" || name == "xcid" || name == "xcon-name" || name == "bound" || name == "switching-type")
        return true;
    return false;
}
...
L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::L2fibMainInterfaceHardwareEgressDetailInfo()
    ...
    evpn_rid{YType::str, "evpn-rid"},
    evpn_service_carving_mcast_mode{YType::enumeration, "evpn-service-carving-mcast-mode"},
...
bool L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::has_data() const
{
    ...
    for (std::size_t index=0; index<es_next_hop.len(); index++)
    {
        if(es_next_hop[index]->has_data())
            return true;
    }
	...
	|| evpn_rid.is_set
	|| evpn_service_carving_mcast_mode.is_set;
}
...
bool L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::has_operation() const
{
    ...
    for (std::size_t index=0; index<es_next_hop.len(); index++)
    {
        if(es_next_hop[index]->has_operation())
            return true;
    }
    for (auto const & leaf : instance_id.getYLeafs())
    {
	...
	|| ydk::is_set(evpn_rid.yfilter)
	|| ydk::is_set(evpn_service_carving_mcast_mode.yfilter)
...
std::vector<std::pair<std::string, LeafData> > L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::get_name_leaf_data() const
{
    ...
    if (evpn_rid.is_set || is_set(evpn_rid.yfilter)) leaf_name_data.push_back(evpn_rid.get_name_leafdata());
    if (evpn_service_carving_mcast_mode.is_set || is_set(evpn_service_carving_mcast_mode.yfilter)) leaf_name_data.push_back(evpn_service_carving_mcast_mode.get_name_leafdata());
...
std::shared_ptr<ydk::Entity> L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "es-next-hop")
    {
        auto ent_ = std::make_shared<L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::EsNextHop>();
        ent_->parent = this;
        es_next_hop.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::get_children() const
{
    ...
    count_ = 0;
    for (auto ent_ : es_next_hop.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
void L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    ...
    if(value_path == "evpn-rid")
    {
        evpn_rid = value;
        evpn_rid.value_namespace = name_space;
        evpn_rid.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "evpn-service-carving-mcast-mode")
    {
        evpn_service_carving_mcast_mode = value;
        evpn_service_carving_mcast_mode.value_namespace = name_space;
        evpn_service_carving_mcast_mode.value_namespace_prefix = name_space_prefix;
    }
...
void L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::set_filter(const std::string & value_path, YFilter yfilter)
{
    ...
    if(value_path == "evpn-rid")
    {
        evpn_rid.yfilter = yfilter;
    }
    if(value_path == "evpn-service-carving-mcast-mode")
    {
        evpn_service_carving_mcast_mode.yfilter = yfilter;
    }
    if(value_path == "instance-id")
    {
...
{
    if(name == "evpn-shg-remote-info" || name == "es-next-hop" || name == "main-interface" || name == "main-if-type" || name == "virtual-if-name" || name == "mac" || name == "esi-id" || name == "evpn-shg-local-label" || name == "evpn-rid" || name == "evpn-service-carving-mcast-mode" || name == "instance-id" || name == "instances-state" || name == "instances-provisioned" || name == "bridge-port-count-instance" || name == "ethernet-segment-identifier")
        return true;
    return false;
}
...
L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::EsNextHop::EsNextHop()
    :
    address{YType::str, "address"}
{

    yang_name = "es-next-hop"; yang_parent_name = "l2fib-main-interface-hardware-egress-detail-info"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::EsNextHop::has_data() const
{
    if (is_presence_container) return true;
    return address.is_set;
}

bool L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::EsNextHop::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(address.yfilter);
}

std::string L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::EsNextHop::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "es-next-hop";
    path_buffer << "[" << get_ylist_key() << "]";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::EsNextHop::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::EsNextHop::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::EsNextHop::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::EsNextHop::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::EsNextHop::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "address")
    {
...
bool L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareEgressDetailInfo::EsNextHop::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "address")
        return true;
    return false;
...
std::shared_ptr<ydk::Entity> L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceDetailInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "es-next-hop")
    {
        auto ent_ = std::make_shared<L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceDetailInfo::EsNextHop>();
        ent_->parent = this;
        es_next_hop.append(ent_);
        return ent_;
    }
...
L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceDetailInfo::EsNextHop::EsNextHop()
    :
    address{YType::str, "address"}
{

    yang_name = "es-next-hop"; yang_parent_name = "l2fib-main-interface-detail-info"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceDetailInfo::EsNextHop::has_data() const
{
    if (is_presence_container) return true;
    return address.is_set;
}

bool L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceDetailInfo::EsNextHop::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(address.yfilter);
}

std::string L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceDetailInfo::EsNextHop::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "es-next-hop";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceDetailInfo::EsNextHop::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceDetailInfo::EsNextHop::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceDetailInfo::EsNextHop::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceDetailInfo::EsNextHop::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "address")
    {
        address = value;
...
void L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceDetailInfo::EsNextHop::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "address")
    {
        address.yfilter = yfilter;
...
bool L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceDetailInfo::EsNextHop::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "address")
        return true;
    return false;
...
std::shared_ptr<ydk::Entity> L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareIngressDetailInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "es-next-hop")
    {
        auto ent_ = std::make_shared<L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareIngressDetailInfo::EsNextHop>();
        ent_->parent = this;
        es_next_hop.append(ent_);
        return ent_;
    }
...
L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareIngressDetailInfo::EsNextHop::EsNextHop()
    :
    address{YType::str, "address"}
{

    yang_name = "es-next-hop"; yang_parent_name = "l2fib-main-interface-hardware-ingress-detail-info"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareIngressDetailInfo::EsNextHop::has_data() const
{
    if (is_presence_container) return true;
    return address.is_set;
}

bool L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareIngressDetailInfo::EsNextHop::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(address.yfilter);
}

std::string L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareIngressDetailInfo::EsNextHop::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "es-next-hop";
    path_buffer << "[" << get_ylist_key() << "]";
...
std::vector<std::pair<std::string, LeafData> > L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareIngressDetailInfo::EsNextHop::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareIngressDetailInfo::EsNextHop::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareIngressDetailInfo::EsNextHop::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareIngressDetailInfo::EsNextHop::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "address")
    {
        address = value;
...
void L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareIngressDetailInfo::EsNextHop::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "address")
    {
        address.yfilter = yfilter;
...
bool L2vpnForwarding::Nodes::Node::L2fibMainInterfaces::L2fibMainInterface::L2fibMainInterfaceHardwareIngressDetailInfo::EsNextHop::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "address")
        return true;
    return false;
...
{
    if(name == "parent-interface" || name == "main-interface-type" || name == "msti" || name == "parent-interface-xr" || name == "msti-xr" || name == "internal-msti" || name == "state" || name == "learn-key" || name == "bridge-port-array")
        return true;
    return false;
}
...
{
    if(name == "session-id" || name == "session-id-xr" || name == "interface-name" || name == "sub-interface-name" || name == "source-address" || name == "bound" || name == "tunnel-id-xr" || name == "ipv4-table-id" || name == "ipv6-table-id" || name == "nhop-ip-addr" || name == "session-type")
        return true;
    return false;
}
...
{
    if(name == "session-id" || name == "tunnel-id" || name == "session-id-xr" || name == "interface-name" || name == "sub-interface-name" || name == "source-address" || name == "bound" || name == "tunnel-id-xr" || name == "ipv4-table-id" || name == "ipv6-table-id" || name == "nhop-ip-addr" || name == "session-type")
        return true;
    return false;
}
...
L2vpnForwarding::Nodes::Node::L2fibBridgePorts::L2fibBridgePort::L2fibBridgePort()
    ...
    number_of_mcast_routes{YType::uint32, "number-of-mcast-routes"},
    mac_limit{YType::uint32, "mac-limit"},
    mac_limit_action{YType::enumeration, "mac-limit-action"},
    flooding_disabled{YType::boolean, "flooding-disabled"},
    mac_learning_disabled{YType::boolean, "mac-learning-disabled"},
...
bool L2vpnForwarding::Nodes::Node::L2fibBridgePorts::L2fibBridgePort::has_operation() const
{
	...
	|| ydk::is_set(number_of_mcast_routes.yfilter)
	|| ydk::is_set(mac_limit.yfilter)
	|| ydk::is_set(mac_limit_action.yfilter)
	|| ydk::is_set(flooding_disabled.yfilter)
	|| ydk::is_set(mac_learning_disabled.yfilter)
...
std::vector<std::pair<std::string, LeafData> > L2vpnForwarding::Nodes::Node::L2fibBridgePorts::L2fibBridgePort::get_name_leaf_data() const
{
    ...
    if (number_of_mcast_routes.is_set || is_set(number_of_mcast_routes.yfilter)) leaf_name_data.push_back(number_of_mcast_routes.get_name_leafdata());
    if (mac_limit.is_set || is_set(mac_limit.yfilter)) leaf_name_data.push_back(mac_limit.get_name_leafdata());
    if (mac_limit_action.is_set || is_set(mac_limit_action.yfilter)) leaf_name_data.push_back(mac_limit_action.get_name_leafdata());
    if (flooding_disabled.is_set || is_set(flooding_disabled.yfilter)) leaf_name_data.push_back(flooding_disabled.get_name_leafdata());
    if (mac_learning_disabled.is_set || is_set(mac_learning_disabled.yfilter)) leaf_name_data.push_back(mac_learning_disabled.get_name_leafdata());
...
void L2vpnForwarding::Nodes::Node::L2fibBridgePorts::L2fibBridgePort::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    ...
    if(value_path == "number-of-mcast-routes")
    {
        number_of_mcast_routes = value;
        number_of_mcast_routes.value_namespace = name_space;
        number_of_mcast_routes.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "mac-limit")
    {
        mac_limit = value;
...
void L2vpnForwarding::Nodes::Node::L2fibBridgePorts::L2fibBridgePort::set_filter(const std::string & value_path, YFilter yfilter)
{
    ...
    if(value_path == "number-of-mcast-routes")
    {
        number_of_mcast_routes.yfilter = yfilter;
    }
    if(value_path == "mac-limit")
    {
        mac_limit.yfilter = yfilter;
...
{
    if(name == "segment" || name == "bridge-port-operational-info" || name == "group-name" || name == "bd-name" || name == "xc-uint-id" || name == "bridge-id" || name == "shg-id" || name == "xc-id" || name == "number-of-hw-mac" || name == "number-of-sw-mac" || name == "number-of-mcast-routes" || name == "mac-limit" || name == "mac-limit-action" || name == "flooding-disabled" || name == "mac-learning-disabled" || name == "mac-port-down-flush-disabled" || name == "mtu" || name == "aging-time-out")
        return true;
    return false;
}
