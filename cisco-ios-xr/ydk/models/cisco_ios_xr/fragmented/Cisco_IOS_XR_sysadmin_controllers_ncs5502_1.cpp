...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-controllers-ncs5502:controller/fabric/oper/fsdb-aggregator/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-controllers-ncs5502:controller/fabric/oper/fsdb-aggregator/fsdbagg/" << get_segment_path();
    return path_buffer.str();
}
