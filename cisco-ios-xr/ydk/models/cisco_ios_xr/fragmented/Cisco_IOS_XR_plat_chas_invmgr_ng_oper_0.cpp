...
#include "Cisco_IOS_XR_plat_chas_invmgr_ng_oper_0.hpp"
    ...
    racks(std::make_shared<Platform::Racks>())
{
    ...
    yang_name = "platform"; yang_parent_name = "Cisco-IOS-XR-plat-chas-invmgr-ng-oper"; is_top_level_class = true; has_list_ancestor = false; 
}
...
std::string Platform::get_segment_path() const
{
    ...
    path_buffer << "Cisco-IOS-XR-plat-chas-invmgr-ng-oper:platform";
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-plat-chas-invmgr-ng-oper:platform/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-plat-chas-invmgr-ng-oper:platform/racks/" << get_segment_path();
    return path_buffer.str();
}
    ...
    racks(std::make_shared<PlatformInventory::Racks>())
{
    ...
    yang_name = "platform-inventory"; yang_parent_name = "Cisco-IOS-XR-plat-chas-invmgr-ng-oper"; is_top_level_class = true; has_list_ancestor = false; 
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-plat-chas-invmgr-ng-oper:platform-inventory";
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-plat-chas-invmgr-ng-oper:platform-inventory/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-plat-chas-invmgr-ng-oper:platform-inventory/racks/" << get_segment_path();
    return path_buffer.str();
}
