...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-controllers-ncs55A1:controller/fabric/oper/fsdb-aggregator/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-controllers-ncs55A1:controller/fabric/oper/fsdb-aggregator/fsdbagg/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-controllers-ncs55A1:controller/fabric/oper/link/" << get_segment_path();
    return path_buffer.str();
}
...
std::shared_ptr<ydk::Entity> Controller::Fabric::Oper::Link::Rack::Port::Tx::Brief::DataIdx::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "history")
    {
        auto ent_ = std::make_shared<Controller::Fabric::Oper::Link::Rack::Port::Tx::Brief::DataIdx::History>();
        ent_->parent = this;
        history.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Fabric::Oper::Link::Rack::Port::Tx::Brief::DataIdx::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Fabric::Oper::Link::Rack::Port::Tx::Brief::DataIdx::History::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Fabric::Oper::Link::Rack::Port::Tx::Brief::DataIdx::History::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
