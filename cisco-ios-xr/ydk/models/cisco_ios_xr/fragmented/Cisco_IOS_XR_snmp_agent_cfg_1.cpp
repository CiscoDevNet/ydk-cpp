...
{
    if(name == "notification-log-mib" || name == "mpls-te-mib" || name == "mpls-p2mp-mib" || name == "mpls-te-ext-std-mib" || name == "mpls-te-ext-mib" || name == "mpls-frr-mib" || name == "cb-qosmib" || name == "entity-mib" || name == "interface-mib" || name == "subscriber" || name == "sensor-mib-cache")
        return true;
    return false;
}
