...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Config()
    :
    ...
    tunnel_name{YType::str, "tunnel-name"}
    	,
    affinity(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity>())
	,bfd_config(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BfdConfig>())
	,bidirectional_config(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BidirectionalConfig>())
{
    affinity->parent = this;
    bfd_config->parent = this;
    bidirectional_config->parent = this;

    yang_name = "config"; yang_parent_name = "tunnel-head"; is_top_level_class = false; has_list_ancestor = true;
}
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::has_data() const
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::has_operation() const
{
    for (std::size_t index=0; index<autoroute_destination.size(); index++)
    {
...
std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "autoroute-destination")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::AutorouteDestination>();
        c->parent = this;
    ...
    if(child_yang_name == "policy-class-entry")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::PolicyClassEntry>();
        c->parent = this;
...
std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(affinity != nullptr)
    {
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "affinity-failure-reopt-timer")
    {
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::has_leaf_or_child_of_name(const std::string & name) const
{
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::Affinity()
    :
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::has_data() const
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::has_operation() const
{
    for (std::size_t index=0; index<named_affinity.size(); index++)
    {
...
std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "named-affinity")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity>();
        c->parent = this;
...
std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    for (auto const & c : named_affinity)
    {
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "affinity-bits")
    {
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::has_leaf_or_child_of_name(const std::string & name) const
{
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::NamedAffinity()
    :
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::has_data() const
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::has_operation() const
{
    for (std::size_t index=0; index<constraint_extended_value.size(); index++)
    {
...
std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "constraint-extended-value")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ConstraintExtendedValue>();
        c->parent = this;
    ...
    if(child_yang_name == "extended-forward-ref-value")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ExtendedForwardRefValue>();
        c->parent = this;
...
std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    for (auto const & c : constraint_extended_value)
    {
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "constraint-type")
    {
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::has_leaf_or_child_of_name(const std::string & name) const
{
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ConstraintExtendedValue::ConstraintExtendedValue()
    :
    entry{YType::uint32, "entry"}
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ConstraintExtendedValue::has_data() const
{
    return entry.is_set;
}

bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ConstraintExtendedValue::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(entry.yfilter);
}

std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ConstraintExtendedValue::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ConstraintExtendedValue::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ConstraintExtendedValue::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ConstraintExtendedValue::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ConstraintExtendedValue::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "entry")
    {
        entry = value;
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ConstraintExtendedValue::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "entry")
    {
        entry.yfilter = yfilter;
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ConstraintExtendedValue::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "entry")
        return true;
    return false;
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ExtendedForwardRefValue::ExtendedForwardRefValue()
    :
    entry{YType::uint32, "entry"}
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ExtendedForwardRefValue::has_data() const
{
    return entry.is_set;
}

bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ExtendedForwardRefValue::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(entry.yfilter);
}

std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ExtendedForwardRefValue::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ExtendedForwardRefValue::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ExtendedForwardRefValue::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ExtendedForwardRefValue::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ExtendedForwardRefValue::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "entry")
    {
        entry = value;
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ExtendedForwardRefValue::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "entry")
    {
        entry.yfilter = yfilter;
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::Affinity::NamedAffinity::ExtendedForwardRefValue::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "entry")
        return true;
    return false;
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::AutorouteDestination::AutorouteDestination()
    :
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::AutorouteDestination::has_data() const
{
    return destination_address.is_set
	|| prefix_length.is_set;
}

bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::AutorouteDestination::has_operation() const
{
    return is_set(yfilter)
...
std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::AutorouteDestination::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::AutorouteDestination::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::AutorouteDestination::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::AutorouteDestination::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::AutorouteDestination::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::AutorouteDestination::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "destination-address")
    {
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::AutorouteDestination::has_leaf_or_child_of_name(const std::string & name) const
{
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BfdConfig::BfdConfig()
    :
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BfdConfig::has_data() const
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BfdConfig::has_operation() const
{
    return is_set(yfilter)
...
std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BfdConfig::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BfdConfig::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BfdConfig::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BfdConfig::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BfdConfig::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BfdConfig::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "bfd-encap-mode")
    {
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BfdConfig::has_leaf_or_child_of_name(const std::string & name) const
{
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BidirectionalConfig::BidirectionalConfig()
    :
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BidirectionalConfig::has_data() const
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BidirectionalConfig::has_operation() const
{
    return is_set(yfilter)
...
std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BidirectionalConfig::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BidirectionalConfig::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BidirectionalConfig::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BidirectionalConfig::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BidirectionalConfig::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BidirectionalConfig::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "association-corouted")
    {
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::BidirectionalConfig::has_leaf_or_child_of_name(const std::string & name) const
{
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::PolicyClassEntry::PolicyClassEntry()
    :
    entry{YType::uint8, "entry"}
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::PolicyClassEntry::has_data() const
{
    return entry.is_set;
}

bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::PolicyClassEntry::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(entry.yfilter);
}

std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::PolicyClassEntry::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::PolicyClassEntry::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::PolicyClassEntry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::PolicyClassEntry::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::PolicyClassEntry::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "entry")
    {
        entry = value;
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::PolicyClassEntry::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "entry")
    {
        entry.yfilter = yfilter;
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::Config::PolicyClassEntry::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "entry")
        return true;
    return false;
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::DelayCleanPpLsp()
    :
    ...
    uptime{YType::uint32, "uptime"}
    	,
    lsp_fec(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec>())
{
    lsp_fec->parent = this;
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::has_data() const
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::has_operation() const
{
    for (std::size_t index=0; index<s2l.size(); index++)
    {
...
std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "s2l")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L>();
        c->parent = this;
        s2l.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(lsp_fec != nullptr)
    {
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "dste-class-index")
    {
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::has_leaf_or_child_of_name(const std::string & name) const
{
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::LspFec()
    :
    fec_extended_tunnel_id{YType::str, "fec-extended-tunnel-id"},
    fec_lsp_id{YType::uint16, "fec-lsp-id"},
    fec_source{YType::str, "fec-source"},
    ...
    fec_vrf{YType::str, "fec-vrf"}
    	,
    fec_destination_info(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::FecDestinationInfo>())
{
    fec_destination_info->parent = this;
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::has_data() const
{
    return fec_extended_tunnel_id.is_set
	|| fec_lsp_id.is_set
	|| fec_source.is_set
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(fec_extended_tunnel_id.yfilter)
	|| ydk::is_set(fec_lsp_id.yfilter)
...
std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "lsp-fec";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "fec-destination-info")
    {
        if(fec_destination_info == nullptr)
...
std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(fec_destination_info != nullptr)
    {
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "fec-extended-tunnel-id")
    {
        fec_extended_tunnel_id = value;
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "fec-extended-tunnel-id")
    {
        fec_extended_tunnel_id.yfilter = yfilter;
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "fec-destination-info" || name == "fec-extended-tunnel-id" || name == "fec-lsp-id" || name == "fec-source" || name == "fec-tunnel-id" || name == "fec-vrf")
        return true;
    return false;
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::FecDestinationInfo::FecDestinationInfo()
    :
    fec_ctype{YType::enumeration, "fec-ctype"},
    fec_destination_p2mp_id{YType::uint32, "fec-destination-p2mp-id"},
    p2p_lsp_destination{YType::str, "p2p-lsp-destination"}
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::FecDestinationInfo::has_data() const
{
    return fec_ctype.is_set
	|| fec_destination_p2mp_id.is_set
	|| p2p_lsp_destination.is_set;
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::FecDestinationInfo::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(fec_ctype.yfilter)
	|| ydk::is_set(fec_destination_p2mp_id.yfilter)
...
std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::FecDestinationInfo::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "fec-destination-info";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::FecDestinationInfo::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::FecDestinationInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::FecDestinationInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::FecDestinationInfo::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "fec-ctype")
    {
        fec_ctype = value;
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::FecDestinationInfo::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "fec-ctype")
    {
        fec_ctype.yfilter = yfilter;
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::LspFec::FecDestinationInfo::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "fec-ctype" || name == "fec-destination-p2mp-id" || name == "p2p-lsp-destination")
        return true;
    return false;
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::S2L()
    :
    ...
    weight{YType::uint64, "weight"}
    	,
    active_path_option(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption>())
	,association(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::Association>())
	,diversity_info(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::DiversityInfo>())
	,flex_info(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::FlexInfo>())
	,fspec(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::Fspec>())
	,generic_fspec(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::GenericFspec>())
	,generic_tspec(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::GenericTspec>())
	,gmpls_labels(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::GmplsLabels>())
	,head_end_bfd_info(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::HeadEndBfdInfo>())
	,in_xro(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::InXro>())
	,incoming_address_generic(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::IncomingAddressGeneric>())
	,lsp_wrap_info(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::LspWrapInfo>())
	,next_hop_address_generic(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::NextHopAddressGeneric>())
	,otn_s2l(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::OtnS2L>())
	,out_xro(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::OutXro>())
	,previous_hop_address_generic(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::PreviousHopAddressGeneric>())
	,protection(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::Protection>())
	,reverse_lsp_fec(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ReverseLspFec>())
	,reverse_tspec(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ReverseTspec>())
	,s2l_convergence(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::S2LConvergence>())
	,s2l_fec(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::S2LFec>())
	,soft_preemption(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::SoftPreemption>())
	,srlg_collection(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::SrlgCollection>())
	,tail_end_bfd_info(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::TailEndBfdInfo>())
	,tspec(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::Tspec>())
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::has_data() const
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::has_operation() const
{
    for (std::size_t index=0; index<in_ero.size(); index++)
    {
...
std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "s2l";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "in-ero")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::InEro>();
        c->parent = this;
        in_ero.push_back(c);
        return c;
    }
    ...
    if(child_yang_name == "out-ero")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::OutEro>();
        c->parent = this;
        out_ero.push_back(c);
        return c;
    }
    ...
    if(child_yang_name == "path-affinity-array")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::PathAffinityArray>();
        c->parent = this;
    ...
    if(child_yang_name == "path-rro")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::PathRro>();
        c->parent = this;
    ...
    if(child_yang_name == "resv-rro")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ResvRro>();
        c->parent = this;
    ...
    if(child_yang_name == "reverse-ero-in")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ReverseEroIn>();
        c->parent = this;
    ...
    if(child_yang_name == "s2l-reverse-lsp-sub-obj")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::S2LReverseLspSubObj>();
        c->parent = this;
    ...
    if(child_yang_name == "s2l-segment-routing-path")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::S2LSegmentRoutingPath>();
        c->parent = this;
    ...
    if(child_yang_name == "shared-risk-link-group")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::SharedRiskLinkGroup>();
        c->parent = this;
...
std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(active_path_option != nullptr)
    {
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "abr-auto-discovered")
    {
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::has_leaf_or_child_of_name(const std::string & name) const
{
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::ActivePathOption()
    :
    ...
    xro_attribute_set_found{YType::boolean, "xro-attribute-set-found"}
    	,
    attribute_set(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet>())
	,xro_attribute_set(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::XroAttributeSet>())
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::has_data() const
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::has_operation() const
{
    for (std::size_t index=0; index<path_calculation_error.size(); index++)
    {
...
std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "path-calculation-error")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::PathCalculationError>();
        c->parent = this;
    ...
    if(child_yang_name == "remerge-error")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::RemergeError>();
        c->parent = this;
    ...
    if(child_yang_name == "signalling-error")
    {
        ...
        auto c = std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::SignallingError>();
        c->parent = this;
...
std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(attribute_set != nullptr)
    {
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "attribute-set-found")
    {
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::has_leaf_or_child_of_name(const std::string & name) const
{
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSet()
    :
    ...
    tunnel_attribute_set_name_crc32{YType::uint32, "tunnel-attribute-set-name-crc32"}
    	,
    attribute_set_union(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion>())
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::has_data() const
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::has_operation() const
{
    return is_set(yfilter)
...
std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(attribute_set_union != nullptr)
    {
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "tunnel-attribute-set-name")
    {
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::has_leaf_or_child_of_name(const std::string & name) const
{
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetUnion()
    :
    tunnel_attribute_set_type{YType::enumeration, "tunnel-attribute-set-type"}
    	,
    attribute_set_aps_pp(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp>())
	,attribute_set_autobackup(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetAutobackup>())
	,attribute_set_automesh(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetAutomesh>())
	,attribute_set_p2mpte(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetP2Mpte>())
	,attribute_set_p2p_te(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetP2PTe>())
	,attribute_set_path_option(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetPathOption>())
	,attribute_set_xro(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetXro>())
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::has_data() const
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::has_operation() const
{
    return is_set(yfilter)
...
std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(attribute_set_aps_pp != nullptr)
    {
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "tunnel-attribute-set-type")
    {
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::has_leaf_or_child_of_name(const std::string & name) const
{
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::AttributeSetApsPp()
    :
    ...
    wait_to_restore_time{YType::uint32, "wait-to-restore-time"}
    	,
    revert_schedule(std::make_shared<MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::RevertSchedule>())
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::has_data() const
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::has_operation() const
{
    return is_set(yfilter)
...
std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(revert_schedule != nullptr)
    {
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "hold-off-time")
    {
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::has_leaf_or_child_of_name(const std::string & name) const
{
...
MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::RevertSchedule::RevertSchedule()
    :
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::RevertSchedule::has_data() const
{
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::RevertSchedule::has_operation() const
{
    return is_set(yfilter)
...
std::string MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::RevertSchedule::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::RevertSchedule::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::RevertSchedule::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::RevertSchedule::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::RevertSchedule::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::RevertSchedule::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "duration")
    {
...
bool MplsTeStandby::P2PP2MpTunnel::TunnelHeads::TunnelHead::DelayCleanPpLsp::S2L::ActivePathOption::AttributeSet::AttributeSetUnion::AttributeSetApsPp::RevertSchedule::has_leaf_or_child_of_name(const std::string & name) const
{
