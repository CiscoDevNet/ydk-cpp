...
{
    if(name == "convergence-timeout" || name == "dr-priority" || name == "hello-interval" || name == "join-prune-mtu" || name == "jp-interval" || name == "override-interval" || name == "propagation-delay")
        return true;
    return false;
}
...
{
    if(name == "clone-joins" || name == "clone-sources" || name == "enable" || name == "flow" || name == "non-revertive" || name == "rib")
        return true;
    return false;
}
...
{
    if(name == "allow-rp" || name == "bidir-rp-addresses" || name == "bsr" || name == "convergence" || name == "inheritable-defaults" || name == "injects" || name == "interfaces" || name == "maximum" || name == "mofrr" || name == "paths" || name == "rpf" || name == "rpf-vector-enable" || name == "sg-expiry-timer" || name == "sparse-mode-rp-addresses" || name == "ssm" || name == "accept-register" || name == "auto-rp-disable" || name == "log-neighbor-changes" || name == "multipath" || name == "neighbor-check-on-receive" || name == "neighbor-check-on-send" || name == "neighbor-filter" || name == "old-register-checksum" || name == "register-source" || name == "rp-static-deny" || name == "spt-threshold-infinity" || name == "ssm-allow-override" || name == "suppress-data-registers" || name == "suppress-rpf-prunes")
        return true;
    return false;
}
