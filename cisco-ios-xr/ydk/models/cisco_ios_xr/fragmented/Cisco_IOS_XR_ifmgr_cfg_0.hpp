...
class InterfaceModeEnum : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            ...
            if (name == "multipoint") return 2;
            if (name == "l2-transport") return 3;
            return -1;
        }
};
...
class LinkStatusEnum : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            ...
            if (name == "software-interfaces") return 2;
            return -1;
        }
};
...
class InterfaceConfigurations::InterfaceConfiguration::Dampening::Args : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            if (name == "default-values") return 0;
            if (name == "specify-half-life") return 1;
            if (name == "specify-all") return 4;
            if (name == "specify-rp") return 5;
            return -1;
        }
};
