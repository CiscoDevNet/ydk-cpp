...
class Snmp::Notification : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XR_snmp_agent_cfg::Snmp::Notification::Bridge> bridge;
        ...
        std::shared_ptr<Cisco_IOS_XR_snmp_agent_cfg::Snmp::Notification::Optical> optical;
