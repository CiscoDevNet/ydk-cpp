...
class Snmp::EncryptedCommunityMaps : public ydk::Entity
{
    public:
        ...
        ydk::YList encrypted_community_map;
...
class Snmp::Notification : public ydk::Entity
{
    public:
        ...
        class IpSec; //type: Snmp::Notification::IpSec
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_snmp_agent_cfg::Snmp::Notification::IpSec> ip_sec;
...
class Snmp::Notification::IpSec : public ydk::Entity
{
    public:
        IpSec();
        ~IpSec();
        ...
        ydk::YLeaf tunnel_stop; //type: empty
        ydk::YLeaf tunnel_start; //type: empty

}; // Snmp::Notification::IpSec


class Snmp::Notification::Isakmp : public ydk::Entity
{
    public:
        Isakmp();
        ~Isakmp();
...
class Snmp::Notification::MplsL3vpn : public ydk::Entity
{
    public:
        ...
        ydk::YLeaf max_threshold_reissue_notification_time; //type: uint32
...
class Snmp::DefaultCommunityMaps : public ydk::Entity
{
    public:
        ...
        ydk::YList default_community_map;
...
class Snmp::Vrfs::Vrf::TrapHosts::TrapHost::EncryptedUserCommunities : public ydk::Entity
{
    public:
        ...
        ydk::YList encrypted_user_community;
...
class SnmpBulkstatSchema : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            if (name == "exact-interface") return 1;
            if (name == "exact-oid") return 2;
            if (name == "wild-interface") return 3;
            if (name == "wild-oid") return 4;
            if (name == "range-oid") return 5;
            if (name == "repeat-oid") return 6;
            return -1;
        }
};
...
class SnmpOwnerAccess : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            if (name == "sdr-owner") return 0;
            if (name == "system-owner") return 1;
            return -1;
        }
};
...
class SnmpBulkstatFileFormat : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            if (name == "schema-ascii") return 1;
            if (name == "bulk-ascii") return 2;
            if (name == "bulk-binary") return 3;
            return -1;
        }
};
...
class SnmpSecurityModel : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            if (name == "no-authentication") return 0;
            if (name == "authentication") return 1;
            if (name == "privacy") return 2;
            return -1;
        }
};
...
class SnmpPrivAlgorithm : public ydk::Enum
{
    public:
        ...
        static int get_enum_value(const std::string & name) {
            ...
            if (name == "3des") return 2;
            if (name == "aes128") return 3;
            if (name == "aes192") return 4;
            if (name == "aes256") return 5;
            return -1;
        }
};
