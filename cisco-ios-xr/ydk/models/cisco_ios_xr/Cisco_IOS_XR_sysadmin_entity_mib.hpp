#ifndef _CISCO_IOS_XR_SYSADMIN_ENTITY_MIB_
#define _CISCO_IOS_XR_SYSADMIN_ENTITY_MIB_
...
namespace Cisco_IOS_XR_sysadmin_entity_mib {
...
class ENTITYMIB::EntLogicalTable::EntLogicalEntry : public ydk::Entity
{
    public:
        ...
        ydk::YLeaf entlogicalcommunity; //type: string
        ydk::YLeaf entlogicaltaddress; //type: string
...
#endif /* _CISCO_IOS_XR_SYSADMIN_ENTITY_MIB_ */
