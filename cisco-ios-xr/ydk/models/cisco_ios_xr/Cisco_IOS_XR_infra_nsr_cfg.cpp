...
std::shared_ptr<ydk::Entity> Nsr::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Nsr::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(process_failure != nullptr)
    {
        _children["process-failure"] = process_failure;
    }
...
std::shared_ptr<ydk::Entity> Nsr::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> Nsr::ProcessFailure::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Nsr::ProcessFailure::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
