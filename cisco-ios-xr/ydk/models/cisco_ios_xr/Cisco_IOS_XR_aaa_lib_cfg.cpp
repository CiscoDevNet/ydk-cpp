...
{
    if(name == "aaa-dot1x" || name == "aaa-mobile" || name == "aaa-subscriber" || name == "accounting-update" || name == "accountings" || name == "authentications" || name == "authorizations" || name == "banner" || name == "diameter" || name == "radius" || name == "radius-attribute" || name == "server-groups" || name == "tacacs" || name == "taskgroups" || name == "usergroups" || name == "usernames" || name == "default-taskgroup" || name == "intercept")
        return true;
    return false;
}
