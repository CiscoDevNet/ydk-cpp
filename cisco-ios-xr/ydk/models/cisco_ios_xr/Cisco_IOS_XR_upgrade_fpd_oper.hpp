...
class Fpd_ : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XR_upgrade_fpd_oper::Fpd_::Nodes> nodes;
        std::shared_ptr<Cisco_IOS_XR_upgrade_fpd_oper::Fpd_::Packages> packages;
...
class Fpd_::Nodes : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<Cisco_IOS_XR_upgrade_fpd_oper::Fpd_::Nodes::Node> > node;
...
class Fpd_::Nodes::Node : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XR_upgrade_fpd_oper::Fpd_::Nodes::Node::Devices> devices;
...
class Fpd_::Nodes::Node::Devices : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<Cisco_IOS_XR_upgrade_fpd_oper::Fpd_::Nodes::Node::Devices::Device> > device;
...
class Fpd_::Packages : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<Cisco_IOS_XR_upgrade_fpd_oper::Fpd_::Packages::AllPackage> > all_package;
