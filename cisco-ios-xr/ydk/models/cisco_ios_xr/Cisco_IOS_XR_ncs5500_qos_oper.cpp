...
{
    if(name == "bundle-interfaces" || name == "interfaces" || name == "bundle-interface-singles" || name == "remote-interfaces" || name == "node-name")
        return true;
    return false;
}
...
{
    if(name == "policy-details" || name == "member-interfaces" || name == "classes" || name == "interface-name" || name == "npu-id" || name == "qos-direction")
        return true;
    return false;
}
...
{
    for (std::size_t index=0; index<bundle_interface_single.size(); index++)
    {
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "bundle-interface-single")
    {
        ...
        c->parent = this;
        bundle_interface_single.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::get_children() const
{
    ...
    char count=0;
    count = 0;
    for (auto const & c : bundle_interface_single)
    {
        if(children.find(c->get_segment_path()) == children.end())
            children[c->get_segment_path()] = c;
        else
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::BundleInterfaceSingle()
	...
	,classes(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes>())
{
    policy_details->parent = this;
    member_interfaces->parent = this;
    classes->parent = this;
...
{
    std::ostringstream path_buffer;
    path_buffer << "bundle-interface-single" <<"[interface-name='" <<interface_name <<"']";
    return path_buffer.str();
}
...
{
    if(name == "policy-details" || name == "member-interfaces" || name == "classes" || name == "interface-name")
        return true;
    return false;
}
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::MemberInterface()
	...
	,classes(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes>())
{
    policy_details->parent = this;
    classes->parent = this;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Classes()
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::has_data() const
{
    for (std::size_t index=0; index<class_.size(); index++)
    {
        if(class_[index]->has_data())
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::has_operation() const
{
    for (std::size_t index=0; index<class_.size(); index++)
    {
        if(class_[index]->has_operation())
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "classes";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "class")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class>();
        c->parent = this;
        class_.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "class")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Class()
    :
    level_one_class_name{YType::str, "level-one-class-name"},
    level_two_class_name{YType::str, "level-two-class-name"},
    class_level{YType::enumeration, "class-level"},
    ...
    hardware_policer_excess_burst_bytes{YType::uint32, "hardware-policer-excess-burst-bytes"}
    	,
    config_max_rate(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMaxRate>())
	,config_min_rate(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMinRate>())
	,config_queue_limit(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigQueueLimit>())
	,config_policer_average_rate(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerAverageRate>())
	,config_policer_peak_rate(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerPeakRate>())
	,config_policer_conform_burst(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerConformBurst>())
	,config_policer_excess_burst(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerExcessBurst>())
	,conform_action(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction>())
	,exceed_action(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction>())
	,violate_action(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction>())
{
    config_max_rate->parent = this;
    config_min_rate->parent = this;
    config_queue_limit->parent = this;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::has_data() const
{
    for (std::size_t index=0; index<ip_mark.size(); index++)
    {
        if(ip_mark[index]->has_data())
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::has_operation() const
{
    for (std::size_t index=0; index<ip_mark.size(); index++)
    {
        if(ip_mark[index]->has_operation())
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "class" <<"[level-one-class-name='" <<level_one_class_name <<"']";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "config-max-rate")
    {
        if(config_max_rate == nullptr)
    ...
    if(child_yang_name == "ip-mark")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::IpMark>();
        c->parent = this;
        ip_mark.push_back(c);
        return c;
    }
    ...
    if(child_yang_name == "common-mark")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::CommonMark>();
        c->parent = this;
        common_mark.push_back(c);
        return c;
    }
    ...
    if(child_yang_name == "mpls-mark")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::MplsMark>();
        c->parent = this;
        mpls_mark.push_back(c);
        return c;
    }
    ...
    if(child_yang_name == "wred")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred>();
        c->parent = this;
        wred.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(config_max_rate != nullptr)
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "level-one-class-name")
    {
        level_one_class_name = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "level-one-class-name")
    {
        level_one_class_name.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "config-max-rate" || name == "config-min-rate" || name == "config-queue-limit" || name == "config-policer-average-rate" || name == "config-policer-peak-rate" || name == "config-policer-conform-burst" || name == "config-policer-excess-burst" || name == "conform-action" || name == "exceed-action" || name == "violate-action" || name == "ip-mark" || name == "common-mark" || name == "mpls-mark" || name == "wred" || name == "level-one-class-name" || name == "level-two-class-name" || name == "class-level" || name == "egress-queue-id" || name == "queue-type" || name == "priority-level" || name == "hardware-max-rate-kbps" || name == "hardware-min-rate-kbps" || name == "config-excess-bandwidth-percent" || name == "config-excess-bandwidth-unit" || name == "hardware-excess-bandwidth-weight" || name == "network-min-bandwidth-kbps" || name == "hardware-queue-limit-bytes" || name == "hardware-queue-limit-microseconds" || name == "policer-bucket-id" || name == "policer-stats-handle" || name == "hardware-policer-average-rate-kbps" || name == "hardware-policer-peak-rate-kbps" || name == "hardware-policer-conform-burst-bytes" || name == "hardware-policer-excess-burst-bytes")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMaxRate::ConfigMaxRate()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMaxRate::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMaxRate::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMaxRate::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-max-rate";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMaxRate::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMaxRate::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMaxRate::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMaxRate::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMaxRate::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMaxRate::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMinRate::ConfigMinRate()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMinRate::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMinRate::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMinRate::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-min-rate";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMinRate::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMinRate::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMinRate::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMinRate::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMinRate::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigMinRate::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigQueueLimit::ConfigQueueLimit()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigQueueLimit::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigQueueLimit::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigQueueLimit::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-queue-limit";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigQueueLimit::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigQueueLimit::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigQueueLimit::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigQueueLimit::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigQueueLimit::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigQueueLimit::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerAverageRate::ConfigPolicerAverageRate()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerAverageRate::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerAverageRate::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerAverageRate::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-policer-average-rate";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerAverageRate::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerAverageRate::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerAverageRate::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerAverageRate::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerAverageRate::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerAverageRate::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerPeakRate::ConfigPolicerPeakRate()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerPeakRate::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerPeakRate::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerPeakRate::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-policer-peak-rate";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerPeakRate::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerPeakRate::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerPeakRate::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerPeakRate::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerPeakRate::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerPeakRate::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerConformBurst::ConfigPolicerConformBurst()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerConformBurst::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerConformBurst::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerConformBurst::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-policer-conform-burst";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerConformBurst::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerConformBurst::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerConformBurst::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerConformBurst::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerConformBurst::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerConformBurst::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerExcessBurst::ConfigPolicerExcessBurst()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerExcessBurst::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerExcessBurst::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerExcessBurst::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-policer-excess-burst";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerExcessBurst::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerExcessBurst::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerExcessBurst::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerExcessBurst::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerExcessBurst::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConfigPolicerExcessBurst::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::ConformAction()
    :
    action_type{YType::enumeration, "action-type"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::has_data() const
{
    for (std::size_t index=0; index<mark.size(); index++)
    {
        if(mark[index]->has_data())
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::has_operation() const
{
    for (std::size_t index=0; index<mark.size(); index++)
    {
        if(mark[index]->has_operation())
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "conform-action";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "mark")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::Mark>();
        c->parent = this;
        mark.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "action-type")
    {
        action_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "action-type")
    {
        action_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark" || name == "action-type")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::Mark::Mark()
    :
    mark_type{YType::enumeration, "mark-type"},
    mark_value{YType::uint16, "mark-value"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::Mark::has_data() const
{
    return mark_type.is_set
	|| mark_value.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::Mark::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(mark_type.yfilter)
	|| ydk::is_set(mark_value.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::Mark::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "mark";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::Mark::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::Mark::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::Mark::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::Mark::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "mark-type")
    {
        mark_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::Mark::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "mark-type")
    {
        mark_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ConformAction::Mark::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark-type" || name == "mark-value")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::ExceedAction()
    :
    action_type{YType::enumeration, "action-type"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::has_data() const
{
    for (std::size_t index=0; index<mark.size(); index++)
    {
        if(mark[index]->has_data())
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::has_operation() const
{
    for (std::size_t index=0; index<mark.size(); index++)
    {
        if(mark[index]->has_operation())
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "exceed-action";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "mark")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::Mark>();
        c->parent = this;
        mark.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "action-type")
    {
        action_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "action-type")
    {
        action_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark" || name == "action-type")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::Mark::Mark()
    :
    mark_type{YType::enumeration, "mark-type"},
    mark_value{YType::uint16, "mark-value"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::Mark::has_data() const
{
    return mark_type.is_set
	|| mark_value.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::Mark::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(mark_type.yfilter)
	|| ydk::is_set(mark_value.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::Mark::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "mark";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::Mark::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::Mark::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::Mark::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::Mark::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "mark-type")
    {
        mark_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::Mark::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "mark-type")
    {
        mark_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ExceedAction::Mark::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark-type" || name == "mark-value")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::ViolateAction()
    :
    action_type{YType::enumeration, "action-type"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::has_data() const
{
    for (std::size_t index=0; index<mark.size(); index++)
    {
        if(mark[index]->has_data())
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::has_operation() const
{
    for (std::size_t index=0; index<mark.size(); index++)
    {
        if(mark[index]->has_operation())
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "violate-action";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "mark")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::Mark>();
        c->parent = this;
        mark.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "action-type")
    {
        action_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "action-type")
    {
        action_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark" || name == "action-type")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::Mark::Mark()
    :
    mark_type{YType::enumeration, "mark-type"},
    mark_value{YType::uint16, "mark-value"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::Mark::has_data() const
{
    return mark_type.is_set
	|| mark_value.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::Mark::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(mark_type.yfilter)
	|| ydk::is_set(mark_value.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::Mark::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "mark";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::Mark::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::Mark::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::Mark::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::Mark::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "mark-type")
    {
        mark_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::Mark::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "mark-type")
    {
        mark_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::ViolateAction::Mark::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark-type" || name == "mark-value")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::IpMark::IpMark()
    :
    mark_type{YType::enumeration, "mark-type"},
    mark_value{YType::uint16, "mark-value"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::IpMark::has_data() const
{
    return mark_type.is_set
	|| mark_value.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::IpMark::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(mark_type.yfilter)
	|| ydk::is_set(mark_value.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::IpMark::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "ip-mark";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::IpMark::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::IpMark::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::IpMark::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::IpMark::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "mark-type")
    {
        mark_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::IpMark::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "mark-type")
    {
        mark_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::IpMark::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark-type" || name == "mark-value")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::CommonMark::CommonMark()
    :
    mark_type{YType::enumeration, "mark-type"},
    mark_value{YType::uint16, "mark-value"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::CommonMark::has_data() const
{
    return mark_type.is_set
	|| mark_value.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::CommonMark::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(mark_type.yfilter)
	|| ydk::is_set(mark_value.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::CommonMark::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "common-mark";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::CommonMark::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::CommonMark::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::CommonMark::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::CommonMark::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "mark-type")
    {
        mark_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::CommonMark::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "mark-type")
    {
        mark_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::CommonMark::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark-type" || name == "mark-value")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::MplsMark::MplsMark()
    :
    mark_type{YType::enumeration, "mark-type"},
    mark_value{YType::uint16, "mark-value"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::MplsMark::has_data() const
{
    return mark_type.is_set
	|| mark_value.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::MplsMark::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(mark_type.yfilter)
	|| ydk::is_set(mark_value.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::MplsMark::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "mpls-mark";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::MplsMark::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::MplsMark::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::MplsMark::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::MplsMark::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "mark-type")
    {
        mark_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::MplsMark::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "mark-type")
    {
        mark_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::MplsMark::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark-type" || name == "mark-value")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::Wred()
    :
    wred_match_type{YType::enumeration, "wred-match-type"},
    hardware_min_threshold_bytes{YType::uint32, "hardware-min-threshold-bytes"},
    hardware_max_threshold_bytes{YType::uint32, "hardware-max-threshold-bytes"},
    ...
    segment_size{YType::uint32, "segment-size"}
    	,
    wred_match_value(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue>())
	,config_min_threshold(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMinThreshold>())
	,config_max_threshold(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMaxThreshold>())
{
    wred_match_value->parent = this;
    config_min_threshold->parent = this;
    config_max_threshold->parent = this;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::has_data() const
{
    return wred_match_type.is_set
	|| hardware_min_threshold_bytes.is_set
	|| hardware_max_threshold_bytes.is_set
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(wred_match_type.yfilter)
	|| ydk::is_set(hardware_min_threshold_bytes.yfilter)
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "wred";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "wred-match-value")
    {
        if(wred_match_value == nullptr)
...
std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(wred_match_value != nullptr)
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "wred-match-type")
    {
        wred_match_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "wred-match-type")
    {
        wred_match_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "wred-match-value" || name == "config-min-threshold" || name == "config-max-threshold" || name == "wred-match-type" || name == "hardware-min-threshold-bytes" || name == "hardware-max-threshold-bytes" || name == "first-segment" || name == "segment-size")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::WredMatchValue()
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::has_data() const
{
    for (std::size_t index=0; index<dnx_qosea_show_red_match_value.size(); index++)
    {
        if(dnx_qosea_show_red_match_value[index]->has_data())
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::has_operation() const
{
    for (std::size_t index=0; index<dnx_qosea_show_red_match_value.size(); index++)
    {
        if(dnx_qosea_show_red_match_value[index]->has_operation())
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "wred-match-value";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "dnx-qosea-show-red-match-value")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue>();
        c->parent = this;
        dnx_qosea_show_red_match_value.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "dnx-qosea-show-red-match-value")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::DnxQoseaShowRedMatchValue()
    :
    range_start{YType::uint8, "range-start"},
    range_end{YType::uint8, "range-end"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::has_data() const
{
    return range_start.is_set
	|| range_end.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(range_start.yfilter)
	|| ydk::is_set(range_end.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "dnx-qosea-show-red-match-value";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "range-start")
    {
        range_start = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "range-start")
    {
        range_start.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "range-start" || name == "range-end")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMinThreshold::ConfigMinThreshold()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMinThreshold::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMinThreshold::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMinThreshold::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-min-threshold";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMinThreshold::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMinThreshold::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMinThreshold::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMinThreshold::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMinThreshold::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMinThreshold::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMaxThreshold::ConfigMaxThreshold()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMaxThreshold::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMaxThreshold::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMaxThreshold::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-max-threshold";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMaxThreshold::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMaxThreshold::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMaxThreshold::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMaxThreshold::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMaxThreshold::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::MemberInterfaces::MemberInterface::Classes::Class::Wred::ConfigMaxThreshold::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Classes()
{

    yang_name = "classes"; yang_parent_name = "bundle-interface-single"; is_top_level_class = false; has_list_ancestor = true;
}
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::has_data() const
{
    for (std::size_t index=0; index<class_.size(); index++)
    {
        if(class_[index]->has_data())
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::has_operation() const
{
    for (std::size_t index=0; index<class_.size(); index++)
    {
        if(class_[index]->has_operation())
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "classes";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "class")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class>();
        c->parent = this;
        class_.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "class")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Class()
    :
    level_one_class_name{YType::str, "level-one-class-name"},
    level_two_class_name{YType::str, "level-two-class-name"},
    class_level{YType::enumeration, "class-level"},
    ...
    hardware_policer_excess_burst_bytes{YType::uint32, "hardware-policer-excess-burst-bytes"}
    	,
    config_max_rate(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMaxRate>())
	,config_min_rate(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMinRate>())
	,config_queue_limit(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigQueueLimit>())
	,config_policer_average_rate(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerAverageRate>())
	,config_policer_peak_rate(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerPeakRate>())
	,config_policer_conform_burst(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerConformBurst>())
	,config_policer_excess_burst(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerExcessBurst>())
	,conform_action(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction>())
	,exceed_action(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction>())
	,violate_action(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction>())
{
    config_max_rate->parent = this;
    config_min_rate->parent = this;
    config_queue_limit->parent = this;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::has_data() const
{
    for (std::size_t index=0; index<ip_mark.size(); index++)
    {
        if(ip_mark[index]->has_data())
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::has_operation() const
{
    for (std::size_t index=0; index<ip_mark.size(); index++)
    {
        if(ip_mark[index]->has_operation())
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "class" <<"[level-one-class-name='" <<level_one_class_name <<"']";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "config-max-rate")
    {
        if(config_max_rate == nullptr)
    ...
    if(child_yang_name == "ip-mark")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::IpMark>();
        c->parent = this;
        ip_mark.push_back(c);
        return c;
    }
    ...
    if(child_yang_name == "common-mark")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::CommonMark>();
        c->parent = this;
        common_mark.push_back(c);
        return c;
    }
    ...
    if(child_yang_name == "mpls-mark")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::MplsMark>();
        c->parent = this;
        mpls_mark.push_back(c);
        return c;
    }
    ...
    if(child_yang_name == "wred")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred>();
        c->parent = this;
        wred.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(config_max_rate != nullptr)
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "level-one-class-name")
    {
        level_one_class_name = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "level-one-class-name")
    {
        level_one_class_name.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "config-max-rate" || name == "config-min-rate" || name == "config-queue-limit" || name == "config-policer-average-rate" || name == "config-policer-peak-rate" || name == "config-policer-conform-burst" || name == "config-policer-excess-burst" || name == "conform-action" || name == "exceed-action" || name == "violate-action" || name == "ip-mark" || name == "common-mark" || name == "mpls-mark" || name == "wred" || name == "level-one-class-name" || name == "level-two-class-name" || name == "class-level" || name == "egress-queue-id" || name == "queue-type" || name == "priority-level" || name == "hardware-max-rate-kbps" || name == "hardware-min-rate-kbps" || name == "config-excess-bandwidth-percent" || name == "config-excess-bandwidth-unit" || name == "hardware-excess-bandwidth-weight" || name == "network-min-bandwidth-kbps" || name == "hardware-queue-limit-bytes" || name == "hardware-queue-limit-microseconds" || name == "policer-bucket-id" || name == "policer-stats-handle" || name == "hardware-policer-average-rate-kbps" || name == "hardware-policer-peak-rate-kbps" || name == "hardware-policer-conform-burst-bytes" || name == "hardware-policer-excess-burst-bytes")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMaxRate::ConfigMaxRate()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMaxRate::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMaxRate::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMaxRate::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-max-rate";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMaxRate::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMaxRate::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMaxRate::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMaxRate::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMaxRate::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMaxRate::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMinRate::ConfigMinRate()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMinRate::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMinRate::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMinRate::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-min-rate";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMinRate::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMinRate::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMinRate::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMinRate::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMinRate::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigMinRate::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigQueueLimit::ConfigQueueLimit()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigQueueLimit::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigQueueLimit::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigQueueLimit::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-queue-limit";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigQueueLimit::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigQueueLimit::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigQueueLimit::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigQueueLimit::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigQueueLimit::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigQueueLimit::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerAverageRate::ConfigPolicerAverageRate()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerAverageRate::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerAverageRate::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerAverageRate::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-policer-average-rate";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerAverageRate::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerAverageRate::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerAverageRate::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerAverageRate::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerAverageRate::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerAverageRate::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerPeakRate::ConfigPolicerPeakRate()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerPeakRate::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerPeakRate::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerPeakRate::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-policer-peak-rate";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerPeakRate::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerPeakRate::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerPeakRate::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerPeakRate::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerPeakRate::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerPeakRate::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerConformBurst::ConfigPolicerConformBurst()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerConformBurst::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerConformBurst::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerConformBurst::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-policer-conform-burst";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerConformBurst::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerConformBurst::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerConformBurst::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerConformBurst::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerConformBurst::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerConformBurst::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerExcessBurst::ConfigPolicerExcessBurst()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerExcessBurst::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerExcessBurst::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerExcessBurst::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-policer-excess-burst";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerExcessBurst::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerExcessBurst::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerExcessBurst::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerExcessBurst::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerExcessBurst::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConfigPolicerExcessBurst::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::ConformAction()
    :
    action_type{YType::enumeration, "action-type"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::has_data() const
{
    for (std::size_t index=0; index<mark.size(); index++)
    {
        if(mark[index]->has_data())
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::has_operation() const
{
    for (std::size_t index=0; index<mark.size(); index++)
    {
        if(mark[index]->has_operation())
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "conform-action";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "mark")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::Mark>();
        c->parent = this;
        mark.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "action-type")
    {
        action_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "action-type")
    {
        action_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark" || name == "action-type")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::Mark::Mark()
    :
    mark_type{YType::enumeration, "mark-type"},
    mark_value{YType::uint16, "mark-value"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::Mark::has_data() const
{
    return mark_type.is_set
	|| mark_value.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::Mark::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(mark_type.yfilter)
	|| ydk::is_set(mark_value.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::Mark::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "mark";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::Mark::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::Mark::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::Mark::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::Mark::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "mark-type")
    {
        mark_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::Mark::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "mark-type")
    {
        mark_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ConformAction::Mark::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark-type" || name == "mark-value")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::ExceedAction()
    :
    action_type{YType::enumeration, "action-type"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::has_data() const
{
    for (std::size_t index=0; index<mark.size(); index++)
    {
        if(mark[index]->has_data())
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::has_operation() const
{
    for (std::size_t index=0; index<mark.size(); index++)
    {
        if(mark[index]->has_operation())
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "exceed-action";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "mark")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::Mark>();
        c->parent = this;
        mark.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "action-type")
    {
        action_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "action-type")
    {
        action_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark" || name == "action-type")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::Mark::Mark()
    :
    mark_type{YType::enumeration, "mark-type"},
    mark_value{YType::uint16, "mark-value"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::Mark::has_data() const
{
    return mark_type.is_set
	|| mark_value.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::Mark::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(mark_type.yfilter)
	|| ydk::is_set(mark_value.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::Mark::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "mark";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::Mark::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::Mark::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::Mark::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::Mark::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "mark-type")
    {
        mark_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::Mark::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "mark-type")
    {
        mark_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ExceedAction::Mark::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark-type" || name == "mark-value")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::ViolateAction()
    :
    action_type{YType::enumeration, "action-type"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::has_data() const
{
    for (std::size_t index=0; index<mark.size(); index++)
    {
        if(mark[index]->has_data())
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::has_operation() const
{
    for (std::size_t index=0; index<mark.size(); index++)
    {
        if(mark[index]->has_operation())
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "violate-action";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "mark")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::Mark>();
        c->parent = this;
        mark.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "action-type")
    {
        action_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "action-type")
    {
        action_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark" || name == "action-type")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::Mark::Mark()
    :
    mark_type{YType::enumeration, "mark-type"},
    mark_value{YType::uint16, "mark-value"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::Mark::has_data() const
{
    return mark_type.is_set
	|| mark_value.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::Mark::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(mark_type.yfilter)
	|| ydk::is_set(mark_value.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::Mark::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "mark";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::Mark::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::Mark::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::Mark::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::Mark::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "mark-type")
    {
        mark_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::Mark::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "mark-type")
    {
        mark_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::ViolateAction::Mark::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark-type" || name == "mark-value")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::IpMark::IpMark()
    :
    mark_type{YType::enumeration, "mark-type"},
    mark_value{YType::uint16, "mark-value"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::IpMark::has_data() const
{
    return mark_type.is_set
	|| mark_value.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::IpMark::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(mark_type.yfilter)
	|| ydk::is_set(mark_value.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::IpMark::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "ip-mark";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::IpMark::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::IpMark::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::IpMark::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::IpMark::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "mark-type")
    {
        mark_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::IpMark::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "mark-type")
    {
        mark_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::IpMark::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark-type" || name == "mark-value")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::CommonMark::CommonMark()
    :
    mark_type{YType::enumeration, "mark-type"},
    mark_value{YType::uint16, "mark-value"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::CommonMark::has_data() const
{
    return mark_type.is_set
	|| mark_value.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::CommonMark::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(mark_type.yfilter)
	|| ydk::is_set(mark_value.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::CommonMark::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "common-mark";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::CommonMark::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::CommonMark::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::CommonMark::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::CommonMark::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "mark-type")
    {
        mark_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::CommonMark::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "mark-type")
    {
        mark_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::CommonMark::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark-type" || name == "mark-value")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::MplsMark::MplsMark()
    :
    mark_type{YType::enumeration, "mark-type"},
    mark_value{YType::uint16, "mark-value"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::MplsMark::has_data() const
{
    return mark_type.is_set
	|| mark_value.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::MplsMark::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(mark_type.yfilter)
	|| ydk::is_set(mark_value.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::MplsMark::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "mpls-mark";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::MplsMark::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::MplsMark::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::MplsMark::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::MplsMark::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "mark-type")
    {
        mark_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::MplsMark::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "mark-type")
    {
        mark_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::MplsMark::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mark-type" || name == "mark-value")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::Wred()
    :
    wred_match_type{YType::enumeration, "wred-match-type"},
    hardware_min_threshold_bytes{YType::uint32, "hardware-min-threshold-bytes"},
    hardware_max_threshold_bytes{YType::uint32, "hardware-max-threshold-bytes"},
    ...
    segment_size{YType::uint32, "segment-size"}
    	,
    wred_match_value(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue>())
	,config_min_threshold(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMinThreshold>())
	,config_max_threshold(std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMaxThreshold>())
{
    wred_match_value->parent = this;
    config_min_threshold->parent = this;
    config_max_threshold->parent = this;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::has_data() const
{
    return wred_match_type.is_set
	|| hardware_min_threshold_bytes.is_set
	|| hardware_max_threshold_bytes.is_set
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(wred_match_type.yfilter)
	|| ydk::is_set(hardware_min_threshold_bytes.yfilter)
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "wred";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "wred-match-value")
    {
        if(wred_match_value == nullptr)
...
std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(wred_match_value != nullptr)
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "wred-match-type")
    {
        wred_match_type = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "wred-match-type")
    {
        wred_match_type.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "wred-match-value" || name == "config-min-threshold" || name == "config-max-threshold" || name == "wred-match-type" || name == "hardware-min-threshold-bytes" || name == "hardware-max-threshold-bytes" || name == "first-segment" || name == "segment-size")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::WredMatchValue()
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::has_data() const
{
    for (std::size_t index=0; index<dnx_qosea_show_red_match_value.size(); index++)
    {
        if(dnx_qosea_show_red_match_value[index]->has_data())
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::has_operation() const
{
    for (std::size_t index=0; index<dnx_qosea_show_red_match_value.size(); index++)
    {
        if(dnx_qosea_show_red_match_value[index]->has_operation())
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "wred-match-value";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "dnx-qosea-show-red-match-value")
    {
        auto c = std::make_shared<PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue>();
        c->parent = this;
        dnx_qosea_show_red_match_value.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "dnx-qosea-show-red-match-value")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::DnxQoseaShowRedMatchValue()
    :
    range_start{YType::uint8, "range-start"},
    range_end{YType::uint8, "range-end"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::has_data() const
{
    return range_start.is_set
	|| range_end.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(range_start.yfilter)
	|| ydk::is_set(range_end.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "dnx-qosea-show-red-match-value";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "range-start")
    {
        range_start = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "range-start")
    {
        range_start.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::WredMatchValue::DnxQoseaShowRedMatchValue::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "range-start" || name == "range-end")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMinThreshold::ConfigMinThreshold()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMinThreshold::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMinThreshold::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMinThreshold::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-min-threshold";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMinThreshold::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMinThreshold::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMinThreshold::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMinThreshold::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMinThreshold::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMinThreshold::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
...
PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMaxThreshold::ConfigMaxThreshold()
    :
    policy_value{YType::uint32, "policy-value"},
    policy_unit{YType::enumeration, "policy-unit"}
{
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMaxThreshold::has_data() const
{
    return policy_value.is_set
	|| policy_unit.is_set;
}

bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMaxThreshold::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_value.yfilter)
	|| ydk::is_set(policy_unit.yfilter);
...
std::string PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMaxThreshold::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "config-max-threshold";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMaxThreshold::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMaxThreshold::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMaxThreshold::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMaxThreshold::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-value")
    {
        policy_value = value;
...
void PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMaxThreshold::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-value")
    {
        policy_value.yfilter = yfilter;
...
bool PlatformQos::Nodes::Node::BundleInterfaceSingles::BundleInterfaceSingle::Classes::Class::Wred::ConfigMaxThreshold::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-value" || name == "policy-unit")
        return true;
    return false;
