    ...
    nodes(std::make_shared<MacsecPlatform::Nodes>())
{
    ...
    yang_name = "macsec-platform"; yang_parent_name = "Cisco-IOS-XR-crypto-macsec-pl-oper";
}
...
const EntityPath MacsecPlatform::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor != nullptr)
    {
...
{
    yang_name = "nodes"; yang_parent_name = "macsec-platform";
}
...
const EntityPath MacsecPlatform::Nodes::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'Interfaces' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'Interface' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "hw-flow-s" || name == "hw-sas" || name == "hw-statistics" || name == "sw-statistics" || name == "name")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'HwStatistics' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
	...
	,xlfpga_stats(std::make_shared<MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::XlfpgaStats>())
{
    ...
    yang_name = "ext"; yang_parent_name = "hw-statistics";
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'Ext' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "es200-stats" || name == "msfpga-stats" || name == "xlfpga-stats" || name == "type")
        return true;
    return false;
}
	...
	,tx_sa_stats(std::make_shared<MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::MsfpgaStats::TxSaStats>())
{
    ...
    yang_name = "msfpga-stats"; yang_parent_name = "ext";
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::MsfpgaStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'MsfpgaStats' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "rx-interface-macsec-stats" || name == "rx-sa-stats" || name == "tx-interface-macsec-stats" || name == "tx-sa-stats")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::MsfpgaStats::TxSaStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'TxSaStats' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "out-octets-encrypted" || name == "out-octets-protected" || name == "out-pkts-encrypted" || name == "out-pkts-protected")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::MsfpgaStats::RxSaStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'RxSaStats' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "in-octets-decrypted" || name == "in-octets-validated" || name == "in-pkts-delayed" || name == "in-pkts-invalid" || name == "in-pkts-late" || name == "in-pkts-not-using-sa" || name == "in-pkts-not-valid" || name == "in-pkts-ok" || name == "in-pkts-unchecked" || name == "in-pkts-unused-sa")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::MsfpgaStats::TxInterfaceMacsecStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'TxInterfaceMacsecStats' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "out-pkt-too-long" || name == "out-pkt-uncontrolled" || name == "out-pkt-untagged")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::MsfpgaStats::RxInterfaceMacsecStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'RxInterfaceMacsecStats' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "in-pkt-bad-tag" || name == "in-pkt-no-sci" || name == "in-pkt-notag" || name == "in-pkt-overrun" || name == "in-pkt-tagged" || name == "in-pkt-uncontrolled" || name == "in-pkt-unknown-sci" || name == "in-pkt-untagged")
        return true;
    return false;
}
	...
	,macsec_tx_stats(std::make_shared<MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::XlfpgaStats::MacsecTxStats>())
{
    ...
    yang_name = "xlfpga-stats"; yang_parent_name = "ext";
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::XlfpgaStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'XlfpgaStats' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "macsec-rx-stats" || name == "macsec-tx-stats")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::XlfpgaStats::MacsecTxStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'MacsecTxStats' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "current-an" || name == "sa-encrypted-pkts" || name == "sc-bypass-pkts" || name == "sc-dropped-pkts" || name == "sc-eapol-pkts" || name == "sc-encrypted-octets" || name == "sc-encrypted-pkts" || name == "sc-overrun-pkts" || name == "sc-toolong-pkts" || name == "sc-untagged-pkts")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::XlfpgaStats::MacsecRxStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'MacsecRxStats' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "rx-sa-stat" || name == "sc-bad-tag-pkts" || name == "sc-bypass-pkts" || name == "sc-decrypted-octets" || name == "sc-delayed-pkts" || name == "sc-dropped-pkts" || name == "sc-eapol-pkts" || name == "sc-invalid-pkts" || name == "sc-late-pkts" || name == "sc-no-sci-pkts" || name == "sc-no-tag-pkts" || name == "sc-not-using-pkts" || name == "sc-not-valid-pkts" || name == "sc-ok-pkts" || name == "sc-overrun-pkts" || name == "sc-unchecked-pkts" || name == "sc-unknown-sci-pkts" || name == "sc-untagged-pkts" || name == "sc-unused-pkts")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::XlfpgaStats::MacsecRxStats::RxSaStat::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'RxSaStat' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "an" || name == "sa-invalid-pkts" || name == "sa-not-using-pkts" || name == "sa-not-valid-pkts" || name == "sa-ok-pkts" || name == "sa-unused-pkts")
        return true;
    return false;
}
	...
	,tx_sc_macsec_stats(std::make_shared<MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::Es200Stats::TxScMacsecStats>())
{
    ...
    yang_name = "es200-stats"; yang_parent_name = "ext";
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::Es200Stats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'Es200Stats' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "rx-interface-macsec-stats" || name == "rx-port-stats" || name == "rx-sa-stats" || name == "rx-sc-macsec-stats" || name == "tx-interface-macsec-stats" || name == "tx-port-stats" || name == "tx-sa-stats" || name == "tx-sc-macsec-stats")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::Es200Stats::TxSaStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    if(name == "out-octets-encrypted-protected1" || name == "out-pkts-encrypted-protected" || name == "out-pkts-too-long")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::Es200Stats::RxSaStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    if(name == "in-octets-decrypted-validated1" || name == "in-octets-validated" || name == "in-pkts-delayed" || name == "in-pkts-invalid" || name == "in-pkts-late" || name == "in-pkts-not-using-sa" || name == "in-pkts-not-valid" || name == "in-pkts-ok" || name == "in-pkts-unchecked" || name == "in-pkts-unused-sa")
        return true;
    return false;
}
...
{
    yang_name = "tx-sc-macsec-stats"; yang_parent_name = "es200-stats";
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::Es200Stats::TxScMacsecStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'TxScMacsecStats' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    yang_name = "rx-sc-macsec-stats"; yang_parent_name = "es200-stats";
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::Es200Stats::RxScMacsecStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'RxScMacsecStats' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::Es200Stats::TxInterfaceMacsecStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::Es200Stats::RxInterfaceMacsecStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    if(name == "in-bcast-pkts-ctrl" || name == "in-bcast-pkts-unctrl" || name == "in-drop-pkts-class" || name == "in-drop-pkts-data" || name == "in-mcast-pkts-ctrl" || name == "in-mcast-pkts-unctrl" || name == "in-octets-ctrl" || name == "in-octets-unctrl" || name == "in-pkt-bad-tag" || name == "in-pkt-ctrl" || name == "in-pkt-no-sci" || name == "in-pkt-no-tag" || name == "in-pkts-tagged-ctrl" || name == "in-pkts-unknown-sci" || name == "in-pkts-untagged" || name == "in-rx-drop-pkts-ctrl" || name == "in-rx-drop-pkts-unctrl" || name == "in-rx-error-pkts-ctrl" || name == "in-rx-error-pkts-unctrl" || name == "in-ucast-pkts-ctrl" || name == "in-ucast-pkts-unctrl" || name == "transform-error-pkts")
        return true;
    return false;
}
...
{
    yang_name = "tx-port-stats"; yang_parent_name = "es200-stats";
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::Es200Stats::TxPortStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'TxPortStats' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "flow-miss" || name == "multi-flow-match" || name == "parser-dropped" || name == "pkts-ctrl" || name == "pkts-data" || name == "pkts-dropped" || name == "pkts-err-in")
        return true;
    return false;
}
...
MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::Es200Stats::RxPortStats::RxPortStats()
    ...
    pkts_err_in{YType::uint64, "pkts-err-in"}
{
    yang_name = "rx-port-stats"; yang_parent_name = "es200-stats";
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwStatistics::Ext::Es200Stats::RxPortStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'RxPortStats' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'HwSas' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    std::ostringstream path_buffer;
    path_buffer << "hw-sa" <<"[sa-id='" <<sa_id <<"']";

    return path_buffer.str();

}

const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'HwSa' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
	...
	,xlfpga_sa(std::make_shared<MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::Ext::XlfpgaSa>())
{
    ...
    yang_name = "ext"; yang_parent_name = "hw-sa";
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::Ext::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    if(name == "es200-sa" || name == "msfpga-sa" || name == "xlfpga-sa" || name == "type")
        return true;
    return false;
}
	...
	,tx_sa(std::make_shared<MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::Ext::MsfpgaSa::TxSa>())
{
    ...
    yang_name = "msfpga-sa"; yang_parent_name = "ext";
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::Ext::MsfpgaSa::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'MsfpgaSa' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::Ext::MsfpgaSa::TxSa::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'TxSa' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "action" || name == "an" || name == "c-offset" || name == "crypto-algo" || name == "in-use" || name == "is-egress" || name == "key-len" || name == "next-pn" || name == "q-bit" || name == "qq-bit" || name == "sa-id" || name == "sci" || name == "valid" || name == "xpn")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::Ext::MsfpgaSa::RxSa::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'RxSa' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
	...
	,tx_sa(std::make_shared<MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::Ext::XlfpgaSa::TxSa>())
{
    ...
    yang_name = "xlfpga-sa"; yang_parent_name = "ext";
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::Ext::XlfpgaSa::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'XlfpgaSa' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::Ext::XlfpgaSa::TxSa::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    if(name == "an" || name == "cipher-suite" || name == "confidentiality-offset" || name == "crc-value" || name == "current-packet-num" || name == "fcs-err-cfg" || name == "initial-packet-number" || name == "max-packet-num" || name == "protection-enable" || name == "sectag-length" || name == "secure-channel-id" || name == "secure-mode" || name == "ssci")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::Ext::XlfpgaSa::RxSa::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    if(name == "an" || name == "auth-err-cfg" || name == "cipher-suite" || name == "confidentiality-offset" || name == "crc-value" || name == "current-packet-num" || name == "fcs-err-cfg" || name == "lowest-acceptable-packet-num" || name == "max-packet-num" || name == "next-expected-packet-num" || name == "num-an-in-use" || name == "pkt-tagged-detected" || name == "pkt-tagged-validated" || name == "pkt-untagged-detected" || name == "protection-enable" || name == "recent-an" || name == "replay-protect-mode" || name == "replay-window" || name == "secure-channel-id" || name == "secure-mode" || name == "ssci" || name == "validation-mode")
        return true;
    return false;
}
    ...
    tx_sa(std::make_shared<MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::Ext::Es200Sa::TxSa>())
{
    ...
    yang_name = "es200-sa"; yang_parent_name = "ext";
}
...
{
    for (std::size_t index=0; index<rx_sa.size(); index++)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::Ext::Es200Sa::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'Es200Sa' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    return current_pkt_number.is_set
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::Ext::Es200Sa::TxSa::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    if(name == "xform-params" || name == "current-pkt-number" || name == "initial-pkt-number" || name == "is-valid" || name == "max-pkt-number" || name == "out-octets-encrypted-protected1" || name == "out-pkts-encrypted-protected" || name == "out-pkts-too-long" || name == "sa-id" || name == "sc-no")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::Ext::Es200Sa::TxSa::XformParams::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'XformParams' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "aes-key-len" || name == "assoc-num" || name == "bgen-auth-key" || name == "crypt-algo" || name == "is-egress-tr" || name == "is-seq-num64-bit" || name == "replay-win-size")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::Ext::Es200Sa::RxSa::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    if(name == "xform-params" || name == "in-octets-decrypted-validated1" || name == "in-octets-validated" || name == "in-pkts-delayed" || name == "in-pkts-invalid" || name == "in-pkts-late" || name == "in-pkts-not-using-sa" || name == "in-pkts-not-valid" || name == "in-pkts-ok" || name == "in-pkts-unchecked" || name == "in-pkts-unused-sa" || name == "is-valid" || name == "sa-id" || name == "sc-no")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwSas::HwSa::Ext::Es200Sa::RxSa::XformParams::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwFlowS::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'HwFlowS' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    std::ostringstream path_buffer;
    path_buffer << "hw-flow" <<"[flow-id='" <<flow_id <<"']";

    return path_buffer.str();

}

const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwFlowS::HwFlow::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'HwFlow' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
	...
	,msfpga_flow(std::make_shared<MacsecPlatform::Nodes::Node::Interfaces::Interface::HwFlowS::HwFlow::Ext::MsfpgaFlow>())
{
    ...
    yang_name = "ext"; yang_parent_name = "hw-flow";
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwFlowS::HwFlow::Ext::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    if(name == "es200-flow" || name == "msfpga-flow" || name == "type")
        return true;
    return false;
}
	...
	,tx_flow(std::make_shared<MacsecPlatform::Nodes::Node::Interfaces::Interface::HwFlowS::HwFlow::Ext::MsfpgaFlow::TxFlow>())
{
    ...
    yang_name = "msfpga-flow"; yang_parent_name = "ext";
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwFlowS::HwFlow::Ext::MsfpgaFlow::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'MsfpgaFlow' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwFlowS::HwFlow::Ext::MsfpgaFlow::TxFlow::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'TxFlow' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "action" || name == "ctrl-check" || name == "dmac-inuse" || name == "ethertype" || name == "flow-id" || name == "in-use" || name == "inner-vlan" || name == "inner-vlan-tpid" || name == "inner-vlan-up" || name == "is-ctrl-pkt" || name == "is-egress" || name == "macda" || name == "macsa" || name == "match-bad-tag" || name == "match-kay-tag" || name == "match-pri" || name == "match-tagged" || name == "match-untagged" || name == "outer-vlan" || name == "outer-vlan-tpid" || name == "outer-vlan-up" || name == "sai" || name == "sci" || name == "sci-inuse" || name == "smac-inuse" || name == "source-port" || name == "source-port-chk" || name == "tci" || name == "tci-an" || name == "tci-an-chk" || name == "tci-c" || name == "tci-chk" || name == "tci-e-xr" || name == "tci-sc" || name == "tci-scb" || name == "tci-v" || name == "valid")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwFlowS::HwFlow::Ext::MsfpgaFlow::RxFlow::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'RxFlow' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
	...
	,tx_flow(std::make_shared<MacsecPlatform::Nodes::Node::Interfaces::Interface::HwFlowS::HwFlow::Ext::Es200Flow::TxFlow>())
{
    ...
    yang_name = "es200-flow"; yang_parent_name = "ext";
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwFlowS::HwFlow::Ext::Es200Flow::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'Es200Flow' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwFlowS::HwFlow::Ext::Es200Flow::TxFlow::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    if(name == "drop" || name == "ethertype" || name == "flow-hits" || name == "flow-no" || name == "force-ctrl" || name == "inner-vlan-dei" || name == "inner-vlan-id" || name == "inner-vlan-user-pri" || name == "is-flow-enabled" || name == "macda" || name == "mask-da" || name == "mask-ethertype" || name == "mask-plain-bits" || name == "match-priority" || name == "mpls1-bos" || name == "mpls1-exp" || name == "mpls1-label" || name == "mpls2-bos" || name == "mpls2-exp" || name == "mpls2-label" || name == "outer-vlan-dei" || name == "outer-vlan-id" || name == "outer-vlan-user-pri" || name == "pbb-bvid" || name == "pbb-dei" || name == "pbb-pcp" || name == "pbb-sid" || name == "pkt-type" || name == "plain-bits" || name == "plain-bits-size" || name == "psci" || name == "tag-num" || name == "tci" || name == "tci-c" || name == "tci-chk" || name == "tci-e-xr" || name == "tci-sc" || name == "tci-scb" || name == "tci-v")
        return true;
    return false;
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::HwFlowS::HwFlow::Ext::Es200Flow::RxFlow::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'SwStatistics' in Cisco_IOS_XR_crypto_macsec_pl_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
	...
	,xlfpga_stats(std::make_shared<MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::XlfpgaStats>())
{
    ...
    yang_name = "ext"; yang_parent_name = "sw-statistics";
}
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::MsfpgaStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::MsfpgaStats::TxSaStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::MsfpgaStats::RxSaStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::MsfpgaStats::TxInterfaceMacsecStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::MsfpgaStats::RxInterfaceMacsecStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::XlfpgaStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::XlfpgaStats::MacsecTxStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::XlfpgaStats::MacsecRxStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::XlfpgaStats::MacsecRxStats::RxSaStat::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::Es200Stats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::Es200Stats::TxSaStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::Es200Stats::RxSaStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::Es200Stats::TxScMacsecStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::Es200Stats::RxScMacsecStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::Es200Stats::TxInterfaceMacsecStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::Es200Stats::RxInterfaceMacsecStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::Es200Stats::TxPortStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath MacsecPlatform::Nodes::Node::Interfaces::Interface::SwStatistics::Ext::Es200Stats::RxPortStats::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const Enum::YLeaf MacsecCard::macsec_none {0, "macsec-none"};
const Enum::YLeaf MacsecCard::macsec_msfpga {1, "macsec-msfpga"};
const Enum::YLeaf MacsecCard::macsec_xlmsfpga {2, "macsec-xlmsfpga"};
const Enum::YLeaf MacsecCard::macsec_apm {3, "macsec-apm"};
