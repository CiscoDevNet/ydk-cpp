...
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<slice_table.len(); index++)
    {
...
OpticalInterface::OpticalChannelInterfaces::OpticalChannelInterfaces()
    :
    optical_channel_interface(this, {"location"})
{
...
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<optical_channel_interface.len(); index++)
    {
...
{
    std::ostringstream path_buffer;
    path_buffer << "optical-channel-interface";
...
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<operational_mode.len(); index++)
    {
...
OpticalInterface::OpticalLogicalInterfaces::OpticalLogicalInterfaces()
    :
    optical_logical_interface(this, {"index_"})
{
...
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<optical_logical_interface.len(); index++)
    {
...
{
    std::ostringstream path_buffer;
    path_buffer << "optical-logical-interface";
    ADD_KEY_TOKEN(index_, "index");
    return path_buffer.str();
}
...
OpticalInterface::OpticalLogicalInterfaces::OpticalLogicalInterface::OpticalLogicalInterfaceLogicalChannelAssignments::OpticalLogicalInterfaceLogicalChannelAssignments()
    :
    optical_logical_interface_logical_channel_assignment(this, {"index_"})
{
...
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<optical_logical_interface_logical_channel_assignment.len(); index++)
    {
...
{
    std::ostringstream path_buffer;
    path_buffer << "optical-logical-interface-logical-channel-assignment";
    ADD_KEY_TOKEN(index_, "index");
    return path_buffer.str();
}
