...
{
    if(name == "profile-name" || name == "relay-profile-broadcast-flag-policy" || name == "relay-profile-gi-addr" || name == "relay-profile-gi-addr-policy" || name == "relay-profile-helper-address" || name == "relay-profile-helper-count" || name == "relay-profile-helper-vrf" || name == "relay-profile-mac-mismatch-action" || name == "relay-profile-name" || name == "relay-profile-relay-info-allow-untrusted" || name == "relay-profile-relay-info-check" || name == "relay-profile-relay-info-option" || name == "relay-profile-relay-info-optionvpn" || name == "relay-profile-relay-info-optionvpn-mode" || name == "relay-profile-relay-info-policy" || name == "relay-profile-uid")
        return true;
    return false;
}
