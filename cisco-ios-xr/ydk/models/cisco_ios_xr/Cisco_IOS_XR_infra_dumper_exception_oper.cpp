...
std::shared_ptr<ydk::Entity> Exception::Enter::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::Enter::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(display_config1 != nullptr)
    {
        _children["display-config1"] = display_config1;
    }

    if(display_config2 != nullptr)
    {
        _children["display-config2"] = display_config2;
    }

    if(display_config3 != nullptr)
    {
        _children["display-config3"] = display_config3;
    }

    if(display_fall_back_config1 != nullptr)
    {
        _children["display-fall-back-config1"] = display_fall_back_config1;
    }

    if(display_fall_back_config2 != nullptr)
    {
        _children["display-fall-back-config2"] = display_fall_back_config2;
    }

    if(display_fall_back_config3 != nullptr)
    {
        _children["display-fall-back-config3"] = display_fall_back_config3;
    }

    if(kernel_config != nullptr)
    {
        _children["kernel-config"] = kernel_config;
    }

    if(kernel_route_config != nullptr)
    {
        _children["kernel-route-config"] = kernel_route_config;
    }

    if(core_size != nullptr)
    {
        _children["core-size"] = core_size;
    }
    ...
    if(proc_size != nullptr)
    {
        _children["proc-size"] = proc_size;
    }

    if(qsize != nullptr)
    {
        _children["qsize"] = qsize;
    }
...
std::shared_ptr<ydk::Entity> Exception::Enter::DisplayConfig1::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::Enter::DisplayConfig1::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Exception::Enter::DisplayConfig2::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::Enter::DisplayConfig2::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Exception::Enter::DisplayConfig3::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::Enter::DisplayConfig3::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Exception::Enter::DisplayFallBackConfig1::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::Enter::DisplayFallBackConfig1::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Exception::Enter::DisplayFallBackConfig2::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::Enter::DisplayFallBackConfig2::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Exception::Enter::DisplayFallBackConfig3::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::Enter::DisplayFallBackConfig3::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Exception::Enter::KernelConfig::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::Enter::KernelConfig::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Exception::Enter::KernelRouteConfig::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::Enter::KernelRouteConfig::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Exception::Enter::CoreSize::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::Enter::CoreSize::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Exception::Enter::MemoryThreshold::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::Enter::MemoryThreshold::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Exception::Enter::ProcSize::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::Enter::ProcSize::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Exception::Enter::Qsize::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Exception::Enter::Qsize::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
