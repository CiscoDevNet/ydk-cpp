...
{
    if(name == "service-layer" || name == "port" || name == "vrf" || name == "enable" || name == "max-request-per-user" || name == "no-tls" || name == "tls-trustpoint" || name == "address-family" || name == "tls-mutual" || name == "max-request-total")
        return true;
    return false;
}
