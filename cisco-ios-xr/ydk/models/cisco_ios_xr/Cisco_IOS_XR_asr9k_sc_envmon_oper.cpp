...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(rack_clis != nullptr)
    {
        children["rack-clis"] = rack_clis;
    }
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::clone_ptr() const
{
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::RackClis::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::RackClis::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::RackClis::RackCli::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::RackClis::RackCli::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(slot_clis != nullptr)
    {
        children["slot-clis"] = slot_clis;
    }
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(module_clis != nullptr)
    {
        children["module-clis"] = module_clis;
    }
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(sensor_type_clis != nullptr)
    {
        children["sensor-type-clis"] = sensor_type_clis;
    }

    if(power_cli != nullptr)
    {
        children["power-cli"] = power_cli;
    }
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::SensorTypeClis::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::SensorTypeClis::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::SensorTypeClis::SensorTypeCli::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::SensorTypeClis::SensorTypeCli::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(sensor_name_clis != nullptr)
    {
        children["sensor-name-clis"] = sensor_name_clis;
    }
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::SensorTypeClis::SensorTypeCli::SensorNameClis::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::SensorTypeClis::SensorTypeCli::SensorNameClis::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::SensorTypeClis::SensorTypeCli::SensorNameClis::SensorNameCli::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::SensorTypeClis::SensorTypeCli::SensorNameClis::SensorNameCli::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(value_detailed_cli != nullptr)
    {
        children["value-detailed-cli"] = value_detailed_cli;
    }

    if(threshold_clis != nullptr)
    {
        children["threshold-clis"] = threshold_clis;
    }
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::SensorTypeClis::SensorTypeCli::SensorNameClis::SensorNameCli::ValueDetailedCli::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::SensorTypeClis::SensorTypeCli::SensorNameClis::SensorNameCli::ValueDetailedCli::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::SensorTypeClis::SensorTypeCli::SensorNameClis::SensorNameCli::ThresholdClis::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::SensorTypeClis::SensorTypeCli::SensorNameClis::SensorNameCli::ThresholdClis::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::SensorTypeClis::SensorTypeCli::SensorNameClis::SensorNameCli::ThresholdClis::ThresholdCli::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "value-detailed-cli")
    {
        if(value_detailed_cli == nullptr)
...
std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::SensorTypeClis::SensorTypeCli::SensorNameClis::SensorNameCli::ThresholdClis::ThresholdCli::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(value_detailed_cli != nullptr)
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::SensorTypeClis::SensorTypeCli::SensorNameClis::SensorNameCli::ThresholdClis::ThresholdCli::ValueDetailedCli::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::SensorTypeClis::SensorTypeCli::SensorNameClis::SensorNameCli::ThresholdClis::ThresholdCli::ValueDetailedCli::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::PowerCli::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::PowerCli::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(power_bag_cli != nullptr)
    {
        children["power-bag-cli"] = power_bag_cli;
    }
...
std::shared_ptr<Entity> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::PowerCli::PowerBagCli::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> EnvironmentalMonitoringCli::RackClis::RackCli::SlotClis::SlotCli::ModuleClis::ModuleCli::PowerCli::PowerBagCli::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
