...
#include "Cisco_IOS_XR_upgrade_fpd_admin_cfg.hpp"

using namespace ydk;

namespace cisco_ios_xr {
namespace Cisco_IOS_XR_upgrade_fpd_admin_cfg {

Fpd::Fpd()
    :
    auto_upgrade{YType::boolean, "auto-upgrade"},
    auto_reload{YType::boolean, "auto-reload"}
{

    yang_name = "fpd"; yang_parent_name = "Cisco-IOS-XR-upgrade-fpd-admin-cfg"; is_top_level_class = true; has_list_ancestor = false; 
}
...
std::string Fpd::get_segment_path() const
{
    ...
    path_buffer << "Cisco-IOS-XR-upgrade-fpd-admin-cfg:fpd";
...
{
    if(name == "auto-upgrade" || name == "auto-reload")
        return true;
    return false;
}
