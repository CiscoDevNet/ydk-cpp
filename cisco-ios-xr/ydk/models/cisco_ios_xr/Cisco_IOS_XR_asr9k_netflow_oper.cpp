...
NetFlow::Statistics::Statistic::Producer::Statistics_::Statistics_()
    ...
    section_ingress_flows{YType::uint64, "section-ingress-flows"},
...
bool NetFlow::Statistics::Statistic::Producer::Statistics_::has_operation() const
{
	...
	|| ydk::is_set(section_ingress_flows.yfilter)
...
std::vector<std::pair<std::string, LeafData> > NetFlow::Statistics::Statistic::Producer::Statistics_::get_name_leaf_data() const
{
    ...
    if (section_ingress_flows.is_set || is_set(section_ingress_flows.yfilter)) leaf_name_data.push_back(section_ingress_flows.get_name_leafdata());
...
void NetFlow::Statistics::Statistic::Producer::Statistics_::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    ...
    if(value_path == "section-ingress-flows")
    {
        section_ingress_flows = value;
        section_ingress_flows.value_namespace = name_space;
        section_ingress_flows.value_namespace_prefix = name_space_prefix;
    }
...
void NetFlow::Statistics::Statistic::Producer::Statistics_::set_filter(const std::string & value_path, YFilter yfilter)
{
    ...
    if(value_path == "section-ingress-flows")
    {
        section_ingress_flows.yfilter = yfilter;
    }
    if(value_path == "drops-no-space")
    {
...
{
    if(name == "ipv4-ingress-flows" || name == "ipv4-egress-flows" || name == "ipv6-ingress-flows" || name == "ipv6-egress-flows" || name == "mpls-ingress-flows" || name == "mpls-egress-flows" || name == "section-ingress-flows" || name == "drops-no-space" || name == "drops-others" || name == "unknown-ingress-flows" || name == "unknown-egress-flows" || name == "waiting-servers" || name == "spp-rx-counts" || name == "flow-packet-counts" || name == "last-cleared")
        return true;
    return false;
}
