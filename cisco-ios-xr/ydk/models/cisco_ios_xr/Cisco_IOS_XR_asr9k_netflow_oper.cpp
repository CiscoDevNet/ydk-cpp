...
{
    if(name == "ipv4-ingress-flows" || name == "ipv4-egress-flows" || name == "ipv6-ingress-flows" || name == "ipv6-egress-flows" || name == "mpls-ingress-flows" || name == "mpls-egress-flows" || name == "drops-no-space" || name == "drops-others" || name == "unknown-ingress-flows" || name == "unknown-egress-flows" || name == "waiting-servers" || name == "spp-rx-counts" || name == "flow-packet-counts" || name == "last-cleared")
        return true;
    return false;
}
