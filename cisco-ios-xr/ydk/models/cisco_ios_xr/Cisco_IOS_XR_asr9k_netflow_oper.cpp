...
{
    if(name == "drops-no-space" || name == "drops-others" || name == "flow-packet-counts" || name == "ipv4-egress-flows" || name == "ipv4-ingress-flows" || name == "ipv6-egress-flows" || name == "ipv6-ingress-flows" || name == "last-cleared" || name == "mpls-egress-flows" || name == "mpls-ingress-flows" || name == "spp-rx-counts" || name == "unknown-egress-flows" || name == "unknown-ingress-flows" || name == "waiting-servers")
        return true;
    return false;
}
