#ifndef _CISCO_IOS_XR_SLICE_MGR_PROXY_CFG_
#define _CISCO_IOS_XR_SLICE_MGR_PROXY_CFG_
...
class NodePath : public ydk::Entity
{
    public:
        NodePath();
        ~NodePath();
...
class NodePath::Node : public ydk::Entity
{
    public:
        Node();
        ~Node();
        ...
        class SliceIds; //type: NodePath::Node::SliceIds

        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_slice_mgr_proxy_cfg::NodePath::Node::SliceIds> slice_ids;
        
}; // NodePath::Node


class NodePath::Node::SliceIds : public ydk::Entity
{
    public:
        SliceIds();
        ~SliceIds();
...
class NodePath::Node::SliceIds::SliceId : public ydk::Entity
{
    public:
        SliceId();
        ~SliceId();
...
#endif /* _CISCO_IOS_XR_SLICE_MGR_PROXY_CFG_ */
