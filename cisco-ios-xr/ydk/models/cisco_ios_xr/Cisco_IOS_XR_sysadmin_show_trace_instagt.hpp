#ifndef _CISCO_IOS_XR_SYSADMIN_SHOW_TRACE_INSTAGT_
#define _CISCO_IOS_XR_SYSADMIN_SHOW_TRACE_INSTAGT_
...
class Instagt : public ydk::Entity
{
    public:
        Instagt();
        ~Instagt();
...
class Instagt::Trace : public ydk::Entity
{
    public:
        Trace();
        ~Trace();
...
class Instagt::Trace::Location : public ydk::Entity
{
    public:
        Location();
        ~Location();
...
class Instagt::Trace::Location::AllOptions : public ydk::Entity
{
    public:
        AllOptions();
        ~AllOptions();
...
class Instagt::Trace::Location::AllOptions::TraceBlocks : public ydk::Entity
{
    public:
        TraceBlocks();
        ~TraceBlocks();
...
#endif /* _CISCO_IOS_XR_SYSADMIN_SHOW_TRACE_INSTAGT_ */
