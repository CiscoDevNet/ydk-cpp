...
std::vector<std::pair<std::string, LeafData> > Locale::get_name_leaf_data() const
{
...
std::shared_ptr<ydk::Entity> Locale::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Locale::get_children() const
{
...
std::shared_ptr<ydk::Entity> Locale::clone_ptr() const
{
