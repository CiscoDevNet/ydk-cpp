...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::get_children() const
{
    ...
    if(switch_debug_cont != nullptr)
    {
        _children["switch-debug-cont"] = switch_debug_cont;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Vlan::get_children() const
{
    ...
    if(vlan_detail != nullptr)
    {
        _children["vlan-detail"] = vlan_detail;
    }
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Vlan::Rules::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "location")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Vlan::Rules::Location>();
        ent_->parent = this;
        location.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Vlan::Rules::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Vlan::Rules::Location::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "port-iter")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Vlan::Rules::Location::PortIter>();
        ent_->parent = this;
        port_iter.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Vlan::Rules::Location::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Vlan::Rules::Location::PortIter::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "vlan-id")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Vlan::Rules::Location::PortIter::VlanId>();
        ent_->parent = this;
        vlan_id.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Vlan::Rules::Location::PortIter::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Vlan::Rules::Location::PortIter::VlanId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "rule-id")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Vlan::Rules::Location::PortIter::VlanId::RuleId>();
        ent_->parent = this;
        rule_id.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Vlan::Rules::Location::PortIter::VlanId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : rule_id.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Vlan::Rules::Location::PortIter::VlanId::RuleId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Vlan::Rules::Location::PortIter::VlanId::RuleId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Vlan::VlanDetail::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "vlan-id")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Vlan::VlanDetail::VlanId>();
        ent_->parent = this;
        vlan_id.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Vlan::VlanDetail::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Vlan::VlanDetail::VlanId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "rules")
    {
        if(rules == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Vlan::VlanDetail::VlanId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(rules != nullptr)
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Vlan::VlanDetail::VlanId::Rules::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "location")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Vlan::VlanDetail::VlanId::Rules::Location>();
        ent_->parent = this;
        location.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Vlan::VlanDetail::VlanId::Rules::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Vlan::VlanDetail::VlanId::Rules::Location::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "port-iter")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Vlan::VlanDetail::VlanId::Rules::Location::PortIter>();
        ent_->parent = this;
        port_iter.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Vlan::VlanDetail::VlanId::Rules::Location::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Vlan::VlanDetail::VlanId::Rules::Location::PortIter::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "rule-id")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Vlan::VlanDetail::VlanId::Rules::Location::PortIter::RuleId>();
        ent_->parent = this;
        rule_id.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Vlan::VlanDetail::VlanId::Rules::Location::PortIter::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Vlan::VlanDetail::VlanId::Rules::Location::PortIter::RuleId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Vlan::VlanDetail::VlanId::Rules::Location::PortIter::RuleId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Esd::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "instance")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Esd::Instance>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Esd::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Esd::Instance::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "trace")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Esd::Instance::Trace>();
        ent_->parent = this;
        trace.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Esd::Instance::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Esd::Instance::Trace::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "location")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Esd::Instance::Trace::Location>();
        ent_->parent = this;
        location.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Esd::Instance::Trace::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Esd::Instance::Trace::Location::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "all-options")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Esd::Instance::Trace::Location::AllOptions>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Esd::Instance::Trace::Location::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Esd::Instance::Trace::Location::AllOptions::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "trace-blocks")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Esd::Instance::Trace::Location::AllOptions::TraceBlocks>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Esd::Instance::Trace::Location::AllOptions::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Esd::Instance::Trace::Location::AllOptions::TraceBlocks::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Esd::Instance::Trace::Location::AllOptions::TraceBlocks::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(port_statistics != nullptr)
    {
        _children["port-statistics"] = port_statistics;
    }

    if(global_statistics != nullptr)
    {
        _children["global-statistics"] = global_statistics;
    }

    if(policers != nullptr)
    {
        _children["policers"] = policers;
    }

    if(sdr_detail != nullptr)
    {
        _children["sdr-detail"] = sdr_detail;
    }
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::PortStatistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "location")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::PortStatistics::Location>();
        ent_->parent = this;
        location.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::PortStatistics::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::PortStatistics::Location::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "port-iter")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::PortStatistics::Location::PortIter>();
        ent_->parent = this;
        port_iter.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::PortStatistics::Location::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::PortStatistics::Location::PortIter::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "sdr-id")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::PortStatistics::Location::PortIter::SdrId>();
        ent_->parent = this;
        sdr_id.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::PortStatistics::Location::PortIter::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::PortStatistics::Location::PortIter::SdrId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "traffic-type-id")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::PortStatistics::Location::PortIter::SdrId::TrafficTypeId>();
        ent_->parent = this;
        traffic_type_id.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::PortStatistics::Location::PortIter::SdrId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : traffic_type_id.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::PortStatistics::Location::PortIter::SdrId::TrafficTypeId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "direction-id")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::PortStatistics::Location::PortIter::SdrId::TrafficTypeId::DirectionId>();
        ent_->parent = this;
        direction_id.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::PortStatistics::Location::PortIter::SdrId::TrafficTypeId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : direction_id.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::PortStatistics::Location::PortIter::SdrId::TrafficTypeId::DirectionId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::PortStatistics::Location::PortIter::SdrId::TrafficTypeId::DirectionId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::GlobalStatistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "location")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::GlobalStatistics::Location>();
        ent_->parent = this;
        location.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::GlobalStatistics::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::GlobalStatistics::Location::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "sdr-id")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::GlobalStatistics::Location::SdrId>();
        ent_->parent = this;
        sdr_id.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::GlobalStatistics::Location::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::GlobalStatistics::Location::SdrId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "traffic-type-id")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::GlobalStatistics::Location::SdrId::TrafficTypeId>();
        ent_->parent = this;
        traffic_type_id.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::GlobalStatistics::Location::SdrId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::GlobalStatistics::Location::SdrId::TrafficTypeId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "traffic-class-id")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::GlobalStatistics::Location::SdrId::TrafficTypeId::TrafficClassId>();
        ent_->parent = this;
        traffic_class_id.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::GlobalStatistics::Location::SdrId::TrafficTypeId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : traffic_class_id.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::GlobalStatistics::Location::SdrId::TrafficTypeId::TrafficClassId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::GlobalStatistics::Location::SdrId::TrafficTypeId::TrafficClassId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::Policers::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "location")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::Policers::Location>();
        ent_->parent = this;
        location.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::Policers::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::Policers::Location::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "sdr-id")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::Policers::Location::SdrId>();
        ent_->parent = this;
        sdr_id.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::Policers::Location::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(esd_policer_status != nullptr)
    {
        _children["esd-policer-status"] = esd_policer_status;
    }
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::Policers::Location::EsdPolicerStatus::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::Policers::Location::EsdPolicerStatus::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(indent_group != nullptr)
    {
        _children["indent-group"] = indent_group;
    }
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::Policers::Location::EsdPolicerStatus::IndentGroup::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::Policers::Location::EsdPolicerStatus::IndentGroup::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::Policers::Location::SdrId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "esd-sdr-cos-type-iter")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::Policers::Location::SdrId::EsdSdrCosTypeIter>();
        ent_->parent = this;
        esd_sdr_cos_type_iter.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::Policers::Location::SdrId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : esd_sdr_cos_type_iter.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::Policers::Location::SdrId::EsdSdrCosTypeIter::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::Policers::Location::SdrId::EsdSdrCosTypeIter::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::SdrDetail::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "sdr-id")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::SdrDetail::SdrId>();
        ent_->parent = this;
        sdr_id.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::SdrDetail::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::SdrDetail::SdrId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "port-statistics")
    {
        if(port_statistics == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::SdrDetail::SdrId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(port_statistics != nullptr)
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "location")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::Location>();
        ent_->parent = this;
        location.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::Location::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "port-iter")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::Location::PortIter>();
        ent_->parent = this;
        port_iter.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::Location::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::Location::PortIter::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "traffic-type-id")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::Location::PortIter::TrafficTypeId>();
        ent_->parent = this;
        traffic_type_id.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::Location::PortIter::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::Location::PortIter::TrafficTypeId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "direction-id")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::Location::PortIter::TrafficTypeId::DirectionId>();
        ent_->parent = this;
        direction_id.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::Location::PortIter::TrafficTypeId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::Location::PortIter::TrafficTypeId::DirectionId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "traffic-class-id")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::Location::PortIter::TrafficTypeId::DirectionId::TrafficClassId>();
        ent_->parent = this;
        traffic_class_id.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::Location::PortIter::TrafficTypeId::DirectionId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::Location::PortIter::TrafficTypeId::DirectionId::TrafficClassId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::Sdr::SdrDetail::SdrId::PortStatistics::Location::PortIter::TrafficTypeId::DirectionId::TrafficClassId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::SwitchDebugCont::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::SwitchDebugCont::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(debug != nullptr)
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::SwitchDebugCont::Debug::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "counters")
    {
        if(counters == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::SwitchDebugCont::Debug::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(counters != nullptr)
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::SwitchDebugCont::Debug::Counters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "location")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::SwitchDebugCont::Debug::Counters::Location>();
        ent_->parent = this;
        location.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::SwitchDebugCont::Debug::Counters::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::SwitchDebugCont::Debug::Counters::Location::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "counters")
    {
        if(counters == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::SwitchDebugCont::Debug::Counters::Location::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(counters != nullptr)
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::SwitchDebugCont::Debug::Counters::Location::Counters_::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "switch-core")
    {
        auto ent_ = std::make_shared<Controller::Switch::Oper::SwitchDebugCont::Debug::Counters::Location::Counters_::SwitchCore>();
        ent_->parent = this;
        switch_core.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::SwitchDebugCont::Debug::Counters::Location::Counters_::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : switch_core.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> Controller::Switch::Oper::SwitchDebugCont::Debug::Counters::Location::Counters_::SwitchCore::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Controller::Switch::Oper::SwitchDebugCont::Debug::Counters::Location::Counters_::SwitchCore::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
