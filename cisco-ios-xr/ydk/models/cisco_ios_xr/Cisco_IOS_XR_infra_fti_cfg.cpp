...
std::shared_ptr<ydk::Entity> DciFabricInterconnect::Fabrics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "fabric")
    {
        auto ent_ = std::make_shared<DciFabricInterconnect::Fabrics::Fabric>();
        ent_->parent = this;
        fabric.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> DciFabricInterconnect::Fabrics::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : fabric.entities())
    {
...
std::shared_ptr<ydk::Entity> DciFabricInterconnect::Fabrics::Fabric::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> DciFabricInterconnect::Fabrics::Fabric::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(controllers != nullptr)
...
std::shared_ptr<ydk::Entity> DciFabricInterconnect::Fabrics::Fabric::Controllers::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "controller")
    {
        auto ent_ = std::make_shared<DciFabricInterconnect::Fabrics::Fabric::Controllers::Controller>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> DciFabricInterconnect::Fabrics::Fabric::Controllers::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> DciFabricInterconnect::Fabrics::Fabric::Controllers::Controller::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> DciFabricInterconnect::Fabrics::Fabric::Controllers::Controller::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> DciFabricInterconnect::Acp::get_children() const
{
    ...
    if(bd_range != nullptr)
    {
        _children["bd-range"] = bd_range;
    }

    if(vni_range != nullptr)
    {
        _children["vni-range"] = vni_range;
    }

    if(bvi_range != nullptr)
    {
        _children["bvi-range"] = bvi_range;
    }
...
std::shared_ptr<ydk::Entity> DciFabricInterconnect::Acp::BdRange::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> DciFabricInterconnect::Acp::BdRange::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> DciFabricInterconnect::Acp::VniRange::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> DciFabricInterconnect::Acp::VniRange::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> DciFabricInterconnect::Acp::BviRange::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> DciFabricInterconnect::Acp::BviRange::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> DciFabricInterconnect::Acp::Vrfs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "vrf")
    {
        auto ent_ = std::make_shared<DciFabricInterconnect::Acp::Vrfs::Vrf>();
        ent_->parent = this;
        vrf.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> DciFabricInterconnect::Acp::Vrfs::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> DciFabricInterconnect::Acp::Vrfs::Vrf::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> DciFabricInterconnect::Acp::Vrfs::Vrf::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
