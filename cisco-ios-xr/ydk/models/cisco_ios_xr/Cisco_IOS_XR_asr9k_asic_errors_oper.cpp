...
std::shared_ptr<ydk::Entity> AsicErrorStats::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AsicErrorStats::get_children() const
{
...
std::shared_ptr<ydk::Entity> AsicErrorStats::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> AsicErrorStats::Racks::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "rack")
    {
        auto ent_ = std::make_shared<AsicErrorStats::Racks::Rack>();
        ent_->parent = this;
        rack.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AsicErrorStats::Racks::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> AsicErrorStats::Racks::Rack::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AsicErrorStats::Racks::Rack::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(nodes != nullptr)
...
std::shared_ptr<ydk::Entity> AsicErrorStats::Racks::Rack::Nodes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "node")
    {
        auto ent_ = std::make_shared<AsicErrorStats::Racks::Rack::Nodes::Node>();
        ent_->parent = this;
        node.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AsicErrorStats::Racks::Rack::Nodes::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> AsicErrorStats::Racks::Rack::Nodes::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AsicErrorStats::Racks::Rack::Nodes::Node::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(counts != nullptr)
    {
        _children["counts"] = counts;
    }
...
std::shared_ptr<ydk::Entity> AsicErrorStats::Racks::Rack::Nodes::Node::Counts::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "count")
    {
        auto ent_ = std::make_shared<AsicErrorStats::Racks::Rack::Nodes::Node::Counts::Count>();
        ent_->parent = this;
        count.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AsicErrorStats::Racks::Rack::Nodes::Node::Counts::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> AsicErrorStats::Racks::Rack::Nodes::Node::Counts::Count::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "sum-data")
    {
        auto ent_ = std::make_shared<AsicErrorStats::Racks::Rack::Nodes::Node::Counts::Count::SumData>();
        ent_->parent = this;
        sum_data.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AsicErrorStats::Racks::Rack::Nodes::Node::Counts::Count::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : sum_data.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> AsicErrorStats::Racks::Rack::Nodes::Node::Counts::Count::SumData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> AsicErrorStats::Racks::Rack::Nodes::Node::Counts::Count::SumData::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
