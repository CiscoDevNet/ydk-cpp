...
std::shared_ptr<ydk::Entity> NodePath::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "node")
    {
        auto ent_ = std::make_shared<NodePath::Node>();
        ent_->parent = this;
        node.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> NodePath::get_children() const
{
...
std::shared_ptr<ydk::Entity> NodePath::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> NodePath::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> NodePath::Node::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(slice_ids != nullptr)
...
std::shared_ptr<ydk::Entity> NodePath::Node::SliceIds::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "slice-id")
    {
        auto ent_ = std::make_shared<NodePath::Node::SliceIds::SliceId>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> NodePath::Node::SliceIds::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> NodePath::Node::SliceIds::SliceId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> NodePath::Node::SliceIds::SliceId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
