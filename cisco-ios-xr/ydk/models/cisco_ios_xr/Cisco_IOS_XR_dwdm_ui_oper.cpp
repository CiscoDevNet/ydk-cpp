...
{
    if(name == "prbs" || name == "optics" || name == "info" || name == "name")
        return true;
    return false;
}
...
{
    if(name == "twenty-four-hours-bucket" || name == "fifteen-minutes-bucket")
        return true;
    return false;
}
...
{
    if(name == "interval-index" || name == "configured-pattern" || name == "start-at" || name == "stop-at" || name == "received-pattern" || name == "bit-error-count" || name == "found-count" || name == "lost-count" || name == "found-at" || name == "lost-at")
        return true;
    return false;
}
...
{
    if(name == "wave-band" || name == "wave-channel-min" || name == "wave-channel-max")
        return true;
    return false;
}
...
{
    if(name == "g709-info" || name == "optics-info" || name == "tdc-info" || name == "network-srlg-info" || name == "proactive" || name == "signal-log" || name == "controller-state" || name == "transport-admin-state" || name == "slice-state")
        return true;
    return false;
}
...
{
    if(name == "fec-mismatch" || name == "ec-tca" || name == "uc-tca" || name == "otu-info" || name == "odu-info" || name == "is-g709-enabled" || name == "is-fec-mode-default" || name == "fec-mode" || name == "remote-fec-mode" || name == "efec-mode" || name == "loopback-mode" || name == "ec" || name == "ec-accum" || name == "uc" || name == "fec-ber" || name == "fec-ber-man" || name == "q" || name == "q-margin" || name == "fe-cstr" || name == "qstr" || name == "qmargin-str" || name == "network-port-id" || name == "network-conn-id" || name == "is-prbs-enabled" || name == "g709-prbs-mode" || name == "g709-prbs-pattern" || name == "prbs-time-stamp")
        return true;
    return false;
}
...
{
    if(name == "reporting-enabled" || name == "is-detected" || name == "is-asserted" || name == "threshold" || name == "counter")
        return true;
    return false;
}
...
{
    if(name == "los" || name == "lof" || name == "lom" || name == "oof" || name == "oom" || name == "ais" || name == "iae" || name == "bdi" || name == "tim" || name == "eoc" || name == "sf-ber" || name == "sd-ber" || name == "prefec-sf-ber" || name == "prefec-sd-ber" || name == "bbe-tca" || name == "es-tca" || name == "bbe" || name == "es" || name == "ses" || name == "uas" || name == "fc" || name == "bber" || name == "esr" || name == "sesr" || name == "tti" || name == "bei" || name == "bip")
        return true;
    return false;
}
...
{
    if(name == "tx-string-type" || name == "expected-string-type" || name == "rx-string-type" || name == "tx-tti" || name == "tx-sapi0" || name == "tx-sapi" || name == "tx-sapi-range" || name == "tx-dapi0" || name == "tx-dapi" || name == "tx-dapi-range" || name == "tx-oper-spec" || name == "tx-oper-spec-range" || name == "rx-tti" || name == "rx-sapi0" || name == "rx-sapi" || name == "rx-sapi-range" || name == "rx-dapi0" || name == "rx-dapi" || name == "rx-dapi-range" || name == "rx-oper-spec-range" || name == "rx-oper-spec" || name == "expected-tti" || name == "expected-sapi0" || name == "expected-sapi" || name == "exp-sapi-range" || name == "expected-dapi0" || name == "expected-dapi" || name == "exp-dapi-range" || name == "expected-oper-spec" || name == "exp-oper-spec-range")
        return true;
    return false;
}
...
{
    if(name == "oci" || name == "ais" || name == "lck" || name == "bdi" || name == "eoc" || name == "ptim" || name == "tim" || name == "sf-ber" || name == "sd-ber" || name == "bbe-tca" || name == "es-tca" || name == "bbe" || name == "es" || name == "ses" || name == "uas" || name == "fc" || name == "bber" || name == "esr" || name == "sesr" || name == "tti" || name == "bip" || name == "bei")
        return true;
    return false;
}
...
{
    if(name == "optics-type" || name == "clock-source" || name == "wave-frequency-progressive-string" || name == "wavelength-progressive-string" || name == "is-wave-frequency-progressive-valid" || name == "wavelength-progressive" || name == "wave-band" || name == "wave-channel" || name == "wave-frequency" || name == "is-wave-frequency-valid" || name == "wave-channel-owner" || name == "gmpls-set-wave-channel" || name == "configured-wave-channel" || name == "default-wave-channel" || name == "transmit-power" || name == "transmit-power-threshold" || name == "laser-current-bias" || name == "laser-current-bias-threshold" || name == "receive-power" || name == "is-rx-los-threshold-supported" || name == "rx-los-threshold" || name == "transmit-power-min" || name == "transmit-power-max" || name == "transmit-power-avg" || name == "receive-power-min" || name == "receive-power-max" || name == "receive-power-avg" || name == "laser-bias-current-min" || name == "laser-bias-current-max" || name == "laser-bias-current-avg" || name == "chromatic-dispersion" || name == "differential-group-delay" || name == "polarization-mode-dispersion" || name == "signal-to-noise-ratio" || name == "polarization-dependent-loss" || name == "polarization-change-rate" || name == "phase-noise" || name == "output-power-fail" || name == "input-power-fail")
        return true;
    return false;
}
...
{
    if(name == "tdc-valid" || name == "major-alarm" || name == "operation-mode" || name == "tdc-status" || name == "dispersion-offset" || name == "reroute-ber" || name == "is-reroute-control-enabled")
        return true;
    return false;
}
...
{
    if(name == "proactive-feature" || name == "proactive-mode" || name == "proactive-fsm-state" || name == "proactive-fsm-if-state" || name == "tas-state" || name == "trig-thresh-coeff" || name == "trig-thresh-power" || name == "rvrt-thresh-coeff" || name == "rvrt-thresh-power" || name == "default-trig-thresh-coeff" || name == "default-trig-thresh-power" || name == "default-rvrt-thresh-coeff" || name == "default-rvrt-thresh-power" || name == "trig-samples" || name == "rvrt-samples" || name == "trigger-window" || name == "revert-window" || name == "protection-trigger" || name == "interface-trigger" || name == "tx-aps" || name == "tx-aps-descr" || name == "rx-aps" || name == "rx-aps-descr" || name == "alarm-state" || name == "trig-ec-cnt" || name == "rvrt-ec-cnt" || name == "prefec-thresh-crossed")
        return true;
    return false;
}
