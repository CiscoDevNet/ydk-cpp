...
{
    if(name == "client-algo" || name == "client-enable" || name == "rekey-volume" || name == "host-public-key" || name == "client-vrf" || name == "tcp-window-scale" || name == "rekey-time" || name == "source-interface" || name == "dscp")
        return true;
    return false;
}
