...
std::shared_ptr<ydk::Entity> HardwareModulePortMode::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "config-mode")
    {
        auto ent_ = std::make_shared<HardwareModulePortMode::ConfigMode>();
        ent_->parent = this;
        config_mode.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> HardwareModulePortMode::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : config_mode.entities())
    {
...
std::shared_ptr<ydk::Entity> HardwareModulePortMode::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> HardwareModulePortMode::ConfigMode::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "node")
    {
        auto ent_ = std::make_shared<HardwareModulePortMode::ConfigMode::Node>();
        ent_->parent = this;
        node.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> HardwareModulePortMode::ConfigMode::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> HardwareModulePortMode::ConfigMode::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> HardwareModulePortMode::ConfigMode::Node::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(port_mode != nullptr)
...
std::shared_ptr<ydk::Entity> HardwareModulePortMode::ConfigMode::Node::PortMode::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> HardwareModulePortMode::ConfigMode::Node::PortMode::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
