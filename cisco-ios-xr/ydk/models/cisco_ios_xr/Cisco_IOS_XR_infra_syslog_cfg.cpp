...
{
    if(name == "alarm-filter-strings" || name == "buffer-size" || name == "pre-config-suppression" || name == "pre-config-suppression-timeout" || name == "severity-level" || name == "source-location" || name == "threshold")
        return true;
    return false;
}
