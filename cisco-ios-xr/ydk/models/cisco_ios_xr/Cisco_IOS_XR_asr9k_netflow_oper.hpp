...
class NetFlow : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_asr9k_netflow_oper::NetFlow::Statistics> statistics;
...
class NetFlow::Statistics::Statistic : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_asr9k_netflow_oper::NetFlow::Statistics::Statistic::Producer> producer;
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_asr9k_netflow_oper::NetFlow::Statistics::Statistic::Server> server;
...
class NetFlow::Statistics::Statistic::Producer : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_asr9k_netflow_oper::NetFlow::Statistics::Statistic::Producer::Statistics_> statistics;
...
class NetFlow::Statistics::Statistic::Server : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_asr9k_netflow_oper::NetFlow::Statistics::Statistic::Server::FlowExporters> flow_exporters;
...
class NetFlow::Statistics::Statistic::Server::FlowExporters::FlowExporter : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_asr9k_netflow_oper::NetFlow::Statistics::Statistic::Server::FlowExporters::FlowExporter::Exporter> exporter;
