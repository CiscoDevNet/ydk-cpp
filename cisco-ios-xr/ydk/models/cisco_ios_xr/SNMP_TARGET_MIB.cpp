...
{
    if (is_presence_container) return true;
    return snmpunavailablecontexts.is_set
...
{
    if(name == "snmpUnavailableContexts" || name == "snmpUnknownContexts")
        return true;
    return false;
}
...
SNMPTARGETMIB::SnmpTargetAddrTable::SnmpTargetAddrEntry::SnmpTargetAddrEntry()
    ...
    snmptargetaddrengineid{YType::str, "snmpTargetAddrEngineID"},
    snmptargetaddrtmask{YType::str, "snmpTargetAddrTMask"},
    snmptargetaddrmms{YType::int32, "snmpTargetAddrMMS"},
...
bool SNMPTARGETMIB::SnmpTargetAddrTable::SnmpTargetAddrEntry::has_data() const
{
	...
	|| snmptargetaddrengineid.is_set
	|| snmptargetaddrtmask.is_set
	|| snmptargetaddrmms.is_set
	|| enabled.is_set;
}
...
bool SNMPTARGETMIB::SnmpTargetAddrTable::SnmpTargetAddrEntry::has_operation() const
{
	...
	|| ydk::is_set(snmptargetaddrengineid.yfilter)
	|| ydk::is_set(snmptargetaddrtmask.yfilter)
	|| ydk::is_set(snmptargetaddrmms.yfilter)
...
std::vector<std::pair<std::string, LeafData> > SNMPTARGETMIB::SnmpTargetAddrTable::SnmpTargetAddrEntry::get_name_leaf_data() const
{
    ...
    if (snmptargetaddrengineid.is_set || is_set(snmptargetaddrengineid.yfilter)) leaf_name_data.push_back(snmptargetaddrengineid.get_name_leafdata());
    if (snmptargetaddrtmask.is_set || is_set(snmptargetaddrtmask.yfilter)) leaf_name_data.push_back(snmptargetaddrtmask.get_name_leafdata());
    if (snmptargetaddrmms.is_set || is_set(snmptargetaddrmms.yfilter)) leaf_name_data.push_back(snmptargetaddrmms.get_name_leafdata());
...
void SNMPTARGETMIB::SnmpTargetAddrTable::SnmpTargetAddrEntry::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    ...
    if(value_path == "snmpTargetAddrEngineID")
    {
        snmptargetaddrengineid = value;
        snmptargetaddrengineid.value_namespace = name_space;
        snmptargetaddrengineid.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "snmpTargetAddrTMask")
    {
        snmptargetaddrtmask = value;
        snmptargetaddrtmask.value_namespace = name_space;
        snmptargetaddrtmask.value_namespace_prefix = name_space_prefix;
    }
    if(value_path == "snmpTargetAddrMMS")
    {
        snmptargetaddrmms = value;
        snmptargetaddrmms.value_namespace = name_space;
        snmptargetaddrmms.value_namespace_prefix = name_space_prefix;
    }
...
void SNMPTARGETMIB::SnmpTargetAddrTable::SnmpTargetAddrEntry::set_filter(const std::string & value_path, YFilter yfilter)
{
    ...
    if(value_path == "snmpTargetAddrEngineID")
    {
        snmptargetaddrengineid.yfilter = yfilter;
    }
    if(value_path == "snmpTargetAddrTMask")
    {
        snmptargetaddrtmask.yfilter = yfilter;
    }
    if(value_path == "snmpTargetAddrMMS")
    {
        snmptargetaddrmms.yfilter = yfilter;
    }
    if(value_path == "enabled")
    {
...
{
    if(name == "snmpTargetAddrName" || name == "snmpTargetAddrTDomain" || name == "snmpTargetAddrTAddress" || name == "snmpTargetAddrTimeout" || name == "snmpTargetAddrRetryCount" || name == "snmpTargetAddrTagList" || name == "snmpTargetAddrParams" || name == "snmpTargetAddrStorageType" || name == "snmpTargetAddrEngineID" || name == "snmpTargetAddrTMask" || name == "snmpTargetAddrMMS" || name == "enabled")
        return true;
    return false;
}
...
{
    if(name == "snmpTargetParamsName" || name == "snmpTargetParamsMPModel" || name == "snmpTargetParamsSecurityModel" || name == "snmpTargetParamsSecurityName" || name == "snmpTargetParamsSecurityLevel" || name == "snmpTargetParamsStorageType")
        return true;
    return false;
}
