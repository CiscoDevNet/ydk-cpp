...
const Enum::YLeaf CfmService::vlan_aware_flexible_cross_connect {4, "vlan-aware-flexible-cross-connect"};
const Enum::YLeaf CfmService::vlan_unaware_flexible_cross_connect {5, "vlan-unaware-flexible-cross-connect"};
const Enum::YLeaf CfmService::down_meps {6, "down-meps"};
