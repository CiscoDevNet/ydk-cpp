...
#include "Cisco_IOS_XR_sysadmin_clear_ncs5502.hpp"
    ...
    , clear_asic_errors_grp(std::make_shared<Clear::ClearAsicErrorsGrp>())
{
    ...
    yang_name = "clear"; yang_parent_name = "Cisco-IOS-XR-sysadmin-clear-ncs5502"; is_top_level_class = true; has_list_ancestor = false; 
}
...
std::string Clear::get_segment_path() const
{
    ...
    path_buffer << "Cisco-IOS-XR-sysadmin-clear-ncs5502:clear";
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-clear-ncs5502:clear/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-clear-ncs5502:clear/controller/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-clear-ncs5502:clear/controller/switch/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-clear-ncs5502:clear/controller/switch/oper/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-clear-ncs5502:clear/controller/switch/oper/fdb/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-clear-ncs5502:clear/controller/switch/oper/statistics/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-clear-ncs5502:clear/controller/fabric/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-clear-ncs5502:clear/controller/fabric/counter/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-clear-ncs5502:clear/controller/fabric/clear_statistics/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-clear-ncs5502:clear/clear-asic-errors-grp/" << get_segment_path();
    return path_buffer.str();
}
