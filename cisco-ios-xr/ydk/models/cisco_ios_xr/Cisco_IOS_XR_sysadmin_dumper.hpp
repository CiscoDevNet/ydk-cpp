#ifndef _CISCO_IOS_XR_SYSADMIN_DUMPER_
#define _CISCO_IOS_XR_SYSADMIN_DUMPER_
...
class Exception::Choice : public ydk::Entity
{
    public:
        Choice();
        ~Choice();
...
#endif /* _CISCO_IOS_XR_SYSADMIN_DUMPER_ */
