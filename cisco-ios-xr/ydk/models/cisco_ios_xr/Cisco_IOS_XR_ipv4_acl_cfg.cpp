...
{
    if(name == "destination-network" || name == "destination-port" || name == "dscp" || name == "fragment-offset" || name == "icmp" || name == "next-hop" || name == "packet-length" || name == "source-network" || name == "source-port" || name == "tcp" || name == "time-to-live" || name == "sequence-number" || name == "capture" || name == "counter-name" || name == "destination-port-group" || name == "destination-prefix-group" || name == "fragments" || name == "grant" || name == "icmp-off" || name == "igmp-message-type" || name == "log-option" || name == "precedence" || name == "protocol" || name == "protocol2" || name == "protocol-operator" || name == "qos-group" || name == "remark" || name == "sequence-str" || name == "source-port-group" || name == "source-prefix-group")
        return true;
    return false;
}
