...
EntityPath Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'AccessListEntries' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
EntityPath Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'AccessListEntry' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
bool Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::SourceNetwork::has_operation() const
{
	...
	|| is_set(source_prefix_length.operation)
...
EntityPath Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::SourceNetwork::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'SourceNetwork' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
    ...
    if (source_prefix_length.is_set || is_set(source_prefix_length.operation)) leaf_name_data.push_back(source_prefix_length.get_name_leafdata());
...
EntityPath Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::DestinationNetwork::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'DestinationNetwork' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
EntityPath Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::SourcePort::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'SourcePort' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
EntityPath Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::DestinationPort::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'DestinationPort' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
EntityPath Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::Icmp::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'Icmp' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
EntityPath Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::Tcp::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'Tcp' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
EntityPath Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::PacketLength::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'PacketLength' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
EntityPath Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::TimeToLive::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'TimeToLive' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    yang_name = "fragment-offset"; yang_parent_name = "access-list-entry";
}
...
{
    return is_set(operation)
	|| is_set(fragment_offset_1.operation)
	|| is_set(fragment_offset_2.operation)
...
EntityPath Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::FragmentOffset::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'FragmentOffset' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
    ...
    if (fragment_offset_1.is_set || is_set(fragment_offset_1.operation)) leaf_name_data.push_back(fragment_offset_1.get_name_leafdata());
    if (fragment_offset_2.is_set || is_set(fragment_offset_2.operation)) leaf_name_data.push_back(fragment_offset_2.get_name_leafdata());
...
void Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::FragmentOffset::set_value(const std::string & value_path, std::string value)
{
...
EntityPath Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::NextHop::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'NextHop' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
EntityPath Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::NextHop::NextHop1::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'NextHop1' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
EntityPath Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::NextHop::NextHop2::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'NextHop2' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
EntityPath Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::NextHop::NextHop3::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'NextHop3' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
EntityPath Ipv4AclAndPrefixList::Accesses::Access::AccessListEntries::AccessListEntry::Dscp::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'Dscp' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
EntityPath Ipv4AclAndPrefixList::Prefixes::Prefix::PrefixListEntries::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'PrefixListEntries' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
EntityPath Ipv4AclAndPrefixList::Prefixes::Prefix::PrefixListEntries::PrefixListEntry::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'PrefixListEntry' in Cisco_IOS_XR_ipv4_acl_cfg cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
