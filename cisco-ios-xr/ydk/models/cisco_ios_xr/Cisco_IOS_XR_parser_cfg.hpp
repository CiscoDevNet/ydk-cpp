...
class Parser : public ydk::Entity
{
    public:
        Parser();
        ~Parser();
        ...
        class LoggingSuppress; //type: Parser::LoggingSuppress
        class History; //type: Parser::History
        class Interactive; //type: Parser::Interactive
        class CommitOptimized; //type: Parser::CommitOptimized
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_parser_cfg::Parser::LoggingSuppress> logging_suppress;
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_parser_cfg::Parser::CommitOptimized> commit_optimized;
...
class Parser::Alias::Execs::Exec : public ydk::Entity
{
    public:
        Exec();
        ~Exec();
...
class Parser::LoggingSuppress : public ydk::Entity
{
    public:
        LoggingSuppress();
        ~LoggingSuppress();
        ...
        ydk::YLeaf deprecated; //type: boolean
...
class Parser::CommitOptimized : public ydk::Entity
{
    public:
        CommitOptimized();
        ~CommitOptimized();
        ...
        ydk::YLeaf commit_optimized_enable; //type: boolean
...
class Parser::InterfaceDisplay : public ydk::Entity
{
    public:
        ...
        ydk::YLeaf slot_order; //type: boolean

}; // Parser::InterfaceDisplay


class Parser::NetmaskFormat : public ydk::Entity
{
    public:
        NetmaskFormat();
        ~NetmaskFormat();
