...
const Enum::YLeaf BgpAddressFamily::vp_nv4_unicast {4, "vp-nv4-unicast"};
...
const Enum::YLeaf BgpAddressFamily::vp_nv6_unicast {8, "vp-nv6-unicast"};
const Enum::YLeaf BgpAddressFamily::ipv4mdt {9, "ipv4mdt"};
const Enum::YLeaf BgpAddressFamily::l2vpnvpls {10, "l2vpnvpls"};
const Enum::YLeaf BgpAddressFamily::ipv4rt_constraint {11, "ipv4rt-constraint"};
const Enum::YLeaf BgpAddressFamily::ipv4mvpn {12, "ipv4mvpn"};
const Enum::YLeaf BgpAddressFamily::ipv6mvpn {13, "ipv6mvpn"};
const Enum::YLeaf BgpAddressFamily::l2vpnevpn {14, "l2vpnevpn"};
const Enum::YLeaf BgpAddressFamily::lsls {15, "lsls"};
const Enum::YLeaf BgpAddressFamily::vp_nv4_multicast {16, "vp-nv4-multicast"};
const Enum::YLeaf BgpAddressFamily::vp_nv6_multicast {17, "vp-nv6-multicast"};
...
const Enum::YLeaf BgpAddressFamily::vp_nv4_flowspec {20, "vp-nv4-flowspec"};
const Enum::YLeaf BgpAddressFamily::vp_nv6_flowspec {21, "vp-nv6-flowspec"};
const Enum::YLeaf BgpAddressFamily::l2vpnmspw {22, "l2vpnmspw"};
const Enum::YLeaf BgpAddressFamily::ipv4sr_policy {23, "ipv4sr-policy"};
const Enum::YLeaf BgpAddressFamily::ipv6sr_policy {24, "ipv6sr-policy"};
