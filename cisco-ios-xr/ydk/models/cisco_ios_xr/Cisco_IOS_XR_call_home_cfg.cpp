...
{
    if(name == "alert-group-config" || name == "alert-groups" || name == "authorization" || name == "data-privacies" || name == "http-proxy" || name == "mail-servers" || name == "profiles" || name == "smart-licensing" || name == "syslog-throttling" || name == "active" || name == "contact-email-address" || name == "contact-smart-licensing" || name == "contract-id" || name == "customer-id" || name == "from" || name == "phone-number" || name == "rate-limit" || name == "reply-to" || name == "site-id" || name == "source-interface" || name == "street-address" || name == "vrf")
        return true;
    return false;
}
...
{
    if(name == "alert-group-name" || name == "disable" || name == "enable")
        return true;
    return false;
}
...
{
    if(name == "port" || name == "server-address")
        return true;
    return false;
}
...
{
    if(name == "addresses" || name == "methods" || name == "report-type" || name == "subscribe-alert-group" || name == "profile-name" || name == "active" || name == "anonymous" || name == "create" || name == "message-format" || name == "message-size-limit")
        return true;
    return false;
}
...
{
    if(name == "configuration" || name == "crash" || name == "environment" || name == "inventory" || name == "snapshot" || name == "syslogs")
        return true;
    return false;
}
...
{
    if(name == "day" || name == "hour" || name == "interval" || name == "minute" || name == "weekday")
        return true;
    return false;
}
...
{
    if(name == "active" || name == "profile-name")
        return true;
    return false;
}
