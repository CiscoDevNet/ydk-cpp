...
#include "Cisco_IOS_XR_sysadmin_hw_module_xrv9k.hpp"
    ...
    , shhwfpd(std::make_shared<HwModule::Shhwfpd>())
{
    ...
    yang_name = "hw-module"; yang_parent_name = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k"; is_top_level_class = true; has_list_ancestor = false; 
}
...
std::string HwModule::get_segment_path() const
{
    ...
    path_buffer << "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module";
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/" << get_segment_path();
    return path_buffer.str();
}
...
{
    if(name == "shutdown" || name == "reset" || name == "offline" || name == "location")
        return true;
    return false;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/shutdown/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/reset/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/reset/auto/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/reset/auto/disable/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/offline/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/oper/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/shhwfpd/" << get_segment_path();
    return path_buffer.str();
}
