...
std::shared_ptr<ydk::Entity> ExternalUsb::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> ExternalUsb::get_children() const
{
...
std::shared_ptr<ydk::Entity> ExternalUsb::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> ExternalUsb::Config::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> ExternalUsb::Config::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
