#ifndef _CISCO_IOS_XR_SYSADMIN_FPD_INFRA_CLI_FPDSERV_CTRACE_
#define _CISCO_IOS_XR_SYSADMIN_FPD_INFRA_CLI_FPDSERV_CTRACE_
...
class Fpdserv : public ydk::Entity
{
    public:
        Fpdserv();
        ~Fpdserv();
...
class Fpdserv::Trace : public ydk::Entity
{
    public:
        Trace();
        ~Trace();
...
class Fpdserv::Trace::Location : public ydk::Entity
{
    public:
        Location();
        ~Location();
...
class Fpdserv::Trace::Location::AllOptions : public ydk::Entity
{
    public:
        AllOptions();
        ~AllOptions();
...
class Fpdserv::Trace::Location::AllOptions::TraceBlocks : public ydk::Entity
{
    public:
        TraceBlocks();
        ~TraceBlocks();
...
#endif /* _CISCO_IOS_XR_SYSADMIN_FPD_INFRA_CLI_FPDSERV_CTRACE_ */
