...
{
    return is_set(operation)
	|| is_set(destination_ip_address_length.operation)
	...
	|| is_set(tunnel_mode_decap.operation)
...
EntityPath Interfaces::InterfaceXr::Interface::InterfaceTypeInformation::TunnelGreInformation::get_entity_path(Entity* ancestor) const
{
    ...
    if (destination_ip_address_length.is_set || is_set(destination_ip_address_length.operation)) leaf_name_data.push_back(destination_ip_address_length.get_name_leafdata());
    ...
    if (tunnel_mode_decap.is_set || is_set(tunnel_mode_decap.operation)) leaf_name_data.push_back(tunnel_mode_decap.get_name_leafdata());
