...
{
    if(name == "interface-id-references" || name == "interface-references" || name == "vrf-references" || name == "interface-name" || name == "profile-helper-address" || name == "profile-link-address" || name == "profile-name" || name == "proxy-profile-linkaddress-from-ra-enable" || name == "remote-id" || name == "vrf-name")
        return true;
    return false;
}
