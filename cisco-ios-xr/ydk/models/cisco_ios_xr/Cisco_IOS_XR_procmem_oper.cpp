...
{
    if(name == "process-id" || name == "data-seg-size" || name == "dyn-limit" || name == "jid" || name == "malloc-size" || name == "name" || name == "physical-mem" || name == "pid" || name == "shared-mem" || name == "stack-seg-size" || name == "text-seg-size")
        return true;
    return false;
}
