...
std::shared_ptr<ydk::Entity> Ssespan::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Ssespan::get_children() const
{
...
std::shared_ptr<ydk::Entity> Ssespan::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> Ssespan::Nodes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "node")
    {
        auto ent_ = std::make_shared<Ssespan::Nodes::Node>();
        ent_->parent = this;
        node.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Ssespan::Nodes::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Ssespan::Nodes::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Ssespan::Nodes::Node::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(span_mirr_infos != nullptr)
    {
        _children["span-mirr-infos"] = span_mirr_infos;
    }

    if(spanudf != nullptr)
    {
        _children["spanudf"] = spanudf;
    }

    if(span_sess_infos != nullptr)
    {
        _children["span-sess-infos"] = span_sess_infos;
    }
...
std::shared_ptr<ydk::Entity> Ssespan::Nodes::Node::SpanMirrInfos::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "span-mirr-info")
    {
        auto ent_ = std::make_shared<Ssespan::Nodes::Node::SpanMirrInfos::SpanMirrInfo>();
        ent_->parent = this;
        span_mirr_info.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Ssespan::Nodes::Node::SpanMirrInfos::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : span_mirr_info.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> Ssespan::Nodes::Node::SpanMirrInfos::SpanMirrInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Ssespan::Nodes::Node::SpanMirrInfos::SpanMirrInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Ssespan::Nodes::Node::Spanudf::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Ssespan::Nodes::Node::Spanudf::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Ssespan::Nodes::Node::SpanSessInfos::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "span-sess-info")
    {
        auto ent_ = std::make_shared<Ssespan::Nodes::Node::SpanSessInfos::SpanSessInfo>();
        ent_->parent = this;
        span_sess_info.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Ssespan::Nodes::Node::SpanSessInfos::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : span_sess_info.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
Ssespan::Nodes::Node::SpanSessInfos::SpanSessInfo::SpanSessInfo()
    ...
    session_class{YType::uint32, "session-class"},
...
std::shared_ptr<ydk::Entity> Ssespan::Nodes::Node::SpanSessInfos::SpanSessInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Ssespan::Nodes::Node::SpanSessInfos::SpanSessInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
