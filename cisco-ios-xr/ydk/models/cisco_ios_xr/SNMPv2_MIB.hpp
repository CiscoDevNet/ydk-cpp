...
class SNMPv2MIB : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::SNMPv2_MIB::SNMPv2MIB::System> system;
        std::shared_ptr<cisco_ios_xr::SNMPv2_MIB::SNMPv2MIB::Snmp> snmp;
        std::shared_ptr<cisco_ios_xr::SNMPv2_MIB::SNMPv2MIB::SnmpSet> snmpset;
        std::shared_ptr<cisco_ios_xr::SNMPv2_MIB::SNMPv2MIB::SysORTable> sysortable;
...
class SNMPv2MIB::Snmp : public ydk::Entity
{
    public:
        ...
        ydk::YLeaf snmpenableauthentraps; //type: SnmpEnableAuthenTrapsType
...
class SnmpEnableAuthenTrapsType : public ydk::Enum
{
    public:
