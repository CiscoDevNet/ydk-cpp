...
std::shared_ptr<ydk::Entity> Usb::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Usb::get_children() const
{
...
std::shared_ptr<ydk::Entity> Usb::clone_ptr() const
{
