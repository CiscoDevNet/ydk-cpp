...
class RedundancyGroupManager::Aps::Groups : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_rgmgr_cfg::RedundancyGroupManager::Aps::Groups::Group> > group;
...
class RedundancyGroupManager::Aps::Groups::Group::Controllers : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_rgmgr_cfg::RedundancyGroupManager::Aps::Groups::Group::Controllers::Controller> > controller;
...
class RedundancyGroupManager::Iccp::IccpGroups : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_rgmgr_cfg::RedundancyGroupManager::Iccp::IccpGroups::IccpGroup> > iccp_group;
...
class RedundancyGroupManager::Iccp::IccpGroups::IccpGroup::Backbones : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_rgmgr_cfg::RedundancyGroupManager::Iccp::IccpGroups::IccpGroup::Backbones::Backbone> > backbone;
...
class RedundancyGroupManager::Iccp::IccpGroups::IccpGroup::Members : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_rgmgr_cfg::RedundancyGroupManager::Iccp::IccpGroups::IccpGroup::Members::Member> > member;
