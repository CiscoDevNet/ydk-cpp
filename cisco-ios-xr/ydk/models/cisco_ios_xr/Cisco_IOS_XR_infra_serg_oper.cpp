...
{
    if(name == "client-ids" || name == "group-id-xr" || name == "group-ids" || name == "group-summaries" || name == "interfaces" || name == "memory" || name == "stats-global" || name == "node-name")
        return true;
    return false;
}
...
{
    if(name == "stats-client-id" || name == "clean-call-back" || name == "last-replay-all-count" || name == "tx-list-active-not-ok" || name == "tx-list-active-ok" || name == "tx-list-clear-all-add-not-ok" || name == "tx-list-clear-all-add-ok" || name == "tx-list-clear-selected-add-not-ok" || name == "tx-list-clear-selected-add-ok" || name == "tx-list-client-cleanup" || name == "tx-list-client-connection-down" || name == "tx-list-client-de-registration" || name == "tx-list-client-registration-not-ok" || name == "tx-list-client-registration-ok" || name == "tx-list-de-active-not-ok" || name == "tx-list-de-active-ok" || name == "tx-list-encode-session-session-ok" || name == "tx-list-encode-session-session-partial-write" || name == "tx-list-end-of-download-add-not-ok" || name == "tx-list-end-of-download-add-ok" || name == "tx-list-end-of-message-add-not-ok" || name == "tx-list-end-of-message-add-ok" || name == "tx-list-receive-command-replay-all" || name == "tx-list-receive-command-replay-selected" || name == "tx-list-receive-session-session-clear-all" || name == "tx-list-receive-session-session-clear-selected" || name == "tx-list-receive-session-session-delete-invalid" || name == "tx-list-receive-session-session-delete-valid" || name == "tx-list-receive-session-session-eod-all" || name == "tx-list-receive-session-session-eod-selected" || name == "tx-list-receive-session-session-eoms" || name == "tx-list-receive-session-session-neg-ack" || name == "tx-list-receive-session-session-neg-ack-not-ok" || name == "tx-list-receive-session-session-sod-all" || name == "tx-list-receive-session-session-sod-selected" || name == "tx-list-receive-session-session-update-invalid" || name == "tx-list-receive-session-session-update-valid" || name == "tx-list-replay-all-add-not-ok" || name == "tx-list-replay-all-add-ok" || name == "tx-list-replay-selected-add-not-ok" || name == "tx-list-replay-selected-add-ok" || name == "tx-list-session-session-add-not-ok" || name == "tx-list-session-session-add-ok" || name == "tx-list-session-session-delete" || name == "tx-list-session-session-update-not-ok" || name == "tx-list-session-session-update-ok" || name == "tx-list-start-of-download-add-not-ok" || name == "tx-list-start-of-download-add-ok")
        return true;
    return false;
}
...
{
    if(name == "client-status" || name == "intf-status-statistics" || name == "opaque-memory-status" || name == "tx-list-over-tcp-status" || name == "tx-list-statistics" || name == "client-init-sync-time-stamp" || name == "peer-action-timer" || name == "peer-init-sync-time-stamp" || name == "redundancy-role" || name == "restart-client-sync-in-progress" || name == "restart-peer-sync-in-progress" || name == "retry-timer-remaining" || name == "source-interface-ipv4-address" || name == "source-interface-ipv6-address" || name == "source-interface-name" || name == "sync-in-progress" || name == "tx-list-client-connection-down" || name == "tx-list-client-connection-up" || name == "tx-list-client-de-registration-invalid" || name == "tx-list-client-message-call-back" || name == "tx-list-client-peer-done" || name == "tx-list-client-receive-command-invalid" || name == "tx-list-client-receive-command-valid" || name == "tx-list-client-receive-invalid" || name == "tx-list-client-receive-session-session-invalid" || name == "tx-list-client-receive-session-sessionvalid" || name == "tx-list-client-receive-valid" || name == "tx-list-client-registration-invalid" || name == "tx-list-peer-cmd-connection-down-not-ok" || name == "tx-list-peer-cmd-connection-up-not-ok" || name == "tx-list-peer-de-registration-invalid" || name == "tx-list-peer-done" || name == "tx-list-peer-message-call-back-invalid" || name == "tx-list-peer-message-call-back-valid" || name == "tx-list-peer-registration-invalid" || name == "tx-list-peer-session-connection-down-not-ok" || name == "tx-list-peer-session-connection-up-not-ok" || name == "tx-list-peer-timer-handler" || name == "vrf-name")
        return true;
    return false;
}
...
{
    if(name == "clean-up-timer-remaining" || name == "client-connection-status" || name == "client-initialization-synchronization-pending" || name == "client-synchronization-end-of-download-pending" || name == "component" || name == "down-time-stamp" || name == "up-time-stamp")
        return true;
    return false;
}
...
{
    if(name == "component" || name == "opaque-data-size" || name == "opaque-high-size" || name == "opaque-size" || name == "session-count")
        return true;
    return false;
}
...
{
    if(name == "accept-count" || name == "active-socket-count" || name == "blocked-connect-count" || name == "buffer-cache-hit" || name == "buffer-cache-miss" || name == "buffer-freed-count" || name == "buffer-full-occurence-count" || name == "bytes-received" || name == "bytes-sent" || name == "connect-count" || name == "connect-retry-count" || name == "maximum-received-message-size" || name == "maximum-requested-buffer-size" || name == "maximum-sent-message-size" || name == "mem-move-bytes-count" || name == "mem-move-message-count" || name == "messages-received" || name == "messages-sent" || name == "peer-pause-count" || name == "remote-node-down-count" || name == "socket-read-count" || name == "socket-write-count")
        return true;
    return false;
}
