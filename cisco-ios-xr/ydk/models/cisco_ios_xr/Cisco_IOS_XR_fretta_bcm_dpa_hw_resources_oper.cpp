...
Dpa::Stats::Nodes::Node::Node()
    ...
    , stats_resources_datas(std::make_shared<Dpa::Stats::Nodes::Node::StatsResourcesDatas>())
    , hw_resources_datas(std::make_shared<Dpa::Stats::Nodes::Node::HwResourcesDatas>())
{
    ...
    stats_resources_datas->parent = this;
...
bool Dpa::Stats::Nodes::Node::has_data() const
{
	...
	|| (stats_resources_datas !=  nullptr && stats_resources_datas->has_data())
...
bool Dpa::Stats::Nodes::Node::has_operation() const
{
	...
	|| (stats_resources_datas !=  nullptr && stats_resources_datas->has_operation())
...
std::shared_ptr<ydk::Entity> Dpa::Stats::Nodes::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "stats-resources-datas")
    {
        if(stats_resources_datas == nullptr)
        {
            stats_resources_datas = std::make_shared<Dpa::Stats::Nodes::Node::StatsResourcesDatas>();
        }
        return stats_resources_datas;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Dpa::Stats::Nodes::Node::get_children() const
{
    ...
    if(stats_resources_datas != nullptr)
    {
        _children["stats-resources-datas"] = stats_resources_datas;
    }

    if(hw_resources_datas != nullptr)
    {
        _children["hw-resources-datas"] = hw_resources_datas;
    }
...
{
    if(name == "asic-statistics" || name == "npu-numbers" || name == "stats-resources-datas" || name == "hw-resources-datas" || name == "node-name")
        return true;
    return false;
}
...
Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesDatas()
    :
    stats_resources_data(this, {"resource"})
{

    yang_name = "stats-resources-datas"; yang_parent_name = "node"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Dpa::Stats::Nodes::Node::StatsResourcesDatas::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<stats_resources_data.len(); index++)
    {
        if(stats_resources_data[index]->has_data())
            return true;
    }
    return false;
}

bool Dpa::Stats::Nodes::Node::StatsResourcesDatas::has_operation() const
{
    for (std::size_t index=0; index<stats_resources_data.len(); index++)
    {
        if(stats_resources_data[index]->has_operation())
            return true;
    }
    return is_set(yfilter);
}

std::string Dpa::Stats::Nodes::Node::StatsResourcesDatas::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "stats-resources-datas";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > Dpa::Stats::Nodes::Node::StatsResourcesDatas::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Dpa::Stats::Nodes::Node::StatsResourcesDatas::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "stats-resources-data")
    {
        auto ent_ = std::make_shared<Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData>();
        ent_->parent = this;
        stats_resources_data.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Dpa::Stats::Nodes::Node::StatsResourcesDatas::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : stats_resources_data.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
void Dpa::Stats::Nodes::Node::StatsResourcesDatas::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Dpa::Stats::Nodes::Node::StatsResourcesDatas::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Dpa::Stats::Nodes::Node::StatsResourcesDatas::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "stats-resources-data")
        return true;
    return false;
}

Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::StatsResourcesData()
    :
    ...
    cntr_engine(this, {})
{
    ...
    yang_name = "stats-resources-data"; yang_parent_name = "stats-resources-datas"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<cntr_engine.len(); index++)
    {
...
bool Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::has_operation() const
{
    for (std::size_t index=0; index<cntr_engine.len(); index++)
    {
...
std::string Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "stats-resources-data";
    ADD_KEY_TOKEN(resource, "resource");
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "cntr-engine")
    {
        auto ent_ = std::make_shared<Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine>();
        ent_->parent = this;
        cntr_engine.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : cntr_engine.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
void Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "resource")
    {
...
bool Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "cntr-engine" || name == "resource" || name == "sys-cp-cnfg-prof" || name == "next-avail-cp-id" || name == "num-cntr-engines")
        return true;
    return false;
}

Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::CntrEngine()
    :
    ...
    apps_info(this, {})
{
    ...
    yang_name = "cntr-engine"; yang_parent_name = "stats-resources-data"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<apps_info.len(); index++)
    {
...
bool Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::has_operation() const
{
    for (std::size_t index=0; index<apps_info.len(); index++)
    {
...
std::string Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "apps-info")
    {
        auto ent_ = std::make_shared<Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::AppsInfo>();
        ent_->parent = this;
        apps_info.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : apps_info.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
void Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "state")
    {
        state = value;
...
void Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "state")
    {
...
bool Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::has_leaf_or_child_of_name(const std::string & name) const
{
...
Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::AppsInfo::AppsInfo()
    :
...
bool Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::AppsInfo::has_data() const
{
    if (is_presence_container) return true;
...
bool Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::AppsInfo::has_operation() const
{
    return is_set(yfilter)
...
std::string Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::AppsInfo::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::AppsInfo::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::AppsInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::AppsInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::AppsInfo::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::AppsInfo::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "app-type")
    {
...
bool Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::AppsInfo::has_leaf_or_child_of_name(const std::string & name) const
{
...
Dpa::Stats::Nodes::Node::HwResourcesDatas::HwResourcesDatas()
    :
    hw_resources_data(this, {"resource"})
{
...
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<hw_resources_data.len(); index++)
    {
...
std::shared_ptr<ydk::Entity> Dpa::Stats::Nodes::Node::HwResourcesDatas::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "hw-resources-data")
    {
        auto ent_ = std::make_shared<Dpa::Stats::Nodes::Node::HwResourcesDatas::HwResourcesData>();
        ent_->parent = this;
        hw_resources_data.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Dpa::Stats::Nodes::Node::HwResourcesDatas::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : hw_resources_data.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<npu_hwr.len(); index++)
    {
...
std::shared_ptr<ydk::Entity> Dpa::Stats::Nodes::Node::HwResourcesDatas::HwResourcesData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "npu-hwr")
    {
        auto ent_ = std::make_shared<Dpa::Stats::Nodes::Node::HwResourcesDatas::HwResourcesData::NpuHwr>();
        ent_->parent = this;
        npu_hwr.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Dpa::Stats::Nodes::Node::HwResourcesDatas::HwResourcesData::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : npu_hwr.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<lt_hwr.len(); index++)
    {
...
std::shared_ptr<ydk::Entity> Dpa::Stats::Nodes::Node::HwResourcesDatas::HwResourcesData::NpuHwr::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "lt-hwr")
    {
        auto ent_ = std::make_shared<Dpa::Stats::Nodes::Node::HwResourcesDatas::HwResourcesData::NpuHwr::LtHwr>();
        ent_->parent = this;
        lt_hwr.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Dpa::Stats::Nodes::Node::HwResourcesDatas::HwResourcesData::NpuHwr::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : lt_hwr.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> Dpa::Stats::Nodes::Node::HwResourcesDatas::HwResourcesData::NpuHwr::LtHwr::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Dpa::Stats::Nodes::Node::HwResourcesDatas::HwResourcesData::NpuHwr::LtHwr::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
