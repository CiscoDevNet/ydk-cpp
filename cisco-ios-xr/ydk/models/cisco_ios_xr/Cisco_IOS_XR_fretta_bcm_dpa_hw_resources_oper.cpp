...
std::map<std::string, std::shared_ptr<Entity>> Dpa::Stats::Nodes::Node::get_children() const
{
    ...
    if(stats_resources_datas != nullptr)
    {
        children["stats-resources-datas"] = stats_resources_datas;
    }
...
std::shared_ptr<Entity> Dpa::Stats::Nodes::Node::StatsResourcesDatas::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "stats-resources-data")
    {
        auto c = std::make_shared<Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData>();
        c->parent = this;
        stats_resources_data.append(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> Dpa::Stats::Nodes::Node::StatsResourcesDatas::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
    for (auto c : stats_resources_data.entities())
    {
        if(children.find(c->get_segment_path()) == children.end())
            children[c->get_segment_path()] = c;
        else
...
std::shared_ptr<Entity> Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "cntr-engine")
    {
        auto c = std::make_shared<Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine>();
        c->parent = this;
        cntr_engine.append(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
    for (auto c : cntr_engine.entities())
    {
        if(children.find(c->get_segment_path()) == children.end())
            children[c->get_segment_path()] = c;
        else
...
std::shared_ptr<Entity> Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "apps-info")
    {
        auto c = std::make_shared<Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::AppsInfo>();
        c->parent = this;
        apps_info.append(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
    for (auto c : apps_info.entities())
    {
        if(children.find(c->get_segment_path()) == children.end())
            children[c->get_segment_path()] = c;
        else
...
std::shared_ptr<Entity> Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::AppsInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Dpa::Stats::Nodes::Node::StatsResourcesDatas::StatsResourcesData::CntrEngine::AppsInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
std::map<std::string, std::shared_ptr<Entity>> Dpa::Stats::Nodes::Node::HwResourcesDatas::get_children() const
{
    ...
    char count=0;
    count = 0;
    for (auto c : hw_resources_data.entities())
    {
        if(children.find(c->get_segment_path()) == children.end())
            children[c->get_segment_path()] = c;
        else
