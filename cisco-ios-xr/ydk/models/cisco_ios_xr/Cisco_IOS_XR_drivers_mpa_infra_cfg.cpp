...
#include "Cisco_IOS_XR_drivers_mpa_infra_cfg.hpp"
    ...
    nodes(std::make_shared<HardwareModule::Nodes>())
{
    ...
    yang_name = "hardware-module"; yang_parent_name = "Cisco-IOS-XR-drivers-mpa-infra-cfg"; is_top_level_class = true; has_list_ancestor = false; 
}
...
std::string HardwareModule::get_segment_path() const
{
    ...
    path_buffer << "Cisco-IOS-XR-drivers-mpa-infra-cfg:hardware-module";
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-drivers-mpa-infra-cfg:hardware-module/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-drivers-mpa-infra-cfg:hardware-module/nodes/" << get_segment_path();
    return path_buffer.str();
}
