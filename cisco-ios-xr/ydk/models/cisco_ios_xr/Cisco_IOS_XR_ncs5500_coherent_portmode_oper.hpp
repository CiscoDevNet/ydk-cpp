...
class ControllerPortMode : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<Cisco_IOS_XR_ncs5500_coherent_portmode_oper::ControllerPortMode::OpticsName> > optics_name;
...
class ControllerPortMode::OpticsName : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XR_ncs5500_coherent_portmode_oper::ControllerPortMode::OpticsName::PortModeInfo> port_mode_info;
