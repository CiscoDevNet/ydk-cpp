...
RoutingPolicy::Sets::Sets()
	...
	,prepend_large_community_sets(std::make_shared<RoutingPolicy::Sets::PrependLargeCommunitySets>())
	...
	,remove_large_community_sets(std::make_shared<RoutingPolicy::Sets::RemoveLargeCommunitySets>())
	...
	,append_large_community_sets(std::make_shared<RoutingPolicy::Sets::AppendLargeCommunitySets>())
	...
	,extended_community_rt_sets(std::make_shared<RoutingPolicy::Sets::ExtendedCommunityRtSets>())
{
    ...
    prepend_large_community_sets->parent = this;
    append_etag_sets->parent = this;
    remove_etag_sets->parent = this;
    remove_large_community_sets->parent = this;
    ...
    append_large_community_sets->parent = this;
...
{
    return (prepend_etag_sets !=  nullptr && prepend_etag_sets->has_data())
	|| (prefix_sets !=  nullptr && prefix_sets->has_data())
	|| (large_community_sets !=  nullptr && large_community_sets->has_data())
	|| (prepend_large_community_sets !=  nullptr && prepend_large_community_sets->has_data())
	|| (append_etag_sets !=  nullptr && append_etag_sets->has_data())
	|| (remove_etag_sets !=  nullptr && remove_etag_sets->has_data())
	|| (remove_large_community_sets !=  nullptr && remove_large_community_sets->has_data())
	...
	|| (append_esi_sets !=  nullptr && append_esi_sets->has_data())
	...
	|| (append_large_community_sets !=  nullptr && append_large_community_sets->has_data())
...
bool RoutingPolicy::Sets::has_operation() const
{
	...
	|| (prepend_large_community_sets !=  nullptr && prepend_large_community_sets->has_operation())
	|| (append_etag_sets !=  nullptr && append_etag_sets->has_operation())
	|| (remove_etag_sets !=  nullptr && remove_etag_sets->has_operation())
	|| (remove_large_community_sets !=  nullptr && remove_large_community_sets->has_operation())
	...
	|| (append_large_community_sets !=  nullptr && append_large_community_sets->has_operation())
...
std::shared_ptr<Entity> RoutingPolicy::Sets::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "prepend-large-community-sets")
    {
        if(prepend_large_community_sets == nullptr)
        {
            prepend_large_community_sets = std::make_shared<RoutingPolicy::Sets::PrependLargeCommunitySets>();
        }
        return prepend_large_community_sets;
    }
    ...
    if(child_yang_name == "remove-large-community-sets")
    {
        if(remove_large_community_sets == nullptr)
        {
            remove_large_community_sets = std::make_shared<RoutingPolicy::Sets::RemoveLargeCommunitySets>();
        }
        return remove_large_community_sets;
    }
    ...
    if(child_yang_name == "append-large-community-sets")
    {
        if(append_large_community_sets == nullptr)
        {
            append_large_community_sets = std::make_shared<RoutingPolicy::Sets::AppendLargeCommunitySets>();
        }
        return append_large_community_sets;
    }
...
std::map<std::string, std::shared_ptr<Entity>> RoutingPolicy::Sets::get_children() const
{
    ...
    if(prepend_large_community_sets != nullptr)
    {
        children["prepend-large-community-sets"] = prepend_large_community_sets;
    }
    ...
    if(remove_large_community_sets != nullptr)
    {
        children["remove-large-community-sets"] = remove_large_community_sets;
    }
    ...
    if(append_large_community_sets != nullptr)
    {
        children["append-large-community-sets"] = append_large_community_sets;
    }
...
{
    if(name == "prepend-etag-sets" || name == "prefix-sets" || name == "large-community-sets" || name == "prepend-large-community-sets" || name == "append-etag-sets" || name == "remove-etag-sets" || name == "remove-large-community-sets" || name == "mac-sets" || name == "extended-community-opaque-sets" || name == "prepend-mac-sets" || name == "ospf-area-sets" || name == "append-mac-sets" || name == "extended-community-cost-sets" || name == "remove-mac-sets" || name == "extended-community-soo-sets" || name == "esi-sets" || name == "prepend-esi-sets" || name == "append-esi-sets" || name == "remove-esi-sets" || name == "extended-community-seg-nh-sets" || name == "rd-sets" || name == "policy-global-set-table" || name == "append-large-community-sets" || name == "extended-community-bandwidth-sets" || name == "community-sets" || name == "as-path-sets" || name == "tag-sets" || name == "etag-sets" || name == "extended-community-rt-sets")
        return true;
    return false;
}
...
RoutingPolicy::Sets::PrependEtagSets::PrependEtagSets()
{
    ...
    yang_name = "prepend-etag-sets"; yang_parent_name = "sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::PrependEtagSets::get_absolute_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::PrependEtagSets::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
    ...
    etag_set_as_text{YType::str, "etag-set-as-text"}
{
    ...
    yang_name = "prepend-etag-set"; yang_parent_name = "prepend-etag-sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::PrependEtagSets::PrependEtagSet::get_absolute_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::PrependEtagSets::PrependEtagSet::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
RoutingPolicy::Sets::PrependLargeCommunitySets::PrependLargeCommunitySets()
{

    yang_name = "prepend-large-community-sets"; yang_parent_name = "sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
bool RoutingPolicy::Sets::PrependLargeCommunitySets::has_data() const
{
    for (std::size_t index=0; index<prepend_large_community_set.size(); index++)
    {
        if(prepend_large_community_set[index]->has_data())
            return true;
    }
    return false;
}

bool RoutingPolicy::Sets::PrependLargeCommunitySets::has_operation() const
{
    for (std::size_t index=0; index<prepend_large_community_set.size(); index++)
    {
        if(prepend_large_community_set[index]->has_operation())
            return true;
    }
    return is_set(yfilter);
}

std::string RoutingPolicy::Sets::PrependLargeCommunitySets::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-policy-repository-cfg:routing-policy/sets/" << get_segment_path();
    return path_buffer.str();
...
std::string RoutingPolicy::Sets::PrependLargeCommunitySets::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "prepend-large-community-sets";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::PrependLargeCommunitySets::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> RoutingPolicy::Sets::PrependLargeCommunitySets::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
void RoutingPolicy::Sets::PrependLargeCommunitySets::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void RoutingPolicy::Sets::PrependLargeCommunitySets::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool RoutingPolicy::Sets::PrependLargeCommunitySets::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "prepend-large-community-set")
        return true;
    return false;
}

RoutingPolicy::Sets::PrependLargeCommunitySets::PrependLargeCommunitySet::PrependLargeCommunitySet()
    :
    set_name{YType::str, "set-name"},
    large_community_set_as_text{YType::str, "large-community-set-as-text"}
{

    yang_name = "prepend-large-community-set"; yang_parent_name = "prepend-large-community-sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
bool RoutingPolicy::Sets::PrependLargeCommunitySets::PrependLargeCommunitySet::has_data() const
{
    return set_name.is_set
	|| large_community_set_as_text.is_set;
}

bool RoutingPolicy::Sets::PrependLargeCommunitySets::PrependLargeCommunitySet::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(set_name.yfilter)
	|| ydk::is_set(large_community_set_as_text.yfilter);
...
std::string RoutingPolicy::Sets::PrependLargeCommunitySets::PrependLargeCommunitySet::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-policy-repository-cfg:routing-policy/sets/prepend-large-community-sets/" << get_segment_path();
    return path_buffer.str();
}

std::string RoutingPolicy::Sets::PrependLargeCommunitySets::PrependLargeCommunitySet::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "prepend-large-community-set" <<"[set-name='" <<set_name <<"']";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::PrependLargeCommunitySets::PrependLargeCommunitySet::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> RoutingPolicy::Sets::PrependLargeCommunitySets::PrependLargeCommunitySet::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}
...
void RoutingPolicy::Sets::PrependLargeCommunitySets::PrependLargeCommunitySet::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "set-name")
    {
        set_name = value;
...
void RoutingPolicy::Sets::PrependLargeCommunitySets::PrependLargeCommunitySet::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "set-name")
    {
        set_name.yfilter = yfilter;
...
bool RoutingPolicy::Sets::PrependLargeCommunitySets::PrependLargeCommunitySet::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "set-name" || name == "large-community-set-as-text")
        return true;
    return false;
...
RoutingPolicy::Sets::AppendEtagSets::AppendEtagSets()
{
    ...
    yang_name = "append-etag-sets"; yang_parent_name = "sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::AppendEtagSets::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-policy-repository-cfg:routing-policy/sets/" << get_segment_path();
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::AppendEtagSets::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
    ...
    etag_set_as_text{YType::str, "etag-set-as-text"}
{
    ...
    yang_name = "append-etag-set"; yang_parent_name = "append-etag-sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::AppendEtagSets::AppendEtagSet::get_absolute_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::AppendEtagSets::AppendEtagSet::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
RoutingPolicy::Sets::RemoveEtagSets::RemoveEtagSets()
{
    ...
    yang_name = "remove-etag-sets"; yang_parent_name = "sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::RemoveEtagSets::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-policy-repository-cfg:routing-policy/sets/" << get_segment_path();
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::RemoveEtagSets::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
    ...
    etag_set_as_text{YType::str, "etag-set-as-text"}
{
    ...
    yang_name = "remove-etag-set"; yang_parent_name = "remove-etag-sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::RemoveEtagSets::RemoveEtagSet::get_absolute_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::RemoveEtagSets::RemoveEtagSet::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
RoutingPolicy::Sets::RemoveLargeCommunitySets::RemoveLargeCommunitySets()
{

    yang_name = "remove-large-community-sets"; yang_parent_name = "sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
bool RoutingPolicy::Sets::RemoveLargeCommunitySets::has_data() const
{
    for (std::size_t index=0; index<remove_large_community_set.size(); index++)
    {
        if(remove_large_community_set[index]->has_data())
            return true;
    }
    return false;
}

bool RoutingPolicy::Sets::RemoveLargeCommunitySets::has_operation() const
{
    for (std::size_t index=0; index<remove_large_community_set.size(); index++)
    {
        if(remove_large_community_set[index]->has_operation())
            return true;
    }
    return is_set(yfilter);
}

std::string RoutingPolicy::Sets::RemoveLargeCommunitySets::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-policy-repository-cfg:routing-policy/sets/" << get_segment_path();
    return path_buffer.str();
...
std::string RoutingPolicy::Sets::RemoveLargeCommunitySets::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "remove-large-community-sets";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::RemoveLargeCommunitySets::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> RoutingPolicy::Sets::RemoveLargeCommunitySets::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
void RoutingPolicy::Sets::RemoveLargeCommunitySets::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void RoutingPolicy::Sets::RemoveLargeCommunitySets::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool RoutingPolicy::Sets::RemoveLargeCommunitySets::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "remove-large-community-set")
        return true;
    return false;
}

RoutingPolicy::Sets::RemoveLargeCommunitySets::RemoveLargeCommunitySet::RemoveLargeCommunitySet()
    :
    set_name{YType::str, "set-name"},
    large_community_set_as_text{YType::str, "large-community-set-as-text"}
{

    yang_name = "remove-large-community-set"; yang_parent_name = "remove-large-community-sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
bool RoutingPolicy::Sets::RemoveLargeCommunitySets::RemoveLargeCommunitySet::has_data() const
{
    return set_name.is_set
	|| large_community_set_as_text.is_set;
}

bool RoutingPolicy::Sets::RemoveLargeCommunitySets::RemoveLargeCommunitySet::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(set_name.yfilter)
	|| ydk::is_set(large_community_set_as_text.yfilter);
...
std::string RoutingPolicy::Sets::RemoveLargeCommunitySets::RemoveLargeCommunitySet::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-policy-repository-cfg:routing-policy/sets/remove-large-community-sets/" << get_segment_path();
    return path_buffer.str();
}

std::string RoutingPolicy::Sets::RemoveLargeCommunitySets::RemoveLargeCommunitySet::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "remove-large-community-set" <<"[set-name='" <<set_name <<"']";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::RemoveLargeCommunitySets::RemoveLargeCommunitySet::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> RoutingPolicy::Sets::RemoveLargeCommunitySets::RemoveLargeCommunitySet::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}
...
void RoutingPolicy::Sets::RemoveLargeCommunitySets::RemoveLargeCommunitySet::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "set-name")
    {
        set_name = value;
...
void RoutingPolicy::Sets::RemoveLargeCommunitySets::RemoveLargeCommunitySet::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "set-name")
    {
        set_name.yfilter = yfilter;
...
bool RoutingPolicy::Sets::RemoveLargeCommunitySets::RemoveLargeCommunitySet::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "set-name" || name == "large-community-set-as-text")
        return true;
    return false;
...
RoutingPolicy::Sets::PrependMacSets::PrependMacSets()
{
    ...
    yang_name = "prepend-mac-sets"; yang_parent_name = "sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::PrependMacSets::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-policy-repository-cfg:routing-policy/sets/" << get_segment_path();
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::PrependMacSets::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
    ...
    mac_set_as_text{YType::str, "mac-set-as-text"}
{
    ...
    yang_name = "prepend-mac-set"; yang_parent_name = "prepend-mac-sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::PrependMacSets::PrependMacSet::get_absolute_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::PrependMacSets::PrependMacSet::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
RoutingPolicy::Sets::AppendMacSets::AppendMacSets()
{
    ...
    yang_name = "append-mac-sets"; yang_parent_name = "sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::AppendMacSets::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-policy-repository-cfg:routing-policy/sets/" << get_segment_path();
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::AppendMacSets::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
    ...
    mac_set_as_text{YType::str, "mac-set-as-text"}
{
    ...
    yang_name = "append-mac-set"; yang_parent_name = "append-mac-sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::AppendMacSets::AppendMacSet::get_absolute_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::AppendMacSets::AppendMacSet::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
RoutingPolicy::Sets::RemoveMacSets::RemoveMacSets()
{
    ...
    yang_name = "remove-mac-sets"; yang_parent_name = "sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::RemoveMacSets::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-policy-repository-cfg:routing-policy/sets/" << get_segment_path();
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::RemoveMacSets::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
    ...
    mac_set_as_text{YType::str, "mac-set-as-text"}
{
    ...
    yang_name = "remove-mac-set"; yang_parent_name = "remove-mac-sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::RemoveMacSets::RemoveMacSet::get_absolute_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::RemoveMacSets::RemoveMacSet::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
RoutingPolicy::Sets::PrependEsiSets::PrependEsiSets()
{
    ...
    yang_name = "prepend-esi-sets"; yang_parent_name = "sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::PrependEsiSets::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-policy-repository-cfg:routing-policy/sets/" << get_segment_path();
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::PrependEsiSets::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
    ...
    esi_set_as_text{YType::str, "esi-set-as-text"}
{
    ...
    yang_name = "prepend-esi-set"; yang_parent_name = "prepend-esi-sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::PrependEsiSets::PrependEsiSet::get_absolute_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::PrependEsiSets::PrependEsiSet::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
RoutingPolicy::Sets::AppendEsiSets::AppendEsiSets()
{
    ...
    yang_name = "append-esi-sets"; yang_parent_name = "sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::AppendEsiSets::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-policy-repository-cfg:routing-policy/sets/" << get_segment_path();
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::AppendEsiSets::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
    ...
    esi_set_as_text{YType::str, "esi-set-as-text"}
{
    ...
    yang_name = "append-esi-set"; yang_parent_name = "append-esi-sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::AppendEsiSets::AppendEsiSet::get_absolute_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::AppendEsiSets::AppendEsiSet::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
RoutingPolicy::Sets::RemoveEsiSets::RemoveEsiSets()
{
    ...
    yang_name = "remove-esi-sets"; yang_parent_name = "sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::RemoveEsiSets::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-policy-repository-cfg:routing-policy/sets/" << get_segment_path();
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::RemoveEsiSets::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
    ...
    esi_set_as_text{YType::str, "esi-set-as-text"}
{
    ...
    yang_name = "remove-esi-set"; yang_parent_name = "remove-esi-sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string RoutingPolicy::Sets::RemoveEsiSets::RemoveEsiSet::get_absolute_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::RemoveEsiSets::RemoveEsiSet::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
RoutingPolicy::Sets::AppendLargeCommunitySets::AppendLargeCommunitySets()
{

    yang_name = "append-large-community-sets"; yang_parent_name = "sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
bool RoutingPolicy::Sets::AppendLargeCommunitySets::has_data() const
{
    for (std::size_t index=0; index<append_large_community_set.size(); index++)
    {
        if(append_large_community_set[index]->has_data())
            return true;
    }
    return false;
}

bool RoutingPolicy::Sets::AppendLargeCommunitySets::has_operation() const
{
    for (std::size_t index=0; index<append_large_community_set.size(); index++)
    {
        if(append_large_community_set[index]->has_operation())
            return true;
    }
    return is_set(yfilter);
}

std::string RoutingPolicy::Sets::AppendLargeCommunitySets::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-policy-repository-cfg:routing-policy/sets/" << get_segment_path();
    return path_buffer.str();
...
std::string RoutingPolicy::Sets::AppendLargeCommunitySets::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "append-large-community-sets";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::AppendLargeCommunitySets::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> RoutingPolicy::Sets::AppendLargeCommunitySets::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
void RoutingPolicy::Sets::AppendLargeCommunitySets::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void RoutingPolicy::Sets::AppendLargeCommunitySets::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool RoutingPolicy::Sets::AppendLargeCommunitySets::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "append-large-community-set")
        return true;
    return false;
}

RoutingPolicy::Sets::AppendLargeCommunitySets::AppendLargeCommunitySet::AppendLargeCommunitySet()
    :
    set_name{YType::str, "set-name"},
    large_community_set_as_text{YType::str, "large-community-set-as-text"}
{

    yang_name = "append-large-community-set"; yang_parent_name = "append-large-community-sets"; is_top_level_class = false; has_list_ancestor = false;
}
...
bool RoutingPolicy::Sets::AppendLargeCommunitySets::AppendLargeCommunitySet::has_data() const
{
    return set_name.is_set
	|| large_community_set_as_text.is_set;
}

bool RoutingPolicy::Sets::AppendLargeCommunitySets::AppendLargeCommunitySet::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(set_name.yfilter)
	|| ydk::is_set(large_community_set_as_text.yfilter);
...
std::string RoutingPolicy::Sets::AppendLargeCommunitySets::AppendLargeCommunitySet::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-policy-repository-cfg:routing-policy/sets/append-large-community-sets/" << get_segment_path();
    return path_buffer.str();
}

std::string RoutingPolicy::Sets::AppendLargeCommunitySets::AppendLargeCommunitySet::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "append-large-community-set" <<"[set-name='" <<set_name <<"']";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > RoutingPolicy::Sets::AppendLargeCommunitySets::AppendLargeCommunitySet::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> RoutingPolicy::Sets::AppendLargeCommunitySets::AppendLargeCommunitySet::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}
...
void RoutingPolicy::Sets::AppendLargeCommunitySets::AppendLargeCommunitySet::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "set-name")
    {
        set_name = value;
...
void RoutingPolicy::Sets::AppendLargeCommunitySets::AppendLargeCommunitySet::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "set-name")
    {
        set_name.yfilter = yfilter;
...
bool RoutingPolicy::Sets::AppendLargeCommunitySets::AppendLargeCommunitySet::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "set-name" || name == "large-community-set-as-text")
        return true;
    return false;
