...
{
    if(name == "limits" || name == "route-policies" || name == "sets" || name == "editor" || name == "set-exit-as-abort")
        return true;
    return false;
}
...
{
    if(name == "append-esi-sets" || name == "append-etag-sets" || name == "append-large-community-sets" || name == "append-mac-sets" || name == "as-path-sets" || name == "community-sets" || name == "esi-sets" || name == "etag-sets" || name == "extended-community-bandwidth-sets" || name == "extended-community-cost-sets" || name == "extended-community-opaque-sets" || name == "extended-community-rt-sets" || name == "extended-community-seg-nh-sets" || name == "extended-community-soo-sets" || name == "large-community-sets" || name == "mac-sets" || name == "ospf-area-sets" || name == "policy-global-set-table" || name == "prefix-sets" || name == "prepend-esi-sets" || name == "prepend-etag-sets" || name == "prepend-large-community-sets" || name == "prepend-mac-sets" || name == "rd-sets" || name == "remove-esi-sets" || name == "remove-etag-sets" || name == "remove-large-community-sets" || name == "remove-mac-sets" || name == "tag-sets")
        return true;
    return false;
}
