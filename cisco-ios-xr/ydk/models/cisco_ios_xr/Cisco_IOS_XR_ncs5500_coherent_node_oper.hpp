...
class Coherent::Nodes::Node::Coherenthealth : public ydk::Entity
{
    public:
        ...
        ydk::YLeaf is_peyto; //type: boolean
        ...
        ydk::YLeaf dsp0_version; //type: string
        ydk::YLeaf dsp1_version; //type: string
        ydk::YLeaf dsp2_version; //type: string
...
class Coherent::Nodes::Node::Coherenthealth::PortData : public ydk::Entity
{
    public:
        ...
        ydk::YLeaf end_of_config; //type: boolean
        ydk::YLeaf optics_laser_state; //type: boolean
        ydk::YLeaf laser_state; //type: boolean
        ...
        ydk::YLeaf dsp_hw_alarms; //type: string
...
class Coherent::Nodes::Node::Coherenthealth::PortData::CtpInfo : public ydk::Entity
{
    public:
        ...
        ydk::YLeaf module_hardware_version_number; //type: string
        ydk::YLeaf module_firmware_running_version_number; //type: string
        ydk::YLeaf module_firmware_committed_version_number; //type: string
