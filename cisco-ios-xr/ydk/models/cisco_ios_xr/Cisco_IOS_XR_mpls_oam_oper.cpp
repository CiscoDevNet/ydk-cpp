...
{
    if(name == "interface" || name == "packet" || name == "global")
        return true;
    return false;
}
...
{
    if(name == "interface-name" || name == "interface-name-xr" || name == "state" || name == "mtu" || name == "prefix-length" || name == "prefix-length-v6" || name == "primary-address" || name == "primary-address-v6")
        return true;
    return false;
}
...
{
    if(name == "interface-name-xr" || name == "state" || name == "mtu" || name == "prefix-length" || name == "prefix-length-v6" || name == "primary-address" || name == "primary-address-v6")
        return true;
    return false;
}
...
bool MplsOam::Interface::Details::Detail::PacketStatistics::has_data() const
{
	...
	|| (protect_rep_sent !=  nullptr && protect_rep_sent->has_data());
}
...
{
    if(name == "received" || name == "sent" || name == "working-req-sent" || name == "working-rep-sent" || name == "protect-req-sent" || name == "protect-rep-sent")
        return true;
    return false;
}
...
bool MplsOam::Interface::Details::Detail::PacketStatistics::Received::has_data() const
{
	...
	|| (protect_protocol_received_good_reply !=  nullptr && protect_protocol_received_good_reply->has_data())
...
bool MplsOam::Interface::Details::Detail::PacketStatistics::Sent::has_data() const
{
	...
	|| (bfd_no_reply !=  nullptr && bfd_no_reply->has_data());
}
...
{
    if(name == "transmit-good" || name == "transmit-drop" || name == "transmit-bfd-good" || name == "bfd-no-reply")
        return true;
    return false;
}
...
{
    if(name == "message-statistics" || name == "collaborator-statistics" || name == "total-clients")
        return true;
    return false;
}
...
{
    if(name == "register-messages" || name == "unregister-messages" || name == "echo-submit-messages" || name == "echo-cancel-messages" || name == "get-result-messages" || name == "get-config-messages" || name == "get-response-messages" || name == "property-response-messages" || name == "property-request-messages" || name == "property-block-messages" || name == "thread-request-messages")
        return true;
    return false;
}
