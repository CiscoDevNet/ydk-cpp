...
std::shared_ptr<ydk::Entity> AtmVcm::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::get_children() const
{
...
std::shared_ptr<ydk::Entity> AtmVcm::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "node")
    {
        auto ent_ = std::make_shared<AtmVcm::Nodes::Node>();
        ent_->parent = this;
        node.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(vcs != nullptr)
    ...
    if(cell_packs != nullptr)
    {
        _children["cell-packs"] = cell_packs;
    }
    ...
    if(class_links != nullptr)
    {
        _children["class-links"] = class_links;
    }
...
{
    if(name == "vcs" || name == "cell-packs" || name == "pvps" || name == "class-links" || name == "interfaces" || name == "vp-tunnels" || name == "node-name")
        return true;
    return false;
}
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::Vcs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "vc")
    {
        auto ent_ = std::make_shared<AtmVcm::Nodes::Node::Vcs::Vc>();
        ent_->parent = this;
        vc.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::Vcs::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : vc.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::Vcs::Vc::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::Vcs::Vc::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(cell_packing_data != nullptr)
    {
        _children["cell-packing-data"] = cell_packing_data;
    }
...
{
    if(name == "cell-packing-data" || name == "interface-name" || name == "vpi" || name == "vci" || name == "main-interface" || name == "sub-interface" || name == "vc-interface" || name == "vpi-xr" || name == "vci-xr" || name == "type" || name == "encapsulation" || name == "shape" || name == "peak-cell-rate" || name == "sustained-cell-rate" || name == "burst-rate" || name == "encaps-inherit-level" || name == "qos-inherit-level" || name == "transmit-mtu" || name == "receive-mtu" || name == "vc-onvp-tunnel" || name == "vc-on-p2p-sub-interface" || name == "oper-status" || name == "amin-status" || name == "internal-state" || name == "last-state-change-time" || name == "test-mode")
        return true;
    return false;
}
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::Vcs::Vc::CellPackingData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::Vcs::Vc::CellPackingData::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
{
    if(name == "local-max-cells-packed-per-packet" || name == "negotiated-max-cells-packed-per-packet" || name == "max-cell-packed-timeout")
        return true;
    return false;
}
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::CellPacks::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "cell-pack")
    {
        auto ent_ = std::make_shared<AtmVcm::Nodes::Node::CellPacks::CellPack>();
        ent_->parent = this;
        cell_pack.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::CellPacks::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : cell_pack.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::CellPacks::CellPack::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::CellPacks::CellPack::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(cell_packing != nullptr)
...
{
    if(name == "cell-packing" || name == "interface-name" || name == "pci" || name == "sub-interface-name" || name == "cell-packing-mode" || name == "vpi" || name == "vci" || name == "received-average-cells-packets" || name == "sent-cells-packets")
        return true;
    return false;
}
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::CellPacks::CellPack::CellPacking::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::CellPacks::CellPack::CellPacking::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::Pvps::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "pvp")
    {
        auto ent_ = std::make_shared<AtmVcm::Nodes::Node::Pvps::Pvp>();
        ent_->parent = this;
        pvp.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::Pvps::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::Pvps::Pvp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "cell-packing-data")
    {
        if(cell_packing_data == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::Pvps::Pvp::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(cell_packing_data != nullptr)
...
{
    if(name == "cell-packing-data" || name == "interface-name" || name == "vpi" || name == "main-interface" || name == "sub-interface" || name == "vc-interface" || name == "vpi-xr" || name == "vci-xr" || name == "type" || name == "encapsulation" || name == "shape" || name == "peak-cell-rate" || name == "sustained-cell-rate" || name == "burst-rate" || name == "encaps-inherit-level" || name == "qos-inherit-level" || name == "transmit-mtu" || name == "receive-mtu" || name == "vc-onvp-tunnel" || name == "vc-on-p2p-sub-interface" || name == "oper-status" || name == "amin-status" || name == "internal-state" || name == "last-state-change-time" || name == "test-mode")
        return true;
    return false;
}
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::Pvps::Pvp::CellPackingData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::Pvps::Pvp::CellPackingData::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::ClassLinks::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "class-link")
    {
        auto ent_ = std::make_shared<AtmVcm::Nodes::Node::ClassLinks::ClassLink>();
        ent_->parent = this;
        class_link.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::ClassLinks::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : class_link.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::ClassLinks::ClassLink::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::ClassLinks::ClassLink::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(vc_class_not_supported != nullptr)
    {
        _children["vc-class-not-supported"] = vc_class_not_supported;
    }

    if(oam_config != nullptr)
    {
        _children["oam-config"] = oam_config;
    }
...
{
    if(name == "vc-class-not-supported" || name == "oam-config" || name == "vpi" || name == "vci" || name == "sub-interface-name")
        return true;
    return false;
}
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::ClassLinks::ClassLink::VcClassNotSupported::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::ClassLinks::ClassLink::VcClassNotSupported::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
bool AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::has_data() const
{
	...
	|| (ais_rdi !=  nullptr && ais_rdi->has_data());
}
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(class_link_shaping != nullptr)
    {
        _children["class-link-shaping"] = class_link_shaping;
    }

    if(class_link_encapsulation != nullptr)
    {
        _children["class-link-encapsulation"] = class_link_encapsulation;
    }
    ...
    if(oam_retry != nullptr)
    {
        _children["oam-retry"] = oam_retry;
    }

    if(ais_rdi != nullptr)
    {
        _children["ais-rdi"] = ais_rdi;
    }
...
{
    if(name == "class-link-shaping" || name == "class-link-encapsulation" || name == "oam-pvc" || name == "oam-retry" || name == "ais-rdi")
        return true;
    return false;
}
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::ClassLinkShaping::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::ClassLinkShaping::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
{
    if(name == "shaping-type" || name == "peak-output-rate" || name == "average-output-rate" || name == "burst-output-rate" || name == "shaping-inherit-level")
        return true;
    return false;
}
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::ClassLinkEncapsulation::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::ClassLinkEncapsulation::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
{
    if(name == "encapsulation-type" || name == "encapsulation-inherit-level")
        return true;
    return false;
}
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::OamPvc::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::OamPvc::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
{
    if(name == "manage-level" || name == "pvc-frequency" || name == "keep-vc-up" || name == "ais-rdi-failure" || name == "manage-inherit-level")
        return true;
    return false;
}
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::OamRetry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::OamRetry::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
{
    if(name == "retry-up-count" || name == "down-count" || name == "retry-frequency" || name == "retry-inherit-level")
        return true;
    return false;
}
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::AisRdi::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::ClassLinks::ClassLink::OamConfig::AisRdi::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
{
    if(name == "ais-rdi-up-count" || name == "ais-rdi-up-time" || name == "ais-rdi-inherit-level")
        return true;
    return false;
}
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::Interfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "interface")
    {
        auto ent_ = std::make_shared<AtmVcm::Nodes::Node::Interfaces::Interface>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::Interfaces::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::Interfaces::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "cell-packing-data")
    {
        if(cell_packing_data == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::Interfaces::Interface::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(cell_packing_data != nullptr)
...
{
    if(name == "cell-packing-data" || name == "interface-name" || name == "ilmi-vpi" || name == "ilmi-vci" || name == "pvc-failures" || name == "currently-failing-layer2pv-ps" || name == "currently-failing-layer2pv-cs" || name == "currently-failing-layer3vp-tunnels" || name == "currently-failing-layer3pv-cs" || name == "pvc-failures-trap-enable" || name == "pvc-notification-interval" || name == "configured-layer2pv-ps" || name == "configured-layer2pv-cs" || name == "configured-layer3vp-tunnels" || name == "configured-layer3pv-cs" || name == "port-type" || name == "main-interface" || name == "l2-cell-packing-count")
        return true;
    return false;
}
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::Interfaces::Interface::CellPackingData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::Interfaces::Interface::CellPackingData::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::VpTunnels::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "vp-tunnel")
    {
        auto ent_ = std::make_shared<AtmVcm::Nodes::Node::VpTunnels::VpTunnel>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::VpTunnels::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> AtmVcm::Nodes::Node::VpTunnels::VpTunnel::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> AtmVcm::Nodes::Node::VpTunnels::VpTunnel::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
{
    if(name == "interface-name" || name == "vpi" || name == "main-interface" || name == "vp-interface" || name == "vpi-xr" || name == "shape" || name == "peak-cell-rate" || name == "sustained-cell-rate" || name == "burst-rate" || name == "f4oam-enabled" || name == "data-vc-count" || name == "oper-status" || name == "amin-status" || name == "internal-state" || name == "last-vp-state-change-time")
        return true;
    return false;
}
