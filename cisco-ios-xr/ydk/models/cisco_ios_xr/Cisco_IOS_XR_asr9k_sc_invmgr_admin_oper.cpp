    ...
    racks(std::make_shared<Inventory::Racks>())
{
    ...
    yang_name = "inventory"; yang_parent_name = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper"; is_top_level_class = true; has_list_ancestor = false; 
}
...
Inventory::Racks::Rack::Rack()
    ...
    number{YType::uint32, "number"}
        ,
    power_supply_shelfs(std::make_shared<Inventory::Racks::Rack::PowerSupplyShelfs>())
    , slots(std::make_shared<Inventory::Racks::Rack::Slots>())
    , fan_trays(std::make_shared<Inventory::Racks::Rack::FanTrays>())
    , power_supply_zones(std::make_shared<Inventory::Racks::Rack::PowerSupplyZones>())
    , basic_attributes(std::make_shared<Inventory::Racks::Rack::BasicAttributes>())
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Inventory::Racks::Rack::get_children() const
{
    ...
    if(power_supply_shelfs != nullptr)
    {
        _children["power-supply-shelfs"] = power_supply_shelfs;
    }
    ...
    if(power_supply_zones != nullptr)
    {
        _children["power-supply-zones"] = power_supply_zones;
    }
...
{
    if(name == "power-supply-shelfs" || name == "slots" || name == "fan-trays" || name == "power-supply-zones" || name == "basic-attributes" || name == "number")
        return true;
    return false;
}
...
Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelfs()
    :
    power_supply_shelf(this, {"number"})
{

    yang_name = "power-supply-shelfs"; yang_parent_name = "rack"; is_top_level_class = false; has_list_ancestor = true; 
}
...
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<power_supply_shelf.len(); index++)
    {
...
std::vector<std::pair<std::string, LeafData> > Inventory::Racks::Rack::PowerSupplyShelfs::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Inventory::Racks::Rack::PowerSupplyShelfs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "power-supply-shelf")
    {
        auto ent_ = std::make_shared<Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf>();
        ent_->parent = this;
        power_supply_shelf.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Inventory::Racks::Rack::PowerSupplyShelfs::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : power_supply_shelf.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
void Inventory::Racks::Rack::PowerSupplyShelfs::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Inventory::Racks::Rack::PowerSupplyShelfs::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Inventory::Racks::Rack::PowerSupplyShelfs::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "power-supply-shelf")
        return true;
    return false;
}
...
Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::PowerSupplyShelf()
    ...
    number{YType::uint32, "number"}
        ,
    basic_attributes(std::make_shared<Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::BasicAttributes>())
{
    basic_attributes->parent = this;

    yang_name = "power-supply-shelf"; yang_parent_name = "power-supply-shelfs"; is_top_level_class = false; has_list_ancestor = true; 
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "power-supply-shelf";
    ADD_KEY_TOKEN(number, "number");
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "basic-attributes")
    {
        if(basic_attributes == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(basic_attributes != nullptr)
...
void Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "number")
    {
        number = value;
...
void Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "number")
    {
        number.yfilter = yfilter;
...
bool Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::has_leaf_or_child_of_name(const std::string & name) const
{
...
Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::BasicAttributes::BasicAttributes()
    :
    basic_info(std::make_shared<Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::BasicAttributes::BasicInfo>())
{
    basic_info->parent = this;

    yang_name = "basic-attributes"; yang_parent_name = "power-supply-shelf"; is_top_level_class = false; has_list_ancestor = true; 
}
...
std::vector<std::pair<std::string, LeafData> > Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::BasicAttributes::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::BasicAttributes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::BasicAttributes::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(basic_info != nullptr)
...
void Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::BasicAttributes::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::BasicAttributes::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::BasicAttributes::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "basic-info")
        return true;
    return false;
...
std::vector<std::pair<std::string, LeafData> > Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::BasicAttributes::BasicInfo::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::BasicAttributes::BasicInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::BasicAttributes::BasicInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Inventory::Racks::Rack::PowerSupplyShelfs::PowerSupplyShelf::BasicAttributes::BasicInfo::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
{
    if(name == "sub-slots" || name == "hw-components" || name == "port-slots" || name == "sensors" || name == "basic-attributes" || name == "number")
        return true;
    return false;
}
...
{
    if(name == "port-slots" || name == "sensors" || name == "basic-attributes")
        return true;
    return false;
}
...
{
    if (is_presence_container) return true;
    return (fru_info !=  nullptr && fru_info->has_data())
...
{
    if(name == "fru-info" || name == "basic-info")
        return true;
    return false;
}
...
Inventory::Racks::Rack::FanTrays::FanTrays()
    :
    fan_tray(this, {"number"})
{
...
bool Inventory::Racks::Rack::FanTrays::has_data() const
{
    if (is_presence_container) return true;
...
bool Inventory::Racks::Rack::FanTrays::has_operation() const
{
    for (std::size_t index=0; index<fan_tray.len(); index++)
    {
...
std::string Inventory::Racks::Rack::FanTrays::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Inventory::Racks::Rack::FanTrays::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Inventory::Racks::Rack::FanTrays::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "fan-tray")
    {
        auto ent_ = std::make_shared<Inventory::Racks::Rack::FanTrays::FanTray>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Inventory::Racks::Rack::FanTrays::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Inventory::Racks::Rack::FanTrays::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Inventory::Racks::Rack::FanTrays::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Inventory::Racks::Rack::FanTrays::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "fan-tray")
        return true;
    return false;
...
Inventory::Racks::Rack::FanTrays::FanTray::FanTray()
    :
    number{YType::uint32, "number"}
        ,
    basic_attributes(std::make_shared<Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes>())
{
    basic_attributes->parent = this;
...
bool Inventory::Racks::Rack::FanTrays::FanTray::has_data() const
{
    if (is_presence_container) return true;
    return number.is_set
	|| (basic_attributes !=  nullptr && basic_attributes->has_data());
...
bool Inventory::Racks::Rack::FanTrays::FanTray::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(number.yfilter)
	|| (basic_attributes !=  nullptr && basic_attributes->has_operation());
...
std::string Inventory::Racks::Rack::FanTrays::FanTray::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Inventory::Racks::Rack::FanTrays::FanTray::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Inventory::Racks::Rack::FanTrays::FanTray::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "basic-attributes")
    {
        if(basic_attributes == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Inventory::Racks::Rack::FanTrays::FanTray::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(basic_attributes != nullptr)
...
void Inventory::Racks::Rack::FanTrays::FanTray::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "number")
    {
        number = value;
...
void Inventory::Racks::Rack::FanTrays::FanTray::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "number")
    {
        number.yfilter = yfilter;
...
bool Inventory::Racks::Rack::FanTrays::FanTray::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "basic-attributes" || name == "number")
        return true;
    return false;
...
Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::BasicAttributes()
    :
    basic_info(std::make_shared<Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::BasicInfo>())
{
    basic_info->parent = this;

    yang_name = "basic-attributes"; yang_parent_name = "fan-tray"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::has_data() const
{
    if (is_presence_container) return true;
    return (basic_info !=  nullptr && basic_info->has_data());
}

bool Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::has_operation() const
{
    return is_set(yfilter)
	|| (basic_info !=  nullptr && basic_info->has_operation());
}

std::string Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "basic-attributes";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "basic-info")
    {
        if(basic_info == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(basic_info != nullptr)
...
void Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "basic-info")
        return true;
    return false;
...
Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::BasicInfo::BasicInfo()
    :
    description{YType::str, "description"},
    vendor_type{YType::str, "vendor-type"},
    name{YType::str, "name"},
...
bool Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::BasicInfo::has_data() const
{
    if (is_presence_container) return true;
    return description.is_set
	|| vendor_type.is_set
...
std::vector<std::pair<std::string, LeafData> > Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::BasicInfo::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::BasicInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::BasicInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Inventory::Racks::Rack::FanTrays::FanTray::BasicAttributes::BasicInfo::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "description")
    {
        description = value;
...
Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZones()
    :
    power_supply_zone(this, {"number"})
{

    yang_name = "power-supply-zones"; yang_parent_name = "rack"; is_top_level_class = false; has_list_ancestor = true; 
}
...
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<power_supply_zone.len(); index++)
    {
...
std::vector<std::pair<std::string, LeafData> > Inventory::Racks::Rack::PowerSupplyZones::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Inventory::Racks::Rack::PowerSupplyZones::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "power-supply-zone")
    {
        auto ent_ = std::make_shared<Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone>();
        ent_->parent = this;
        power_supply_zone.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Inventory::Racks::Rack::PowerSupplyZones::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : power_supply_zone.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
void Inventory::Racks::Rack::PowerSupplyZones::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Inventory::Racks::Rack::PowerSupplyZones::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Inventory::Racks::Rack::PowerSupplyZones::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "power-supply-zone")
        return true;
    return false;
}
...
Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::PowerSupplyZone()
    ...
    number{YType::uint32, "number"}
        ,
    power_supply_zone_attributes(std::make_shared<Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::PowerSupplyZoneAttributes>())
{
    power_supply_zone_attributes->parent = this;

    yang_name = "power-supply-zone"; yang_parent_name = "power-supply-zones"; is_top_level_class = false; has_list_ancestor = true; 
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "power-supply-zone";
    ADD_KEY_TOKEN(number, "number");
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "power-supply-zone-attributes")
    {
        ...
        return power_supply_zone_attributes;
    }

    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(power_supply_zone_attributes != nullptr)
    {
        _children["power-supply-zone-attributes"] = power_supply_zone_attributes;
    }

    return _children;
}

void Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "number")
    {
        number = value;
...
void Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "number")
    {
        number.yfilter = yfilter;
...
bool Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "power-supply-zone-attributes" || name == "number")
        return true;
    return false;
}
...
Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::PowerSupplyZoneAttributes::PowerSupplyZoneAttributes()
    :
    power_supply_group_info(std::make_shared<Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::PowerSupplyZoneAttributes::PowerSupplyGroupInfo>())
{
    power_supply_group_info->parent = this;

    yang_name = "power-supply-zone-attributes"; yang_parent_name = "power-supply-zone"; is_top_level_class = false; has_list_ancestor = true; 
}
...
std::vector<std::pair<std::string, LeafData> > Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::PowerSupplyZoneAttributes::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::PowerSupplyZoneAttributes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "power-supply-group-info")
    {
        ...
        return power_supply_group_info;
    }

    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::PowerSupplyZoneAttributes::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(power_supply_group_info != nullptr)
    {
        _children["power-supply-group-info"] = power_supply_group_info;
    }

    return _children;
}

void Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::PowerSupplyZoneAttributes::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::PowerSupplyZoneAttributes::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::PowerSupplyZoneAttributes::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "power-supply-group-info")
        return true;
    return false;
}
    ...
    power_group_drawn_current{YType::int32, "power-group-drawn-current"}
{
    ...
    yang_name = "power-supply-group-info"; yang_parent_name = "power-supply-zone-attributes"; is_top_level_class = false; has_list_ancestor = true; 
}
...
std::vector<std::pair<std::string, LeafData> > Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::PowerSupplyZoneAttributes::PowerSupplyGroupInfo::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::PowerSupplyZoneAttributes::PowerSupplyGroupInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::PowerSupplyZoneAttributes::PowerSupplyGroupInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::PowerSupplyZoneAttributes::PowerSupplyGroupInfo::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::PowerSupplyZoneAttributes::PowerSupplyGroupInfo::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "power-group-redundancy-mode")
    {
...
bool Inventory::Racks::Rack::PowerSupplyZones::PowerSupplyZone::PowerSupplyZoneAttributes::PowerSupplyGroupInfo::has_leaf_or_child_of_name(const std::string & name) const
{
...
Inventory::Racks::Rack::BasicAttributes::BasicAttributes()
    :
    basic_info(std::make_shared<Inventory::Racks::Rack::BasicAttributes::BasicInfo>())
{
    basic_info->parent = this;

    yang_name = "basic-attributes"; yang_parent_name = "rack"; is_top_level_class = false; has_list_ancestor = true; 
}
...
std::vector<std::pair<std::string, LeafData> > Inventory::Racks::Rack::BasicAttributes::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Inventory::Racks::Rack::BasicAttributes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "basic-info")
    {
        if(basic_info == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Inventory::Racks::Rack::BasicAttributes::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(basic_info != nullptr)
...
void Inventory::Racks::Rack::BasicAttributes::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Inventory::Racks::Rack::BasicAttributes::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Inventory::Racks::Rack::BasicAttributes::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "basic-info")
        return true;
    return false;
...
std::vector<std::pair<std::string, LeafData> > Inventory::Racks::Rack::BasicAttributes::BasicInfo::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Inventory::Racks::Rack::BasicAttributes::BasicInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Inventory::Racks::Rack::BasicAttributes::BasicInfo::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Inventory::Racks::Rack::BasicAttributes::BasicInfo::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "description")
    {
        description = value;
