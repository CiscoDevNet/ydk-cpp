#ifndef _CISCO_IOS_XR_SYSADMIN_SHOW_TRACE_CM_
#define _CISCO_IOS_XR_SYSADMIN_SHOW_TRACE_CM_
...
class Cm::Trace : public ydk::Entity
{
    public:
        Trace();
        ~Trace();
...
class Cm::Trace::Location : public ydk::Entity
{
    public:
        Location();
        ~Location();
...
class Cm::Trace::Location::AllOptions : public ydk::Entity
{
    public:
        AllOptions();
        ~AllOptions();
...
class Cm::Trace::Location::AllOptions::TraceBlocks : public ydk::Entity
{
    public:
        TraceBlocks();
        ~TraceBlocks();
...
class Cm::Lsp : public ydk::Entity
{
    public:
        Lsp();
        ~Lsp();
...
class Cm::Lsp::LspdbLocations : public ydk::Entity
{
    public:
        LspdbLocations();
        ~LspdbLocations();
...
class Cm::Lsp::LspdbLocations::Lspdbi : public ydk::Entity
{
    public:
        Lspdbi();
        ~Lspdbi();
        ...
        ydk::YLeaf lsp_area_type; //type: AreaType
        ydk::YLeaf lsp_sequence; //type: uint32
        ydk::YLeaf lsp_core; //type: string
        ydk::YLeafList lsp_tlvs; //type: list of  string
...
#endif /* _CISCO_IOS_XR_SYSADMIN_SHOW_TRACE_CM_ */
