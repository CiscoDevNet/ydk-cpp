...
std::shared_ptr<Entity> ClearIsisLocalLsp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::shared_ptr<Entity> ClearIsisLocalLsp::clone_ptr() const
{
...
std::shared_ptr<Entity> ClearIsisLocalLsp::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "instance")
    {
        if(instance == nullptr)
...
std::shared_ptr<Entity> ClearIsisLocalLsp::Input::Instance::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}
