...
std::shared_ptr<ydk::Entity> SdrInventoryVm::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> SdrInventoryVm::get_children() const
{
...
std::shared_ptr<ydk::Entity> SdrInventoryVm::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> SdrInventoryVm::Nodes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "node")
    {
        auto ent_ = std::make_shared<SdrInventoryVm::Nodes::Node>();
        ent_->parent = this;
        node.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> SdrInventoryVm::Nodes::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> SdrInventoryVm::Nodes::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> SdrInventoryVm::Nodes::Node::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(node_entries != nullptr)
    {
        _children["node-entries"] = node_entries;
    }
...
std::shared_ptr<ydk::Entity> SdrInventoryVm::Nodes::Node::NodeEntries::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "node-entry")
    {
        auto ent_ = std::make_shared<SdrInventoryVm::Nodes::Node::NodeEntries::NodeEntry>();
        ent_->parent = this;
        node_entry.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> SdrInventoryVm::Nodes::Node::NodeEntries::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : node_entry.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> SdrInventoryVm::Nodes::Node::NodeEntries::NodeEntry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> SdrInventoryVm::Nodes::Node::NodeEntries::NodeEntry::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
