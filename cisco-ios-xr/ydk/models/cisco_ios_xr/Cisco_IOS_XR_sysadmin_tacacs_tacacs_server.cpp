...
{
    std::ostringstream path_buffer;
    path_buffer << "host" <<"[ip='" <<ip <<"']" <<"[port='" <<port <<"']";
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "ipv4" <<"[addr='" <<addr <<"']" <<"[port='" <<port <<"']";
    return path_buffer.str();
}
    ...
    authentication{YType::str, "authentication"}
{
    ...
    yang_name = "test-authentication"; yang_parent_name = "tacacs-server"; is_top_level_class = false; has_list_ancestor = false;
}
    ...
    authorization{YType::str, "authorization"}
{
    ...
    yang_name = "test-authorization"; yang_parent_name = "tacacs-server"; is_top_level_class = false; has_list_ancestor = false;
}
    ...
    accounting{YType::str, "accounting"}
{
    ...
    yang_name = "test-accounting"; yang_parent_name = "tacacs-server"; is_top_level_class = false; has_list_ancestor = false;
}
