...
std::shared_ptr<ydk::Entity> SnmpColdStart::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> SnmpColdStart::get_children() const
{
...
std::shared_ptr<ydk::Entity> SnmpColdStart::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> SnmpWarmStart::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> SnmpWarmStart::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> SnmpWarmStart::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> InterfaceLinkUp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceLinkUp::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> InterfaceLinkUp::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> InterfaceLinkUp::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceLinkUp::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> InterfaceLinkDown::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceLinkDown::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> InterfaceLinkDown::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> InterfaceLinkDown::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InterfaceLinkDown::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> SonetSectionStatus::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> SonetSectionStatus::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> SonetSectionStatus::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> SonetSectionStatus::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> SonetSectionStatus::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> SonetLineStatus::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> SonetLineStatus::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> SonetLineStatus::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> SonetLineStatus::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> SonetLineStatus::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> SonetPathStatus::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> SonetPathStatus::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> SonetPathStatus::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> SonetPathStatus::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> SonetPathStatus::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> InfraSyslogMessageGenerated::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InfraSyslogMessageGenerated::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> InfraSyslogMessageGenerated::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> InfraFlashDeviceInserted::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InfraFlashDeviceInserted::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> InfraFlashDeviceInserted::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> InfraFlashDeviceRemoved::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InfraFlashDeviceRemoved::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> InfraFlashDeviceRemoved::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> InfraRedundancyProgression::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InfraRedundancyProgression::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> InfraRedundancyProgression::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> InfraRedundancySwitch::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InfraRedundancySwitch::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> InfraRedundancySwitch::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> InfraBridgeNewRoot::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InfraBridgeNewRoot::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> InfraBridgeNewRoot::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> InfraBridgeTopologyChange::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InfraBridgeTopologyChange::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> InfraBridgeTopologyChange::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> InfraConfigEvent::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> InfraConfigEvent::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> InfraConfigEvent::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> EntitySensorThresholdNotification::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> EntitySensorThresholdNotification::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> EntitySensorThresholdNotification::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> EntitySensorThresholdNotification::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> EntitySensorThresholdNotification::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> EntityFruPowerStatusChangeFailed::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> EntityFruPowerStatusChangeFailed::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> EntityFruPowerStatusChangeFailed::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> EntityFruPowerStatusChangeFailed::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> EntityFruPowerStatusChangeFailed::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> EntityFruModuleStatusChangeUp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> EntityFruModuleStatusChangeUp::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> EntityFruModuleStatusChangeUp::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> EntityFruModuleStatusChangeUp::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> EntityFruModuleStatusChangeUp::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> EntityFruModuleStatusChangeDown::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> EntityFruModuleStatusChangeDown::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> EntityFruModuleStatusChangeDown::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> EntityFruModuleStatusChangeDown::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> EntityFruModuleStatusChangeDown::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> EntityFruFanTrayOperStatusUp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> EntityFruFanTrayOperStatusUp::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> EntityFruFanTrayOperStatusUp::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> EntityFruFanTrayOperStatusUp::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> EntityFruFanTrayOperStatusUp::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> EntityFruFanTrayInserted::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> EntityFruFanTrayInserted::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> EntityFruFanTrayInserted::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> EntityFruFanTrayInserted::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> EntityFruFanTrayInserted::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> EntityFruFanTrayRemoved::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> EntityFruFanTrayRemoved::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> EntityFruFanTrayRemoved::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> EntityFruFanTrayRemoved::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> EntityFruFanTrayRemoved::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> PlatformHfrBundleDownedLink::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformHfrBundleDownedLink::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> PlatformHfrBundleDownedLink::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> PlatformHfrBundleDownedLink::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformHfrBundleDownedLink::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> PlatformHfrBundleState::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformHfrBundleState::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> PlatformHfrBundleState::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> PlatformHfrBundleState::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformHfrBundleState::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> PlatformHfrPlaneState::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformHfrPlaneState::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> PlatformHfrPlaneState::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> PlatformHfrPlaneState::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> PlatformHfrPlaneState::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> RoutingBgpEstablished::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingBgpEstablished::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> RoutingBgpEstablished::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> RoutingBgpEstablishedRemotePeer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingBgpEstablishedRemotePeer::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> RoutingBgpEstablishedRemotePeer::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> RoutingBgpEstablishedRemotePeer::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingBgpEstablishedRemotePeer::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> RoutingBgpStateChange::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingBgpStateChange::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> RoutingBgpStateChange::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> RoutingBgpStateChangeRemotePeer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingBgpStateChangeRemotePeer::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> RoutingBgpStateChangeRemotePeer::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> RoutingBgpStateChangeRemotePeer::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingBgpStateChangeRemotePeer::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> RoutingOspfNeighborStateChange::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingOspfNeighborStateChange::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> RoutingOspfNeighborStateChange::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> RoutingOspfNeighborStateChangeAddress::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingOspfNeighborStateChangeAddress::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> RoutingOspfNeighborStateChangeAddress::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> RoutingOspfNeighborStateChangeAddress::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingOspfNeighborStateChangeAddress::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> RoutingMplsLdpSessionDown::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingMplsLdpSessionDown::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> RoutingMplsLdpSessionDown::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> RoutingMplsLdpSessionDownEntityId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingMplsLdpSessionDownEntityId::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> RoutingMplsLdpSessionDownEntityId::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> RoutingMplsLdpSessionDownEntityId::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingMplsLdpSessionDownEntityId::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> RoutingMplsTunnelReRouted::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingMplsTunnelReRouted::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> RoutingMplsTunnelReRouted::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> RoutingMplsTunnelReRoutedIndex::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingMplsTunnelReRoutedIndex::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> RoutingMplsTunnelReRoutedIndex::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> RoutingMplsTunnelReRoutedIndex::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingMplsTunnelReRoutedIndex::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> RoutingMplsTunnelReOptimized::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingMplsTunnelReOptimized::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> RoutingMplsTunnelReOptimized::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> RoutingMplsTunnelReOptimizedIndex::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingMplsTunnelReOptimizedIndex::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> RoutingMplsTunnelReOptimizedIndex::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> RoutingMplsTunnelReOptimizedIndex::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingMplsTunnelReOptimizedIndex::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> RoutingMplsTunnelDown::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingMplsTunnelDown::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> RoutingMplsTunnelDown::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> RoutingMplsTunnelDownIndex::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingMplsTunnelDownIndex::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(input != nullptr)
...
std::shared_ptr<ydk::Entity> RoutingMplsTunnelDownIndex::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> RoutingMplsTunnelDownIndex::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> RoutingMplsTunnelDownIndex::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> All::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> All::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> All::clone_ptr() const
{
