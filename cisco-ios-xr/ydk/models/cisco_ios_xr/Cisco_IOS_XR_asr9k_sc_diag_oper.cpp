...
#include "Cisco_IOS_XR_asr9k_sc_diag_oper.hpp"
    ...
    racks(std::make_shared<Diag::Racks>())
{
    ...
    yang_name = "diag"; yang_parent_name = "Cisco-IOS-XR-asr9k-sc-diag-oper"; is_top_level_class = true; has_list_ancestor = false; 
}
...
std::string Diag::get_segment_path() const
{
    ...
    path_buffer << "Cisco-IOS-XR-asr9k-sc-diag-oper:diag";
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-asr9k-sc-diag-oper:diag/" << get_segment_path();
    return path_buffer.str();
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XR-asr9k-sc-diag-oper:diag/racks/" << get_segment_path();
    return path_buffer.str();
}
...
{
    if(name == "slots" || name == "summary" || name == "rack-name")
        return true;
    return false;
}
