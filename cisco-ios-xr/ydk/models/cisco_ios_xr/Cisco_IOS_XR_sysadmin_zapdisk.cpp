...
std::shared_ptr<ydk::Entity> Zapdisk::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Zapdisk::get_children() const
{
...
std::shared_ptr<ydk::Entity> Zapdisk::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> Zapdisk::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Zapdisk::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(czapdisk_unset != nullptr)
    {
        _children["czapdisk-unset"] = czapdisk_unset;
    }
...
std::shared_ptr<ydk::Entity> Zapdisk::Input::CzapdiskUnset::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Zapdisk::Input::CzapdiskUnset::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> Zapdisk::Output::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Zapdisk::Output::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
