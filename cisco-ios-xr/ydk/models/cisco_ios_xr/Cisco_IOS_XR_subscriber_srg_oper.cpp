...
{
    if(name == "group-id-xr" || name == "group-ids" || name == "group-summaries" || name == "interfaces" || name == "node-name")
        return true;
    return false;
}
...
{
    if(name == "session-detailed-information" || name == "session-sync-error-information" || name == "group-id" || name == "group-id-xr" || name == "inner-vlan" || name == "interface-name" || name == "l2tp-tunnel-id" || name == "negative-acknowledgement-update-all" || name == "outer-vlan" || name == "pppoe-session-id" || name == "role-master" || name == "session-mac-address" || name == "valid-mac-address")
        return true;
    return false;
}
...
{
    if(name == "interface" || name == "group-id" || name == "access-tracking-object-name" || name == "access-tracking-object-status" || name == "core-tracking-object-name" || name == "core-tracking-object-status" || name == "current-role" || name == "description" || name == "disabled" || name == "group-id-xr" || name == "hold-timer" || name == "init-role" || name == "interface-count" || name == "l2tp-source-ip" || name == "last-switchover-reason" || name == "last-switchover-time" || name == "negotiating-role" || name == "object-tracking-status" || name == "peer-current-role" || name == "peer-init-role" || name == "peer-ipv4-address" || name == "peer-ipv6-address" || name == "peer-last-down-time" || name == "peer-last-negotiation-time" || name == "peer-last-up-time" || name == "peer-negotiating-role" || name == "peer-object-tracking-status" || name == "peer-status" || name == "pending-session-delete-count" || name == "pending-session-update-count" || name == "revertive-timer" || name == "session-count" || name == "slave-mode" || name == "slave-update-failure-count" || name == "switchover-count" || name == "switchover-hold-time" || name == "switchover-revert-time" || name == "tunnel-count" || name == "virtual-mac-address" || name == "virtual-mac-address-disable")
        return true;
    return false;
}
...
{
    if(name == "forward-referenced" || name == "interface-name" || name == "interface-synchronization-id" || name == "session-count")
        return true;
    return false;
}
