#ifndef _CISCO_IOS_XR_SYSADMIN_SHOW_TRACE_SLICE_MANAGER_
#define _CISCO_IOS_XR_SYSADMIN_SHOW_TRACE_SLICE_MANAGER_
...
class SliceManager : public ydk::Entity
{
    public:
        SliceManager();
        ~SliceManager();
...
class SliceManager::Trace : public ydk::Entity
{
    public:
        Trace();
        ~Trace();
...
class SliceManager::Trace::Location : public ydk::Entity
{
    public:
        Location();
        ~Location();
...
class SliceManager::Trace::Location::AllOptions : public ydk::Entity
{
    public:
        AllOptions();
        ~AllOptions();
...
class SliceManager::Trace::Location::AllOptions::TraceBlocks : public ydk::Entity
{
    public:
        TraceBlocks();
        ~TraceBlocks();
...
}; // SliceManager::Trace::Location::AllOptions::TraceBlocks


}
}

#endif /* _CISCO_IOS_XR_SYSADMIN_SHOW_TRACE_SLICE_MANAGER_ */
