...
std::shared_ptr<ydk::Entity> Controllers::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controllers::get_children() const
{
...
std::shared_ptr<ydk::Entity> Controllers::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> Controllers::Controllers_::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "controller")
    {
        auto ent_ = std::make_shared<Controllers::Controllers_::Controller>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Controllers::Controllers_::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
std::shared_ptr<ydk::Entity> Controllers::Controllers_::Controller::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Controllers::Controllers_::Controller::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
