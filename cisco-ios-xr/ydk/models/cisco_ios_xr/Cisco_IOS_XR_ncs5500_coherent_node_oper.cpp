...
{
    if(name == "coherent-time-stats" || name == "coherenthealth" || name == "devicemapping" || name == "port-mode-all-info" || name == "node-name")
        return true;
    return false;
}
...
{
    if(name == "dsp-ea-bulk-create" || name == "dsp-ea-bulk-update" || name == "opts-ea-bulk-create" || name == "opts-ea-bulk-update" || name == "port-stat" || name == "device-created" || name == "driver-init" || name == "driver-operational" || name == "dsp-controllers-created" || name == "eth-intf-created" || name == "optics-controllers-created")
        return true;
    return false;
}
...
{
    if(name == "cdmax-op-stats" || name == "cdmin-op-stats" || name == "laser-off-stats" || name == "laser-on-stats" || name == "traffictype-op-stats" || name == "txpwr-op-stats" || name == "wl-op-stats" || name == "cd-max" || name == "cd-min" || name == "laser-state" || name == "provisioned-frequency" || name == "traffic-type" || name == "tx-power")
        return true;
    return false;
}
...
{
    if(name == "port-data" || name == "aipc-srvr-state" || name == "board-type" || name == "denali0-version" || name == "denali1-version" || name == "denali2-version" || name == "dsp-ea-conn" || name == "fpd-in-progress" || name == "im-state" || name == "inside-prov-loop" || name == "jlink-op" || name == "morgoth-alive" || name == "morgoth-downloaded-version" || name == "morgoth-golden-version" || name == "morgoth-running-version" || name == "optics-ea-conn" || name == "pending-provision" || name == "pm-state" || name == "prov-infra-state" || name == "prov-run-count" || name == "pulse-sent" || name == "sdk-fpga-compatible" || name == "sdk-version" || name == "sysdb-state" || name == "vether-state")
        return true;
    return false;
}
...
{
    if(name == "ctp-info" || name == "interface-info" || name == "cd-max-op-rc" || name == "cd-min-op-rc" || name == "configured-cd-max" || name == "configured-cd-min" || name == "configured-frequency" || name == "configured-loopback-mode" || name == "configured-traffic-type" || name == "configured-tx-power" || name == "ctp2-hw-alarms" || name == "denali-hw-alarms" || name == "dsp-admin-up" || name == "dsp-ctrl-created" || name == "expected-ctp2-led-state" || name == "force-reprovision" || name == "fp-port-idx" || name == "has-pluggable" || name == "is-alarm-port-created-dsp" || name == "is-alarm-port-created-opt" || name == "is-pm-port-created-dsp" || name == "is-pm-port-created-opt" || name == "laser-on-pending" || name == "laser-op-rc" || name == "laser-state" || name == "led-op-rc" || name == "loopback-op-rc" || name == "optics-admin-up" || name == "optics-ctrl-created" || name == "pm-port-state-dsp" || name == "pm-port-state-opt" || name == "provisioned-cd-max" || name == "provisioned-cd-min" || name == "provisioned-ctp2-led-state" || name == "provisioned-frequency" || name == "provisioned-loopback-mode" || name == "provisioned-traffic-type" || name == "provisioned-tx-power" || name == "provisioning-failed" || name == "provisioning-needed" || name == "rc-alarm-port-dsp" || name == "rc-alarm-port-opt" || name == "rc-pm-port-dsp" || name == "rc-pm-port-opt" || name == "rc-pm-provision-dsp" || name == "rc-pm-provision-opt" || name == "traffic-op-rc" || name == "tx-power-op-rc" || name == "wlen-op-rc")
        return true;
    return false;
}
...
{
    if(name == "clei-code-number" || name == "ctp-type" || name == "date-code-number" || name == "description" || name == "deviation" || name == "module-firmware-committed-version-number" || name == "module-firmware-running-version-number" || name == "module-hardware-version-number" || name == "part-number" || name == "pid" || name == "serial-number" || name == "vendorname" || name == "vid")
        return true;
    return false;
}
...
{
    if(name == "admin-state" || name == "admin-up" || name == "ifname" || name == "intf-handle" || name == "is-created")
        return true;
    return false;
}
