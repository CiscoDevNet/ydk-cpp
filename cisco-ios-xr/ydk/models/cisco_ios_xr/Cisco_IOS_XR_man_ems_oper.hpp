...
class Grpc : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_man_ems_oper::Grpc::Statistics> statistics;
        std::shared_ptr<cisco_ios_xr::Cisco_IOS_XR_man_ems_oper::Grpc::Status> status;
...
class Grpc::Statistics : public ydk::Entity
{
    public:
        ...
        ydk::YLeaf ct_commit_config_req_recv; //type: uint64
        ydk::YLeaf ct_commit_config_res_sent; //type: uint64
        ydk::YLeaf ct_action_json_req_recv; //type: uint64
        ydk::YLeaf ct_action_json_res_sent; //type: uint64
