                        ...
                        class Module : public Entity
                        {
                                    ...
                                    class SensorNames : public Entity
                                    {
                                        ...
                                        class SensorName : public Entity
                                        {
                                            ...
                                            class Thresholds : public Entity
                                            {
                                                ...
                                                class Threshold : public Entity
                                                {
                                                    ...
                                                    class ValueDetailed : public Entity
                                                    {
                                                        ...
                                                        std::unique_ptr<Cisco_IOS_XR_asr9k_sc_envmon_admin_oper::EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules::Module::SensorTypes::SensorType::SensorNames::SensorName::Thresholds::Threshold::ValueDetailed> value_detailed;
                                                    ...
                                                    std::vector<std::unique_ptr<Cisco_IOS_XR_asr9k_sc_envmon_admin_oper::EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules::Module::SensorTypes::SensorType::SensorNames::SensorName::Thresholds::Threshold> > threshold;
                                            ...
                                            class ValueDetailed : public Entity
                                            {
                                                ...
                                                std::unique_ptr<Cisco_IOS_XR_asr9k_sc_envmon_admin_oper::EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules::Module::SensorTypes::SensorType::SensorNames::SensorName::Thresholds> thresholds;
                                                std::unique_ptr<Cisco_IOS_XR_asr9k_sc_envmon_admin_oper::EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules::Module::SensorTypes::SensorType::SensorNames::SensorName::ValueDetailed> value_detailed;


                                        }; // EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules::Module::SensorTypes::SensorType::SensorNames::SensorName


                                            std::vector<std::unique_ptr<Cisco_IOS_XR_asr9k_sc_envmon_admin_oper::EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules::Module::SensorTypes::SensorType::SensorNames::SensorName> > sensor_name;


                                    }; // EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules::Module::SensorTypes::SensorType::SensorNames


                                        std::unique_ptr<Cisco_IOS_XR_asr9k_sc_envmon_admin_oper::EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules::Module::SensorTypes::SensorType::SensorNames> sensor_names;


                                }; // EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules::Module::SensorTypes::SensorType


                                    std::vector<std::unique_ptr<Cisco_IOS_XR_asr9k_sc_envmon_admin_oper::EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules::Module::SensorTypes::SensorType> > sensor_type;
                            ...
                            class Power : public Entity
                            {
                                ...
                                class PowerBag : public Entity
                                {
                                    ...
                                    std::unique_ptr<Cisco_IOS_XR_asr9k_sc_envmon_admin_oper::EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules::Module::Power::PowerBag> power_bag;


                            }; // EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules::Module::Power


                                std::unique_ptr<Cisco_IOS_XR_asr9k_sc_envmon_admin_oper::EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules::Module::Power> power;
                                std::unique_ptr<Cisco_IOS_XR_asr9k_sc_envmon_admin_oper::EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules::Module::SensorTypes> sensor_types;


                        }; // EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules::Module


                            std::vector<std::unique_ptr<Cisco_IOS_XR_asr9k_sc_envmon_admin_oper::EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules::Module> > module;


                    }; // EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules


                        std::unique_ptr<Cisco_IOS_XR_asr9k_sc_envmon_admin_oper::EnvironmentalMonitoring::Racks::Rack::Slots::Slot::Modules> modules;


                }; // EnvironmentalMonitoring::Racks::Rack::Slots::Slot


                    std::vector<std::unique_ptr<Cisco_IOS_XR_asr9k_sc_envmon_admin_oper::EnvironmentalMonitoring::Racks::Rack::Slots::Slot> > slot;


            }; // EnvironmentalMonitoring::Racks::Rack::Slots


                std::unique_ptr<Cisco_IOS_XR_asr9k_sc_envmon_admin_oper::EnvironmentalMonitoring::Racks::Rack::Slots> slots;


        }; // EnvironmentalMonitoring::Racks::Rack


            std::vector<std::unique_ptr<Cisco_IOS_XR_asr9k_sc_envmon_admin_oper::EnvironmentalMonitoring::Racks::Rack> > rack;


    }; // EnvironmentalMonitoring::Racks


        std::unique_ptr<Cisco_IOS_XR_asr9k_sc_envmon_admin_oper::EnvironmentalMonitoring::Racks> racks;
