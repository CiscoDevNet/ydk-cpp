...
EntityPath NetFlow::Configuration::FlowExporterMaps::FlowExporterMap::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        path_buffer << "Cisco-IOS-XR-asr9k-netflow-oper:net-flow/configuration/flow-exporter-maps/" << get_segment_path();
    }
    else
    {
        get_relative_entity_path(this, ancestor, path_buffer);
...
EntityPath NetFlow::Configuration::FlowExporterMaps::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        path_buffer << "Cisco-IOS-XR-asr9k-netflow-oper:net-flow/configuration/" << get_segment_path();
    }
    else
    {
        get_relative_entity_path(this, ancestor, path_buffer);
...
EntityPath NetFlow::Configuration::FlowMonitorMaps::FlowMonitorMap::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        path_buffer << "Cisco-IOS-XR-asr9k-netflow-oper:net-flow/configuration/flow-monitor-maps/" << get_segment_path();
    }
    else
    {
        get_relative_entity_path(this, ancestor, path_buffer);
...
EntityPath NetFlow::Configuration::FlowSamplerMaps::FlowSamplerMap::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        path_buffer << "Cisco-IOS-XR-asr9k-netflow-oper:net-flow/configuration/flow-sampler-maps/" << get_segment_path();
    }
    else
    {
        get_relative_entity_path(this, ancestor, path_buffer);
