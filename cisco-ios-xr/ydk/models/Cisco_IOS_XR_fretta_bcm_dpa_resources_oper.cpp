...
Entity* Dpa::Resources::Nodes::Node::TableDatas::TableData::NpuTblr::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & Dpa::Resources::Nodes::Node::TableDatas::TableData::NpuTblr::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "table-data" <<"[resource='" <<resource.get() <<"']";
...
Entity* Dpa::Resources::Nodes::Node::TableDatas::TableData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "npu-tblr")
    {
        ...
        auto c = std::make_unique<Dpa::Resources::Nodes::Node::TableDatas::TableData::NpuTblr>();
        c->parent = this;
        npu_tblr.push_back(std::move(c));
        children[segment_path] = npu_tblr.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Dpa::Resources::Nodes::Node::TableDatas::TableData::get_children()
{
    for (auto const & c : npu_tblr)
    {
...
Entity* Dpa::Resources::Nodes::Node::TableDatas::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "table-data")
    {
        ...
        auto c = std::make_unique<Dpa::Resources::Nodes::Node::TableDatas::TableData>();
        c->parent = this;
        table_data.push_back(std::move(c));
        children[segment_path] = table_data.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Dpa::Resources::Nodes::Node::TableDatas::get_children()
{
    for (auto const & c : table_data)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Dpa::Resources::Nodes::Node::Node()
    :
    	...
    	,
    table_datas(std::make_unique<Dpa::Resources::Nodes::Node::TableDatas>())
{
    table_datas->parent = this;
    children["table-datas"] = table_datas.get();
...
bool Dpa::Resources::Nodes::Node::has_operation() const
{
	...
	|| (table_datas !=  nullptr && is_set(table_datas->operation));
}
...
Entity* Dpa::Resources::Nodes::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Dpa::Resources::Nodes::Node::get_children()
{
...
Entity* Dpa::Resources::Nodes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "node")
    {
        ...
        auto c = std::make_unique<Dpa::Resources::Nodes::Node>();
        c->parent = this;
...
std::map<std::string, Entity*> & Dpa::Resources::Nodes::get_children()
{
    for (auto const & c : node)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Dpa::Resources::Resources()
    :
    nodes(std::make_unique<Dpa::Resources::Nodes>())
{
    nodes->parent = this;
...
Entity* Dpa::Resources::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Dpa::Resources::get_children()
{
...
Dpa::Dpa()
    :
    resources(std::make_unique<Dpa::Resources>())
