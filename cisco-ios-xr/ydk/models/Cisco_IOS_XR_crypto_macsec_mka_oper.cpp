...
Entity* Macsec::Mka::Interfaces::Interface::Session::SessionSummary::OuterTag::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & Macsec::Mka::Interfaces::Interface::Session::SessionSummary::OuterTag::get_children()
{
    return children;
}
...
Entity* Macsec::Mka::Interfaces::Interface::Session::SessionSummary::InnerTag::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Macsec::Mka::Interfaces::Interface::Session::SessionSummary::InnerTag::get_children()
{
    return children;
}
...
Macsec::Mka::Interfaces::Interface::Session::SessionSummary::SessionSummary()
    :
	 ...
	 delay_protect{YType::boolean, "delay-protect"},
	 ...
	 window_size{YType::uint32, "window-size"}
    	,
    inner_tag(std::make_unique<Macsec::Mka::Interfaces::Interface::Session::SessionSummary::InnerTag>())
	,outer_tag(std::make_unique<Macsec::Mka::Interfaces::Interface::Session::SessionSummary::OuterTag>())
{
    inner_tag->parent = this;
    children["inner-tag"] = inner_tag.get();

    outer_tag->parent = this;
    children["outer-tag"] = outer_tag.get();
...
bool Macsec::Mka::Interfaces::Interface::Session::SessionSummary::has_operation() const
{
	...
	|| is_set(delay_protect.operation)
...
EntityPath Macsec::Mka::Interfaces::Interface::Session::SessionSummary::get_entity_path(Entity* ancestor) const
{
    ...
    if (delay_protect.is_set || is_set(delay_protect.operation)) leaf_name_data.push_back(delay_protect.get_name_leafdata());
...
Entity* Macsec::Mka::Interfaces::Interface::Session::SessionSummary::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Macsec::Mka::Interfaces::Interface::Session::SessionSummary::get_children()
{
...
Entity* Macsec::Mka::Interfaces::Interface::Session::Vp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Macsec::Mka::Interfaces::Interface::Session::Vp::get_children()
{
    return children;
}
...
Entity* Macsec::Mka::Interfaces::Interface::Session::Ca::LivePeer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Macsec::Mka::Interfaces::Interface::Session::Ca::LivePeer::get_children()
{
    return children;
}
...
Entity* Macsec::Mka::Interfaces::Interface::Session::Ca::PotentialPeer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Macsec::Mka::Interfaces::Interface::Session::Ca::PotentialPeer::get_children()
{
    return children;
}
...
Entity* Macsec::Mka::Interfaces::Interface::Session::Ca::DormantPeer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Macsec::Mka::Interfaces::Interface::Session::Ca::DormantPeer::get_children()
{
    return children;
}
...
Entity* Macsec::Mka::Interfaces::Interface::Session::Ca::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "dormant-peer")
    {
        ...
        auto c = std::make_unique<Macsec::Mka::Interfaces::Interface::Session::Ca::DormantPeer>();
        c->parent = this;
        dormant_peer.push_back(std::move(c));
        children[segment_path] = dormant_peer.back().get();
        return children.at(segment_path);
    }
    ...
    if(child_yang_name == "live-peer")
    {
        ...
        auto c = std::make_unique<Macsec::Mka::Interfaces::Interface::Session::Ca::LivePeer>();
        c->parent = this;
        live_peer.push_back(std::move(c));
        children[segment_path] = live_peer.back().get();
        return children.at(segment_path);
    }
    ...
    if(child_yang_name == "potential-peer")
    {
        ...
        auto c = std::make_unique<Macsec::Mka::Interfaces::Interface::Session::Ca::PotentialPeer>();
        c->parent = this;
        potential_peer.push_back(std::move(c));
        children[segment_path] = potential_peer.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Macsec::Mka::Interfaces::Interface::Session::Ca::get_children()
{
    for (auto const & c : dormant_peer)
    {
...
Macsec::Mka::Interfaces::Interface::Session::Session()
    :
    session_summary(std::make_unique<Macsec::Mka::Interfaces::Interface::Session::SessionSummary>())
	,vp(std::make_unique<Macsec::Mka::Interfaces::Interface::Session::Vp>())
{
    session_summary->parent = this;
    children["session-summary"] = session_summary.get();
...
Entity* Macsec::Mka::Interfaces::Interface::Session::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "ca")
    {
        ...
        auto c = std::make_unique<Macsec::Mka::Interfaces::Interface::Session::Ca>();
        c->parent = this;
        ca.push_back(std::move(c));
        children[segment_path] = ca.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Macsec::Mka::Interfaces::Interface::Session::get_children()
{
    for (auto const & c : ca)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Macsec::Mka::Interfaces::Interface::Interface()
    :
    	name{YType::str, "name"}
    	,
    session(std::make_unique<Macsec::Mka::Interfaces::Interface::Session>())
{
    session->parent = this;
...
Entity* Macsec::Mka::Interfaces::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Macsec::Mka::Interfaces::Interface::get_children()
{
...
Entity* Macsec::Mka::Interfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "interface")
    {
        ...
        auto c = std::make_unique<Macsec::Mka::Interfaces::Interface>();
        c->parent = this;
...
std::map<std::string, Entity*> & Macsec::Mka::Interfaces::get_children()
{
    for (auto const & c : interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Macsec::Mka::Mka()
    :
    interfaces(std::make_unique<Macsec::Mka::Interfaces>())
{
...
Entity* Macsec::Mka::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Macsec::Mka::get_children()
{
...
Macsec::Macsec()
    :
    mka(std::make_unique<Macsec::Mka>())
{
    mka->parent = this;
    children["mka"] = mka.get();
