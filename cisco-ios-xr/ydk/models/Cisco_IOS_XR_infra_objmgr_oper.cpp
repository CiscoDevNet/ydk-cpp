...
{
    std::ostringstream path_buffer;
    path_buffer << "parent-group" <<"[parent-group-name='" <<parent_group_name.get() <<"']";
...
Entity* ObjectGroup::Port::Objects::Object::ParentGroups::ParentGroup::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & ObjectGroup::Port::Objects::Object::ParentGroups::ParentGroup::get_children()
{
    return children;
}
...
Entity* ObjectGroup::Port::Objects::Object::ParentGroups::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "parent-group")
    {
        ...
        auto c = std::make_unique<ObjectGroup::Port::Objects::Object::ParentGroups::ParentGroup>();
        c->parent = this;
        parent_group.push_back(std::move(c));
        children[segment_path] = parent_group.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & ObjectGroup::Port::Objects::Object::ParentGroups::get_children()
{
    for (auto const & c : parent_group)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
ObjectGroup::Port::Objects::Object::Object()
	...
	,parent_groups(std::make_unique<ObjectGroup::Port::Objects::Object::ParentGroups>())
	,port_ranges(std::make_unique<ObjectGroup::Port::Objects::Object::PortRanges>())
{
    ...
    children["parent-groups"] = parent_groups.get();
...
bool ObjectGroup::Port::Objects::Object::has_operation() const
{
	...
	|| (parent_groups !=  nullptr && is_set(parent_groups->operation))
...
Entity* ObjectGroup::Network::Ipv6::Objects::Object::ParentGroups::ParentGroup::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & ObjectGroup::Network::Ipv6::Objects::Object::ParentGroups::ParentGroup::get_children()
{
    return children;
}
...
Entity* ObjectGroup::Network::Ipv6::Objects::Object::ParentGroups::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "parent-group")
    {
        ...
        auto c = std::make_unique<ObjectGroup::Network::Ipv6::Objects::Object::ParentGroups::ParentGroup>();
        c->parent = this;
        parent_group.push_back(std::move(c));
        children[segment_path] = parent_group.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & ObjectGroup::Network::Ipv6::Objects::Object::ParentGroups::get_children()
{
    for (auto const & c : parent_group)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
ObjectGroup::Network::Ipv6::Objects::Object::Object()
	...
	,parent_groups(std::make_unique<ObjectGroup::Network::Ipv6::Objects::Object::ParentGroups>())
{
...
Entity* ObjectGroup::Network::Ipv4::Objects::Object::ParentGroups::ParentGroup::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & ObjectGroup::Network::Ipv4::Objects::Object::ParentGroups::ParentGroup::get_children()
{
    return children;
}
...
Entity* ObjectGroup::Network::Ipv4::Objects::Object::ParentGroups::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "parent-group")
    {
        ...
        auto c = std::make_unique<ObjectGroup::Network::Ipv4::Objects::Object::ParentGroups::ParentGroup>();
        c->parent = this;
        parent_group.push_back(std::move(c));
        children[segment_path] = parent_group.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & ObjectGroup::Network::Ipv4::Objects::Object::ParentGroups::get_children()
{
    for (auto const & c : parent_group)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
ObjectGroup::Network::Ipv4::Objects::Object::Object()
	...
	,parent_groups(std::make_unique<ObjectGroup::Network::Ipv4::Objects::Object::ParentGroups>())
{
    address_ranges->parent = this;
    children["address-ranges"] = address_ranges.get();
