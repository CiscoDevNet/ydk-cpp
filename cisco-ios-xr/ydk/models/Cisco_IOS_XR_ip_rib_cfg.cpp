...
Entity* Rib::Af::Ipv4::RedistributionHistory::Keep::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & Rib::Af::Ipv4::RedistributionHistory::Keep::get_children()
{
    return children;
}
...
Rib::Af::Ipv4::RedistributionHistory::RedistributionHistory()
    :
	 ...
	 protocol_client{YType::uint32, "protocol-client"}
    	,
    keep(std::make_unique<Rib::Af::Ipv4::RedistributionHistory::Keep>())
{
    keep->parent = this;
    children["keep"] = keep.get();
...
Entity* Rib::Af::Ipv4::RedistributionHistory::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Rib::Af::Ipv4::RedistributionHistory::get_children()
{
...
Rib::Af::Ipv4::Ipv4()
    :
    	...
    	,
    redistribution_history(std::make_unique<Rib::Af::Ipv4::RedistributionHistory>())
{
    redistribution_history->parent = this;
    children["redistribution-history"] = redistribution_history.get();
...
Entity* Rib::Af::Ipv4::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Rib::Af::Ipv4::get_children()
{
...
Entity* Rib::Af::Ipv6::RedistributionHistory::Keep::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Rib::Af::Ipv6::RedistributionHistory::Keep::get_children()
{
    return children;
}
...
Rib::Af::Ipv6::RedistributionHistory::RedistributionHistory()
    :
	 ...
	 protocol_client{YType::uint32, "protocol-client"}
    	,
    keep(std::make_unique<Rib::Af::Ipv6::RedistributionHistory::Keep>())
{
    keep->parent = this;
    children["keep"] = keep.get();
...
Entity* Rib::Af::Ipv6::RedistributionHistory::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Rib::Af::Ipv6::RedistributionHistory::get_children()
{
    if(children.find("keep") == children.end())
    {
        if(keep != nullptr)
...
Rib::Af::Ipv6::Ipv6()
    :
    	next_hop_dampening_disable{YType::empty, "next-hop-dampening-disable"}
    	,
    redistribution_history(std::make_unique<Rib::Af::Ipv6::RedistributionHistory>())
{
    redistribution_history->parent = this;
    children["redistribution-history"] = redistribution_history.get();
...
Entity* Rib::Af::Ipv6::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Rib::Af::Ipv6::get_children()
{
    if(children.find("redistribution-history") == children.end())
    {
        if(redistribution_history != nullptr)
...
Rib::Af::Af()
    :
    ipv4(std::make_unique<Rib::Af::Ipv4>())
	,ipv6(std::make_unique<Rib::Af::Ipv6>())
{
    ipv4->parent = this;
...
Entity* Rib::Af::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Rib::Af::get_children()
{
...
Entity* Rib::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Rib::get_children()
{
...
std::unique_ptr<Entity> Rib::clone_ptr()
{
    return std::make_unique<Rib>();
}
