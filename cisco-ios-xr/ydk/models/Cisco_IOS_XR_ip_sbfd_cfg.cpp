...
std::string Sbfd::RemoteTarget::Ipv4Addresses::Ipv4Address::RemoteDiscriminator::get_segment_path() const
{
    ...
    path_buffer << "remote-discriminator" <<"[remote-discriminator='" <<remote_discriminator.get() <<"']";
...
Entity* Sbfd::RemoteTarget::Ipv4Addresses::Ipv4Address::RemoteDiscriminator::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & Sbfd::RemoteTarget::Ipv4Addresses::Ipv4Address::RemoteDiscriminator::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "ipv4-address" <<"[address='" <<address.get() <<"']";
...
Entity* Sbfd::RemoteTarget::Ipv4Addresses::Ipv4Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "remote-discriminator")
    {
        ...
        auto c = std::make_unique<Sbfd::RemoteTarget::Ipv4Addresses::Ipv4Address::RemoteDiscriminator>();
        c->parent = this;
...
std::map<std::string, Entity*> & Sbfd::RemoteTarget::Ipv4Addresses::Ipv4Address::get_children()
{
    for (auto const & c : remote_discriminator)
    {
...
Entity* Sbfd::RemoteTarget::Ipv4Addresses::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "ipv4-address")
    {
        ...
        auto c = std::make_unique<Sbfd::RemoteTarget::Ipv4Addresses::Ipv4Address>();
        c->parent = this;
...
std::map<std::string, Entity*> & Sbfd::RemoteTarget::Ipv4Addresses::get_children()
{
    for (auto const & c : ipv4_address)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Sbfd::RemoteTarget::Ipv6Addresses::Ipv6Address::RemoteDiscriminator::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Sbfd::RemoteTarget::Ipv6Addresses::Ipv6Address::RemoteDiscriminator::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "ipv6-address" <<"[address='" <<address.get() <<"']";
...
Entity* Sbfd::RemoteTarget::Ipv6Addresses::Ipv6Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "remote-discriminator")
    {
        ...
        auto c = std::make_unique<Sbfd::RemoteTarget::Ipv6Addresses::Ipv6Address::RemoteDiscriminator>();
        c->parent = this;
        remote_discriminator.push_back(std::move(c));
        children[segment_path] = remote_discriminator.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Sbfd::RemoteTarget::Ipv6Addresses::Ipv6Address::get_children()
{
    for (auto const & c : remote_discriminator)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Sbfd::RemoteTarget::Ipv6Addresses::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "ipv6-address")
    {
        ...
        auto c = std::make_unique<Sbfd::RemoteTarget::Ipv6Addresses::Ipv6Address>();
        c->parent = this;
        ipv6_address.push_back(std::move(c));
        children[segment_path] = ipv6_address.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Sbfd::RemoteTarget::Ipv6Addresses::get_children()
{
    for (auto const & c : ipv6_address)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Sbfd::RemoteTarget::RemoteTarget()
    :
    ipv4_addresses(std::make_unique<Sbfd::RemoteTarget::Ipv4Addresses>())
	,ipv6_addresses(std::make_unique<Sbfd::RemoteTarget::Ipv6Addresses>())
{
    ipv4_addresses->parent = this;
    children["ipv4-addresses"] = ipv4_addresses.get();

    ipv6_addresses->parent = this;
    children["ipv6-addresses"] = ipv6_addresses.get();
...
Entity* Sbfd::RemoteTarget::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Sbfd::RemoteTarget::get_children()
{
...
{
    std::ostringstream path_buffer;
    path_buffer << "intf-discriminator" <<"[interface-name='" <<interface_name.get() <<"']";
...
Entity* Sbfd::LocalDiscriminator::IntfDiscriminators::IntfDiscriminator::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Sbfd::LocalDiscriminator::IntfDiscriminators::IntfDiscriminator::get_children()
{
    return children;
}
...
Entity* Sbfd::LocalDiscriminator::IntfDiscriminators::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "intf-discriminator")
    {
        ...
        auto c = std::make_unique<Sbfd::LocalDiscriminator::IntfDiscriminators::IntfDiscriminator>();
        c->parent = this;
        intf_discriminator.push_back(std::move(c));
        children[segment_path] = intf_discriminator.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Sbfd::LocalDiscriminator::IntfDiscriminators::get_children()
{
    for (auto const & c : intf_discriminator)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
{
    std::ostringstream path_buffer;
    path_buffer << "dynamic-discriminator" <<"[discriminator='" <<discriminator.get() <<"']";
...
Entity* Sbfd::LocalDiscriminator::DynamicDiscriminators::DynamicDiscriminator::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Sbfd::LocalDiscriminator::DynamicDiscriminators::DynamicDiscriminator::get_children()
{
    return children;
}
...
Entity* Sbfd::LocalDiscriminator::DynamicDiscriminators::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "dynamic-discriminator")
    {
        ...
        auto c = std::make_unique<Sbfd::LocalDiscriminator::DynamicDiscriminators::DynamicDiscriminator>();
        c->parent = this;
        dynamic_discriminator.push_back(std::move(c));
        children[segment_path] = dynamic_discriminator.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Sbfd::LocalDiscriminator::DynamicDiscriminators::get_children()
{
    for (auto const & c : dynamic_discriminator)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
{
    std::ostringstream path_buffer;
    path_buffer << "ipv4-discriminator" <<"[address='" <<address.get() <<"']";
...
Entity* Sbfd::LocalDiscriminator::Ipv4Discriminators::Ipv4Discriminator::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Sbfd::LocalDiscriminator::Ipv4Discriminators::Ipv4Discriminator::get_children()
{
    return children;
}
...
Entity* Sbfd::LocalDiscriminator::Ipv4Discriminators::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "ipv4-discriminator")
    {
        ...
        auto c = std::make_unique<Sbfd::LocalDiscriminator::Ipv4Discriminators::Ipv4Discriminator>();
        c->parent = this;
        ipv4_discriminator.push_back(std::move(c));
        children[segment_path] = ipv4_discriminator.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Sbfd::LocalDiscriminator::Ipv4Discriminators::get_children()
{
    for (auto const & c : ipv4_discriminator)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
{
    std::ostringstream path_buffer;
    path_buffer << "val32-discriminator" <<"[discriminator='" <<discriminator.get() <<"']";
...
Entity* Sbfd::LocalDiscriminator::Val32Discriminators::Val32Discriminator::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Sbfd::LocalDiscriminator::Val32Discriminators::Val32Discriminator::get_children()
{
    return children;
}
...
Entity* Sbfd::LocalDiscriminator::Val32Discriminators::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "val32-discriminator")
    {
        ...
        auto c = std::make_unique<Sbfd::LocalDiscriminator::Val32Discriminators::Val32Discriminator>();
        c->parent = this;
        val32_discriminator.push_back(std::move(c));
        children[segment_path] = val32_discriminator.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Sbfd::LocalDiscriminator::Val32Discriminators::get_children()
{
    for (auto const & c : val32_discriminator)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Sbfd::LocalDiscriminator::LocalDiscriminator()
    :
    dynamic_discriminators(std::make_unique<Sbfd::LocalDiscriminator::DynamicDiscriminators>())
	,intf_discriminators(std::make_unique<Sbfd::LocalDiscriminator::IntfDiscriminators>())
	,ipv4_discriminators(std::make_unique<Sbfd::LocalDiscriminator::Ipv4Discriminators>())
	,val32_discriminators(std::make_unique<Sbfd::LocalDiscriminator::Val32Discriminators>())
{
    dynamic_discriminators->parent = this;
    children["dynamic-discriminators"] = dynamic_discriminators.get();

    intf_discriminators->parent = this;
    children["intf-discriminators"] = intf_discriminators.get();

    ipv4_discriminators->parent = this;
    children["ipv4-discriminators"] = ipv4_discriminators.get();

    val32_discriminators->parent = this;
    children["val32-discriminators"] = val32_discriminators.get();
...
Entity* Sbfd::LocalDiscriminator::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Sbfd::LocalDiscriminator::get_children()
{
...
Sbfd::Sbfd()
    :
    local_discriminator(std::make_unique<Sbfd::LocalDiscriminator>())
	,remote_target(std::make_unique<Sbfd::RemoteTarget>())
{
    local_discriminator->parent = this;
    children["local-discriminator"] = local_discriminator.get();

    remote_target->parent = this;
    children["remote-target"] = remote_target.get();
