...
Entity* Vrrp::Logging::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & Vrrp::Logging::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "global-ipv6-address" <<"[ip-address='" <<ip_address.get() <<"']";
...
Entity* Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::GlobalIpv6Addresses::GlobalIpv6Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::GlobalIpv6Addresses::GlobalIpv6Address::get_children()
{
    return children;
}
...
Entity* Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::GlobalIpv6Addresses::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "global-ipv6-address")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::GlobalIpv6Addresses::GlobalIpv6Address>();
        c->parent = this;
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::GlobalIpv6Addresses::get_children()
{
    for (auto const & c : global_ipv6_address)
    {
...
{
    std::ostringstream path_buffer;
    path_buffer << "track" <<"[interface-name='" <<interface_name.get() <<"']";
...
Entity* Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::Tracks::Track::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::Tracks::Track::get_children()
{
    return children;
}
...
Entity* Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::Tracks::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "track")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::Tracks::Track>();
        c->parent = this;
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::Tracks::get_children()
{
    for (auto const & c : track)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::Timer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::Timer::get_children()
{
    return children;
}
...
Entity* Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::TrackedObjects::TrackedObject::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::TrackedObjects::TrackedObject::get_children()
{
    return children;
}
...
Entity* Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::TrackedObjects::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "tracked-object")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::TrackedObjects::TrackedObject>();
        c->parent = this;
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::TrackedObjects::get_children()
{
    for (auto const & c : tracked_object)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::LinkLocalIpv6Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::LinkLocalIpv6Address::get_children()
{
    return children;
}
...
Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::VirtualRouter()
    :
	 ...
	 session_name{YType::str, "session-name"}
    	,
    global_ipv6_addresses(std::make_unique<Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::GlobalIpv6Addresses>())
	,link_local_ipv6_address(std::make_unique<Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::LinkLocalIpv6Address>())
	,timer(std::make_unique<Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::Timer>())
	,tracked_objects(std::make_unique<Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::TrackedObjects>())
	,tracks(std::make_unique<Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::Tracks>())
{
...
{
    std::ostringstream path_buffer;
    path_buffer << "virtual-router" <<"[vr-id='" <<vr_id.get() <<"']";
...
Entity* Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter::get_children()
{
...
Entity* Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "virtual-router")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::VirtualRouter>();
        c->parent = this;
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters::get_children()
{
    for (auto const & c : virtual_router)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Vrrp::Interfaces::Interface::Ipv6::Version3::Version3()
    :
    virtual_routers(std::make_unique<Vrrp::Interfaces::Interface::Ipv6::Version3::VirtualRouters>())
{
...
Entity* Vrrp::Interfaces::Interface::Ipv6::Version3::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::Version3::get_children()
{
...
Entity* Vrrp::Interfaces::Interface::Ipv6::SlaveVirtualRouters::SlaveVirtualRouter::LinkLocalIpv6Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::SlaveVirtualRouters::SlaveVirtualRouter::LinkLocalIpv6Address::get_children()
{
    return children;
}
...
Entity* Vrrp::Interfaces::Interface::Ipv6::SlaveVirtualRouters::SlaveVirtualRouter::GlobalIpv6Addresses::GlobalIpv6Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::SlaveVirtualRouters::SlaveVirtualRouter::GlobalIpv6Addresses::GlobalIpv6Address::get_children()
{
    return children;
}
...
Entity* Vrrp::Interfaces::Interface::Ipv6::SlaveVirtualRouters::SlaveVirtualRouter::GlobalIpv6Addresses::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "global-ipv6-address")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface::Ipv6::SlaveVirtualRouters::SlaveVirtualRouter::GlobalIpv6Addresses::GlobalIpv6Address>();
        c->parent = this;
        global_ipv6_address.push_back(std::move(c));
        children[segment_path] = global_ipv6_address.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::SlaveVirtualRouters::SlaveVirtualRouter::GlobalIpv6Addresses::get_children()
{
    for (auto const & c : global_ipv6_address)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Vrrp::Interfaces::Interface::Ipv6::SlaveVirtualRouters::SlaveVirtualRouter::SlaveVirtualRouter()
    :
	 ...
	 follow{YType::str, "follow"}
    	,
    global_ipv6_addresses(std::make_unique<Vrrp::Interfaces::Interface::Ipv6::SlaveVirtualRouters::SlaveVirtualRouter::GlobalIpv6Addresses>())
	,link_local_ipv6_address(std::make_unique<Vrrp::Interfaces::Interface::Ipv6::SlaveVirtualRouters::SlaveVirtualRouter::LinkLocalIpv6Address>())
{
    global_ipv6_addresses->parent = this;
    children["global-ipv6-addresses"] = global_ipv6_addresses.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "slave-virtual-router" <<"[slave-virtual-router-id='" <<slave_virtual_router_id.get() <<"']";
...
Entity* Vrrp::Interfaces::Interface::Ipv6::SlaveVirtualRouters::SlaveVirtualRouter::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::SlaveVirtualRouters::SlaveVirtualRouter::get_children()
{
    if(children.find("global-ipv6-addresses") == children.end())
    {
        if(global_ipv6_addresses != nullptr)
...
Entity* Vrrp::Interfaces::Interface::Ipv6::SlaveVirtualRouters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "slave-virtual-router")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface::Ipv6::SlaveVirtualRouters::SlaveVirtualRouter>();
        c->parent = this;
        slave_virtual_router.push_back(std::move(c));
        children[segment_path] = slave_virtual_router.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::SlaveVirtualRouters::get_children()
{
    for (auto const & c : slave_virtual_router)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Vrrp::Interfaces::Interface::Ipv6::Ipv6()
    :
    slave_virtual_routers(std::make_unique<Vrrp::Interfaces::Interface::Ipv6::SlaveVirtualRouters>())
	,version3(std::make_unique<Vrrp::Interfaces::Interface::Ipv6::Version3>())
{
    slave_virtual_routers->parent = this;
    children["slave-virtual-routers"] = slave_virtual_routers.get();

    version3->parent = this;
    children["version3"] = version3.get();
...
Entity* Vrrp::Interfaces::Interface::Ipv6::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv6::get_children()
{
...
Entity* Vrrp::Interfaces::Interface::Delay::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Delay::get_children()
{
    return children;
}
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::Timer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::Timer::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "secondary-ipv4-address" <<"[ip-address='" <<ip_address.get() <<"']";
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::SecondaryIpv4Addresses::SecondaryIpv4Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::SecondaryIpv4Addresses::SecondaryIpv4Address::get_children()
{
    return children;
}
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::SecondaryIpv4Addresses::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "secondary-ipv4-address")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::SecondaryIpv4Addresses::SecondaryIpv4Address>();
        c->parent = this;
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::SecondaryIpv4Addresses::get_children()
{
    for (auto const & c : secondary_ipv4_address)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::TrackedObjects::TrackedObject::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::TrackedObjects::TrackedObject::get_children()
{
    return children;
}
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::TrackedObjects::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "tracked-object")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::TrackedObjects::TrackedObject>();
        c->parent = this;
        tracked_object.push_back(std::move(c));
        children[segment_path] = tracked_object.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::TrackedObjects::get_children()
{
    for (auto const & c : tracked_object)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::Tracks::Track::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::Tracks::Track::get_children()
{
    return children;
}
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::Tracks::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "track")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::Tracks::Track>();
        c->parent = this;
        track.push_back(std::move(c));
        children[segment_path] = track.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::Tracks::get_children()
{
    for (auto const & c : track)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::VirtualRouter()
    :
	 ...
	 session_name{YType::str, "session-name"}
    	,
    secondary_ipv4_addresses(std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::SecondaryIpv4Addresses>())
	,timer(std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::Timer>())
	,tracked_objects(std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::TrackedObjects>())
	,tracks(std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::Tracks>())
{
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter::get_children()
{
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "virtual-router")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::VirtualRouter>();
        c->parent = this;
        virtual_router.push_back(std::move(c));
        children[segment_path] = virtual_router.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters::get_children()
{
    for (auto const & c : virtual_router)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Vrrp::Interfaces::Interface::Ipv4::Version3::Version3()
    :
    virtual_routers(std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version3::VirtualRouters>())
{
    virtual_routers->parent = this;
    children["virtual-routers"] = virtual_routers.get();
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version3::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version3::get_children()
{
    if(children.find("virtual-routers") == children.end())
    {
        if(virtual_routers != nullptr)
...
Entity* Vrrp::Interfaces::Interface::Ipv4::SlaveVirtualRouters::SlaveVirtualRouter::SecondaryIpv4Addresses::SecondaryIpv4Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::SlaveVirtualRouters::SlaveVirtualRouter::SecondaryIpv4Addresses::SecondaryIpv4Address::get_children()
{
    return children;
}
...
Entity* Vrrp::Interfaces::Interface::Ipv4::SlaveVirtualRouters::SlaveVirtualRouter::SecondaryIpv4Addresses::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "secondary-ipv4-address")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface::Ipv4::SlaveVirtualRouters::SlaveVirtualRouter::SecondaryIpv4Addresses::SecondaryIpv4Address>();
        c->parent = this;
        secondary_ipv4_address.push_back(std::move(c));
        children[segment_path] = secondary_ipv4_address.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::SlaveVirtualRouters::SlaveVirtualRouter::SecondaryIpv4Addresses::get_children()
{
    for (auto const & c : secondary_ipv4_address)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Vrrp::Interfaces::Interface::Ipv4::SlaveVirtualRouters::SlaveVirtualRouter::SlaveVirtualRouter()
    :
	 ...
	 primary_ipv4_address{YType::str, "primary-ipv4-address"}
    	,
    secondary_ipv4_addresses(std::make_unique<Vrrp::Interfaces::Interface::Ipv4::SlaveVirtualRouters::SlaveVirtualRouter::SecondaryIpv4Addresses>())
{
    secondary_ipv4_addresses->parent = this;
    children["secondary-ipv4-addresses"] = secondary_ipv4_addresses.get();
...
Entity* Vrrp::Interfaces::Interface::Ipv4::SlaveVirtualRouters::SlaveVirtualRouter::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::SlaveVirtualRouters::SlaveVirtualRouter::get_children()
{
    if(children.find("secondary-ipv4-addresses") == children.end())
    {
        if(secondary_ipv4_addresses != nullptr)
...
Entity* Vrrp::Interfaces::Interface::Ipv4::SlaveVirtualRouters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "slave-virtual-router")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface::Ipv4::SlaveVirtualRouters::SlaveVirtualRouter>();
        c->parent = this;
        slave_virtual_router.push_back(std::move(c));
        children[segment_path] = slave_virtual_router.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::SlaveVirtualRouters::get_children()
{
    for (auto const & c : slave_virtual_router)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::Timer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::Timer::get_children()
{
    return children;
}
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::SecondaryIpv4Addresses::SecondaryIpv4Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::SecondaryIpv4Addresses::SecondaryIpv4Address::get_children()
{
    return children;
}
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::SecondaryIpv4Addresses::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "secondary-ipv4-address")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::SecondaryIpv4Addresses::SecondaryIpv4Address>();
        c->parent = this;
        secondary_ipv4_address.push_back(std::move(c));
        children[segment_path] = secondary_ipv4_address.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::SecondaryIpv4Addresses::get_children()
{
    for (auto const & c : secondary_ipv4_address)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::Tracks::Track::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::Tracks::Track::get_children()
{
    return children;
}
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::Tracks::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "track")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::Tracks::Track>();
        c->parent = this;
        track.push_back(std::move(c));
        children[segment_path] = track.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::Tracks::get_children()
{
    for (auto const & c : track)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::TrackedObjects::TrackedObject::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::TrackedObjects::TrackedObject::get_children()
{
    return children;
}
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::TrackedObjects::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "tracked-object")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::TrackedObjects::TrackedObject>();
        c->parent = this;
        tracked_object.push_back(std::move(c));
        children[segment_path] = tracked_object.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::TrackedObjects::get_children()
{
    for (auto const & c : tracked_object)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::VirtualRouter()
    :
	 ...
	 text_password{YType::str, "text-password"}
    	,
    secondary_ipv4_addresses(std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::SecondaryIpv4Addresses>())
	,timer(std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::Timer>())
	,tracked_objects(std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::TrackedObjects>())
	,tracks(std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::Tracks>())
{
    secondary_ipv4_addresses->parent = this;
    children["secondary-ipv4-addresses"] = secondary_ipv4_addresses.get();
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter::get_children()
{
    if(children.find("secondary-ipv4-addresses") == children.end())
    {
        if(secondary_ipv4_addresses != nullptr)
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "virtual-router")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::VirtualRouter>();
        c->parent = this;
        virtual_router.push_back(std::move(c));
        children[segment_path] = virtual_router.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters::get_children()
{
    for (auto const & c : virtual_router)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Vrrp::Interfaces::Interface::Ipv4::Version2::Version2()
    :
    virtual_routers(std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version2::VirtualRouters>())
{
    virtual_routers->parent = this;
    children["virtual-routers"] = virtual_routers.get();
...
Entity* Vrrp::Interfaces::Interface::Ipv4::Version2::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::Version2::get_children()
{
    if(children.find("virtual-routers") == children.end())
    {
        if(virtual_routers != nullptr)
...
Vrrp::Interfaces::Interface::Ipv4::Ipv4()
    :
    slave_virtual_routers(std::make_unique<Vrrp::Interfaces::Interface::Ipv4::SlaveVirtualRouters>())
	,version2(std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version2>())
	,version3(std::make_unique<Vrrp::Interfaces::Interface::Ipv4::Version3>())
{
    slave_virtual_routers->parent = this;
    children["slave-virtual-routers"] = slave_virtual_routers.get();
...
Entity* Vrrp::Interfaces::Interface::Ipv4::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Ipv4::get_children()
{
    if(children.find("slave-virtual-routers") == children.end())
    {
        if(slave_virtual_routers != nullptr)
...
Entity* Vrrp::Interfaces::Interface::Bfd::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::Bfd::get_children()
{
    return children;
}
...
Vrrp::Interfaces::Interface::Interface()
    :
	 ...
	 mac_refresh{YType::uint32, "mac-refresh"}
    	,
    bfd(std::make_unique<Vrrp::Interfaces::Interface::Bfd>())
	,delay(std::make_unique<Vrrp::Interfaces::Interface::Delay>())
	,ipv4(std::make_unique<Vrrp::Interfaces::Interface::Ipv4>())
	,ipv6(std::make_unique<Vrrp::Interfaces::Interface::Ipv6>())
{
    bfd->parent = this;
...
Entity* Vrrp::Interfaces::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Vrrp::Interfaces::Interface::get_children()
{
...
Entity* Vrrp::Interfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "interface")
    {
        ...
        auto c = std::make_unique<Vrrp::Interfaces::Interface>();
        c->parent = this;
...
std::map<std::string, Entity*> & Vrrp::Interfaces::get_children()
{
    for (auto const & c : interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Vrrp::Vrrp()
    :
    interfaces(std::make_unique<Vrrp::Interfaces>())
	,logging(std::make_unique<Vrrp::Logging>())
{
