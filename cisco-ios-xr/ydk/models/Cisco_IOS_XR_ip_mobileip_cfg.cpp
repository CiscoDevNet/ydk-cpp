...
std::string MobileIp::Domains::Domain::Mags::Mag::get_segment_path() const
{
    ...
    path_buffer << "mag" <<"[mag-name='" <<mag_name.get() <<"']";
...
Entity* MobileIp::Domains::Domain::Mags::Mag::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & MobileIp::Domains::Domain::Mags::Mag::get_children()
{
    return children;
}
...
Entity* MobileIp::Domains::Domain::Mags::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "mag")
    {
        ...
        auto c = std::make_unique<MobileIp::Domains::Domain::Mags::Mag>();
        c->parent = this;
        mag.push_back(std::move(c));
        children[segment_path] = mag.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & MobileIp::Domains::Domain::Mags::get_children()
{
    for (auto const & c : mag)
    {
...
{
    std::ostringstream path_buffer;
    path_buffer << "nai" <<"[nai-name='" <<nai_name.get() <<"']";
...
Entity* MobileIp::Domains::Domain::Nais::Nai::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Domains::Domain::Nais::Nai::get_children()
{
    return children;
}
...
Entity* MobileIp::Domains::Domain::Nais::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "nai")
    {
        ...
        auto c = std::make_unique<MobileIp::Domains::Domain::Nais::Nai>();
        c->parent = this;
        nai.push_back(std::move(c));
        children[segment_path] = nai.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & MobileIp::Domains::Domain::Nais::get_children()
{
    for (auto const & c : nai)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* MobileIp::Domains::Domain::AuthenticateOption::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Domains::Domain::AuthenticateOption::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "lma" <<"[lma-name='" <<lma_name.get() <<"']";
...
Entity* MobileIp::Domains::Domain::Lmas::Lma::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Domains::Domain::Lmas::Lma::get_children()
{
    return children;
}
...
Entity* MobileIp::Domains::Domain::Lmas::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "lma")
    {
        ...
        auto c = std::make_unique<MobileIp::Domains::Domain::Lmas::Lma>();
        c->parent = this;
        lma.push_back(std::move(c));
        children[segment_path] = lma.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & MobileIp::Domains::Domain::Lmas::get_children()
{
    for (auto const & c : lma)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
MobileIp::Domains::Domain::Domain()
    :
	 ...
	 enable{YType::empty, "enable"}
    	,
    authenticate_option(std::make_unique<MobileIp::Domains::Domain::AuthenticateOption>())
	,lmas(std::make_unique<MobileIp::Domains::Domain::Lmas>())
	,mags(std::make_unique<MobileIp::Domains::Domain::Mags>())
	,nais(std::make_unique<MobileIp::Domains::Domain::Nais>())
{
    authenticate_option->parent = this;
    children["authenticate-option"] = authenticate_option.get();

    lmas->parent = this;
    children["lmas"] = lmas.get();

    mags->parent = this;
    children["mags"] = mags.get();

    nais->parent = this;
    children["nais"] = nais.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "domain" <<"[domain-name='" <<domain_name.get() <<"']";
...
Entity* MobileIp::Domains::Domain::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Domains::Domain::get_children()
{
...
Entity* MobileIp::Domains::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "domain")
    {
        ...
        auto c = std::make_unique<MobileIp::Domains::Domain>();
        c->parent = this;
...
std::map<std::string, Entity*> & MobileIp::Domains::get_children()
{
    for (auto const & c : domain)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* MobileIp::Lmas::Lma::BindingRevocationAttributes::Delay::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::BindingRevocationAttributes::Delay::get_children()
{
    return children;
}
...
MobileIp::Lmas::Lma::BindingRevocationAttributes::BindingRevocationAttributes()
    :
    	...
    	,
    delay(std::make_unique<MobileIp::Lmas::Lma::BindingRevocationAttributes::Delay>())
{
    delay->parent = this;
...
Entity* MobileIp::Lmas::Lma::BindingRevocationAttributes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::BindingRevocationAttributes::get_children()
{
...
Entity* MobileIp::Lmas::Lma::RatAttributes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::RatAttributes::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::HeartBeatAttributes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::HeartBeatAttributes::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "lmaipv6-address" <<"[address='" <<address.get() <<"']";
...
Entity* MobileIp::Lmas::Lma::Lmaipv6Addresses::Lmaipv6Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Lmaipv6Addresses::Lmaipv6Address::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Lmaipv6Addresses::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "lmaipv6-address")
    {
        ...
        auto c = std::make_unique<MobileIp::Lmas::Lma::Lmaipv6Addresses::Lmaipv6Address>();
        c->parent = this;
        lmaipv6_address.push_back(std::move(c));
        children[segment_path] = lmaipv6_address.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Lmaipv6Addresses::get_children()
{
    for (auto const & c : lmaipv6_address)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* MobileIp::Lmas::Lma::Hnp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Hnp::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Redistribute::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Redistribute::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Dscp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Dscp::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "lmaipv4-address" <<"[address='" <<address.get() <<"']";
...
Entity* MobileIp::Lmas::Lma::Lmaipv4Addresses::Lmaipv4Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Lmaipv4Addresses::Lmaipv4Address::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Lmaipv4Addresses::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "lmaipv4-address")
    {
        ...
        auto c = std::make_unique<MobileIp::Lmas::Lma::Lmaipv4Addresses::Lmaipv4Address>();
        c->parent = this;
        lmaipv4_address.push_back(std::move(c));
        children[segment_path] = lmaipv4_address.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Lmaipv4Addresses::get_children()
{
    for (auto const & c : lmaipv4_address)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
{
    std::ostringstream path_buffer;
    path_buffer << "role" <<"[lma-role='" <<lma_role.get() <<"']";
...
Entity* MobileIp::Lmas::Lma::Roles::Role::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Roles::Role::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Roles::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "role")
    {
        ...
        auto c = std::make_unique<MobileIp::Lmas::Lma::Roles::Role>();
        c->parent = this;
        role.push_back(std::move(c));
        children[segment_path] = role.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Roles::get_children()
{
    for (auto const & c : role)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* MobileIp::Lmas::Lma::BindingAttributes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::BindingAttributes::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Aaa::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Aaa::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Mags::Mag::AuthenticateOption::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Mags::Mag::AuthenticateOption::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Mags::Mag::Dscp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Mags::Mag::Dscp::get_children()
{
    return children;
}
...
MobileIp::Lmas::Lma::Mags::Mag::Mag()
    :
	 ...
	 tunnel{YType::str, "tunnel"}
    	,
    authenticate_option(std::make_unique<MobileIp::Lmas::Lma::Mags::Mag::AuthenticateOption>())
	,dscp(std::make_unique<MobileIp::Lmas::Lma::Mags::Mag::Dscp>())
{
    authenticate_option->parent = this;
    children["authenticate-option"] = authenticate_option.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "mag" <<"[domain-name='" <<domain_name.get() <<"']" <<"[mag-name='" <<mag_name.get() <<"']";
...
Entity* MobileIp::Lmas::Lma::Mags::Mag::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Mags::Mag::get_children()
{
    if(children.find("authenticate-option") == children.end())
    {
        if(authenticate_option != nullptr)
...
Entity* MobileIp::Lmas::Lma::Mags::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "mag")
    {
        ...
        auto c = std::make_unique<MobileIp::Lmas::Lma::Mags::Mag>();
        c->parent = this;
        mag.push_back(std::move(c));
        children[segment_path] = mag.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Mags::get_children()
{
    for (auto const & c : mag)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* MobileIp::Lmas::Lma::TunnelAttributes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::TunnelAttributes::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::AuthenticateOption::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::AuthenticateOption::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::HeartBeatAttributes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::HeartBeatAttributes::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "transport" <<"[vrf-name='" <<vrf_name.get() <<"']";
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::Transports::Transport::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::Transports::Transport::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::Transports::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "transport")
    {
        ...
        auto c = std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::Transports::Transport>();
        c->parent = this;
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::Transports::get_children()
{
    for (auto const & c : transport)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNode::Ipv4Pool::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNode::Ipv4Pool::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNode::Ipv6Pool::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNode::Ipv6Pool::get_children()
{
    return children;
}
...
MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNode::MobileNode()
    :
    ipv4_pool(std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNode::Ipv4Pool>())
	,ipv6_pool(std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNode::Ipv6Pool>())
{
    ipv4_pool->parent = this;
    children["ipv4-pool"] = ipv4_pool.get();

    ipv6_pool->parent = this;
    children["ipv6-pool"] = ipv6_pool.get();
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNode::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNode::get_children()
{
...
{
    std::ostringstream path_buffer;
    path_buffer << "mripv4-pool" <<"[start-address='" <<start_address.get() <<"']";
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNetwork::Mripv4Pools::Mripv4Pool::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNetwork::Mripv4Pools::Mripv4Pool::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNetwork::Mripv4Pools::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "mripv4-pool")
    {
        ...
        auto c = std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNetwork::Mripv4Pools::Mripv4Pool>();
        c->parent = this;
        mripv4_pool.push_back(std::move(c));
        children[segment_path] = mripv4_pool.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNetwork::Mripv4Pools::get_children()
{
    for (auto const & c : mripv4_pool)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
{
    std::ostringstream path_buffer;
    path_buffer << "mripv6-pool" <<"[start-address='" <<start_address.get() <<"']";
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNetwork::Mripv6Pools::Mripv6Pool::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNetwork::Mripv6Pools::Mripv6Pool::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNetwork::Mripv6Pools::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "mripv6-pool")
    {
        ...
        auto c = std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNetwork::Mripv6Pools::Mripv6Pool>();
        c->parent = this;
        mripv6_pool.push_back(std::move(c));
        children[segment_path] = mripv6_pool.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNetwork::Mripv6Pools::get_children()
{
    for (auto const & c : mripv6_pool)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNetwork::MobileNetwork()
    :
    mripv4_pools(std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNetwork::Mripv4Pools>())
	,mripv6_pools(std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNetwork::Mripv6Pools>())
{
    mripv4_pools->parent = this;
    children["mripv4-pools"] = mripv4_pools.get();

    mripv6_pools->parent = this;
    children["mripv6-pools"] = mripv6_pools.get();
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNetwork::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNetwork::get_children()
{
...
MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::PoolAttributes()
    :
    mobile_network(std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNetwork>())
	,mobile_node(std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::MobileNode>())
{
    mobile_network->parent = this;
    children["mobile-network"] = mobile_network.get();

    mobile_node->parent = this;
    children["mobile-node"] = mobile_node.get();
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes::get_children()
{
...
MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::Authorize()
    :
    	name{YType::str, "name"}
    	,
    pool_attributes(std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::PoolAttributes>())
{
    pool_attributes->parent = this;
    children["pool-attributes"] = pool_attributes.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "authorize" <<"[name='" <<name.get() <<"']";
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize::get_children()
{
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "authorize")
    {
        ...
        auto c = std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::Authorize>();
        c->parent = this;
        authorize.push_back(std::move(c));
        children[segment_path] = authorize.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes::get_children()
{
    for (auto const & c : authorize)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::NetworkAttributes()
    :
    	...
    	,
    authorizes(std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::Authorizes>())
{
    authorizes->parent = this;
    children["authorizes"] = authorizes.get();
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes::get_children()
{
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::GreKey::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::GreKey::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::BindingAttributes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::BindingAttributes::get_children()
{
    return children;
}
...
MobileIp::Lmas::Lma::Services::Service::Customers::Customer::Customer()
    :
	 ...
	 mobile_route_ad{YType::uint32, "mobile-route-ad"}
    	,
    authenticate_option(std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::AuthenticateOption>())
	,binding_attributes(std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::BindingAttributes>())
	,gre_key(std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::GreKey>())
	,heart_beat_attributes(std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::HeartBeatAttributes>())
	,network_attributes(std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::NetworkAttributes>())
	,transports(std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer::Transports>())
{
    authenticate_option->parent = this;
    children["authenticate-option"] = authenticate_option.get();

    binding_attributes->parent = this;
    children["binding-attributes"] = binding_attributes.get();

    gre_key->parent = this;
    children["gre-key"] = gre_key.get();

    heart_beat_attributes->parent = this;
    children["heart-beat-attributes"] = heart_beat_attributes.get();

    network_attributes->parent = this;
    children["network-attributes"] = network_attributes.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "customer" <<"[customer-name='" <<customer_name.get() <<"']" <<"[vrf-name='" <<vrf_name.get() <<"']";
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::Customer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::Customer::get_children()
{
    if(children.find("authenticate-option") == children.end())
    {
        if(authenticate_option != nullptr)
...
Entity* MobileIp::Lmas::Lma::Services::Service::Customers::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "customer")
    {
        ...
        auto c = std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers::Customer>();
        c->parent = this;
        customer.push_back(std::move(c));
        children[segment_path] = customer.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::Customers::get_children()
{
    for (auto const & c : customer)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
MobileIp::Lmas::Lma::Services::Service::Service()
    :
	 ...
	 mnp_lmn{YType::uint32, "mnp-lmn"}
    	,
    customers(std::make_unique<MobileIp::Lmas::Lma::Services::Service::Customers>())
{
    customers->parent = this;
    children["customers"] = customers.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "service" <<"[lma-service='" <<lma_service.get() <<"']";
...
Entity* MobileIp::Lmas::Lma::Services::Service::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::Service::get_children()
{
...
Entity* MobileIp::Lmas::Lma::Services::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "service")
    {
        ...
        auto c = std::make_unique<MobileIp::Lmas::Lma::Services::Service>();
        c->parent = this;
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Services::get_children()
{
    for (auto const & c : service)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* MobileIp::Lmas::Lma::ReplayProtection::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::ReplayProtection::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNode::Ipv4Pool::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNode::Ipv4Pool::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNode::Ipv6Pool::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNode::Ipv6Pool::get_children()
{
    return children;
}
...
MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNode::MobileNode()
    :
    ipv4_pool(std::make_unique<MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNode::Ipv4Pool>())
	,ipv6_pool(std::make_unique<MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNode::Ipv6Pool>())
{
    ipv4_pool->parent = this;
    children["ipv4-pool"] = ipv4_pool.get();
...
Entity* MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNode::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNode::get_children()
{
    if(children.find("ipv4-pool") == children.end())
    {
        if(ipv4_pool != nullptr)
...
Entity* MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNetwork::Mripv6Pools::Mripv6Pool::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNetwork::Mripv6Pools::Mripv6Pool::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNetwork::Mripv6Pools::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "mripv6-pool")
    {
        ...
        auto c = std::make_unique<MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNetwork::Mripv6Pools::Mripv6Pool>();
        c->parent = this;
        mripv6_pool.push_back(std::move(c));
        children[segment_path] = mripv6_pool.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNetwork::Mripv6Pools::get_children()
{
    for (auto const & c : mripv6_pool)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNetwork::Mripv4Pools::Mripv4Pool::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNetwork::Mripv4Pools::Mripv4Pool::get_children()
{
    return children;
}
...
Entity* MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNetwork::Mripv4Pools::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "mripv4-pool")
    {
        ...
        auto c = std::make_unique<MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNetwork::Mripv4Pools::Mripv4Pool>();
        c->parent = this;
        mripv4_pool.push_back(std::move(c));
        children[segment_path] = mripv4_pool.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNetwork::Mripv4Pools::get_children()
{
    for (auto const & c : mripv4_pool)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNetwork::MobileNetwork()
    :
    mripv4_pools(std::make_unique<MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNetwork::Mripv4Pools>())
	,mripv6_pools(std::make_unique<MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNetwork::Mripv6Pools>())
{
    mripv4_pools->parent = this;
    children["mripv4-pools"] = mripv4_pools.get();
...
Entity* MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNetwork::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNetwork::get_children()
{
    if(children.find("mripv4-pools") == children.end())
    {
        if(mripv4_pools != nullptr)
...
MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::PoolAttributes()
    :
    mobile_network(std::make_unique<MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNetwork>())
	,mobile_node(std::make_unique<MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::MobileNode>())
{
    mobile_network->parent = this;
    children["mobile-network"] = mobile_network.get();
...
Entity* MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Networks::Network::PoolAttributes::get_children()
{
    if(children.find("mobile-network") == children.end())
    {
        if(mobile_network != nullptr)
...
MobileIp::Lmas::Lma::Networks::Network::Network()
    :
    	...
    	,
    pool_attributes(std::make_unique<MobileIp::Lmas::Lma::Networks::Network::PoolAttributes>())
{
    pool_attributes->parent = this;
    children["pool-attributes"] = pool_attributes.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "network" <<"[lma-network='" <<lma_network.get() <<"']";
...
Entity* MobileIp::Lmas::Lma::Networks::Network::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Networks::Network::get_children()
{
    if(children.find("pool-attributes") == children.end())
    {
        if(pool_attributes != nullptr)
...
Entity* MobileIp::Lmas::Lma::Networks::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "network")
    {
        ...
        auto c = std::make_unique<MobileIp::Lmas::Lma::Networks::Network>();
        c->parent = this;
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::Networks::get_children()
{
    for (auto const & c : network)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
MobileIp::Lmas::Lma::Lma()
    :
	 ...
	 pgw_subs_cont{YType::empty, "pgw-subs-cont"}
    	,
    aaa(std::make_unique<MobileIp::Lmas::Lma::Aaa>())
	,binding_attributes(std::make_unique<MobileIp::Lmas::Lma::BindingAttributes>())
	,binding_revocation_attributes(std::make_unique<MobileIp::Lmas::Lma::BindingRevocationAttributes>())
	,dscp(std::make_unique<MobileIp::Lmas::Lma::Dscp>())
	,heart_beat_attributes(std::make_unique<MobileIp::Lmas::Lma::HeartBeatAttributes>())
	,hnp(std::make_unique<MobileIp::Lmas::Lma::Hnp>())
	,lmaipv4_addresses(std::make_unique<MobileIp::Lmas::Lma::Lmaipv4Addresses>())
	,lmaipv6_addresses(std::make_unique<MobileIp::Lmas::Lma::Lmaipv6Addresses>())
	,mags(std::make_unique<MobileIp::Lmas::Lma::Mags>())
	,networks(std::make_unique<MobileIp::Lmas::Lma::Networks>())
	,rat_attributes(std::make_unique<MobileIp::Lmas::Lma::RatAttributes>())
	,redistribute(std::make_unique<MobileIp::Lmas::Lma::Redistribute>())
	,replay_protection(std::make_unique<MobileIp::Lmas::Lma::ReplayProtection>())
	,roles(std::make_unique<MobileIp::Lmas::Lma::Roles>())
	,services(std::make_unique<MobileIp::Lmas::Lma::Services>())
	,tunnel_attributes(std::make_unique<MobileIp::Lmas::Lma::TunnelAttributes>())
{
    aaa->parent = this;
    ...
    children["binding-revocation-attributes"] = binding_revocation_attributes.get();
    ...
    hnp->parent = this;
    children["hnp"] = hnp.get();

    lmaipv4_addresses->parent = this;
    children["lmaipv4-addresses"] = lmaipv4_addresses.get();

    lmaipv6_addresses->parent = this;
    children["lmaipv6-addresses"] = lmaipv6_addresses.get();
    ...
    children["rat-attributes"] = rat_attributes.get();

    redistribute->parent = this;
    children["redistribute"] = redistribute.get();

    replay_protection->parent = this;
    children["replay-protection"] = replay_protection.get();

    roles->parent = this;
    children["roles"] = roles.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "lma" <<"[domain-name='" <<domain_name.get() <<"']" <<"[lma-name='" <<lma_name.get() <<"']";
...
Entity* MobileIp::Lmas::Lma::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::Lmas::Lma::get_children()
{
...
Entity* MobileIp::Lmas::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "lma")
    {
        ...
        auto c = std::make_unique<MobileIp::Lmas::Lma>();
        c->parent = this;
        lma.push_back(std::move(c));
        children[segment_path] = lma.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & MobileIp::Lmas::get_children()
{
    for (auto const & c : lma)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
MobileIp::MobileIp()
    :
    domains(std::make_unique<MobileIp::Domains>())
	,lmas(std::make_unique<MobileIp::Lmas>())
{
    domains->parent = this;
...
Entity* MobileIp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & MobileIp::get_children()
{
...
std::unique_ptr<Entity> MobileIp::clone_ptr()
{
