...
std::string PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples::Sample::get_segment_path() const
{
    ...
    path_buffer << "sample" <<"[sample-id='" <<sample_id.get() <<"']";

    return path_buffer.str();

}

EntityPath PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples::Sample>();
        c->parent = this;
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples::get_children()
{
    for (auto const & c : sample)
    {
...
PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Ospfv2ProtocolInstance()
    :
    	...
    	,
    samples(std::make_unique<PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples>())
{
    samples->parent = this;
    children["samples"] = samples.get();
...
bool PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::has_operation() const
{
	...
	|| (samples !=  nullptr && is_set(samples->operation));
}

std::string PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "ospfv2-protocol-instance" <<"[instance-name='" <<instance_name.get() <<"']";

    return path_buffer.str();

}

EntityPath PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "samples")
    {
        ...
        return children.at("samples");
    }

    return nullptr;
}

std::map<std::string, Entity*> & PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::get_children()
{
    if(children.find("samples") == children.end())
    {
        if(samples != nullptr)
        {
            children["samples"] = samples.get();
...
EntityPath PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "ospfv2-protocol-instance")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance>();
        c->parent = this;
        ospfv2_protocol_instance.push_back(std::move(c));
        children[segment_path] = ospfv2_protocol_instance.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances::get_children()
{
    for (auto const & c : ospfv2_protocol_instance)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Ospfv3ProtocolInstance()
    :
    	instance_name{YType::str, "instance-name"}
    	,
    samples(std::make_unique<PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Samples>())
{
    samples->parent = this;
    children["samples"] = samples.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "ospfv3-protocol-instance" <<"[instance-name='" <<instance_name.get() <<"']";

    return path_buffer.str();

}

EntityPath PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::get_children()
{
    if(children.find("samples") == children.end())
    {
        if(samples != nullptr)
...
EntityPath PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "ospfv3-protocol-instance")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance>();
        c->parent = this;
        ospfv3_protocol_instance.push_back(std::move(c));
        children[segment_path] = ospfv3_protocol_instance.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances::get_children()
{
    for (auto const & c : ospfv3_protocol_instance)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Periodic::Ospf::Ospf()
    :
    ospfv2_protocol_instances(std::make_unique<PerfMgmt::Periodic::Ospf::Ospfv2ProtocolInstances>())
	,ospfv3_protocol_instances(std::make_unique<PerfMgmt::Periodic::Ospf::Ospfv3ProtocolInstances>())
{
    ospfv2_protocol_instances->parent = this;
    children["ospfv2-protocol-instances"] = ospfv2_protocol_instances.get();

    ospfv3_protocol_instances->parent = this;
    children["ospfv3-protocol-instances"] = ospfv3_protocol_instances.get();
...
{
    return is_set(operation)
	|| (ospfv2_protocol_instances !=  nullptr && is_set(ospfv2_protocol_instances->operation))
	|| (ospfv3_protocol_instances !=  nullptr && is_set(ospfv3_protocol_instances->operation));
}
...
EntityPath PerfMgmt::Periodic::Ospf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Ospf::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "ospfv2-protocol-instances")
    {
        ...
        return children.at("ospfv2-protocol-instances");
    }
    ...
    if(child_yang_name == "ospfv3-protocol-instances")
    {
        ...
        return children.at("ospfv3-protocol-instances");
    }

    return nullptr;
}

std::map<std::string, Entity*> & PerfMgmt::Periodic::Ospf::get_children()
{
    if(children.find("ospfv2-protocol-instances") == children.end())
    {
        if(ospfv2_protocol_instances != nullptr)
        {
            children["ospfv2-protocol-instances"] = ospfv2_protocol_instances.get();
    ...
    if(children.find("ospfv3-protocol-instances") == children.end())
    {
        if(ospfv3_protocol_instances != nullptr)
        {
            children["ospfv3-protocol-instances"] = ospfv3_protocol_instances.get();
...
EntityPath PerfMgmt::Periodic::Mpls::LdpNeighbors::LdpNeighbor::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Mpls::LdpNeighbors::LdpNeighbor::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Mpls::LdpNeighbors::LdpNeighbor::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Periodic::Mpls::LdpNeighbors::LdpNeighbor::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Mpls::LdpNeighbors::LdpNeighbor::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Mpls::LdpNeighbors::LdpNeighbor::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Mpls::LdpNeighbors::LdpNeighbor::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Periodic::Mpls::LdpNeighbors::LdpNeighbor::LdpNeighbor()
    :
    	nbr{YType::str, "nbr"}
    	,
    samples(std::make_unique<PerfMgmt::Periodic::Mpls::LdpNeighbors::LdpNeighbor::Samples>())
{
    samples->parent = this;
    children["samples"] = samples.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "ldp-neighbor" <<"[nbr='" <<nbr.get() <<"']";

    return path_buffer.str();

}

EntityPath PerfMgmt::Periodic::Mpls::LdpNeighbors::LdpNeighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Mpls::LdpNeighbors::LdpNeighbor::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Mpls::LdpNeighbors::LdpNeighbor::get_children()
{
    if(children.find("samples") == children.end())
    {
        if(samples != nullptr)
...
EntityPath PerfMgmt::Periodic::Mpls::LdpNeighbors::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Mpls::LdpNeighbors::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "ldp-neighbor")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Mpls::LdpNeighbors::LdpNeighbor>();
        c->parent = this;
        ldp_neighbor.push_back(std::move(c));
        children[segment_path] = ldp_neighbor.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Mpls::LdpNeighbors::get_children()
{
    for (auto const & c : ldp_neighbor)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Periodic::Mpls::Mpls()
    :
    ldp_neighbors(std::make_unique<PerfMgmt::Periodic::Mpls::LdpNeighbors>())
{
    ldp_neighbors->parent = this;
    children["ldp-neighbors"] = ldp_neighbors.get();
...
{
    return is_set(operation)
	|| (ldp_neighbors !=  nullptr && is_set(ldp_neighbors->operation));
}
...
EntityPath PerfMgmt::Periodic::Mpls::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Mpls::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "ldp-neighbors")
    {
        ...
        return children.at("ldp-neighbors");
    }

    return nullptr;
}

std::map<std::string, Entity*> & PerfMgmt::Periodic::Mpls::get_children()
{
    if(children.find("ldp-neighbors") == children.end())
    {
        if(ldp_neighbors != nullptr)
        {
            children["ldp-neighbors"] = ldp_neighbors.get();
...
EntityPath PerfMgmt::Periodic::Nodes::Node::SampleXr::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Nodes::Node::SampleXr::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Nodes::Node::SampleXr::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Periodic::Nodes::Node::SampleXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Nodes::Node::SampleXr::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Nodes::Node::SampleXr::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Nodes::Node::SampleXr::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath PerfMgmt::Periodic::Nodes::Node::Processes::Process::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Nodes::Node::Processes::Process::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Nodes::Node::Processes::Process::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Periodic::Nodes::Node::Processes::Process::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Nodes::Node::Processes::Process::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Nodes::Node::Processes::Process::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Nodes::Node::Processes::Process::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Periodic::Nodes::Node::Processes::Process::Process()
    :
    	...
    	,
    samples(std::make_unique<PerfMgmt::Periodic::Nodes::Node::Processes::Process::Samples>())
{
    samples->parent = this;
    children["samples"] = samples.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "process" <<"[process-id='" <<process_id.get() <<"']";

    return path_buffer.str();

}

EntityPath PerfMgmt::Periodic::Nodes::Node::Processes::Process::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Nodes::Node::Processes::Process::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Nodes::Node::Processes::Process::get_children()
{
    if(children.find("samples") == children.end())
    {
        if(samples != nullptr)
...
EntityPath PerfMgmt::Periodic::Nodes::Node::Processes::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Nodes::Node::Processes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "process")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Nodes::Node::Processes::Process>();
        c->parent = this;
        process.push_back(std::move(c));
        children[segment_path] = process.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Nodes::Node::Processes::get_children()
{
    for (auto const & c : process)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath PerfMgmt::Periodic::Nodes::Node::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Nodes::Node::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Nodes::Node::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Periodic::Nodes::Node::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Nodes::Node::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Nodes::Node::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Nodes::Node::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Periodic::Nodes::Node::Node()
    :
    	...
    	,
    processes(std::make_unique<PerfMgmt::Periodic::Nodes::Node::Processes>())
	,sample_xr(std::make_unique<PerfMgmt::Periodic::Nodes::Node::SampleXr>())
	,samples(std::make_unique<PerfMgmt::Periodic::Nodes::Node::Samples>())
{
    processes->parent = this;
    children["processes"] = processes.get();

    sample_xr->parent = this;
    children["sample-xr"] = sample_xr.get();
...
bool PerfMgmt::Periodic::Nodes::Node::has_operation() const
{
	...
	|| (sample_xr !=  nullptr && is_set(sample_xr->operation))
	|| (samples !=  nullptr && is_set(samples->operation));
}
...
EntityPath PerfMgmt::Periodic::Nodes::Node::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Nodes::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Nodes::Node::get_children()
{
    ...
    if(children.find("sample-xr") == children.end())
    {
        if(sample_xr != nullptr)
        {
            children["sample-xr"] = sample_xr.get();
...
EntityPath PerfMgmt::Periodic::Nodes::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Nodes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "node")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Nodes::Node>();
        c->parent = this;
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Nodes::get_children()
{
    for (auto const & c : node)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath PerfMgmt::Periodic::Bgp::BgpNeighbors::BgpNeighbor::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Bgp::BgpNeighbors::BgpNeighbor::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Bgp::BgpNeighbors::BgpNeighbor::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Periodic::Bgp::BgpNeighbors::BgpNeighbor::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Bgp::BgpNeighbors::BgpNeighbor::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Bgp::BgpNeighbors::BgpNeighbor::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Bgp::BgpNeighbors::BgpNeighbor::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Periodic::Bgp::BgpNeighbors::BgpNeighbor::BgpNeighbor()
    :
    	...
    	,
    samples(std::make_unique<PerfMgmt::Periodic::Bgp::BgpNeighbors::BgpNeighbor::Samples>())
{
    samples->parent = this;
    children["samples"] = samples.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "bgp-neighbor" <<"[ip-address='" <<ip_address.get() <<"']";

    return path_buffer.str();

}

EntityPath PerfMgmt::Periodic::Bgp::BgpNeighbors::BgpNeighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Bgp::BgpNeighbors::BgpNeighbor::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Bgp::BgpNeighbors::BgpNeighbor::get_children()
{
    if(children.find("samples") == children.end())
    {
        if(samples != nullptr)
...
EntityPath PerfMgmt::Periodic::Bgp::BgpNeighbors::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Bgp::BgpNeighbors::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "bgp-neighbor")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Bgp::BgpNeighbors::BgpNeighbor>();
        c->parent = this;
        bgp_neighbor.push_back(std::move(c));
        children[segment_path] = bgp_neighbor.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Bgp::BgpNeighbors::get_children()
{
    for (auto const & c : bgp_neighbor)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Periodic::Bgp::Bgp()
    :
    bgp_neighbors(std::make_unique<PerfMgmt::Periodic::Bgp::BgpNeighbors>())
{
    bgp_neighbors->parent = this;
    children["bgp-neighbors"] = bgp_neighbors.get();
...
{
    return is_set(operation)
	|| (bgp_neighbors !=  nullptr && is_set(bgp_neighbors->operation));
}
...
EntityPath PerfMgmt::Periodic::Bgp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Bgp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "bgp-neighbors")
    {
        ...
        return children.at("bgp-neighbors");
    }

    return nullptr;
}

std::map<std::string, Entity*> & PerfMgmt::Periodic::Bgp::get_children()
{
    if(children.find("bgp-neighbors") == children.end())
    {
        if(bgp_neighbors != nullptr)
        {
            children["bgp-neighbors"] = bgp_neighbors.get();
...
EntityPath PerfMgmt::Periodic::Interface::GenericCounterInterfaces::GenericCounterInterface::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Interface::GenericCounterInterfaces::GenericCounterInterface::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Interface::GenericCounterInterfaces::GenericCounterInterface::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Periodic::Interface::GenericCounterInterfaces::GenericCounterInterface::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Interface::GenericCounterInterfaces::GenericCounterInterface::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Interface::GenericCounterInterfaces::GenericCounterInterface::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Interface::GenericCounterInterfaces::GenericCounterInterface::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Periodic::Interface::GenericCounterInterfaces::GenericCounterInterface::GenericCounterInterface()
    :
    	...
    	,
    samples(std::make_unique<PerfMgmt::Periodic::Interface::GenericCounterInterfaces::GenericCounterInterface::Samples>())
{
    samples->parent = this;
    children["samples"] = samples.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "generic-counter-interface" <<"[interface-name='" <<interface_name.get() <<"']";

    return path_buffer.str();

}

EntityPath PerfMgmt::Periodic::Interface::GenericCounterInterfaces::GenericCounterInterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Interface::GenericCounterInterfaces::GenericCounterInterface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Interface::GenericCounterInterfaces::GenericCounterInterface::get_children()
{
    if(children.find("samples") == children.end())
    {
        if(samples != nullptr)
...
EntityPath PerfMgmt::Periodic::Interface::GenericCounterInterfaces::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Interface::GenericCounterInterfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "generic-counter-interface")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Interface::GenericCounterInterfaces::GenericCounterInterface>();
        c->parent = this;
        generic_counter_interface.push_back(std::move(c));
        children[segment_path] = generic_counter_interface.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Interface::GenericCounterInterfaces::get_children()
{
    for (auto const & c : generic_counter_interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath PerfMgmt::Periodic::Interface::BasicCounterInterfaces::BasicCounterInterface::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Interface::BasicCounterInterfaces::BasicCounterInterface::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Interface::BasicCounterInterfaces::BasicCounterInterface::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Periodic::Interface::BasicCounterInterfaces::BasicCounterInterface::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Interface::BasicCounterInterfaces::BasicCounterInterface::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Interface::BasicCounterInterfaces::BasicCounterInterface::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Interface::BasicCounterInterfaces::BasicCounterInterface::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Periodic::Interface::BasicCounterInterfaces::BasicCounterInterface::BasicCounterInterface()
    :
    	interface_name{YType::str, "interface-name"}
    	,
    samples(std::make_unique<PerfMgmt::Periodic::Interface::BasicCounterInterfaces::BasicCounterInterface::Samples>())
{
    samples->parent = this;
    children["samples"] = samples.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "basic-counter-interface" <<"[interface-name='" <<interface_name.get() <<"']";

    return path_buffer.str();

}

EntityPath PerfMgmt::Periodic::Interface::BasicCounterInterfaces::BasicCounterInterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Interface::BasicCounterInterfaces::BasicCounterInterface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Interface::BasicCounterInterfaces::BasicCounterInterface::get_children()
{
    if(children.find("samples") == children.end())
    {
        if(samples != nullptr)
...
EntityPath PerfMgmt::Periodic::Interface::BasicCounterInterfaces::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Interface::BasicCounterInterfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "basic-counter-interface")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Interface::BasicCounterInterfaces::BasicCounterInterface>();
        c->parent = this;
        basic_counter_interface.push_back(std::move(c));
        children[segment_path] = basic_counter_interface.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Interface::BasicCounterInterfaces::get_children()
{
    for (auto const & c : basic_counter_interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath PerfMgmt::Periodic::Interface::DataRateInterfaces::DataRateInterface::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Interface::DataRateInterfaces::DataRateInterface::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Interface::DataRateInterfaces::DataRateInterface::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Periodic::Interface::DataRateInterfaces::DataRateInterface::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Interface::DataRateInterfaces::DataRateInterface::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Interface::DataRateInterfaces::DataRateInterface::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Interface::DataRateInterfaces::DataRateInterface::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Periodic::Interface::DataRateInterfaces::DataRateInterface::DataRateInterface()
    :
    	interface_name{YType::str, "interface-name"}
    	,
    samples(std::make_unique<PerfMgmt::Periodic::Interface::DataRateInterfaces::DataRateInterface::Samples>())
{
    samples->parent = this;
    children["samples"] = samples.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "data-rate-interface" <<"[interface-name='" <<interface_name.get() <<"']";

    return path_buffer.str();

}

EntityPath PerfMgmt::Periodic::Interface::DataRateInterfaces::DataRateInterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Interface::DataRateInterfaces::DataRateInterface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Interface::DataRateInterfaces::DataRateInterface::get_children()
{
    if(children.find("samples") == children.end())
    {
        if(samples != nullptr)
...
EntityPath PerfMgmt::Periodic::Interface::DataRateInterfaces::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Interface::DataRateInterfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "data-rate-interface")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Periodic::Interface::DataRateInterfaces::DataRateInterface>();
        c->parent = this;
        data_rate_interface.push_back(std::move(c));
        children[segment_path] = data_rate_interface.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::Interface::DataRateInterfaces::get_children()
{
    for (auto const & c : data_rate_interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Periodic::Interface::Interface()
    :
    basic_counter_interfaces(std::make_unique<PerfMgmt::Periodic::Interface::BasicCounterInterfaces>())
	,data_rate_interfaces(std::make_unique<PerfMgmt::Periodic::Interface::DataRateInterfaces>())
	,generic_counter_interfaces(std::make_unique<PerfMgmt::Periodic::Interface::GenericCounterInterfaces>())
{
    basic_counter_interfaces->parent = this;
    children["basic-counter-interfaces"] = basic_counter_interfaces.get();

    data_rate_interfaces->parent = this;
    children["data-rate-interfaces"] = data_rate_interfaces.get();

    generic_counter_interfaces->parent = this;
    children["generic-counter-interfaces"] = generic_counter_interfaces.get();
...
{
    return is_set(operation)
	|| (basic_counter_interfaces !=  nullptr && is_set(basic_counter_interfaces->operation))
	|| (data_rate_interfaces !=  nullptr && is_set(data_rate_interfaces->operation))
	|| (generic_counter_interfaces !=  nullptr && is_set(generic_counter_interfaces->operation));
}
...
EntityPath PerfMgmt::Periodic::Interface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "basic-counter-interfaces")
    {
        ...
        return children.at("basic-counter-interfaces");
    }
    ...
    if(child_yang_name == "data-rate-interfaces")
    {
        ...
        return children.at("data-rate-interfaces");
    }
    ...
    if(child_yang_name == "generic-counter-interfaces")
    {
        ...
        return children.at("generic-counter-interfaces");
    }

    return nullptr;
}

std::map<std::string, Entity*> & PerfMgmt::Periodic::Interface::get_children()
{
    if(children.find("basic-counter-interfaces") == children.end())
    {
        if(basic_counter_interfaces != nullptr)
        {
            children["basic-counter-interfaces"] = basic_counter_interfaces.get();
    ...
    if(children.find("data-rate-interfaces") == children.end())
    {
        if(data_rate_interfaces != nullptr)
        {
            children["data-rate-interfaces"] = data_rate_interfaces.get();
    ...
    if(children.find("generic-counter-interfaces") == children.end())
    {
        if(generic_counter_interfaces != nullptr)
        {
            children["generic-counter-interfaces"] = generic_counter_interfaces.get();
...
PerfMgmt::Periodic::Periodic()
    :
    bgp(std::make_unique<PerfMgmt::Periodic::Bgp>())
	,interface(std::make_unique<PerfMgmt::Periodic::Interface>())
	,mpls(std::make_unique<PerfMgmt::Periodic::Mpls>())
	,nodes(std::make_unique<PerfMgmt::Periodic::Nodes>())
	,ospf(std::make_unique<PerfMgmt::Periodic::Ospf>())
{
    bgp->parent = this;
    children["bgp"] = bgp.get();

    interface->parent = this;
    children["interface"] = interface.get();
...
bool PerfMgmt::Periodic::has_operation() const
{
	...
	|| (interface !=  nullptr && is_set(interface->operation))
...
EntityPath PerfMgmt::Periodic::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Periodic::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Periodic::get_children()
{
...
EntityPath PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Ospfv2ProtocolInstance()
    :
    	instance_name{YType::str, "instance-name"}
    	,
    samples(std::make_unique<PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::Samples>())
{
    samples->parent = this;
    children["samples"] = samples.get();
...
EntityPath PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance::get_children()
{
    if(children.find("samples") == children.end())
    {
        if(samples != nullptr)
...
EntityPath PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "ospfv2-protocol-instance")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances::Ospfv2ProtocolInstance>();
        c->parent = this;
        ospfv2_protocol_instance.push_back(std::move(c));
        children[segment_path] = ospfv2_protocol_instance.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances::get_children()
{
    for (auto const & c : ospfv2_protocol_instance)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Ospfv3ProtocolInstance()
    :
    	instance_name{YType::str, "instance-name"}
    	,
    samples(std::make_unique<PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::Samples>())
{
    samples->parent = this;
    children["samples"] = samples.get();
...
EntityPath PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance::get_children()
{
    if(children.find("samples") == children.end())
    {
        if(samples != nullptr)
...
EntityPath PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "ospfv3-protocol-instance")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances::Ospfv3ProtocolInstance>();
        c->parent = this;
        ospfv3_protocol_instance.push_back(std::move(c));
        children[segment_path] = ospfv3_protocol_instance.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances::get_children()
{
    for (auto const & c : ospfv3_protocol_instance)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Monitor::Ospf::Ospf()
    :
    ospfv2_protocol_instances(std::make_unique<PerfMgmt::Monitor::Ospf::Ospfv2ProtocolInstances>())
	,ospfv3_protocol_instances(std::make_unique<PerfMgmt::Monitor::Ospf::Ospfv3ProtocolInstances>())
{
    ospfv2_protocol_instances->parent = this;
    children["ospfv2-protocol-instances"] = ospfv2_protocol_instances.get();
...
EntityPath PerfMgmt::Monitor::Ospf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Ospf::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Ospf::get_children()
{
    if(children.find("ospfv2-protocol-instances") == children.end())
    {
        if(ospfv2_protocol_instances != nullptr)
...
EntityPath PerfMgmt::Monitor::Mpls::LdpNeighbors::LdpNeighbor::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Mpls::LdpNeighbors::LdpNeighbor::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Mpls::LdpNeighbors::LdpNeighbor::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Monitor::Mpls::LdpNeighbors::LdpNeighbor::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Mpls::LdpNeighbors::LdpNeighbor::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Mpls::LdpNeighbors::LdpNeighbor::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Mpls::LdpNeighbors::LdpNeighbor::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Monitor::Mpls::LdpNeighbors::LdpNeighbor::LdpNeighbor()
    :
    	nbr{YType::str, "nbr"}
    	,
    samples(std::make_unique<PerfMgmt::Monitor::Mpls::LdpNeighbors::LdpNeighbor::Samples>())
{
    samples->parent = this;
    children["samples"] = samples.get();
...
EntityPath PerfMgmt::Monitor::Mpls::LdpNeighbors::LdpNeighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Mpls::LdpNeighbors::LdpNeighbor::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Mpls::LdpNeighbors::LdpNeighbor::get_children()
{
    if(children.find("samples") == children.end())
    {
        if(samples != nullptr)
...
EntityPath PerfMgmt::Monitor::Mpls::LdpNeighbors::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Mpls::LdpNeighbors::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "ldp-neighbor")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Mpls::LdpNeighbors::LdpNeighbor>();
        c->parent = this;
        ldp_neighbor.push_back(std::move(c));
        children[segment_path] = ldp_neighbor.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Mpls::LdpNeighbors::get_children()
{
    for (auto const & c : ldp_neighbor)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Monitor::Mpls::Mpls()
    :
    ldp_neighbors(std::make_unique<PerfMgmt::Monitor::Mpls::LdpNeighbors>())
{
    ldp_neighbors->parent = this;
    children["ldp-neighbors"] = ldp_neighbors.get();
...
EntityPath PerfMgmt::Monitor::Mpls::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Mpls::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Mpls::get_children()
{
    if(children.find("ldp-neighbors") == children.end())
    {
        if(ldp_neighbors != nullptr)
...
EntityPath PerfMgmt::Monitor::Nodes::Node::SampleXr::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Nodes::Node::SampleXr::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Nodes::Node::SampleXr::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Monitor::Nodes::Node::SampleXr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Nodes::Node::SampleXr::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Nodes::Node::SampleXr::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Nodes::Node::SampleXr::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath PerfMgmt::Monitor::Nodes::Node::Processes::Process::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Nodes::Node::Processes::Process::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Nodes::Node::Processes::Process::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Monitor::Nodes::Node::Processes::Process::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Nodes::Node::Processes::Process::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Nodes::Node::Processes::Process::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Nodes::Node::Processes::Process::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Monitor::Nodes::Node::Processes::Process::Process()
    :
    	process_id{YType::int32, "process-id"}
    	,
    samples(std::make_unique<PerfMgmt::Monitor::Nodes::Node::Processes::Process::Samples>())
{
    samples->parent = this;
    children["samples"] = samples.get();
...
EntityPath PerfMgmt::Monitor::Nodes::Node::Processes::Process::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Nodes::Node::Processes::Process::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Nodes::Node::Processes::Process::get_children()
{
    if(children.find("samples") == children.end())
    {
        if(samples != nullptr)
...
EntityPath PerfMgmt::Monitor::Nodes::Node::Processes::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Nodes::Node::Processes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "process")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Nodes::Node::Processes::Process>();
        c->parent = this;
        process.push_back(std::move(c));
        children[segment_path] = process.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Nodes::Node::Processes::get_children()
{
    for (auto const & c : process)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath PerfMgmt::Monitor::Nodes::Node::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Nodes::Node::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Nodes::Node::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Monitor::Nodes::Node::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Nodes::Node::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Nodes::Node::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Nodes::Node::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Monitor::Nodes::Node::Node()
    :
    	node_id{YType::str, "node-id"}
    	,
    processes(std::make_unique<PerfMgmt::Monitor::Nodes::Node::Processes>())
	,sample_xr(std::make_unique<PerfMgmt::Monitor::Nodes::Node::SampleXr>())
	,samples(std::make_unique<PerfMgmt::Monitor::Nodes::Node::Samples>())
{
    processes->parent = this;
    children["processes"] = processes.get();
...
EntityPath PerfMgmt::Monitor::Nodes::Node::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Nodes::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Nodes::Node::get_children()
{
    if(children.find("processes") == children.end())
    {
        if(processes != nullptr)
...
EntityPath PerfMgmt::Monitor::Nodes::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Nodes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "node")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Nodes::Node>();
        c->parent = this;
        node.push_back(std::move(c));
        children[segment_path] = node.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Nodes::get_children()
{
    for (auto const & c : node)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath PerfMgmt::Monitor::Bgp::BgpNeighbors::BgpNeighbor::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Bgp::BgpNeighbors::BgpNeighbor::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Bgp::BgpNeighbors::BgpNeighbor::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Monitor::Bgp::BgpNeighbors::BgpNeighbor::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Bgp::BgpNeighbors::BgpNeighbor::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Bgp::BgpNeighbors::BgpNeighbor::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Bgp::BgpNeighbors::BgpNeighbor::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Monitor::Bgp::BgpNeighbors::BgpNeighbor::BgpNeighbor()
    :
    	ip_address{YType::str, "ip-address"}
    	,
    samples(std::make_unique<PerfMgmt::Monitor::Bgp::BgpNeighbors::BgpNeighbor::Samples>())
{
    samples->parent = this;
    children["samples"] = samples.get();
...
EntityPath PerfMgmt::Monitor::Bgp::BgpNeighbors::BgpNeighbor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Bgp::BgpNeighbors::BgpNeighbor::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Bgp::BgpNeighbors::BgpNeighbor::get_children()
{
    if(children.find("samples") == children.end())
    {
        if(samples != nullptr)
...
EntityPath PerfMgmt::Monitor::Bgp::BgpNeighbors::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Bgp::BgpNeighbors::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "bgp-neighbor")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Bgp::BgpNeighbors::BgpNeighbor>();
        c->parent = this;
        bgp_neighbor.push_back(std::move(c));
        children[segment_path] = bgp_neighbor.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Bgp::BgpNeighbors::get_children()
{
    for (auto const & c : bgp_neighbor)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Monitor::Bgp::Bgp()
    :
    bgp_neighbors(std::make_unique<PerfMgmt::Monitor::Bgp::BgpNeighbors>())
{
    bgp_neighbors->parent = this;
    children["bgp-neighbors"] = bgp_neighbors.get();
...
EntityPath PerfMgmt::Monitor::Bgp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Bgp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Bgp::get_children()
{
    if(children.find("bgp-neighbors") == children.end())
    {
        if(bgp_neighbors != nullptr)
...
EntityPath PerfMgmt::Monitor::Interface::GenericCounterInterfaces::GenericCounterInterface::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Interface::GenericCounterInterfaces::GenericCounterInterface::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Interface::GenericCounterInterfaces::GenericCounterInterface::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Monitor::Interface::GenericCounterInterfaces::GenericCounterInterface::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Interface::GenericCounterInterfaces::GenericCounterInterface::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Interface::GenericCounterInterfaces::GenericCounterInterface::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Interface::GenericCounterInterfaces::GenericCounterInterface::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Monitor::Interface::GenericCounterInterfaces::GenericCounterInterface::GenericCounterInterface()
    :
    	interface_name{YType::str, "interface-name"}
    	,
    samples(std::make_unique<PerfMgmt::Monitor::Interface::GenericCounterInterfaces::GenericCounterInterface::Samples>())
{
    samples->parent = this;
    children["samples"] = samples.get();
...
EntityPath PerfMgmt::Monitor::Interface::GenericCounterInterfaces::GenericCounterInterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Interface::GenericCounterInterfaces::GenericCounterInterface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Interface::GenericCounterInterfaces::GenericCounterInterface::get_children()
{
    if(children.find("samples") == children.end())
    {
        if(samples != nullptr)
...
EntityPath PerfMgmt::Monitor::Interface::GenericCounterInterfaces::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Interface::GenericCounterInterfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "generic-counter-interface")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Interface::GenericCounterInterfaces::GenericCounterInterface>();
        c->parent = this;
        generic_counter_interface.push_back(std::move(c));
        children[segment_path] = generic_counter_interface.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Interface::GenericCounterInterfaces::get_children()
{
    for (auto const & c : generic_counter_interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath PerfMgmt::Monitor::Interface::BasicCounterInterfaces::BasicCounterInterface::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Interface::BasicCounterInterfaces::BasicCounterInterface::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Interface::BasicCounterInterfaces::BasicCounterInterface::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Monitor::Interface::BasicCounterInterfaces::BasicCounterInterface::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Interface::BasicCounterInterfaces::BasicCounterInterface::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Interface::BasicCounterInterfaces::BasicCounterInterface::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Interface::BasicCounterInterfaces::BasicCounterInterface::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Monitor::Interface::BasicCounterInterfaces::BasicCounterInterface::BasicCounterInterface()
    :
    	interface_name{YType::str, "interface-name"}
    	,
    samples(std::make_unique<PerfMgmt::Monitor::Interface::BasicCounterInterfaces::BasicCounterInterface::Samples>())
{
    samples->parent = this;
    children["samples"] = samples.get();
...
EntityPath PerfMgmt::Monitor::Interface::BasicCounterInterfaces::BasicCounterInterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Interface::BasicCounterInterfaces::BasicCounterInterface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Interface::BasicCounterInterfaces::BasicCounterInterface::get_children()
{
    if(children.find("samples") == children.end())
    {
        if(samples != nullptr)
...
EntityPath PerfMgmt::Monitor::Interface::BasicCounterInterfaces::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Interface::BasicCounterInterfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "basic-counter-interface")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Interface::BasicCounterInterfaces::BasicCounterInterface>();
        c->parent = this;
        basic_counter_interface.push_back(std::move(c));
        children[segment_path] = basic_counter_interface.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Interface::BasicCounterInterfaces::get_children()
{
    for (auto const & c : basic_counter_interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
EntityPath PerfMgmt::Monitor::Interface::DataRateInterfaces::DataRateInterface::Samples::Sample::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Interface::DataRateInterfaces::DataRateInterface::Samples::Sample::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Interface::DataRateInterfaces::DataRateInterface::Samples::Sample::get_children()
{
    return children;
}
...
EntityPath PerfMgmt::Monitor::Interface::DataRateInterfaces::DataRateInterface::Samples::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Interface::DataRateInterfaces::DataRateInterface::Samples::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "sample")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Interface::DataRateInterfaces::DataRateInterface::Samples::Sample>();
        c->parent = this;
        sample.push_back(std::move(c));
        children[segment_path] = sample.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Interface::DataRateInterfaces::DataRateInterface::Samples::get_children()
{
    for (auto const & c : sample)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Monitor::Interface::DataRateInterfaces::DataRateInterface::DataRateInterface()
    :
    	interface_name{YType::str, "interface-name"}
    	,
    samples(std::make_unique<PerfMgmt::Monitor::Interface::DataRateInterfaces::DataRateInterface::Samples>())
{
    samples->parent = this;
    children["samples"] = samples.get();
...
EntityPath PerfMgmt::Monitor::Interface::DataRateInterfaces::DataRateInterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Interface::DataRateInterfaces::DataRateInterface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Interface::DataRateInterfaces::DataRateInterface::get_children()
{
    if(children.find("samples") == children.end())
    {
        if(samples != nullptr)
...
EntityPath PerfMgmt::Monitor::Interface::DataRateInterfaces::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Interface::DataRateInterfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "data-rate-interface")
    {
        ...
        auto c = std::make_unique<PerfMgmt::Monitor::Interface::DataRateInterfaces::DataRateInterface>();
        c->parent = this;
        data_rate_interface.push_back(std::move(c));
        children[segment_path] = data_rate_interface.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Interface::DataRateInterfaces::get_children()
{
    for (auto const & c : data_rate_interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
PerfMgmt::Monitor::Interface::Interface()
    :
    basic_counter_interfaces(std::make_unique<PerfMgmt::Monitor::Interface::BasicCounterInterfaces>())
	,data_rate_interfaces(std::make_unique<PerfMgmt::Monitor::Interface::DataRateInterfaces>())
	,generic_counter_interfaces(std::make_unique<PerfMgmt::Monitor::Interface::GenericCounterInterfaces>())
{
    basic_counter_interfaces->parent = this;
    children["basic-counter-interfaces"] = basic_counter_interfaces.get();
...
EntityPath PerfMgmt::Monitor::Interface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::Interface::get_children()
{
    if(children.find("basic-counter-interfaces") == children.end())
    {
        if(basic_counter_interfaces != nullptr)
...
PerfMgmt::Monitor::Monitor()
    :
    bgp(std::make_unique<PerfMgmt::Monitor::Bgp>())
	,interface(std::make_unique<PerfMgmt::Monitor::Interface>())
	,mpls(std::make_unique<PerfMgmt::Monitor::Mpls>())
	,nodes(std::make_unique<PerfMgmt::Monitor::Nodes>())
	,ospf(std::make_unique<PerfMgmt::Monitor::Ospf>())
{
    bgp->parent = this;
    children["bgp"] = bgp.get();
...
EntityPath PerfMgmt::Monitor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Entity* PerfMgmt::Monitor::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & PerfMgmt::Monitor::get_children()
{
    if(children.find("bgp") == children.end())
    {
        if(bgp != nullptr)
...
PerfMgmt::PerfMgmt()
    :
    monitor(std::make_unique<PerfMgmt::Monitor>())
	,periodic(std::make_unique<PerfMgmt::Periodic>())
{
    monitor->parent = this;
    children["monitor"] = monitor.get();

    periodic->parent = this;
    children["periodic"] = periodic.get();
...
{
    return is_set(operation)
	|| (monitor !=  nullptr && is_set(monitor->operation))
	|| (periodic !=  nullptr && is_set(periodic->operation));
}
...
{
    if(children.find("monitor") == children.end())
    {
        if(monitor != nullptr)
        {
            children["monitor"] = monitor.get();
