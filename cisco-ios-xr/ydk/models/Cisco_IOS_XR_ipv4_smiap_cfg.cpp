...
Entity* Ipv4Virtual::Vrfs::Vrf::Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & Ipv4Virtual::Vrfs::Vrf::Address::get_children()
{
    return children;
}
...
Entity* Ipv4Virtual::Vrfs::Vrf::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "address")
    {
        ...
        {
            address = std::make_unique<Ipv4Virtual::Vrfs::Vrf::Address>();
            address->parent = this;
            children["address"] = address.get();
        }
...
std::map<std::string, Entity*> & Ipv4Virtual::Vrfs::Vrf::get_children()
{
...
Entity* Ipv4Virtual::Vrfs::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "vrf")
    {
        ...
        auto c = std::make_unique<Ipv4Virtual::Vrfs::Vrf>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ipv4Virtual::Vrfs::get_children()
{
    for (auto const & c : vrf)
    {
...
Ipv4Virtual::Ipv4Virtual()
    :
    	...
    	,
    vrfs(std::make_unique<Ipv4Virtual::Vrfs>())
{
    vrfs->parent = this;
...
Entity* Ipv4Virtual::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv4Virtual::get_children()
{
...
std::unique_ptr<Entity> Ipv4Virtual::clone_ptr()
{
    return std::make_unique<Ipv4Virtual>();
}
