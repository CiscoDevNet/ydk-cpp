...
Entity* Cfm::Nodes::Node::InterfaceAises::InterfaceAis::Statistics::Defects::RemoteMepsDefects::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & Cfm::Nodes::Node::InterfaceAises::InterfaceAis::Statistics::Defects::RemoteMepsDefects::get_children()
{
    return children;
}
...
Cfm::Nodes::Node::InterfaceAises::InterfaceAis::Statistics::Defects::Defects()
    :
	 ...
	 unexpected{YType::uint32, "unexpected"}
    	,
    remote_meps_defects(std::make_unique<Cfm::Nodes::Node::InterfaceAises::InterfaceAis::Statistics::Defects::RemoteMepsDefects>())
{
    remote_meps_defects->parent = this;
    children["remote-meps-defects"] = remote_meps_defects.get();
...
Entity* Cfm::Nodes::Node::InterfaceAises::InterfaceAis::Statistics::Defects::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Nodes::Node::InterfaceAises::InterfaceAis::Statistics::Defects::get_children()
{
...
Entity* Cfm::Nodes::Node::InterfaceAises::InterfaceAis::Statistics::LastStarted::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Nodes::Node::InterfaceAises::InterfaceAis::Statistics::LastStarted::get_children()
{
    return children;
}
...
Cfm::Nodes::Node::InterfaceAises::InterfaceAis::Statistics::Statistics()
    :
	 ...
	 via_level{YType::enumeration, "via-level"}
    	,
    defects(std::make_unique<Cfm::Nodes::Node::InterfaceAises::InterfaceAis::Statistics::Defects>())
	,last_started(std::make_unique<Cfm::Nodes::Node::InterfaceAises::InterfaceAis::Statistics::LastStarted>())
{
    defects->parent = this;
    children["defects"] = defects.get();

    last_started->parent = this;
    children["last-started"] = last_started.get();
...
Entity* Cfm::Nodes::Node::InterfaceAises::InterfaceAis::Statistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Nodes::Node::InterfaceAises::InterfaceAis::Statistics::get_children()
{
...
Cfm::Nodes::Node::InterfaceAises::InterfaceAis::InterfaceAis()
    :
	 ...
	 stp_state{YType::enumeration, "stp-state"}
    	,
    statistics(std::make_unique<Cfm::Nodes::Node::InterfaceAises::InterfaceAis::Statistics>())
{
...
{
    std::ostringstream path_buffer;
    path_buffer << "interface-ais" <<"[direction='" <<direction.get() <<"']" <<"[interface-name='" <<interface_name.get() <<"']";
...
Entity* Cfm::Nodes::Node::InterfaceAises::InterfaceAis::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Nodes::Node::InterfaceAises::InterfaceAis::get_children()
{
...
Entity* Cfm::Nodes::Node::InterfaceAises::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "interface-ais")
    {
        ...
        auto c = std::make_unique<Cfm::Nodes::Node::InterfaceAises::InterfaceAis>();
        c->parent = this;
        interface_ais.push_back(std::move(c));
        children[segment_path] = interface_ais.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Cfm::Nodes::Node::InterfaceAises::get_children()
{
    for (auto const & c : interface_ais)
    {
...
Entity* Cfm::Nodes::Node::InterfaceStatistics::InterfaceStatistic::Statistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Nodes::Node::InterfaceStatistics::InterfaceStatistic::Statistics::get_children()
{
    return children;
}
...
Cfm::Nodes::Node::InterfaceStatistics::InterfaceStatistic::InterfaceStatistic()
    :
	 ...
	 interface_xr{YType::str, "interface-xr"}
    	,
    statistics(std::make_unique<Cfm::Nodes::Node::InterfaceStatistics::InterfaceStatistic::Statistics>())
{
    statistics->parent = this;
    children["statistics"] = statistics.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "interface-statistic" <<"[interface='" <<interface.get() <<"']";
...
Entity* Cfm::Nodes::Node::InterfaceStatistics::InterfaceStatistic::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Nodes::Node::InterfaceStatistics::InterfaceStatistic::get_children()
{
    if(children.find("statistics") == children.end())
    {
        if(statistics != nullptr)
...
Entity* Cfm::Nodes::Node::InterfaceStatistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "interface-statistic")
    {
        ...
        auto c = std::make_unique<Cfm::Nodes::Node::InterfaceStatistics::InterfaceStatistic>();
        c->parent = this;
...
std::map<std::string, Entity*> & Cfm::Nodes::Node::InterfaceStatistics::get_children()
{
    for (auto const & c : interface_statistic)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Cfm::Nodes::Node::Summary::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Nodes::Node::Summary::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "ccm-learning-database" <<"[domain='" <<domain.get() <<"']" <<"[mac-address='" <<mac_address.get() <<"']" <<"[service='" <<service.get() <<"']";
...
Entity* Cfm::Nodes::Node::CcmLearningDatabases::CcmLearningDatabase::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Nodes::Node::CcmLearningDatabases::CcmLearningDatabase::get_children()
{
    return children;
}
...
Entity* Cfm::Nodes::Node::CcmLearningDatabases::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "ccm-learning-database")
    {
        ...
        auto c = std::make_unique<Cfm::Nodes::Node::CcmLearningDatabases::CcmLearningDatabase>();
        c->parent = this;
        ccm_learning_database.push_back(std::move(c));
        children[segment_path] = ccm_learning_database.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Cfm::Nodes::Node::CcmLearningDatabases::get_children()
{
    for (auto const & c : ccm_learning_database)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Cfm::Nodes::Node::Node()
    :
    	node{YType::str, "node"}
    	,
    ccm_learning_databases(std::make_unique<Cfm::Nodes::Node::CcmLearningDatabases>())
	,interface_aises(std::make_unique<Cfm::Nodes::Node::InterfaceAises>())
	,interface_statistics(std::make_unique<Cfm::Nodes::Node::InterfaceStatistics>())
	,summary(std::make_unique<Cfm::Nodes::Node::Summary>())
{
    ccm_learning_databases->parent = this;
    children["ccm-learning-databases"] = ccm_learning_databases.get();

    interface_aises->parent = this;
    children["interface-aises"] = interface_aises.get();
...
Entity* Cfm::Nodes::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Nodes::Node::get_children()
{
...
Entity* Cfm::Nodes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "node")
    {
        ...
        auto c = std::make_unique<Cfm::Nodes::Node>();
        c->parent = this;
...
std::map<std::string, Entity*> & Cfm::Nodes::get_children()
{
    for (auto const & c : node)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::TracerouteInformation::Options::BasicOptions::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::TracerouteInformation::Options::BasicOptions::get_children()
{
    return children;
}
...
Entity* Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::TracerouteInformation::Options::ExploratoryOptions::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::TracerouteInformation::Options::ExploratoryOptions::get_children()
{
    return children;
}
...
Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::TracerouteInformation::Options::Options()
    :
    	...
    	,
    basic_options(std::make_unique<Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::TracerouteInformation::Options::BasicOptions>())
	,exploratory_options(std::make_unique<Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::TracerouteInformation::Options::ExploratoryOptions>())
{
    basic_options->parent = this;
    children["basic-options"] = basic_options.get();

    exploratory_options->parent = this;
    children["exploratory-options"] = exploratory_options.get();
...
Entity* Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::TracerouteInformation::Options::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::TracerouteInformation::Options::get_children()
{
...
Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::TracerouteInformation::TracerouteInformation()
    :
	 ...
	 ttl{YType::uint8, "ttl"}
    	,
    options(std::make_unique<Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::TracerouteInformation::Options>())
{
    options->parent = this;
...
Entity* Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::TracerouteInformation::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::TracerouteInformation::get_children()
{
...
Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::IncompleteTraceroute()
    :
	 ...
	 time_left{YType::uint64, "time-left"}
    	,
    traceroute_information(std::make_unique<Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::TracerouteInformation>())
{
    traceroute_information->parent = this;
    children["traceroute-information"] = traceroute_information.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "incomplete-traceroute" <<"[domain='" <<domain.get() <<"']" <<"[interface='" <<interface.get() <<"']" <<"[mep-id='" <<mep_id.get() <<"']" <<"[service='" <<service.get() <<"']" <<"[transaction-id='" <<transaction_id.get() <<"']";
...
Entity* Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute::get_children()
{
...
Entity* Cfm::Global::IncompleteTraceroutes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "incomplete-traceroute")
    {
        ...
        auto c = std::make_unique<Cfm::Global::IncompleteTraceroutes::IncompleteTraceroute>();
        c->parent = this;
        incomplete_traceroute.push_back(std::move(c));
        children[segment_path] = incomplete_traceroute.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Cfm::Global::IncompleteTraceroutes::get_children()
{
    for (auto const & c : incomplete_traceroute)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Cfm::Global::MaintenancePoints::MaintenancePoint::MaintenancePoint_::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::MaintenancePoints::MaintenancePoint::MaintenancePoint_::get_children()
{
    return children;
}
...
Cfm::Global::MaintenancePoints::MaintenancePoint::MaintenancePoint()
    :
	 ...
	 mep_has_error{YType::boolean, "mep-has-error"}
    	,
    maintenance_point(std::make_unique<Cfm::Global::MaintenancePoints::MaintenancePoint::MaintenancePoint_>())
{
    maintenance_point->parent = this;
    children["maintenance-point"] = maintenance_point.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "maintenance-point" <<"[domain='" <<domain.get() <<"']" <<"[interface='" <<interface.get() <<"']" <<"[service='" <<service.get() <<"']";
...
Entity* Cfm::Global::MaintenancePoints::MaintenancePoint::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::MaintenancePoints::MaintenancePoint::get_children()
{
...
Entity* Cfm::Global::MaintenancePoints::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "maintenance-point")
    {
        ...
        auto c = std::make_unique<Cfm::Global::MaintenancePoints::MaintenancePoint>();
        c->parent = this;
        maintenance_point.push_back(std::move(c));
        children[segment_path] = maintenance_point.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Cfm::Global::MaintenancePoints::get_children()
{
    for (auto const & c : maintenance_point)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Cfm::Global::GlobalConfigurationErrors::GlobalConfigurationError::BridgeDomainId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::GlobalConfigurationErrors::GlobalConfigurationError::BridgeDomainId::get_children()
{
    return children;
}
...
Cfm::Global::GlobalConfigurationErrors::GlobalConfigurationError::GlobalConfigurationError()
    :
	 ...
	 service_name{YType::str, "service-name"}
    	,
    bridge_domain_id(std::make_unique<Cfm::Global::GlobalConfigurationErrors::GlobalConfigurationError::BridgeDomainId>())
{
    bridge_domain_id->parent = this;
    children["bridge-domain-id"] = bridge_domain_id.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "global-configuration-error" <<"[domain='" <<domain.get() <<"']" <<"[service='" <<service.get() <<"']";
...
Entity* Cfm::Global::GlobalConfigurationErrors::GlobalConfigurationError::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::GlobalConfigurationErrors::GlobalConfigurationError::get_children()
{
...
Entity* Cfm::Global::GlobalConfigurationErrors::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "global-configuration-error")
    {
        ...
        auto c = std::make_unique<Cfm::Global::GlobalConfigurationErrors::GlobalConfigurationError>();
        c->parent = this;
        global_configuration_error.push_back(std::move(c));
        children[segment_path] = global_configuration_error.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Cfm::Global::GlobalConfigurationErrors::get_children()
{
    for (auto const & c : global_configuration_error)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Cfm::Global::MepConfigurationErrors::MepConfigurationError::Mep::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::MepConfigurationErrors::MepConfigurationError::Mep::get_children()
{
    return children;
}
...
Entity* Cfm::Global::MepConfigurationErrors::MepConfigurationError::ServiceBridgeDomain::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::MepConfigurationErrors::MepConfigurationError::ServiceBridgeDomain::get_children()
{
    return children;
}
...
Entity* Cfm::Global::MepConfigurationErrors::MepConfigurationError::InterfaceBridgeDomain::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::MepConfigurationErrors::MepConfigurationError::InterfaceBridgeDomain::get_children()
{
    return children;
}
...
Entity* Cfm::Global::MepConfigurationErrors::MepConfigurationError::SatelliteCapabilities::Loopback::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::MepConfigurationErrors::MepConfigurationError::SatelliteCapabilities::Loopback::get_children()
{
    return children;
}
...
Entity* Cfm::Global::MepConfigurationErrors::MepConfigurationError::SatelliteCapabilities::DelayMeasurement::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::MepConfigurationErrors::MepConfigurationError::SatelliteCapabilities::DelayMeasurement::get_children()
{
    return children;
}
...
Entity* Cfm::Global::MepConfigurationErrors::MepConfigurationError::SatelliteCapabilities::SyntheticLossMeasurement::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::MepConfigurationErrors::MepConfigurationError::SatelliteCapabilities::SyntheticLossMeasurement::get_children()
{
    return children;
}
...
Cfm::Global::MepConfigurationErrors::MepConfigurationError::SatelliteCapabilities::SatelliteCapabilities()
    :
    delay_measurement(std::make_unique<Cfm::Global::MepConfigurationErrors::MepConfigurationError::SatelliteCapabilities::DelayMeasurement>())
	,loopback(std::make_unique<Cfm::Global::MepConfigurationErrors::MepConfigurationError::SatelliteCapabilities::Loopback>())
	,synthetic_loss_measurement(std::make_unique<Cfm::Global::MepConfigurationErrors::MepConfigurationError::SatelliteCapabilities::SyntheticLossMeasurement>())
{
    delay_measurement->parent = this;
    children["delay-measurement"] = delay_measurement.get();

    loopback->parent = this;
    children["loopback"] = loopback.get();

    synthetic_loss_measurement->parent = this;
    children["synthetic-loss-measurement"] = synthetic_loss_measurement.get();
...
Entity* Cfm::Global::MepConfigurationErrors::MepConfigurationError::SatelliteCapabilities::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::MepConfigurationErrors::MepConfigurationError::SatelliteCapabilities::get_children()
{
...
Cfm::Global::MepConfigurationErrors::MepConfigurationError::MepConfigurationError()
    :
	 ...
	 sla_synthetic_loss_operations_disabled{YType::boolean, "sla-synthetic-loss-operations-disabled"}
    	,
    interface_bridge_domain(std::make_unique<Cfm::Global::MepConfigurationErrors::MepConfigurationError::InterfaceBridgeDomain>())
	,mep(std::make_unique<Cfm::Global::MepConfigurationErrors::MepConfigurationError::Mep>())
	,satellite_capabilities(std::make_unique<Cfm::Global::MepConfigurationErrors::MepConfigurationError::SatelliteCapabilities>())
	,service_bridge_domain(std::make_unique<Cfm::Global::MepConfigurationErrors::MepConfigurationError::ServiceBridgeDomain>())
{
    interface_bridge_domain->parent = this;
    children["interface-bridge-domain"] = interface_bridge_domain.get();

    mep->parent = this;
    children["mep"] = mep.get();

    satellite_capabilities->parent = this;
    children["satellite-capabilities"] = satellite_capabilities.get();

    service_bridge_domain->parent = this;
    children["service-bridge-domain"] = service_bridge_domain.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "mep-configuration-error" <<"[domain='" <<domain.get() <<"']" <<"[interface='" <<interface.get() <<"']" <<"[service='" <<service.get() <<"']";
...
Entity* Cfm::Global::MepConfigurationErrors::MepConfigurationError::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::MepConfigurationErrors::MepConfigurationError::get_children()
{
...
Entity* Cfm::Global::MepConfigurationErrors::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "mep-configuration-error")
    {
        ...
        auto c = std::make_unique<Cfm::Global::MepConfigurationErrors::MepConfigurationError>();
        c->parent = this;
        mep_configuration_error.push_back(std::move(c));
        children[segment_path] = mep_configuration_error.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Cfm::Global::MepConfigurationErrors::get_children()
{
    for (auto const & c : mep_configuration_error)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::TracerouteInformation::Options::BasicOptions::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::TracerouteInformation::Options::BasicOptions::get_children()
{
    return children;
}
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::TracerouteInformation::Options::ExploratoryOptions::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::TracerouteInformation::Options::ExploratoryOptions::get_children()
{
    return children;
}
...
Cfm::Global::TracerouteCaches::TracerouteCache::TracerouteInformation::Options::Options()
    :
    	mode{YType::enumeration, "mode"}
    	,
    basic_options(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::TracerouteInformation::Options::BasicOptions>())
	,exploratory_options(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::TracerouteInformation::Options::ExploratoryOptions>())
{
    basic_options->parent = this;
    children["basic-options"] = basic_options.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::TracerouteInformation::Options::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::TracerouteInformation::Options::get_children()
{
    if(children.find("basic-options") == children.end())
    {
        if(basic_options != nullptr)
...
Cfm::Global::TracerouteCaches::TracerouteCache::TracerouteInformation::TracerouteInformation()
    :
	 ...
	 ttl{YType::uint8, "ttl"}
    	,
    options(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::TracerouteInformation::Options>())
{
    options->parent = this;
    children["options"] = options.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::TracerouteInformation::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::TracerouteInformation::get_children()
{
    if(children.find("options") == children.end())
    {
        if(options != nullptr)
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::Header::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::Header::get_children()
{
    return children;
}
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::SenderId::ChassisId::ChassisIdValue::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::SenderId::ChassisId::ChassisIdValue::get_children()
{
    return children;
}
...
Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::SenderId::ChassisId::ChassisId()
    :
	 ...
	 chassis_id_type_value{YType::uint8, "chassis-id-type-value"}
    	,
    chassis_id_value(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::SenderId::ChassisId::ChassisIdValue>())
{
    chassis_id_value->parent = this;
    children["chassis-id-value"] = chassis_id_value.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::SenderId::ChassisId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::SenderId::ChassisId::get_children()
{
...
Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::SenderId::SenderId()
    :
	 ...
	 management_address_domain{YType::str, "management-address-domain"}
    	,
    chassis_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::SenderId::ChassisId>())
{
    chassis_id->parent = this;
    children["chassis-id"] = chassis_id.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::SenderId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::SenderId::get_children()
{
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::EgressId::LastEgressId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::EgressId::LastEgressId::get_children()
{
    return children;
}
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::EgressId::NextEgressId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::EgressId::NextEgressId::get_children()
{
    return children;
}
...
Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::EgressId::EgressId()
    :
    last_egress_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::EgressId::LastEgressId>())
	,next_egress_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::EgressId::NextEgressId>())
{
    last_egress_id->parent = this;
    children["last-egress-id"] = last_egress_id.get();

    next_egress_id->parent = this;
    children["next-egress-id"] = next_egress_id.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::EgressId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::EgressId::get_children()
{
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyIngress::PortId::PortIdValue::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyIngress::PortId::PortIdValue::get_children()
{
    return children;
}
...
Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyIngress::PortId::PortId()
    :
	 ...
	 port_id_type_value{YType::uint8, "port-id-type-value"}
    	,
    port_id_value(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyIngress::PortId::PortIdValue>())
{
    port_id_value->parent = this;
    children["port-id-value"] = port_id_value.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyIngress::PortId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyIngress::PortId::get_children()
{
...
Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyIngress::ReplyIngress()
    :
	 ...
	 mac_address{YType::str, "mac-address"}
    	,
    port_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyIngress::PortId>())
{
    port_id->parent = this;
    children["port-id"] = port_id.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyIngress::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyIngress::get_children()
{
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyEgress::PortId::PortIdValue::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyEgress::PortId::PortIdValue::get_children()
{
    return children;
}
...
Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyEgress::PortId::PortId()
    :
	 ...
	 port_id_type_value{YType::uint8, "port-id-type-value"}
    	,
    port_id_value(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyEgress::PortId::PortIdValue>())
{
    port_id_value->parent = this;
    children["port-id-value"] = port_id_value.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyEgress::PortId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyEgress::PortId::get_children()
{
    if(children.find("port-id-value") == children.end())
    {
        if(port_id_value != nullptr)
...
Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyEgress::ReplyEgress()
    :
	 ...
	 mac_address{YType::str, "mac-address"}
    	,
    port_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyEgress::PortId>())
{
    port_id->parent = this;
    children["port-id"] = port_id.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyEgress::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyEgress::get_children()
{
    if(children.find("port-id") == children.end())
    {
        if(port_id != nullptr)
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::LastHop::EgressId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::LastHop::EgressId::get_children()
{
    return children;
}
...
Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::LastHop::LastHop()
    :
	 ...
	 last_hop_format{YType::enumeration, "last-hop-format"}
    	,
    egress_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::LastHop::EgressId>())
{
    egress_id->parent = this;
    children["egress-id"] = egress_id.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::LastHop::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::LastHop::get_children()
{
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::OrganizationSpecificTlv::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::OrganizationSpecificTlv::get_children()
{
    return children;
}
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::UnknownTlv::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::UnknownTlv::get_children()
{
    return children;
}
...
Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::LinktraceReply()
    :
    	...
    	,
    egress_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::EgressId>())
	,header(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::Header>())
	,last_hop(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::LastHop>())
	,reply_egress(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyEgress>())
	,reply_ingress(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::ReplyIngress>())
	,sender_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::SenderId>())
{
    egress_id->parent = this;
    children["egress-id"] = egress_id.get();
    ...
    children["last-hop"] = last_hop.get();

    reply_egress->parent = this;
    children["reply-egress"] = reply_egress.get();

    reply_ingress->parent = this;
    children["reply-ingress"] = reply_ingress.get();

    sender_id->parent = this;
    children["sender-id"] = sender_id.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "organization-specific-tlv")
    {
        ...
        auto c = std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::OrganizationSpecificTlv>();
        c->parent = this;
        organization_specific_tlv.push_back(std::move(c));
        children[segment_path] = organization_specific_tlv.back().get();
        return children.at(segment_path);
    }
    ...
    if(child_yang_name == "unknown-tlv")
    {
        ...
        auto c = std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::UnknownTlv>();
        c->parent = this;
        unknown_tlv.push_back(std::move(c));
        children[segment_path] = unknown_tlv.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply::get_children()
{
    if(children.find("egress-id") == children.end())
    {
        if(egress_id != nullptr)
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::Header::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::Header::get_children()
{
    return children;
}
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::SenderId::ChassisId::ChassisIdValue::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::SenderId::ChassisId::ChassisIdValue::get_children()
{
    return children;
}
...
Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::SenderId::ChassisId::ChassisId()
    :
	 ...
	 chassis_id_type_value{YType::uint8, "chassis-id-type-value"}
    	,
    chassis_id_value(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::SenderId::ChassisId::ChassisIdValue>())
{
    chassis_id_value->parent = this;
    children["chassis-id-value"] = chassis_id_value.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::SenderId::ChassisId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::SenderId::ChassisId::get_children()
{
    if(children.find("chassis-id-value") == children.end())
    {
        if(chassis_id_value != nullptr)
...
Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::SenderId::SenderId()
    :
	 ...
	 management_address_domain{YType::str, "management-address-domain"}
    	,
    chassis_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::SenderId::ChassisId>())
{
    chassis_id->parent = this;
    children["chassis-id"] = chassis_id.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::SenderId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::SenderId::get_children()
{
    if(children.find("chassis-id") == children.end())
    {
        if(chassis_id != nullptr)
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress::LastEgressId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress::LastEgressId::get_children()
{
    return children;
}
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress::NextEgressId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress::NextEgressId::get_children()
{
    return children;
}
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress::PortId::PortIdValue::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress::PortId::PortIdValue::get_children()
{
    return children;
}
...
Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress::PortId::PortId()
    :
	 ...
	 port_id_type_value{YType::uint8, "port-id-type-value"}
    	,
    port_id_value(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress::PortId::PortIdValue>())
{
    port_id_value->parent = this;
    children["port-id-value"] = port_id_value.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress::PortId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress::PortId::get_children()
{
    if(children.find("port-id-value") == children.end())
    {
        if(port_id_value != nullptr)
...
Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress::ReplyIngress()
    :
	 ...
	 mac_address{YType::str, "mac-address"}
    	,
    last_egress_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress::LastEgressId>())
	,next_egress_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress::NextEgressId>())
	,port_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress::PortId>())
{
    last_egress_id->parent = this;
    children["last-egress-id"] = last_egress_id.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress::get_children()
{
    if(children.find("last-egress-id") == children.end())
    {
        if(last_egress_id != nullptr)
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress::LastEgressId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress::LastEgressId::get_children()
{
    return children;
}
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress::NextEgressId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress::NextEgressId::get_children()
{
    return children;
}
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress::PortId::PortIdValue::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress::PortId::PortIdValue::get_children()
{
    return children;
}
...
Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress::PortId::PortId()
    :
	 ...
	 port_id_type_value{YType::uint8, "port-id-type-value"}
    	,
    port_id_value(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress::PortId::PortIdValue>())
{
    port_id_value->parent = this;
    children["port-id-value"] = port_id_value.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress::PortId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress::PortId::get_children()
{
    if(children.find("port-id-value") == children.end())
    {
        if(port_id_value != nullptr)
...
Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress::ReplyEgress()
    :
	 ...
	 mac_address{YType::str, "mac-address"}
    	,
    last_egress_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress::LastEgressId>())
	,next_egress_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress::NextEgressId>())
	,port_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress::PortId>())
{
    last_egress_id->parent = this;
    children["last-egress-id"] = last_egress_id.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress::get_children()
{
    if(children.find("last-egress-id") == children.end())
    {
        if(last_egress_id != nullptr)
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::LastHop::EgressId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::LastHop::EgressId::get_children()
{
    return children;
}
...
Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::LastHop::LastHop()
    :
	 ...
	 last_hop_format{YType::enumeration, "last-hop-format"}
    	,
    egress_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::LastHop::EgressId>())
{
    egress_id->parent = this;
    children["egress-id"] = egress_id.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::LastHop::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::LastHop::get_children()
{
    if(children.find("egress-id") == children.end())
    {
        if(egress_id != nullptr)
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::OrganizationSpecificTlv::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::OrganizationSpecificTlv::get_children()
{
    return children;
}
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::UnknownTlv::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::UnknownTlv::get_children()
{
    return children;
}
...
Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ExploratoryLinktraceReply()
    :
    	raw_data{YType::str, "raw-data"}
    	,
    header(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::Header>())
	,last_hop(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::LastHop>())
	,reply_egress(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyEgress>())
	,reply_ingress(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::ReplyIngress>())
	,sender_id(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::SenderId>())
{
    header->parent = this;
    children["header"] = header.get();
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "organization-specific-tlv")
    {
        ...
        auto c = std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::OrganizationSpecificTlv>();
        c->parent = this;
        organization_specific_tlv.push_back(std::move(c));
        children[segment_path] = organization_specific_tlv.back().get();
        return children.at(segment_path);
    ...
    if(child_yang_name == "unknown-tlv")
    {
        ...
        auto c = std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::UnknownTlv>();
        c->parent = this;
        unknown_tlv.push_back(std::move(c));
        children[segment_path] = unknown_tlv.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply::get_children()
{
    if(children.find("header") == children.end())
    {
        if(header != nullptr)
...
Cfm::Global::TracerouteCaches::TracerouteCache::TracerouteCache()
    :
	 ...
	 replies_dropped{YType::uint32, "replies-dropped"}
    	,
    traceroute_information(std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::TracerouteInformation>())
{
    traceroute_information->parent = this;
    children["traceroute-information"] = traceroute_information.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "traceroute-cache" <<"[domain='" <<domain.get() <<"']" <<"[interface='" <<interface.get() <<"']" <<"[mep-id='" <<mep_id.get() <<"']" <<"[service='" <<service.get() <<"']" <<"[transaction-id='" <<transaction_id.get() <<"']";
...
Entity* Cfm::Global::TracerouteCaches::TracerouteCache::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "exploratory-linktrace-reply")
    {
        ...
        auto c = std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::ExploratoryLinktraceReply>();
        c->parent = this;
        exploratory_linktrace_reply.push_back(std::move(c));
        children[segment_path] = exploratory_linktrace_reply.back().get();
        return children.at(segment_path);
    }
    ...
    if(child_yang_name == "linktrace-reply")
    {
        ...
        auto c = std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache::LinktraceReply>();
        c->parent = this;
        linktrace_reply.push_back(std::move(c));
        children[segment_path] = linktrace_reply.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::TracerouteCache::get_children()
{
    for (auto const & c : exploratory_linktrace_reply)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Cfm::Global::TracerouteCaches::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "traceroute-cache")
    {
        ...
        auto c = std::make_unique<Cfm::Global::TracerouteCaches::TracerouteCache>();
        c->parent = this;
        traceroute_cache.push_back(std::move(c));
        children[segment_path] = traceroute_cache.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Cfm::Global::TracerouteCaches::get_children()
{
    for (auto const & c : traceroute_cache)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Cfm::Global::LocalMeps::LocalMep::Statistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::LocalMeps::LocalMep::Statistics::get_children()
{
    return children;
}
...
Entity* Cfm::Global::LocalMeps::LocalMep::AisStatistics::SendingStart::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::LocalMeps::LocalMep::AisStatistics::SendingStart::get_children()
{
    return children;
}
...
Entity* Cfm::Global::LocalMeps::LocalMep::AisStatistics::ReceivingStart::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::LocalMeps::LocalMep::AisStatistics::ReceivingStart::get_children()
{
    return children;
}
...
Cfm::Global::LocalMeps::LocalMep::AisStatistics::AisStatistics()
    :
	 ...
	 sending_ais{YType::enumeration, "sending-ais"}
    	,
    receiving_start(std::make_unique<Cfm::Global::LocalMeps::LocalMep::AisStatistics::ReceivingStart>())
	,sending_start(std::make_unique<Cfm::Global::LocalMeps::LocalMep::AisStatistics::SendingStart>())
{
    receiving_start->parent = this;
    children["receiving-start"] = receiving_start.get();

    sending_start->parent = this;
    children["sending-start"] = sending_start.get();
...
Entity* Cfm::Global::LocalMeps::LocalMep::AisStatistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::LocalMeps::LocalMep::AisStatistics::get_children()
{
...
Entity* Cfm::Global::LocalMeps::LocalMep::Defects::RemoteMepsDefects::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::LocalMeps::LocalMep::Defects::RemoteMepsDefects::get_children()
{
    return children;
}
...
Cfm::Global::LocalMeps::LocalMep::Defects::Defects()
    :
	 ...
	 unexpected{YType::uint32, "unexpected"}
    	,
    remote_meps_defects(std::make_unique<Cfm::Global::LocalMeps::LocalMep::Defects::RemoteMepsDefects>())
{
    remote_meps_defects->parent = this;
    children["remote-meps-defects"] = remote_meps_defects.get();
...
Entity* Cfm::Global::LocalMeps::LocalMep::Defects::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::LocalMeps::LocalMep::Defects::get_children()
{
    if(children.find("remote-meps-defects") == children.end())
    {
        if(remote_meps_defects != nullptr)
...
Cfm::Global::LocalMeps::LocalMep::LocalMep()
    :
	 ...
	 stp_state{YType::enumeration, "stp-state"}
    	,
    ais_statistics(std::make_unique<Cfm::Global::LocalMeps::LocalMep::AisStatistics>())
	,defects(std::make_unique<Cfm::Global::LocalMeps::LocalMep::Defects>())
	,statistics(std::make_unique<Cfm::Global::LocalMeps::LocalMep::Statistics>())
{
    ais_statistics->parent = this;
    children["ais-statistics"] = ais_statistics.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "local-mep" <<"[domain='" <<domain.get() <<"']" <<"[interface='" <<interface.get() <<"']" <<"[mep-id='" <<mep_id.get() <<"']" <<"[service='" <<service.get() <<"']";
...
Entity* Cfm::Global::LocalMeps::LocalMep::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::LocalMeps::LocalMep::get_children()
{
...
Entity* Cfm::Global::LocalMeps::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "local-mep")
    {
        ...
        auto c = std::make_unique<Cfm::Global::LocalMeps::LocalMep>();
        c->parent = this;
        local_mep.push_back(std::move(c));
        children[segment_path] = local_mep.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Cfm::Global::LocalMeps::get_children()
{
    for (auto const & c : local_mep)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::ErrorState::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::ErrorState::get_children()
{
    return children;
}
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastUpDownTime::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastUpDownTime::get_children()
{
    return children;
}
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::Mdid::MacName::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::Mdid::MacName::get_children()
{
    return children;
}
...
Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::Mdid::Mdid()
    :
	 ...
	 string_name{YType::str, "string-name"}
    	,
    mac_name(std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::Mdid::MacName>())
{
    mac_name->parent = this;
    children["mac-name"] = mac_name.get();
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::Mdid::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::Mdid::get_children()
{
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::ShortMaName::VpnIdName::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::ShortMaName::VpnIdName::get_children()
{
    return children;
}
...
Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::ShortMaName::ShortMaName()
    :
	 ...
	 vlan_id_name{YType::uint16, "vlan-id-name"}
    	,
    vpn_id_name(std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::ShortMaName::VpnIdName>())
{
    vpn_id_name->parent = this;
    children["vpn-id-name"] = vpn_id_name.get();
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::ShortMaName::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::ShortMaName::get_children()
{
...
Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::Header()
    :
	 ...
	 version{YType::uint8, "version"}
    	,
    mdid(std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::Mdid>())
	,short_ma_name(std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::ShortMaName>())
{
    mdid->parent = this;
    children["mdid"] = mdid.get();

    short_ma_name->parent = this;
    children["short-ma-name"] = short_ma_name.get();
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header::get_children()
{
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::SenderId::ChassisId::ChassisIdValue::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::SenderId::ChassisId::ChassisIdValue::get_children()
{
    return children;
}
...
Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::SenderId::ChassisId::ChassisId()
    :
	 ...
	 chassis_id_type_value{YType::uint8, "chassis-id-type-value"}
    	,
    chassis_id_value(std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::SenderId::ChassisId::ChassisIdValue>())
{
    chassis_id_value->parent = this;
    children["chassis-id-value"] = chassis_id_value.get();
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::SenderId::ChassisId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::SenderId::ChassisId::get_children()
{
    if(children.find("chassis-id-value") == children.end())
    {
        if(chassis_id_value != nullptr)
...
Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::SenderId::SenderId()
    :
	 ...
	 management_address_domain{YType::str, "management-address-domain"}
    	,
    chassis_id(std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::SenderId::ChassisId>())
{
    chassis_id->parent = this;
    children["chassis-id"] = chassis_id.get();
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::SenderId::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::SenderId::get_children()
{
    if(children.find("chassis-id") == children.end())
    {
        if(chassis_id != nullptr)
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::MepName::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::MepName::get_children()
{
    return children;
}
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::OrganizationSpecificTlv::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::OrganizationSpecificTlv::get_children()
{
    return children;
}
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::UnknownTlv::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::UnknownTlv::get_children()
{
    return children;
}
...
Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::LastCcmReceived()
    :
	 ...
	 raw_data{YType::str, "raw-data"}
    	,
    header(std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::Header>())
	,mep_name(std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::MepName>())
	,sender_id(std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::SenderId>())
{
    header->parent = this;
    children["header"] = header.get();

    mep_name->parent = this;
    children["mep-name"] = mep_name.get();
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "organization-specific-tlv")
    {
        ...
        auto c = std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::OrganizationSpecificTlv>();
        c->parent = this;
        organization_specific_tlv.push_back(std::move(c));
        children[segment_path] = organization_specific_tlv.back().get();
        return children.at(segment_path);
    ...
    if(child_yang_name == "unknown-tlv")
    {
        ...
        auto c = std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::UnknownTlv>();
        c->parent = this;
        unknown_tlv.push_back(std::move(c));
        children[segment_path] = unknown_tlv.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived::get_children()
{
    if(children.find("header") == children.end())
    {
        if(header != nullptr)
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::Statistics::LastCcmReceivedTime::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::Statistics::LastCcmReceivedTime::get_children()
{
    return children;
}
...
Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::Statistics::Statistics()
    :
	 ...
	 last_ccm_sequence_number{YType::uint32, "last-ccm-sequence-number"}
    	,
    last_ccm_received_time(std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::Statistics::LastCcmReceivedTime>())
{
    last_ccm_received_time->parent = this;
    children["last-ccm-received-time"] = last_ccm_received_time.get();
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::Statistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::Statistics::get_children()
{
...
Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::PeerMep()
    :
	 ...
	 peer_mep_state{YType::enumeration, "peer-mep-state"}
    	,
    error_state(std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::ErrorState>())
	,last_ccm_received(std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastCcmReceived>())
	,last_up_down_time(std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::LastUpDownTime>())
	,statistics(std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::Statistics>())
{
    error_state->parent = this;
    children["error-state"] = error_state.get();

    last_ccm_received->parent = this;
    children["last-ccm-received"] = last_ccm_received.get();

    last_up_down_time->parent = this;
    children["last-up-down-time"] = last_up_down_time.get();
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep::get_children()
{
...
Cfm::Global::PeerMePv2S::PeerMePv2::PeerMePv2()
    :
	 ...
	 standby{YType::boolean, "standby"}
    	,
    peer_mep(std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2::PeerMep>())
{
    peer_mep->parent = this;
    children["peer-mep"] = peer_mep.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "peer-me-pv2" <<"[domain='" <<domain.get() <<"']" <<"[interface='" <<interface.get() <<"']" <<"[local-mep-id='" <<local_mep_id.get() <<"']" <<"[peer-mac-address='" <<peer_mac_address.get() <<"']" <<"[peer-mep-id='" <<peer_mep_id.get() <<"']" <<"[service='" <<service.get() <<"']";
...
Entity* Cfm::Global::PeerMePv2S::PeerMePv2::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::PeerMePv2::get_children()
{
...
Entity* Cfm::Global::PeerMePv2S::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "peer-me-pv2")
    {
        ...
        auto c = std::make_unique<Cfm::Global::PeerMePv2S::PeerMePv2>();
        c->parent = this;
        peer_me_pv2.push_back(std::move(c));
        children[segment_path] = peer_me_pv2.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Cfm::Global::PeerMePv2S::get_children()
{
    for (auto const & c : peer_me_pv2)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Cfm::Global::Global()
    :
    global_configuration_errors(std::make_unique<Cfm::Global::GlobalConfigurationErrors>())
	,incomplete_traceroutes(std::make_unique<Cfm::Global::IncompleteTraceroutes>())
	,local_meps(std::make_unique<Cfm::Global::LocalMeps>())
	,maintenance_points(std::make_unique<Cfm::Global::MaintenancePoints>())
	,mep_configuration_errors(std::make_unique<Cfm::Global::MepConfigurationErrors>())
	,peer_me_pv2s(std::make_unique<Cfm::Global::PeerMePv2S>())
	,traceroute_caches(std::make_unique<Cfm::Global::TracerouteCaches>())
{
    global_configuration_errors->parent = this;
    children["global-configuration-errors"] = global_configuration_errors.get();

    incomplete_traceroutes->parent = this;
    children["incomplete-traceroutes"] = incomplete_traceroutes.get();

    local_meps->parent = this;
    children["local-meps"] = local_meps.get();

    maintenance_points->parent = this;
    children["maintenance-points"] = maintenance_points.get();

    mep_configuration_errors->parent = this;
    children["mep-configuration-errors"] = mep_configuration_errors.get();

    peer_me_pv2s->parent = this;
    children["peer-me-pv2s"] = peer_me_pv2s.get();

    traceroute_caches->parent = this;
    children["traceroute-caches"] = traceroute_caches.get();
...
Entity* Cfm::Global::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::Global::get_children()
{
...
Cfm::Cfm()
    :
    global(std::make_unique<Cfm::Global>())
	,nodes(std::make_unique<Cfm::Nodes>())
{
    global->parent = this;
...
Entity* Cfm::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Cfm::get_children()
{
...
std::unique_ptr<Entity> Cfm::clone_ptr()
{
