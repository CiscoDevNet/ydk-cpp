...
Entity* Hsrp::Ipv4::Groups::Group::ResignSentTime::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & Hsrp::Ipv4::Groups::Group::ResignSentTime::get_children()
{
    return children;
}
...
Entity* Hsrp::Ipv4::Groups::Group::ResignReceivedTime::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv4::Groups::Group::ResignReceivedTime::get_children()
{
    return children;
}
...
Entity* Hsrp::Ipv4::Groups::Group::CoupSentTime::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv4::Groups::Group::CoupSentTime::get_children()
{
    return children;
}
...
Entity* Hsrp::Ipv4::Groups::Group::CoupReceivedTime::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv4::Groups::Group::CoupReceivedTime::get_children()
{
    return children;
}
...
Entity* Hsrp::Ipv4::Groups::Group::Statistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv4::Groups::Group::Statistics::get_children()
{
    return children;
}
...
Entity* Hsrp::Ipv4::Groups::Group::GlobalAddress::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv4::Groups::Group::GlobalAddress::get_children()
{
    return children;
}
...
Entity* Hsrp::Ipv4::Groups::Group::StateChangeHistory::Time::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv4::Groups::Group::StateChangeHistory::Time::get_children()
{
    return children;
}
...
Hsrp::Ipv4::Groups::Group::StateChangeHistory::StateChangeHistory()
    :
	 ...
	 reason{YType::enumeration, "reason"}
    	,
    time(std::make_unique<Hsrp::Ipv4::Groups::Group::StateChangeHistory::Time>())
{
    time->parent = this;
...
Entity* Hsrp::Ipv4::Groups::Group::StateChangeHistory::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv4::Groups::Group::StateChangeHistory::get_children()
{
...
Hsrp::Ipv4::Groups::Group::Group()
    :
	 ...
	 virtual_mac_address_state{YType::enumeration, "virtual-mac-address-state"}
    	,
    coup_received_time(std::make_unique<Hsrp::Ipv4::Groups::Group::CoupReceivedTime>())
	,coup_sent_time(std::make_unique<Hsrp::Ipv4::Groups::Group::CoupSentTime>())
	,resign_received_time(std::make_unique<Hsrp::Ipv4::Groups::Group::ResignReceivedTime>())
	,resign_sent_time(std::make_unique<Hsrp::Ipv4::Groups::Group::ResignSentTime>())
	,statistics(std::make_unique<Hsrp::Ipv4::Groups::Group::Statistics>())
{
    coup_received_time->parent = this;
    children["coup-received-time"] = coup_received_time.get();

    coup_sent_time->parent = this;
    children["coup-sent-time"] = coup_sent_time.get();
...
{
    std::ostringstream path_buffer;
    path_buffer << "group" <<"[group-number='" <<group_number.get() <<"']" <<"[interface-name='" <<interface_name.get() <<"']";
...
Entity* Hsrp::Ipv4::Groups::Group::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "global-address")
    {
        ...
        auto c = std::make_unique<Hsrp::Ipv4::Groups::Group::GlobalAddress>();
        c->parent = this;
    ...
    if(child_yang_name == "state-change-history")
    {
        ...
        auto c = std::make_unique<Hsrp::Ipv4::Groups::Group::StateChangeHistory>();
        c->parent = this;
...
std::map<std::string, Entity*> & Hsrp::Ipv4::Groups::Group::get_children()
{
...
Entity* Hsrp::Ipv4::Groups::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "group")
    {
        ...
        auto c = std::make_unique<Hsrp::Ipv4::Groups::Group>();
        c->parent = this;
...
std::map<std::string, Entity*> & Hsrp::Ipv4::Groups::get_children()
{
    for (auto const & c : group)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
{
    std::ostringstream path_buffer;
    path_buffer << "tracked-interface" <<"[group-number='" <<group_number.get() <<"']" <<"[interface-name='" <<interface_name.get() <<"']" <<"[tracked-interface-name='" <<tracked_interface_name.get() <<"']";
...
Entity* Hsrp::Ipv4::TrackedInterfaces::TrackedInterface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv4::TrackedInterfaces::TrackedInterface::get_children()
{
    return children;
}
...
Entity* Hsrp::Ipv4::TrackedInterfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "tracked-interface")
    {
        ...
        auto c = std::make_unique<Hsrp::Ipv4::TrackedInterfaces::TrackedInterface>();
        c->parent = this;
...
std::map<std::string, Entity*> & Hsrp::Ipv4::TrackedInterfaces::get_children()
{
    for (auto const & c : tracked_interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Hsrp::Ipv4::Interfaces::Interface::Statistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv4::Interfaces::Interface::Statistics::get_children()
{
    return children;
}
...
Hsrp::Ipv4::Interfaces::Interface::Interface()
    :
	 ...
	 use_bia_flag{YType::boolean, "use-bia-flag"}
    	,
    statistics(std::make_unique<Hsrp::Ipv4::Interfaces::Interface::Statistics>())
{
    statistics->parent = this;
    children["statistics"] = statistics.get();
...
Entity* Hsrp::Ipv4::Interfaces::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv4::Interfaces::Interface::get_children()
{
    if(children.find("statistics") == children.end())
    {
        if(statistics != nullptr)
...
Entity* Hsrp::Ipv4::Interfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "interface")
    {
        ...
        auto c = std::make_unique<Hsrp::Ipv4::Interfaces::Interface>();
        c->parent = this;
...
std::map<std::string, Entity*> & Hsrp::Ipv4::Interfaces::get_children()
{
    for (auto const & c : interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Hsrp::Ipv4::Ipv4()
    :
    groups(std::make_unique<Hsrp::Ipv4::Groups>())
	,interfaces(std::make_unique<Hsrp::Ipv4::Interfaces>())
	,tracked_interfaces(std::make_unique<Hsrp::Ipv4::TrackedInterfaces>())
{
    groups->parent = this;
...
Entity* Hsrp::Ipv4::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv4::get_children()
{
...
Entity* Hsrp::MgoSessions::MgoSession::Slave::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::MgoSessions::MgoSession::Slave::get_children()
{
    return children;
}
...
Entity* Hsrp::MgoSessions::MgoSession::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "slave")
    {
        ...
        auto c = std::make_unique<Hsrp::MgoSessions::MgoSession::Slave>();
        c->parent = this;
...
std::map<std::string, Entity*> & Hsrp::MgoSessions::MgoSession::get_children()
{
    for (auto const & c : slave)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Hsrp::MgoSessions::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "mgo-session")
    {
        ...
        auto c = std::make_unique<Hsrp::MgoSessions::MgoSession>();
        c->parent = this;
...
std::map<std::string, Entity*> & Hsrp::MgoSessions::get_children()
{
    for (auto const & c : mgo_session)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Hsrp::Ipv6::TrackedInterfaces::TrackedInterface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv6::TrackedInterfaces::TrackedInterface::get_children()
{
    return children;
}
...
Entity* Hsrp::Ipv6::TrackedInterfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "tracked-interface")
    {
        ...
        auto c = std::make_unique<Hsrp::Ipv6::TrackedInterfaces::TrackedInterface>();
        c->parent = this;
        tracked_interface.push_back(std::move(c));
        children[segment_path] = tracked_interface.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Hsrp::Ipv6::TrackedInterfaces::get_children()
{
    for (auto const & c : tracked_interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Hsrp::Ipv6::Groups::Group::ResignSentTime::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv6::Groups::Group::ResignSentTime::get_children()
{
    return children;
}
...
Entity* Hsrp::Ipv6::Groups::Group::ResignReceivedTime::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv6::Groups::Group::ResignReceivedTime::get_children()
{
    return children;
}
...
Entity* Hsrp::Ipv6::Groups::Group::CoupSentTime::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv6::Groups::Group::CoupSentTime::get_children()
{
    return children;
}
...
Entity* Hsrp::Ipv6::Groups::Group::CoupReceivedTime::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv6::Groups::Group::CoupReceivedTime::get_children()
{
    return children;
}
...
Entity* Hsrp::Ipv6::Groups::Group::Statistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv6::Groups::Group::Statistics::get_children()
{
    return children;
}
...
Entity* Hsrp::Ipv6::Groups::Group::GlobalAddress::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv6::Groups::Group::GlobalAddress::get_children()
{
    return children;
}
...
Entity* Hsrp::Ipv6::Groups::Group::StateChangeHistory::Time::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv6::Groups::Group::StateChangeHistory::Time::get_children()
{
    return children;
}
...
Hsrp::Ipv6::Groups::Group::StateChangeHistory::StateChangeHistory()
    :
	 ...
	 reason{YType::enumeration, "reason"}
    	,
    time(std::make_unique<Hsrp::Ipv6::Groups::Group::StateChangeHistory::Time>())
{
    time->parent = this;
    children["time"] = time.get();
...
Entity* Hsrp::Ipv6::Groups::Group::StateChangeHistory::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv6::Groups::Group::StateChangeHistory::get_children()
{
    if(children.find("time") == children.end())
    {
        if(time != nullptr)
...
Hsrp::Ipv6::Groups::Group::Group()
    :
	 ...
	 virtual_mac_address_state{YType::enumeration, "virtual-mac-address-state"}
    	,
    coup_received_time(std::make_unique<Hsrp::Ipv6::Groups::Group::CoupReceivedTime>())
	,coup_sent_time(std::make_unique<Hsrp::Ipv6::Groups::Group::CoupSentTime>())
	,resign_received_time(std::make_unique<Hsrp::Ipv6::Groups::Group::ResignReceivedTime>())
	,resign_sent_time(std::make_unique<Hsrp::Ipv6::Groups::Group::ResignSentTime>())
	,statistics(std::make_unique<Hsrp::Ipv6::Groups::Group::Statistics>())
{
    coup_received_time->parent = this;
    children["coup-received-time"] = coup_received_time.get();
...
Entity* Hsrp::Ipv6::Groups::Group::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "global-address")
    {
        ...
        auto c = std::make_unique<Hsrp::Ipv6::Groups::Group::GlobalAddress>();
        c->parent = this;
        global_address.push_back(std::move(c));
        children[segment_path] = global_address.back().get();
        return children.at(segment_path);
    ...
    if(child_yang_name == "state-change-history")
    {
        ...
        auto c = std::make_unique<Hsrp::Ipv6::Groups::Group::StateChangeHistory>();
        c->parent = this;
        state_change_history.push_back(std::move(c));
        children[segment_path] = state_change_history.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Hsrp::Ipv6::Groups::Group::get_children()
{
    if(children.find("coup-received-time") == children.end())
    {
        if(coup_received_time != nullptr)
...
Entity* Hsrp::Ipv6::Groups::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "group")
    {
        ...
        auto c = std::make_unique<Hsrp::Ipv6::Groups::Group>();
        c->parent = this;
        group.push_back(std::move(c));
        children[segment_path] = group.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Hsrp::Ipv6::Groups::get_children()
{
    for (auto const & c : group)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Hsrp::Ipv6::Interfaces::Interface::Statistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv6::Interfaces::Interface::Statistics::get_children()
{
    return children;
}
...
Hsrp::Ipv6::Interfaces::Interface::Interface()
    :
	 ...
	 use_bia_flag{YType::boolean, "use-bia-flag"}
    	,
    statistics(std::make_unique<Hsrp::Ipv6::Interfaces::Interface::Statistics>())
{
    statistics->parent = this;
    children["statistics"] = statistics.get();
...
Entity* Hsrp::Ipv6::Interfaces::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv6::Interfaces::Interface::get_children()
{
    if(children.find("statistics") == children.end())
    {
        if(statistics != nullptr)
...
Entity* Hsrp::Ipv6::Interfaces::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "interface")
    {
        ...
        auto c = std::make_unique<Hsrp::Ipv6::Interfaces::Interface>();
        c->parent = this;
        interface.push_back(std::move(c));
        children[segment_path] = interface.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Hsrp::Ipv6::Interfaces::get_children()
{
    for (auto const & c : interface)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Hsrp::Ipv6::Ipv6()
    :
    groups(std::make_unique<Hsrp::Ipv6::Groups>())
	,interfaces(std::make_unique<Hsrp::Ipv6::Interfaces>())
	,tracked_interfaces(std::make_unique<Hsrp::Ipv6::TrackedInterfaces>())
{
    groups->parent = this;
    children["groups"] = groups.get();
...
Entity* Hsrp::Ipv6::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Ipv6::get_children()
{
    if(children.find("groups") == children.end())
    {
        if(groups != nullptr)
...
Entity* Hsrp::BfdSessions::BfdSession::Group::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::BfdSessions::BfdSession::Group::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "bfd-session" <<"[interface-name='" <<interface_name.get() <<"']" <<"[ip-address='" <<ip_address.get() <<"']";
...
Entity* Hsrp::BfdSessions::BfdSession::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "group")
    {
        ...
        auto c = std::make_unique<Hsrp::BfdSessions::BfdSession::Group>();
        c->parent = this;
        group.push_back(std::move(c));
        children[segment_path] = group.back().get();
        return children.at(segment_path);
...
std::map<std::string, Entity*> & Hsrp::BfdSessions::BfdSession::get_children()
{
    for (auto const & c : group)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Hsrp::BfdSessions::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "bfd-session")
    {
        ...
        auto c = std::make_unique<Hsrp::BfdSessions::BfdSession>();
        c->parent = this;
        bfd_session.push_back(std::move(c));
        children[segment_path] = bfd_session.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & Hsrp::BfdSessions::get_children()
{
    for (auto const & c : bfd_session)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Hsrp::Summary::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Hsrp::Summary::get_children()
{
    return children;
}
...
Hsrp::Hsrp()
    :
    bfd_sessions(std::make_unique<Hsrp::BfdSessions>())
	,ipv4(std::make_unique<Hsrp::Ipv4>())
	,ipv6(std::make_unique<Hsrp::Ipv6>())
	,mgo_sessions(std::make_unique<Hsrp::MgoSessions>())
	,summary(std::make_unique<Hsrp::Summary>())
{
    bfd_sessions->parent = this;
    children["bfd-sessions"] = bfd_sessions.get();
