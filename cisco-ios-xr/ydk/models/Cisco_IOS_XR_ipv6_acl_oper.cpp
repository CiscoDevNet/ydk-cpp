...
Entity* Ipv6AclAndPrefixList::AccessListManager::Prefixes::Prefix::PrefixListSequences::PrefixListSequence::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::AccessListManager::Prefixes::Prefix::PrefixListSequences::PrefixListSequence::get_children()
{
    return children;
}
...
Entity* Ipv6AclAndPrefixList::AccessListManager::Prefixes::Prefix::PrefixListSequences::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "prefix-list-sequence")
    {
        ...
        auto c = std::make_unique<Ipv6AclAndPrefixList::AccessListManager::Prefixes::Prefix::PrefixListSequences::PrefixListSequence>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::AccessListManager::Prefixes::Prefix::PrefixListSequences::get_children()
{
    for (auto const & c : prefix_list_sequence)
    {
...
Ipv6AclAndPrefixList::AccessListManager::Prefixes::Prefix::Prefix()
    :
    	...
    	,
    prefix_list_sequences(std::make_unique<Ipv6AclAndPrefixList::AccessListManager::Prefixes::Prefix::PrefixListSequences>())
{
...
Entity* Ipv6AclAndPrefixList::AccessListManager::Prefixes::Prefix::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::AccessListManager::Prefixes::Prefix::get_children()
{
...
Entity* Ipv6AclAndPrefixList::AccessListManager::Prefixes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "prefix")
    {
        ...
        auto c = std::make_unique<Ipv6AclAndPrefixList::AccessListManager::Prefixes::Prefix>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::AccessListManager::Prefixes::get_children()
{
    for (auto const & c : prefix)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Ipv6AclAndPrefixList::AccessListManager::Usages::Usage::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::AccessListManager::Usages::Usage::get_children()
{
    return children;
}
...
Entity* Ipv6AclAndPrefixList::AccessListManager::Usages::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "usage")
    {
        ...
        auto c = std::make_unique<Ipv6AclAndPrefixList::AccessListManager::Usages::Usage>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::AccessListManager::Usages::get_children()
{
    for (auto const & c : usage)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Ipv6AclAndPrefixList::AccessListManager::Accesses::Access::AccessListSequences::AccessListSequence::HwNextHopInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::AccessListManager::Accesses::Access::AccessListSequences::AccessListSequence::HwNextHopInfo::get_children()
{
    return children;
}
...
Entity* Ipv6AclAndPrefixList::AccessListManager::Accesses::Access::AccessListSequences::AccessListSequence::NextHopInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::AccessListManager::Accesses::Access::AccessListSequences::AccessListSequence::NextHopInfo::get_children()
{
    return children;
}
...
Ipv6AclAndPrefixList::AccessListManager::Accesses::Access::AccessListSequences::AccessListSequence::AccessListSequence()
    :
	 ...
	 source_prefix_group{YType::str, "source-prefix-group"}
    	,
    hw_next_hop_info(std::make_unique<Ipv6AclAndPrefixList::AccessListManager::Accesses::Access::AccessListSequences::AccessListSequence::HwNextHopInfo>())
{
...
Entity* Ipv6AclAndPrefixList::AccessListManager::Accesses::Access::AccessListSequences::AccessListSequence::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "next-hop-info")
    {
        ...
        auto c = std::make_unique<Ipv6AclAndPrefixList::AccessListManager::Accesses::Access::AccessListSequences::AccessListSequence::NextHopInfo>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::AccessListManager::Accesses::Access::AccessListSequences::AccessListSequence::get_children()
{
...
Entity* Ipv6AclAndPrefixList::AccessListManager::Accesses::Access::AccessListSequences::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "access-list-sequence")
    {
        ...
        auto c = std::make_unique<Ipv6AclAndPrefixList::AccessListManager::Accesses::Access::AccessListSequences::AccessListSequence>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::AccessListManager::Accesses::Access::AccessListSequences::get_children()
{
    for (auto const & c : access_list_sequence)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Ipv6AclAndPrefixList::AccessListManager::Accesses::Access::Access()
    :
    	access_list_name{YType::str, "access-list-name"}
    	,
    access_list_sequences(std::make_unique<Ipv6AclAndPrefixList::AccessListManager::Accesses::Access::AccessListSequences>())
{
...
Entity* Ipv6AclAndPrefixList::AccessListManager::Accesses::Access::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::AccessListManager::Accesses::Access::get_children()
{
...
Entity* Ipv6AclAndPrefixList::AccessListManager::Accesses::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "access")
    {
        ...
        auto c = std::make_unique<Ipv6AclAndPrefixList::AccessListManager::Accesses::Access>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::AccessListManager::Accesses::get_children()
{
    for (auto const & c : access)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Ipv6AclAndPrefixList::AccessListManager::AccessListManager()
    :
    accesses(std::make_unique<Ipv6AclAndPrefixList::AccessListManager::Accesses>())
	,prefixes(std::make_unique<Ipv6AclAndPrefixList::AccessListManager::Prefixes>())
	,usages(std::make_unique<Ipv6AclAndPrefixList::AccessListManager::Usages>())
{
...
Entity* Ipv6AclAndPrefixList::AccessListManager::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::AccessListManager::get_children()
{
...
Entity* Ipv6AclAndPrefixList::Oor::Details::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::Oor::Details::get_children()
{
    return children;
}
...
Entity* Ipv6AclAndPrefixList::Oor::PrefixListSummary::Details::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::Oor::PrefixListSummary::Details::get_children()
{
    return children;
}
...
Ipv6AclAndPrefixList::Oor::PrefixListSummary::PrefixListSummary()
    :
    details(std::make_unique<Ipv6AclAndPrefixList::Oor::PrefixListSummary::Details>())
{
    details->parent = this;
...
Entity* Ipv6AclAndPrefixList::Oor::PrefixListSummary::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::Oor::PrefixListSummary::get_children()
{
...
Entity* Ipv6AclAndPrefixList::Oor::OorAccesses::OorAccess::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::Oor::OorAccesses::OorAccess::get_children()
{
    return children;
}
...
Entity* Ipv6AclAndPrefixList::Oor::OorAccesses::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "oor-access")
    {
        ...
        auto c = std::make_unique<Ipv6AclAndPrefixList::Oor::OorAccesses::OorAccess>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::Oor::OorAccesses::get_children()
{
    for (auto const & c : oor_access)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Ipv6AclAndPrefixList::Oor::OorPrefixes::OorPrefix::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::Oor::OorPrefixes::OorPrefix::get_children()
{
    return children;
}
...
Entity* Ipv6AclAndPrefixList::Oor::OorPrefixes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "oor-prefix")
    {
        ...
        auto c = std::make_unique<Ipv6AclAndPrefixList::Oor::OorPrefixes::OorPrefix>();
        c->parent = this;
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::Oor::OorPrefixes::get_children()
{
    for (auto const & c : oor_prefix)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* Ipv6AclAndPrefixList::Oor::AccessListSummary::Details::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::Oor::AccessListSummary::Details::get_children()
{
    return children;
}
...
Ipv6AclAndPrefixList::Oor::AccessListSummary::AccessListSummary()
    :
    details(std::make_unique<Ipv6AclAndPrefixList::Oor::AccessListSummary::Details>())
{
    details->parent = this;
    children["details"] = details.get();
...
Entity* Ipv6AclAndPrefixList::Oor::AccessListSummary::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::Oor::AccessListSummary::get_children()
{
    if(children.find("details") == children.end())
    {
        if(details != nullptr)
...
Ipv6AclAndPrefixList::Oor::Oor()
    :
    access_list_summary(std::make_unique<Ipv6AclAndPrefixList::Oor::AccessListSummary>())
	,details(std::make_unique<Ipv6AclAndPrefixList::Oor::Details>())
	,oor_accesses(std::make_unique<Ipv6AclAndPrefixList::Oor::OorAccesses>())
	,oor_prefixes(std::make_unique<Ipv6AclAndPrefixList::Oor::OorPrefixes>())
	,prefix_list_summary(std::make_unique<Ipv6AclAndPrefixList::Oor::PrefixListSummary>())
{
...
Entity* Ipv6AclAndPrefixList::Oor::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & Ipv6AclAndPrefixList::Oor::get_children()
{
...
Ipv6AclAndPrefixList::Ipv6AclAndPrefixList()
    :
    access_list_manager(std::make_unique<Ipv6AclAndPrefixList::AccessListManager>())
	,oor(std::make_unique<Ipv6AclAndPrefixList::Oor>())
{
