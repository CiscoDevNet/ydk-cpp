...
LptsPifib::Nodes::Node::TypeValues::TypeValue::Entry::Utime::Utime()
    :
    	tv_nsec{YType::uint32, "tv-nsec"},
	 tv_sec{YType::uint32, "tv-sec"}
{
    yang_name = "utime"; yang_parent_name = "entry";
}
...
bool LptsPifib::Nodes::Node::TypeValues::TypeValue::Entry::Utime::has_data() const
{
    return tv_nsec.is_set
	|| tv_sec.is_set;
}

bool LptsPifib::Nodes::Node::TypeValues::TypeValue::Entry::Utime::has_operation() const
{
    return is_set(operation)
	|| is_set(tv_nsec.operation)
	|| is_set(tv_sec.operation);
}

std::string LptsPifib::Nodes::Node::TypeValues::TypeValue::Entry::Utime::get_segment_path() const
{
...
EntityPath LptsPifib::Nodes::Node::TypeValues::TypeValue::Entry::Utime::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
    ...
    if (tv_nsec.is_set || is_set(tv_nsec.operation)) leaf_name_data.push_back(tv_nsec.get_name_leafdata());
    if (tv_sec.is_set || is_set(tv_sec.operation)) leaf_name_data.push_back(tv_sec.get_name_leafdata());
...
Entity* LptsPifib::Nodes::Node::TypeValues::TypeValue::Entry::Utime::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::TypeValues::TypeValue::Entry::Utime::get_children()
{
    return children;
}

void LptsPifib::Nodes::Node::TypeValues::TypeValue::Entry::Utime::set_value(const std::string & value_path, std::string value)
{
...
LptsPifib::Nodes::Node::TypeValues::TypeValue::Entry::Entry()
    :
	 ...
	 deliver_list{YType::uint32, "deliver-list"},
	 deliver_list_str{YType::str, "deliver-list-str"},
	 ...
	 vid{YType::uint32, "vid"}
    	,
    utime(std::make_unique<LptsPifib::Nodes::Node::TypeValues::TypeValue::Entry::Utime>())
{
    utime->parent = this;
...
bool LptsPifib::Nodes::Node::TypeValues::TypeValue::Entry::has_operation() const
{
	...
	|| is_set(deliver_list.operation)
	|| is_set(deliver_list_str.operation)
...
{
    std::ostringstream path_buffer;
    path_buffer << "entry" <<"[entry='" <<entry.get() <<"']";
...
EntityPath LptsPifib::Nodes::Node::TypeValues::TypeValue::Entry::get_entity_path(Entity* ancestor) const
{
    ...
    if (deliver_list.is_set || is_set(deliver_list.operation)) leaf_name_data.push_back(deliver_list.get_name_leafdata());
    if (deliver_list_str.is_set || is_set(deliver_list_str.operation)) leaf_name_data.push_back(deliver_list_str.get_name_leafdata());
...
Entity* LptsPifib::Nodes::Node::TypeValues::TypeValue::Entry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::TypeValues::TypeValue::Entry::get_children()
{
...
void LptsPifib::Nodes::Node::TypeValues::TypeValue::Entry::set_value(const std::string & value_path, std::string value)
{
    ...
    if(value_path == "deliver-list")
    {
        deliver_list = value;
    }
    if(value_path == "deliver-list-str")
    {
        deliver_list_str = value;
    }
    if(value_path == "drops")
    {
        drops = value;
...
{
    std::ostringstream path_buffer;
    path_buffer << "type-value" <<"[pifib-type='" <<pifib_type.get() <<"']";
...
Entity* LptsPifib::Nodes::Node::TypeValues::TypeValue::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "entry")
    {
        ...
        auto c = std::make_unique<LptsPifib::Nodes::Node::TypeValues::TypeValue::Entry>();
        c->parent = this;
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::TypeValues::TypeValue::get_children()
{
    for (auto const & c : entry)
    {
...
Entity* LptsPifib::Nodes::Node::TypeValues::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "type-value")
    {
        ...
        auto c = std::make_unique<LptsPifib::Nodes::Node::TypeValues::TypeValue>();
        c->parent = this;
        type_value.push_back(std::move(c));
        children[segment_path] = type_value.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::TypeValues::get_children()
{
    for (auto const & c : type_value)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* LptsPifib::Nodes::Node::Hardware::UsageEntries::UsageEntry::UsageInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::Hardware::UsageEntries::UsageEntry::UsageInfo::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "usage-entry" <<"[region-id='" <<region_id.get() <<"']";
...
Entity* LptsPifib::Nodes::Node::Hardware::UsageEntries::UsageEntry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "usage-info")
    {
        ...
        auto c = std::make_unique<LptsPifib::Nodes::Node::Hardware::UsageEntries::UsageEntry::UsageInfo>();
        c->parent = this;
        usage_info.push_back(std::move(c));
        children[segment_path] = usage_info.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::Hardware::UsageEntries::UsageEntry::get_children()
{
    for (auto const & c : usage_info)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* LptsPifib::Nodes::Node::Hardware::UsageEntries::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "usage-entry")
    {
        ...
        auto c = std::make_unique<LptsPifib::Nodes::Node::Hardware::UsageEntries::UsageEntry>();
        c->parent = this;
        usage_entry.push_back(std::move(c));
        children[segment_path] = usage_entry.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::Hardware::UsageEntries::get_children()
{
    for (auto const & c : usage_entry)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* LptsPifib::Nodes::Node::Hardware::Police::PoliceInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::Hardware::Police::PoliceInfo::get_children()
{
    return children;
}
...
Entity* LptsPifib::Nodes::Node::Hardware::Police::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "police-info")
    {
        ...
        auto c = std::make_unique<LptsPifib::Nodes::Node::Hardware::Police::PoliceInfo>();
        c->parent = this;
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::Hardware::Police::get_children()
{
    for (auto const & c : police_info)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* LptsPifib::Nodes::Node::Hardware::StaticPolice::StaticInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::Hardware::StaticPolice::StaticInfo::get_children()
{
    return children;
}
...
Entity* LptsPifib::Nodes::Node::Hardware::StaticPolice::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "static-info")
    {
        ...
        auto c = std::make_unique<LptsPifib::Nodes::Node::Hardware::StaticPolice::StaticInfo>();
        c->parent = this;
        static_info.push_back(std::move(c));
        children[segment_path] = static_info.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::Hardware::StaticPolice::get_children()
{
    for (auto const & c : static_info)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* LptsPifib::Nodes::Node::Hardware::Bfd::BfdEntryInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::Hardware::Bfd::BfdEntryInfo::get_children()
{
    return children;
}
...
Entity* LptsPifib::Nodes::Node::Hardware::Bfd::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "bfd-entry-info")
    {
        ...
        auto c = std::make_unique<LptsPifib::Nodes::Node::Hardware::Bfd::BfdEntryInfo>();
        c->parent = this;
        bfd_entry_info.push_back(std::move(c));
        children[segment_path] = bfd_entry_info.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::Hardware::Bfd::get_children()
{
    for (auto const & c : bfd_entry_info)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* LptsPifib::Nodes::Node::Hardware::Statistics::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::Hardware::Statistics::get_children()
{
    return children;
}
...
Entity* LptsPifib::Nodes::Node::Hardware::IndexEntries::IndexEntry::HwInfo::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::Hardware::IndexEntries::IndexEntry::HwInfo::get_children()
{
    return children;
}
...
{
    std::ostringstream path_buffer;
    path_buffer << "index-entry" <<"[index='" <<index_.get() <<"']";
...
Entity* LptsPifib::Nodes::Node::Hardware::IndexEntries::IndexEntry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "hw-info")
    {
        ...
        auto c = std::make_unique<LptsPifib::Nodes::Node::Hardware::IndexEntries::IndexEntry::HwInfo>();
        c->parent = this;
        hw_info.push_back(std::move(c));
        children[segment_path] = hw_info.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::Hardware::IndexEntries::IndexEntry::get_children()
{
    for (auto const & c : hw_info)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
Entity* LptsPifib::Nodes::Node::Hardware::IndexEntries::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "index-entry")
    {
        ...
        auto c = std::make_unique<LptsPifib::Nodes::Node::Hardware::IndexEntries::IndexEntry>();
        c->parent = this;
        index_entry.push_back(std::move(c));
        children[segment_path] = index_entry.back().get();
        return children.at(segment_path);
    }
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::Hardware::IndexEntries::get_children()
{
    for (auto const & c : index_entry)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
LptsPifib::Nodes::Node::Hardware::Hardware()
    :
    bfd(std::make_unique<LptsPifib::Nodes::Node::Hardware::Bfd>())
	,index_entries(std::make_unique<LptsPifib::Nodes::Node::Hardware::IndexEntries>())
	,police(std::make_unique<LptsPifib::Nodes::Node::Hardware::Police>())
	,static_police(std::make_unique<LptsPifib::Nodes::Node::Hardware::StaticPolice>())
	,statistics(std::make_unique<LptsPifib::Nodes::Node::Hardware::Statistics>())
	,usage_entries(std::make_unique<LptsPifib::Nodes::Node::Hardware::UsageEntries>())
{
    bfd->parent = this;
    children["bfd"] = bfd.get();

    index_entries->parent = this;
    children["index-entries"] = index_entries.get();

    police->parent = this;
    children["police"] = police.get();

    static_police->parent = this;
    children["static-police"] = static_police.get();

    statistics->parent = this;
    children["statistics"] = statistics.get();

    usage_entries->parent = this;
    children["usage-entries"] = usage_entries.get();
...
Entity* LptsPifib::Nodes::Node::Hardware::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::Hardware::get_children()
{
...
LptsPifib::Nodes::Node::Node()
    :
    	...
    	,
    hardware(std::make_unique<LptsPifib::Nodes::Node::Hardware>())
	,type_values(std::make_unique<LptsPifib::Nodes::Node::TypeValues>())
{
    hardware->parent = this;
    children["hardware"] = hardware.get();

    type_values->parent = this;
    children["type-values"] = type_values.get();
...
Entity* LptsPifib::Nodes::Node::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & LptsPifib::Nodes::Node::get_children()
{
...
Entity* LptsPifib::Nodes::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
    ...
    if(child_yang_name == "node")
    {
        ...
        auto c = std::make_unique<LptsPifib::Nodes::Node>();
        c->parent = this;
...
std::map<std::string, Entity*> & LptsPifib::Nodes::get_children()
{
    for (auto const & c : node)
    {
        if(children.find(c->get_segment_path()) == children.end())
...
LptsPifib::LptsPifib()
    :
    nodes(std::make_unique<LptsPifib::Nodes>())
{
    nodes->parent = this;
...
Entity* LptsPifib::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(children.find(child_yang_name) != children.end())
    {
        return children.at(child_yang_name);
...
std::map<std::string, Entity*> & LptsPifib::get_children()
{
...
std::unique_ptr<Entity> LptsPifib::clone_ptr()
{
