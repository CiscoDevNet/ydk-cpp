...
class Policies::PolicyEntry::ClassifierEntry::ClassifierActionEntryCfg::MinRateCfg : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<ietf::ietf_diffserv_policy::Policies::PolicyEntry::ClassifierEntry::ClassifierActionEntryCfg::MinRateCfg::BwExcessShareCfg> bw_excess_share_cfg;
...
class Policies::PolicyEntry::ClassifierEntry::ClassifierActionEntryCfg::TailDropCfg::QlimitDscpThresh : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<ietf::ietf_diffserv_policy::Policies::PolicyEntry::ClassifierEntry::ClassifierActionEntryCfg::TailDropCfg::QlimitDscpThresh::Threshold> threshold;
