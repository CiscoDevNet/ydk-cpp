...
std::shared_ptr<Entity> System::clone_ptr() const
{
...
EntityPath System::Ntp::Server::Udp::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'Udp' in ietf_system cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
EntityPath System::DnsResolver::Server::UdpAndTcp::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'UdpAndTcp' in ietf_system cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    std::ostringstream path_buffer;
    path_buffer << "authorized-key" <<"[name='" <<name <<"']";
...
EntityPath System::Authentication::User::AuthorizedKey::get_entity_path(Entity* ancestor) const
{
    ...
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'AuthorizedKey' in ietf_system cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
std::shared_ptr<Entity> SystemState::clone_ptr() const
{
    return std::make_shared<SystemState>();
}

std::string SystemState::get_bundle_yang_models_location() const
{
    return ydk_ietf_models_path;
}

std::string SystemState::get_bundle_name() const
{
    return "ietf";
}

augment_capabilities_function SystemState::get_augment_capabilities_function() const
{
    return ietf_augment_lookup_tables;
}
...
{
    return std::make_shared<SetCurrentDatetimeRpc>();
}

std::string SetCurrentDatetimeRpc::get_bundle_yang_models_location() const
{
    return ydk_ietf_models_path;
}

std::string SetCurrentDatetimeRpc::get_bundle_name() const
{
    return "ietf";
}
...
std::shared_ptr<Entity> SystemRestartRpc::clone_ptr() const
{
    return std::make_shared<SystemRestartRpc>();
}

std::string SystemRestartRpc::get_bundle_yang_models_location() const
{
    return ydk_ietf_models_path;
}

std::string SystemRestartRpc::get_bundle_name() const
{
    return "ietf";
}

augment_capabilities_function SystemRestartRpc::get_augment_capabilities_function() const
{
    return ietf_augment_lookup_tables;
}
...
std::shared_ptr<Entity> SystemShutdownRpc::clone_ptr() const
{
    return std::make_shared<SystemShutdownRpc>();
}

std::string SystemShutdownRpc::get_bundle_yang_models_location() const
{
    return ydk_ietf_models_path;
}

std::string SystemShutdownRpc::get_bundle_name() const
{
    return "ietf";
}

augment_capabilities_function SystemShutdownRpc::get_augment_capabilities_function() const
{
    return ietf_augment_lookup_tables;
}
