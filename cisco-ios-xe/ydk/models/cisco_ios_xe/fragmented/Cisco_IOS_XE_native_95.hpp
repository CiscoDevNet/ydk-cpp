...
class Native::Router::Bgp::AddressFamily::NoVrf::Vpnv6::Snmp::Context::Context_Word : public ydk::Entity
{
    public:
        Context_Word();
        ~Context_Word();
...
class Native::Router::Bgp::AddressFamily::NoVrf::Nsap : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Router::Bgp::AddressFamily::NoVrf::Nsap::Import> import;
...
class Native::Router::Bgp::AddressFamily::NoVrf::Nsap::Import : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Router::Bgp::AddressFamily::NoVrf::Nsap::Import::Path> path;
...
class Native::Router::Bgp::AddressFamily::NoVrf::Nsap::Neighbor::PathAttribute::Discard::Attibute_Type : public ydk::Entity
{
    public:
        Attibute_Type();
        ~Attibute_Type();
...
class Native::Router::Bgp::AddressFamily::NoVrf::Nsap::Neighbor::PathAttribute::TreatAsWithdraw::Attibute_Type : public ydk::Entity
{
    public:
        Attibute_Type();
        ~Attibute_Type();
