...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::NonDisruptive::Port::InterfacePortNumber::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::NonDisruptive::Port::InterfacePortNumber::Daily::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::NonDisruptive::Port::InterfacePortNumber::On::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::NonDisruptive::Port::InterfacePortNumber::Weekly::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::NonDisruptive::Port::PortNumberList::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::NonDisruptive::Port::PortNumberList::Daily::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::NonDisruptive::Port::PortNumberList::On::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::NonDisruptive::Port::PortNumberList::Weekly::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::NonDisruptive::Port::All::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::NonDisruptive::Port::All::Daily::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::NonDisruptive::Port::All::On::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::NonDisruptive::Port::All::Weekly::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::Daily::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::On::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::Weekly::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::Port::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::Port::InterfacePortNumber::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::Port::InterfacePortNumber::Daily::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::Port::InterfacePortNumber::On::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::Port::InterfacePortNumber::Weekly::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::Port::PortNumberList::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::Port::PortNumberList::Daily::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::Port::PortNumberList::On::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::Port::PortNumberList::Weekly::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::Port::All::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::Port::All::Daily::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::Port::All::On::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Diagnostic::Schedule::Switch_::Test::PerPort::Port::All::Weekly::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
    ...
    config_maintenance_templ(std::make_shared<Native::MaintenanceTemplate::ConfigMaintenanceTempl>())
{
    ...
    yang_name = "maintenance-template"; yang_parent_name = "native";
}
...
const EntityPath Native::MaintenanceTemplate::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
	...
	,shutdown(std::make_shared<Native::MaintenanceTemplate::ConfigMaintenanceTempl::Shutdown>())
{
    ...
    yang_name = "config-maintenance-templ"; yang_parent_name = "maintenance-template";
}
...
const EntityPath Native::MaintenanceTemplate::ConfigMaintenanceTempl::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'ConfigMaintenanceTempl' in Cisco_IOS_XE_native cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    yang_name = "router"; yang_parent_name = "config-maintenance-templ";
}
...
const EntityPath Native::MaintenanceTemplate::ConfigMaintenanceTempl::Router::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "routing-protocol"; yang_parent_name = "router";
}
...
const EntityPath Native::MaintenanceTemplate::ConfigMaintenanceTempl::Router::RoutingProtocol::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'RoutingProtocol' in Cisco_IOS_XE_native cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
Native::MaintenanceTemplate::ConfigMaintenanceTempl::Shutdown::Shutdown()
    ...
    l2{YType::empty, "l2"}
{
    yang_name = "shutdown"; yang_parent_name = "config-maintenance-templ";
}
...
const EntityPath Native::MaintenanceTemplate::ConfigMaintenanceTempl::Shutdown::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
    ...
    prefix(std::make_shared<Native::Nat66::Prefix>())
{
    ...
    yang_name = "nat66"; yang_parent_name = "native";
}
...
const EntityPath Native::Nat66::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "prefix"; yang_parent_name = "nat66";
}
...
const EntityPath Native::Nat66::Prefix::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "inside"; yang_parent_name = "prefix";
}
...
const EntityPath Native::Nat66::Prefix::Inside::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::PmAgent::ConfigPmAgent::Device::Id::Device_Range::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::PmAgent::ConfigPmAgent::Device::Id::Device_Range::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "device_id_range")
    {
...
bool Native::PmAgent::ConfigPmAgent::Device::Id::Device_Range::has_leaf_or_child_of_name(const std::string & name) const
{
...
void Native::PmAgent::ConfigPmAgent::Region::Id::Region_Id_Range::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::PmAgent::ConfigPmAgent::Region::Id::Region_Id_Range::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "region_id_range")
    {
...
bool Native::PmAgent::ConfigPmAgent::Region::Id::Region_Id_Range::has_leaf_or_child_of_name(const std::string & name) const
{
...
void Native::PmAgent::ConfigPmAgent::Site::Id::Site_Id_Range::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::PmAgent::ConfigPmAgent::Site::Id::Site_Id_Range::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "site_id_range")
    {
...
bool Native::PmAgent::ConfigPmAgent::Site::Id::Site_Id_Range::has_leaf_or_child_of_name(const std::string & name) const
{
...
void Native::PmAgent::ConfigPmAgent::Tenant::Id::Tenant_Id_Range::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::PmAgent::ConfigPmAgent::Tenant::Id::Tenant_Id_Range::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "tenant_id_range")
    {
...
bool Native::PmAgent::ConfigPmAgent::Tenant::Id::Tenant_Id_Range::has_leaf_or_child_of_name(const std::string & name) const
{
...
void Native::PmAgent::ConfigPmAgent::Pmcs::Ipv4::Pmcs_Ipv4::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ipv4")
    {
        ipv4 = value;
...
void Native::PmAgent::ConfigPmAgent::Pmcs::Ipv4::Pmcs_Ipv4::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ipv4")
    {
...
bool Native::PmAgent::ConfigPmAgent::Pmcs::Ipv4::Pmcs_Ipv4::has_leaf_or_child_of_name(const std::string & name) const
{
...
void Native::PmAgent::ConfigPmAgent::Pmcs::Ipv4::Pmcs_Ipv4::Ipv6::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::PmAgent::ConfigPmAgent::Pmcs::Ipv4::Pmcs_Ipv4::Ipv6::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::PmAgent::ConfigPmAgent::Pmcs::Ipv4::Pmcs_Ipv4::Ipv6::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "pmcs_ipv6")
        return true;
    return false;
...
void Native::PmAgent::ConfigPmAgent::Pmcs::Ipv4::Pmcs_Ipv4::Ipv6::Pmcs_Ipv6::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ipv6")
    {
        ipv6 = value;
...
void Native::PmAgent::ConfigPmAgent::Pmcs::Ipv4::Pmcs_Ipv4::Ipv6::Pmcs_Ipv6::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ipv6")
    {
...
bool Native::PmAgent::ConfigPmAgent::Pmcs::Ipv4::Pmcs_Ipv4::Ipv6::Pmcs_Ipv6::has_leaf_or_child_of_name(const std::string & name) const
{
...
{
    yang_name = "named-ordering-route-map"; yang_parent_name = "native";
}
...
const EntityPath Native::NamedOrderingRouteMap::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Native::CiscoIosXeSwitch_Template::CiscoIosXeSwitch_Template()
    :
    ap_interface_template(std::make_shared<Native::CiscoIosXeSwitch_Template::Ap_Interface_Template>())
	,dmp_interface_template(std::make_shared<Native::CiscoIosXeSwitch_Template::Dmp_Interface_Template>())
	,ip_camera_interface_template(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template>())
	,ip_phone_interface_template(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Phone_Interface_Template>())
	,lap_interface_template(std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template>())
	,msp_camera_interface_template(std::make_shared<Native::CiscoIosXeSwitch_Template::Msp_Camera_Interface_Template>())
	,msp_vc_interface_template(std::make_shared<Native::CiscoIosXeSwitch_Template::Msp_Vc_Interface_Template>())
	,printer_interface_template(std::make_shared<Native::CiscoIosXeSwitch_Template::Printer_Interface_Template>())
	,router_interface_template(std::make_shared<Native::CiscoIosXeSwitch_Template::Router_Interface_Template>())
	,switch_interface_template(std::make_shared<Native::CiscoIosXeSwitch_Template::Switch_Interface_Template>())
	,tp_interface_template(std::make_shared<Native::CiscoIosXeSwitch_Template::Tp_Interface_Template>())
{
    ...
    yang_name = "Cisco-IOS-XE-switch_template"; yang_parent_name = "native";
}
...
bool Native::CiscoIosXeSwitch_Template::has_data() const
{
...
bool Native::CiscoIosXeSwitch_Template::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::CiscoIosXeSwitch_Template::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::CiscoIosXeSwitch_Template::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(ap_interface_template != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::CiscoIosXeSwitch_Template::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::CiscoIosXeSwitch_Template::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip_Camera_Interface_Template()
    :
    load_interval{YType::uint16, "load-interval"}
    	,
    ip(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip>())
	,service_policy(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy>())
	,spanning_tree(nullptr) // presence node
	,storm_control(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl>())
	,switchport(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport>())
{
    ip->parent = this;
    ...
    yang_name = "IP_CAMERA_INTERFACE_TEMPLATE"; yang_parent_name = "Cisco-IOS-XE-switch_template";
}
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::has_data() const
{
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "spanning-tree")
    {
        ...
        {
            spanning_tree = std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree>();
        }
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(ip != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "load-interval")
    {
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::ServicePolicy()
    :
    input(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Input>())
	,output(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Output>())
{
    input->parent = this;
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::has_data() const
{
    return (input !=  nullptr && input->has_data())
	|| (output !=  nullptr && output->has_data());
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(input != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Input::Input()
    :
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Input::has_data() const
{
    return policy_map_name.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Input::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_map_name.yfilter);
}

std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Input::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "input";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Input::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Input::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Input::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-map-name")
    {
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Input::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Output::Output()
    :
    policy_map_name{YType::str, "policy-map-name"}
{
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Output::has_data() const
{
    return policy_map_name.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Output::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_map_name.yfilter);
}

std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Output::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "output";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Output::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Output::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Output::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Output::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-map-name")
    {
        policy_map_name = value;
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Output::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-map-name")
    {
        policy_map_name.yfilter = yfilter;
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::ServicePolicy::Output::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-map-name")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Switchport()
    :
    nonegotiate{YType::empty, "nonegotiate"}
    	,
    access(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Access>())
	,block(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Block>())
	,mode(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Mode>())
	,port_security(nullptr) // presence node
	,voice(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Voice>())
{
    access->parent = this;
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::has_data() const
{
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "port-security")
    {
        ...
        {
            port_security = std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity>();
        }
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(access != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "nonegotiate")
    {
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Mode::Mode()
    :
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Mode::has_data() const
{
    return access.is_set
	|| trunk.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Mode::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Mode::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "mode";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Mode::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Mode::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Mode::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Mode::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Mode::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "access")
    {
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Mode::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Block::Block()
    :
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Block::has_data() const
{
    return unicast.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Block::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(unicast.yfilter);
}

std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Block::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "block";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Block::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Block::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Block::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Block::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Block::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "unicast")
    {
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Block::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "unicast")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::PortSecurity()
    :
    aging(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging>())
	,maximum(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum>())
	,violation(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Violation>())
{
    aging->parent = this;
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::has_data() const
{
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(aging != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::Aging()
    :
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::has_data() const
{
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "aging";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "type")
    {
        if(type == nullptr)
        {
            type = std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::Type>();
        }
        return type;
    }
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(type != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "static")
    {
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::Type::Type()
    :
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::Type::has_data() const
{
    return inactivity.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::Type::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(inactivity.yfilter);
}

std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::Type::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "type";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::Type::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::Type::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::Type::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::Type::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::Type::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "inactivity")
    {
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Aging::Type::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "inactivity")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Maximum()
{
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::has_data() const
{
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::has_operation() const
{
    for (std::size_t index=0; index<range.size(); index++)
    {
...
std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "maximum";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "range")
    {
        ...
        auto c = std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range>();
        c->parent = this;
        range.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    for (auto const & c : range)
    {
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "range")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::Range()
    :
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::has_data() const
{
    return range.is_set
	|| (vlan !=  nullptr && vlan->has_data());
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "vlan")
    {
        if(vlan == nullptr)
        {
            vlan = std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::Vlan>();
        }
        return vlan;
    }
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(vlan != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "range")
    {
        range = value;
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "range")
    {
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::Vlan::Vlan()
    :
    access{YType::empty, "access"}
{
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::Vlan::has_data() const
{
    return access.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::Vlan::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(access.yfilter);
}

std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::Vlan::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "vlan";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::Vlan::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::Vlan::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::Vlan::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::Vlan::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "access")
    {
        access = value;
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::Vlan::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "access")
    {
        access.yfilter = yfilter;
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Maximum::Range::Vlan::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "access")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Violation::Violation()
    :
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Violation::has_data() const
{
    return restrict.is_set
	|| shutdown.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Violation::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Violation::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Violation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Violation::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Violation::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Violation::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Violation::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "restrict")
    {
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::PortSecurity::Violation::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Access::Access()
    :
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Access::has_data() const
{
    return vlan.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Access::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(vlan.yfilter);
}

std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Access::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "access";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Access::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Access::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Access::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Access::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "vlan")
    {
        vlan = value;
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Access::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "vlan")
    {
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Access::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "vlan")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Voice::Voice()
    :
    vlan{YType::uint16, "vlan"}
{
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Voice::has_data() const
{
    return vlan.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Voice::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(vlan.yfilter);
}

std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Voice::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "voice";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Voice::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Voice::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Voice::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Voice::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "vlan")
    {
        vlan = value;
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Voice::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "vlan")
    {
        vlan.yfilter = yfilter;
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Switchport::Voice::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "vlan")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::SpanningTree()
    :
    service_policy{YType::empty, "service-policy"}
    	,
    bpduguard(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Bpduguard>())
	,portfast(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Portfast>())
{
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::has_data() const
{
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(bpduguard != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "service-policy")
    {
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Bpduguard::Bpduguard()
    :
    enable{YType::empty, "enable"}
{
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Bpduguard::has_data() const
{
    return enable.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Bpduguard::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(enable.yfilter);
}

std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Bpduguard::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Bpduguard::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Bpduguard::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Bpduguard::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Bpduguard::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "enable")
    {
        enable = value;
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Bpduguard::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "enable")
    {
        enable.yfilter = yfilter;
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Bpduguard::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "enable")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Portfast::Portfast()
    :
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Portfast::has_data() const
{
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Portfast::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Portfast::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Portfast::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Portfast::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Portfast::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Portfast::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Portfast::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "disable")
    {
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::SpanningTree::Portfast::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::StormControl()
    :
    action(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Action>())
	,broadcast(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast>())
{
    action->parent = this;
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::has_data() const
{
    return (action !=  nullptr && action->has_data())
	|| (broadcast !=  nullptr && broadcast->has_data());
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(action != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Broadcast()
    :
    level(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level>())
{
    level->parent = this;
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::has_data() const
{
    return (level !=  nullptr && level->has_data());
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::has_operation() const
{
    return is_set(yfilter)
	|| (level !=  nullptr && level->has_operation());
}

std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(level != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "level")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Level()
    :
    threshold{YType::str, "threshold"}
    	,
    bps(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Bps>())
	,pps(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Pps>())
{
    bps->parent = this;
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::has_data() const
{
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "level";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(bps != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "threshold")
    {
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Pps::Pps()
    :
    threshold{YType::str, "threshold"}
{
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Pps::has_data() const
{
    return threshold.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Pps::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(threshold.yfilter);
}

std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Pps::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "pps";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Pps::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Pps::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Pps::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Pps::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "threshold")
    {
        threshold = value;
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Pps::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "threshold")
    {
        threshold.yfilter = yfilter;
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Pps::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "threshold")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Bps::Bps()
    :
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Bps::has_data() const
{
    return b_unit.is_set
	|| threshold.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Bps::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Bps::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "bps";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Bps::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Bps::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Bps::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Bps::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Bps::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "b-unit")
    {
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Broadcast::Level::Bps::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Action::Action()
    :
    shutdown{YType::empty, "shutdown"},
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Action::has_data() const
{
    return shutdown.is_set
	|| trap.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Action::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(shutdown.yfilter)
...
std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Action::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "action";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Action::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Action::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Action::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Action::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "shutdown")
    {
        shutdown = value;
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Action::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "shutdown")
    {
        shutdown.yfilter = yfilter;
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::StormControl::Action::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Ip()
    :
    dhcp(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp>())
{
    dhcp->parent = this;
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::has_data() const
{
    return (dhcp !=  nullptr && dhcp->has_data());
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::has_operation() const
{
    return is_set(yfilter)
	|| (dhcp !=  nullptr && dhcp->has_operation());
}

std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "ip";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(dhcp != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "dhcp")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Dhcp()
    :
    snooping(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping>())
{
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::has_data() const
{
    return (snooping !=  nullptr && snooping->has_data());
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::has_operation() const
{
    return is_set(yfilter)
	|| (snooping !=  nullptr && snooping->has_operation());
}

std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "dhcp";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(snooping != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "snooping")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::Snooping()
    :
    limit(std::make_shared<Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::Limit>())
{
    limit->parent = this;
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::has_data() const
{
    return (limit !=  nullptr && limit->has_data());
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::has_operation() const
{
    return is_set(yfilter)
	|| (limit !=  nullptr && limit->has_operation());
}

std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(limit != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "limit")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::Limit::Limit()
    :
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::Limit::has_data() const
{
    return rate.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::Limit::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(rate.yfilter);
}

std::string Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::Limit::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "limit";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::Limit::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::Limit::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::Limit::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::Limit::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "rate")
    {
        rate = value;
...
void Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::Limit::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "rate")
    {
...
bool Native::CiscoIosXeSwitch_Template::Ip_Camera_Interface_Template::Ip::Dhcp::Snooping::Limit::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "rate")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Lap_Interface_Template()
    :
    load_interval{YType::uint16, "load-interval"}
    	,
    ip(std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Ip>())
	,service_policy(std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy>())
	,spanning_tree(nullptr) // presence node
	,storm_control(std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::StormControl>())
	,switchport(std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport>())
{
    ip->parent = this;
    ...
    yang_name = "LAP_INTERFACE_TEMPLATE"; yang_parent_name = "Cisco-IOS-XE-switch_template";
}
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::has_data() const
{
    return load_interval.is_set
	|| (ip !=  nullptr && ip->has_data())
	|| (service_policy !=  nullptr && service_policy->has_data())
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(load_interval.yfilter)
	|| (ip !=  nullptr && ip->has_operation())
...
std::string Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "ip")
    {
        if(ip == nullptr)
    ...
    if(child_yang_name == "spanning-tree")
    {
        if(spanning_tree == nullptr)
        {
            spanning_tree = std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::SpanningTree>();
        }
        return spanning_tree;
    }
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(ip != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "load-interval")
    {
        load_interval = value;
...
void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "load-interval")
    {
        load_interval.yfilter = yfilter;
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ip" || name == "service-policy" || name == "spanning-tree" || name == "storm-control" || name == "switchport" || name == "load-interval")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::ServicePolicy()
    :
    input(std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Input>())
	,output(std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Output>())
{
    input->parent = this;
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::has_data() const
{
    return (input !=  nullptr && input->has_data())
	|| (output !=  nullptr && output->has_data());
}

bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::has_operation() const
{
    return is_set(yfilter)
	|| (input !=  nullptr && input->has_operation())
	|| (output !=  nullptr && output->has_operation());
...
std::string Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "service-policy";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "input")
    {
        if(input == nullptr)
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(input != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "input" || name == "output")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Input::Input()
    :
    policy_map_name{YType::str, "policy-map-name"}
{
    yang_name = "input"; yang_parent_name = "service-policy";
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Input::has_data() const
{
    return policy_map_name.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Input::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_map_name.yfilter);
}

std::string Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Input::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "input";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Input::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Input::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Input::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Input::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-map-name")
    {
        policy_map_name = value;
...
void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Input::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-map-name")
    {
        policy_map_name.yfilter = yfilter;
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Input::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-map-name")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Output::Output()
    :
    policy_map_name{YType::str, "policy-map-name"}
{
    yang_name = "output"; yang_parent_name = "service-policy";
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Output::has_data() const
{
    return policy_map_name.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Output::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(policy_map_name.yfilter);
}

std::string Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Output::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "output";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Output::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Output::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Output::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Output::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "policy-map-name")
    {
        policy_map_name = value;
...
void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Output::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "policy-map-name")
    {
        policy_map_name.yfilter = yfilter;
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::ServicePolicy::Output::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "policy-map-name")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Switchport()
    :
    nonegotiate{YType::empty, "nonegotiate"}
    	,
    access(std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Access>())
	,block(std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Block>())
	,mode(std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Mode>())
	,port_security(nullptr) // presence node
	,voice(std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Voice>())
{
    access->parent = this;
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::has_data() const
{
    return nonegotiate.is_set
	|| (access !=  nullptr && access->has_data())
	|| (block !=  nullptr && block->has_data())
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(nonegotiate.yfilter)
	|| (access !=  nullptr && access->has_operation())
...
std::string Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "switchport";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "access")
    {
        if(access == nullptr)
    ...
    if(child_yang_name == "port-security")
    {
        if(port_security == nullptr)
        {
            port_security = std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity>();
        }
        return port_security;
    }
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(access != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "nonegotiate")
    {
        nonegotiate = value;
...
void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "nonegotiate")
    {
        nonegotiate.yfilter = yfilter;
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "access" || name == "block" || name == "mode" || name == "port-security" || name == "voice" || name == "nonegotiate")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Mode::Mode()
    :
    access{YType::empty, "access"},
    trunk{YType::empty, "trunk"}
{
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Mode::has_data() const
{
    return access.is_set
	|| trunk.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Mode::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(access.yfilter)
	|| ydk::is_set(trunk.yfilter);
...
std::string Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Mode::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "mode";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Mode::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Mode::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Mode::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Mode::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "access")
    {
        access = value;
...
void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Mode::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "access")
    {
        access.yfilter = yfilter;
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Mode::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "access" || name == "trunk")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Block::Block()
    :
    unicast{YType::empty, "unicast"}
{
    yang_name = "block"; yang_parent_name = "switchport";
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Block::has_data() const
{
    return unicast.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Block::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(unicast.yfilter);
}

std::string Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Block::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "block";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Block::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Block::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Block::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Block::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "unicast")
    {
        unicast = value;
...
void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Block::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "unicast")
    {
        unicast.yfilter = yfilter;
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::Block::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "unicast")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::PortSecurity()
    :
    aging(std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging>())
	,maximum(std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum>())
	,violation(std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Violation>())
{
    aging->parent = this;
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::has_data() const
{
    return (aging !=  nullptr && aging->has_data())
	|| (maximum !=  nullptr && maximum->has_data())
	|| (violation !=  nullptr && violation->has_data());
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::has_operation() const
{
    return is_set(yfilter)
	|| (aging !=  nullptr && aging->has_operation())
	|| (maximum !=  nullptr && maximum->has_operation())
...
std::string Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "port-security";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "aging")
    {
        if(aging == nullptr)
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(aging != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "aging" || name == "maximum" || name == "violation")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::Aging()
    :
    static_{YType::empty, "static"},
    time{YType::uint16, "time"}
    	,
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::has_data() const
{
    return static_.is_set
	|| time.is_set
	|| (type !=  nullptr && type->has_data());
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(static_.yfilter)
	|| ydk::is_set(time.yfilter)
...
std::string Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "aging";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "type")
    {
        if(type == nullptr)
        {
            type = std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::Type>();
        }
        return type;
    }
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(type != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "static")
    {
        static_ = value;
...
void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "static")
    {
        static_.yfilter = yfilter;
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "type" || name == "static" || name == "time")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::Type::Type()
    :
    inactivity{YType::empty, "inactivity"}
{
    yang_name = "type"; yang_parent_name = "aging";
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::Type::has_data() const
{
    return inactivity.is_set;
}

bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::Type::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(inactivity.yfilter);
}

std::string Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::Type::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "type";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::Type::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::Type::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::Type::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::Type::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "inactivity")
    {
        inactivity = value;
...
void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::Type::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "inactivity")
    {
        inactivity.yfilter = yfilter;
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Aging::Type::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "inactivity")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::Maximum()
{
    yang_name = "maximum"; yang_parent_name = "port-security";
}
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::has_data() const
{
    for (std::size_t index=0; index<range.size(); index++)
    {
        if(range[index]->has_data())
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::has_operation() const
{
    for (std::size_t index=0; index<range.size(); index++)
    {
        if(range[index]->has_operation())
...
std::string Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "maximum";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "range")
    {
        for(auto const & c : range)
        ...
        auto c = std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::Range>();
        c->parent = this;
        range.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    for (auto const & c : range)
    {
...
void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "range")
        return true;
    return false;
...
Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::Range::Range()
    :
    range{YType::uint16, "range"}
    	,
    vlan(nullptr) // presence node
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::Range::has_data() const
{
    return range.is_set
	|| (vlan !=  nullptr && vlan->has_data());
}

bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::Range::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(range.yfilter)
	|| (vlan !=  nullptr && vlan->has_operation());
...
std::string Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::Range::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "range" <<"[range='" <<range <<"']";
...
const EntityPath Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::Range::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::Range::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "vlan")
    {
        if(vlan == nullptr)
        {
            vlan = std::make_shared<Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::Range::Vlan>();
        }
        return vlan;
    }
...
std::map<std::string, std::shared_ptr<Entity>> Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::Range::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(vlan != nullptr)
    {
...
void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::Range::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "range")
    {
        range = value;
...
void Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::Range::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "range")
    {
        range.yfilter = yfilter;
...
bool Native::CiscoIosXeSwitch_Template::Lap_Interface_Template::Switchport::PortSecurity::Maximum::Range::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "vlan" || name == "range")
        return true;
    return false;
