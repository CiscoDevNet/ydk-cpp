...
void Native::Router::Bgp::AddressFamily::NoVrf::Ipv4::Neighbor::PathAttribute::Discard::Attibute_Type::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "in")
    {
        in = value;
...
void Native::Router::Bgp::AddressFamily::NoVrf::Ipv4::Neighbor::PathAttribute::Discard::Attibute_Type::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "in")
    {
        in.yfilter = yfilter;
...
bool Native::Router::Bgp::AddressFamily::NoVrf::Ipv4::Neighbor::PathAttribute::Discard::Attibute_Type::has_leaf_or_child_of_name(const std::string & name) const
{
...
void Native::Router::Bgp::AddressFamily::NoVrf::Ipv4::Neighbor::PathAttribute::TreatAsWithdraw::Attibute_Type::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "in")
    {
        in = value;
...
void Native::Router::Bgp::AddressFamily::NoVrf::Ipv4::Neighbor::PathAttribute::TreatAsWithdraw::Attibute_Type::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "in")
    {
        in.yfilter = yfilter;
...
bool Native::Router::Bgp::AddressFamily::NoVrf::Ipv4::Neighbor::PathAttribute::TreatAsWithdraw::Attibute_Type::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "in" || name == "type")
        return true;
    return false;
...
void Native::Router::Bgp::AddressFamily::NoVrf::Ipv4::Snmp::Context::Context_Word::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Router::Bgp::AddressFamily::NoVrf::Ipv4::Snmp::Context::Context_Word::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "context_word")
    {
...
bool Native::Router::Bgp::AddressFamily::NoVrf::Ipv4::Snmp::Context::Context_Word::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "context_word")
        return true;
    return false;
...
const EntityPath Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Import::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Import::Path::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
