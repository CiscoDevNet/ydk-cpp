...
{
    if(name == "group" || name == "authentication" || name == "authorization" || name == "accounting" || name == "server" || name == "login" || name == "memory" || name == "policy" || name == "route" || name == "new-model" || name == "session-id" || name == "max-sessions" || name == "password" || name == "traceback")
        return true;
    return false;
}
...
const Enum::YLeaf Native::Aaa::Authentication::Dot1X::Default::Group::tacacs__PLUS__ {1, "tacacs+"};
