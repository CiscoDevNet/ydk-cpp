...
const EntityPath Native::Interface::Gigabitethernet::Cts::RoleBased::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Gigabitethernet::Cts::RoleBased::SgtMap::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
