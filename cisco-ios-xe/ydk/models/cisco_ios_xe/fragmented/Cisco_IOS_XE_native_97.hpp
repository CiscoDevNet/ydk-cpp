...
class Native::Router::Bgp::AddressFamily::NoVrf::L2Vpn::Neighbor::PathAttribute::Discard::Attibute_Type : public ydk::Entity
{
    public:
        Attibute_Type();
        ~Attibute_Type();
...
class Native::Router::Bgp::AddressFamily::NoVrf::L2Vpn::Neighbor::PathAttribute::TreatAsWithdraw::Attibute_Type : public ydk::Entity
{
    public:
        Attibute_Type();
        ~Attibute_Type();
...
class Native::Router::Bgp::AddressFamily::NoVrf::L2Vpn::Snmp::Context::Context_Word : public ydk::Entity
{
    public:
        Context_Word();
        ~Context_Word();
...
class Native::Router::Bgp::AddressFamily::NoVrf::Rtfilter : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Router::Bgp::AddressFamily::NoVrf::Rtfilter::Import> import;
...
class Native::Router::Bgp::AddressFamily::NoVrf::Rtfilter::Import : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Router::Bgp::AddressFamily::NoVrf::Rtfilter::Import::Path> path;
