...
class Native::Interface::Tunnel::Ip::Rip : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Interface::Tunnel::Ip::Rip::Authentication> authentication;
...
class Native::Interface::Tunnel::Ip::Rip::Authentication : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Interface::Tunnel::Ip::Rip::Authentication::Mode> mode;
