...
Native::Interface::Tunnel::Ip::Ip()
    ...
    , no_address(std::make_shared<Native::Interface::Tunnel::Ip::NoAddress>())
...
std::vector<std::pair<std::string, LeafData> > Native::Interface::Tunnel::Ip::NoAddress::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Interface::Tunnel::Ip::NoAddress::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Interface::Tunnel::Ip::NoAddress::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
