...
const EntityPath Native::Interface::VirtualTemplate::Logging::Event::SpanningTree::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Logging::Event::SpanningTree::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Logging::Event::SubifLinkStatus::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Logging::Event::SubifLinkStatus::set_value(const std::string & value_path, std::string value)
{
...
{
    yang_name = "mdix"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::Mdix::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Mdix::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "auto")
    {
        auto_ = value;
...
{
    yang_name = "mop"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::Mop::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Mop::set_value(const std::string & value_path, std::string value)
{
...
Native::Interface::VirtualTemplate::Interface_Qos::Interface_Qos()
    :
    trust(std::make_shared<Native::Interface::VirtualTemplate::Interface_Qos::Trust>())
{
    trust->parent = this;

    yang_name = "interface_qos"; yang_parent_name = "Virtual-Template";
}
...
bool Native::Interface::VirtualTemplate::Interface_Qos::has_data() const
{
    return (trust !=  nullptr && trust->has_data());
}

bool Native::Interface::VirtualTemplate::Interface_Qos::has_operation() const
{
    return is_set(operation)
	|| (trust !=  nullptr && trust->has_operation());
}

std::string Native::Interface::VirtualTemplate::Interface_Qos::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::Interface::VirtualTemplate::Interface_Qos::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::VirtualTemplate::Interface_Qos::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::Interface::VirtualTemplate::Interface_Qos::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(trust != nullptr)
    {
...
void Native::Interface::VirtualTemplate::Interface_Qos::set_value(const std::string & value_path, std::string value)
{
}

Native::Interface::VirtualTemplate::Interface_Qos::Trust::Trust()
    :
...
bool Native::Interface::VirtualTemplate::Interface_Qos::Trust::has_data() const
{
    return device.is_set;
}

bool Native::Interface::VirtualTemplate::Interface_Qos::Trust::has_operation() const
{
    return is_set(operation)
	|| is_set(device.operation);
}

std::string Native::Interface::VirtualTemplate::Interface_Qos::Trust::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "trust";
...
const EntityPath Native::Interface::VirtualTemplate::Interface_Qos::Trust::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::VirtualTemplate::Interface_Qos::Trust::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::VirtualTemplate::Interface_Qos::Trust::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::VirtualTemplate::Interface_Qos::Trust::set_value(const std::string & value_path, std::string value)
{
	...
	,use_bia(nullptr) // presence node
{
    ...
    yang_name = "standby"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::Standby::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "bfd")
    {
        bfd = value;
...
const EntityPath Native::Interface::VirtualTemplate::Standby::Delay::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::Delay::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Standby::UseBia::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::UseBia::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Standby::UseBia::Scope::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::UseBia::Scope::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::Authentication::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::Authentication::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "text")
    {
        text = value;
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::Authentication::Md5::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::Authentication::Md5::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::Authentication::Md5::KeyString::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::Authentication::Md5::KeyString::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::Ip::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::Ip::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::Preempt::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::Preempt::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::Preempt::Delay::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::Preempt::Delay::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "minimum")
    {
        minimum = value;
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::Redirect::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::Redirect::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::Redirect::Advertisement::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::Redirect::Advertisement::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::Redirect::Advertisement::Authentication::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::Redirect::Advertisement::Authentication::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::Redirect::Advertisement::Authentication::Md5::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::Redirect::Advertisement::Authentication::Md5::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "key-chain")
    {
        key_chain = value;
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::Redirect::Advertisement::Authentication::Md5::KeyString::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::Redirect::Advertisement::Authentication::Md5::KeyString::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "encrypt")
    {
        encrypt = value;
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::Redirect::Timers::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::Redirect::Timers::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::Timers::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::Timers::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::Timers::HelloInterval::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::Timers::HelloInterval::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "msec")
    {
        msec = value;
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::Timers::HoldTime::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::Timers::HoldTime::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "msec")
    {
        msec = value;
...
const EntityPath Native::Interface::VirtualTemplate::Standby::StandbyList::Track::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Standby::StandbyList::Track::set_value(const std::string & value_path, std::string value)
{
    ...
    port_control(std::make_shared<Native::Interface::VirtualTemplate::AccessSession::PortControl>())
{
    ...
    yang_name = "access-session"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::AccessSession::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::AccessSession::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::AccessSession::PortControl::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::AccessSession::PortControl::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "auto")
    {
        auto_ = value;
	...
	,unicast(std::make_shared<Native::Interface::VirtualTemplate::StormControl::Unicast>())
{
    ...
    yang_name = "storm-control"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::StormControl::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::StormControl::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::StormControl::Action::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::StormControl::Action::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "level")
    {
        level = value;
...
const EntityPath Native::Interface::VirtualTemplate::StormControl::Broadcast::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::StormControl::Broadcast::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::StormControl::Broadcast::Include::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::StormControl::Broadcast::Include::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::StormControl::Broadcast::Level::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::StormControl::Broadcast::Level::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::StormControl::Broadcast::Level::Bps::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::StormControl::Broadcast::Level::Bps::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::StormControl::Broadcast::Level::Pps::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::StormControl::Broadcast::Level::Pps::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold = value;
...
const EntityPath Native::Interface::VirtualTemplate::StormControl::Multicast::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::StormControl::Multicast::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::StormControl::Multicast::Level::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::StormControl::Multicast::Level::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "threshold")
    {
        threshold = value;
...
const EntityPath Native::Interface::VirtualTemplate::StormControl::Multicast::Level::Bps::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::StormControl::Multicast::Level::Bps::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold = value;
...
const EntityPath Native::Interface::VirtualTemplate::StormControl::Multicast::Level::Pps::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::StormControl::Multicast::Level::Pps::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold = value;
...
const EntityPath Native::Interface::VirtualTemplate::StormControl::Unicast::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::StormControl::Unicast::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::StormControl::Unicast::Level::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::StormControl::Unicast::Level::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::StormControl::Unicast::Level::Threshold::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::StormControl::Unicast::Level::Threshold::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold = value;
...
const EntityPath Native::Interface::VirtualTemplate::StormControl::Unicast::Level::Bps::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::StormControl::Unicast::Level::Bps::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold = value;
...
const EntityPath Native::Interface::VirtualTemplate::StormControl::Unicast::Level::Pps::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::StormControl::Unicast::Level::Pps::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold = value;
...
Native::Interface::VirtualTemplate::Trust::Trust()
    ...
    device{YType::enumeration, "device"}
{
    yang_name = "trust"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::Trust::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Trust::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "device")
    {
        device = value;
...
{
    yang_name = "utd"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::Utd::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Utd::set_value(const std::string & value_path, std::string value)
{
    ...
    cos_map(std::make_shared<Native::Interface::VirtualTemplate::PriorityQueue::CosMap>())
{
    ...
    yang_name = "priority-queue"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::PriorityQueue::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::PriorityQueue::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "out")
    {
        out = value;
...
const EntityPath Native::Interface::VirtualTemplate::PriorityQueue::CosMap::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::PriorityQueue::CosMap::set_value(const std::string & value_path, std::string value)
{
...
{
    yang_name = "rcv-queue"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::RcvQueue::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::RcvQueue::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::RcvQueue::CosMap::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::RcvQueue::CosMap::set_value(const std::string & value_path, std::string value)
{
    ...
    default_(std::make_shared<Native::Interface::VirtualTemplate::Peer::Default_>())
{
    ...
    yang_name = "peer"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::Peer::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Peer::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Peer::Default_::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Peer::Default_::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Peer::Default_::Ip::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Peer::Default_::Ip::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Peer::Default_::Ip::Address::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Peer::Default_::Ip::Address::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "dhcp")
    {
        dhcp = value;
...
const EntityPath Native::Interface::VirtualTemplate::Peer::Default_::Ip::Address::DhcpPool::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Peer::Default_::Ip::Address::DhcpPool::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "pools")
    {
        pools = value;
...
const EntityPath Native::Interface::VirtualTemplate::Peer::Default_::Ip::Address::Pool::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Peer::Default_::Ip::Address::Pool::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "pools")
    {
        pools = value;
...
Native::Interface::VirtualTemplate::PmPath::PmPath()
    ...
    name{YType::str, "name"}
{
    yang_name = "pm-path"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::PmPath::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::PmPath::set_value(const std::string & value_path, std::string value)
{
	...
	,up(std::make_shared<Native::Interface::VirtualTemplate::CarrierDelay::Up>())
{
    ...
    yang_name = "carrier-delay"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::CarrierDelay::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::CarrierDelay::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "msec")
    {
        msec = value;
...
const EntityPath Native::Interface::VirtualTemplate::CarrierDelay::Down::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::CarrierDelay::Down::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "msec")
    {
        msec = value;
...
const EntityPath Native::Interface::VirtualTemplate::CarrierDelay::Up::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::CarrierDelay::Up::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "msec")
    {
        msec = value;
...
Native::Interface::VirtualTemplate::ChannelGroup::ChannelGroup()
    ...
    number{YType::uint16, "number"}
{
    yang_name = "channel-group"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::ChannelGroup::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::ChannelGroup::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "auto")
    {
        auto_ = value;
...
{
    yang_name = "ethernet"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "on")
    {
        on = value;
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::Frame::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::Frame::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::Frame::Threshold::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::Frame::Threshold::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "low")
    {
        low = value;
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::Frame::Threshold::High::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::Frame::Threshold::High::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "none")
    {
        none = value;
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::FramePeriod::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::FramePeriod::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "window")
    {
        window = value;
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::FramePeriod::Threshold::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::FramePeriod::Threshold::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "low")
    {
        low = value;
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::FramePeriod::Threshold::High::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::FramePeriod::Threshold::High::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::FrameSeconds::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::FrameSeconds::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "window")
    {
        window = value;
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::FrameSeconds::Threshold::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::FrameSeconds::Threshold::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "low")
    {
        low = value;
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::FrameSeconds::Threshold::High::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::FrameSeconds::Threshold::High::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::HighThreshold::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::HighThreshold::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::HighThreshold::Action::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::HighThreshold::Action::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::ReceiveCrc::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::ReceiveCrc::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "window")
    {
        window = value;
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::ReceiveCrc::Threshold::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::ReceiveCrc::Threshold::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "low")
    {
        low = value;
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::ReceiveCrc::Threshold::High::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::ReceiveCrc::Threshold::High::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::SymbolPeriod::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::SymbolPeriod::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "window")
    {
        window = value;
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::SymbolPeriod::Threshold::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::SymbolPeriod::Threshold::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "low")
    {
        low = value;
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::SymbolPeriod::Threshold::High::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::LinkMonitor::SymbolPeriod::Threshold::High::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::RemoteFailure::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::RemoteFailure::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::RemoteFailure::CriticalEvent::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::RemoteFailure::CriticalEvent::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::RemoteFailure::CriticalEvent::Action::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::RemoteFailure::CriticalEvent::Action::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "error-disable-interface")
    {
        error_disable_interface = value;
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::RemoteFailure::DyingGasp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::RemoteFailure::DyingGasp::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::RemoteFailure::DyingGasp::Action::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::RemoteFailure::DyingGasp::Action::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "error-disable-interface")
    {
        error_disable_interface = value;
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::RemoteFailure::LinkFault::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::RemoteFailure::LinkFault::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::RemoteFailure::LinkFault::Action::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::RemoteFailure::LinkFault::Action::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "error-disable-interface")
    {
        error_disable_interface = value;
...
const EntityPath Native::Interface::VirtualTemplate::Ethernet::Oam::RemoteLoopback::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Ethernet::Oam::RemoteLoopback::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "supported")
    {
        supported = value;
...
Native::Interface::VirtualTemplate::Negotiation::Negotiation()
    ...
    auto_{YType::boolean, "auto"}
{
    yang_name = "negotiation"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::Negotiation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Negotiation::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "auto")
    {
        auto_ = value;
...
{
    yang_name = "synchronous"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::Synchronous::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Synchronous::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "mode")
    {
        mode = value;
...
{
    yang_name = "speed"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::Speed::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Speed::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "auto")
    {
        auto_ = value;
	...
	,qos(std::make_shared<Native::Interface::VirtualTemplate::Plim::Qos>())
{
    ...
    yang_name = "plim"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::Plim::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Plim::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Plim::Ethernet::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Plim::Ethernet::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Plim::Ethernet::Vlan::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Plim::Ethernet::Vlan::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Plim::Ethernet::Vlan::Filter::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Plim::Ethernet::Vlan::Filter::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Plim::Qos::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Plim::Qos::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Plim::Qos::Input::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Plim::Qos::Input::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Plim::Qos::Input::Queue::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Plim::Qos::Input::Queue::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Plim::Qos::Input::Queue::Zero::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Plim::Qos::Input::Queue::Zero::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Plim::Qos::Input::Queue::Zero::Pause::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Plim::Qos::Input::Queue::Zero::Pause::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "enable")
    {
        enable = value;
...
const EntityPath Native::Interface::VirtualTemplate::Plim::Qos::Input::Queue::StrictPriority::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Plim::Qos::Input::Queue::StrictPriority::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Plim::Qos::Input::Queue::StrictPriority::Pause::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Plim::Qos::Input::Queue::StrictPriority::Pause::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "enable")
    {
        enable = value;
...
{
    yang_name = "pppoe"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::Pppoe::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Pppoe::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Pppoe::Enable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Pppoe::Enable::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "group")
    {
        group = value;
...
{
    yang_name = "service"; yang_parent_name = "Virtual-Template";
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "id")
    {
        id = value;
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Ad::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Ad::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "cos")
    {
        cos.append(value);
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Ad::Cos2::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Ad::Cos2::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "cos")
    {
        cos.append(value);
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Q::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Q::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "cos")
    {
        cos.append(value);
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Q::Cos2::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Q::Cos2::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "cos")
    {
        cos.append(value);
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::PriorityTagged::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::PriorityTagged::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "etype")
    {
        etype.append(value);
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::PriorityTagged::CosContainer::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::PriorityTagged::CosContainer::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "cos")
    {
        cos.append(value);
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Untagged::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Untagged::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Ip::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Ip::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Ip::Acl::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Ip::Acl::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Ip::Dhcp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Ip::Dhcp::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Ip::Dhcp::Relay::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Ip::Dhcp::Relay::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Ip::Dhcp::Relay::Information::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Ip::Dhcp::Relay::Information::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Ip::Dhcp::Relay::Information::Option::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Ip::Dhcp::Relay::Information::Option::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Ip::Verify::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Ip::Verify::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Ipv6::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Ipv6::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "in")
    {
        in = value;
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Rewrite::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Rewrite::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Pop::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Pop::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "mode")
    {
        mode = value;
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Push::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Push::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "dot1q")
    {
        dot1q = value;
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Translate::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Translate::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Translate::T1To1::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Translate::T1To1::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "dot1q")
    {
        dot1q = value;
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Translate::T1To2::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Translate::T1To2::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "dot1q")
    {
        dot1q = value;
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Translate::T2To1::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Translate::T2To1::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "dot1q")
    {
        dot1q = value;
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Translate::T2To2::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Translate::T2To2::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "dot1q")
    {
        dot1q = value;
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Errdisable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Errdisable::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Errdisable::Recovery::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Errdisable::Recovery::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Errdisable::Recovery::Cause::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Errdisable::Recovery::Cause::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::EthernetContainer::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::EthernetContainer::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::EthernetContainer::Ethernet::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::EthernetContainer::Ethernet::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::EthernetContainer::Ethernet::Lmi::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::EthernetContainer::Ethernet::Lmi::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::EthernetContainer::Ethernet::Lmi::CeVlan::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::EthernetContainer::Ethernet::Lmi::CeVlan::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::EthernetContainer::Ethernet::Lmi::CeVlan::Map::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::EthernetContainer::Ethernet::Lmi::CeVlan::Map::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "any")
    {
        any = value;
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::EthernetContainer::Ethernet::Lmi::CeVlan::Map::VlanRange::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::EthernetContainer::Ethernet::Lmi::CeVlan::Map::VlanRange::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "comma")
    {
        comma = value;
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::EthernetContainer::Ethernet::Loopback::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::EthernetContainer::Ethernet::Loopback::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::EthernetContainer::Ethernet::Loopback::Permit::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::EthernetContainer::Ethernet::Loopback::Permit::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Snmp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Snmp::set_value(const std::string & value_path, std::string value)
{
}
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Snmp::Trap::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Snmp::Trap::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::Snmp::Ifindex::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::Snmp::Ifindex::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::BridgeDomain::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::BridgeDomain::set_value(const std::string & value_path, std::string value)
{
...
const EntityPath Native::Interface::VirtualTemplate::Service::Instance::BridgeDomain::SplitHorizon::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::VirtualTemplate::Service::Instance::BridgeDomain::SplitHorizon::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "group")
    {
        group = value;
...
const Enum::YLeaf Native::Interface::VirtualTemplate::Interface_Qos::Trust::DeviceEnum::cisco_phone {0, "cisco-phone"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Standby::VersionEnum::Y_1 {0, "1"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Standby::VersionEnum::Y_2 {1, "2"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Standby::StandbyList::Ipv6Enum::autoconfig {0, "autoconfig"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Standby::StandbyList::Authentication::Md5::KeyString::EncryptEnum::Y_0 {0, "0"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Standby::StandbyList::Authentication::Md5::KeyString::EncryptEnum::Y_7 {1, "7"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Standby::StandbyList::Redirect::Advertisement::Authentication::Md5::KeyString::EncryptEnum::Y_0 {0, "0"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Standby::StandbyList::Redirect::Advertisement::Authentication::Md5::KeyString::EncryptEnum::Y_7 {1, "7"};

const Enum::YLeaf Native::Interface::VirtualTemplate::AccessSession::HostModeEnum::multi_auth {0, "multi-auth"};
const Enum::YLeaf Native::Interface::VirtualTemplate::AccessSession::HostModeEnum::multi_domain {1, "multi-domain"};
const Enum::YLeaf Native::Interface::VirtualTemplate::AccessSession::HostModeEnum::multi_host {2, "multi-host"};
const Enum::YLeaf Native::Interface::VirtualTemplate::AccessSession::HostModeEnum::single_host {3, "single-host"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Trust::DeviceEnum::cisco_phone {0, "cisco-phone"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Trust::DeviceEnum::cts {1, "cts"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Trust::DeviceEnum::ip_camera {2, "ip-camera"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Trust::DeviceEnum::media_player {3, "media-player"};

const Enum::YLeaf Native::Interface::VirtualTemplate::ChannelGroup::ModeEnum::active {0, "active"};
const Enum::YLeaf Native::Interface::VirtualTemplate::ChannelGroup::ModeEnum::auto_ {1, "auto"};
const Enum::YLeaf Native::Interface::VirtualTemplate::ChannelGroup::ModeEnum::desirable {2, "desirable"};
const Enum::YLeaf Native::Interface::VirtualTemplate::ChannelGroup::ModeEnum::on {3, "on"};
const Enum::YLeaf Native::Interface::VirtualTemplate::ChannelGroup::ModeEnum::passive {4, "passive"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Ethernet::Oam::ModeEnum::active {0, "active"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Ethernet::Oam::ModeEnum::passive {1, "passive"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Pppoe::Enable::GroupEnum::global {0, "global"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Ad::IdEnum::any {0, "any"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Ad::Dot1QEnum::any {0, "any"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Ad::EtypeEnum::ipv4 {0, "ipv4"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Ad::EtypeEnum::ipv6 {1, "ipv6"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Ad::EtypeEnum::pppoe_all {2, "pppoe-all"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Ad::EtypeEnum::pppoe_discovery {3, "pppoe-discovery"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Ad::EtypeEnum::pppoe_session {4, "pppoe-session"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Q::IdEnum::any {0, "any"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Q::SecondDot1QEnum::any {0, "any"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Q::EtypeEnum::ipv4 {0, "ipv4"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Q::EtypeEnum::ipv6 {1, "ipv6"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Q::EtypeEnum::pppoe_all {2, "pppoe-all"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Q::EtypeEnum::pppoe_discovery {3, "pppoe-discovery"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Q::EtypeEnum::pppoe_session {4, "pppoe-session"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Q::VlanTypeEnum::Y_0x88A8 {0, "0x88A8"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Q::VlanTypeEnum::Y_0x9100 {1, "0x9100"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::Dot1Q::VlanTypeEnum::Y_0x9200 {2, "0x9200"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::PriorityTagged::EtypeEnum::ipv4 {0, "ipv4"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::PriorityTagged::EtypeEnum::ipv6 {1, "ipv6"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::PriorityTagged::EtypeEnum::pppoe_all {2, "pppoe-all"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::PriorityTagged::EtypeEnum::pppoe_discovery {3, "pppoe-discovery"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Encapsulation::PriorityTagged::EtypeEnum::pppoe_session {4, "pppoe-session"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Pop::WayEnum::Y_1 {0, "1"};
const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Pop::WayEnum::Y_2 {1, "2"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Pop::ModeEnum::symmetric {0, "symmetric"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Push::ModeEnum::symmetric {0, "symmetric"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Translate::T1To1::ModeEnum::symmetric {0, "symmetric"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Translate::T1To2::ModeEnum::symmetric {0, "symmetric"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Translate::T2To1::ModeEnum::symmetric {0, "symmetric"};

const Enum::YLeaf Native::Interface::VirtualTemplate::Service::Instance::Rewrite::Ingress::Tag::Translate::T2To2::ModeEnum::symmetric {0, "symmetric"};
