...
{
    if(name == "ipbase" || name == "ipservices" || name == "ipservicesk9" || name == "lanbase" || name == "lite" || name == "metroaggrservices" || name == "uck9" || name == "ipbasek9" || name == "lanbasek9" || name == "advancedmetroipaccess" || name == "metroaccess" || name == "metroipaccess" || name == "entservices" || name == "adventerprise" || name == "appx" || name == "appxk9" || name == "securityk9")
        return true;
    return false;
}
