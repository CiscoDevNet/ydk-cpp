...
class Native::Router::Bgp::AddressFamily::NoVrf::Vpnv4::Snmp::Context::Context_Word : public ydk::Entity
{
    public:
        Context_Word();
        ~Context_Word();
...
class Native::Router::Bgp::AddressFamily::NoVrf::Vpnv6 : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Router::Bgp::AddressFamily::NoVrf::Vpnv6::Import> import;
...
class Native::Router::Bgp::AddressFamily::NoVrf::Vpnv6::Import : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Router::Bgp::AddressFamily::NoVrf::Vpnv6::Import::Path> path;
...
class Native::Router::Bgp::AddressFamily::NoVrf::Vpnv6::Neighbor::PathAttribute::Discard::Attibute_Type : public ydk::Entity
{
    public:
        Attibute_Type();
        ~Attibute_Type();
...
class Native::Router::Bgp::AddressFamily::NoVrf::Vpnv6::Neighbor::PathAttribute::TreatAsWithdraw::Attibute_Type : public ydk::Entity
{
    public:
        Attibute_Type();
        ~Attibute_Type();
