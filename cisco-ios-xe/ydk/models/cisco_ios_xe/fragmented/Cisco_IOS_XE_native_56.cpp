...
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XE-vlan:Cisco-IOS-XE-interfaces_hold-queue";
...
void Native::Interface::Vlan::ZoneMember::set_value(const std::string & value_path, std::string value)
{
...
Native::Interface::GroupAsync::GroupAsync()
	...
	,hold_queue(std::make_shared<Native::Interface::GroupAsync::HoldQueue>())
...
bool Native::Interface::GroupAsync::has_operation() const
{
	...
	|| is_set(mtu.operation)
	|| is_set(physical_layer.operation)
...
const EntityPath Native::Interface::GroupAsync::get_entity_path(Entity* ancestor) const
{
    ...
    if (mtu.is_set || is_set(mtu.operation)) leaf_name_data.push_back(mtu.get_name_leafdata());
    if (physical_layer.is_set || is_set(physical_layer.operation)) leaf_name_data.push_back(physical_layer.get_name_leafdata());
...
void Native::Interface::GroupAsync::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "name")
    {
        name = value;
...
void Native::Interface::GroupAsync::SwitchportConf::set_value(const std::string & value_path, std::string value)
{
...
void Native::Interface::GroupAsync::Switchport::set_value(const std::string & value_path, std::string value)
{
}
...
void Native::Interface::GroupAsync::Arp::set_value(const std::string & value_path, std::string value)
{
    if(value_path == "timeout")
    {
        timeout = value;
...
void Native::Interface::GroupAsync::Backup::set_value(const std::string & value_path, std::string value)
{
}

const Enum::YLeaf Native::Interface::GroupAsync::PhysicalLayerEnum::async {0, "async"};
const Enum::YLeaf Native::Interface::GroupAsync::PhysicalLayerEnum::sync {1, "sync"};

const Enum::YLeaf Native::Interface::GroupAsync::IfStateEnum::nhrp {0, "nhrp"};

const Enum::YLeaf Native::Interface::GroupAsync::ServiceInsertionEnum::waas {0, "waas"};
