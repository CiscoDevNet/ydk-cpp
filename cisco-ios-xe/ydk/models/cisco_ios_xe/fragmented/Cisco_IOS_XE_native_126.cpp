...
Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Default::Default()
    :
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Default::has_data() const
{
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Default::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Default::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "default";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Default::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Default::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Default::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Default::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Default::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ipv4-unicast")
    {
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Default::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::Listen()
    :
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::has_data() const
{
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::has_operation() const
{
    for (std::size_t index=0; index<range.size(); index++)
    {
...
std::string Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "listen";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "range")
    {
        auto c = std::make_shared<Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::Range>();
        c->parent = this;
        range.push_back(c);
        return c;
    }
...
std::map<std::string, std::shared_ptr<Entity>> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    count = 0;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "limit")
    {
        limit = value;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "limit")
    {
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::Range::Range()
    :
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::Range::has_data() const
{
    return network_range.is_set
	|| peer_group.is_set;
}

bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::Range::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::Range::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::Range::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::Range::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::Range::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::Range::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::Range::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "network-range")
    {
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen::Range::has_leaf_or_child_of_name(const std::string & name) const
{
...
std::shared_ptr<Entity> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Neighbor::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "next-hop-self")
    {
        ...
        {
            next_hop_self = std::make_shared<Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Neighbor::NextHopSelf>();
        }
    ...
    if(child_yang_name == "remove-private-as")
    {
        ...
        {
            remove_private_as = std::make_shared<Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Neighbor::RemovePrivateAs>();
        }
...
const Enum::YLeaf Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Bestpath::AsPath::ignore {0, "ignore"};

const Enum::YLeaf Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Default::RouteTarget::filter {0, "filter"};
