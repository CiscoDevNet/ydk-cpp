...
class Native::Router::LispList::Default_::InstanceContainer::InstanceList::Service::Ethernet::Default__::DatabaseMapping : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Router::LispList::Default_::InstanceContainer::InstanceList::Service::Ethernet::Default__::DatabaseMapping::Mac> mac; // presence node
