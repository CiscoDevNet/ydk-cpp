...
{
    yang_name = "locator"; yang_parent_name = "default";
}
...
const EntityPath Native::Router::Lisp::Default_::Locator::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Router::Lisp::Default_::InstanceContainer::InstanceList::Default__::DynamicEid::EidNotify::GatewayKey::Key::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Router::Lisp::Default_::InstanceContainer::InstanceList::Default__::DynamicEid::EidNotify::GatewayKey::Key::KeyPwd::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Router::Lisp::Default_::InstanceContainer::InstanceList::Default__::DynamicEid::EidNotify::GatewayKey::Key::Key0::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Router::Lisp::Default_::InstanceContainer::InstanceList::Default__::DynamicEid::EidNotify::GatewayKey::Key::Key6::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Router::Lisp::Default_::InstanceContainer::InstanceList::Default__::DynamicEid::MapServer::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Router::Lisp::Default_::InstanceContainer::InstanceList::Default__::DynamicEid::MapServer::Key::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Router::Lisp::Default_::InstanceContainer::InstanceList::Default__::DynamicEid::MapServer::Key::KeyPwd::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
