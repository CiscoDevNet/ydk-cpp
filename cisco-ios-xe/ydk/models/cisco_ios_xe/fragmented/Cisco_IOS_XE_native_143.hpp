...
class Native::Router::LispList::Default_::InstanceContainer::InstanceList::Default__::Service::Ethernet::Default__::DatabaseMapping : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Router::LispList::Default_::InstanceContainer::InstanceList::Default__::Service::Ethernet::Default__::DatabaseMapping::Mac> mac; // presence node
...
class Native::Router::LispList::Default_::InstanceContainer::InstanceList::Default__::Service::Ethernet::DatabaseMapping : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Router::LispList::Default_::InstanceContainer::InstanceList::Default__::Service::Ethernet::DatabaseMapping::Mac> mac; // presence node
