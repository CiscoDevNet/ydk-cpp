...
class Native::Router::Ospf::FastReroute::PerPrefix::RemoteLfa : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Router::Ospf::FastReroute::PerPrefix::RemoteLfa::AreaCost> area_cost;
        std::shared_ptr<Cisco_IOS_XE_native::Native::Router::Ospf::FastReroute::PerPrefix::RemoteLfa::AreaTunnel> area_tunnel;
                class Tunnel;
...
class Native::Router::Ospf::Mpls::TrafficEng : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<Cisco_IOS_XE_native::Native::Router::Ospf::Mpls::TrafficEng::Area> > area;
        std::shared_ptr<Cisco_IOS_XE_native::Native::Router::Ospf::Mpls::TrafficEng::AutorouteExclude> autoroute_exclude;
        std::vector<std::shared_ptr<Cisco_IOS_XE_native::Native::Router::Ospf::Mpls::TrafficEng::Interface> > interface;
        std::vector<std::shared_ptr<Cisco_IOS_XE_native::Native::Router::Ospf::Mpls::TrafficEng::MeshGroup> > mesh_group;
...
class Native::Router::Ospf::Mpls::TrafficEng::RouterId : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Router::Ospf::Mpls::TrafficEng::RouterId::AtmAcrsubinterface> atm_acrsubinterface;
        std::shared_ptr<Cisco_IOS_XE_native::Native::Router::Ospf::Mpls::TrafficEng::RouterId::AtmSubinterface> atm_subinterface;
        std::shared_ptr<Cisco_IOS_XE_native::Native::Router::Ospf::Mpls::TrafficEng::RouterId::LispSubinterface> lisp_subinterface;
        std::shared_ptr<Cisco_IOS_XE_native::Native::Router::Ospf::Mpls::TrafficEng::RouterId::PortChannelSubinterface> port_channel_subinterface;
