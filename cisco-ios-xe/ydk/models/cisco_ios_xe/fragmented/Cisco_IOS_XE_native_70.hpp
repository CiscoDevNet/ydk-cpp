...
class Native::Interface::Virtualportgroup::Ipv6 : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Interface::Virtualportgroup::Ipv6::Tcp> tcp;
...
class Native::Interface::Virtualportgroup::Interface_Qos : public ydk::Entity
{
    public:
        Interface_Qos();
        ~Interface_Qos();
...
class Native::Interface::Virtualportgroup::Interface_Qos::Trust : public ydk::Entity
{
    public:
        Trust();
        ~Trust();
...
class Native::Interface::Virtualportgroup::Interface_Qos::Trust::Device : public ydk::Enum
{
    public:
