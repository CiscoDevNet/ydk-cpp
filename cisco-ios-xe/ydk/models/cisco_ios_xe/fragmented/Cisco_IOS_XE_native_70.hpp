...
class Native::Interface::SM::Peer : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::SM::Peer::Default_> default_;
        
}; // Native::Interface::SM::Peer


class Native::Interface::SM::Peer::Default_ : public ydk::Entity
{
    public:
        Default_();
        ~Default_();
        ...
        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::SM::Peer::Default_::Ip> ip;
        
}; // Native::Interface::SM::Peer::Default_


class Native::Interface::SM::Peer::Default_::Ip : public ydk::Entity
{
    public:
        Ip();
        ~Ip();
        ...
        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::SM::Peer::Default_::Ip::Address> address;
        
}; // Native::Interface::SM::Peer::Default_::Ip


class Native::Interface::SM::Peer::Default_::Ip::Address : public ydk::Entity
{
    public:
        Address();
        ~Address();
        ...
        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::SM::Peer::Default_::Ip::Address::DhcpPool> dhcp_pool; // presence node
        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::SM::Peer::Default_::Ip::Address::Pool> pool; // presence node
        
}; // Native::Interface::SM::Peer::Default_::Ip::Address


class Native::Interface::SM::Peer::Default_::Ip::Address::DhcpPool : public ydk::Entity
{
    public:
        DhcpPool();
        ~DhcpPool();
...
class Native::Interface::SM::Peer::Default_::Ip::Address::Pool : public ydk::Entity
{
    public:
        Pool();
        ~Pool();
