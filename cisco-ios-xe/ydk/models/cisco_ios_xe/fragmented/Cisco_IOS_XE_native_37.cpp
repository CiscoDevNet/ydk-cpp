...
const Enum::YLeaf Native::Interface::Fortygigabitethernet::Switchport::Access::Vlan::Vlan::dynamic {0, "dynamic"};
...
const Enum::YLeaf Native::Interface::Fortygigabitethernet::Switchport::Voice::Vlan::Vlan::dot1p {0, "dot1p"};
const Enum::YLeaf Native::Interface::Fortygigabitethernet::Switchport::Voice::Vlan::Vlan::none {1, "none"};
const Enum::YLeaf Native::Interface::Fortygigabitethernet::Switchport::Voice::Vlan::Vlan::untagged {2, "untagged"};
