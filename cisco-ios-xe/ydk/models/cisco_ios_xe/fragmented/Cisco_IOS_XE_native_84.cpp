...
Native::Interface::Overlay::Source::Source()
    :
    template_(std::make_shared<Native::Interface::Overlay::Source::Template>())
{
    template_->parent = this;

    yang_name = "source"; yang_parent_name = "overlay"; is_top_level_class = false; has_list_ancestor = true; 
}
...
bool Native::Interface::Overlay::Source::has_data() const
{
    if (is_presence_container) return true;
    return (template_ !=  nullptr && template_->has_data());
}

bool Native::Interface::Overlay::Source::has_operation() const
{
    return is_set(yfilter)
	|| (template_ !=  nullptr && template_->has_operation());
}

std::string Native::Interface::Overlay::Source::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XE-otv:source";
    return path_buffer.str();
}

std::vector<std::pair<std::string, LeafData> > Native::Interface::Overlay::Source::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
void Native::Interface::Overlay::Source::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Interface::Overlay::Source::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "template")
        return true;
    return false;
...
Native::Interface::Overlay::Source::Template::Template()
    :
...
bool Native::Interface::Overlay::Source::Template::has_data() const
{
    if (is_presence_container) return true;
...
bool Native::Interface::Overlay::Source::Template::has_operation() const
{
    for (std::size_t index=0; index<template_name.len(); index++)
    {
...
std::string Native::Interface::Overlay::Source::Template::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Interface::Overlay::Source::Template::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
void Native::Interface::Overlay::Source::Template::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Interface::Overlay::Source::Template::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Interface::Overlay::Source::Template::TemplateName::TemplateName()
    :
...
bool Native::Interface::Overlay::Source::Template::TemplateName::has_data() const
{
    if (is_presence_container) return true;
...
bool Native::Interface::Overlay::Source::Template::TemplateName::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Interface::Overlay::Source::Template::TemplateName::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Interface::Overlay::Source::Template::TemplateName::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
void Native::Interface::Overlay::Source::Template::TemplateName::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "template-name")
    {
...
bool Native::Interface::Overlay::Source::Template::TemplateName::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Interface::Overlay::AccessSession::AccessSession()
    ...
    , control_direction(std::make_shared<Native::Interface::Overlay::AccessSession::ControlDirection>())
{
...
Native::Interface::Overlay::AccessSession::ControlDirection::ControlDirection()
    :
    in{YType::empty, "in"}
{
...
bool Native::Interface::Overlay::AccessSession::ControlDirection::has_data() const
{
    if (is_presence_container) return true;
    return in.is_set;
}

bool Native::Interface::Overlay::AccessSession::ControlDirection::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(in.yfilter);
}

std::string Native::Interface::Overlay::AccessSession::ControlDirection::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Interface::Overlay::AccessSession::ControlDirection::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
void Native::Interface::Overlay::AccessSession::ControlDirection::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "in")
    {
        in.yfilter = yfilter;
...
bool Native::Interface::Overlay::AccessSession::ControlDirection::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "in")
        return true;
    return false;
...
Native::Interface::Overlay::StormControl::Multicast::Level::Level()
    :
    threshold(std::make_shared<Native::Interface::Overlay::StormControl::Multicast::Level::Threshold>())
...
Native::Interface::Overlay::StormControl::Multicast::Level::Threshold::Threshold()
    :
    rising_threshold{YType::str, "rising-threshold"},
    falling_threshold{YType::str, "falling-threshold"}
{
...
bool Native::Interface::Overlay::StormControl::Multicast::Level::Threshold::has_data() const
{
    if (is_presence_container) return true;
    return rising_threshold.is_set
	|| falling_threshold.is_set;
...
bool Native::Interface::Overlay::StormControl::Multicast::Level::Threshold::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(rising_threshold.yfilter)
	|| ydk::is_set(falling_threshold.yfilter);
...
std::string Native::Interface::Overlay::StormControl::Multicast::Level::Threshold::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "threshold";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Interface::Overlay::StormControl::Multicast::Level::Threshold::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
void Native::Interface::Overlay::StormControl::Multicast::Level::Threshold::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "rising-threshold")
    {
        rising_threshold.yfilter = yfilter;
...
bool Native::Interface::Overlay::StormControl::Multicast::Level::Threshold::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "rising-threshold" || name == "falling-threshold")
        return true;
    return false;
...
Native::Interface::Overlay::Ethernet::Ethernet()
    ...
    , dot1ad(std::make_shared<Native::Interface::Overlay::Ethernet::Dot1ad>())
{
    dot1ad->parent = this;
...
Native::Interface::Overlay::Ethernet::Dot1ad::Dot1ad()
    :
    nni{YType::empty, "nni"}
        ,
    uni(std::make_shared<Native::Interface::Overlay::Ethernet::Dot1ad::Uni>())
{
    uni->parent = this;
...
bool Native::Interface::Overlay::Ethernet::Dot1ad::has_data() const
{
    if (is_presence_container) return true;
    return nni.is_set
...
bool Native::Interface::Overlay::Ethernet::Dot1ad::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Interface::Overlay::Ethernet::Dot1ad::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "dot1ad";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Interface::Overlay::Ethernet::Dot1ad::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
void Native::Interface::Overlay::Ethernet::Dot1ad::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "nni")
    {
        nni.yfilter = yfilter;
...
bool Native::Interface::Overlay::Ethernet::Dot1ad::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Interface::Overlay::Ethernet::Dot1ad::Uni::Uni()
    :
...
bool Native::Interface::Overlay::Ethernet::Dot1ad::Uni::has_data() const
{
    if (is_presence_container) return true;
...
bool Native::Interface::Overlay::Ethernet::Dot1ad::Uni::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Interface::Overlay::Ethernet::Dot1ad::Uni::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "uni";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Interface::Overlay::Ethernet::Dot1ad::Uni::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
void Native::Interface::Overlay::Ethernet::Dot1ad::Uni::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "c-port")
    {
...
bool Native::Interface::Overlay::Ethernet::Dot1ad::Uni::has_leaf_or_child_of_name(const std::string & name) const
{
