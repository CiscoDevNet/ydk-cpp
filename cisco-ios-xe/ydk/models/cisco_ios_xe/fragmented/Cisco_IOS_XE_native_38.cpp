...
const EntityPath Native::Interface::Fortygigabitethernet::Ip::Pim::AcceptRegister::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fortygigabitethernet::Ip::Pim::QueryInterval::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fortygigabitethernet::Ip::Rip::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fortygigabitethernet::Ip::Rip::Authentication::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fortygigabitethernet::Ip::Rip::Authentication::Mode::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    if(name == "address" || name == "destination-guard" || name == "dhcp" || name == "nd" || name == "no-pim" || name == "pim" || name == "tcp" || name == "traffic-filter" || name == "enable" || name == "mtu" || name == "redirects" || name == "unnumbered")
        return true;
    return false;
}
...
const EntityPath Native::Interface::Fortygigabitethernet::Ipv6::Tcp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fortygigabitethernet::Ipv6::NoPim::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fortygigabitethernet::Ipv6::Pim::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fortygigabitethernet::Ipv6::Pim::Bsr::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
void Native::Interface::Fortygigabitethernet::Interface_Qos::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Interface::Fortygigabitethernet::Interface_Qos::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Interface::Fortygigabitethernet::Interface_Qos::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "trust")
        return true;
    return false;
...
void Native::Interface::Fortygigabitethernet::Interface_Qos::Trust::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Interface::Fortygigabitethernet::Interface_Qos::Trust::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "device")
    {
...
bool Native::Interface::Fortygigabitethernet::Interface_Qos::Trust::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "device")
        return true;
    return false;
...
const Enum::YLeaf Native::Interface::Fortygigabitethernet::Ip::Pim::SparseMode::sparse_dense_mode {0, "sparse-dense-mode"};
const Enum::YLeaf Native::Interface::Fortygigabitethernet::Ip::Pim::SparseMode::sparse_mode {1, "sparse-mode"};
...
const Enum::YLeaf Native::Interface::Fortygigabitethernet::Interface_Qos::Trust::Device::cisco_phone {0, "cisco-phone"};
