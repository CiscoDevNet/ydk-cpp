...
Native::Router::Ospf::FastReroute::PerPrefix::RemoteLfa::AreaCost::AreaCost()
    ...
    maximum_cost{YType::uint32, "maximum-cost"}
{
    yang_name = "area-cost"; yang_parent_name = "remote-lfa";
}
...
const EntityPath Native::Router::Ospf::FastReroute::PerPrefix::RemoteLfa::AreaCost::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'AreaCost' in Cisco_IOS_XE_native cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
Native::Router::Ospf::FastReroute::PerPrefix::RemoteLfa::AreaTunnel::AreaTunnel()
    ...
    tunnel{YType::enumeration, "tunnel"}
{
    yang_name = "area-tunnel"; yang_parent_name = "remote-lfa";
}
...
const EntityPath Native::Router::Ospf::FastReroute::PerPrefix::RemoteLfa::AreaTunnel::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'AreaTunnel' in Cisco_IOS_XE_native cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
Native::Router::Ospf::Mpls::TrafficEng::Area::Area()
    ...
    id{YType::str, "id"}
{
    yang_name = "area"; yang_parent_name = "traffic-eng";
}
...
const EntityPath Native::Router::Ospf::Mpls::TrafficEng::Area::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Native::Router::Ospf::Mpls::TrafficEng::MeshGroup::MeshGroup()
    ...
    interface{YType::str, "interface"}
{
    yang_name = "mesh-group"; yang_parent_name = "traffic-eng";
}
...
const EntityPath Native::Router::Ospf::Mpls::TrafficEng::MeshGroup::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Router::Ospf::Mpls::TrafficEng::RouterId::AtmSubinterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Router::Ospf::Mpls::TrafficEng::RouterId::AtmAcrsubinterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Router::Ospf::Mpls::TrafficEng::RouterId::LispSubinterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Router::Ospf::Mpls::TrafficEng::RouterId::PortChannelSubinterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
