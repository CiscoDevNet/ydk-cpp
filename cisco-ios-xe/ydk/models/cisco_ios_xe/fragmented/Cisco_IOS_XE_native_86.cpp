...
void Native::Mpls::Ldp::Enable2::Label::LabelMode__ConfigLdpLbl::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Mpls::Ldp::Enable2::Label::LabelMode__ConfigLdpLbl::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Mpls::Ldp::Enable2::Label::LabelMode__ConfigLdpLbl::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "allocate")
        return true;
    return false;
...
void Native::Mpls::Ldp::Enable2::Label::LabelMode__ConfigLdpLbl::Allocate::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Mpls::Ldp::Enable2::Label::LabelMode__ConfigLdpLbl::Allocate::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Mpls::Ldp::Enable2::Label::LabelMode__ConfigLdpLbl::Allocate::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "global")
        return true;
    return false;
...
void Native::Mpls::Ldp::Enable2::Label::LabelMode__ConfigLdpLbl::Allocate::Global::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Mpls::Ldp::Enable2::Label::LabelMode__ConfigLdpLbl::Allocate::Global::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "host-routes")
    {
...
bool Native::Mpls::Ldp::Enable2::Label::LabelMode__ConfigLdpLbl::Allocate::Global::has_leaf_or_child_of_name(const std::string & name) const
{
...
bool Native::Mpls::Ldp::Enable2::Logging::Password::has_data() const
{
	...
	|| (configuration_conf !=  nullptr && configuration_conf->has_data())
...
{
    if(name == "configuration" || name == "configuration-conf" || name == "rollover" || name == "rollover-conf")
        return true;
    return false;
}
...
{
    yang_name = "configuration-conf"; yang_parent_name = "password";
}
...
const EntityPath Native::Mpls::Ldp::Enable2::Logging::Password::ConfigurationConf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "rollover-conf"; yang_parent_name = "password";
}
...
const EntityPath Native::Mpls::Ldp::Enable2::Logging::Password::RolloverConf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    if(name == "ATM-ACRsubinterface" || name == "ATM-subinterface" || name == "LISP-subinterface" || name == "Port-channel-subinterface" || name == "AppNav-Compress" || name == "AppNav-UnCompress" || name == "ATM" || name == "ATM-ACR" || name == "BDI" || name == "Cellular" || name == "CEM" || name == "CEM-ACR" || name == "Embedded-Service-Engine" || name == "FastEthernet" || name == "force" || name == "GigabitEthernet" || name == "LISP" || name == "Loopback" || name == "Multilink" || name == "nve" || name == "overlay" || name == "Port-channel" || name == "pseudowire" || name == "Serial" || name == "SM" || name == "TenGigabitEthernet" || name == "Tunnel" || name == "vasileft" || name == "vasiright" || name == "Virtual-Template" || name == "VirtualPortGroup" || name == "Vlan")
        return true;
    return false;
}
...
void Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "vrf-name")
    {
        vrf_name = value;
...
void Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "vrf-name")
    {
        vrf_name.yfilter = yfilter;
...
bool Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::has_leaf_or_child_of_name(const std::string & name) const
{
...
void Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::Interface::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "AppNav-Compress")
    {
        appnav_compress = value;
...
void Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::Interface::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "AppNav-Compress")
    {
        appnav_compress.yfilter = yfilter;
...
bool Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::Interface::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ATM-ACRsubinterface" || name == "ATM-subinterface" || name == "LISP-subinterface" || name == "Port-channel-subinterface" || name == "AppNav-Compress" || name == "AppNav-UnCompress" || name == "ATM" || name == "ATM-ACR" || name == "BDI" || name == "Cellular" || name == "CEM" || name == "CEM-ACR" || name == "Embedded-Service-Engine" || name == "FastEthernet" || name == "force" || name == "GigabitEthernet" || name == "LISP" || name == "Loopback" || name == "Multilink" || name == "nve" || name == "overlay" || name == "Port-channel" || name == "pseudowire" || name == "Serial" || name == "SM" || name == "TenGigabitEthernet" || name == "Tunnel" || name == "vasileft" || name == "vasiright" || name == "Virtual-Template" || name == "VirtualPortGroup" || name == "Vlan")
        return true;
    return false;
...
void Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::Interface::AtmSubinterface::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ATM")
    {
        atm = value;
...
void Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::Interface::AtmSubinterface::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ATM")
    {
        atm.yfilter = yfilter;
...
bool Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::Interface::AtmSubinterface::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ATM")
        return true;
    return false;
...
void Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::Interface::AtmAcrsubinterface::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ATM-ACR")
    {
        atm_acr = value;
...
void Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::Interface::AtmAcrsubinterface::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ATM-ACR")
    {
        atm_acr.yfilter = yfilter;
...
bool Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::Interface::AtmAcrsubinterface::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ATM-ACR")
        return true;
    return false;
...
void Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::Interface::LispSubinterface::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "LISP")
    {
        lisp = value;
...
void Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::Interface::LispSubinterface::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "LISP")
    {
        lisp.yfilter = yfilter;
...
bool Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::Interface::LispSubinterface::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "LISP")
        return true;
    return false;
...
void Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::Interface::PortChannelSubinterface::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "Port-channel")
    {
        port_channel = value;
...
void Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::Interface::PortChannelSubinterface::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "Port-channel")
    {
        port_channel.yfilter = yfilter;
...
bool Native::Mpls::Ldp::Enable2::RouterId::Vrf::Vrf_::Interface::PortChannelSubinterface::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "Port-channel")
        return true;
    return false;
...
Native::Mpls::Ldp::Session::Protection::For_::Duration::Duration()
    ...
    infinite{YType::empty, "infinite"}
{
    yang_name = "duration"; yang_parent_name = "for";
}
...
const EntityPath Native::Mpls::Ldp::Session::Protection::For_::Duration::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    if(name == "duration" || name == "for" || name == "vrf-name")
        return true;
    return false;
}
...
const EntityPath Native::Mpls::Ldp::Session::Protection::Vrf::Vrf_::For_::Duration::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Native::Mpls::Ldp::Session::Protection::Vrf::Vrf_::Duration::Duration()
    ...
    infinite{YType::empty, "infinite"}
{
    yang_name = "duration"; yang_parent_name = "vrf";
}
...
const EntityPath Native::Mpls::Ldp::Session::Protection::Vrf::Vrf_::Duration::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    if(name == "access-list" || name == "cos-map" || name == "nr")
        return true;
    return false;
}
...
Native::Mpls::TrafficEng::AutoTunnel::Backup::Config::AffinityMask::AffinityMask()
    ...
    mask{YType::str, "mask"}
{
    yang_name = "affinity-mask"; yang_parent_name = "config";
}
...
const EntityPath Native::Mpls::TrafficEng::AutoTunnel::Backup::Config::AffinityMask::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Mpls::TrafficEng::AutoTunnel::Backup::Config::UnnumberedInterface::AtmSubinterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Mpls::TrafficEng::AutoTunnel::Backup::Config::UnnumberedInterface::AtmAcrsubinterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Mpls::TrafficEng::AutoTunnel::Backup::Config::UnnumberedInterface::LispSubinterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Mpls::TrafficEng::AutoTunnel::Backup::Config::UnnumberedInterface::PortChannelSubinterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "unused"; yang_parent_name = "removal";
}
...
const EntityPath Native::Mpls::TrafficEng::AutoTunnel::Backup::Timers::Removal::Unused::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    if(name == "duration" || name == "interval")
        return true;
    return false;
}
...
const EntityPath Native::Mpls::TrafficEng::AutoTunnel::Backup::TunnelNum::MinMax::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Mpls::TrafficEng::AutoTunnel::Mesh::TunnelNum::MinMax::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
	...
	,tunnel_num(std::make_shared<Native::Mpls::TrafficEng::AutoTunnel::P2P::TunnelNum>())
{
    ...
    yang_name = "p2p"; yang_parent_name = "auto-tunnel";
}
...
const EntityPath Native::Mpls::TrafficEng::AutoTunnel::P2P::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
    ...
    unnumbered_interface(std::make_shared<Native::Mpls::TrafficEng::AutoTunnel::P2P::Config::UnnumberedInterface>())
{
    ...
    yang_name = "config"; yang_parent_name = "p2p";
}
...
const EntityPath Native::Mpls::TrafficEng::AutoTunnel::P2P::Config::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Mpls::TrafficEng::AutoTunnel::P2P::Config::UnnumberedInterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Mpls::TrafficEng::AutoTunnel::P2P::Config::UnnumberedInterface::AtmSubinterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
