...
std::map<std::string, std::shared_ptr<Entity>> Native::Interface::Cellular::get_children() const
{
    ...
    if(async != nullptr)
    {
        children["Cisco-IOS-XE-cellular:async"] = async;
    }
