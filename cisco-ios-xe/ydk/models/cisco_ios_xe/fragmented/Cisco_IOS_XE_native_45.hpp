...
class Native::Interface::TwoGigabitEthernet::Ip : public ydk::Entity
{
    public:
        ...
        class DirectedBroadcast; //type: Native::Interface::TwoGigabitEthernet::Ip::DirectedBroadcast
        ...
        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::TwoGigabitEthernet::Ip::DirectedBroadcast> directed_broadcast; // presence node
...
class Native::Interface::TwoGigabitEthernet::Ip::DirectedBroadcast : public ydk::Entity
{
    public:
        DirectedBroadcast();
        ~DirectedBroadcast();
...
}; // Native::Interface::TwoGigabitEthernet::Ip::DirectedBroadcast
