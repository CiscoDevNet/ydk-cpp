...
Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Ipv6Multicast::Redistribute::Static::Static()
    ...
    , default_(std::make_shared<Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Ipv6Multicast::Redistribute::Static::Default>())
{
    default_->parent = this;
...
Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Ipv6Multicast::Redistribute::Static::Default::Default()
    :
    metric{YType::uint32, "metric"},
    route_map{YType::str, "route-map"}
{
...
bool Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Ipv6Multicast::Redistribute::Static::Default::has_data() const
{
    if (is_presence_container) return true;
    return metric.is_set
	|| route_map.is_set;
...
bool Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Ipv6Multicast::Redistribute::Static::Default::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(metric.yfilter)
	|| ydk::is_set(route_map.yfilter);
...
std::string Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Ipv6Multicast::Redistribute::Static::Default::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "default";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Ipv6Multicast::Redistribute::Static::Default::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Ipv6Multicast::Redistribute::Static::Default::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Ipv6Multicast::Redistribute::Static::Default::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Ipv6Multicast::Redistribute::Static::Default::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "metric")
    {
        metric = value;
...
void Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Ipv6Multicast::Redistribute::Static::Default::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "metric")
    {
        metric.yfilter = yfilter;
...
bool Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Ipv6Multicast::Redistribute::Static::Default::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "metric" || name == "route-map")
        return true;
    return false;
