...
{
    if(name == "group-based" || name == "member" || name == "source-interface" || name == "name")
        return true;
    return false;
}
...
{
    yang_name = "group-based"; yang_parent_name = "nve";
}
...
const EntityPath Native::Interface::Nve::GroupBased::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'GroupBased' in Cisco_IOS_XE_native cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    if(name == "mcast-group" || name == "vni-range")
        return true;
    return false;
}
...
{
    if(name == "access-session" || name == "arp" || name == "backup" || name == "bandwidth" || name == "bfd" || name == "carrier-delay" || name == "cemoudp" || name == "channel-group" || name == "cws-tunnel" || name == "dampening" || name == "domain" || name == "encapsulation" || name == "ethernet" || name == "fair-queue" || name == "fair-queue-conf" || name == "flowcontrol" || name == "hold-queue" || name == "interface_qos" || name == "ip" || name == "ip-vrf" || name == "ipv6" || name == "isis" || name == "keepalive-settings" || name == "l2protocol-tunnel" || name == "logging" || name == "mdix" || name == "mop" || name == "mpls" || name == "negotiation" || name == "otv" || name == "peer" || name == "plim" || name == "pm-path" || name == "pppoe" || name == "priority-queue" || name == "rcv-queue" || name == "service" || name == "speed" || name == "standby" || name == "storm-control" || name == "switchport" || name == "switchport-conf" || name == "synchronous" || name == "trust" || name == "utd" || name == "vrf" || name == "name" || name == "channel-protocol" || name == "delay" || name == "description" || name == "duplex" || name == "if-state" || name == "keepalive" || name == "load-interval" || name == "mac-address" || name == "max-reserved-bandwidth" || name == "mtu" || name == "service-insertion" || name == "shutdown")
        return true;
    return false;
}
...
const EntityPath Native::Interface::Overlay::Ip::Rip::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Overlay::Ip::Rip::Authentication::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Overlay::Ip::Rip::Authentication::Mode::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Overlay::Ipv6::Tcp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
