...
class Native::Interface::Tengigabitethernet::Switchport::Access::Vlan::Vlan : public ydk::Enum
{
    public:
...
class Native::Interface::Tengigabitethernet::Switchport::Voice::Vlan::Vlan : public ydk::Enum
{
    public:
