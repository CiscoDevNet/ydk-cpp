...
class Native::Router::Bgp::Scope::Global::AddressFamily::NoVrf::Nsap::Redistribute::Static_ : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Router::Bgp::Scope::Global::AddressFamily::NoVrf::Nsap::Redistribute::Static_::Clns> clns; // presence node
        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Router::Bgp::Scope::Global::AddressFamily::NoVrf::Nsap::Redistribute::Static_::Ip> ip; // presence node
...
class Native::Router::Bgp::Scope::Global::AddressFamily::NoVrf::L2Vpn::Bgp_ : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Router::Bgp::Scope::Global::AddressFamily::NoVrf::L2Vpn::Bgp_::Default_> default_;
