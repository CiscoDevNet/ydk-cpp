...
void Native::Interface::Tunnel::Ospfv3::Encryption::Ipsec::Ipsec_3Des::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Interface::Tunnel::Ospfv3::Encryption::Ipsec::Ipsec_3Des::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Interface::Tunnel::Ospfv3::Encryption::Ipsec::Ipsec_3Des::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "key-string")
        return true;
    return false;
...
void Native::Interface::Tunnel::Ospfv3::Encryption::Ipsec::Ipsec_3Des::KeyString::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "encrypt")
    {
        encrypt = value;
...
void Native::Interface::Tunnel::Ospfv3::Encryption::Ipsec::Ipsec_3Des::KeyString::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "encrypt")
    {
        encrypt.yfilter = yfilter;
...
bool Native::Interface::Tunnel::Ospfv3::Encryption::Ipsec::Ipsec_3Des::KeyString::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "encrypt" || name == "string")
        return true;
    return false;
...
{
    if(name == "access-session" || name == "arp" || name == "backup" || name == "bandwidth" || name == "bfd" || name == "carrier-delay" || name == "cdp" || name == "cemoudp" || name == "channel-group" || name == "crypto" || name == "cts" || name == "cws-tunnel" || name == "dampening" || name == "domain" || name == "encapsulation" || name == "ethernet" || name == "fair-queue" || name == "fair-queue-conf" || name == "flowcontrol" || name == "hold-queue" || name == "interface_qos" || name == "ip" || name == "ip-vrf" || name == "ipv6" || name == "isis" || name == "keepalive-settings" || name == "l2protocol-tunnel" || name == "logging" || name == "mab" || name == "mdix" || name == "mop" || name == "mpls" || name == "negotiation" || name == "nhrp" || name == "peer" || name == "plim" || name == "pm-path" || name == "ppp" || name == "pppoe" || name == "priority-queue" || name == "rcv-queue" || name == "service" || name == "service-policy" || name == "snmp" || name == "speed" || name == "standby" || name == "storm-control" || name == "switchport" || name == "switchport-conf" || name == "synchronous" || name == "trust" || name == "tunnel" || name == "utd" || name == "vrf" || name == "zone-member" || name == "name" || name == "channel-protocol" || name == "delay" || name == "description" || name == "duplex" || name == "if-state" || name == "keepalive" || name == "load-interval" || name == "mac-address" || name == "max-reserved-bandwidth" || name == "mtu" || name == "service-insertion" || name == "shutdown" || name == "type")
        return true;
    return false;
}
...
const Enum::YLeaf Native::Interface::Tunnel::Ospfv3::Encryption::Ipsec::Ipsec_3Des::KeyString::Encrypt::Y_0 {0, "0"};
const Enum::YLeaf Native::Interface::Tunnel::Ospfv3::Encryption::Ipsec::Ipsec_3Des::KeyString::Encrypt::Y_7 {1, "7"};
