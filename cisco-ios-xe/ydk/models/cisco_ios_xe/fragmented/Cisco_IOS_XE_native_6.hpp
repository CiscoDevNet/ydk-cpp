...
class Native::Ip : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Ip::ExplicitPath> explicit_path;
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Ip::GratuitousArpsConf> gratuitous_arps_conf;
        std::shared_ptr<Cisco_IOS_XE_native::Native::Ip::Host> host;
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Ip::Routing> routing; // presence node
        std::shared_ptr<Cisco_IOS_XE_native::Native::Ip::Rsvp> rsvp;
...
class Native::Ip::Vrf::Export_ : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Ip::Vrf::Export_::Ipv4> ipv4;
...
class Native::Ip::Cef : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Ip::Cef::Accounting> accounting;
        std::shared_ptr<Cisco_IOS_XE_native::Native::Ip::Cef::LoadSharing> load_sharing;
        std::shared_ptr<Cisco_IOS_XE_native::Native::Ip::Cef::Optimize> optimize;
        std::shared_ptr<Cisco_IOS_XE_native::Native::Ip::Cef::TrafficStatistics> traffic_statistics;
...
class Native::Ip::Cef::Optimize : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Ip::Cef::Optimize::Neighbor> neighbor;
...
class Native::Ip::Cef::LoadSharing : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Ip::Cef::LoadSharing::KeyControl> key_control;
...
class Native::Ip::Cef::LoadSharing::Algorithm : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Ip::Cef::LoadSharing::Algorithm::IncludePorts> include_ports; // presence node
        std::shared_ptr<Cisco_IOS_XE_native::Native::Ip::Cef::LoadSharing::Algorithm::Original> original;
        std::shared_ptr<Cisco_IOS_XE_native::Native::Ip::Cef::LoadSharing::Algorithm::Tunnel> tunnel;
        std::shared_ptr<Cisco_IOS_XE_native::Native::Ip::Cef::LoadSharing::Algorithm::Universal> universal;
