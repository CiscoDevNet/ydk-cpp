...
Native::Interface::HundredGigE::Lisp::Mobility::Mobility()
    :
    dynamic_eid(std::make_shared<Native::Interface::HundredGigE::Lisp::Mobility::DynamicEid>())
	...
	,timer(std::make_shared<Native::Interface::HundredGigE::Mvrp::Timer>())
{
    ...
    yang_name = "mvrp"; yang_parent_name = "HundredGigE"; is_top_level_class = false; has_list_ancestor = true;
}
