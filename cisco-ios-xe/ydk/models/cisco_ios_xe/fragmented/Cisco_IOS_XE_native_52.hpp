...
class Native::Interface::TenGigabitEthernet::Service::Instance::Mac : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::TenGigabitEthernet::Service::Instance::Mac::AccessGroup> > access_group;
...
class Native::Interface::TenGigabitEthernet::CiscoIOSXEEthernetMacsecOption::Macsec : public ydk::Entity
{
    public:
        Macsec();
        ~Macsec();
        ...
        class ReplayProtection; //type: Native::Interface::TenGigabitEthernet::CiscoIOSXEEthernetMacsecOption::Macsec::ReplayProtection

        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::TenGigabitEthernet::CiscoIOSXEEthernetMacsecOption::Macsec::ReplayProtection> replay_protection;
                class Dot1QInClear;

}; // Native::Interface::TenGigabitEthernet::CiscoIOSXEEthernetMacsecOption::Macsec


class Native::Interface::TenGigabitEthernet::CiscoIOSXEEthernetMacsecOption::Macsec::ReplayProtection : public ydk::Entity
{
    public:
        ReplayProtection();
        ~ReplayProtection();
...
}; // Native::Interface::TenGigabitEthernet::CiscoIOSXEEthernetMacsecOption::Macsec::ReplayProtection
...
class Native::Interface::TenGigabitEthernet::EtAnalytics : public ydk::Entity
{
    public:
        EtAnalytics();
        ~EtAnalytics();
...
}; // Native::Interface::TenGigabitEthernet::EtAnalytics
...
class Native::Interface::TenGigabitEthernet::FabricDomain::IwanFabric : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::TenGigabitEthernet::FabricDomain::IwanFabric::Word> > word;
...
class Native::Interface::TenGigabitEthernet::CiscoIOSXEEthernetMacsecOption::Macsec::Dot1QInClear : public ydk::Enum
{
    public:
        static const ydk::Enum::YLeaf Y_1;
