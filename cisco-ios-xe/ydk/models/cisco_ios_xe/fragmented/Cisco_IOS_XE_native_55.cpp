    ...
    enable{YType::empty, "enable"}
{
    ...
    yang_name = "utd"; yang_parent_name = "SM"; is_top_level_class = false; has_list_ancestor = true;
}
...
std::vector<std::pair<std::string, LeafData> > Native::Interface::SM::Utd::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
void Native::Interface::SM::Utd::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Interface::SM::Utd::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "enable")
    {
...
bool Native::Interface::SM::Utd::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "enable")
        return true;
    return false;
