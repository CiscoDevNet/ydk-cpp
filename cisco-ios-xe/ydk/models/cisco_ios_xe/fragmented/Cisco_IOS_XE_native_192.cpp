    ...
    filter{YType::empty, "filter"}
{
    ...
    yang_name = "table-map"; yang_parent_name = "rtfilter"; is_top_level_class = false; has_list_ancestor = true; is_presence_container = true;
}
...
std::map<std::string, std::shared_ptr<Entity>> Native::Router::Ospf::get_children() const
{
    ...
    count = 0;
    for (auto c : summary_address.entities())
    {
        if(children.find(c->get_segment_path()) == children.end())
            children[c->get_segment_path()] = c;
        else
...
const Enum::YLeaf Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Rtfilter::Redistribute::Isis::Routes::level_1 {0, "level-1"};
const Enum::YLeaf Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Rtfilter::Redistribute::Isis::Routes::level_2 {1, "level-2"};
const Enum::YLeaf Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Rtfilter::Redistribute::Isis::Routes::level_1_2 {2, "level-1-2"};
