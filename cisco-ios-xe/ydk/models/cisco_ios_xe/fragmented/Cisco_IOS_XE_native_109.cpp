...
{
    if(name == "commands" || name == "connection" || name == "delay-start" || name == "dot1x" || name == "identity" || name == "exec" || name == "exec-submode" || name == "network" || name == "send" || name == "system" || name == "update" || name == "auth-proxy")
        return true;
    return false;
}
