...
{
    if(name == "default-information" || name == "distance" || name == "distribute-list" || name == "neighbor" || name == "network" || name == "offset-list" || name == "redistribute" || name == "timers" || name == "name" || name == "auto-summary" || name == "default-metric" || name == "maximum-paths" || name == "validate-update-source" || name == "version")
        return true;
    return false;
}
