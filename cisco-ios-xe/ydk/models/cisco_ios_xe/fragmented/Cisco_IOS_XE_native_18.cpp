...
Native::Policy::PolicyMap::Class_::ActionList::RandomDetect::Cos::Cos()
    :
...
bool Native::Policy::PolicyMap::Class_::ActionList::RandomDetect::Cos::has_data() const
{
...
bool Native::Policy::PolicyMap::Class_::ActionList::RandomDetect::Cos::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Policy::PolicyMap::Class_::ActionList::RandomDetect::Cos::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "cos";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Policy::PolicyMap::Class_::ActionList::RandomDetect::Cos::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> Native::Policy::PolicyMap::Class_::ActionList::RandomDetect::Cos::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Policy::PolicyMap::Class_::ActionList::RandomDetect::Cos::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Policy::PolicyMap::Class_::ActionList::RandomDetect::Cos::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Policy::PolicyMap::Class_::ActionList::RandomDetect::Cos::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "cos-val")
    {
...
bool Native::Policy::PolicyMap::Class_::ActionList::RandomDetect::Cos::has_leaf_or_child_of_name(const std::string & name) const
{
...
bool Native::Interface::has_data() const
{
    ...
    for (std::size_t index=0; index<ucse.size(); index++)
    {
        if(ucse[index]->has_data())
            return true;
    }
    for (std::size_t index=0; index<ethernet_internal.size(); index++)
    {
        if(ethernet_internal[index]->has_data())
            return true;
    }
    for (std::size_t index=0; index<service_engine.size(); index++)
    {
    ...
    for (std::size_t index=0; index<fivegigabitethernet.size(); index++)
    {
    ...
    for (std::size_t index=0; index<twentyfivegigabitethernet.size(); index++)
    {
        if(twentyfivegigabitethernet[index]->has_data())
            return true;
    }
    ...
    for (std::size_t index=0; index<hundredgige.size(); index++)
    {
...
bool Native::Interface::has_operation() const
{
    ...
    for (std::size_t index=0; index<twentyfivegigabitethernet.size(); index++)
    {
        if(twentyfivegigabitethernet[index]->has_operation())
            return true;
    }
    for (std::size_t index=0; index<fortygigabitethernet.size(); index++)
    {
...
std::shared_ptr<Entity> Native::Interface::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    {
        for(auto const & c : ethernet_internal)
        {
            std::string segment = c->get_segment_path();
            if(segment_path == segment)
            {
        ...
        c->parent = this;
        ethernet_internal.push_back(c);
        return c;
    }

    if(child_yang_name == "Service-Engine")
    {
        for(auto const & c : service_engine)
        {
            std::string segment = c->get_segment_path();
            if(segment_path == segment)
            {
    ...
    {
        for(auto const & c : fivegigabitethernet)
        {
            std::string segment = c->get_segment_path();
            if(segment_path == segment)
            {
        ...
        c->parent = this;
        fivegigabitethernet.push_back(c);
        return c;
    }
    ...
    if(child_yang_name == "TwentyFiveGigabitEthernet")
    {
        for(auto const & c : twentyfivegigabitethernet)
        {
            std::string segment = c->get_segment_path();
            if(segment_path == segment)
            {
        ...
        auto c = std::make_shared<Native::Interface::TwentyFiveGigabitEthernet>();
        c->parent = this;
        twentyfivegigabitethernet.push_back(c);
        return c;
    }
...
{
    if(name == "AppNav-Compress" || name == "AppNav-UnCompress" || name == "ATM" || name == "ATM-subinterface" || name == "ATM-ACR" || name == "ATM-ACRsubinterface" || name == "BDI" || name == "CEM" || name == "CEM-ACR" || name == "Embedded-Service-Engine" || name == "FastEthernet" || name == "ucse" || name == "Ethernet-Internal" || name == "Service-Engine" || name == "GigabitEthernet" || name == "FiveGigabitEthernet" || name == "TenGigabitEthernet" || name == "TwentyFiveGigabitEthernet" || name == "FortyGigabitEthernet" || name == "HundredGigE" || name == "Loopback" || name == "LISP" || name == "LISP-subinterface" || name == "nve" || name == "overlay" || name == "Port-channel" || name == "Port-channel-subinterface" || name == "pseudowire" || name == "SM" || name == "Cellular" || name == "Vlan" || name == "Group-Async" || name == "Multilink" || name == "Serial" || name == "Tunnel" || name == "Virtual-Template" || name == "VirtualPortGroup" || name == "vasileft" || name == "vasiright")
        return true;
    return false;
}
