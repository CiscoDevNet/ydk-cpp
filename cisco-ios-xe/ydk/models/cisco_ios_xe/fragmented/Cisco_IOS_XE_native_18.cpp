    ...
    enable{YType::empty, "enable"}
{
    ...
    yang_name = "utd"; yang_parent_name = "AppNav-Compress"; is_top_level_class = false; has_list_ancestor = true;
}
...
std::vector<std::pair<std::string, LeafData> > Native::Interface::AppNavCompress::Utd::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
