...
Native::Router::LispList::Default::MapServer::Rloc::Members::ModifyDiscovered::ModifyDiscovered()
    :
...
bool Native::Router::LispList::Default::MapServer::Rloc::Members::ModifyDiscovered::has_data() const
{
    if (is_presence_container) return true;
...
bool Native::Router::LispList::Default::MapServer::Rloc::Members::ModifyDiscovered::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Router::LispList::Default::MapServer::Rloc::Members::ModifyDiscovered::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::MapServer::Rloc::Members::ModifyDiscovered::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::MapServer::Rloc::Members::ModifyDiscovered::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::MapServer::Rloc::Members::ModifyDiscovered::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Native::Router::LispList::Default::MapServer::Rloc::Members::ModifyDiscovered::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Router::LispList::Default::MapServer::Rloc::Members::ModifyDiscovered::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "operator")
    {
...
bool Native::Router::LispList::Default::MapServer::Rloc::Members::ModifyDiscovered::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::MapServer::SiteRegistration::SiteRegistration()
    :
    limit{YType::uint32, "limit"},
    warning_threshold{YType::uint8, "warning-threshold"}
{
...
bool Native::Router::LispList::Default::MapServer::SiteRegistration::has_data() const
{
    if (is_presence_container) return true;
    return limit.is_set
	|| warning_threshold.is_set;
...
bool Native::Router::LispList::Default::MapServer::SiteRegistration::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(limit.yfilter)
	|| ydk::is_set(warning_threshold.yfilter);
...
std::string Native::Router::LispList::Default::MapServer::SiteRegistration::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "site-registration";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::MapServer::SiteRegistration::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::MapServer::SiteRegistration::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::MapServer::SiteRegistration::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Native::Router::LispList::Default::MapServer::SiteRegistration::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "limit")
    {
        limit = value;
...
void Native::Router::LispList::Default::MapServer::SiteRegistration::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "limit")
    {
        limit.yfilter = yfilter;
...
bool Native::Router::LispList::Default::MapServer::SiteRegistration::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "limit" || name == "warning-threshold")
        return true;
    return false;
...
Native::Router::LispList::Default::MapServer::Nmr::Nmr()
    :
...
bool Native::Router::LispList::Default::MapServer::Nmr::has_data() const
{
    if (is_presence_container) return true;
    return non_site_ttl.is_set;
}

bool Native::Router::LispList::Default::MapServer::Nmr::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(non_site_ttl.yfilter);
}

std::string Native::Router::LispList::Default::MapServer::Nmr::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "nmr";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::MapServer::Nmr::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::MapServer::Nmr::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::MapServer::Nmr::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Native::Router::LispList::Default::MapServer::Nmr::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Router::LispList::Default::MapServer::Nmr::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "non-site-ttl")
    {
...
bool Native::Router::LispList::Default::MapServer::Nmr::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::MapServer::Session::Session()
    :
...
bool Native::Router::LispList::Default::MapServer::Session::has_data() const
{
    if (is_presence_container) return true;
    return passive_open.is_set;
}

bool Native::Router::LispList::Default::MapServer::Session::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(passive_open.yfilter);
}

std::string Native::Router::LispList::Default::MapServer::Session::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "session";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::MapServer::Session::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::MapServer::Session::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::MapServer::Session::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Native::Router::LispList::Default::MapServer::Session::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Router::LispList::Default::MapServer::Session::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "passive-open")
    {
...
bool Native::Router::LispList::Default::MapServer::Session::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::OtherXtrProbe::OtherXtrProbe()
    :
...
bool Native::Router::LispList::Default::OtherXtrProbe::has_data() const
{
    if (is_presence_container) return true;
    return period.is_set;
}

bool Native::Router::LispList::Default::OtherXtrProbe::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(period.yfilter);
}

std::string Native::Router::LispList::Default::OtherXtrProbe::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::OtherXtrProbe::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::OtherXtrProbe::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::OtherXtrProbe::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Native::Router::LispList::Default::OtherXtrProbe::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Router::LispList::Default::OtherXtrProbe::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "period")
    {
...
bool Native::Router::LispList::Default::OtherXtrProbe::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "period")
        return true;
    return false;
...
Native::Router::LispList::Default::RemoteRlocProbe::RemoteRlocProbe()
    :
...
bool Native::Router::LispList::Default::RemoteRlocProbe::has_data() const
{
    if (is_presence_container) return true;
...
bool Native::Router::LispList::Default::RemoteRlocProbe::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Router::LispList::Default::RemoteRlocProbe::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::RemoteRlocProbe::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::RemoteRlocProbe::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::RemoteRlocProbe::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Native::Router::LispList::Default::RemoteRlocProbe::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Router::LispList::Default::RemoteRlocProbe::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "on-membership-change")
    {
...
bool Native::Router::LispList::Default::RemoteRlocProbe::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::EidTable()
    :
...
bool Native::Router::LispList::Default::EidTable::has_data() const
{
    if (is_presence_container) return true;
...
bool Native::Router::LispList::Default::EidTable::has_operation() const
{
    for (std::size_t index=0; index<instance_list.len(); index++)
    {
...
std::string Native::Router::LispList::Default::EidTable::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "instance-list")
    {
        auto ent_ = std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Native::Router::LispList::Default::EidTable::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Router::LispList::Default::EidTable::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Router::LispList::Default::EidTable::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::InstanceList::InstanceList()
    :
    ...
    , alt(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::Alt>())
    , control_packet(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::ControlPacket>())
    , ddt(nullptr) // presence node
    , decapsulation(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::Decapsulation>())
    , etr(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::Etr>())
    , ipv4(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::Ipv4>())
    , ipv6(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::Ipv6>())
    , loc_reach_algorithm(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::LocReachAlgorithm>())
    , locator_down(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::LocatorDown>())
    , locator_table(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::LocatorTable>())
    , map_request(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::MapRequest>())
    , map_server(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::MapServer>())
    , other_xtr_probe(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::OtherXtrProbe>())
    , remote_rloc_probe(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::RemoteRlocProbe>())
...
bool Native::Router::LispList::Default::EidTable::InstanceList::has_data() const
{
    if (is_presence_container) return true;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::has_operation() const
{
    for (std::size_t index=0; index<database_mapping.len(); index++)
    {
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "database-mapping")
    {
        auto ent_ = std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::DatabaseMapping>();
        ent_->parent = this;
    ...
    {
        auto ent_ = std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid>();
        ent_->parent = this;
    ...
    if(child_yang_name == "ddt")
    {
        if(ddt == nullptr)
        {
            ddt = std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::Ddt>();
        }
        return ddt;
    }
    ...
    {
        auto ent_ = std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::MapCache>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Native::Router::LispList::Default::EidTable::InstanceList::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Router::LispList::Default::EidTable::InstanceList::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "instance-id")
    {
...
bool Native::Router::LispList::Default::EidTable::InstanceList::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::InstanceList::DatabaseMapping::DatabaseMapping()
    :
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DatabaseMapping::has_data() const
{
    if (is_presence_container) return true;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DatabaseMapping::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::DatabaseMapping::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::DatabaseMapping::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::DatabaseMapping::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::DatabaseMapping::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Native::Router::LispList::Default::EidTable::InstanceList::DatabaseMapping::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Router::LispList::Default::EidTable::InstanceList::DatabaseMapping::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "eid-prefix")
    {
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DatabaseMapping::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::DynamicEid()
    :
    name{YType::str, "name"},
    map_notify_group{YType::str, "map-notify-group"}
        ,
    database_mapping(this, {"eid_prefix"})
    , eid_notify(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify>())
    , map_server(this, {"ip"})
{
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::has_data() const
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<database_mapping.len(); index++)
    {
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::has_operation() const
{
    for (std::size_t index=0; index<database_mapping.len(); index++)
    {
        if(database_mapping[index]->has_operation())
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "database-mapping")
    {
        auto ent_ = std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::DatabaseMapping>();
        ent_->parent = this;
        database_mapping.append(ent_);
        return ent_;
    }
    ...
    if(child_yang_name == "map-server")
    {
        auto ent_ = std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "name")
    {
        name = value;
...
void Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "name")
    {
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::DatabaseMapping::DatabaseMapping()
    :
    eid_prefix{YType::str, "eid-prefix"},
    locator_set{YType::str, "locator-set"}
{
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::DatabaseMapping::has_data() const
{
    if (is_presence_container) return true;
    return eid_prefix.is_set
	|| locator_set.is_set;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::DatabaseMapping::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(eid_prefix.yfilter)
	|| ydk::is_set(locator_set.yfilter);
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::DatabaseMapping::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "database-mapping";
    ADD_KEY_TOKEN(eid_prefix, "eid-prefix");
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::DatabaseMapping::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::DatabaseMapping::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::DatabaseMapping::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::DatabaseMapping::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "eid-prefix")
    {
        eid_prefix = value;
...
void Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::DatabaseMapping::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "eid-prefix")
    {
        eid_prefix.yfilter = yfilter;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::DatabaseMapping::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "eid-prefix" || name == "locator-set")
        return true;
    return false;
...
Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::EidNotify()
    :
    authentication_key(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::AuthenticationKey>())
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::has_data() const
{
    if (is_presence_container) return true;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::has_operation() const
{
    for (std::size_t index=0; index<gateway_key.len(); index++)
    {
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    {
        auto ent_ = std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::GatewayKey>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(authentication_key != nullptr)
...
void Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::AuthenticationKey::AuthenticationKey()
    :
    ak_0{YType::str, "ak-0"},
    ak_6{YType::str, "ak-6"},
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::AuthenticationKey::has_data() const
{
    if (is_presence_container) return true;
    return ak_0.is_set
	|| ak_6.is_set
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::AuthenticationKey::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::AuthenticationKey::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::AuthenticationKey::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::AuthenticationKey::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::AuthenticationKey::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::AuthenticationKey::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ak-0")
    {
        ak_0 = value;
...
void Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::AuthenticationKey::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ak-0")
    {
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::AuthenticationKey::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::GatewayKey::GatewayKey()
    :
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::GatewayKey::has_data() const
{
    if (is_presence_container) return true;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::GatewayKey::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::GatewayKey::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::GatewayKey::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::GatewayKey::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::GatewayKey::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::GatewayKey::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::GatewayKey::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "gateway-ip")
    {
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::GatewayKey::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::MapServer()
    :
    ip{YType::str, "ip"},
    proxy_reply{YType::empty, "proxy-reply"}
        ,
    key(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::Key>())
{
    key->parent = this;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::has_data() const
{
    if (is_presence_container) return true;
    return ip.is_set
	|| proxy_reply.is_set
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "map-server";
    ADD_KEY_TOKEN(ip, "ip");
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(key != nullptr)
...
void Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ip")
    {
        ip = value;
...
void Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ip")
    {
        ip.yfilter = yfilter;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::Key::Key()
    :
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::Key::has_data() const
{
    if (is_presence_container) return true;
    return key_0.is_set
	|| key_6.is_set
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::Key::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::Key::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "key";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::Key::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::Key::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::Key::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::Key::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "key-0")
    {
        key_0 = value;
...
void Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::Key::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "key-0")
    {
...
bool Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::Key::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::InstanceList::Alt::Alt()
    :
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Alt::has_data() const
{
    if (is_presence_container) return true;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Alt::has_operation() const
{
    for (std::size_t index=0; index<summary_route.len(); index++)
    {
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::Alt::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "alt";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::Alt::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::Alt::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "summary-route")
    {
        auto ent_ = std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::Alt::SummaryRoute>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::Alt::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Native::Router::LispList::Default::EidTable::InstanceList::Alt::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Router::LispList::Default::EidTable::InstanceList::Alt::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Router::LispList::Default::EidTable::InstanceList::Alt::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::InstanceList::Alt::SummaryRoute::SummaryRoute()
    :
    eid_prefix{YType::str, "eid-prefix"},
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Alt::SummaryRoute::has_data() const
{
    if (is_presence_container) return true;
    return eid_prefix.is_set
	|| route_tag.is_set;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Alt::SummaryRoute::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(eid_prefix.yfilter)
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::Alt::SummaryRoute::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::Alt::SummaryRoute::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::Alt::SummaryRoute::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::Alt::SummaryRoute::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Native::Router::LispList::Default::EidTable::InstanceList::Alt::SummaryRoute::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "eid-prefix")
    {
        eid_prefix = value;
...
void Native::Router::LispList::Default::EidTable::InstanceList::Alt::SummaryRoute::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "eid-prefix")
    {
        eid_prefix.yfilter = yfilter;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Alt::SummaryRoute::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::InstanceList::ControlPacket::ControlPacket()
    :
...
bool Native::Router::LispList::Default::EidTable::InstanceList::ControlPacket::has_data() const
{
    if (is_presence_container) return true;
    return mtu.is_set;
}

bool Native::Router::LispList::Default::EidTable::InstanceList::ControlPacket::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(mtu.yfilter);
}

std::string Native::Router::LispList::Default::EidTable::InstanceList::ControlPacket::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::ControlPacket::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::ControlPacket::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::ControlPacket::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Native::Router::LispList::Default::EidTable::InstanceList::ControlPacket::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "mtu")
    {
        mtu = value;
...
void Native::Router::LispList::Default::EidTable::InstanceList::ControlPacket::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "mtu")
    {
        mtu.yfilter = yfilter;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::ControlPacket::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "mtu")
        return true;
    return false;
...
Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Ddt()
    :
    cache_limit{YType::uint32, "cache-limit"},
    root{YType::str, "root"}
        ,
    authoritative(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative>())
{
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::has_data() const
{
    if (is_presence_container) return true;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::Ddt::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "ddt";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::Ddt::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::Ddt::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::Ddt::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(authoritative != nullptr)
...
void Native::Router::LispList::Default::EidTable::InstanceList::Ddt::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Router::LispList::Default::EidTable::InstanceList::Ddt::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "cache-limit")
    {
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::Authoritative()
    :
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::has_data() const
{
    if (is_presence_container) return true;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::has_operation() const
{
    for (std::size_t index=0; index<instance_id_eid_prefix_list.len(); index++)
    {
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "instance-id-eid-prefix-list")
    {
        auto ent_ = std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList>();
        ent_->parent = this;
    ...
    {
        auto ent_ = std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList>();
        ent_->parent = this;
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
...
void Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::InstanceIdEidPrefixList()
    :
    instance_id{YType::uint32, "instance-id"},
    eid_prefix{YType::str, "eid-prefix"},
    map_server_peer{YType::str, "map-server-peer"}
        ,
    delegate(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::Delegate>())
{
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::has_data() const
{
    if (is_presence_container) return true;
    return instance_id.is_set
	|| eid_prefix.is_set
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(instance_id.yfilter)
	|| ydk::is_set(eid_prefix.yfilter)
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(delegate != nullptr)
...
void Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "instance-id")
    {
        instance_id = value;
...
void Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "instance-id")
    {
        instance_id.yfilter = yfilter;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::Delegate::Delegate()
    :
    eid_prefix{YType::str, "eid-prefix"},
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::Delegate::has_data() const
{
    if (is_presence_container) return true;
    return eid_prefix.is_set
	|| instance_id.is_set
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::Delegate::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(eid_prefix.yfilter)
	|| ydk::is_set(instance_id.yfilter)
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::Delegate::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::Delegate::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::Delegate::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::Delegate::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::Delegate::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "eid-prefix")
    {
        eid_prefix = value;
...
void Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::Delegate::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "eid-prefix")
    {
        eid_prefix.yfilter = yfilter;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdEidPrefixList::Delegate::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::InstanceIdList()
    :
    instance_id{YType::str, "instance-id"},
    map_server_peer{YType::str, "map-server-peer"}
        ,
    delegate(std::make_shared<Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::Delegate>())
{
    delegate->parent = this;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::has_data() const
{
    if (is_presence_container) return true;
    return instance_id.is_set
	|| map_server_peer.is_set
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(instance_id.yfilter)
	|| ydk::is_set(map_server_peer.yfilter)
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "delegate")
    {
        if(delegate == nullptr)
...
std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(delegate != nullptr)
...
void Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "instance-id")
    {
        instance_id = value;
...
void Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "instance-id")
    {
        instance_id.yfilter = yfilter;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::Delegate::Delegate()
    :
    eid_prefix{YType::str, "eid-prefix"},
    instance_id{YType::str, "instance-id"},
    to{YType::empty, "to"},
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::Delegate::has_data() const
{
    if (is_presence_container) return true;
    return eid_prefix.is_set
	|| instance_id.is_set
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::Delegate::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(eid_prefix.yfilter)
	|| ydk::is_set(instance_id.yfilter)
...
std::string Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::Delegate::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "delegate";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::Delegate::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<ydk::Entity> Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::Delegate::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::Delegate::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
void Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::Delegate::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "eid-prefix")
    {
        eid_prefix = value;
...
void Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::Delegate::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "eid-prefix")
    {
        eid_prefix.yfilter = yfilter;
...
bool Native::Router::LispList::Default::EidTable::InstanceList::Ddt::Authoritative::InstanceIdList::Delegate::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "eid-prefix" || name == "instance-id" || name == "to" || name == "ip-address" || name == "map-server")
        return true;
    return false;
...
const Enum::YLeaf Native::Router::LispList::Default::MapServer::Rloc::Members::ModifyDiscovered::Operator_::add {0, "add"};
const Enum::YLeaf Native::Router::LispList::Default::MapServer::Rloc::Members::ModifyDiscovered::Operator_::override {1, "override"};

const Enum::YLeaf Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::GatewayKey::HashFunction::sha1 {0, "sha1"};
const Enum::YLeaf Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::EidNotify::GatewayKey::HashFunction::sha2 {1, "sha2"};

const Enum::YLeaf Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::Key::HashFunction::sha1 {0, "sha1"};
const Enum::YLeaf Native::Router::LispList::Default::EidTable::InstanceList::DynamicEid::MapServer::Key::HashFunction::sha2 {1, "sha2"};
