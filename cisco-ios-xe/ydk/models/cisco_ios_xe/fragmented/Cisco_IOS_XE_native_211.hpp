...
class Native::Arp : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Arp::Vrf> > vrf;
...
class Native::Arp::Vrf : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Arp::Vrf::ArpEntry> > arp_entry;
