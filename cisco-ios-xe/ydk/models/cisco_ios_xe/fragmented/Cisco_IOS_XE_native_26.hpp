...
class Native::Interface::Fastethernet::Cts : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Interface::Fastethernet::Cts::RoleBased> role_based;
...
class Native::Interface::Fastethernet::Cts::Manual::Policy::Static_ : public ydk::Entity
{
    public:
        Static_();
        ~Static_();
...
class Native::Interface::Fastethernet::Cts::RoleBased : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Interface::Fastethernet::Cts::RoleBased::SgtMap> sgt_map;
                class SgtCache;
