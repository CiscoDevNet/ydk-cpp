...
std::vector<std::pair<std::string, LeafData> > Native::Router::Isis::AddressFamily::Ipv4::Topology::Redistribute::Vrf::Global::Static_::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Isis::AddressFamily::Ipv4::Topology::Redistribute::Vrf::Global::Static_::Clns::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Isis::AddressFamily::Ipv4::Topology::Redistribute::Vrf::Global::Static_::Ip::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Isis::AddressFamily::Ipv4::Topology::Redistribute::Vrf::VrfNm::Static_::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Isis::AddressFamily::Ipv4::Topology::Redistribute::Vrf::VrfNm::Static_::Clns::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Isis::AddressFamily::Ipv4::Topology::Redistribute::Vrf::VrfNm::Static_::Ip::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
    ...
    transition{YType::empty, "transition"}
{
    ...
    yang_name = "multi-topology"; yang_parent_name = "ipv6"; is_top_level_class = false; has_list_ancestor = false;
}
    ...
    route_map{YType::str, "route-map"}
{
    ...
    yang_name = "nd"; yang_parent_name = "redistribute"; is_top_level_class = false; has_list_ancestor = false;
}
...
std::string Native::Router::Isis::AddressFamily::Ipv6::Redistribute::Static_::get_absolute_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "Cisco-IOS-XE-native:native/router/Cisco-IOS-XE-isis:isis/address-family/ipv6/redistribute/" << get_segment_path();
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Isis::AddressFamily::Ipv6::Redistribute::Static_::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
	...
	,suppress(std::make_shared<Native::Router::Isis::AddressFamily::Ipv6::SetOverloadBit::Suppress>())
{
    ...
    yang_name = "set-overload-bit"; yang_parent_name = "ipv6"; is_top_level_class = false; has_list_ancestor = false;
}
