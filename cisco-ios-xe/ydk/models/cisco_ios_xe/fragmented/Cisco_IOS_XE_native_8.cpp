...
const EntityPath Native::Ip::Ssh::Server::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
    ...
    encryption(std::make_shared<Native::Ip::Ssh::Server::Algorithm::Encryption>())
{
    ...
    yang_name = "algorithm"; yang_parent_name = "server";
}
...
const EntityPath Native::Ip::Ssh::Server::Algorithm::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "encryption"; yang_parent_name = "algorithm";
}
...
const EntityPath Native::Ip::Ssh::Server::Algorithm::Encryption::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Native::Ip::Icmp::RateLimit::Unreachable::Df::Df()
    ...
    time{YType::uint32, "time"}
{
    yang_name = "DF"; yang_parent_name = "unreachable";
}
...
const EntityPath Native::Ip::Icmp::RateLimit::Unreachable::Df::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
