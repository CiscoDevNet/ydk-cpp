...
Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Isis()
    ...
    route_map{YType::str, "route-map"}
        ,
    isis_area(this, {"name"})
    , default_(std::make_shared<Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Default>())
{
...
Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Default::Default()
    :
    ip{YType::empty, "ip"},
    clns{YType::empty, "clns"},
    routes{YType::enumeration, "routes"},
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Default::has_data() const
{
    if (is_presence_container) return true;
    return ip.is_set
	|| clns.is_set
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Default::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(ip.yfilter)
	|| ydk::is_set(clns.yfilter)
...
std::string Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Default::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "default";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Default::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Default::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Default::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Default::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "ip")
    {
        ip = value;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Default::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "ip")
    {
        ip.yfilter = yfilter;
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Default::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::IsoIgrp::IsoIgrp()
    ...
    , default_(std::make_shared<Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::IsoIgrp::Default>())
{
    default_->parent = this;
...
Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::IsoIgrp::Default::Default()
    :
    route_map{YType::str, "route-map"},
    metric{YType::uint32, "metric"}
{
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::IsoIgrp::Default::has_data() const
{
    if (is_presence_container) return true;
    return route_map.is_set
	|| metric.is_set;
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::IsoIgrp::Default::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(route_map.yfilter)
	|| ydk::is_set(metric.yfilter);
...
std::string Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::IsoIgrp::Default::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "default";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::IsoIgrp::Default::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::IsoIgrp::Default::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::IsoIgrp::Default::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::IsoIgrp::Default::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "route-map")
    {
        route_map = value;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::IsoIgrp::Default::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "route-map")
    {
        route_map.yfilter = yfilter;
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::IsoIgrp::Default::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "route-map" || name == "metric")
        return true;
    return false;
...
Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::Ospfv3()
    :
    id{YType::uint16, "id"},
    metric{YType::uint32, "metric"},
    route_map{YType::str, "route-map"}
        ,
    match(std::make_shared<Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::Match>())
{
    match->parent = this;
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::has_data() const
{
    if (is_presence_container) return true;
    return id.is_set
	|| metric.is_set
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(id.yfilter)
	|| ydk::is_set(metric.yfilter)
...
std::string Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "ospfv3";
    ADD_KEY_TOKEN(id, "id");
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "match")
    {
        if(match == nullptr)
...
std::map<std::string, std::shared_ptr<Entity>> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(match != nullptr)
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "id")
    {
        id = value;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "id")
    {
        id.yfilter = yfilter;
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::Match::Match()
    :
    internal{YType::empty, "internal"},
    external{YType::enumeration, "external"},
    external2{YType::enumeration, "external2"},
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::Match::has_data() const
{
    if (is_presence_container) return true;
    return internal.is_set
	|| external.is_set
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::Match::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(internal.yfilter)
	|| ydk::is_set(external.yfilter)
...
std::string Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::Match::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "match";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::Match::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::Match::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::Match::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::Match::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "internal")
    {
        internal = value;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::Match::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "internal")
    {
        internal.yfilter = yfilter;
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Ospfv3::Match::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "internal" || name == "external" || name == "external2" || name == "nssa-external" || name == "metric" || name == "route-map")
        return true;
    return false;
...
Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Static()
    :
    metric{YType::uint32, "metric"},
    route_map{YType::str, "route-map"}
        ,
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::has_data() const
{
    if (is_presence_container) return true;
    return metric.is_set
	|| route_map.is_set
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(metric.yfilter)
	|| ydk::is_set(route_map.yfilter)
...
std::string Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "static";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "clns")
    {
        if(clns == nullptr)
        {
            clns = std::make_shared<Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Clns>();
        }
        return clns;
    }
    ...
    if(child_yang_name == "ip")
    {
        if(ip == nullptr)
        {
            ip = std::make_shared<Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Ip>();
        }
        return ip;
    }
...
std::map<std::string, std::shared_ptr<Entity>> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    if(clns != nullptr)
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "metric")
    {
        metric = value;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "metric")
    {
        metric.yfilter = yfilter;
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Clns::Clns()
    :
    route_map{YType::str, "route-map"},
    metric{YType::uint32, "metric"}
{
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Clns::has_data() const
{
    if (is_presence_container) return true;
    return route_map.is_set
	|| metric.is_set;
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Clns::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(route_map.yfilter)
	|| ydk::is_set(metric.yfilter);
...
std::string Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Clns::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "clns";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Clns::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Clns::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Clns::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Clns::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "route-map")
    {
        route_map = value;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Clns::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "route-map")
    {
        route_map.yfilter = yfilter;
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Clns::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "route-map" || name == "metric")
        return true;
    return false;
...
Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Ip::Ip()
    :
    metric{YType::uint32, "metric"},
    route_map{YType::str, "route-map"}
{
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Ip::has_data() const
{
    if (is_presence_container) return true;
    return metric.is_set
	|| route_map.is_set;
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Ip::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(metric.yfilter)
	|| ydk::is_set(route_map.yfilter);
...
std::string Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Ip::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "ip";
    return path_buffer.str();
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Ip::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Ip::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Ip::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Ip::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "metric")
    {
        metric = value;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Ip::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "metric")
    {
        metric.yfilter = yfilter;
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Static::Ip::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "metric" || name == "route-map")
        return true;
    return false;
    ...
    filter{YType::empty, "filter"}
{
    ...
    yang_name = "table-map"; yang_parent_name = "ipv4"; is_top_level_class = false; has_list_ancestor = true; is_presence_container = true;
}
    ...
    context(std::make_shared<Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Snmp::Context>())
{
    ...
    yang_name = "snmp"; yang_parent_name = "ipv4"; is_top_level_class = false; has_list_ancestor = true; is_presence_container = true;
}
...
Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Import::Path::Path()
    ...
    limit{YType::uint8, "limit"}
        ,
    selection(std::make_shared<Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Import::Path::Selection>())
{
...
Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Import::Path::Selection::Selection()
    :
    all{YType::empty, "all"}
{
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Import::Path::Selection::has_data() const
{
    if (is_presence_container) return true;
    return all.is_set;
}

bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Import::Path::Selection::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(all.yfilter);
}

std::string Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Import::Path::Selection::get_segment_path() const
{
    std::ostringstream path_buffer;
...
std::vector<std::pair<std::string, LeafData> > Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Import::Path::Selection::get_name_leaf_data() const
{
    std::vector<std::pair<std::string, LeafData> > leaf_name_data {};
...
std::shared_ptr<Entity> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Import::Path::Selection::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Import::Path::Selection::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    char count=0;
    return children;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Import::Path::Selection::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "all")
    {
        all = value;
...
void Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Import::Path::Selection::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "all")
    {
        all.yfilter = yfilter;
...
bool Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Import::Path::Selection::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "all")
        return true;
    return false;
...
Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Bgp_()
    ...
    , default_(std::make_shared<Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Default>())
    ...
    , listen(std::make_shared<Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv6::Bgp_::Listen>())
...
const Enum::YLeaf Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Routes::level_1 {0, "level-1"};
const Enum::YLeaf Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Routes::level_2 {1, "level-2"};
const Enum::YLeaf Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Routes::level_1_2 {2, "level-1-2"};
...
const Enum::YLeaf Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Default::Routes::level_1 {0, "level-1"};
const Enum::YLeaf Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Default::Routes::level_2 {1, "level-2"};
const Enum::YLeaf Native::Router::Bgp::Scope::Vrf::AddressFamily::NoVrf::Ipv4::Redistribute::Isis::Default::Routes::level_1_2 {2, "level-1-2"};
