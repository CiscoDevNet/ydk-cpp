...
class Native::Interface::PortChannelSubinterface::PortChannel::Source::Template::TemplateName : public ydk::Entity
{
    public:
        TemplateName();
        ~TemplateName();
...
}; // Native::Interface::PortChannelSubinterface::PortChannel::Source::Template::TemplateName
...
class Native::Interface::PortChannelSubinterface::PortChannel::AccessSession : public ydk::Entity
{
    public:
        ...
        class ControlDirection; //type: Native::Interface::PortChannelSubinterface::PortChannel::AccessSession::ControlDirection
        ...
        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::PortChannelSubinterface::PortChannel::AccessSession::ControlDirection> control_direction;
                class HostMode;
...
class Native::Interface::PortChannelSubinterface::PortChannel::AccessSession::ControlDirection : public ydk::Entity
{
    public:
        ControlDirection();
        ~ControlDirection();
...
}; // Native::Interface::PortChannelSubinterface::PortChannel::AccessSession::ControlDirection
...
class Native::Interface::PortChannelSubinterface::PortChannel::Ethernet : public ydk::Entity
{
    public:
        ...
        class Dot1ad; //type: Native::Interface::PortChannelSubinterface::PortChannel::Ethernet::Dot1ad
        ...
        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::PortChannelSubinterface::PortChannel::Ethernet::Dot1ad> dot1ad;
...
class Native::Interface::PortChannelSubinterface::PortChannel::Ethernet::Dot1ad : public ydk::Entity
{
    public:
        Dot1ad();
        ~Dot1ad();
        ...
        class Uni; //type: Native::Interface::PortChannelSubinterface::PortChannel::Ethernet::Dot1ad::Uni

        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::PortChannelSubinterface::PortChannel::Ethernet::Dot1ad::Uni> uni;
        
}; // Native::Interface::PortChannelSubinterface::PortChannel::Ethernet::Dot1ad


class Native::Interface::PortChannelSubinterface::PortChannel::Ethernet::Dot1ad::Uni : public ydk::Entity
{
    public:
        Uni();
        ~Uni();
...
}; // Native::Interface::PortChannelSubinterface::PortChannel::Ethernet::Dot1ad::Uni
