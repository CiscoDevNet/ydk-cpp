    ...
    port_control(std::make_shared<Native::Interface::EmbeddedServiceEngine::AccessSession::PortControl>())
{
    ...
    yang_name = "access-session"; yang_parent_name = "Embedded-Service-Engine";
}
...
bool Native::Interface::EmbeddedServiceEngine::AccessSession::has_operation() const
{
...
std::string Native::Interface::EmbeddedServiceEngine::AccessSession::get_segment_path() const
{
...
const EntityPath Native::Interface::EmbeddedServiceEngine::AccessSession::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::AccessSession::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::AccessSession::get_children() const
{
...
void Native::Interface::EmbeddedServiceEngine::AccessSession::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Interface::EmbeddedServiceEngine::AccessSession::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "closed")
    {
...
bool Native::Interface::EmbeddedServiceEngine::AccessSession::has_leaf_or_child_of_name(const std::string & name) const
{
...
bool Native::Interface::EmbeddedServiceEngine::AccessSession::PortControl::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(auto_.yfilter);
}

std::string Native::Interface::EmbeddedServiceEngine::AccessSession::PortControl::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::Interface::EmbeddedServiceEngine::AccessSession::PortControl::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::AccessSession::PortControl::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::AccessSession::PortControl::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::AccessSession::PortControl::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "auto")
    {
        auto_ = value;
...
void Native::Interface::EmbeddedServiceEngine::AccessSession::PortControl::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "auto")
    {
...
bool Native::Interface::EmbeddedServiceEngine::AccessSession::PortControl::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "auto")
        return true;
    return false;
	...
	,unicast(std::make_shared<Native::Interface::EmbeddedServiceEngine::StormControl::Unicast>())
{
    ...
    yang_name = "storm-control"; yang_parent_name = "Embedded-Service-Engine";
}
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Interface::EmbeddedServiceEngine::StormControl::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::Interface::EmbeddedServiceEngine::StormControl::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::StormControl::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::StormControl::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(action != nullptr)
    {
...
void Native::Interface::EmbeddedServiceEngine::StormControl::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Interface::EmbeddedServiceEngine::StormControl::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Interface::EmbeddedServiceEngine::StormControl::has_leaf_or_child_of_name(const std::string & name) const
{
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Action::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Interface::EmbeddedServiceEngine::StormControl::Action::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "action";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::StormControl::Action::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::StormControl::Action::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::StormControl::Action::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::StormControl::Action::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "level")
    {
        level = value;
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Action::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "level")
    {
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Action::has_leaf_or_child_of_name(const std::string & name) const
{
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(include != nullptr)
    {
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::has_leaf_or_child_of_name(const std::string & name) const
{
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Include::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(multicast.yfilter);
}

std::string Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Include::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "include";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Include::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Include::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Include::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Include::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Include::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "multicast")
    {
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Include::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "multicast")
        return true;
    return false;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "level";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(bps != nullptr)
    {
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "threshold")
    {
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::has_leaf_or_child_of_name(const std::string & name) const
{
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::Bps::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::Bps::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "bps";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::Bps::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::Bps::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::Bps::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::Bps::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::Bps::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "falling-threshold")
    {
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::Bps::has_leaf_or_child_of_name(const std::string & name) const
{
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::Pps::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(falling_threshold.yfilter)
	|| ydk::is_set(rising_threshold.yfilter);
...
std::string Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::Pps::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "pps";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::Pps::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::Pps::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::Pps::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::Pps::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold = value;
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::Pps::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold.yfilter = yfilter;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Broadcast::Level::Pps::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "falling-threshold" || name == "rising-threshold")
        return true;
    return false;
...
Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Multicast()
    :
    level(std::make_shared<Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level>())
{
    level->parent = this;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::has_operation() const
{
    return is_set(yfilter)
	|| (level !=  nullptr && level->has_operation());
}

std::string Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "level")
    {
        if(level == nullptr)
...
std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(level != nullptr)
    {
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "level")
        return true;
    return false;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(threshold.yfilter)
	|| (bps !=  nullptr && bps->has_operation())
...
std::string Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "level";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "bps")
    {
        if(bps == nullptr)
...
std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(bps != nullptr)
    {
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "threshold")
    {
        threshold = value;
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "threshold")
    {
        threshold.yfilter = yfilter;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "bps" || name == "pps" || name == "threshold")
        return true;
    return false;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::Bps::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(falling_threshold.yfilter)
	|| ydk::is_set(rising_threshold.yfilter);
...
std::string Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::Bps::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "bps";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::Bps::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::Bps::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::Bps::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::Bps::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold = value;
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::Bps::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold.yfilter = yfilter;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::Bps::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "falling-threshold" || name == "rising-threshold")
        return true;
    return false;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::Pps::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(falling_threshold.yfilter)
	|| ydk::is_set(rising_threshold.yfilter);
...
std::string Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::Pps::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "pps";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::Pps::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::Pps::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::Pps::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::Pps::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold = value;
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::Pps::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold.yfilter = yfilter;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Multicast::Level::Pps::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "falling-threshold" || name == "rising-threshold")
        return true;
    return false;
...
Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Unicast()
    :
    level(std::make_shared<Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level>())
{
    level->parent = this;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::has_operation() const
{
    return is_set(yfilter)
	|| (level !=  nullptr && level->has_operation());
}

std::string Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "unicast";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "level")
    {
        if(level == nullptr)
...
std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(level != nullptr)
    {
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "level")
        return true;
    return false;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::has_operation() const
{
    return is_set(yfilter)
	|| (bps !=  nullptr && bps->has_operation())
	|| (pps !=  nullptr && pps->has_operation())
...
std::string Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "level";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "bps")
    {
        if(bps == nullptr)
...
std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(bps != nullptr)
    {
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "bps" || name == "pps" || name == "threshold")
        return true;
    return false;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Threshold::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(falling_threshold.yfilter)
	|| ydk::is_set(rising_threshold.yfilter);
...
std::string Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Threshold::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Threshold::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Threshold::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Threshold::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Threshold::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold = value;
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Threshold::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold.yfilter = yfilter;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Threshold::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "falling-threshold" || name == "rising-threshold")
        return true;
    return false;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Bps::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(falling_threshold.yfilter)
	|| ydk::is_set(rising_threshold.yfilter);
...
std::string Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Bps::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "bps";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Bps::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Bps::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Bps::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Bps::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold = value;
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Bps::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold.yfilter = yfilter;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Bps::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "falling-threshold" || name == "rising-threshold")
        return true;
    return false;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Pps::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(falling_threshold.yfilter)
	|| ydk::is_set(rising_threshold.yfilter);
...
std::string Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Pps::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "pps";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Pps::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Pps::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Pps::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Pps::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold = value;
...
void Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Pps::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "falling-threshold")
    {
        falling_threshold.yfilter = yfilter;
...
bool Native::Interface::EmbeddedServiceEngine::StormControl::Unicast::Level::Pps::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "falling-threshold" || name == "rising-threshold")
        return true;
    return false;
...
{
    yang_name = "trust"; yang_parent_name = "Embedded-Service-Engine";
}
...
bool Native::Interface::EmbeddedServiceEngine::Trust::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(device.yfilter);
}

std::string Native::Interface::EmbeddedServiceEngine::Trust::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "trust";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::Trust::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::Trust::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::Trust::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::Trust::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Interface::EmbeddedServiceEngine::Trust::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "device")
    {
...
bool Native::Interface::EmbeddedServiceEngine::Trust::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "device")
        return true;
    return false;
...
Native::Interface::EmbeddedServiceEngine::Utd::Utd()
    :
    enable{YType::empty, "enable"}
{
    yang_name = "utd"; yang_parent_name = "Embedded-Service-Engine";
}
...
bool Native::Interface::EmbeddedServiceEngine::Utd::has_data() const
{
    return enable.is_set;
}

bool Native::Interface::EmbeddedServiceEngine::Utd::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(enable.yfilter);
}

std::string Native::Interface::EmbeddedServiceEngine::Utd::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "utd";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::Utd::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::Utd::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::Utd::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::Utd::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Interface::EmbeddedServiceEngine::Utd::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "enable")
    {
...
bool Native::Interface::EmbeddedServiceEngine::Utd::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "enable")
        return true;
    return false;
    ...
    cos_map(std::make_shared<Native::Interface::EmbeddedServiceEngine::PriorityQueue::CosMap>())
{
    ...
    yang_name = "priority-queue"; yang_parent_name = "Embedded-Service-Engine";
}
...
bool Native::Interface::EmbeddedServiceEngine::PriorityQueue::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Interface::EmbeddedServiceEngine::PriorityQueue::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::Interface::EmbeddedServiceEngine::PriorityQueue::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::PriorityQueue::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::PriorityQueue::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(cos_map != nullptr)
    {
...
void Native::Interface::EmbeddedServiceEngine::PriorityQueue::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "out")
    {
        out = value;
...
void Native::Interface::EmbeddedServiceEngine::PriorityQueue::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "out")
    {
        out.yfilter = yfilter;
...
bool Native::Interface::EmbeddedServiceEngine::PriorityQueue::has_leaf_or_child_of_name(const std::string & name) const
{
...
bool Native::Interface::EmbeddedServiceEngine::PriorityQueue::CosMap::has_operation() const
{
    for (auto const & leaf : cos_values.getYLeafs())
    {
...
std::string Native::Interface::EmbeddedServiceEngine::PriorityQueue::CosMap::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "cos-map";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::PriorityQueue::CosMap::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::PriorityQueue::CosMap::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::PriorityQueue::CosMap::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::PriorityQueue::CosMap::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Interface::EmbeddedServiceEngine::PriorityQueue::CosMap::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "cos-values")
    {
...
bool Native::Interface::EmbeddedServiceEngine::PriorityQueue::CosMap::has_leaf_or_child_of_name(const std::string & name) const
{
...
{
    yang_name = "rcv-queue"; yang_parent_name = "Embedded-Service-Engine";
}
...
std::string Native::Interface::EmbeddedServiceEngine::RcvQueue::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::Interface::EmbeddedServiceEngine::RcvQueue::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::RcvQueue::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "cos-map")
    {
...
std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::RcvQueue::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    for (auto const & c : cos_map)
    {
...
void Native::Interface::EmbeddedServiceEngine::RcvQueue::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Interface::EmbeddedServiceEngine::RcvQueue::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Interface::EmbeddedServiceEngine::RcvQueue::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "cos-map")
        return true;
    return false;
...
bool Native::Interface::EmbeddedServiceEngine::RcvQueue::CosMap::has_operation() const
{
    for (auto const & leaf : cos_values.getYLeafs())
    {
        if(is_set(leaf.yfilter))
...
const EntityPath Native::Interface::EmbeddedServiceEngine::RcvQueue::CosMap::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::RcvQueue::CosMap::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::RcvQueue::CosMap::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::RcvQueue::CosMap::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Interface::EmbeddedServiceEngine::RcvQueue::CosMap::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "queue-id")
    {
...
bool Native::Interface::EmbeddedServiceEngine::RcvQueue::CosMap::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Interface::EmbeddedServiceEngine::Peer::Peer()
    :
    default_(std::make_shared<Native::Interface::EmbeddedServiceEngine::Peer::Default_>())
{
    default_->parent = this;

    yang_name = "peer"; yang_parent_name = "Embedded-Service-Engine";
}
...
bool Native::Interface::EmbeddedServiceEngine::Peer::has_operation() const
{
    return is_set(yfilter)
	|| (default_ !=  nullptr && default_->has_operation());
}

std::string Native::Interface::EmbeddedServiceEngine::Peer::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "peer";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::Peer::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::Peer::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::Peer::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(default_ != nullptr)
    {
...
void Native::Interface::EmbeddedServiceEngine::Peer::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Interface::EmbeddedServiceEngine::Peer::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Interface::EmbeddedServiceEngine::Peer::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "default")
        return true;
    return false;
...
Native::Interface::EmbeddedServiceEngine::Peer::Default_::Default_()
    :
    ip(std::make_shared<Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip>())
{
    ip->parent = this;
...
bool Native::Interface::EmbeddedServiceEngine::Peer::Default_::has_data() const
{
    return (ip !=  nullptr && ip->has_data());
}

bool Native::Interface::EmbeddedServiceEngine::Peer::Default_::has_operation() const
{
    return is_set(yfilter)
	|| (ip !=  nullptr && ip->has_operation());
}

std::string Native::Interface::EmbeddedServiceEngine::Peer::Default_::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "default";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::Peer::Default_::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::Peer::Default_::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::Peer::Default_::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(ip != nullptr)
    {
...
void Native::Interface::EmbeddedServiceEngine::Peer::Default_::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Interface::EmbeddedServiceEngine::Peer::Default_::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Interface::EmbeddedServiceEngine::Peer::Default_::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "ip")
        return true;
    return false;
...
Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Ip()
    :
    address(std::make_shared<Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address>())
{
    address->parent = this;
...
bool Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::has_data() const
{
    return (address !=  nullptr && address->has_data());
}

bool Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::has_operation() const
{
    return is_set(yfilter)
	|| (address !=  nullptr && address->has_operation());
}

std::string Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "ip";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(address != nullptr)
    {
...
void Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
}

void Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::set_filter(const std::string & value_path, YFilter yfilter)
{
}

bool Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "address")
        return true;
    return false;
...
Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::Address()
    :
...
bool Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::has_data() const
{
    return dhcp.is_set
...
bool Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "address";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "dhcp-pool")
    {
        if(dhcp_pool == nullptr)
        {
            dhcp_pool = std::make_shared<Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::DhcpPool>();
        }
        return dhcp_pool;
    }
    ...
    if(child_yang_name == "pool")
    {
        if(pool == nullptr)
        {
            pool = std::make_shared<Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::Pool>();
        }
        return pool;
    }
...
std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    if(dhcp_pool != nullptr)
    {
...
void Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "dhcp")
    {
        dhcp = value;
...
void Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "dhcp")
    {
...
bool Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::DhcpPool::DhcpPool()
    :
...
bool Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::DhcpPool::has_data() const
{
    return pools.is_set;
}

bool Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::DhcpPool::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(pools.yfilter);
}

std::string Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::DhcpPool::get_segment_path() const
{
    std::ostringstream path_buffer;
...
const EntityPath Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::DhcpPool::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::DhcpPool::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::DhcpPool::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::DhcpPool::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "pools")
    {
        pools = value;
...
void Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::DhcpPool::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "pools")
    {
...
bool Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::DhcpPool::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "pools")
        return true;
    return false;
...
Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::Pool::Pool()
    :
    pools{YType::str, "pools"}
{
...
bool Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::Pool::has_data() const
{
    return pools.is_set;
}

bool Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::Pool::has_operation() const
{
    return is_set(yfilter)
	|| ydk::is_set(pools.yfilter);
}

std::string Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::Pool::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "pool";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::Pool::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::Pool::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::Pool::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::Pool::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "pools")
    {
        pools = value;
...
void Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::Pool::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "pools")
    {
        pools.yfilter = yfilter;
...
bool Native::Interface::EmbeddedServiceEngine::Peer::Default_::Ip::Address::Pool::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "pools")
        return true;
    return false;
...
Native::Interface::EmbeddedServiceEngine::PmPath::PmPath()
    ...
    name{YType::str, "name"}
{
    yang_name = "pm-path"; yang_parent_name = "Embedded-Service-Engine";
}
...
bool Native::Interface::EmbeddedServiceEngine::PmPath::has_operation() const
{
    return is_set(yfilter)
...
std::string Native::Interface::EmbeddedServiceEngine::PmPath::get_segment_path() const
{
    std::ostringstream path_buffer;
    path_buffer << "pm-path";
...
const EntityPath Native::Interface::EmbeddedServiceEngine::PmPath::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::EmbeddedServiceEngine::PmPath::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<Entity>> Native::Interface::EmbeddedServiceEngine::PmPath::get_children() const
{
    std::map<std::string, std::shared_ptr<Entity>> children{};
    return children;
}

void Native::Interface::EmbeddedServiceEngine::PmPath::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
...
void Native::Interface::EmbeddedServiceEngine::PmPath::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "interface-id")
    {
...
bool Native::Interface::EmbeddedServiceEngine::PmPath::has_leaf_or_child_of_name(const std::string & name) const
{
...
Native::Interface::Fastethernet::Fastethernet()
	...
	,auto_(std::make_shared<Native::Interface::Fastethernet::Auto_>())
	...
	,interface_qos(std::make_shared<Native::Interface::Fastethernet::Interface_Qos>())
	...
	,switch_(std::make_shared<Native::Interface::Fastethernet::Switch_>())
	...
	,zone_member(std::make_shared<Native::Interface::Fastethernet::ZoneMember>())
{
    ...
    yang_name = "FastEthernet"; yang_parent_name = "interface";
}
...
const EntityPath Native::Interface::Fastethernet::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
std::shared_ptr<Entity> Native::Interface::Fastethernet::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    ...
    if(child_yang_name == "macsec")
    {
        if(macsec == nullptr)
        {
            macsec = std::make_shared<Native::Interface::Fastethernet::Macsec>();
        }
        return macsec;
    }
...
{
    yang_name = "switchport-conf"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::SwitchportConf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
	...
	,voice(std::make_shared<Native::Interface::Fastethernet::Switchport::Voice>())
{
    ...
    yang_name = "switchport"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::Switchport::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Access::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Access::Vlan::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Block::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Mode::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Mode::Access::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Mode::Dot1QTunnel::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Mode::PrivateVlan::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Mode::Trunk::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::PortSecurity::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::PortSecurity::Aging::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::PortSecurity::MacAddress::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::PortSecurity::Maximum::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Trunk::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Trunk::Allowed::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Trunk::Allowed::Vlan::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Trunk::Native_::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Trunk::Pruning::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Trunk::Pruning::Vlan::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Voice::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Voice::Vlan::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Voice::Detect::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Voice::Detect::CiscoPhone::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Priority::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Priority::Extend::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::Autostate::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::PrivateVlan::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::PrivateVlan::Association::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::PrivateVlan::Association::Host::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::PrivateVlan::Association::Mapping::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::PrivateVlan::HostAssociation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::PrivateVlan::Mapping::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Switchport::DeviceTracking::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "arp"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::Arp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
	...
	,load(std::make_shared<Native::Interface::Fastethernet::Backup::Load>())
{
    ...
    yang_name = "backup"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::Backup::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Backup::Delay::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Backup::Interface_::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Backup::Interface_::AtmSubinterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Backup::Interface_::AtmAcrsubinterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Backup::Interface_::LispSubinterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Backup::Interface_::PortChannelSubinterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Backup::Load::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
    ...
    reserve(std::make_shared<Native::Interface::Fastethernet::Cemoudp::Reserve>())
{
    ...
    yang_name = "cemoudp"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::Cemoudp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Cemoudp::Reserve::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
    ...
    out(std::make_shared<Native::Interface::Fastethernet::CwsTunnel::Out>())
{
    ...
    yang_name = "cws-tunnel"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::CwsTunnel::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::CwsTunnel::Out::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
	...
	,shutdown_threshold(std::make_shared<Native::Interface::Fastethernet::L2ProtocolTunnel::ShutdownThreshold>())
{
    ...
    yang_name = "l2protocol-tunnel"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::L2ProtocolTunnel::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::L2ProtocolTunnel::DropThreshold::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::L2ProtocolTunnel::ShutdownThreshold::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
	...
	,slip(nullptr) // presence node
{
    ...
    yang_name = "encapsulation"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::Encapsulation::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Encapsulation::Dot1Q::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Encapsulation::Isl::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Encapsulation::Ppp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Encapsulation::Slip::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Encapsulation::FrameRelay::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "fair-queue-conf"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::FairQueueConf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "fair-queue"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::FairQueue::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "flowcontrol"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::Flowcontrol::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
	...
	,three_way_handshake(nullptr) // presence node
{
    ...
    yang_name = "isis"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::Isis::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::AdjacencyFilter::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Advertise::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Authentication::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Authentication::Mode::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Authentication::Mode::Md5::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Authentication::Mode::Text::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Authentication::KeyChain::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Authentication::KeyChain::KeyChainList::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Authentication::SendOnly::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::CircuitType::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::CsnpInterval::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::CsnpInterval::CsnpIntervalList::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Hello::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Hello::Padding::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::HelloInterval::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::HelloInterval::HelloIntervalList::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::HelloMultiplier::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::HelloMultiplier::HelloMultiplierList::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Ipv6::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Ipv6::Metric::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Ipv6::Metric::MetricList::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Metric::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Metric::MetricList::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Password::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Password::PasswordList::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Priority::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::Priority::PriorityList::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Isis::ThreeWayHandshake::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "keepalive-settings"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::KeepaliveSettings::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::KeepaliveSettings::Keepalive::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
    ...
    interval(std::make_shared<Native::Interface::Fastethernet::Bfd::Interval>())
{
    ...
    yang_name = "bfd"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::Bfd::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Bfd::Interval::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
	...
	,receive(std::make_shared<Native::Interface::Fastethernet::Bandwidth::Receive>())
{
    ...
    yang_name = "bandwidth"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::Bandwidth::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Bandwidth::Receive::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Bandwidth::Inherit::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
    ...
    restart(std::make_shared<Native::Interface::Fastethernet::Dampening::Restart>())
{
    ...
    yang_name = "dampening"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::Dampening::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Dampening::Restart::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "domain"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::Domain::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "hold-queue"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::HoldQueue::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
	...
	,traffic_eng(std::make_shared<Native::Interface::Fastethernet::Mpls::TrafficEng>())
{
    ...
    yang_name = "mpls"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::Mpls::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Mpls::Accounting::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Mpls::Accounting::Experimental::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Mpls::Bgp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Mpls::Label::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Mpls::Ldp::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Mpls::Ldp::Discovery::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Mpls::TrafficEng::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Mpls::TrafficEng::BackupPath::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Mpls::TrafficEng::Flooding::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Mpls::TrafficEng::Flooding::Thresholds::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Mpls::TrafficEng::PassiveInterface::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Mpls::TrafficEng::PassiveInterface::NbrIgpId::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
    ...
    ip(std::make_shared<Native::Interface::Fastethernet::IpVrf::Ip>())
{
    ...
    yang_name = "ip-vrf"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::IpVrf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::IpVrf::Ip::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::IpVrf::Ip::Vrf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
Native::Interface::Fastethernet::Vrf::Vrf()
    ...
    forwarding{YType::str, "forwarding"}
{
    yang_name = "vrf"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::Vrf::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
	...
	,wccp(std::make_shared<Native::Interface::Fastethernet::Ip::Wccp>())
{
    ...
    yang_name = "ip"; yang_parent_name = "FastEthernet";
}
...
const EntityPath Native::Interface::Fastethernet::Ip::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const EntityPath Native::Interface::Fastethernet::Ip::AccessGroup::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
const Enum::YLeaf Native::Interface::EmbeddedServiceEngine::AccessSession::HostMode::multi_auth {0, "multi-auth"};
const Enum::YLeaf Native::Interface::EmbeddedServiceEngine::AccessSession::HostMode::multi_domain {1, "multi-domain"};
const Enum::YLeaf Native::Interface::EmbeddedServiceEngine::AccessSession::HostMode::multi_host {2, "multi-host"};
const Enum::YLeaf Native::Interface::EmbeddedServiceEngine::AccessSession::HostMode::single_host {3, "single-host"};

const Enum::YLeaf Native::Interface::EmbeddedServiceEngine::Trust::Device::cisco_phone {0, "cisco-phone"};
const Enum::YLeaf Native::Interface::EmbeddedServiceEngine::Trust::Device::cts {1, "cts"};
const Enum::YLeaf Native::Interface::EmbeddedServiceEngine::Trust::Device::ip_camera {2, "ip-camera"};
const Enum::YLeaf Native::Interface::EmbeddedServiceEngine::Trust::Device::media_player {3, "media-player"};
