...
class Native::Interface::VirtualTemplate::Source : public ydk::Entity
{
    public:
        Source();
        ~Source();
        ...
        class Template; //type: Native::Interface::VirtualTemplate::Source::Template

        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::VirtualTemplate::Source::Template> template_;
        
}; // Native::Interface::VirtualTemplate::Source


class Native::Interface::VirtualTemplate::Source::Template : public ydk::Entity
{
    public:
        Template();
        ~Template();
        ...
        class TemplateName; //type: Native::Interface::VirtualTemplate::Source::Template::TemplateName

        ydk::YList template_name;
        
}; // Native::Interface::VirtualTemplate::Source::Template


class Native::Interface::VirtualTemplate::Source::Template::TemplateName : public ydk::Entity
{
    public:
        TemplateName();
        ~TemplateName();
...
}; // Native::Interface::VirtualTemplate::Source::Template::TemplateName
...
class Native::Interface::VirtualTemplate::AccessSession : public ydk::Entity
{
    public:
        ...
        class ControlDirection; //type: Native::Interface::VirtualTemplate::AccessSession::ControlDirection

        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::VirtualTemplate::AccessSession::PortControl> port_control;
        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::VirtualTemplate::AccessSession::ControlDirection> control_direction;
                class HostMode;
...
class Native::Interface::VirtualTemplate::AccessSession::ControlDirection : public ydk::Entity
{
    public:
        ControlDirection();
        ~ControlDirection();
...
}; // Native::Interface::VirtualTemplate::AccessSession::ControlDirection
...
class Native::Interface::VirtualTemplate::Ethernet : public ydk::Entity
{
    public:
        ...
        class Dot1ad; //type: Native::Interface::VirtualTemplate::Ethernet::Dot1ad

        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::VirtualTemplate::Ethernet::Oam> oam; // presence node
        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::VirtualTemplate::Ethernet::Dot1ad> dot1ad;
...
class Native::Interface::VirtualTemplate::Ethernet::Dot1ad : public ydk::Entity
{
    public:
        Dot1ad();
        ~Dot1ad();
        ...
        class Uni; //type: Native::Interface::VirtualTemplate::Ethernet::Dot1ad::Uni

        std::shared_ptr<cisco_ios_xe::Cisco_IOS_XE_native::Native::Interface::VirtualTemplate::Ethernet::Dot1ad::Uni> uni;
        
}; // Native::Interface::VirtualTemplate::Ethernet::Dot1ad


class Native::Interface::VirtualTemplate::Ethernet::Dot1ad::Uni : public ydk::Entity
{
    public:
        Uni();
        ~Uni();
...
}; // Native::Interface::VirtualTemplate::Ethernet::Dot1ad::Uni
