...
class Native::Interface::Tengigabitethernet::Ospfv3::Encryption::Ipsec::Ipsec_3Des : public ydk::Entity
{
    public:
        Ipsec_3Des();
        ~Ipsec_3Des();
...
class Native::Interface::Tengigabitethernet::Ospfv3::Encryption::Ipsec::Ipsec_3Des::KeyString : public ydk::Entity
{
    public:
        KeyString();
        ~KeyString();
...
class Native::Interface::Tengigabitethernet::Ospfv3::Encryption::Ipsec::Ipsec_3Des::KeyString::Encrypt : public ydk::Enum
{
    public:
        static const ydk::Enum::YLeaf Y_0;
        static const ydk::Enum::YLeaf Y_7;
