...
class Native::Interface::Gigabitethernet::Cts : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Interface::Gigabitethernet::Cts::RoleBased> role_based;
...
class Native::Interface::Gigabitethernet::Cts::RoleBased : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Interface::Gigabitethernet::Cts::RoleBased::SgtMap> sgt_map;
                class SgtCache;
