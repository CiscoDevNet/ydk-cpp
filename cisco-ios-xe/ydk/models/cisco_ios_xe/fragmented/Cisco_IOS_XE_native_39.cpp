...
Native::Interface::TwoGigabitEthernet::TwoGigabitEthernet()
    ...
    , cisco_ios_xe_ethernet_macsec_option_(std::make_shared<Native::Interface::TwoGigabitEthernet::CiscoIOSXEEthernetMacsecOption>())
    ...
    , shutdown_threshold(std::make_shared<Native::Interface::TwoGigabitEthernet::L2protocolTunnel::ShutdownThreshold>())
{
    ...
    yang_name = "l2protocol-tunnel"; yang_parent_name = "TwoGigabitEthernet"; is_top_level_class = false; has_list_ancestor = true; is_presence_container = true;
}
