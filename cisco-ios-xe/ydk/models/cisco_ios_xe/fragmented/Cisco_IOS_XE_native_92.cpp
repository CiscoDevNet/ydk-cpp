...
void Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Neighbor::PathAttribute::Discard::Attibute_Type::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "in")
    {
        in = value;
...
void Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Neighbor::PathAttribute::Discard::Attibute_Type::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "in")
    {
        in.yfilter = yfilter;
...
bool Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Neighbor::PathAttribute::Discard::Attibute_Type::has_leaf_or_child_of_name(const std::string & name) const
{
...
void Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Neighbor::PathAttribute::TreatAsWithdraw::Attibute_Type::set_value(const std::string & value_path, const std::string & value, const std::string & name_space, const std::string & name_space_prefix)
{
    if(value_path == "in")
    {
        in = value;
...
void Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Neighbor::PathAttribute::TreatAsWithdraw::Attibute_Type::set_filter(const std::string & value_path, YFilter yfilter)
{
    if(value_path == "in")
    {
        in.yfilter = yfilter;
...
bool Native::Router::Bgp::AddressFamily::NoVrf::Ipv6::Neighbor::PathAttribute::TreatAsWithdraw::Attibute_Type::has_leaf_or_child_of_name(const std::string & name) const
{
    if(name == "in" || name == "type")
        return true;
    return false;
