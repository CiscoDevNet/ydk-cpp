...
{
    if(name == "url" || name == "size" || name == "threshold" || name == "protected")
        return true;
    return false;
}
...
{
    if(name == "group" || name == "authentication" || name == "authorization" || name == "accounting" || name == "server" || name == "login" || name == "new-model" || name == "session-id")
        return true;
    return false;
}
