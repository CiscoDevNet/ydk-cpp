...
class Native::Interface::Tunnel::Ospfv3::Encryption::Ipsec::Ipsec_3Des : public ydk::Entity
{
    public:
        Ipsec_3Des();
        ~Ipsec_3Des();
...
class Native::Interface::Tunnel::Ospfv3::Encryption::Ipsec::Ipsec_3Des::KeyString : public ydk::Entity
{
    public:
        KeyString();
        ~KeyString();
...
class Native::Interface::VirtualTemplate : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_native::Native::Interface::VirtualTemplate::Dampening> dampening;
        ...
        std::vector<std::shared_ptr<Cisco_IOS_XE_native::Native::Interface::VirtualTemplate::HoldQueue> > hold_queue;
...
class Native::Interface::Tunnel::Ospfv3::Encryption::Ipsec::Ipsec_3Des::KeyString::Encrypt : public ydk::Enum
{
    public:
        static const ydk::Enum::YLeaf Y_0;
        static const ydk::Enum::YLeaf Y_7;
