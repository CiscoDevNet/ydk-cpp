...
std::shared_ptr<ydk::Entity> CISCOPINGMIB::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOPINGMIB::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(ciscopingtable != nullptr)
    {
        _children["ciscoPingTable"] = ciscopingtable;
    }
...
std::shared_ptr<ydk::Entity> CISCOPINGMIB::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> CISCOPINGMIB::CiscoPingTable::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "ciscoPingEntry")
    {
        auto ent_ = std::make_shared<CISCOPINGMIB::CiscoPingTable::CiscoPingEntry>();
        ent_->parent = this;
        ciscopingentry.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOPINGMIB::CiscoPingTable::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : ciscopingentry.entities())
    {
...
std::shared_ptr<ydk::Entity> CISCOPINGMIB::CiscoPingTable::CiscoPingEntry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOPINGMIB::CiscoPingTable::CiscoPingEntry::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
