...
{
    yang_name = "cdp-neighbour-details"; yang_parent_name = "Cisco-IOS-XE-cdp-oper";
}
...
const EntityPath CdpNeighbourDetails::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor != nullptr)
    {
	...
	,spare_pair(std::make_shared<CdpNeighbourDetails::CdpNeighbourDetail::SparePair>())
{
    ...
    yang_name = "cdp-neighbour-detail"; yang_parent_name = "cdp-neighbour-details";
}
...
const EntityPath CdpNeighbourDetails::CdpNeighbourDetail::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "hello-message"; yang_parent_name = "cdp-neighbour-detail";
}
...
const EntityPath CdpNeighbourDetails::CdpNeighbourDetail::HelloMessage::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'HelloMessage' in Cisco_IOS_XE_cdp_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    yang_name = "power-request"; yang_parent_name = "cdp-neighbour-detail";
}
...
const EntityPath CdpNeighbourDetails::CdpNeighbourDetail::PowerRequest::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'PowerRequest' in Cisco_IOS_XE_cdp_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
CdpNeighbourDetails::CdpNeighbourDetail::PowerAvailable::PowerAvailable()
    ...
    power_request_id{YType::uint16, "power-request-id"}
{
    yang_name = "power-available"; yang_parent_name = "cdp-neighbour-detail";
}
...
const EntityPath CdpNeighbourDetails::CdpNeighbourDetail::PowerAvailable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'PowerAvailable' in Cisco_IOS_XE_cdp_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
...
{
    yang_name = "spare-pair"; yang_parent_name = "cdp-neighbour-detail";
}
...
const EntityPath CdpNeighbourDetails::CdpNeighbourDetail::SparePair::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
        throw(YCPPInvalidArgumentError{"ancestor for 'SparePair' in Cisco_IOS_XE_cdp_oper cannot be nullptr as one of the ancestors is a list"});
    }
    else
    {
        path_buffer << get_relative_entity_path(this, ancestor, path_buffer.str());
