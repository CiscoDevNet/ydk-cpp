...
{
    if(name == "source" || name == "filter" || name == "with-defaults" || name == "with-inactive")
        return true;
    return false;
}
...
{
    if(name == "target" || name == "config" || name == "default-operation" || name == "error-option" || name == "test-option" || name == "url" || name == "with-inactive")
        return true;
    return false;
}
...
{
    if(name == "source" || name == "target" || name == "with-defaults" || name == "with-inactive")
        return true;
    return false;
}
...
{
    if(name == "filter" || name == "with-defaults" || name == "with-inactive")
        return true;
    return false;
}
