...
{
    if(name == "in-label-lsps" || name == "ipv6-ingress-lsps" || name == "interfaces" || name == "named-lsps" || name == "ipv4-ingress-lsps")
        return true;
    return false;
}
...
{
    if(name == "out-interface-name" || name == "if-index" || name == "ipv6-address" || name == "mac-address" || name == "ipv4-address")
        return true;
    return false;
}
