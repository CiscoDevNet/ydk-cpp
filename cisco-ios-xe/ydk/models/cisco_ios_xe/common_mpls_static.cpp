...
{
    if (is_presence_container) return true;
    return (ipv6_ingress_lsps !=  nullptr && ipv6_ingress_lsps->has_data())
...
{
    if(name == "ipv6-ingress-lsps" || name == "named-lsps" || name == "interfaces" || name == "in-label-lsps" || name == "ipv4-ingress-lsps")
        return true;
    return false;
}
...
{
    if(name == "ipv6-address" || name == "ipv4-address" || name == "if-index" || name == "mac-address" || name == "out-interface-name")
        return true;
    return false;
}
