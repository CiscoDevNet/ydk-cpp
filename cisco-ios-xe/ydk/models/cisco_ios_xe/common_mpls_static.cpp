...
{
    if(name == "ipv4-ingress-lsps" || name == "interfaces" || name == "named-lsps" || name == "ipv6-ingress-lsps" || name == "in-label-lsps")
        return true;
    return false;
}
...
{
    if(name == "ipv6-address" || name == "mac-address" || name == "if-index" || name == "ipv4-address" || name == "out-interface-name")
        return true;
    return false;
}
