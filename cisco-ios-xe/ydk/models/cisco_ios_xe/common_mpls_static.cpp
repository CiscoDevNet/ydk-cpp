...
{
    if(name == "interfaces" || name == "ipv6-ingress-lsps" || name == "ipv4-ingress-lsps" || name == "in-label-lsps" || name == "named-lsps")
        return true;
    return false;
}
...
{
    if(name == "if-index" || name == "ipv4-address" || name == "mac-address" || name == "ipv6-address" || name == "out-interface-name")
        return true;
    return false;
}
