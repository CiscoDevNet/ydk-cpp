...
class MdtOperData : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<Cisco_IOS_XE_mdt_oper::MdtOperData::MdtConnections> > mdt_connections;
        std::shared_ptr<Cisco_IOS_XE_mdt_oper::MdtOperData::MdtStreams> mdt_streams;
        std::vector<std::shared_ptr<Cisco_IOS_XE_mdt_oper::MdtOperData::MdtSubscriptions> > mdt_subscriptions;
...
class MdtOperData::MdtSubscriptions : public ydk::Entity
{
    public:
        ...
        std::shared_ptr<Cisco_IOS_XE_mdt_oper::MdtOperData::MdtSubscriptions::Base> base;
        std::vector<std::shared_ptr<Cisco_IOS_XE_mdt_oper::MdtOperData::MdtSubscriptions::MdtReceivers> > mdt_receivers;
...
class MdtOperData::MdtConnections : public ydk::Entity
{
    public:
        ...
        std::vector<std::shared_ptr<Cisco_IOS_XE_mdt_oper::MdtOperData::MdtConnections::MdtSubConStats> > mdt_sub_con_stats;
