	...
	,usrhistorytable(std::make_shared<Rmon2Mib::Usrhistorytable>())
{
    ...
    yang_name = "RMON2-MIB"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor != nullptr)
    {
...
{
    yang_name = "protocolDir"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Protocoldir::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "addressMap"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Addressmap::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "probeConfig"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Probeconfig::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "protocolDirTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Protocoldirtable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "protocolDirEntry"; yang_parent_name = "protocolDirTable";
}
...
const EntityPath Rmon2Mib::Protocoldirtable::Protocoldirentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "protocolDistControlTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Protocoldistcontroltable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "protocolDistControlEntry"; yang_parent_name = "protocolDistControlTable";
}
...
const EntityPath Rmon2Mib::Protocoldistcontroltable::Protocoldistcontrolentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "protocolDistStatsTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Protocoldiststatstable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "protocolDistStatsEntry"; yang_parent_name = "protocolDistStatsTable";
}
...
const EntityPath Rmon2Mib::Protocoldiststatstable::Protocoldiststatsentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "addressMapControlTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Addressmapcontroltable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "addressMapControlEntry"; yang_parent_name = "addressMapControlTable";
}
...
const EntityPath Rmon2Mib::Addressmapcontroltable::Addressmapcontrolentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "addressMapTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Addressmaptable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "addressMapEntry"; yang_parent_name = "addressMapTable";
}
...
const EntityPath Rmon2Mib::Addressmaptable::Addressmapentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "hlHostControlTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Hlhostcontroltable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "hlHostControlEntry"; yang_parent_name = "hlHostControlTable";
}
...
const EntityPath Rmon2Mib::Hlhostcontroltable::Hlhostcontrolentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "nlHostTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Nlhosttable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "nlHostEntry"; yang_parent_name = "nlHostTable";
}
...
const EntityPath Rmon2Mib::Nlhosttable::Nlhostentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "hlMatrixControlTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Hlmatrixcontroltable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "hlMatrixControlEntry"; yang_parent_name = "hlMatrixControlTable";
}
...
const EntityPath Rmon2Mib::Hlmatrixcontroltable::Hlmatrixcontrolentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "nlMatrixSDTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Nlmatrixsdtable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "nlMatrixSDEntry"; yang_parent_name = "nlMatrixSDTable";
}
...
const EntityPath Rmon2Mib::Nlmatrixsdtable::Nlmatrixsdentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "nlMatrixDSTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Nlmatrixdstable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "nlMatrixDSEntry"; yang_parent_name = "nlMatrixDSTable";
}
...
const EntityPath Rmon2Mib::Nlmatrixdstable::Nlmatrixdsentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "nlMatrixTopNControlTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Nlmatrixtopncontroltable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "nlMatrixTopNControlEntry"; yang_parent_name = "nlMatrixTopNControlTable";
}
...
const EntityPath Rmon2Mib::Nlmatrixtopncontroltable::Nlmatrixtopncontrolentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "nlMatrixTopNTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Nlmatrixtopntable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "nlMatrixTopNEntry"; yang_parent_name = "nlMatrixTopNTable";
}
...
const EntityPath Rmon2Mib::Nlmatrixtopntable::Nlmatrixtopnentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "alHostTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Alhosttable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "alHostEntry"; yang_parent_name = "alHostTable";
}
...
const EntityPath Rmon2Mib::Alhosttable::Alhostentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "alMatrixSDTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Almatrixsdtable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "alMatrixSDEntry"; yang_parent_name = "alMatrixSDTable";
}
...
const EntityPath Rmon2Mib::Almatrixsdtable::Almatrixsdentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "alMatrixDSTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Almatrixdstable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "alMatrixDSEntry"; yang_parent_name = "alMatrixDSTable";
}
...
const EntityPath Rmon2Mib::Almatrixdstable::Almatrixdsentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "alMatrixTopNControlTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Almatrixtopncontroltable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "alMatrixTopNControlEntry"; yang_parent_name = "alMatrixTopNControlTable";
}
...
const EntityPath Rmon2Mib::Almatrixtopncontroltable::Almatrixtopncontrolentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "alMatrixTopNTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Almatrixtopntable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "alMatrixTopNEntry"; yang_parent_name = "alMatrixTopNTable";
}
...
const EntityPath Rmon2Mib::Almatrixtopntable::Almatrixtopnentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "usrHistoryControlTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Usrhistorycontroltable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "usrHistoryControlEntry"; yang_parent_name = "usrHistoryControlTable";
}
...
const EntityPath Rmon2Mib::Usrhistorycontroltable::Usrhistorycontrolentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "usrHistoryObjectTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Usrhistoryobjecttable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "usrHistoryObjectEntry"; yang_parent_name = "usrHistoryObjectTable";
}
...
const EntityPath Rmon2Mib::Usrhistoryobjecttable::Usrhistoryobjectentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "usrHistoryTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Usrhistorytable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "usrHistoryEntry"; yang_parent_name = "usrHistoryTable";
}
...
const EntityPath Rmon2Mib::Usrhistorytable::Usrhistoryentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "serialConfigTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Serialconfigtable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "serialConfigEntry"; yang_parent_name = "serialConfigTable";
}
...
const EntityPath Rmon2Mib::Serialconfigtable::Serialconfigentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "netConfigTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Netconfigtable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "netConfigEntry"; yang_parent_name = "netConfigTable";
}
...
const EntityPath Rmon2Mib::Netconfigtable::Netconfigentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "trapDestTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Trapdesttable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "trapDestEntry"; yang_parent_name = "trapDestTable";
}
...
const EntityPath Rmon2Mib::Trapdesttable::Trapdestentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "serialConnectionTable"; yang_parent_name = "RMON2-MIB";
}
...
const EntityPath Rmon2Mib::Serialconnectiontable::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
...
{
    yang_name = "serialConnectionEntry"; yang_parent_name = "serialConnectionTable";
}
...
const EntityPath Rmon2Mib::Serialconnectiontable::Serialconnectionentry::get_entity_path(Entity* ancestor) const
{
    std::ostringstream path_buffer;
    if (ancestor == nullptr)
    {
