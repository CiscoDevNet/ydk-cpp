...
std::shared_ptr<ydk::Entity> CISCOIPSECPOLICYMAPMIB::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOIPSECPOLICYMAPMIB::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(ikepolmaptable != nullptr)
    {
        _children["ikePolMapTable"] = ikepolmaptable;
    }

    if(ipsecpolmaptable != nullptr)
    {
        _children["ipSecPolMapTable"] = ipsecpolmaptable;
    }
...
std::shared_ptr<ydk::Entity> CISCOIPSECPOLICYMAPMIB::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> CISCOIPSECPOLICYMAPMIB::IkePolMapTable::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "ikePolMapEntry")
    {
        auto ent_ = std::make_shared<CISCOIPSECPOLICYMAPMIB::IkePolMapTable::IkePolMapEntry>();
        ent_->parent = this;
        ikepolmapentry.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOIPSECPOLICYMAPMIB::IkePolMapTable::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : ikepolmapentry.entities())
    {
...
std::shared_ptr<ydk::Entity> CISCOIPSECPOLICYMAPMIB::IkePolMapTable::IkePolMapEntry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOIPSECPOLICYMAPMIB::IkePolMapTable::IkePolMapEntry::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> CISCOIPSECPOLICYMAPMIB::IpSecPolMapTable::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "ipSecPolMapEntry")
    {
        auto ent_ = std::make_shared<CISCOIPSECPOLICYMAPMIB::IpSecPolMapTable::IpSecPolMapEntry>();
        ent_->parent = this;
        ipsecpolmapentry.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOIPSECPOLICYMAPMIB::IpSecPolMapTable::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : ipsecpolmapentry.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> CISCOIPSECPOLICYMAPMIB::IpSecPolMapTable::IpSecPolMapEntry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOIPSECPOLICYMAPMIB::IpSecPolMapTable::IpSecPolMapEntry::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
