...
std::shared_ptr<ydk::Entity> CISCOETHERLIKEEXTMIB::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOETHERLIKEEXTMIB::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(ceedot3pauseexttable != nullptr)
    {
        _children["ceeDot3PauseExtTable"] = ceedot3pauseexttable;
    }

    if(ceesubinterfacetable != nullptr)
    {
        _children["ceeSubInterfaceTable"] = ceesubinterfacetable;
    }
...
std::shared_ptr<ydk::Entity> CISCOETHERLIKEEXTMIB::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> CISCOETHERLIKEEXTMIB::CeeDot3PauseExtTable::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "ceeDot3PauseExtEntry")
    {
        auto ent_ = std::make_shared<CISCOETHERLIKEEXTMIB::CeeDot3PauseExtTable::CeeDot3PauseExtEntry>();
        ent_->parent = this;
        ceedot3pauseextentry.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOETHERLIKEEXTMIB::CeeDot3PauseExtTable::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : ceedot3pauseextentry.entities())
    {
...
std::shared_ptr<ydk::Entity> CISCOETHERLIKEEXTMIB::CeeDot3PauseExtTable::CeeDot3PauseExtEntry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOETHERLIKEEXTMIB::CeeDot3PauseExtTable::CeeDot3PauseExtEntry::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> CISCOETHERLIKEEXTMIB::CeeSubInterfaceTable::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "ceeSubInterfaceEntry")
    {
        auto ent_ = std::make_shared<CISCOETHERLIKEEXTMIB::CeeSubInterfaceTable::CeeSubInterfaceEntry>();
        ent_->parent = this;
        ceesubinterfaceentry.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOETHERLIKEEXTMIB::CeeSubInterfaceTable::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : ceesubinterfaceentry.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> CISCOETHERLIKEEXTMIB::CeeSubInterfaceTable::CeeSubInterfaceEntry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOETHERLIKEEXTMIB::CeeSubInterfaceTable::CeeSubInterfaceEntry::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
