...
std::shared_ptr<ydk::Entity> OLDCISCOINTERFACESMIB::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> OLDCISCOINTERFACESMIB::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(liftable != nullptr)
    {
        _children["lifTable"] = liftable;
    }

    if(lfsiptable != nullptr)
    {
        _children["lFSIPTable"] = lfsiptable;
    }
...
std::shared_ptr<ydk::Entity> OLDCISCOINTERFACESMIB::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> OLDCISCOINTERFACESMIB::LifTable::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "lifEntry")
    {
        auto ent_ = std::make_shared<OLDCISCOINTERFACESMIB::LifTable::LifEntry>();
        ent_->parent = this;
        lifentry.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> OLDCISCOINTERFACESMIB::LifTable::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : lifentry.entities())
    {
...
std::shared_ptr<ydk::Entity> OLDCISCOINTERFACESMIB::LifTable::LifEntry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> OLDCISCOINTERFACESMIB::LifTable::LifEntry::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> OLDCISCOINTERFACESMIB::LFSIPTable::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "lFSIPEntry")
    {
        auto ent_ = std::make_shared<OLDCISCOINTERFACESMIB::LFSIPTable::LFSIPEntry>();
        ent_->parent = this;
        lfsipentry.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> OLDCISCOINTERFACESMIB::LFSIPTable::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : lfsipentry.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
...
std::shared_ptr<ydk::Entity> OLDCISCOINTERFACESMIB::LFSIPTable::LFSIPEntry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> OLDCISCOINTERFACESMIB::LFSIPTable::LFSIPEntry::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
