...
class Interfaces::Interface::Config : public ydk::Entity
{
    public:
        ...
        class Bandwidth; //type: Interfaces::Interface::Config::Bandwidth

        std::shared_ptr<openconfig_interfaces::Interfaces::Interface::Config::Bandwidth> bandwidth;
        
}; // Interfaces::Interface::Config


class Interfaces::Interface::Config::Bandwidth : public ydk::Entity
{
    public:
        Bandwidth();
        ~Bandwidth();
...
class Interfaces::Interface::HoldTime::Config : public ydk::Entity
{
    public:
        ...
        ydk::YLeaf dampening_time; //type: uint32
        ydk::YLeaf maximum_suppressing_time; //type: uint32
