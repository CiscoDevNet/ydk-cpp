...
std::shared_ptr<ydk::Entity> DeviceHardwareData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> DeviceHardwareData::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(device_hardware != nullptr)
    {
        _children["device-hardware"] = device_hardware;
    }
...
std::shared_ptr<ydk::Entity> DeviceHardwareData::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> DeviceHardwareData::DeviceHardware::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "device-inventory")
    {
        auto ent_ = std::make_shared<DeviceHardwareData::DeviceHardware::DeviceInventory>();
        ent_->parent = this;
        device_inventory.append(ent_);
        return ent_;
    }

    if(child_yang_name == "device-alarm")
    {
        auto ent_ = std::make_shared<DeviceHardwareData::DeviceHardware::DeviceAlarm>();
        ent_->parent = this;
        device_alarm.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> DeviceHardwareData::DeviceHardware::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : device_inventory.entities())
    {
    ...
    count_ = 0;
    for (auto ent_ : device_alarm.entities())
    {
        if(_children.find(ent_->get_segment_path()) == _children.end())
            _children[ent_->get_segment_path()] = ent_;
        else
    ...
    if(device_system_data != nullptr)
    {
        _children["device-system-data"] = device_system_data;
    }
...
std::shared_ptr<ydk::Entity> DeviceHardwareData::DeviceHardware::DeviceInventory::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> DeviceHardwareData::DeviceHardware::DeviceInventory::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> DeviceHardwareData::DeviceHardware::DeviceAlarm::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> DeviceHardwareData::DeviceHardware::DeviceAlarm::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> DeviceHardwareData::DeviceHardware::DeviceSystemData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> DeviceHardwareData::DeviceHardware::DeviceSystemData::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
