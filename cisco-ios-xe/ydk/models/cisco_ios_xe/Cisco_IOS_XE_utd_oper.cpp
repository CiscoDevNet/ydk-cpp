...
std::shared_ptr<ydk::Entity> UtdOperData::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> UtdOperData::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(utd_engine_status != nullptr)
    {
        _children["utd-engine-status"] = utd_engine_status;
    }

    if(utd_ips_update_status != nullptr)
    {
        _children["utd-ips-update-status"] = utd_ips_update_status;
    }

    if(utd_urlf_update_status != nullptr)
    {
        _children["utd-urlf-update-status"] = utd_urlf_update_status;
    }
...
std::shared_ptr<ydk::Entity> UtdOperData::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> UtdOperData::UtdEngineStatus::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "utd-engine-instance-status")
    {
        auto ent_ = std::make_shared<UtdOperData::UtdEngineStatus::UtdEngineInstanceStatus>();
        ent_->parent = this;
        utd_engine_instance_status.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> UtdOperData::UtdEngineStatus::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : utd_engine_instance_status.entities())
    {
...
std::shared_ptr<ydk::Entity> UtdOperData::UtdEngineStatus::UtdEngineInstanceStatus::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> UtdOperData::UtdEngineStatus::UtdEngineInstanceStatus::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> UtdOperData::UtdIpsUpdateStatus::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> UtdOperData::UtdIpsUpdateStatus::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(ips_update_status != nullptr)
    {
        _children["ips-update-status"] = ips_update_status;
    }
...
std::shared_ptr<ydk::Entity> UtdOperData::UtdIpsUpdateStatus::IpsUpdateStatus::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> UtdOperData::UtdIpsUpdateStatus::IpsUpdateStatus::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
std::shared_ptr<ydk::Entity> UtdOperData::UtdUrlfUpdateStatus::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> UtdOperData::UtdUrlfUpdateStatus::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(urlf_update_status != nullptr)
    {
        _children["urlf-update-status"] = urlf_update_status;
    }
...
std::shared_ptr<ydk::Entity> UtdOperData::UtdUrlfUpdateStatus::UrlfUpdateStatus::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> UtdOperData::UtdUrlfUpdateStatus::UrlfUpdateStatus::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
