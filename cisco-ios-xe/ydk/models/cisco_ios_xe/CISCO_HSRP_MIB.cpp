...
std::shared_ptr<ydk::Entity> CISCOHSRPMIB::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
...
std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOHSRPMIB::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    if(chsrpglobalconfig != nullptr)
    {
        _children["cHsrpGlobalConfig"] = chsrpglobalconfig;
    }

    if(chsrpgrptable != nullptr)
    {
        _children["cHsrpGrpTable"] = chsrpgrptable;
    }
...
std::shared_ptr<ydk::Entity> CISCOHSRPMIB::clone_ptr() const
{
...
std::shared_ptr<ydk::Entity> CISCOHSRPMIB::CHsrpGlobalConfig::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOHSRPMIB::CHsrpGlobalConfig::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
...
CISCOHSRPMIB::CHsrpGrpTable::CHsrpGrpTable()
    :
    chsrpgrpentry(this, {"ifindex", "chsrpgrpnumber"})
{
...
{
    if (is_presence_container) return true;
    for (std::size_t index=0; index<chsrpgrpentry.len(); index++)
    {
...
std::shared_ptr<ydk::Entity> CISCOHSRPMIB::CHsrpGrpTable::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    if(child_yang_name == "cHsrpGrpEntry")
    {
        auto ent_ = std::make_shared<CISCOHSRPMIB::CHsrpGrpTable::CHsrpGrpEntry>();
        ent_->parent = this;
        chsrpgrpentry.append(ent_);
        return ent_;
    }
...
std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOHSRPMIB::CHsrpGrpTable::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    count_ = 0;
    for (auto ent_ : chsrpgrpentry.entities())
    {
...
std::shared_ptr<ydk::Entity> CISCOHSRPMIB::CHsrpGrpTable::CHsrpGrpEntry::get_child_by_name(const std::string & child_yang_name, const std::string & segment_path)
{
    return nullptr;
}

std::map<std::string, std::shared_ptr<ydk::Entity>> CISCOHSRPMIB::CHsrpGrpTable::CHsrpGrpEntry::get_children() const
{
    std::map<std::string, std::shared_ptr<ydk::Entity>> _children{};
    char count_=0;
    return _children;
